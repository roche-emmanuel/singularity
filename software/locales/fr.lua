local lang = {
	...
	mainframe_title="Singularity Gate",
	mainframe_menuitem_exit="&Quitter",
	mainframe_menuitem_exit_hint="Quitter l'application",
	mainframe_menuitem_about="&A propos",
	mainframe_menuitem_about_hint="A propos de l'application",
