...
public:
	...
	static int _bind_cloneType(lua_State *L) {
		...
		if(!self) {
			luaL_error(L, "Invalid object in function call osg::Object * sgt::ModuleProvider::cloneType() const. Got : '%s'\n%s",typeid(Luna< osg::Referenced >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_clone_overload_1(lua_State *L) {
		...
		sgt::ModuleProvider* self=Luna< osg::Referenced >::checkSubType< sgt::ModuleProvider >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call osg::Object * sgt::ModuleProvider::clone() const. Got : '%s'\n%s",typeid(Luna< osg::Referenced >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_clone_overload_2(lua_State *L) {
		...
		sgt::ModuleProvider* self=Luna< osg::Referenced >::checkSubType< sgt::ModuleProvider >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call osg::Object * sgt::ModuleProvider::clone(const osg::CopyOp &) const. Got : '%s'\n%s",typeid(Luna< osg::Referenced >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_isSameKindAs(lua_State *L) {
		...
		sgt::ModuleProvider* self=Luna< osg::Referenced >::checkSubType< sgt::ModuleProvider >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call bool sgt::ModuleProvider::isSameKindAs(const osg::Object *) const. Got : '%s'\n%s",typeid(Luna< osg::Referenced >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_libraryName(lua_State *L) {
		...
		sgt::ModuleProvider* self=Luna< osg::Referenced >::checkSubType< sgt::ModuleProvider >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call const char * sgt::ModuleProvider::libraryName() const. Got : '%s'\n%s",typeid(Luna< osg::Referenced >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_className(lua_State *L) {
		...
		sgt::ModuleProvider* self=Luna< osg::Referenced >::checkSubType< sgt::ModuleProvider >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call const char * sgt::ModuleProvider::className() const. Got : '%s'\n%s",typeid(Luna< osg::Referenced >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_setName(lua_State *L) {
		...
		sgt::ModuleProvider* self=Luna< osg::Referenced >::checkSubType< sgt::ModuleProvider >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void sgt::ModuleProvider::base_setName(const std::string &). Got : '%s'\n%s",typeid(Luna< osg::Referenced >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_computeDataVariance(lua_State *L) {
		...
		sgt::ModuleProvider* self=Luna< osg::Referenced >::checkSubType< sgt::ModuleProvider >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void sgt::ModuleProvider::base_computeDataVariance(). Got : '%s'\n%s",typeid(Luna< osg::Referenced >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_setUserData(lua_State *L) {
		...
		sgt::ModuleProvider* self=Luna< osg::Referenced >::checkSubType< sgt::ModuleProvider >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void sgt::ModuleProvider::base_setUserData(osg::Referenced *). Got : '%s'\n%s",typeid(Luna< osg::Referenced >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_getUserData_overload_1(lua_State *L) {
		...
		sgt::ModuleProvider* self=Luna< osg::Referenced >::checkSubType< sgt::ModuleProvider >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call osg::Referenced * sgt::ModuleProvider::base_getUserData(). Got : '%s'\n%s",typeid(Luna< osg::Referenced >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_getUserData_overload_2(lua_State *L) {
		...
		sgt::ModuleProvider* self=Luna< osg::Referenced >::checkSubType< sgt::ModuleProvider >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call const osg::Referenced * sgt::ModuleProvider::base_getUserData() const. Got : '%s'\n%s",typeid(Luna< osg::Referenced >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_resizeGLObjectBuffers(lua_State *L) {
		...
		sgt::ModuleProvider* self=Luna< osg::Referenced >::checkSubType< sgt::ModuleProvider >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void sgt::ModuleProvider::base_resizeGLObjectBuffers(unsigned int). Got : '%s'\n%s",typeid(Luna< osg::Referenced >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_releaseGLObjects(lua_State *L) {
		...
		sgt::ModuleProvider* self=Luna< osg::Referenced >::checkSubType< sgt::ModuleProvider >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void sgt::ModuleProvider::base_releaseGLObjects(osg::State *) const. Got : '%s'\n%s",typeid(Luna< osg::Referenced >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_cloneType(lua_State *L) {
		...
		sgt::ModuleProvider* self=Luna< osg::Referenced >::checkSubType< sgt::ModuleProvider >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call osg::Object * sgt::ModuleProvider::base_cloneType() const. Got : '%s'\n%s",typeid(Luna< osg::Referenced >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_clone_overload_1(lua_State *L) {
		...
		sgt::ModuleProvider* self=Luna< osg::Referenced >::checkSubType< sgt::ModuleProvider >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call osg::Object * sgt::ModuleProvider::base_clone() const. Got : '%s'\n%s",typeid(Luna< osg::Referenced >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_clone_overload_2(lua_State *L) {
		...
		sgt::ModuleProvider* self=Luna< osg::Referenced >::checkSubType< sgt::ModuleProvider >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call osg::Object * sgt::ModuleProvider::base_clone(const osg::CopyOp &) const. Got : '%s'\n%s",typeid(Luna< osg::Referenced >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_isSameKindAs(lua_State *L) {
		...
		sgt::ModuleProvider* self=Luna< osg::Referenced >::checkSubType< sgt::ModuleProvider >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call bool sgt::ModuleProvider::base_isSameKindAs(const osg::Object *) const. Got : '%s'\n%s",typeid(Luna< osg::Referenced >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_libraryName(lua_State *L) {
		...
		sgt::ModuleProvider* self=Luna< osg::Referenced >::checkSubType< sgt::ModuleProvider >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call const char * sgt::ModuleProvider::base_libraryName() const. Got : '%s'\n%s",typeid(Luna< osg::Referenced >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_className(lua_State *L) {
		...
		sgt::ModuleProvider* self=Luna< osg::Referenced >::checkSubType< sgt::ModuleProvider >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call const char * sgt::ModuleProvider::base_className() const. Got : '%s'\n%s",typeid(Luna< osg::Referenced >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
