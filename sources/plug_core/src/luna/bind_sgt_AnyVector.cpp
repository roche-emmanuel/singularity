...
public:
	...
	static int _bind_fromVoid(lua_State *L) {
		...
		Luna< sgt::AnyVector >::push(L,self,false);
		return 1;
	}
...
luna_RegType LunaTraits< sgt::AnyVector >::methods[] = {
	...
	{"fromVoid", &luna_wrapper_sgt_AnyVector::_bind_fromVoid},
	{"asVoid", &luna_wrapper_sgt_AnyVector::_bind_asVoid},
	{"getTable", &luna_wrapper_sgt_AnyVector::_bind_getTable},
	{0,0}
};
