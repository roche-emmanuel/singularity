...
public:
	...
	static int _bind___eq(lua_State *L) {
		if (!_lg_typecheck___eq(L)) {
			luaL_error(L, "luna typecheck failed in __eq function, expected prototype:\n__eq(NUI_IMAGE_FRAME*). Got arguments:\n%s",luna_dumpStack(L).c_str());
		}
	...
	static int _bind_fromVoid(lua_State *L) {
		...
		NUI_IMAGE_FRAME* self= (NUI_IMAGE_FRAME*)(Luna< void >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call fromVoid(...)");
		}
		
		Luna< NUI_IMAGE_FRAME >::push(L,self,false);
		return 1;
	}
	...
	static int _bind_asVoid(lua_State *L) {
		...
		void* self= (void*)(Luna< NUI_IMAGE_FRAME >::check(L,1));
		if(!self) {
...
luna_RegType LunaTraits< NUI_IMAGE_FRAME >::methods[] = {
	...
	{"fromVoid", &luna_wrapper_NUI_IMAGE_FRAME::_bind_fromVoid},
	{"asVoid", &luna_wrapper_NUI_IMAGE_FRAME::_bind_asVoid},
	{0,0}
};
