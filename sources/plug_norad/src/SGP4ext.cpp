...
double  angle
   ...
   {
     double smalld, undefined, magv1, magv2, temp;
     smalld     = 0.00000001;
     undefined = 999999.1;
...
void rv2coe
     ...
     {
       double undefined, smalld, hbar[3], nbar[3], magr, magv, magn, ebar[3], sme,
     ...
     if ( magh > smalld )
       {
         ...
         if ( ecc < smalld )
           {
             // ----------------  circular equatorial ---------------
             if  ((incl<smalld) | (fabs(incl-pi)<smalld))
                 strcpy(typeorbit,"ce");
               else
                 // --------------  circular inclined ---------------
                 strcpy(typeorbit,"ci");
         ...
         if  (( ecc>smalld ) && (strcmp(typeorbit,"ee") == 0))
           {
             temp= ebar[0]/ecc;
             if ( fabs(temp) > 1.0  )
                 temp= sgn(temp);
         ...
         if  (( magr>smalld ) && ( strcmp(typeorbit,"ce") == 0 ))
           {
             temp= r[0]/magr;
             if ( fabs(temp) > 1.0  )
                 temp= sgn(temp);
