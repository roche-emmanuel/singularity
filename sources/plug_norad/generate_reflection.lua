...
im:addPattern("class","_Spice")
im:addPattern("class","list")
im:addPattern("class","complex")
im:addPattern("class","syl")
im:addPattern("class","unit")
im:addPattern("class","Vardesc")

im:addPattern("function","SpiceCell")
im:addPattern("function","SpiceEKAttDsc")
im:addPattern("function","SpiceEKSegSum")
im:addPattern("function","SpiceEllipse")

im:addPattern("function","ekuced_c")
im:addPattern("function","ekucei_c")
im:addPattern("function","dafgh_c")
im:addPattern("function","prefix_c")


injector:addFragment("after_headers","\n")
...
local options = {
	...
	locationPrefixes={"W:/Shared/Dev/Deps/win32/CSpice%-N0064/include/", dest_path.."/interface/"}
