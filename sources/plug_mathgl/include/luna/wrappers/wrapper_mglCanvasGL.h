#ifndef _WRAPPERS_WRAPPER_MGLCANVASGL_H_
#define _WRAPPERS_WRAPPER_MGLCANVASGL_H_
...
class wrapper_mglCanvasGL : public mglCanvasGL, public luna_wrapper_base {

public:
		

	~wrapper_mglCanvasGL() {
		logDEBUG3("Calling delete function for wrapper mglCanvasGL");
		if(_obj.pushFunction("delete")) {
			//_obj.pushArg((mglCanvasGL*)this); // No this argument or the object will be referenced again!
			_obj.callFunction<void>();
		}
	};
	
	wrapper_mglCanvasGL(lua_State* L, lua_Table* dum) 
		: mglCanvasGL(), luna_wrapper_base(L) { 
		register_protected_methods(L); 
		if(_obj.pushFunction("buildInstance")) {
			_obj.pushArg((mglCanvasGL*)this);
			_obj.callFunction<void>();
		}
	};
...
protected:
	...
	bool ScalePoint(mglPoint & p, mglPoint & n, bool use_nan = true) const {
		...
		return mglCanvasGL::ScalePoint(p, n, use_nan);
	};
	...
	double GetOrgX(char dir) const {
		...
		return mglCanvasGL::GetOrgX(dir);
	};
	...
	double GetOrgY(char dir) const {
		...
		return mglCanvasGL::GetOrgY(dir);
	};
	...
	double GetOrgZ(char dir) const {
		...
		return mglCanvasGL::GetOrgZ(dir);
	};
	...
	void mark_plot(long p, char type, double size = 1) {
		...
		return mglCanvasGL::mark_plot(p, type, size);
	};
	...
	void arrow_plot(long p1, long p2, char st) {
		...
		return mglCanvasGL::arrow_plot(p1, p2, st);
	};
	...
	void line_plot(long p1, long p2) {
		...
		return mglCanvasGL::line_plot(p1, p2);
	};
	...
	void trig_plot(long p1, long p2, long p3) {
		...
		return mglCanvasGL::trig_plot(p1, p2, p3);
	};
	...
	void quad_plot(long p1, long p2, long p3, long p4) {
		...
		return mglCanvasGL::quad_plot(p1, p2, p3, p4);
	};
	...
	void Glyph(double x, double y, double f, int style, long icode, double col) {
		...
		return mglCanvasGL::Glyph(x, y, f, style, icode, col);
	};

	// void mglCanvasGL::line_draw(long p1, long p2, mglDrawReg * d)
	void line_draw(long p1, long p2, mglDrawReg * d) {
		...
		return mglCanvasGL::line_draw(p1, p2, d);
	};

	// void mglCanvasGL::trig_draw(long p1, long p2, long p3, bool anorm, mglDrawReg * d)
	void trig_draw(long p1, long p2, long p3, bool anorm, mglDrawReg * d) {
		...
		return mglCanvasGL::trig_draw(p1, p2, p3, anorm, d);
	};

	// void mglCanvasGL::quad_draw(long p1, long p2, long p3, long p4, mglDrawReg * d)
	void quad_draw(long p1, long p2, long p3, long p4, mglDrawReg * d) {
		...
		return mglCanvasGL::quad_draw(p1, p2, p3, p4, d);
	};

	// void mglCanvasGL::pnt_draw(long p, mglDrawReg * d)
	void pnt_draw(long p, mglDrawReg * d) {
		...
		return mglCanvasGL::pnt_draw(p, d);
	};
...
public:
	...
	void SetAmbient(double bright = 0.5) {
		...
		return mglCanvasGL::SetAmbient(bright);
	};
	...
	void ResetFrames() {
		...
		return mglCanvasGL::ResetFrames();
	};
	...
	void StartAutoGroup(const char * arg1) {
		...
		return mglCanvasGL::StartAutoGroup(arg1);
	};
	...
	void EndGroup() {
		...
		return mglCanvasGL::EndGroup();
	};

	// void mglCanvasGL::SetQuality(int qual = 0)
	void SetQuality(int qual = 0) {
		...
		return mglCanvasGL::SetQuality(qual);
	};
	...
	void Finish(bool fast = true) {
		...
		return mglCanvasGL::Finish(fast);
	};
	...
	void SetSize(int w, int h) {
		...
		return mglCanvasGL::SetSize(w, h);
	};

	// void mglCanvasGL::View(double tetx, double tetz, double tety)
	void View(double tetx, double tetz, double tety) {
		...
		return mglCanvasGL::View(tetx, tetz, tety);
	};
	...
	void Zoom(double x1, double y1, double x2, double y2) {
		...
		return mglCanvasGL::Zoom(x1, y1, x2, y2);
	};
	...
	bool Alpha(bool enable) {
		...
		return mglCanvasGL::Alpha(enable);
	};
	...
	bool Light(bool enable) {
		...
		return mglCanvasGL::Light(enable);
	};
	...
	void Light(int n, bool enable) {
		...
		return mglCanvasGL::Light(n, enable);
	};
	...
	void AddLight(int n, mglPoint r, mglPoint d, char c = 'w', double bright = 0.5, double ap = 0) {
		...
		return mglCanvasGL::AddLight(n, r, d, c, bright, ap);
	};
	...
	void Clf(mglColor back = WC) {
		...
		return mglCanvasGL::Clf(back);
	};


	// Protected non-virtual methods:
	// void mglCanvasGL::set_pen(unsigned int style, double width)
	void public_set_pen(unsigned int style, double width) {
		return mglCanvasGL::set_pen(style, width);
	};
	...
	inline static bool _lg_typecheck_public_set_pen(lua_State *L) {
	...
	// void mglCanvasGL::public_set_pen(unsigned int style, double width)
	static int _bind_public_set_pen(lua_State *L) {
		if (!_lg_typecheck_public_set_pen(L)) {
			luna_printStack(L);
			luaL_error(L, "luna typecheck failed in void mglCanvasGL::public_set_pen(unsigned int style, double width) function, expected prototype:\nvoid mglCanvasGL::public_set_pen(unsigned int style, double width)\nClass arguments details:\n");
		}

		unsigned style=(unsigned)lua_tointeger(L,2);
		double width=(double)lua_tonumber(L,3);

		wrapper_mglCanvasGL* self=Luna< mglBase >::checkSubType< wrapper_mglCanvasGL >(L,1);
		if(!self) {
			luna_printStack(L);
			luaL_error(L, "Invalid object in function call void mglCanvasGL::public_set_pen(unsigned int, double). Got : '%s'",typeid(Luna< mglBase >::check(L,1)).name());
		}
		self->public_set_pen(style, width);
