...
public:
	...
	static int _bind_getName(lua_State *L) {
		...
		mglCommand* self=(Luna< mglCommand >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call const char * mglCommand::name(). Got : '%s'\n%s",typeid(Luna< mglCommand >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_getDesc(lua_State *L) {
		...
		mglCommand* self=(Luna< mglCommand >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call const char * mglCommand::desc(). Got : '%s'\n%s",typeid(Luna< mglCommand >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_getForm(lua_State *L) {
		...
		mglCommand* self=(Luna< mglCommand >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call const char * mglCommand::form(). Got : '%s'\n%s",typeid(Luna< mglCommand >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_getType(lua_State *L) {
		...
		mglCommand* self=(Luna< mglCommand >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call int mglCommand::type(). Got : '%s'\n%s",typeid(Luna< mglCommand >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
		int lret = self->type;
	...
	static int _bind_setType(lua_State *L) {
		...
		mglCommand* self=(Luna< mglCommand >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call void mglCommand::type(int). Got : '%s'\n%s",typeid(Luna< mglCommand >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
		self->type = value;
