...
public:
	...
	static int _bind_DefaultPlotParam(lua_State *L) {
		...
		if(!self) {
			luaL_error(L, "Invalid object in function call void mglCanvas::DefaultPlotParam(). Got : '%s'\n%s",typeid(Luna< mglBase >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_View(lua_State *L) {
		...
		mglCanvas* self=Luna< mglBase >::checkSubType< mglCanvas >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void mglCanvas::View(double, double, double). Got : '%s'\n%s",typeid(Luna< mglBase >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_Zoom(lua_State *L) {
		...
		mglCanvas* self=Luna< mglBase >::checkSubType< mglCanvas >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void mglCanvas::Zoom(double, double, double, double). Got : '%s'\n%s",typeid(Luna< mglBase >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_Restore(lua_State *L) {
		...
		mglCanvas* self=Luna< mglBase >::checkSubType< mglCanvas >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void mglCanvas::Restore(). Got : '%s'\n%s",typeid(Luna< mglBase >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
		self->Restore();
	...
	static int _bind_Identity(lua_State *L) {
		...
		mglCanvas* self=Luna< mglBase >::checkSubType< mglCanvas >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void mglCanvas::Identity(bool). Got : '%s'\n%s",typeid(Luna< mglBase >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
		self->Identity(rel);
	...
	static int _bind_Push(lua_State *L) {
		...
		mglCanvas* self=Luna< mglBase >::checkSubType< mglCanvas >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void mglCanvas::Push(). Got : '%s'\n%s",typeid(Luna< mglBase >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
		self->Push();
	...
	static int _bind_SetPlotFactor(lua_State *L) {
		...
		mglCanvas* self=Luna< mglBase >::checkSubType< mglCanvas >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void mglCanvas::SetPlotFactor(double). Got : '%s'\n%s",typeid(Luna< mglBase >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_GetPlotFactor(lua_State *L) {
		...
		mglCanvas* self=Luna< mglBase >::checkSubType< mglCanvas >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call double mglCanvas::GetPlotFactor(). Got : '%s'\n%s",typeid(Luna< mglBase >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_Pop(lua_State *L) {
		...
		mglCanvas* self=Luna< mglBase >::checkSubType< mglCanvas >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void mglCanvas::Pop(). Got : '%s'\n%s",typeid(Luna< mglBase >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
		self->Pop();
	...
	static int _bind_Clf(lua_State *L) {
		...
		mglCanvas* self=Luna< mglBase >::checkSubType< mglCanvas >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void mglCanvas::Clf(mglColor). Got : '%s'\n%s",typeid(Luna< mglBase >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
		self->Clf(back);
	...
	static int _bind_StickPlot(lua_State *L) {
		...
		mglCanvas* self=Luna< mglBase >::checkSubType< mglCanvas >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void mglCanvas::StickPlot(int, int, double, double). Got : '%s'\n%s",typeid(Luna< mglBase >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_InPlot_overload_1(lua_State *L) {
		...
		mglCanvas* self=Luna< mglBase >::checkSubType< mglCanvas >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void mglCanvas::InPlot(double, double, double, double, bool). Got : '%s'\n%s",typeid(Luna< mglBase >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_InPlot_overload_2(lua_State *L) {
		...
		mglCanvas* self=Luna< mglBase >::checkSubType< mglCanvas >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void mglCanvas::InPlot(double, double, double, double, const char *). Got : '%s'\n%s",typeid(Luna< mglBase >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_Title(lua_State *L) {
		...
		mglCanvas* self=Luna< mglBase >::checkSubType< mglCanvas >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void mglCanvas::Title(const char *, const char *, double). Got : '%s'\n%s",typeid(Luna< mglBase >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_Aspect(lua_State *L) {
		...
		mglCanvas* self=Luna< mglBase >::checkSubType< mglCanvas >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void mglCanvas::Aspect(double, double, double). Got : '%s'\n%s",typeid(Luna< mglBase >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_Rotate(lua_State *L) {
		...
		mglCanvas* self=Luna< mglBase >::checkSubType< mglCanvas >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void mglCanvas::Rotate(double, double, double). Got : '%s'\n%s",typeid(Luna< mglBase >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_RotateN(lua_State *L) {
		...
		mglCanvas* self=Luna< mglBase >::checkSubType< mglCanvas >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void mglCanvas::RotateN(double, double, double, double). Got : '%s'\n%s",typeid(Luna< mglBase >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_Perspective(lua_State *L) {
		...
		mglCanvas* self=Luna< mglBase >::checkSubType< mglCanvas >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void mglCanvas::Perspective(double). Got : '%s'\n%s",typeid(Luna< mglBase >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
		self->Perspective(a);
	...
	static int _bind_SetSize(lua_State *L) {
		...
		mglCanvas* self=Luna< mglBase >::checkSubType< mglCanvas >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void mglCanvas::SetSize(int, int). Got : '%s'\n%s",typeid(Luna< mglBase >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
		self->SetSize(w, h);
	...
	static int _bind_GetRatio(lua_State *L) {
		...
		mglCanvas* self=Luna< mglBase >::checkSubType< mglCanvas >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call double mglCanvas::GetRatio() const. Got : '%s'\n%s",typeid(Luna< mglBase >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_GetBits(lua_State *L) {
		...
		mglCanvas* self=Luna< mglBase >::checkSubType< mglCanvas >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call const unsigned char * mglCanvas::GetBits(). Got : '%s'\n%s",typeid(Luna< mglBase >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_GetRGBA(lua_State *L) {
		...
		mglCanvas* self=Luna< mglBase >::checkSubType< mglCanvas >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call const unsigned char * mglCanvas::GetRGBA(). Got : '%s'\n%s",typeid(Luna< mglBase >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_GetWidth(lua_State *L) {
		...
		mglCanvas* self=Luna< mglBase >::checkSubType< mglCanvas >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call int mglCanvas::GetWidth() const. Got : '%s'\n%s",typeid(Luna< mglBase >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_GetHeight(lua_State *L) {
		...
		mglCanvas* self=Luna< mglBase >::checkSubType< mglCanvas >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call int mglCanvas::GetHeight() const. Got : '%s'\n%s",typeid(Luna< mglBase >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_Combine(lua_State *L) {
		...
		mglCanvas* self=Luna< mglBase >::checkSubType< mglCanvas >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void mglCanvas::Combine(const mglCanvas *). Got : '%s'\n%s",typeid(Luna< mglBase >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
		self->Combine(gr);
	...
	static int _bind_MPI_Send(lua_State *L) {
		...
		mglCanvas* self=Luna< mglBase >::checkSubType< mglCanvas >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void mglCanvas::MPI_Send(int). Got : '%s'\n%s",typeid(Luna< mglBase >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
		self->MPI_Send(id);
	...
	static int _bind_MPI_Recv(lua_State *L) {
		...
		mglCanvas* self=Luna< mglBase >::checkSubType< mglCanvas >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void mglCanvas::MPI_Recv(int). Got : '%s'\n%s",typeid(Luna< mglBase >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
		self->MPI_Recv(id);
	...
	static int _bind_GetDelay(lua_State *L) {
		...
		mglCanvas* self=Luna< mglBase >::checkSubType< mglCanvas >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call double mglCanvas::GetDelay() const. Got : '%s'\n%s",typeid(Luna< mglBase >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_SetDelay(lua_State *L) {
		...
		mglCanvas* self=Luna< mglBase >::checkSubType< mglCanvas >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void mglCanvas::SetDelay(double). Got : '%s'\n%s",typeid(Luna< mglBase >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
		self->SetDelay(d);
	...
	static int _bind_CalcXYZ(lua_State *L) {
		...
		mglCanvas* self=Luna< mglBase >::checkSubType< mglCanvas >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call mglPoint mglCanvas::CalcXYZ(int, int, bool) const. Got : '%s'\n%s",typeid(Luna< mglBase >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_CalcScr_overload_1(lua_State *L) {
		...
		mglCanvas* self=Luna< mglBase >::checkSubType< mglCanvas >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void mglCanvas::CalcScr(mglPoint, int *, int *) const. Got : '%s'\n%s",typeid(Luna< mglBase >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_CalcScr_overload_2(lua_State *L) {
		...
		mglCanvas* self=Luna< mglBase >::checkSubType< mglCanvas >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call mglPoint mglCanvas::CalcScr(mglPoint) const. Got : '%s'\n%s",typeid(Luna< mglBase >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_SetObjId(lua_State *L) {
		...
		mglCanvas* self=Luna< mglBase >::checkSubType< mglCanvas >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void mglCanvas::SetObjId(long). Got : '%s'\n%s",typeid(Luna< mglBase >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
		self->SetObjId(id);
	...
	static int _bind_GetObjId(lua_State *L) {
		...
		long xs=(long)lua_tonumber(L,2);
		long ys=(long)lua_tonumber(L,3);

		mglCanvas* self=Luna< mglBase >::checkSubType< mglCanvas >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call int mglCanvas::GetObjId(long, long) const. Got : '%s'\n%s",typeid(Luna< mglBase >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_GetSplId(lua_State *L) {
		...
		mglCanvas* self=Luna< mglBase >::checkSubType< mglCanvas >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call int mglCanvas::GetSplId(long, long) const. Got : '%s'\n%s",typeid(Luna< mglBase >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_IsActive(lua_State *L) {
		...
		mglCanvas* self=Luna< mglBase >::checkSubType< mglCanvas >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call int mglCanvas::IsActive(int, int, int &). Got : '%s'\n%s",typeid(Luna< mglBase >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_NewFrame(lua_State *L) {
		...
		mglCanvas* self=Luna< mglBase >::checkSubType< mglCanvas >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call int mglCanvas::NewFrame(). Got : '%s'\n%s",typeid(Luna< mglBase >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_EndFrame(lua_State *L) {
		...
		mglCanvas* self=Luna< mglBase >::checkSubType< mglCanvas >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void mglCanvas::EndFrame(). Got : '%s'\n%s",typeid(Luna< mglBase >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
		self->EndFrame();
	...
	static int _bind_GetNumFrame(lua_State *L) {
		...
		mglCanvas* self=Luna< mglBase >::checkSubType< mglCanvas >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call int mglCanvas::GetNumFrame() const. Got : '%s'\n%s",typeid(Luna< mglBase >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_ResetFrames(lua_State *L) {
		...
		mglCanvas* self=Luna< mglBase >::checkSubType< mglCanvas >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void mglCanvas::ResetFrames(). Got : '%s'\n%s",typeid(Luna< mglBase >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
		self->ResetFrames();
	...
	static int _bind_DelFrame(lua_State *L) {
		...
		mglCanvas* self=Luna< mglBase >::checkSubType< mglCanvas >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void mglCanvas::DelFrame(long). Got : '%s'\n%s",typeid(Luna< mglBase >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
		self->DelFrame(i);
	...
	static int _bind_GetFrame(lua_State *L) {
		...
		mglCanvas* self=Luna< mglBase >::checkSubType< mglCanvas >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void mglCanvas::GetFrame(long). Got : '%s'\n%s",typeid(Luna< mglBase >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
		self->GetFrame(i);
	...
	static int _bind_SetFrame(lua_State *L) {
		...
		mglCanvas* self=Luna< mglBase >::checkSubType< mglCanvas >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void mglCanvas::SetFrame(long). Got : '%s'\n%s",typeid(Luna< mglBase >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
		self->SetFrame(i);
	...
	static int _bind_ShowFrame(lua_State *L) {
		...
		mglCanvas* self=Luna< mglBase >::checkSubType< mglCanvas >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void mglCanvas::ShowFrame(long). Got : '%s'\n%s",typeid(Luna< mglBase >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
		self->ShowFrame(i);
	...
	static int _bind_StartGIF(lua_State *L) {
		...
		mglCanvas* self=Luna< mglBase >::checkSubType< mglCanvas >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void mglCanvas::StartGIF(const char *, int). Got : '%s'\n%s",typeid(Luna< mglBase >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_CloseGIF(lua_State *L) {
		...
		mglCanvas* self=Luna< mglBase >::checkSubType< mglCanvas >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void mglCanvas::CloseGIF(). Got : '%s'\n%s",typeid(Luna< mglBase >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
		self->CloseGIF();
	...
	static int _bind_Finish(lua_State *L) {
		...
		mglCanvas* self=Luna< mglBase >::checkSubType< mglCanvas >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void mglCanvas::Finish(bool). Got : '%s'\n%s",typeid(Luna< mglBase >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
		self->Finish(fast);
	...
	static int _bind_ExportMGLD(lua_State *L) {
		...
		mglCanvas* self=Luna< mglBase >::checkSubType< mglCanvas >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call bool mglCanvas::ExportMGLD(const char *, const char *). Got : '%s'\n%s",typeid(Luna< mglBase >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_ImportMGLD(lua_State *L) {
		...
		mglCanvas* self=Luna< mglBase >::checkSubType< mglCanvas >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call bool mglCanvas::ImportMGLD(const char *, bool). Got : '%s'\n%s",typeid(Luna< mglBase >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_WriteJSON(lua_State *L) {
		...
		mglCanvas* self=Luna< mglBase >::checkSubType< mglCanvas >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call bool mglCanvas::WriteJSON(const char *). Got : '%s'\n%s",typeid(Luna< mglBase >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_SetTranspType(lua_State *L) {
		...
		mglCanvas* self=Luna< mglBase >::checkSubType< mglCanvas >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void mglCanvas::SetTranspType(int). Got : '%s'\n%s",typeid(Luna< mglBase >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_Fog(lua_State *L) {
		...
		mglCanvas* self=Luna< mglBase >::checkSubType< mglCanvas >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void mglCanvas::Fog(double, double). Got : '%s'\n%s",typeid(Luna< mglBase >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
		self->Fog(d, dz);
	...
	static int _bind_Light(lua_State *L) {
		...
		mglCanvas* self=Luna< mglBase >::checkSubType< mglCanvas >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void mglCanvas::Light(int, bool). Got : '%s'\n%s",typeid(Luna< mglBase >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
		self->Light(n, enable);
	...
	static int _bind_AddLight_overload_1(lua_State *L) {
		...
		mglCanvas* self=Luna< mglBase >::checkSubType< mglCanvas >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void mglCanvas::AddLight(int, mglPoint, mglPoint, char, double, double). Got : '%s'\n%s",typeid(Luna< mglBase >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_AddLight_overload_2(lua_State *L) {
		...
		mglCanvas* self=Luna< mglBase >::checkSubType< mglCanvas >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void mglCanvas::AddLight(int, mglPoint, char, double, double). Got : '%s'\n%s",typeid(Luna< mglBase >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_SetTicksVal_overload_1(lua_State *L) {
		...
		mglCanvas* self=Luna< mglBase >::checkSubType< mglCanvas >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void mglCanvas::SetTicksVal(char, const char *, bool). Got : '%s'\n%s",typeid(Luna< mglBase >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_SetTicksVal_overload_2(lua_State *L) {
		...
		mglCanvas* self=Luna< mglBase >::checkSubType< mglCanvas >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void mglCanvas::SetTicksVal(char, const mglDataA *, const char *, bool). Got : '%s'\n%s",typeid(Luna< mglBase >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_SetTickTempl(lua_State *L) {
		...
		mglCanvas* self=Luna< mglBase >::checkSubType< mglCanvas >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void mglCanvas::SetTickTempl(char, const char *). Got : '%s'\n%s",typeid(Luna< mglBase >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_SetTickTime(lua_State *L) {
		...
		mglCanvas* self=Luna< mglBase >::checkSubType< mglCanvas >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void mglCanvas::SetTickTime(char, double, const char *). Got : '%s'\n%s",typeid(Luna< mglBase >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_SetTicks(lua_State *L) {
		...
		mglCanvas* self=Luna< mglBase >::checkSubType< mglCanvas >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void mglCanvas::SetTicks(char, double, int, double). Got : '%s'\n%s",typeid(Luna< mglBase >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_AdjustTicks(lua_State *L) {
		...
		mglCanvas* self=Luna< mglBase >::checkSubType< mglCanvas >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void mglCanvas::AdjustTicks(const char *, bool). Got : '%s'\n%s",typeid(Luna< mglBase >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_SetTuneTicks(lua_State *L) {
		...
		mglCanvas* self=Luna< mglBase >::checkSubType< mglCanvas >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void mglCanvas::SetTuneTicks(int, double). Got : '%s'\n%s",typeid(Luna< mglBase >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_SetAxisStl(lua_State *L) {
		...
		mglCanvas* self=Luna< mglBase >::checkSubType< mglCanvas >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void mglCanvas::SetAxisStl(const char *, const char *, const char *). Got : '%s'\n%s",typeid(Luna< mglBase >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_SetTickLen(lua_State *L) {
		...
		mglCanvas* self=Luna< mglBase >::checkSubType< mglCanvas >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void mglCanvas::SetTickLen(double, double). Got : '%s'\n%s",typeid(Luna< mglBase >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_Box(lua_State *L) {
		...
		mglCanvas* self=Luna< mglBase >::checkSubType< mglCanvas >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void mglCanvas::Box(const char *, bool). Got : '%s'\n%s",typeid(Luna< mglBase >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
		self->Box(col, ticks);
	...
	static int _bind_Axis(lua_State *L) {
		...
		mglCanvas* self=Luna< mglBase >::checkSubType< mglCanvas >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void mglCanvas::Axis(const char *, const char *, const char *). Got : '%s'\n%s",typeid(Luna< mglBase >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_Grid(lua_State *L) {
		...
		mglCanvas* self=Luna< mglBase >::checkSubType< mglCanvas >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void mglCanvas::Grid(const char *, const char *, const char *). Got : '%s'\n%s",typeid(Luna< mglBase >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_Label(lua_State *L) {
		...
		mglCanvas* self=Luna< mglBase >::checkSubType< mglCanvas >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void mglCanvas::Label(char, const char *, double, const char *). Got : '%s'\n%s",typeid(Luna< mglBase >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_Colorbar_overload_1(lua_State *L) {
		...
		mglCanvas* self=Luna< mglBase >::checkSubType< mglCanvas >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void mglCanvas::Colorbar(const char *). Got : '%s'\n%s",typeid(Luna< mglBase >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
		self->Colorbar(sch);
	...
	static int _bind_Colorbar_overload_2(lua_State *L) {
		...
		mglCanvas* self=Luna< mglBase >::checkSubType< mglCanvas >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void mglCanvas::Colorbar(const char *, double, double, double, double). Got : '%s'\n%s",typeid(Luna< mglBase >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_Colorbar_overload_3(lua_State *L) {
		...
		mglCanvas* self=Luna< mglBase >::checkSubType< mglCanvas >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void mglCanvas::Colorbar(const mglDataA *, const char *). Got : '%s'\n%s",typeid(Luna< mglBase >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
		self->Colorbar(v, sch);
	...
	static int _bind_Colorbar_overload_4(lua_State *L) {
		...
		mglCanvas* self=Luna< mglBase >::checkSubType< mglCanvas >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void mglCanvas::Colorbar(const mglDataA *, const char *, double, double, double, double). Got : '%s'\n%s",typeid(Luna< mglBase >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_Legend_overload_1(lua_State *L) {
		...
		mglCanvas* self=Luna< mglBase >::checkSubType< mglCanvas >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void mglCanvas::Legend(double, double, const char *, const char *). Got : '%s'\n%s",typeid(Luna< mglBase >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_Legend_overload_2(lua_State *L) {
		...
		mglCanvas* self=Luna< mglBase >::checkSubType< mglCanvas >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void mglCanvas::Legend(int, const char *, const char *). Got : '%s'\n%s",typeid(Luna< mglBase >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_Legend_overload_3(lua_State *L) {
		...
		mglCanvas* self=Luna< mglBase >::checkSubType< mglCanvas >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void mglCanvas::Legend(const std::vector< mglText > &, int, const char *, const char *). Got : '%s'\n%s",typeid(Luna< mglBase >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_Legend_overload_4(lua_State *L) {
		...
		mglCanvas* self=Luna< mglBase >::checkSubType< mglCanvas >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void mglCanvas::Legend(const std::vector< mglText > &, double, double, const char *, const char *). Got : '%s'\n%s",typeid(Luna< mglBase >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_SetLegendMarks(lua_State *L) {
		...
		mglCanvas* self=Luna< mglBase >::checkSubType< mglCanvas >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void mglCanvas::SetLegendMarks(int). Got : '%s'\n%s",typeid(Luna< mglBase >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_StartAutoGroup(lua_State *L) {
		...
		mglCanvas* self=Luna< mglBase >::checkSubType< mglCanvas >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void mglCanvas::StartAutoGroup(const char *). Got : '%s'\n%s",typeid(Luna< mglBase >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_EndGroup(lua_State *L) {
		...
		mglCanvas* self=Luna< mglBase >::checkSubType< mglCanvas >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void mglCanvas::EndGroup(). Got : '%s'\n%s",typeid(Luna< mglBase >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
		self->EndGroup();
	...
	static int _bind_GetColor(lua_State *L) {
		...
		mglCanvas* self=Luna< mglBase >::checkSubType< mglCanvas >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call mglColor mglCanvas::GetColor(const mglPrim &). Got : '%s'\n%s",typeid(Luna< mglBase >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_SetTickShift(lua_State *L) {
		...
		mglCanvas* self=Luna< mglBase >::checkSubType< mglCanvas >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void mglCanvas::SetTickShift(mglPoint). Got : '%s'\n%s",typeid(Luna< mglBase >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
		self->SetTickShift(p);
	...
	static int _bind_base_SetAmbient(lua_State *L) {
		...
		mglCanvas* self=Luna< mglBase >::checkSubType< mglCanvas >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void mglCanvas::base_SetAmbient(double). Got : '%s'\n%s",typeid(Luna< mglBase >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_Alpha(lua_State *L) {
		...
		mglCanvas* self=Luna< mglBase >::checkSubType< mglCanvas >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call bool mglCanvas::base_Alpha(bool). Got : '%s'\n%s",typeid(Luna< mglBase >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_SetQuality(lua_State *L) {
		...
		mglCanvas* self=Luna< mglBase >::checkSubType< mglCanvas >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void mglCanvas::base_SetQuality(int). Got : '%s'\n%s",typeid(Luna< mglBase >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_Reserve(lua_State *L) {
		...
		mglCanvas* self=Luna< mglBase >::checkSubType< mglCanvas >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void mglCanvas::base_Reserve(long). Got : '%s'\n%s",typeid(Luna< mglBase >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_View(lua_State *L) {
		...
		mglCanvas* self=Luna< mglBase >::checkSubType< mglCanvas >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void mglCanvas::base_View(double, double, double). Got : '%s'\n%s",typeid(Luna< mglBase >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_Zoom(lua_State *L) {
		...
		mglCanvas* self=Luna< mglBase >::checkSubType< mglCanvas >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void mglCanvas::base_Zoom(double, double, double, double). Got : '%s'\n%s",typeid(Luna< mglBase >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_Clf(lua_State *L) {
		...
		mglCanvas* self=Luna< mglBase >::checkSubType< mglCanvas >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void mglCanvas::base_Clf(mglColor). Got : '%s'\n%s",typeid(Luna< mglBase >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_SetSize(lua_State *L) {
		...
		mglCanvas* self=Luna< mglBase >::checkSubType< mglCanvas >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void mglCanvas::base_SetSize(int, int). Got : '%s'\n%s",typeid(Luna< mglBase >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_GetRatio(lua_State *L) {
		...
		mglCanvas* self=Luna< mglBase >::checkSubType< mglCanvas >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call double mglCanvas::base_GetRatio() const. Got : '%s'\n%s",typeid(Luna< mglBase >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_GetBits(lua_State *L) {
		...
		mglCanvas* self=Luna< mglBase >::checkSubType< mglCanvas >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call const unsigned char * mglCanvas::base_GetBits(). Got : '%s'\n%s",typeid(Luna< mglBase >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_GetWidth(lua_State *L) {
		...
		mglCanvas* self=Luna< mglBase >::checkSubType< mglCanvas >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call int mglCanvas::base_GetWidth() const. Got : '%s'\n%s",typeid(Luna< mglBase >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_GetHeight(lua_State *L) {
		...
		mglCanvas* self=Luna< mglBase >::checkSubType< mglCanvas >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call int mglCanvas::base_GetHeight() const. Got : '%s'\n%s",typeid(Luna< mglBase >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_NewFrame(lua_State *L) {
		...
		mglCanvas* self=Luna< mglBase >::checkSubType< mglCanvas >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call int mglCanvas::base_NewFrame(). Got : '%s'\n%s",typeid(Luna< mglBase >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_EndFrame(lua_State *L) {
		...
		mglCanvas* self=Luna< mglBase >::checkSubType< mglCanvas >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void mglCanvas::base_EndFrame(). Got : '%s'\n%s",typeid(Luna< mglBase >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_ResetFrames(lua_State *L) {
		...
		mglCanvas* self=Luna< mglBase >::checkSubType< mglCanvas >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void mglCanvas::base_ResetFrames(). Got : '%s'\n%s",typeid(Luna< mglBase >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_DelFrame(lua_State *L) {
		...
		mglCanvas* self=Luna< mglBase >::checkSubType< mglCanvas >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void mglCanvas::base_DelFrame(long). Got : '%s'\n%s",typeid(Luna< mglBase >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_SetFrame(lua_State *L) {
		...
		mglCanvas* self=Luna< mglBase >::checkSubType< mglCanvas >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void mglCanvas::base_SetFrame(long). Got : '%s'\n%s",typeid(Luna< mglBase >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_Finish(lua_State *L) {
		...
		mglCanvas* self=Luna< mglBase >::checkSubType< mglCanvas >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void mglCanvas::base_Finish(bool). Got : '%s'\n%s",typeid(Luna< mglBase >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_Fog(lua_State *L) {
		...
		mglCanvas* self=Luna< mglBase >::checkSubType< mglCanvas >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void mglCanvas::base_Fog(double, double). Got : '%s'\n%s",typeid(Luna< mglBase >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_Light(lua_State *L) {
		...
		mglCanvas* self=Luna< mglBase >::checkSubType< mglCanvas >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void mglCanvas::base_Light(int, bool). Got : '%s'\n%s",typeid(Luna< mglBase >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_AddLight(lua_State *L) {
		...
		mglCanvas* self=Luna< mglBase >::checkSubType< mglCanvas >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void mglCanvas::base_AddLight(int, mglPoint, mglPoint, char, double, double). Got : '%s'\n%s",typeid(Luna< mglBase >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_StartAutoGroup(lua_State *L) {
		...
		mglCanvas* self=Luna< mglBase >::checkSubType< mglCanvas >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void mglCanvas::base_StartAutoGroup(const char *). Got : '%s'\n%s",typeid(Luna< mglBase >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_EndGroup(lua_State *L) {
		...
		mglCanvas* self=Luna< mglBase >::checkSubType< mglCanvas >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void mglCanvas::base_EndGroup(). Got : '%s'\n%s",typeid(Luna< mglBase >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
