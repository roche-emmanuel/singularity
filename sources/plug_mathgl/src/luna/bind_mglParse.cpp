...
public:
	...
	static int _bind_Self(lua_State *L) {
		...
		mglParse* self=(Luna< mglParse >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call mglParser * mglParse::Self(). Got : '%s'\n%s",typeid(Luna< mglParse >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_Parse(lua_State *L) {
		...
		mglParse* self=(Luna< mglParse >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call int mglParse::Parse(mglGraph *, const char *, int). Got : '%s'\n%s",typeid(Luna< mglParse >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_Execute(lua_State *L) {
		...
		mglParse* self=(Luna< mglParse >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call void mglParse::Execute(mglGraph *, const char *). Got : '%s'\n%s",typeid(Luna< mglParse >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
		self->Execute(gr, str);
	...
	static int _bind_CmdType(lua_State *L) {
		...
		mglParse* self=(Luna< mglParse >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call int mglParse::CmdType(const char *). Got : '%s'\n%s",typeid(Luna< mglParse >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_CmdFormat(lua_State *L) {
		...
		mglParse* self=(Luna< mglParse >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call const char * mglParse::CmdFormat(const char *). Got : '%s'\n%s",typeid(Luna< mglParse >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_CmdDesc(lua_State *L) {
		...
		mglParse* self=(Luna< mglParse >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call const char * mglParse::CmdDesc(const char *). Got : '%s'\n%s",typeid(Luna< mglParse >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_GetCmdName(lua_State *L) {
		...
		mglParse* self=(Luna< mglParse >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call const char * mglParse::GetCmdName(long). Got : '%s'\n%s",typeid(Luna< mglParse >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_GetCmdNum(lua_State *L) {
		...
		mglParse* self=(Luna< mglParse >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call long mglParse::GetCmdNum(). Got : '%s'\n%s",typeid(Luna< mglParse >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_AddParam(lua_State *L) {
		...
		mglParse* self=(Luna< mglParse >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call void mglParse::AddParam(int, const char *). Got : '%s'\n%s",typeid(Luna< mglParse >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_RestoreOnce(lua_State *L) {
		...
		mglParse* self=(Luna< mglParse >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call void mglParse::RestoreOnce(). Got : '%s'\n%s",typeid(Luna< mglParse >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
		self->RestoreOnce();
	...
	static int _bind_AllowSetSize(lua_State *L) {
		...
		mglParse* self=(Luna< mglParse >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call void mglParse::AllowSetSize(bool). Got : '%s'\n%s",typeid(Luna< mglParse >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_AllowFileIO(lua_State *L) {
		...
		mglParse* self=(Luna< mglParse >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call void mglParse::AllowFileIO(bool). Got : '%s'\n%s",typeid(Luna< mglParse >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_Stop(lua_State *L) {
		...
		mglParse* self=(Luna< mglParse >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call void mglParse::Stop(). Got : '%s'\n%s",typeid(Luna< mglParse >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
		self->Stop();
	...
	static int _bind_Calc(lua_State *L) {
		...
		mglParse* self=(Luna< mglParse >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call mglData mglParse::Calc(const char *). Got : '%s'\n%s",typeid(Luna< mglParse >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_AddVar(lua_State *L) {
		...
		mglParse* self=(Luna< mglParse >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call mglVar * mglParse::AddVar(const char *). Got : '%s'\n%s",typeid(Luna< mglParse >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_FindVar(lua_State *L) {
		...
		mglParse* self=(Luna< mglParse >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call mglVar * mglParse::FindVar(const char *). Got : '%s'\n%s",typeid(Luna< mglParse >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_DeleteVar(lua_State *L) {
		...
		mglParse* self=(Luna< mglParse >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call void mglParse::DeleteVar(const char *). Got : '%s'\n%s",typeid(Luna< mglParse >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
		self->DeleteVar(name);
	...
	static int _bind_DeleteAll(lua_State *L) {
		...
		mglParse* self=(Luna< mglParse >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call void mglParse::DeleteAll(). Got : '%s'\n%s",typeid(Luna< mglParse >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
		self->DeleteAll();
