...
#include <W:/Shared/Dev/Projects/singularity/sources/plug_osgDB/include/plug_extensions.h>
...
template<>
class LunaTraits< osgDB::Registry::ReadFunctor > {
public:
    static const char className[];
    static const char fullName[];
    static const char moduleName[];
    ...
    static luna_RegType methods[];
    static luna_RegEnumType enumValues[];
    static osgDB::Registry::ReadFunctor* _bind_ctor(lua_State *L);
    static void _bind_dtor(osgDB::Registry::ReadFunctor* obj);
    typedef osgDB::Registry::ReadFunctor parent_t;
    typedef osgDB::Registry::ReadFunctor base_t;
	static luna_ConverterType converters[];
};
...
template<>
class LunaType< 24569242 > {
public:
    typedef osgDB::Registry::ReadFunctor type;
