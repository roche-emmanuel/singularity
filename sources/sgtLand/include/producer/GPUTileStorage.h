#ifndef _SGTLAND_GPU_TILE_STORAGE_H_
#define _SGTLAND_GPU_TILE_STORAGE_H_
...
public:
    ...
    public:
         ...
         */
		GPUSlot(TileStorage *owner, int index, osg::Texture2DArray* t, int l);
         ...
         */
        //virtual void copyPixels(sgtPtr<FrameBuffer> fb, int x, int y, int w, int h);
     ...
     */
	sgtPtr<osg::Texture2DArray> getTexture(int index);
...
private:
     ...
     */
	std::vector< sgtPtr<osg::Texture2DArray> > textures;
     ...
     */
    //sgtPtr<FrameBuffer> fbo;

    /**
     * Program used to generate mipmaps.
     */
    //sgtPtr<Program> mipmapProg;

    /**
     * Parameters used to generate a mipmap level.
     */
    //sgtPtr<Uniform4i> mipmapParams;
