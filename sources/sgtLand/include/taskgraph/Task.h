 ...
 * @ingroup taskgraph
 */
class SGTLAND_EXPORT Task : public sgt::Object
{
public:
    /**
...
protected:
     ...
     * time statistics of tasks of the same type. LUNA_IGNORED
     */
...
private:
    ...
    static OpenThreads::Mutex mutex; ///< mutex used to synchronize accesses to #statistics
...
public:
     ...
     */
    virtual void taskStateChanged(Task* t, bool done, Task::reason r) = 0;
     ...
     */
    virtual void completionDateChanged(Task* t, unsigned int date) = 0;
};
