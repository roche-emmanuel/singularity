...
im:addPattern("function","SDL_ListModes")
im:addPattern("function","SDL_LoadBMP_RW")
im:addPattern("function","SDL_SaveBMP_RW")
...
local options = {
	...
	locationPrefixes={"W:/Shared/Dev/Projects/singularity/sources/plug_SDL/interface/SDL/"}
