...
template<>
class LunaTraits< SDL_SysWMEvent > {
public:
    static const char className[];
    static const char fullName[];
    static const char moduleName[];
    ...
    static luna_RegType methods[];
    static luna_RegEnumType enumValues[];
    static SDL_SysWMEvent* _bind_ctor(lua_State *L);
    static void _bind_dtor(SDL_SysWMEvent* obj);
    typedef SDL_SysWMEvent parent_t;
    typedef SDL_SysWMEvent base_t;
	static luna_ConverterType converters[];
};
...
template<>
class LunaType< 2590390 > {
public:
    typedef SDL_SysWMEvent type;
