...
/** stupid_name_tag Basic data types */
/*@{*/
typedef enum {
	SDL_FALSE = 0,
	SDL_TRUE  = 1
...
/** stupid_name_tag Make sure the types really have the right sizes */
/*@{*/
...
/** stupid_name_tag Enum Size Check
...
/** stupid_name_tag SDL_ICONV Error Codes
