...
public:
	...
	static int _bind___eq(lua_State *L) {
		if (!_lg_typecheck___eq(L)) {
			luaL_error(L, "luna typecheck failed in __eq function, expected prototype:\n__eq(SDL_EventFilter*). Got arguments:\n%s",luna_dumpStack(L).c_str());
		}

		SDL_EventFilter* rhs =(Luna< SDL_EventFilter >::check(L,2));
	...
	static int _bind_fromVoid(lua_State *L) {
		...
		SDL_EventFilter* self= (SDL_EventFilter*)(Luna< void >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call fromVoid(...)");
		}
		
		Luna< SDL_EventFilter >::push(L,self,false);
		return 1;
	}
	...
	static int _bind_asVoid(lua_State *L) {
		...
		void* self= (void*)(Luna< SDL_EventFilter >::check(L,1));
		if(!self) {
...
luna_RegType LunaTraits< SDL_EventFilter >::methods[] = {
	...
	{"__eq", &luna_wrapper_SDL_EventFilter::_bind___eq},
	{"fromVoid", &luna_wrapper_SDL_EventFilter::_bind_fromVoid},
	{"asVoid", &luna_wrapper_SDL_EventFilter::_bind_asVoid},
	{0,0}
};
