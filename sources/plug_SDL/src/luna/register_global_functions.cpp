...
// Function checkers:
inline static bool _lg_typecheck_joystickGetBall(lua_State *L) {
...
// Function binds:
// int joystickGetBall(SDL_Joystick * joystick, int ball, lua_State * L)
static int _bind_joystickGetBall(lua_State *L) {
	if (!_lg_typecheck_joystickGetBall(L)) {
		luaL_error(L, "luna typecheck failed in int joystickGetBall(SDL_Joystick * joystick, int ball, lua_State * L) function, expected prototype:\nint joystickGetBall(SDL_Joystick * joystick, int ball, lua_State * L)\nClass arguments details:\narg 1 ID = 73977241\n\n%s",luna_dumpStack(L).c_str());
	}

	SDL_Joystick* joystick=(Luna< SDL_Joystick >::check(L,1));
	int ball=(int)lua_tointeger(L,2);

	return ::joystickGetBall(joystick, ball, L);
}
...
static int _bind_SDL_AudioDriverName(lua_State *L) {
	...
	char* namebuf=(char*)Luna< void >::check(L,1);
...
// int SDL_BuildAudioCVT(SDL_AudioCVT * cvt, unsigned short src_format, unsigned char src_channels, int src_rate, unsigned short dst_format, unsigned char dst_channels, int dst_rate)
static int _bind_SDL_BuildAudioCVT(lua_State *L) {
	if (!_lg_typecheck_SDL_BuildAudioCVT(L)) {
		luaL_error(L, "luna typecheck failed in int SDL_BuildAudioCVT(SDL_AudioCVT * cvt, unsigned short src_format, unsigned char src_channels, int src_rate, unsigned short dst_format, unsigned char dst_channels, int dst_rate) function, expected prototype:\nint SDL_BuildAudioCVT(SDL_AudioCVT * cvt, unsigned short src_format, unsigned char src_channels, int src_rate, unsigned short dst_format, unsigned char dst_channels, int dst_rate)\nClass arguments details:\narg 1 ID = 74863825\n\n%s",luna_dumpStack(L).c_str());
	}

	SDL_AudioCVT* cvt=(Luna< SDL_AudioCVT >::check(L,1));
	unsigned short src_format=(unsigned short)lua_tointeger(L,2);
	unsigned char src_channels = (unsigned char)(lua_tointeger(L,3));
	int src_rate=(int)lua_tointeger(L,4);
	unsigned short dst_format=(unsigned short)lua_tointeger(L,5);
...
// static unsigned short SDL_Swap16(unsigned short x)
static int _bind_SDL_Swap16(lua_State *L) {
	if (!_lg_typecheck_SDL_Swap16(L)) {
		luaL_error(L, "luna typecheck failed in static unsigned short SDL_Swap16(unsigned short x) function, expected prototype:\nstatic unsigned short SDL_Swap16(unsigned short x)\nClass arguments details:\n\n%s",luna_dumpStack(L).c_str());
	}

	unsigned short x=(unsigned short)lua_tointeger(L,1);

	unsigned short lret = ::SDL_Swap16(x);
	lua_pushnumber(L,lret);
...
// signed short SDL_JoystickGetAxis(SDL_Joystick * joystick, int axis)
static int _bind_SDL_JoystickGetAxis(lua_State *L) {
	if (!_lg_typecheck_SDL_JoystickGetAxis(L)) {
		luaL_error(L, "luna typecheck failed in signed short SDL_JoystickGetAxis(SDL_Joystick * joystick, int axis) function, expected prototype:\nsigned short SDL_JoystickGetAxis(SDL_Joystick * joystick, int axis)\nClass arguments details:\narg 1 ID = 73977241\n\n%s",luna_dumpStack(L).c_str());
	}

	SDL_Joystick* joystick=(Luna< SDL_Joystick >::check(L,1));
	int axis=(int)lua_tointeger(L,2);

	signed short lret = ::SDL_JoystickGetAxis(joystick, axis);
	lua_pushnumber(L,lret);
...
static int _bind_SDL_JoystickGetBall(lua_State *L) {
	...
	SDL_Joystick* joystick=(Luna< SDL_Joystick >::check(L,1));
	int ball=(int)lua_tointeger(L,2);
	int* dx=(int*)Luna< void >::check(L,3);
	int* dy=(int*)Luna< void >::check(L,4);
...
static int _bind_SDL_GetKeyRepeat(lua_State *L) {
	...
	int* delay=(int*)Luna< void >::check(L,1);
	int* interval=(int*)Luna< void >::check(L,2);
...
static int _bind_SDL_GetKeyState(lua_State *L) {
	...
	int* numkeys=(int*)Luna< void >::check(L,1);
...
static int _bind_SDL_WarpMouse(lua_State *L) {
	if (!_lg_typecheck_SDL_WarpMouse(L)) {
		luaL_error(L, "luna typecheck failed in void SDL_WarpMouse(unsigned short x, unsigned short y) function, expected prototype:\nvoid SDL_WarpMouse(unsigned short x, unsigned short y)\nClass arguments details:\n\n%s",luna_dumpStack(L).c_str());
	}

	unsigned short x=(unsigned short)lua_tointeger(L,1);
	unsigned short y=(unsigned short)lua_tointeger(L,2);
...
static int _bind_SDL_WaitThread(lua_State *L) {
	...
	SDL_Thread* thread=(Luna< SDL_Thread >::check(L,1));
	int* status=(int*)Luna< void >::check(L,2);
...
// void SDL_UpdateRect(SDL_Surface * screen, signed int x, signed int y, unsigned int w, unsigned int h)
static int _bind_SDL_UpdateRect(lua_State *L) {
	if (!_lg_typecheck_SDL_UpdateRect(L)) {
		luaL_error(L, "luna typecheck failed in void SDL_UpdateRect(SDL_Surface * screen, signed int x, signed int y, unsigned int w, unsigned int h) function, expected prototype:\nvoid SDL_UpdateRect(SDL_Surface * screen, signed int x, signed int y, unsigned int w, unsigned int h)\nClass arguments details:\narg 1 ID = 58049030\n\n%s",luna_dumpStack(L).c_str());
	}

	SDL_Surface* screen=(Luna< SDL_Surface >::check(L,1));
	signed int x=(signed int)lua_tointeger(L,2);
	signed int y=(signed int)lua_tointeger(L,3);
...
// int SDL_SetGammaRamp(const unsigned short * red, const unsigned short * green, const unsigned short * blue)
static int _bind_SDL_SetGammaRamp(lua_State *L) {
	if (!_lg_typecheck_SDL_SetGammaRamp(L)) {
		luaL_error(L, "luna typecheck failed in int SDL_SetGammaRamp(const unsigned short * red, const unsigned short * green, const unsigned short * blue) function, expected prototype:\nint SDL_SetGammaRamp(const unsigned short * red, const unsigned short * green, const unsigned short * blue)\nClass arguments details:\n\n%s",luna_dumpStack(L).c_str());
	}

	const unsigned short* red=(const unsigned short*)Luna< void >::check(L,1);
	const unsigned short* green=(const unsigned short*)Luna< void >::check(L,2);
	const unsigned short* blue=(const unsigned short*)Luna< void >::check(L,3);
...
// int SDL_GetGammaRamp(unsigned short * red, unsigned short * green, unsigned short * blue)
static int _bind_SDL_GetGammaRamp(lua_State *L) {
	if (!_lg_typecheck_SDL_GetGammaRamp(L)) {
		luaL_error(L, "luna typecheck failed in int SDL_GetGammaRamp(unsigned short * red, unsigned short * green, unsigned short * blue) function, expected prototype:\nint SDL_GetGammaRamp(unsigned short * red, unsigned short * green, unsigned short * blue)\nClass arguments details:\n\n%s",luna_dumpStack(L).c_str());
	}

	unsigned short* red=(unsigned short*)Luna< void >::check(L,1);
	unsigned short* green=(unsigned short*)Luna< void >::check(L,2);
	unsigned short* blue=(unsigned short*)Luna< void >::check(L,3);
...
void register_global_functions(lua_State* L) {
	...
	lua_pushcfunction(L, _bind_joystickGetBall); lua_setfield(L,-2,"joystickGetBall");
