...
public:
	...
	static int _bind_length(lua_State *L) {
		...
		sgt::vec3i* self=(Luna< sgt::vec3i >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call int sgt::vec3i::length() const. Got : '%s'\n%s",typeid(Luna< sgt::vec3i >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_squaredLength(lua_State *L) {
		...
		sgt::vec3i* self=(Luna< sgt::vec3i >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call int sgt::vec3i::squaredLength() const. Got : '%s'\n%s",typeid(Luna< sgt::vec3i >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_distanceTo(lua_State *L) {
		...
		sgt::vec3i* self=(Luna< sgt::vec3i >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call int sgt::vec3i::distanceTo(const sgt::vec3i &) const. Got : '%s'\n%s",typeid(Luna< sgt::vec3i >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_squaredDistanceTo(lua_State *L) {
		...
		sgt::vec3i* self=(Luna< sgt::vec3i >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call int sgt::vec3i::squaredDistanceTo(const sgt::vec3i &) const. Got : '%s'\n%s",typeid(Luna< sgt::vec3i >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_dot(lua_State *L) {
		...
		sgt::vec3i* self=(Luna< sgt::vec3i >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call int sgt::vec3i::dot(const sgt::vec3i &) const. Got : '%s'\n%s",typeid(Luna< sgt::vec3i >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
		int lret = self->dot(v);
		lua_pushnumber(L,lret);
	...
	static int _bind_normalize_overload_1(lua_State *L) {
		...
		sgt::vec3i* self=(Luna< sgt::vec3i >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call sgt::vec3i sgt::vec3i::normalize() const. Got : '%s'\n%s",typeid(Luna< sgt::vec3i >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_normalize_overload_2(lua_State *L) {
		...
		sgt::vec3i* self=(Luna< sgt::vec3i >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call sgt::vec3i sgt::vec3i::normalize(int) const. Got : '%s'\n%s",typeid(Luna< sgt::vec3i >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_cross(lua_State *L) {
		...
		sgt::vec3i* self=(Luna< sgt::vec3i >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call sgt::vec3i sgt::vec3i::cross(const sgt::vec3i &) const. Got : '%s'\n%s",typeid(Luna< sgt::vec3i >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_xy(lua_State *L) {
		...
		sgt::vec3i* self=(Luna< sgt::vec3i >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call sgt::vec2i sgt::vec3i::xy() const. Got : '%s'\n%s",typeid(Luna< sgt::vec3i >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_getX(lua_State *L) {
		...
		sgt::vec3i* self=(Luna< sgt::vec3i >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call int sgt::vec3i::x(). Got : '%s'\n%s",typeid(Luna< sgt::vec3i >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
		int lret = self->x;
		lua_pushnumber(L,lret);
	...
	static int _bind_getY(lua_State *L) {
		...
		sgt::vec3i* self=(Luna< sgt::vec3i >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call int sgt::vec3i::y(). Got : '%s'\n%s",typeid(Luna< sgt::vec3i >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
		int lret = self->y;
		lua_pushnumber(L,lret);
	...
	static int _bind_getZ(lua_State *L) {
		...
		sgt::vec3i* self=(Luna< sgt::vec3i >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call int sgt::vec3i::z(). Got : '%s'\n%s",typeid(Luna< sgt::vec3i >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
		int lret = self->z;
		lua_pushnumber(L,lret);
	...
	static int _bind_setX(lua_State *L) {
		...
		sgt::vec3i* self=(Luna< sgt::vec3i >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call void sgt::vec3i::x(int). Got : '%s'\n%s",typeid(Luna< sgt::vec3i >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
		self->x = value;
	...
	static int _bind_setY(lua_State *L) {
		...
		sgt::vec3i* self=(Luna< sgt::vec3i >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call void sgt::vec3i::y(int). Got : '%s'\n%s",typeid(Luna< sgt::vec3i >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
		self->y = value;
	...
	static int _bind_setZ(lua_State *L) {
		...
		sgt::vec3i* self=(Luna< sgt::vec3i >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call void sgt::vec3i::z(int). Got : '%s'\n%s",typeid(Luna< sgt::vec3i >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
		self->z = value;
	...
	static int _bind_op_index(lua_State *L) {
		...
		sgt::vec3i* self=(Luna< sgt::vec3i >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call int & sgt::vec3i::operator[](const int). Got : '%s'\n%s",typeid(Luna< sgt::vec3i >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind___eq(lua_State *L) {
		...
		sgt::vec3i* self=(Luna< sgt::vec3i >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call bool sgt::vec3i::operator==(const sgt::vec3i &) const. Got : '%s'\n%s",typeid(Luna< sgt::vec3i >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind___add(lua_State *L) {
		...
		sgt::vec3i* self=(Luna< sgt::vec3i >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call sgt::vec3i sgt::vec3i::operator+(const sgt::vec3i &) const. Got : '%s'\n%s",typeid(Luna< sgt::vec3i >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind___mul_overload_2(lua_State *L) {
		...
		sgt::vec3i* self=(Luna< sgt::vec3i >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call sgt::vec3i sgt::vec3i::operator*(const int) const. Got : '%s'\n%s",typeid(Luna< sgt::vec3i >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind___unm(lua_State *L) {
		...
		sgt::vec3i* self=(Luna< sgt::vec3i >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call sgt::vec3i sgt::vec3i::operator-() const. Got : '%s'\n%s",typeid(Luna< sgt::vec3i >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
