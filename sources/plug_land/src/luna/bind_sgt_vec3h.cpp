...
public:
	...
	static int _bind_length(lua_State *L) {
		...
		sgt::vec3h* self=(Luna< sgt::vec3h >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call sgt::half sgt::vec3h::length() const. Got : '%s'\n%s",typeid(Luna< sgt::vec3h >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_squaredLength(lua_State *L) {
		...
		sgt::vec3h* self=(Luna< sgt::vec3h >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call sgt::half sgt::vec3h::squaredLength() const. Got : '%s'\n%s",typeid(Luna< sgt::vec3h >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	// sgt::half sgt::vec3h::distanceTo(const sgt::vec3h & v) const
	static int _bind_distanceTo(lua_State *L) {
		if (!_lg_typecheck_distanceTo(L)) {
			luaL_error(L, "luna typecheck failed in sgt::half sgt::vec3h::distanceTo(const sgt::vec3h & v) const function, expected prototype:\nsgt::half sgt::vec3h::distanceTo(const sgt::vec3h & v) const\nClass arguments details:\narg 1 ID = 76239304\n\n%s",luna_dumpStack(L).c_str());
		}

		const sgt::vec3h* v_ptr=(Luna< sgt::vec3h >::check(L,2));
		if( !v_ptr ) {
			luaL_error(L, "Dereferencing NULL pointer for arg v in sgt::vec3h::distanceTo function");
		}
		const sgt::vec3h & v=*v_ptr;

		sgt::vec3h* self=(Luna< sgt::vec3h >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call sgt::half sgt::vec3h::distanceTo(const sgt::vec3h &) const. Got : '%s'\n%s",typeid(Luna< sgt::vec3h >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
		sgt::half stack_lret = self->distanceTo(v);
		sgt::half* lret = new sgt::half(stack_lret);
		if(!lret) return 0; // Do not write NULL pointers.
	...
	// sgt::half sgt::vec3h::squaredDistanceTo(const sgt::vec3h & v) const
	static int _bind_squaredDistanceTo(lua_State *L) {
		if (!_lg_typecheck_squaredDistanceTo(L)) {
			luaL_error(L, "luna typecheck failed in sgt::half sgt::vec3h::squaredDistanceTo(const sgt::vec3h & v) const function, expected prototype:\nsgt::half sgt::vec3h::squaredDistanceTo(const sgt::vec3h & v) const\nClass arguments details:\narg 1 ID = 76239304\n\n%s",luna_dumpStack(L).c_str());
		}

		const sgt::vec3h* v_ptr=(Luna< sgt::vec3h >::check(L,2));
		if( !v_ptr ) {
			luaL_error(L, "Dereferencing NULL pointer for arg v in sgt::vec3h::squaredDistanceTo function");
		}
		const sgt::vec3h & v=*v_ptr;

		sgt::vec3h* self=(Luna< sgt::vec3h >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call sgt::half sgt::vec3h::squaredDistanceTo(const sgt::vec3h &) const. Got : '%s'\n%s",typeid(Luna< sgt::vec3h >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
		sgt::half stack_lret = self->squaredDistanceTo(v);
		sgt::half* lret = new sgt::half(stack_lret);
		if(!lret) return 0; // Do not write NULL pointers.
	...
	static int _bind_dot(lua_State *L) {
		...
		sgt::vec3h* self=(Luna< sgt::vec3h >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call sgt::half sgt::vec3h::dot(const sgt::vec3h &) const. Got : '%s'\n%s",typeid(Luna< sgt::vec3h >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_normalize_overload_1(lua_State *L) {
		...
		sgt::vec3h* self=(Luna< sgt::vec3h >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call sgt::vec3h sgt::vec3h::normalize() const. Got : '%s'\n%s",typeid(Luna< sgt::vec3h >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_normalize_overload_2(lua_State *L) {
		...
		sgt::vec3h* self=(Luna< sgt::vec3h >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call sgt::vec3h sgt::vec3h::normalize(sgt::half) const. Got : '%s'\n%s",typeid(Luna< sgt::vec3h >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_cross(lua_State *L) {
		...
		sgt::vec3h* self=(Luna< sgt::vec3h >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call sgt::vec3h sgt::vec3h::cross(const sgt::vec3h &) const. Got : '%s'\n%s",typeid(Luna< sgt::vec3h >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_xy(lua_State *L) {
		...
		sgt::vec3h* self=(Luna< sgt::vec3h >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call sgt::vec2h sgt::vec3h::xy() const. Got : '%s'\n%s",typeid(Luna< sgt::vec3h >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_getX(lua_State *L) {
		...
		sgt::vec3h* self=(Luna< sgt::vec3h >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call sgt::half sgt::vec3h::x(). Got : '%s'\n%s",typeid(Luna< sgt::vec3h >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_getY(lua_State *L) {
		...
		sgt::vec3h* self=(Luna< sgt::vec3h >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call sgt::half sgt::vec3h::y(). Got : '%s'\n%s",typeid(Luna< sgt::vec3h >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_getZ(lua_State *L) {
		...
		sgt::vec3h* self=(Luna< sgt::vec3h >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call sgt::half sgt::vec3h::z(). Got : '%s'\n%s",typeid(Luna< sgt::vec3h >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_setX(lua_State *L) {
		...
		sgt::vec3h* self=(Luna< sgt::vec3h >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call void sgt::vec3h::x(sgt::half). Got : '%s'\n%s",typeid(Luna< sgt::vec3h >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
		self->x = value;
	...
	static int _bind_setY(lua_State *L) {
		...
		sgt::vec3h* self=(Luna< sgt::vec3h >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call void sgt::vec3h::y(sgt::half). Got : '%s'\n%s",typeid(Luna< sgt::vec3h >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
		self->y = value;
	...
	static int _bind_setZ(lua_State *L) {
		...
		sgt::vec3h* self=(Luna< sgt::vec3h >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call void sgt::vec3h::z(sgt::half). Got : '%s'\n%s",typeid(Luna< sgt::vec3h >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
		self->z = value;
	...
	static int _bind_op_index(lua_State *L) {
		...
		sgt::vec3h* self=(Luna< sgt::vec3h >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call sgt::half & sgt::vec3h::operator[](const int). Got : '%s'\n%s",typeid(Luna< sgt::vec3h >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind___eq(lua_State *L) {
		...
		sgt::vec3h* self=(Luna< sgt::vec3h >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call bool sgt::vec3h::operator==(const sgt::vec3h &) const. Got : '%s'\n%s",typeid(Luna< sgt::vec3h >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind___add(lua_State *L) {
		...
		sgt::vec3h* self=(Luna< sgt::vec3h >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call sgt::vec3h sgt::vec3h::operator+(const sgt::vec3h &) const. Got : '%s'\n%s",typeid(Luna< sgt::vec3h >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind___mul_overload_2(lua_State *L) {
		...
		sgt::vec3h* self=(Luna< sgt::vec3h >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call sgt::vec3h sgt::vec3h::operator*(const sgt::half) const. Got : '%s'\n%s",typeid(Luna< sgt::vec3h >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind___unm(lua_State *L) {
		...
		sgt::vec3h* self=(Luna< sgt::vec3h >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call sgt::vec3h sgt::vec3h::operator-() const. Got : '%s'\n%s",typeid(Luna< sgt::vec3h >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
...
luna_RegType LunaTraits< sgt::vec3h >::methods[] = {
	...
	{"distanceTo", &luna_wrapper_sgt_vec3h::_bind_distanceTo},
	{"squaredDistanceTo", &luna_wrapper_sgt_vec3h::_bind_squaredDistanceTo},
