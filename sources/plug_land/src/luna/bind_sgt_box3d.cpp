...
public:
	...
	static int _bind_center(lua_State *L) {
		...
		sgt::box3d* self=(Luna< sgt::box3d >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call sgt::vec3d sgt::box3d::center() const. Got : '%s'\n%s",typeid(Luna< sgt::box3d >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_enlarge_overload_1(lua_State *L) {
		...
		sgt::box3d* self=(Luna< sgt::box3d >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call sgt::box3d sgt::box3d::enlarge(const sgt::vec3d &) const. Got : '%s'\n%s",typeid(Luna< sgt::box3d >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_enlarge_overload_2(lua_State *L) {
		...
		sgt::box3d* self=(Luna< sgt::box3d >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call sgt::box3d sgt::box3d::enlarge(const sgt::box3d &) const. Got : '%s'\n%s",typeid(Luna< sgt::box3d >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_contains(lua_State *L) {
		...
		sgt::box3d* self=(Luna< sgt::box3d >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call bool sgt::box3d::contains(const sgt::vec3d &) const. Got : '%s'\n%s",typeid(Luna< sgt::box3d >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_getXmin(lua_State *L) {
		...
		sgt::box3d* self=(Luna< sgt::box3d >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call double sgt::box3d::xmin(). Got : '%s'\n%s",typeid(Luna< sgt::box3d >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_getXmax(lua_State *L) {
		...
		sgt::box3d* self=(Luna< sgt::box3d >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call double sgt::box3d::xmax(). Got : '%s'\n%s",typeid(Luna< sgt::box3d >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_getYmin(lua_State *L) {
		...
		sgt::box3d* self=(Luna< sgt::box3d >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call double sgt::box3d::ymin(). Got : '%s'\n%s",typeid(Luna< sgt::box3d >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_getYmax(lua_State *L) {
		...
		sgt::box3d* self=(Luna< sgt::box3d >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call double sgt::box3d::ymax(). Got : '%s'\n%s",typeid(Luna< sgt::box3d >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_getZmin(lua_State *L) {
		...
		sgt::box3d* self=(Luna< sgt::box3d >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call double sgt::box3d::zmin(). Got : '%s'\n%s",typeid(Luna< sgt::box3d >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_getZmax(lua_State *L) {
		...
		sgt::box3d* self=(Luna< sgt::box3d >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call double sgt::box3d::zmax(). Got : '%s'\n%s",typeid(Luna< sgt::box3d >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_setXmin(lua_State *L) {
		...
		sgt::box3d* self=(Luna< sgt::box3d >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call void sgt::box3d::xmin(double). Got : '%s'\n%s",typeid(Luna< sgt::box3d >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
		self->xmin = value;
	...
	static int _bind_setXmax(lua_State *L) {
		...
		sgt::box3d* self=(Luna< sgt::box3d >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call void sgt::box3d::xmax(double). Got : '%s'\n%s",typeid(Luna< sgt::box3d >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
		self->xmax = value;
	...
	static int _bind_setYmin(lua_State *L) {
		...
		sgt::box3d* self=(Luna< sgt::box3d >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call void sgt::box3d::ymin(double). Got : '%s'\n%s",typeid(Luna< sgt::box3d >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
		self->ymin = value;
	...
	static int _bind_setYmax(lua_State *L) {
		...
		sgt::box3d* self=(Luna< sgt::box3d >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call void sgt::box3d::ymax(double). Got : '%s'\n%s",typeid(Luna< sgt::box3d >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
		self->ymax = value;
	...
	static int _bind_setZmin(lua_State *L) {
		...
		sgt::box3d* self=(Luna< sgt::box3d >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call void sgt::box3d::zmin(double). Got : '%s'\n%s",typeid(Luna< sgt::box3d >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
		self->zmin = value;
	...
	static int _bind_setZmax(lua_State *L) {
		...
		sgt::box3d* self=(Luna< sgt::box3d >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call void sgt::box3d::zmax(double). Got : '%s'\n%s",typeid(Luna< sgt::box3d >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
		self->zmax = value;
