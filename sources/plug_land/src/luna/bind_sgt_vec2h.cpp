...
public:
	...
	static int _bind_length(lua_State *L) {
		...
		sgt::vec2h* self=(Luna< sgt::vec2h >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call sgt::half sgt::vec2h::length() const. Got : '%s'\n%s",typeid(Luna< sgt::vec2h >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_squaredLength(lua_State *L) {
		...
		sgt::vec2h* self=(Luna< sgt::vec2h >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call sgt::half sgt::vec2h::squaredLength() const. Got : '%s'\n%s",typeid(Luna< sgt::vec2h >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	// sgt::half sgt::vec2h::distanceTo(const sgt::vec2h & v) const
	static int _bind_distanceTo(lua_State *L) {
		if (!_lg_typecheck_distanceTo(L)) {
			luaL_error(L, "luna typecheck failed in sgt::half sgt::vec2h::distanceTo(const sgt::vec2h & v) const function, expected prototype:\nsgt::half sgt::vec2h::distanceTo(const sgt::vec2h & v) const\nClass arguments details:\narg 1 ID = 76239273\n\n%s",luna_dumpStack(L).c_str());
		}

		const sgt::vec2h* v_ptr=(Luna< sgt::vec2h >::check(L,2));
		if( !v_ptr ) {
			luaL_error(L, "Dereferencing NULL pointer for arg v in sgt::vec2h::distanceTo function");
		}
		const sgt::vec2h & v=*v_ptr;

		sgt::vec2h* self=(Luna< sgt::vec2h >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call sgt::half sgt::vec2h::distanceTo(const sgt::vec2h &) const. Got : '%s'\n%s",typeid(Luna< sgt::vec2h >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	// sgt::half sgt::vec2h::squaredDistanceTo(const sgt::vec2h & v) const
	static int _bind_squaredDistanceTo(lua_State *L) {
		if (!_lg_typecheck_squaredDistanceTo(L)) {
			luaL_error(L, "luna typecheck failed in sgt::half sgt::vec2h::squaredDistanceTo(const sgt::vec2h & v) const function, expected prototype:\nsgt::half sgt::vec2h::squaredDistanceTo(const sgt::vec2h & v) const\nClass arguments details:\narg 1 ID = 76239273\n\n%s",luna_dumpStack(L).c_str());
		}

		const sgt::vec2h* v_ptr=(Luna< sgt::vec2h >::check(L,2));
		if( !v_ptr ) {
			luaL_error(L, "Dereferencing NULL pointer for arg v in sgt::vec2h::squaredDistanceTo function");
		}
		const sgt::vec2h & v=*v_ptr;

		sgt::vec2h* self=(Luna< sgt::vec2h >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call sgt::half sgt::vec2h::squaredDistanceTo(const sgt::vec2h &) const. Got : '%s'\n%s",typeid(Luna< sgt::vec2h >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_dot(lua_State *L) {
		...
		sgt::vec2h* self=(Luna< sgt::vec2h >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call sgt::half sgt::vec2h::dot(const sgt::vec2h &) const. Got : '%s'\n%s",typeid(Luna< sgt::vec2h >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_normalize_overload_1(lua_State *L) {
		...
		sgt::vec2h* self=(Luna< sgt::vec2h >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call sgt::vec2h sgt::vec2h::normalize() const. Got : '%s'\n%s",typeid(Luna< sgt::vec2h >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_normalize_overload_2(lua_State *L) {
		...
		sgt::vec2h* self=(Luna< sgt::vec2h >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call sgt::vec2h sgt::vec2h::normalize(sgt::half) const. Got : '%s'\n%s",typeid(Luna< sgt::vec2h >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_getX(lua_State *L) {
		...
		sgt::vec2h* self=(Luna< sgt::vec2h >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call sgt::half sgt::vec2h::x(). Got : '%s'\n%s",typeid(Luna< sgt::vec2h >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_getY(lua_State *L) {
		...
		sgt::vec2h* self=(Luna< sgt::vec2h >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call sgt::half sgt::vec2h::y(). Got : '%s'\n%s",typeid(Luna< sgt::vec2h >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_setX(lua_State *L) {
		...
		sgt::vec2h* self=(Luna< sgt::vec2h >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call void sgt::vec2h::x(sgt::half). Got : '%s'\n%s",typeid(Luna< sgt::vec2h >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
		self->x = value;
	...
	static int _bind_setY(lua_State *L) {
		...
		sgt::vec2h* self=(Luna< sgt::vec2h >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call void sgt::vec2h::y(sgt::half). Got : '%s'\n%s",typeid(Luna< sgt::vec2h >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
		self->y = value;
	...
	static int _bind_op_index(lua_State *L) {
		...
		sgt::vec2h* self=(Luna< sgt::vec2h >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call sgt::half & sgt::vec2h::operator[](const int). Got : '%s'\n%s",typeid(Luna< sgt::vec2h >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind___eq(lua_State *L) {
		...
		sgt::vec2h* self=(Luna< sgt::vec2h >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call bool sgt::vec2h::operator==(const sgt::vec2h &) const. Got : '%s'\n%s",typeid(Luna< sgt::vec2h >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind___add(lua_State *L) {
		...
		sgt::vec2h* self=(Luna< sgt::vec2h >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call sgt::vec2h sgt::vec2h::operator+(const sgt::vec2h &) const. Got : '%s'\n%s",typeid(Luna< sgt::vec2h >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind___mul_overload_2(lua_State *L) {
		...
		sgt::vec2h* self=(Luna< sgt::vec2h >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call sgt::vec2h sgt::vec2h::operator*(const sgt::half) const. Got : '%s'\n%s",typeid(Luna< sgt::vec2h >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind___unm(lua_State *L) {
		...
		sgt::vec2h* self=(Luna< sgt::vec2h >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call sgt::vec2h sgt::vec2h::operator-() const. Got : '%s'\n%s",typeid(Luna< sgt::vec2h >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
...
luna_RegType LunaTraits< sgt::vec2h >::methods[] = {
	...
	{"distanceTo", &luna_wrapper_sgt_vec2h::_bind_distanceTo},
	{"squaredDistanceTo", &luna_wrapper_sgt_vec2h::_bind_squaredDistanceTo},
