...
public:
	...
	static int _bind_center(lua_State *L) {
		...
		if(!self) {
			luna_printStack(L);
			luaL_error(L, "Invalid object in function call sgt::vec2f sgt::box2f::center() const. Got : '%s'",typeid(Luna< sgt::box2f >::check(L,1)).name());
		}
	...
	static int _bind_width(lua_State *L) {
		...
		if(!self) {
			luna_printStack(L);
			luaL_error(L, "Invalid object in function call float sgt::box2f::width() const. Got : '%s'",typeid(Luna< sgt::box2f >::check(L,1)).name());
		}
	...
	static int _bind_height(lua_State *L) {
		...
		if(!self) {
			luna_printStack(L);
			luaL_error(L, "Invalid object in function call float sgt::box2f::height() const. Got : '%s'",typeid(Luna< sgt::box2f >::check(L,1)).name());
		}
	...
	static int _bind_area(lua_State *L) {
		...
		if(!self) {
			luna_printStack(L);
			luaL_error(L, "Invalid object in function call float sgt::box2f::area() const. Got : '%s'",typeid(Luna< sgt::box2f >::check(L,1)).name());
		}
	...
	static int _bind_enlarge_overload_1(lua_State *L) {
		...
		if(!self) {
			luna_printStack(L);
			luaL_error(L, "Invalid object in function call sgt::box2f sgt::box2f::enlarge(float) const. Got : '%s'",typeid(Luna< sgt::box2f >::check(L,1)).name());
		}
	...
	static int _bind_enlarge_overload_2(lua_State *L) {
		...
		if(!self) {
			luna_printStack(L);
			luaL_error(L, "Invalid object in function call sgt::box2f sgt::box2f::enlarge(const sgt::vec2f &) const. Got : '%s'",typeid(Luna< sgt::box2f >::check(L,1)).name());
		}
	...
	static int _bind_enlarge_overload_3(lua_State *L) {
		...
		if(!self) {
			luna_printStack(L);
			luaL_error(L, "Invalid object in function call sgt::box2f sgt::box2f::enlarge(const sgt::box2f &) const. Got : '%s'",typeid(Luna< sgt::box2f >::check(L,1)).name());
		}
	...
	static int _bind_contains_overload_1(lua_State *L) {
		...
		if(!self) {
			luna_printStack(L);
			luaL_error(L, "Invalid object in function call bool sgt::box2f::contains(const sgt::vec2f &) const. Got : '%s'",typeid(Luna< sgt::box2f >::check(L,1)).name());
		}
	...
	static int _bind_contains_overload_2(lua_State *L) {
		...
		if(!self) {
			luna_printStack(L);
			luaL_error(L, "Invalid object in function call bool sgt::box2f::contains(const sgt::box2f &) const. Got : '%s'",typeid(Luna< sgt::box2f >::check(L,1)).name());
		}
	...
	static int _bind_intersects(lua_State *L) {
		...
		if(!self) {
			luna_printStack(L);
			luaL_error(L, "Invalid object in function call bool sgt::box2f::intersects(const sgt::box2f &) const. Got : '%s'",typeid(Luna< sgt::box2f >::check(L,1)).name());
		}
	...
	static int _bind_nearestInnerPoint(lua_State *L) {
		...
		if(!self) {
			luna_printStack(L);
			luaL_error(L, "Invalid object in function call sgt::vec2f sgt::box2f::nearestInnerPoint(sgt::vec2f) const. Got : '%s'",typeid(Luna< sgt::box2f >::check(L,1)).name());
		}
	...
	static int _bind_distanceTo(lua_State *L) {
		...
		if(!self) {
			luna_printStack(L);
			luaL_error(L, "Invalid object in function call float sgt::box2f::distanceTo(sgt::vec2f) const. Got : '%s'",typeid(Luna< sgt::box2f >::check(L,1)).name());
		}
	...
	static int _bind_squaredDistanceTo(lua_State *L) {
		...
		if(!self) {
			luna_printStack(L);
			luaL_error(L, "Invalid object in function call float sgt::box2f::squaredDistanceTo(sgt::vec2f) const. Got : '%s'",typeid(Luna< sgt::box2f >::check(L,1)).name());
		}
	...
	static int _bind_getXmin(lua_State *L) {
		...
		if(!self) {
			luna_printStack(L);
			luaL_error(L, "Invalid object in function call float sgt::box2f::xmin(). Got : '%s'",typeid(Luna< sgt::box2f >::check(L,1)).name());
		}
	...
	static int _bind_getXmax(lua_State *L) {
		...
		if(!self) {
			luna_printStack(L);
			luaL_error(L, "Invalid object in function call float sgt::box2f::xmax(). Got : '%s'",typeid(Luna< sgt::box2f >::check(L,1)).name());
		}
	...
	static int _bind_getYmin(lua_State *L) {
		...
		if(!self) {
			luna_printStack(L);
			luaL_error(L, "Invalid object in function call float sgt::box2f::ymin(). Got : '%s'",typeid(Luna< sgt::box2f >::check(L,1)).name());
		}
	...
	static int _bind_getYmax(lua_State *L) {
		...
		if(!self) {
			luna_printStack(L);
			luaL_error(L, "Invalid object in function call float sgt::box2f::ymax(). Got : '%s'",typeid(Luna< sgt::box2f >::check(L,1)).name());
		}
	...
	static int _bind_setXmin(lua_State *L) {
		...
		if(!self) {
			luna_printStack(L);
			luaL_error(L, "Invalid object in function call void sgt::box2f::xmin(float). Got : '%s'",typeid(Luna< sgt::box2f >::check(L,1)).name());
		}
		self->xmin = value;
	...
	static int _bind_setXmax(lua_State *L) {
		...
		if(!self) {
			luna_printStack(L);
			luaL_error(L, "Invalid object in function call void sgt::box2f::xmax(float). Got : '%s'",typeid(Luna< sgt::box2f >::check(L,1)).name());
		}
		self->xmax = value;
	...
	static int _bind_setYmin(lua_State *L) {
		...
		if(!self) {
			luna_printStack(L);
			luaL_error(L, "Invalid object in function call void sgt::box2f::ymin(float). Got : '%s'",typeid(Luna< sgt::box2f >::check(L,1)).name());
		}
		self->ymin = value;
	...
	static int _bind_setYmax(lua_State *L) {
		...
		if(!self) {
			luna_printStack(L);
			luaL_error(L, "Invalid object in function call void sgt::box2f::ymax(float). Got : '%s'",typeid(Luna< sgt::box2f >::check(L,1)).name());
		}
		self->ymax = value;
	...
	static int _bind___eq(lua_State *L) {
		...
		if(!self) {
			luna_printStack(L);
			luaL_error(L, "Invalid object in function call bool sgt::box2f::operator==(const sgt::box2f &) const. Got : '%s'",typeid(Luna< sgt::box2f >::check(L,1)).name());
		}
