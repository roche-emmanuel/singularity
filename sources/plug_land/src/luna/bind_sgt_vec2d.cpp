...
public:
	...
	static int _bind_length(lua_State *L) {
		...
		sgt::vec2d* self=(Luna< sgt::vec2d >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call double sgt::vec2d::length() const. Got : '%s'\n%s",typeid(Luna< sgt::vec2d >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_squaredLength(lua_State *L) {
		...
		sgt::vec2d* self=(Luna< sgt::vec2d >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call double sgt::vec2d::squaredLength() const. Got : '%s'\n%s",typeid(Luna< sgt::vec2d >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	// double sgt::vec2d::distanceTo(const sgt::vec2d & v) const
	static int _bind_distanceTo(lua_State *L) {
		if (!_lg_typecheck_distanceTo(L)) {
			luaL_error(L, "luna typecheck failed in double sgt::vec2d::distanceTo(const sgt::vec2d & v) const function, expected prototype:\ndouble sgt::vec2d::distanceTo(const sgt::vec2d & v) const\nClass arguments details:\narg 1 ID = 76239269\n\n%s",luna_dumpStack(L).c_str());
		}

		const sgt::vec2d* v_ptr=(Luna< sgt::vec2d >::check(L,2));
		if( !v_ptr ) {
			luaL_error(L, "Dereferencing NULL pointer for arg v in sgt::vec2d::distanceTo function");
		}
		const sgt::vec2d & v=*v_ptr;

		sgt::vec2d* self=(Luna< sgt::vec2d >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call double sgt::vec2d::distanceTo(const sgt::vec2d &) const. Got : '%s'\n%s",typeid(Luna< sgt::vec2d >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	// double sgt::vec2d::squaredDistanceTo(const sgt::vec2d & v) const
	static int _bind_squaredDistanceTo(lua_State *L) {
		if (!_lg_typecheck_squaredDistanceTo(L)) {
			luaL_error(L, "luna typecheck failed in double sgt::vec2d::squaredDistanceTo(const sgt::vec2d & v) const function, expected prototype:\ndouble sgt::vec2d::squaredDistanceTo(const sgt::vec2d & v) const\nClass arguments details:\narg 1 ID = 76239269\n\n%s",luna_dumpStack(L).c_str());
		}

		const sgt::vec2d* v_ptr=(Luna< sgt::vec2d >::check(L,2));
		if( !v_ptr ) {
			luaL_error(L, "Dereferencing NULL pointer for arg v in sgt::vec2d::squaredDistanceTo function");
		}
		const sgt::vec2d & v=*v_ptr;

		sgt::vec2d* self=(Luna< sgt::vec2d >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call double sgt::vec2d::squaredDistanceTo(const sgt::vec2d &) const. Got : '%s'\n%s",typeid(Luna< sgt::vec2d >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_dot(lua_State *L) {
		...
		sgt::vec2d* self=(Luna< sgt::vec2d >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call double sgt::vec2d::dot(const sgt::vec2d &) const. Got : '%s'\n%s",typeid(Luna< sgt::vec2d >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_normalize_overload_1(lua_State *L) {
		...
		sgt::vec2d* self=(Luna< sgt::vec2d >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call sgt::vec2d sgt::vec2d::normalize() const. Got : '%s'\n%s",typeid(Luna< sgt::vec2d >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_normalize_overload_2(lua_State *L) {
		...
		sgt::vec2d* self=(Luna< sgt::vec2d >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call sgt::vec2d sgt::vec2d::normalize(double) const. Got : '%s'\n%s",typeid(Luna< sgt::vec2d >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_getX(lua_State *L) {
		...
		sgt::vec2d* self=(Luna< sgt::vec2d >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call double sgt::vec2d::x(). Got : '%s'\n%s",typeid(Luna< sgt::vec2d >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
		double lret = self->x;
		lua_pushnumber(L,lret);
	...
	static int _bind_getY(lua_State *L) {
		...
		sgt::vec2d* self=(Luna< sgt::vec2d >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call double sgt::vec2d::y(). Got : '%s'\n%s",typeid(Luna< sgt::vec2d >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
		double lret = self->y;
		lua_pushnumber(L,lret);
	...
	static int _bind_setX(lua_State *L) {
		...
		sgt::vec2d* self=(Luna< sgt::vec2d >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call void sgt::vec2d::x(double). Got : '%s'\n%s",typeid(Luna< sgt::vec2d >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
		self->x = value;
	...
	static int _bind_setY(lua_State *L) {
		...
		sgt::vec2d* self=(Luna< sgt::vec2d >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call void sgt::vec2d::y(double). Got : '%s'\n%s",typeid(Luna< sgt::vec2d >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
		self->y = value;
	...
	static int _bind_op_index(lua_State *L) {
		...
		sgt::vec2d* self=(Luna< sgt::vec2d >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call double & sgt::vec2d::operator[](const int). Got : '%s'\n%s",typeid(Luna< sgt::vec2d >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind___eq(lua_State *L) {
		...
		sgt::vec2d* self=(Luna< sgt::vec2d >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call bool sgt::vec2d::operator==(const sgt::vec2d &) const. Got : '%s'\n%s",typeid(Luna< sgt::vec2d >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind___add(lua_State *L) {
		...
		sgt::vec2d* self=(Luna< sgt::vec2d >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call sgt::vec2d sgt::vec2d::operator+(const sgt::vec2d &) const. Got : '%s'\n%s",typeid(Luna< sgt::vec2d >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind___mul_overload_2(lua_State *L) {
		...
		sgt::vec2d* self=(Luna< sgt::vec2d >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call sgt::vec2d sgt::vec2d::operator*(const double) const. Got : '%s'\n%s",typeid(Luna< sgt::vec2d >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind___unm(lua_State *L) {
		...
		sgt::vec2d* self=(Luna< sgt::vec2d >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call sgt::vec2d sgt::vec2d::operator-() const. Got : '%s'\n%s",typeid(Luna< sgt::vec2d >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
...
luna_RegType LunaTraits< sgt::vec2d >::methods[] = {
	...
	{"distanceTo", &luna_wrapper_sgt_vec2d::_bind_distanceTo},
	{"squaredDistanceTo", &luna_wrapper_sgt_vec2d::_bind_squaredDistanceTo},
