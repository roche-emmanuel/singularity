...
public:
	...
	static int _bind_center(lua_State *L) {
		...
		if(!self) {
			luna_printStack(L);
			luaL_error(L, "Invalid object in function call sgt::vec2d sgt::box2d::center() const. Got : '%s'",typeid(Luna< sgt::box2d >::check(L,1)).name());
		}
	...
	static int _bind_width(lua_State *L) {
		...
		if(!self) {
			luna_printStack(L);
			luaL_error(L, "Invalid object in function call double sgt::box2d::width() const. Got : '%s'",typeid(Luna< sgt::box2d >::check(L,1)).name());
		}
	...
	static int _bind_height(lua_State *L) {
		...
		if(!self) {
			luna_printStack(L);
			luaL_error(L, "Invalid object in function call double sgt::box2d::height() const. Got : '%s'",typeid(Luna< sgt::box2d >::check(L,1)).name());
		}
	...
	static int _bind_area(lua_State *L) {
		...
		if(!self) {
			luna_printStack(L);
			luaL_error(L, "Invalid object in function call double sgt::box2d::area() const. Got : '%s'",typeid(Luna< sgt::box2d >::check(L,1)).name());
		}
	...
	static int _bind_enlarge_overload_1(lua_State *L) {
		...
		if(!self) {
			luna_printStack(L);
			luaL_error(L, "Invalid object in function call sgt::box2d sgt::box2d::enlarge(double) const. Got : '%s'",typeid(Luna< sgt::box2d >::check(L,1)).name());
		}
	...
	static int _bind_enlarge_overload_2(lua_State *L) {
		...
		if(!self) {
			luna_printStack(L);
			luaL_error(L, "Invalid object in function call sgt::box2d sgt::box2d::enlarge(const sgt::vec2d &) const. Got : '%s'",typeid(Luna< sgt::box2d >::check(L,1)).name());
		}
	...
	static int _bind_enlarge_overload_3(lua_State *L) {
		...
		if(!self) {
			luna_printStack(L);
			luaL_error(L, "Invalid object in function call sgt::box2d sgt::box2d::enlarge(const sgt::box2d &) const. Got : '%s'",typeid(Luna< sgt::box2d >::check(L,1)).name());
		}
	...
	static int _bind_contains_overload_1(lua_State *L) {
		...
		if(!self) {
			luna_printStack(L);
			luaL_error(L, "Invalid object in function call bool sgt::box2d::contains(const sgt::vec2d &) const. Got : '%s'",typeid(Luna< sgt::box2d >::check(L,1)).name());
		}
	...
	static int _bind_contains_overload_2(lua_State *L) {
		...
		if(!self) {
			luna_printStack(L);
			luaL_error(L, "Invalid object in function call bool sgt::box2d::contains(const sgt::box2d &) const. Got : '%s'",typeid(Luna< sgt::box2d >::check(L,1)).name());
		}
	...
	static int _bind_intersects(lua_State *L) {
		...
		if(!self) {
			luna_printStack(L);
			luaL_error(L, "Invalid object in function call bool sgt::box2d::intersects(const sgt::box2d &) const. Got : '%s'",typeid(Luna< sgt::box2d >::check(L,1)).name());
		}
	...
	static int _bind_nearestInnerPoint(lua_State *L) {
		...
		if(!self) {
			luna_printStack(L);
			luaL_error(L, "Invalid object in function call sgt::vec2d sgt::box2d::nearestInnerPoint(sgt::vec2d) const. Got : '%s'",typeid(Luna< sgt::box2d >::check(L,1)).name());
		}
	...
	static int _bind_distanceTo(lua_State *L) {
		...
		if(!self) {
			luna_printStack(L);
			luaL_error(L, "Invalid object in function call double sgt::box2d::distanceTo(sgt::vec2d) const. Got : '%s'",typeid(Luna< sgt::box2d >::check(L,1)).name());
		}
	...
	static int _bind_squaredDistanceTo(lua_State *L) {
		...
		if(!self) {
			luna_printStack(L);
			luaL_error(L, "Invalid object in function call double sgt::box2d::squaredDistanceTo(sgt::vec2d) const. Got : '%s'",typeid(Luna< sgt::box2d >::check(L,1)).name());
		}
	...
	static int _bind_getXmin(lua_State *L) {
		...
		if(!self) {
			luna_printStack(L);
			luaL_error(L, "Invalid object in function call double sgt::box2d::xmin(). Got : '%s'",typeid(Luna< sgt::box2d >::check(L,1)).name());
		}
	...
	static int _bind_getXmax(lua_State *L) {
		...
		if(!self) {
			luna_printStack(L);
			luaL_error(L, "Invalid object in function call double sgt::box2d::xmax(). Got : '%s'",typeid(Luna< sgt::box2d >::check(L,1)).name());
		}
	...
	static int _bind_getYmin(lua_State *L) {
		...
		if(!self) {
			luna_printStack(L);
			luaL_error(L, "Invalid object in function call double sgt::box2d::ymin(). Got : '%s'",typeid(Luna< sgt::box2d >::check(L,1)).name());
		}
	...
	static int _bind_getYmax(lua_State *L) {
		...
		if(!self) {
			luna_printStack(L);
			luaL_error(L, "Invalid object in function call double sgt::box2d::ymax(). Got : '%s'",typeid(Luna< sgt::box2d >::check(L,1)).name());
		}
	...
	static int _bind_setXmin(lua_State *L) {
		...
		if(!self) {
			luna_printStack(L);
			luaL_error(L, "Invalid object in function call void sgt::box2d::xmin(double). Got : '%s'",typeid(Luna< sgt::box2d >::check(L,1)).name());
		}
		self->xmin = value;
	...
	static int _bind_setXmax(lua_State *L) {
		...
		if(!self) {
			luna_printStack(L);
			luaL_error(L, "Invalid object in function call void sgt::box2d::xmax(double). Got : '%s'",typeid(Luna< sgt::box2d >::check(L,1)).name());
		}
		self->xmax = value;
	...
	static int _bind_setYmin(lua_State *L) {
		...
		if(!self) {
			luna_printStack(L);
			luaL_error(L, "Invalid object in function call void sgt::box2d::ymin(double). Got : '%s'",typeid(Luna< sgt::box2d >::check(L,1)).name());
		}
		self->ymin = value;
	...
	static int _bind_setYmax(lua_State *L) {
		...
		if(!self) {
			luna_printStack(L);
			luaL_error(L, "Invalid object in function call void sgt::box2d::ymax(double). Got : '%s'",typeid(Luna< sgt::box2d >::check(L,1)).name());
		}
		self->ymax = value;
	...
	static int _bind___eq(lua_State *L) {
		...
		if(!self) {
			luna_printStack(L);
			luaL_error(L, "Invalid object in function call bool sgt::box2d::operator==(const sgt::box2d &) const. Got : '%s'",typeid(Luna< sgt::box2d >::check(L,1)).name());
		}
