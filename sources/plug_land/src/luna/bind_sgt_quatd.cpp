...
public:
	...
	static int _bind_inverse(lua_State *L) {
		...
		if(!self) {
			luna_printStack(L);
			luaL_error(L, "Invalid object in function call sgt::quatd sgt::quatd::inverse() const. Got : '%s'",typeid(Luna< sgt::quatd >::check(L,1)).name());
		}
	...
	static int _bind_length(lua_State *L) {
		...
		if(!self) {
			luna_printStack(L);
			luaL_error(L, "Invalid object in function call double sgt::quatd::length() const. Got : '%s'",typeid(Luna< sgt::quatd >::check(L,1)).name());
		}
	...
	static int _bind_normalize(lua_State *L) {
		...
		if(!self) {
			luna_printStack(L);
			luaL_error(L, "Invalid object in function call sgt::quatd sgt::quatd::normalize() const. Got : '%s'",typeid(Luna< sgt::quatd >::check(L,1)).name());
		}
	...
	static int _bind_toMat3(lua_State *L) {
		...
		if(!self) {
			luna_printStack(L);
			luaL_error(L, "Invalid object in function call sgt::mat3d sgt::quatd::toMat3() const. Got : '%s'",typeid(Luna< sgt::quatd >::check(L,1)).name());
		}
	...
	static int _bind_toMat4(lua_State *L) {
		...
		if(!self) {
			luna_printStack(L);
			luaL_error(L, "Invalid object in function call sgt::mat4d sgt::quatd::toMat4() const. Got : '%s'",typeid(Luna< sgt::quatd >::check(L,1)).name());
		}
	...
	static int _bind_getAxis(lua_State *L) {
		...
		if(!self) {
			luna_printStack(L);
			luaL_error(L, "Invalid object in function call sgt::vec3d sgt::quatd::getAxis() const. Got : '%s'",typeid(Luna< sgt::quatd >::check(L,1)).name());
		}
	...
	static int _bind_getAngle(lua_State *L) {
		...
		if(!self) {
			luna_printStack(L);
			luaL_error(L, "Invalid object in function call double sgt::quatd::getAngle() const. Got : '%s'",typeid(Luna< sgt::quatd >::check(L,1)).name());
		}
	...
	static int _bind_getX(lua_State *L) {
		...
		if(!self) {
			luna_printStack(L);
			luaL_error(L, "Invalid object in function call double sgt::quatd::x(). Got : '%s'",typeid(Luna< sgt::quatd >::check(L,1)).name());
		}
		double lret = self->x;
		lua_pushnumber(L,lret);
	...
	static int _bind_getY(lua_State *L) {
		...
		if(!self) {
			luna_printStack(L);
			luaL_error(L, "Invalid object in function call double sgt::quatd::y(). Got : '%s'",typeid(Luna< sgt::quatd >::check(L,1)).name());
		}
		double lret = self->y;
		lua_pushnumber(L,lret);
	...
	static int _bind_getZ(lua_State *L) {
		...
		if(!self) {
			luna_printStack(L);
			luaL_error(L, "Invalid object in function call double sgt::quatd::z(). Got : '%s'",typeid(Luna< sgt::quatd >::check(L,1)).name());
		}
		double lret = self->z;
		lua_pushnumber(L,lret);
	...
	static int _bind_getW(lua_State *L) {
		...
		if(!self) {
			luna_printStack(L);
			luaL_error(L, "Invalid object in function call double sgt::quatd::w(). Got : '%s'",typeid(Luna< sgt::quatd >::check(L,1)).name());
		}
		double lret = self->w;
		lua_pushnumber(L,lret);
	...
	static int _bind_setX(lua_State *L) {
		...
		if(!self) {
			luna_printStack(L);
			luaL_error(L, "Invalid object in function call void sgt::quatd::x(double). Got : '%s'",typeid(Luna< sgt::quatd >::check(L,1)).name());
		}
		self->x = value;
	...
	static int _bind_setY(lua_State *L) {
		...
		if(!self) {
			luna_printStack(L);
			luaL_error(L, "Invalid object in function call void sgt::quatd::y(double). Got : '%s'",typeid(Luna< sgt::quatd >::check(L,1)).name());
		}
		self->y = value;
	...
	static int _bind_setZ(lua_State *L) {
		...
		if(!self) {
			luna_printStack(L);
			luaL_error(L, "Invalid object in function call void sgt::quatd::z(double). Got : '%s'",typeid(Luna< sgt::quatd >::check(L,1)).name());
		}
		self->z = value;
	...
	static int _bind_setW(lua_State *L) {
		...
		if(!self) {
			luna_printStack(L);
			luaL_error(L, "Invalid object in function call void sgt::quatd::w(double). Got : '%s'",typeid(Luna< sgt::quatd >::check(L,1)).name());
		}
		self->w = value;
	...
	static int _bind___mul_overload_1(lua_State *L) {
		...
		if(!self) {
			luna_printStack(L);
			luaL_error(L, "Invalid object in function call sgt::quatd sgt::quatd::operator*(const sgt::quatd &) const. Got : '%s'",typeid(Luna< sgt::quatd >::check(L,1)).name());
		}
	...
	static int _bind___mul_overload_2(lua_State *L) {
		...
		if(!self) {
			luna_printStack(L);
			luaL_error(L, "Invalid object in function call sgt::vec3d sgt::quatd::operator*(const sgt::vec3d &) const. Got : '%s'",typeid(Luna< sgt::quatd >::check(L,1)).name());
		}
