...
public:
	...
	static int _bind_fromVoid(lua_State *L) {
		...
		Luna< Awesomium::WebString >::push(L,self,false);
		return 1;
	}
	...
	inline static bool _lg_typecheck_asVoid(lua_State *L) {
		...
		if( !Luna<void>::has_uniqueid(L,1,13938525) ) return false;
		return true;
	}
...
luna_RegType LunaTraits< Awesomium::WebString >::methods[] = {
	...
	{"fromVoid", &luna_wrapper_Awesomium_WebString::_bind_fromVoid},
	{"asVoid", &luna_wrapper_Awesomium_WebString::_bind_asVoid},
	{0,0}
};
