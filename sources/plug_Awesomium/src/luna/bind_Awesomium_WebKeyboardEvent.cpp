...
public:
	...
	static int _bind_fromVoid(lua_State *L) {
		...
		Luna< Awesomium::WebKeyboardEvent >::push(L,self,false);
		return 1;
	}
...
luna_RegType LunaTraits< Awesomium::WebKeyboardEvent >::methods[] = {
	...
	{"fromVoid", &luna_wrapper_Awesomium_WebKeyboardEvent::_bind_fromVoid},
	{"asVoid", &luna_wrapper_Awesomium_WebKeyboardEvent::_bind_asVoid},
	{0,0}
};
