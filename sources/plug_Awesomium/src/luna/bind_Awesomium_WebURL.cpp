...
public:
	...
	static int _bind_fromVoid(lua_State *L) {
		...
		Awesomium::WebURL* self= (Awesomium::WebURL*)(Luna< void >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call fromVoid(...)");
		}
		
		Luna< Awesomium::WebURL >::push(L,self,false);
		return 1;
	}
	...
	static int _bind_asVoid(lua_State *L) {
		...
		void* self= (void*)(Luna< Awesomium::WebURL >::check(L,1));
		if(!self) {
	...
	static int _bind_IsValid(lua_State *L) {
		...
		Awesomium::WebURL* self=(Luna< Awesomium::WebURL >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call bool Awesomium::WebURL::IsValid() const. Got : '%s'\n%s",typeid(Luna< Awesomium::WebURL >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_IsEmpty(lua_State *L) {
		...
		Awesomium::WebURL* self=(Luna< Awesomium::WebURL >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call bool Awesomium::WebURL::IsEmpty() const. Got : '%s'\n%s",typeid(Luna< Awesomium::WebURL >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_spec(lua_State *L) {
		...
		Awesomium::WebURL* self=(Luna< Awesomium::WebURL >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call Awesomium::WebString Awesomium::WebURL::spec() const. Got : '%s'\n%s",typeid(Luna< Awesomium::WebURL >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_scheme(lua_State *L) {
		...
		Awesomium::WebURL* self=(Luna< Awesomium::WebURL >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call Awesomium::WebString Awesomium::WebURL::scheme() const. Got : '%s'\n%s",typeid(Luna< Awesomium::WebURL >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_username(lua_State *L) {
		...
		Awesomium::WebURL* self=(Luna< Awesomium::WebURL >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call Awesomium::WebString Awesomium::WebURL::username() const. Got : '%s'\n%s",typeid(Luna< Awesomium::WebURL >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_password(lua_State *L) {
		...
		Awesomium::WebURL* self=(Luna< Awesomium::WebURL >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call Awesomium::WebString Awesomium::WebURL::password() const. Got : '%s'\n%s",typeid(Luna< Awesomium::WebURL >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_host(lua_State *L) {
		...
		Awesomium::WebURL* self=(Luna< Awesomium::WebURL >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call Awesomium::WebString Awesomium::WebURL::host() const. Got : '%s'\n%s",typeid(Luna< Awesomium::WebURL >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_port(lua_State *L) {
		...
		Awesomium::WebURL* self=(Luna< Awesomium::WebURL >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call Awesomium::WebString Awesomium::WebURL::port() const. Got : '%s'\n%s",typeid(Luna< Awesomium::WebURL >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_path(lua_State *L) {
		...
		Awesomium::WebURL* self=(Luna< Awesomium::WebURL >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call Awesomium::WebString Awesomium::WebURL::path() const. Got : '%s'\n%s",typeid(Luna< Awesomium::WebURL >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_query(lua_State *L) {
		...
		Awesomium::WebURL* self=(Luna< Awesomium::WebURL >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call Awesomium::WebString Awesomium::WebURL::query() const. Got : '%s'\n%s",typeid(Luna< Awesomium::WebURL >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_anchor(lua_State *L) {
		...
		Awesomium::WebURL* self=(Luna< Awesomium::WebURL >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call Awesomium::WebString Awesomium::WebURL::anchor() const. Got : '%s'\n%s",typeid(Luna< Awesomium::WebURL >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_filename(lua_State *L) {
		...
		Awesomium::WebURL* self=(Luna< Awesomium::WebURL >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call Awesomium::WebString Awesomium::WebURL::filename() const. Got : '%s'\n%s",typeid(Luna< Awesomium::WebURL >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_op_assign(lua_State *L) {
		...
		Awesomium::WebURL* self=(Luna< Awesomium::WebURL >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call Awesomium::WebURL & Awesomium::WebURL::operator=(const Awesomium::WebURL &). Got : '%s'\n%s",typeid(Luna< Awesomium::WebURL >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind___eq(lua_State *L) {
		...
		Awesomium::WebURL* self=(Luna< Awesomium::WebURL >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call bool Awesomium::WebURL::operator==(const Awesomium::WebURL &) const. Got : '%s'\n%s",typeid(Luna< Awesomium::WebURL >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
...
luna_RegType LunaTraits< Awesomium::WebURL >::methods[] = {
	...
	{"fromVoid", &luna_wrapper_Awesomium_WebURL::_bind_fromVoid},
	{"asVoid", &luna_wrapper_Awesomium_WebURL::_bind_asVoid},
	{0,0}
};
