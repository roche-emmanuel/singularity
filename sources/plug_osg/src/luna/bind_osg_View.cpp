...
public:
	...
	static osg::View* _bind_ctor_overload_2(lua_State *L) {
		...
		const osg::View* view_ptr=dynamic_cast< osg::View* >(Luna< osg::Referenced >::check(L,1));
		if( !view_ptr ) {
	...
	static int _bind_cloneType(lua_State *L) {
		...
		osg::View* self=dynamic_cast< osg::View* >(Luna< osg::Referenced >::check(L,1));
		if(!self) {
			luna_printStack(L);
	...
	// osg::Object * osg::View::clone(const osg::CopyOp & ) const
	static int _bind_clone(lua_State *L) {
		if (!_lg_typecheck_clone(L)) {
			luna_printStack(L);
			luaL_error(L, "luna typecheck failed in osg::Object * osg::View::clone(const osg::CopyOp & ) const function, expected prototype:\nosg::Object * osg::View::clone(const osg::CopyOp & ) const\nClass arguments details:\narg 1 ID = 27134364\n");
		}
