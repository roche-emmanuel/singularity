...
public:
	...
	static int _bind_setComputeBoundingBoxCallback(lua_State *L) {
		...
		osg::Drawable::ComputeBoundingBoxCallback* callback=dynamic_cast< osg::Drawable::ComputeBoundingBoxCallback* >(Luna< osg::Referenced >::check(L,2));
	...
	static int _bind_setUpdateCallback(lua_State *L) {
		...
		osg::Drawable::UpdateCallback* ac=dynamic_cast< osg::Drawable::UpdateCallback* >(Luna< osg::Referenced >::check(L,2));
	...
	static int _bind_setEventCallback(lua_State *L) {
		...
		osg::Drawable::EventCallback* ac=dynamic_cast< osg::Drawable::EventCallback* >(Luna< osg::Referenced >::check(L,2));
	...
	static int _bind_setCullCallback(lua_State *L) {
		...
		osg::Drawable::CullCallback* cc=dynamic_cast< osg::Drawable::CullCallback* >(Luna< osg::Referenced >::check(L,2));
	...
	static int _bind_setDrawCallback(lua_State *L) {
		...
		osg::Drawable::DrawCallback* dc=dynamic_cast< osg::Drawable::DrawCallback* >(Luna< osg::Referenced >::check(L,2));
	...
	static int _bind_setExtensions(lua_State *L) {
		...
		unsigned int contextID=(unsigned int)lua_tointeger(L,1);
		osg::Drawable::Extensions* extensions=dynamic_cast< osg::Drawable::Extensions* >(Luna< osg::Referenced >::check(L,2));
