...
public:
	...
	inline static bool _lg_typecheck_ctor_overload_3(lua_State *L) {
		...
		if( !Luna<void>::has_uniqueid(L,1,50169651) ) return false;
		if( (!dynamic_cast< osgDB::ImageOptions* >(Luna< osg::Referenced >::check(L,1))) ) return false;
	...
	inline static bool _lg_typecheck_ctor_overload_6(lua_State *L) {
		...
		if( (!dynamic_cast< osgDB::ImageOptions* >(Luna< osg::Referenced >::check(L,2))) ) return false;
	...
	static osgDB::ImageOptions* _bind_ctor_overload_6(lua_State *L) {
		...
		const osgDB::ImageOptions* options_ptr=dynamic_cast< osgDB::ImageOptions* >(Luna< osg::Referenced >::check(L,2));
		if( !options_ptr ) {
			luaL_error(L, "Dereferencing NULL pointer for arg options in osgDB::ImageOptions::ImageOptions function");
		}
		const osgDB::ImageOptions & options=*options_ptr;
