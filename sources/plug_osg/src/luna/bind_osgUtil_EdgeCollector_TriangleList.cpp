...
public:
	...
	inline static bool _lg_typecheck___eq(lua_State *L) {
		...
		if( !Luna<void>::has_uniqueid(L,1,52419701) ) return false;
		return true;
	}
	...
	static int _bind___eq(lua_State *L) {
		if (!_lg_typecheck___eq(L)) {
			luna_printStack(L);
			luaL_error(L, "luna typecheck failed in __eq function, expected prototype:\n__eq(osgUtil::EdgeCollector::TriangleList*)");
		}

		osgUtil::EdgeCollector::TriangleList* rhs =(Luna< osgUtil::EdgeCollector::TriangleList >::check(L,2));
...
const char LunaTraits< osgUtil::EdgeCollector::TriangleList >::moduleName[] = "osg";
...
luna_RegType LunaTraits< osgUtil::EdgeCollector::TriangleList >::methods[] = {
	...
	{"__eq", &luna_wrapper_osgUtil_EdgeCollector_TriangleList::_bind___eq},
	{0,0}
};
