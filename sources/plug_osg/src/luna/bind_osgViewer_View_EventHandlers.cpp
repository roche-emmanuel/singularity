...
public:
	...
	inline static bool _lg_typecheck___eq(lua_State *L) {
		...
		if( !Luna<void>::has_uniqueid(L,1,62378713) ) return false;
		return true;
	}
	...
	static int _bind___eq(lua_State *L) {
		if (!_lg_typecheck___eq(L)) {
			luna_printStack(L);
			luaL_error(L, "luna typecheck failed in __eq function, expected prototype:\n__eq(osgViewer::View::EventHandlers*)");
		}

		osgViewer::View::EventHandlers* rhs =(Luna< osgViewer::View::EventHandlers >::check(L,2));
...
luna_RegType LunaTraits< osgViewer::View::EventHandlers >::methods[] = {
	...
	{"__eq", &luna_wrapper_osgViewer_View_EventHandlers::_bind___eq},
	{0,0}
};
