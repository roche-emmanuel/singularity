...
public:
	...
	static int _bind_base_setThreadSafeRefUnref(lua_State *L) {
		...
		if(!self) {
			luna_printStack(L);
			luaL_error(L, "Invalid object in function call void osgViewer::LODScaleHandler::base_setThreadSafeRefUnref(bool). Got : '%s'",typeid(Luna< osg::Referenced >::check(L,1)).name());
		}
...
luna_RegType LunaTraits< osgViewer::LODScaleHandler >::methods[] = {
	...
	{"__eq", &luna_wrapper_osgViewer_LODScaleHandler::_bind___eq},
