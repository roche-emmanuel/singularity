...
public:
	...
	inline static bool _lg_typecheck_ctor_overload_3(lua_State *L) {
		...
		if( !Luna<void>::has_uniqueid(L,1,50169651) ) return false;
		if( (!dynamic_cast< osg::ColorMask* >(Luna< osg::Referenced >::check(L,1))) ) return false;
	...
	inline static bool _lg_typecheck_ctor_overload_6(lua_State *L) {
		...
		if( (!dynamic_cast< osg::ColorMask* >(Luna< osg::Referenced >::check(L,2))) ) return false;
	...
	static osg::ColorMask* _bind_ctor_overload_6(lua_State *L) {
		...
		const osg::ColorMask* cm_ptr=dynamic_cast< osg::ColorMask* >(Luna< osg::Referenced >::check(L,2));
		if( !cm_ptr ) {
			luaL_error(L, "Dereferencing NULL pointer for arg cm in osg::ColorMask::ColorMask function");
		}
		const osg::ColorMask & cm=*cm_ptr;
...
luna_RegType LunaTraits< osg::ColorMask >::methods[] = {
	...
	{"__eq", &luna_wrapper_osg_ColorMask::_bind___eq},
	{0,0}
};
