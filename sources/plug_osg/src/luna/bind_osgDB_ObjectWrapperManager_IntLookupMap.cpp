...
public:
	...
	inline static bool _lg_typecheck___eq(lua_State *L) {
		...
		if( !Luna<void>::has_uniqueid(L,1,42677985) ) return false;
		return true;
	}
	...
	static int _bind___eq(lua_State *L) {
		if (!_lg_typecheck___eq(L)) {
			luna_printStack(L);
			luaL_error(L, "luna typecheck failed in __eq function, expected prototype:\n__eq(osgDB::ObjectWrapperManager::IntLookupMap*)");
		}

		osgDB::ObjectWrapperManager::IntLookupMap* rhs =(Luna< osgDB::ObjectWrapperManager::IntLookupMap >::check(L,2));
...
luna_RegType LunaTraits< osgDB::ObjectWrapperManager::IntLookupMap >::methods[] = {
	...
	{"__eq", &luna_wrapper_osgDB_ObjectWrapperManager_IntLookupMap::_bind___eq},
	{0,0}
};
