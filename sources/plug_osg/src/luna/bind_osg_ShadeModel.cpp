...
public:
	...
	static int _bind_fromVoid(lua_State *L) {
		...
		osg::ShadeModel* self= (osg::ShadeModel*)(Luna< void >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call fromVoid(...)");
		}
		
		Luna< osg::ShadeModel >::push(L,self,false);
		return 1;
	}
	...
	static osg::ShadeModel* _bind_ctor_overload_1(lua_State *L) {
		...
		osg::ShadeModel::Mode mode=luatop>0 ? (osg::ShadeModel::Mode)lua_tointeger(L,1) : (osg::ShadeModel::Mode)osg::ShadeModel::SMOOTH;
	...
	static osg::ShadeModel* _bind_ctor_overload_3(lua_State *L) {
		...
		osg::ShadeModel::Mode mode=luatop>1 ? (osg::ShadeModel::Mode)lua_tointeger(L,2) : (osg::ShadeModel::Mode)osg::ShadeModel::SMOOTH;
	...
	static int _bind_cloneType(lua_State *L) {
		...
		if(!self) {
			luaL_error(L, "Invalid object in function call osg::Object * osg::ShadeModel::cloneType() const. Got : '%s'\n%s",typeid(Luna< osg::Referenced >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_clone(lua_State *L) {
		...
		osg::ShadeModel* self=Luna< osg::Referenced >::checkSubType< osg::ShadeModel >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call osg::Object * osg::ShadeModel::clone(const osg::CopyOp &) const. Got : '%s'\n%s",typeid(Luna< osg::Referenced >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_isSameKindAs(lua_State *L) {
		...
		osg::ShadeModel* self=Luna< osg::Referenced >::checkSubType< osg::ShadeModel >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call bool osg::ShadeModel::isSameKindAs(const osg::Object *) const. Got : '%s'\n%s",typeid(Luna< osg::Referenced >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_libraryName(lua_State *L) {
		...
		osg::ShadeModel* self=Luna< osg::Referenced >::checkSubType< osg::ShadeModel >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call const char * osg::ShadeModel::libraryName() const. Got : '%s'\n%s",typeid(Luna< osg::Referenced >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_className(lua_State *L) {
		...
		osg::ShadeModel* self=Luna< osg::Referenced >::checkSubType< osg::ShadeModel >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call const char * osg::ShadeModel::className() const. Got : '%s'\n%s",typeid(Luna< osg::Referenced >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_getType(lua_State *L) {
		...
		osg::ShadeModel* self=Luna< osg::Referenced >::checkSubType< osg::ShadeModel >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call osg::StateAttribute::Type osg::ShadeModel::getType() const. Got : '%s'\n%s",typeid(Luna< osg::Referenced >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_compare(lua_State *L) {
		...
		osg::ShadeModel* self=Luna< osg::Referenced >::checkSubType< osg::ShadeModel >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call int osg::ShadeModel::compare(const osg::StateAttribute &) const. Got : '%s'\n%s",typeid(Luna< osg::Referenced >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_setMode(lua_State *L) {
		...
		osg::ShadeModel* self=Luna< osg::Referenced >::checkSubType< osg::ShadeModel >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void osg::ShadeModel::setMode(osg::ShadeModel::Mode). Got : '%s'\n%s",typeid(Luna< osg::Referenced >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
		self->setMode(mode);
	...
	static int _bind_getMode(lua_State *L) {
		...
		osg::ShadeModel* self=Luna< osg::Referenced >::checkSubType< osg::ShadeModel >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call osg::ShadeModel::Mode osg::ShadeModel::getMode() const. Got : '%s'\n%s",typeid(Luna< osg::Referenced >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_apply(lua_State *L) {
		...
		osg::ShadeModel* self=Luna< osg::Referenced >::checkSubType< osg::ShadeModel >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void osg::ShadeModel::apply(osg::State &) const. Got : '%s'\n%s",typeid(Luna< osg::Referenced >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
		self->apply(_arg1);
	...
	static int _bind_base_setThreadSafeRefUnref(lua_State *L) {
		...
		osg::ShadeModel* self=Luna< osg::Referenced >::checkSubType< osg::ShadeModel >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void osg::ShadeModel::base_setThreadSafeRefUnref(bool). Got : '%s'\n%s",typeid(Luna< osg::Referenced >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_setName(lua_State *L) {
		...
		osg::ShadeModel* self=Luna< osg::Referenced >::checkSubType< osg::ShadeModel >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void osg::ShadeModel::base_setName(const std::string &). Got : '%s'\n%s",typeid(Luna< osg::Referenced >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_computeDataVariance(lua_State *L) {
		...
		osg::ShadeModel* self=Luna< osg::Referenced >::checkSubType< osg::ShadeModel >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void osg::ShadeModel::base_computeDataVariance(). Got : '%s'\n%s",typeid(Luna< osg::Referenced >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_setUserData(lua_State *L) {
		...
		osg::ShadeModel* self=Luna< osg::Referenced >::checkSubType< osg::ShadeModel >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void osg::ShadeModel::base_setUserData(osg::Referenced *). Got : '%s'\n%s",typeid(Luna< osg::Referenced >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_getUserData_overload_1(lua_State *L) {
		...
		osg::ShadeModel* self=Luna< osg::Referenced >::checkSubType< osg::ShadeModel >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call osg::Referenced * osg::ShadeModel::base_getUserData(). Got : '%s'\n%s",typeid(Luna< osg::Referenced >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_getUserData_overload_2(lua_State *L) {
		...
		osg::ShadeModel* self=Luna< osg::Referenced >::checkSubType< osg::ShadeModel >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call const osg::Referenced * osg::ShadeModel::base_getUserData() const. Got : '%s'\n%s",typeid(Luna< osg::Referenced >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_asTexture_overload_1(lua_State *L) {
		...
		osg::ShadeModel* self=Luna< osg::Referenced >::checkSubType< osg::ShadeModel >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call osg::Texture * osg::ShadeModel::base_asTexture(). Got : '%s'\n%s",typeid(Luna< osg::Referenced >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_asTexture_overload_2(lua_State *L) {
		...
		osg::ShadeModel* self=Luna< osg::Referenced >::checkSubType< osg::ShadeModel >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call const osg::Texture * osg::ShadeModel::base_asTexture() const. Got : '%s'\n%s",typeid(Luna< osg::Referenced >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_getMember(lua_State *L) {
		...
		osg::ShadeModel* self=Luna< osg::Referenced >::checkSubType< osg::ShadeModel >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call unsigned int osg::ShadeModel::base_getMember() const. Got : '%s'\n%s",typeid(Luna< osg::Referenced >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_isTextureAttribute(lua_State *L) {
		...
		osg::ShadeModel* self=Luna< osg::Referenced >::checkSubType< osg::ShadeModel >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call bool osg::ShadeModel::base_isTextureAttribute() const. Got : '%s'\n%s",typeid(Luna< osg::Referenced >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_getModeUsage(lua_State *L) {
		...
		osg::ShadeModel* self=Luna< osg::Referenced >::checkSubType< osg::ShadeModel >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call bool osg::ShadeModel::base_getModeUsage(osg::StateAttribute::ModeUsage &) const. Got : '%s'\n%s",typeid(Luna< osg::Referenced >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_checkValidityOfAssociatedModes(lua_State *L) {
		...
		osg::ShadeModel* self=Luna< osg::Referenced >::checkSubType< osg::ShadeModel >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call bool osg::ShadeModel::base_checkValidityOfAssociatedModes(osg::State &) const. Got : '%s'\n%s",typeid(Luna< osg::Referenced >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_compileGLObjects(lua_State *L) {
		...
		osg::ShadeModel* self=Luna< osg::Referenced >::checkSubType< osg::ShadeModel >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void osg::ShadeModel::base_compileGLObjects(osg::State &) const. Got : '%s'\n%s",typeid(Luna< osg::Referenced >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_releaseGLObjects(lua_State *L) {
		...
		osg::ShadeModel* self=Luna< osg::Referenced >::checkSubType< osg::ShadeModel >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void osg::ShadeModel::base_releaseGLObjects(osg::State *) const. Got : '%s'\n%s",typeid(Luna< osg::Referenced >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_cloneType(lua_State *L) {
		...
		osg::ShadeModel* self=Luna< osg::Referenced >::checkSubType< osg::ShadeModel >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call osg::Object * osg::ShadeModel::base_cloneType() const. Got : '%s'\n%s",typeid(Luna< osg::Referenced >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_clone(lua_State *L) {
		...
		osg::ShadeModel* self=Luna< osg::Referenced >::checkSubType< osg::ShadeModel >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call osg::Object * osg::ShadeModel::base_clone(const osg::CopyOp &) const. Got : '%s'\n%s",typeid(Luna< osg::Referenced >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_isSameKindAs(lua_State *L) {
		...
		osg::ShadeModel* self=Luna< osg::Referenced >::checkSubType< osg::ShadeModel >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call bool osg::ShadeModel::base_isSameKindAs(const osg::Object *) const. Got : '%s'\n%s",typeid(Luna< osg::Referenced >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_libraryName(lua_State *L) {
		...
		osg::ShadeModel* self=Luna< osg::Referenced >::checkSubType< osg::ShadeModel >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call const char * osg::ShadeModel::base_libraryName() const. Got : '%s'\n%s",typeid(Luna< osg::Referenced >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_className(lua_State *L) {
		...
		osg::ShadeModel* self=Luna< osg::Referenced >::checkSubType< osg::ShadeModel >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call const char * osg::ShadeModel::base_className() const. Got : '%s'\n%s",typeid(Luna< osg::Referenced >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_getType(lua_State *L) {
		...
		osg::ShadeModel* self=Luna< osg::Referenced >::checkSubType< osg::ShadeModel >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call osg::StateAttribute::Type osg::ShadeModel::base_getType() const. Got : '%s'\n%s",typeid(Luna< osg::Referenced >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_compare(lua_State *L) {
		...
		osg::ShadeModel* self=Luna< osg::Referenced >::checkSubType< osg::ShadeModel >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call int osg::ShadeModel::base_compare(const osg::StateAttribute &) const. Got : '%s'\n%s",typeid(Luna< osg::Referenced >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_apply(lua_State *L) {
		...
		osg::ShadeModel* self=Luna< osg::Referenced >::checkSubType< osg::ShadeModel >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void osg::ShadeModel::base_apply(osg::State &) const. Got : '%s'\n%s",typeid(Luna< osg::Referenced >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
...
luna_RegType LunaTraits< osg::ShadeModel >::methods[] = {
	...
	{"fromVoid", &luna_wrapper_osg_ShadeModel::_bind_fromVoid},
	{"asVoid", &luna_wrapper_osg_ShadeModel::_bind_asVoid},
