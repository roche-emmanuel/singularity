...
public:
	...
	// void osg::DrawElementsUShort::accept(osg::PrimitiveFunctor & functor) const
	static int _bind_accept_overload_1(lua_State *L) {
		if (!_lg_typecheck_accept_overload_1(L)) {
			luna_printStack(L);
			luaL_error(L, "luna typecheck failed in void osg::DrawElementsUShort::accept(osg::PrimitiveFunctor & functor) const function, expected prototype:\nvoid osg::DrawElementsUShort::accept(osg::PrimitiveFunctor & functor) const\nClass arguments details:\narg 1 ID = 8652005\n");
		}

		osg::PrimitiveFunctor* functor_ptr=(Luna< osg::PrimitiveFunctor >::check(L,2));
		if( !functor_ptr ) {
			luaL_error(L, "Dereferencing NULL pointer for arg functor in osg::DrawElementsUShort::accept function");
		}
		...
		if(!self) {
			luna_printStack(L);
			luaL_error(L, "Invalid object in function call void osg::DrawElementsUShort::accept(osg::PrimitiveFunctor &) const");
		}
		self->accept(functor);
	...
	// void osg::DrawElementsUShort::accept(osg::PrimitiveIndexFunctor & functor) const
	static int _bind_accept_overload_2(lua_State *L) {
		if (!_lg_typecheck_accept_overload_2(L)) {
			luna_printStack(L);
			luaL_error(L, "luna typecheck failed in void osg::DrawElementsUShort::accept(osg::PrimitiveIndexFunctor & functor) const function, expected prototype:\nvoid osg::DrawElementsUShort::accept(osg::PrimitiveIndexFunctor & functor) const\nClass arguments details:\narg 1 ID = 22170058\n");
		}
		...
		if(!self) {
			luna_printStack(L);
			luaL_error(L, "Invalid object in function call void osg::DrawElementsUShort::accept(osg::PrimitiveIndexFunctor &) const");
		}
		self->accept(functor);
	...
	// Overload binder for osg::DrawElementsUShort::accept
...
luna_RegType LunaTraits< osg::DrawElementsUShort >::methods[] = {
	...
	{"accept", &luna_wrapper_osg_DrawElementsUShort::_bind_accept},
