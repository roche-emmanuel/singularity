...
public:
	...
	// osg::BoundingSpheref osgParticle::ParticleSystemUpdater::computeBound() const
	static int _bind_computeBound(lua_State *L) {
		if (!_lg_typecheck_computeBound(L)) {
			luna_printStack(L);
			luaL_error(L, "luna typecheck failed in osg::BoundingSpheref osgParticle::ParticleSystemUpdater::computeBound() const function, expected prototype:\nosg::BoundingSpheref osgParticle::ParticleSystemUpdater::computeBound() const\nClass arguments details:\n");
		}
		...
		if(!self) {
			luna_printStack(L);
			luaL_error(L, "Invalid object in function call osg::BoundingSpheref osgParticle::ParticleSystemUpdater::computeBound() const");
		}
