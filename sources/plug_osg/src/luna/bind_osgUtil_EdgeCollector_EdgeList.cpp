...
public:
	...
	inline static bool _lg_typecheck___eq(lua_State *L) {
		...
		if( !Luna<void>::has_uniqueid(L,1,66168244) ) return false;
		return true;
	}
	...
	static int _bind___eq(lua_State *L) {
		if (!_lg_typecheck___eq(L)) {
			luna_printStack(L);
			luaL_error(L, "luna typecheck failed in __eq function, expected prototype:\n__eq(osgUtil::EdgeCollector::EdgeList*)");
		}

		osgUtil::EdgeCollector::EdgeList* rhs =(Luna< osgUtil::EdgeCollector::EdgeList >::check(L,2));
...
const char LunaTraits< osgUtil::EdgeCollector::EdgeList >::moduleName[] = "osg";
...
luna_RegType LunaTraits< osgUtil::EdgeCollector::EdgeList >::methods[] = {
	...
	{"__eq", &luna_wrapper_osgUtil_EdgeCollector_EdgeList::_bind___eq},
	{0,0}
};
