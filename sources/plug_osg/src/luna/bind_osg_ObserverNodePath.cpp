...
public:
	...
	inline static bool _lg_typecheck_ctor_overload_2(lua_State *L) {
		...
		if( !Luna<void>::has_uniqueid(L,1,5626651) ) return false;
		if( (!dynamic_cast< osg::ObserverNodePath* >(Luna< osg::ObserverNodePath >::check(L,1))) ) return false;
		return true;
	}
	...
	inline static bool _lg_typecheck_ctor_overload_3(lua_State *L) {
		...
		if( (!dynamic_cast< osg::NodePath* >(Luna< osg::NodePath >::check(L,1))) ) return false;
		return true;
	}
	...
	inline static bool _lg_typecheck_setNodePath_overload_1(lua_State *L) {
		...
		if( (!dynamic_cast< osg::RefNodePath* >(Luna< osg::RefNodePath >::check(L,2))) ) return false;
		return true;
	}
