...
public:
	...
	static int _bind_getWrapperMap_overload_1(lua_State *L) {
		...
		if(!self) {
			luna_printStack(L);
			luaL_error(L, "Invalid object in function call osgDB::ObjectWrapperManager::WrapperMap & osgDB::ObjectWrapperManager::getWrapperMap()");
		}
	...
	static int _bind_getWrapperMap_overload_2(lua_State *L) {
		...
		if(!self) {
			luna_printStack(L);
			luaL_error(L, "Invalid object in function call const osgDB::ObjectWrapperManager::WrapperMap & osgDB::ObjectWrapperManager::getWrapperMap() const");
		}
		const osgDB::ObjectWrapperManager::WrapperMap* lret = &self->getWrapperMap();
		if(!lret) return 0; // Do not write NULL pointers.
	...
	static int _bind_getCompressorMap_overload_1(lua_State *L) {
		...
		if(!self) {
			luna_printStack(L);
			luaL_error(L, "Invalid object in function call osgDB::ObjectWrapperManager::CompressorMap & osgDB::ObjectWrapperManager::getCompressorMap()");
		}
	...
	static int _bind_getCompressorMap_overload_2(lua_State *L) {
		...
		if(!self) {
			luna_printStack(L);
			luaL_error(L, "Invalid object in function call const osgDB::ObjectWrapperManager::CompressorMap & osgDB::ObjectWrapperManager::getCompressorMap() const");
		}
		const osgDB::ObjectWrapperManager::CompressorMap* lret = &self->getCompressorMap();
		if(!lret) return 0; // Do not write NULL pointers.
