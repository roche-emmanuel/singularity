...
public:
	...
	inline static bool _lg_typecheck___eq(lua_State *L) {
		...
		if( !Luna<void>::has_uniqueid(L,1,95636375) ) return false;
		return true;
	}
	...
	static int _bind___eq(lua_State *L) {
		if (!_lg_typecheck___eq(L)) {
			luna_printStack(L);
			luaL_error(L, "luna typecheck failed in __eq function, expected prototype:\n__eq(osgUtil::IncrementalCompileOperation::CompileList::CompileOps*)");
		}

		osgUtil::IncrementalCompileOperation::CompileList::CompileOps* rhs =(Luna< osgUtil::IncrementalCompileOperation::CompileList::CompileOps >::check(L,2));
...
const char LunaTraits< osgUtil::IncrementalCompileOperation::CompileList::CompileOps >::moduleName[] = "osg";
...
luna_RegType LunaTraits< osgUtil::IncrementalCompileOperation::CompileList::CompileOps >::methods[] = {
	...
	{"__eq", &luna_wrapper_osgUtil_IncrementalCompileOperation_CompileList_CompileOps::_bind___eq},
	{0,0}
};
