...
public:
	...
	inline static bool _lg_typecheck_setPrimitiveSetList(lua_State *L) {
		if( lua_gettop(L)!=2 ) return false;

		if( !Luna<void>::has_uniqueid(L,2,23074168) ) return false;
		return true;
	}

	inline static bool _lg_typecheck_getPrimitiveSetList_overload_1(lua_State *L) {
		if( lua_gettop(L)!=1 ) return false;

		return true;
	}

	inline static bool _lg_typecheck_getPrimitiveSetList_overload_2(lua_State *L) {
		if( lua_gettop(L)!=1 ) return false;
	...
	static osg::Geometry* _bind_ctor_overload_2(lua_State *L) {
		...
		const osg::Geometry* geometry_ptr=dynamic_cast< osg::Geometry* >(Luna< osg::Referenced >::check(L,1));
		if( !geometry_ptr ) {
	...
	static int _bind_cloneType(lua_State *L) {
		...
		osg::Geometry* self=dynamic_cast< osg::Geometry* >(Luna< osg::Referenced >::check(L,1));
		if(!self) {
			luna_printStack(L);
	...
	// osg::Object * osg::Geometry::clone(const osg::CopyOp & ) const
	static int _bind_clone(lua_State *L) {
		if (!_lg_typecheck_clone(L)) {
			luna_printStack(L);
			luaL_error(L, "luna typecheck failed in osg::Object * osg::Geometry::clone(const osg::CopyOp & ) const function, expected prototype:\nosg::Object * osg::Geometry::clone(const osg::CopyOp & ) const\nClass arguments details:\narg 1 ID = 27134364\n");
		}
	...
	// void osg::Geometry::setTexCoordArray(unsigned int unit, osg::Array * )
	static int _bind_setTexCoordArray(lua_State *L) {
		if (!_lg_typecheck_setTexCoordArray(L)) {
			luna_printStack(L);
			luaL_error(L, "luna typecheck failed in void osg::Geometry::setTexCoordArray(unsigned int unit, osg::Array * ) function, expected prototype:\nvoid osg::Geometry::setTexCoordArray(unsigned int unit, osg::Array * )\nClass arguments details:\narg 2 ID = 50169651\n");
		}

		unsigned int unit=(unsigned int)lua_tointeger(L,2);
		osg::Array* _arg2=dynamic_cast< osg::Array* >(Luna< osg::Referenced >::check(L,3));
	...
	// void osg::Geometry::setPrimitiveSetList(const osg::Geometry::PrimitiveSetList & primitives)
	static int _bind_setPrimitiveSetList(lua_State *L) {
		if (!_lg_typecheck_setPrimitiveSetList(L)) {
			luna_printStack(L);
			luaL_error(L, "luna typecheck failed in void osg::Geometry::setPrimitiveSetList(const osg::Geometry::PrimitiveSetList & primitives) function, expected prototype:\nvoid osg::Geometry::setPrimitiveSetList(const osg::Geometry::PrimitiveSetList & primitives)\nClass arguments details:\narg 1 ID = 23074168\n");
		}

		const osg::Geometry::PrimitiveSetList* primitives_ptr=(Luna< osg::Geometry::PrimitiveSetList >::check(L,2));
		if( !primitives_ptr ) {
			luaL_error(L, "Dereferencing NULL pointer for arg primitives in osg::Geometry::setPrimitiveSetList function");
		}
		const osg::Geometry::PrimitiveSetList & primitives=*primitives_ptr;

		osg::Geometry* self=dynamic_cast< osg::Geometry* >(Luna< osg::Referenced >::check(L,1));
		if(!self) {
			luna_printStack(L);
			luaL_error(L, "Invalid object in function call void osg::Geometry::setPrimitiveSetList(const osg::Geometry::PrimitiveSetList &)");
		}
		self->setPrimitiveSetList(primitives);

		return 0;
	}

	// osg::Geometry::PrimitiveSetList & osg::Geometry::getPrimitiveSetList()
	static int _bind_getPrimitiveSetList_overload_1(lua_State *L) {
		if (!_lg_typecheck_getPrimitiveSetList_overload_1(L)) {
			luna_printStack(L);
			luaL_error(L, "luna typecheck failed in osg::Geometry::PrimitiveSetList & osg::Geometry::getPrimitiveSetList() function, expected prototype:\nosg::Geometry::PrimitiveSetList & osg::Geometry::getPrimitiveSetList()\nClass arguments details:\n");
		}
		...
		if(!self) {
			luna_printStack(L);
			luaL_error(L, "Invalid object in function call osg::Geometry::PrimitiveSetList & osg::Geometry::getPrimitiveSetList()");
		}
		const osg::Geometry::PrimitiveSetList* lret = &self->getPrimitiveSetList();
		if(!lret) return 0; // Do not write NULL pointers.

		Luna< osg::Geometry::PrimitiveSetList >::push(L,lret,false);

		return 1;
	}

	// const osg::Geometry::PrimitiveSetList & osg::Geometry::getPrimitiveSetList() const
	static int _bind_getPrimitiveSetList_overload_2(lua_State *L) {
		if (!_lg_typecheck_getPrimitiveSetList_overload_2(L)) {
			luna_printStack(L);
			luaL_error(L, "luna typecheck failed in const osg::Geometry::PrimitiveSetList & osg::Geometry::getPrimitiveSetList() const function, expected prototype:\nconst osg::Geometry::PrimitiveSetList & osg::Geometry::getPrimitiveSetList() const\nClass arguments details:\n");
		}
		...
		if(!self) {
			luna_printStack(L);
			luaL_error(L, "Invalid object in function call const osg::Geometry::PrimitiveSetList & osg::Geometry::getPrimitiveSetList() const");
		}
		const osg::Geometry::PrimitiveSetList* lret = &self->getPrimitiveSetList();
		if(!lret) return 0; // Do not write NULL pointers.
	...
	// Overload binder for osg::Geometry::getPrimitiveSetList
	static int _bind_getPrimitiveSetList(lua_State *L) {
		if (_lg_typecheck_getPrimitiveSetList_overload_1(L)) return _bind_getPrimitiveSetList_overload_1(L);
		if (_lg_typecheck_getPrimitiveSetList_overload_2(L)) return _bind_getPrimitiveSetList_overload_2(L);

		luaL_error(L, "error in function getPrimitiveSetList, cannot match any of the overloads for function getPrimitiveSetList:\n  getPrimitiveSetList()\n  getPrimitiveSetList()\n");
		return 0;
	}
	...
	static int _bind_addPrimitiveSet(lua_State *L) {
		...
		osg::PrimitiveSet* primitiveset=dynamic_cast< osg::PrimitiveSet* >(Luna< osg::Referenced >::check(L,2));
	...
	static int _bind_setPrimitiveSet(lua_State *L) {
		...
		osg::PrimitiveSet* primitiveset=dynamic_cast< osg::PrimitiveSet* >(Luna< osg::Referenced >::check(L,3));
	...
	static int _bind_getPrimitiveSetIndex(lua_State *L) {
		...
		const osg::PrimitiveSet* primitiveset=dynamic_cast< osg::PrimitiveSet* >(Luna< osg::Referenced >::check(L,2));
	...
	static int _bind_setVertexIndices(lua_State *L) {
		...
		osg::IndexArray* array=dynamic_cast< osg::IndexArray* >(Luna< osg::Referenced >::check(L,2));
	...
	// void osg::Geometry::setTexCoordIndices(unsigned int unit, osg::IndexArray * )
	static int _bind_setTexCoordIndices(lua_State *L) {
		if (!_lg_typecheck_setTexCoordIndices(L)) {
			luna_printStack(L);
			luaL_error(L, "luna typecheck failed in void osg::Geometry::setTexCoordIndices(unsigned int unit, osg::IndexArray * ) function, expected prototype:\nvoid osg::Geometry::setTexCoordIndices(unsigned int unit, osg::IndexArray * )\nClass arguments details:\narg 2 ID = 50169651\n");
		}

		unsigned int unit=(unsigned int)lua_tointeger(L,2);
		osg::IndexArray* _arg2=dynamic_cast< osg::IndexArray* >(Luna< osg::Referenced >::check(L,3));
	...
	static int _bind_setVertexAttribIndices(lua_State *L) {
		...
		unsigned int index=(unsigned int)lua_tointeger(L,2);
		osg::IndexArray* array=dynamic_cast< osg::IndexArray* >(Luna< osg::Referenced >::check(L,3));
	...
	static int _bind_copyToAndOptimize(lua_State *L) {
		...
		osg::Geometry* target_ptr=dynamic_cast< osg::Geometry* >(Luna< osg::Referenced >::check(L,2));
		if( !target_ptr ) {
	...
	// bool osg::Geometry::supports(const osg::Drawable::AttributeFunctor & ) const
	static int _bind_supports_overload_1(lua_State *L) {
		if (!_lg_typecheck_supports_overload_1(L)) {
			luna_printStack(L);
			luaL_error(L, "luna typecheck failed in bool osg::Geometry::supports(const osg::Drawable::AttributeFunctor & ) const function, expected prototype:\nbool osg::Geometry::supports(const osg::Drawable::AttributeFunctor & ) const\nClass arguments details:\narg 1 ID = 20397010\n");
		}

		const osg::Drawable::AttributeFunctor* _arg1_ptr=(Luna< osg::Drawable::AttributeFunctor >::check(L,2));
		if( !_arg1_ptr ) {
			luaL_error(L, "Dereferencing NULL pointer for arg _arg1 in osg::Geometry::supports function");
		}
		...
		if(!self) {
			luna_printStack(L);
			luaL_error(L, "Invalid object in function call bool osg::Geometry::supports(const osg::Drawable::AttributeFunctor &) const");
		}
	...
	// bool osg::Geometry::supports(const osg::Drawable::ConstAttributeFunctor & ) const
	static int _bind_supports_overload_2(lua_State *L) {
		if (!_lg_typecheck_supports_overload_2(L)) {
			luna_printStack(L);
			luaL_error(L, "luna typecheck failed in bool osg::Geometry::supports(const osg::Drawable::ConstAttributeFunctor & ) const function, expected prototype:\nbool osg::Geometry::supports(const osg::Drawable::ConstAttributeFunctor & ) const\nClass arguments details:\narg 1 ID = 68991165\n");
		}
		...
		if(!self) {
			luna_printStack(L);
			luaL_error(L, "Invalid object in function call bool osg::Geometry::supports(const osg::Drawable::ConstAttributeFunctor &) const");
		}
		bool lret = self->supports(_arg1);
		lua_pushboolean(L,lret?1:0);
	...
	// bool osg::Geometry::supports(const osg::PrimitiveFunctor & ) const
	static int _bind_supports_overload_3(lua_State *L) {
		if (!_lg_typecheck_supports_overload_3(L)) {
			luna_printStack(L);
			luaL_error(L, "luna typecheck failed in bool osg::Geometry::supports(const osg::PrimitiveFunctor & ) const function, expected prototype:\nbool osg::Geometry::supports(const osg::PrimitiveFunctor & ) const\nClass arguments details:\narg 1 ID = 8652005\n");
		}
		...
		if(!self) {
			luna_printStack(L);
			luaL_error(L, "Invalid object in function call bool osg::Geometry::supports(const osg::PrimitiveFunctor &) const");
		}
		bool lret = self->supports(_arg1);
		lua_pushboolean(L,lret?1:0);
	...
	// bool osg::Geometry::supports(const osg::PrimitiveIndexFunctor & ) const
	static int _bind_supports_overload_4(lua_State *L) {
		if (!_lg_typecheck_supports_overload_4(L)) {
			luna_printStack(L);
			luaL_error(L, "luna typecheck failed in bool osg::Geometry::supports(const osg::PrimitiveIndexFunctor & ) const function, expected prototype:\nbool osg::Geometry::supports(const osg::PrimitiveIndexFunctor & ) const\nClass arguments details:\narg 1 ID = 22170058\n");
		}
		...
		if(!self) {
			luna_printStack(L);
			luaL_error(L, "Invalid object in function call bool osg::Geometry::supports(const osg::PrimitiveIndexFunctor &) const");
		}
		bool lret = self->supports(_arg1);
		lua_pushboolean(L,lret?1:0);
	...
	// Overload binder for osg::Geometry::supports
	...
	// void osg::Geometry::accept(osg::Drawable::AttributeFunctor & af)
	static int _bind_accept_overload_1(lua_State *L) {
		if (!_lg_typecheck_accept_overload_1(L)) {
			luna_printStack(L);
			luaL_error(L, "luna typecheck failed in void osg::Geometry::accept(osg::Drawable::AttributeFunctor & af) function, expected prototype:\nvoid osg::Geometry::accept(osg::Drawable::AttributeFunctor & af)\nClass arguments details:\narg 1 ID = 20397010\n");
		}

		osg::Drawable::AttributeFunctor* af_ptr=(Luna< osg::Drawable::AttributeFunctor >::check(L,2));
		if( !af_ptr ) {
			luaL_error(L, "Dereferencing NULL pointer for arg af in osg::Geometry::accept function");
		}
		osg::Drawable::AttributeFunctor & af=*af_ptr;

		osg::Geometry* self=dynamic_cast< osg::Geometry* >(Luna< osg::Referenced >::check(L,1));
		if(!self) {
			luna_printStack(L);
			luaL_error(L, "Invalid object in function call void osg::Geometry::accept(osg::Drawable::AttributeFunctor &)");
		}
		self->accept(af);
	...
	// void osg::Geometry::accept(osg::Drawable::ConstAttributeFunctor & af) const
	static int _bind_accept_overload_2(lua_State *L) {
		if (!_lg_typecheck_accept_overload_2(L)) {
			luna_printStack(L);
			luaL_error(L, "luna typecheck failed in void osg::Geometry::accept(osg::Drawable::ConstAttributeFunctor & af) const function, expected prototype:\nvoid osg::Geometry::accept(osg::Drawable::ConstAttributeFunctor & af) const\nClass arguments details:\narg 1 ID = 68991165\n");
		}
		...
		if(!self) {
			luna_printStack(L);
			luaL_error(L, "Invalid object in function call void osg::Geometry::accept(osg::Drawable::ConstAttributeFunctor &) const");
		}
		self->accept(af);
	...
	// void osg::Geometry::accept(osg::PrimitiveFunctor & pf) const
	static int _bind_accept_overload_3(lua_State *L) {
		if (!_lg_typecheck_accept_overload_3(L)) {
			luna_printStack(L);
			luaL_error(L, "luna typecheck failed in void osg::Geometry::accept(osg::PrimitiveFunctor & pf) const function, expected prototype:\nvoid osg::Geometry::accept(osg::PrimitiveFunctor & pf) const\nClass arguments details:\narg 1 ID = 8652005\n");
		}

		osg::PrimitiveFunctor* pf_ptr=(Luna< osg::PrimitiveFunctor >::check(L,2));
		if( !pf_ptr ) {
			luaL_error(L, "Dereferencing NULL pointer for arg pf in osg::Geometry::accept function");
		}
		...
		if(!self) {
			luna_printStack(L);
			luaL_error(L, "Invalid object in function call void osg::Geometry::accept(osg::PrimitiveFunctor &) const");
		}
		self->accept(pf);
	...
	// void osg::Geometry::accept(osg::PrimitiveIndexFunctor & pf) const
	static int _bind_accept_overload_4(lua_State *L) {
		if (!_lg_typecheck_accept_overload_4(L)) {
			luna_printStack(L);
			luaL_error(L, "luna typecheck failed in void osg::Geometry::accept(osg::PrimitiveIndexFunctor & pf) const function, expected prototype:\nvoid osg::Geometry::accept(osg::PrimitiveIndexFunctor & pf) const\nClass arguments details:\narg 1 ID = 22170058\n");
		}

		osg::PrimitiveIndexFunctor* pf_ptr=(Luna< osg::PrimitiveIndexFunctor >::check(L,2));
		if( !pf_ptr ) {
			luaL_error(L, "Dereferencing NULL pointer for arg pf in osg::Geometry::accept function");
		}
		osg::PrimitiveIndexFunctor & pf=*pf_ptr;

		osg::Geometry* self=dynamic_cast< osg::Geometry* >(Luna< osg::Referenced >::check(L,1));
		if(!self) {
			luna_printStack(L);
			luaL_error(L, "Invalid object in function call void osg::Geometry::accept(osg::PrimitiveIndexFunctor &) const");
		}
		self->accept(pf);
	...
	// Overload binder for osg::Geometry::accept
...
luna_RegType LunaTraits< osg::Geometry >::methods[] = {
	...
	{"setPrimitiveSetList", &luna_wrapper_osg_Geometry::_bind_setPrimitiveSetList},
	{"getPrimitiveSetList", &luna_wrapper_osg_Geometry::_bind_getPrimitiveSetList},
	...
	{"supports", &luna_wrapper_osg_Geometry::_bind_supports},
	{"accept", &luna_wrapper_osg_Geometry::_bind_accept},
	{0,0}
};
