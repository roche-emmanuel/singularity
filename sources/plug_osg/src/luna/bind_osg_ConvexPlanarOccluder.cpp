...
public:
	...
	inline static bool _lg_typecheck_ctor_overload_2(lua_State *L) {
		...
		if( !Luna<void>::has_uniqueid(L,1,50169651) ) return false;
		if( (!dynamic_cast< osg::ConvexPlanarOccluder* >(Luna< osg::Referenced >::check(L,1))) ) return false;
	...
	static osg::ConvexPlanarOccluder* _bind_ctor_overload_2(lua_State *L) {
		...
		const osg::ConvexPlanarOccluder* cpo_ptr=dynamic_cast< osg::ConvexPlanarOccluder* >(Luna< osg::Referenced >::check(L,1));
		if( !cpo_ptr ) {
	...
	static int _bind_cloneType(lua_State *L) {
		...
		osg::ConvexPlanarOccluder* self=dynamic_cast< osg::ConvexPlanarOccluder* >(Luna< osg::Referenced >::check(L,1));
		if(!self) {
			luna_printStack(L);
	...
	// osg::Object * osg::ConvexPlanarOccluder::clone(const osg::CopyOp & ) const
	static int _bind_clone(lua_State *L) {
		if (!_lg_typecheck_clone(L)) {
			luna_printStack(L);
			luaL_error(L, "luna typecheck failed in osg::Object * osg::ConvexPlanarOccluder::clone(const osg::CopyOp & ) const function, expected prototype:\nosg::Object * osg::ConvexPlanarOccluder::clone(const osg::CopyOp & ) const\nClass arguments details:\narg 1 ID = 27134364\n");
		}
...
luna_RegType LunaTraits< osg::ConvexPlanarOccluder >::methods[] = {
	...
	{"__eq", &luna_wrapper_osg_ConvexPlanarOccluder::_bind___eq},
	{0,0}
};
