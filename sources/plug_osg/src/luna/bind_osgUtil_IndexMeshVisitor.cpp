...
public:
	...
	static int _bind_fromVoid(lua_State *L) {
		...
		osgUtil::IndexMeshVisitor* self= (osgUtil::IndexMeshVisitor*)(Luna< void >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call fromVoid(...)");
		}
		
		Luna< osgUtil::IndexMeshVisitor >::push(L,self,false);
		return 1;
	}
...
luna_RegType LunaTraits< osgUtil::IndexMeshVisitor >::methods[] = {
	...
	{"fromVoid", &luna_wrapper_osgUtil_IndexMeshVisitor::_bind_fromVoid},
	{"asVoid", &luna_wrapper_osgUtil_IndexMeshVisitor::_bind_asVoid},
