...
public:
	...
	static int _bind_isSameKindAs(lua_State *L) {
		...
		osg::Array* self=dynamic_cast< osg::Array* >(Luna< osg::Referenced >::check(L,1));
		if(!self) {
			luna_printStack(L);
	...
	static int _bind_setVertexBufferObject(lua_State *L) {
		...
		osg::VertexBufferObject* vbo=dynamic_cast< osg::VertexBufferObject* >(Luna< osg::Referenced >::check(L,2));
