...
public:
	...
	static int _bind_cloneType(lua_State *L) {
		...
		if(!self) {
			luaL_error(L, "Invalid object in function call osg::Object * osgParticle::FireEffect::cloneType() const. Got : '%s'\n%s",typeid(Luna< osg::Referenced >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_clone(lua_State *L) {
		...
		osgParticle::FireEffect* self=Luna< osg::Referenced >::checkSubType< osgParticle::FireEffect >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call osg::Object * osgParticle::FireEffect::clone(const osg::CopyOp &) const. Got : '%s'\n%s",typeid(Luna< osg::Referenced >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_isSameKindAs(lua_State *L) {
		...
		osgParticle::FireEffect* self=Luna< osg::Referenced >::checkSubType< osgParticle::FireEffect >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call bool osgParticle::FireEffect::isSameKindAs(const osg::Object *) const. Got : '%s'\n%s",typeid(Luna< osg::Referenced >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_className(lua_State *L) {
		...
		osgParticle::FireEffect* self=Luna< osg::Referenced >::checkSubType< osgParticle::FireEffect >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call const char * osgParticle::FireEffect::className() const. Got : '%s'\n%s",typeid(Luna< osg::Referenced >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_libraryName(lua_State *L) {
		...
		osgParticle::FireEffect* self=Luna< osg::Referenced >::checkSubType< osgParticle::FireEffect >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call const char * osgParticle::FireEffect::libraryName() const. Got : '%s'\n%s",typeid(Luna< osg::Referenced >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_accept(lua_State *L) {
		...
		osgParticle::FireEffect* self=Luna< osg::Referenced >::checkSubType< osgParticle::FireEffect >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void osgParticle::FireEffect::accept(osg::NodeVisitor &). Got : '%s'\n%s",typeid(Luna< osg::Referenced >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
		self->accept(nv);
	...
	static int _bind_setDefaults(lua_State *L) {
		...
		osgParticle::FireEffect* self=Luna< osg::Referenced >::checkSubType< osgParticle::FireEffect >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void osgParticle::FireEffect::setDefaults(). Got : '%s'\n%s",typeid(Luna< osg::Referenced >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
		self->setDefaults();
	...
	static int _bind_setUpEmitterAndProgram(lua_State *L) {
		...
		osgParticle::FireEffect* self=Luna< osg::Referenced >::checkSubType< osgParticle::FireEffect >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void osgParticle::FireEffect::setUpEmitterAndProgram(). Got : '%s'\n%s",typeid(Luna< osg::Referenced >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_getEmitter_overload_1(lua_State *L) {
		...
		osgParticle::FireEffect* self=Luna< osg::Referenced >::checkSubType< osgParticle::FireEffect >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call osgParticle::Emitter * osgParticle::FireEffect::getEmitter(). Got : '%s'\n%s",typeid(Luna< osg::Referenced >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_getEmitter_overload_2(lua_State *L) {
		...
		osgParticle::FireEffect* self=Luna< osg::Referenced >::checkSubType< osgParticle::FireEffect >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call const osgParticle::Emitter * osgParticle::FireEffect::getEmitter() const. Got : '%s'\n%s",typeid(Luna< osg::Referenced >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_getProgram_overload_1(lua_State *L) {
		...
		osgParticle::FireEffect* self=Luna< osg::Referenced >::checkSubType< osgParticle::FireEffect >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call osgParticle::Program * osgParticle::FireEffect::getProgram(). Got : '%s'\n%s",typeid(Luna< osg::Referenced >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_getProgram_overload_2(lua_State *L) {
		...
		osgParticle::FireEffect* self=Luna< osg::Referenced >::checkSubType< osgParticle::FireEffect >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call const osgParticle::Program * osgParticle::FireEffect::getProgram() const. Got : '%s'\n%s",typeid(Luna< osg::Referenced >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_setName(lua_State *L) {
		...
		osgParticle::FireEffect* self=Luna< osg::Referenced >::checkSubType< osgParticle::FireEffect >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void osgParticle::FireEffect::base_setName(const std::string &). Got : '%s'\n%s",typeid(Luna< osg::Referenced >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_computeDataVariance(lua_State *L) {
		...
		osgParticle::FireEffect* self=Luna< osg::Referenced >::checkSubType< osgParticle::FireEffect >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void osgParticle::FireEffect::base_computeDataVariance(). Got : '%s'\n%s",typeid(Luna< osg::Referenced >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_setUserData(lua_State *L) {
		...
		osgParticle::FireEffect* self=Luna< osg::Referenced >::checkSubType< osgParticle::FireEffect >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void osgParticle::FireEffect::base_setUserData(osg::Referenced *). Got : '%s'\n%s",typeid(Luna< osg::Referenced >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_getUserData_overload_1(lua_State *L) {
		...
		osgParticle::FireEffect* self=Luna< osg::Referenced >::checkSubType< osgParticle::FireEffect >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call osg::Referenced * osgParticle::FireEffect::base_getUserData(). Got : '%s'\n%s",typeid(Luna< osg::Referenced >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_getUserData_overload_2(lua_State *L) {
		...
		osgParticle::FireEffect* self=Luna< osg::Referenced >::checkSubType< osgParticle::FireEffect >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call const osg::Referenced * osgParticle::FireEffect::base_getUserData() const. Got : '%s'\n%s",typeid(Luna< osg::Referenced >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_asTransform_overload_1(lua_State *L) {
		...
		osgParticle::FireEffect* self=Luna< osg::Referenced >::checkSubType< osgParticle::FireEffect >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call osg::Transform * osgParticle::FireEffect::base_asTransform(). Got : '%s'\n%s",typeid(Luna< osg::Referenced >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_asTransform_overload_2(lua_State *L) {
		...
		osgParticle::FireEffect* self=Luna< osg::Referenced >::checkSubType< osgParticle::FireEffect >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call const osg::Transform * osgParticle::FireEffect::base_asTransform() const. Got : '%s'\n%s",typeid(Luna< osg::Referenced >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_asCamera_overload_1(lua_State *L) {
		...
		osgParticle::FireEffect* self=Luna< osg::Referenced >::checkSubType< osgParticle::FireEffect >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call osg::Camera * osgParticle::FireEffect::base_asCamera(). Got : '%s'\n%s",typeid(Luna< osg::Referenced >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_asCamera_overload_2(lua_State *L) {
		...
		osgParticle::FireEffect* self=Luna< osg::Referenced >::checkSubType< osgParticle::FireEffect >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call const osg::Camera * osgParticle::FireEffect::base_asCamera() const. Got : '%s'\n%s",typeid(Luna< osg::Referenced >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_asSwitch_overload_1(lua_State *L) {
		...
		osgParticle::FireEffect* self=Luna< osg::Referenced >::checkSubType< osgParticle::FireEffect >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call osg::Switch * osgParticle::FireEffect::base_asSwitch(). Got : '%s'\n%s",typeid(Luna< osg::Referenced >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_asSwitch_overload_2(lua_State *L) {
		...
		osgParticle::FireEffect* self=Luna< osg::Referenced >::checkSubType< osgParticle::FireEffect >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call const osg::Switch * osgParticle::FireEffect::base_asSwitch() const. Got : '%s'\n%s",typeid(Luna< osg::Referenced >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_asGeode_overload_1(lua_State *L) {
		...
		osgParticle::FireEffect* self=Luna< osg::Referenced >::checkSubType< osgParticle::FireEffect >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call osg::Geode * osgParticle::FireEffect::base_asGeode(). Got : '%s'\n%s",typeid(Luna< osg::Referenced >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_asGeode_overload_2(lua_State *L) {
		...
		osgParticle::FireEffect* self=Luna< osg::Referenced >::checkSubType< osgParticle::FireEffect >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call const osg::Geode * osgParticle::FireEffect::base_asGeode() const. Got : '%s'\n%s",typeid(Luna< osg::Referenced >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_ascend(lua_State *L) {
		...
		osgParticle::FireEffect* self=Luna< osg::Referenced >::checkSubType< osgParticle::FireEffect >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void osgParticle::FireEffect::base_ascend(osg::NodeVisitor &). Got : '%s'\n%s",typeid(Luna< osg::Referenced >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_asGroup_overload_1(lua_State *L) {
		...
		osgParticle::FireEffect* self=Luna< osg::Referenced >::checkSubType< osgParticle::FireEffect >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call osg::Group * osgParticle::FireEffect::base_asGroup(). Got : '%s'\n%s",typeid(Luna< osg::Referenced >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_asGroup_overload_2(lua_State *L) {
		...
		osgParticle::FireEffect* self=Luna< osg::Referenced >::checkSubType< osgParticle::FireEffect >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call const osg::Group * osgParticle::FireEffect::base_asGroup() const. Got : '%s'\n%s",typeid(Luna< osg::Referenced >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_traverse(lua_State *L) {
		...
		osgParticle::FireEffect* self=Luna< osg::Referenced >::checkSubType< osgParticle::FireEffect >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void osgParticle::FireEffect::base_traverse(osg::NodeVisitor &). Got : '%s'\n%s",typeid(Luna< osg::Referenced >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_addChild(lua_State *L) {
		...
		osgParticle::FireEffect* self=Luna< osg::Referenced >::checkSubType< osgParticle::FireEffect >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call bool osgParticle::FireEffect::base_addChild(osg::Node *). Got : '%s'\n%s",typeid(Luna< osg::Referenced >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_insertChild(lua_State *L) {
		...
		osgParticle::FireEffect* self=Luna< osg::Referenced >::checkSubType< osgParticle::FireEffect >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call bool osgParticle::FireEffect::base_insertChild(unsigned int, osg::Node *). Got : '%s'\n%s",typeid(Luna< osg::Referenced >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_removeChildren(lua_State *L) {
		...
		osgParticle::FireEffect* self=Luna< osg::Referenced >::checkSubType< osgParticle::FireEffect >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call bool osgParticle::FireEffect::base_removeChildren(unsigned int, unsigned int). Got : '%s'\n%s",typeid(Luna< osg::Referenced >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_replaceChild(lua_State *L) {
		...
		osgParticle::FireEffect* self=Luna< osg::Referenced >::checkSubType< osgParticle::FireEffect >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call bool osgParticle::FireEffect::base_replaceChild(osg::Node *, osg::Node *). Got : '%s'\n%s",typeid(Luna< osg::Referenced >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_setChild(lua_State *L) {
		...
		osgParticle::FireEffect* self=Luna< osg::Referenced >::checkSubType< osgParticle::FireEffect >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call bool osgParticle::FireEffect::base_setChild(unsigned int, osg::Node *). Got : '%s'\n%s",typeid(Luna< osg::Referenced >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_setThreadSafeRefUnref(lua_State *L) {
		...
		osgParticle::FireEffect* self=Luna< osg::Referenced >::checkSubType< osgParticle::FireEffect >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void osgParticle::FireEffect::base_setThreadSafeRefUnref(bool). Got : '%s'\n%s",typeid(Luna< osg::Referenced >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_releaseGLObjects(lua_State *L) {
		...
		osgParticle::FireEffect* self=Luna< osg::Referenced >::checkSubType< osgParticle::FireEffect >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void osgParticle::FireEffect::base_releaseGLObjects(osg::State *) const. Got : '%s'\n%s",typeid(Luna< osg::Referenced >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_computeBound(lua_State *L) {
		...
		osgParticle::FireEffect* self=Luna< osg::Referenced >::checkSubType< osgParticle::FireEffect >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call osg::BoundingSphered osgParticle::FireEffect::base_computeBound() const. Got : '%s'\n%s",typeid(Luna< osg::Referenced >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_buildEffect(lua_State *L) {
		...
		osgParticle::FireEffect* self=Luna< osg::Referenced >::checkSubType< osgParticle::FireEffect >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void osgParticle::FireEffect::base_buildEffect(). Got : '%s'\n%s",typeid(Luna< osg::Referenced >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_cloneType(lua_State *L) {
		...
		osgParticle::FireEffect* self=Luna< osg::Referenced >::checkSubType< osgParticle::FireEffect >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call osg::Object * osgParticle::FireEffect::base_cloneType() const. Got : '%s'\n%s",typeid(Luna< osg::Referenced >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_clone(lua_State *L) {
		...
		osgParticle::FireEffect* self=Luna< osg::Referenced >::checkSubType< osgParticle::FireEffect >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call osg::Object * osgParticle::FireEffect::base_clone(const osg::CopyOp &) const. Got : '%s'\n%s",typeid(Luna< osg::Referenced >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_isSameKindAs(lua_State *L) {
		...
		osgParticle::FireEffect* self=Luna< osg::Referenced >::checkSubType< osgParticle::FireEffect >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call bool osgParticle::FireEffect::base_isSameKindAs(const osg::Object *) const. Got : '%s'\n%s",typeid(Luna< osg::Referenced >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_className(lua_State *L) {
		...
		osgParticle::FireEffect* self=Luna< osg::Referenced >::checkSubType< osgParticle::FireEffect >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call const char * osgParticle::FireEffect::base_className() const. Got : '%s'\n%s",typeid(Luna< osg::Referenced >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_libraryName(lua_State *L) {
		...
		osgParticle::FireEffect* self=Luna< osg::Referenced >::checkSubType< osgParticle::FireEffect >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call const char * osgParticle::FireEffect::base_libraryName() const. Got : '%s'\n%s",typeid(Luna< osg::Referenced >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_accept(lua_State *L) {
		...
		osgParticle::FireEffect* self=Luna< osg::Referenced >::checkSubType< osgParticle::FireEffect >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void osgParticle::FireEffect::base_accept(osg::NodeVisitor &). Got : '%s'\n%s",typeid(Luna< osg::Referenced >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_setDefaults(lua_State *L) {
		...
		osgParticle::FireEffect* self=Luna< osg::Referenced >::checkSubType< osgParticle::FireEffect >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void osgParticle::FireEffect::base_setDefaults(). Got : '%s'\n%s",typeid(Luna< osg::Referenced >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_setUpEmitterAndProgram(lua_State *L) {
		...
		osgParticle::FireEffect* self=Luna< osg::Referenced >::checkSubType< osgParticle::FireEffect >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void osgParticle::FireEffect::base_setUpEmitterAndProgram(). Got : '%s'\n%s",typeid(Luna< osg::Referenced >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_getEmitter_overload_1(lua_State *L) {
		...
		osgParticle::FireEffect* self=Luna< osg::Referenced >::checkSubType< osgParticle::FireEffect >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call osgParticle::Emitter * osgParticle::FireEffect::base_getEmitter(). Got : '%s'\n%s",typeid(Luna< osg::Referenced >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_getEmitter_overload_2(lua_State *L) {
		...
		osgParticle::FireEffect* self=Luna< osg::Referenced >::checkSubType< osgParticle::FireEffect >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call const osgParticle::Emitter * osgParticle::FireEffect::base_getEmitter() const. Got : '%s'\n%s",typeid(Luna< osg::Referenced >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_getProgram_overload_1(lua_State *L) {
		...
		osgParticle::FireEffect* self=Luna< osg::Referenced >::checkSubType< osgParticle::FireEffect >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call osgParticle::Program * osgParticle::FireEffect::base_getProgram(). Got : '%s'\n%s",typeid(Luna< osg::Referenced >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_getProgram_overload_2(lua_State *L) {
		...
		osgParticle::FireEffect* self=Luna< osg::Referenced >::checkSubType< osgParticle::FireEffect >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call const osgParticle::Program * osgParticle::FireEffect::base_getProgram() const. Got : '%s'\n%s",typeid(Luna< osg::Referenced >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
