...
public:
	...
	static int _bind_getTable(lua_State *L) {
		...
		luna_wrapper_base* wrapper = luna_caster<osg::ConstValueVisitor,luna_wrapper_base>::cast(self); //dynamic_cast<luna_wrapper_base*>(self);
		if(wrapper) {
	...
	static int _bind_fromVoid(lua_State *L) {
		...
		Luna< osg::ConstValueVisitor >::push(L,self,false);
		return 1;
	}
	...
	static int _bind_base_apply_overload_9(lua_State *L) {
		...
		const osg::Vec4ub* _arg1_ptr=(Luna< osg::Vec4ub >::check(L,2));
		if( !_arg1_ptr ) {
			luaL_error(L, "Dereferencing NULL pointer for arg _arg1 in osg::ConstValueVisitor::base_apply function");
		}
		const osg::Vec4ub & _arg1=*_arg1_ptr;
	...
	// Overload binder for osg::ConstValueVisitor::base_apply
	static int _bind_base_apply(lua_State *L) {
		...
		luaL_error(L, "error in function base_apply, cannot match any of the overloads for function base_apply:\n  base_apply(const signed char &)\n  base_apply(const short &)\n  base_apply(const int &)\n  base_apply(const unsigned short &)\n  base_apply(const unsigned char &)\n  base_apply(const unsigned int &)\n  base_apply(const float &)\n  base_apply(const double &)\n  base_apply(const osg::Vec4ub &)\n  base_apply(const osg::Vec2f &)\n  base_apply(const osg::Vec3f &)\n  base_apply(const osg::Vec4f &)\n  base_apply(const osg::Vec2b &)\n  base_apply(const osg::Vec3b &)\n  base_apply(const osg::Vec4b &)\n  base_apply(const osg::Vec2s &)\n  base_apply(const osg::Vec3s &)\n  base_apply(const osg::Vec4s &)\n  base_apply(const osg::Vec2d &)\n  base_apply(const osg::Vec3d &)\n  base_apply(const osg::Vec4d &)\n  base_apply(const osg::Matrixf &)\n");
		return 0;
	}
...
luna_RegType LunaTraits< osg::ConstValueVisitor >::methods[] = {
	...
	{"base_apply", &luna_wrapper_osg_ConstValueVisitor::_bind_base_apply},
	{"dynCast", &luna_wrapper_osg_ConstValueVisitor::_bind_dynCast},
	{"__eq", &luna_wrapper_osg_ConstValueVisitor::_bind___eq},
	{"fromVoid", &luna_wrapper_osg_ConstValueVisitor::_bind_fromVoid},
	{"asVoid", &luna_wrapper_osg_ConstValueVisitor::_bind_asVoid},
	{"getTable", &luna_wrapper_osg_ConstValueVisitor::_bind_getTable},
	{0,0}
};
