...
const char LunaTraits< osgUtil::IncrementalCompileOperation::CompileTextureOp >::moduleName[] = "osg";
const char* LunaTraits< osgUtil::IncrementalCompileOperation::CompileTextureOp >::parents[] = {"osg.CompileOp", 0};
