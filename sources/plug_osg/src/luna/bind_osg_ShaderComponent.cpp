...
public:
	...
	// osg::Object * osg::ShaderComponent::clone(const osg::CopyOp & ) const
	static int _bind_clone(lua_State *L) {
		if (!_lg_typecheck_clone(L)) {
			luna_printStack(L);
			luaL_error(L, "luna typecheck failed in osg::Object * osg::ShaderComponent::clone(const osg::CopyOp & ) const function, expected prototype:\nosg::Object * osg::ShaderComponent::clone(const osg::CopyOp & ) const\nClass arguments details:\narg 1 ID = 27134364\n");
		}
	...
	// void osg::ShaderComponent::releaseGLObjects(osg::State *  = 0) const
	static int _bind_releaseGLObjects(lua_State *L) {
		if (!_lg_typecheck_releaseGLObjects(L)) {
			luna_printStack(L);
			luaL_error(L, "luna typecheck failed in void osg::ShaderComponent::releaseGLObjects(osg::State *  = 0) const function, expected prototype:\nvoid osg::ShaderComponent::releaseGLObjects(osg::State *  = 0) const\nClass arguments details:\narg 1 ID = 50169651\n");
		}
