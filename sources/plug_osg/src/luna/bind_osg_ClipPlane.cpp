...
public:
	...
	static int _bind_fromVoid(lua_State *L) {
		...
		Luna< osg::ClipPlane >::push(L,self,false);
		return 1;
	}
	...
	inline static bool _lg_typecheck_ctor_overload_6(lua_State *L) {
		...
		if( !Luna<void>::has_uniqueid(L,1,50169651) ) return false;
		if( (!(Luna< osg::Referenced >::checkSubType< osg::ClipPlane >(L,1))) ) return false;
	...
	inline static bool _lg_typecheck_ctor_overload_12(lua_State *L) {
		...
		if( (!(Luna< osg::Referenced >::checkSubType< osg::ClipPlane >(L,2))) ) return false;
...
luna_RegType LunaTraits< osg::ClipPlane >::methods[] = {
	...
	{"base_setThreadSafeRefUnref", &luna_wrapper_osg_ClipPlane::_bind_base_setThreadSafeRefUnref},
	...
	{"fromVoid", &luna_wrapper_osg_ClipPlane::_bind_fromVoid},
	{"asVoid", &luna_wrapper_osg_ClipPlane::_bind_asVoid},
