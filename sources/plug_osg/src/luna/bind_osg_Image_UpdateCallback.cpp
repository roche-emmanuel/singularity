...
public:
	...
	static int _bind_base_setThreadSafeRefUnref(lua_State *L) {
		...
		if(!self) {
			luaL_error(L, "Invalid object in function call void osg::Image::UpdateCallback::base_setThreadSafeRefUnref(bool). Got : '%s'\n%s",typeid(Luna< osg::Referenced >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_setName(lua_State *L) {
		...
		osg::Image::UpdateCallback* self=Luna< osg::Referenced >::checkSubType< osg::Image::UpdateCallback >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void osg::Image::UpdateCallback::base_setName(const std::string &). Got : '%s'\n%s",typeid(Luna< osg::Referenced >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_computeDataVariance(lua_State *L) {
		...
		osg::Image::UpdateCallback* self=Luna< osg::Referenced >::checkSubType< osg::Image::UpdateCallback >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void osg::Image::UpdateCallback::base_computeDataVariance(). Got : '%s'\n%s",typeid(Luna< osg::Referenced >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_setUserData(lua_State *L) {
		...
		osg::Image::UpdateCallback* self=Luna< osg::Referenced >::checkSubType< osg::Image::UpdateCallback >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void osg::Image::UpdateCallback::base_setUserData(osg::Referenced *). Got : '%s'\n%s",typeid(Luna< osg::Referenced >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_getUserData_overload_1(lua_State *L) {
		...
		osg::Image::UpdateCallback* self=Luna< osg::Referenced >::checkSubType< osg::Image::UpdateCallback >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call osg::Referenced * osg::Image::UpdateCallback::base_getUserData(). Got : '%s'\n%s",typeid(Luna< osg::Referenced >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_getUserData_overload_2(lua_State *L) {
		...
		osg::Image::UpdateCallback* self=Luna< osg::Referenced >::checkSubType< osg::Image::UpdateCallback >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call const osg::Referenced * osg::Image::UpdateCallback::base_getUserData() const. Got : '%s'\n%s",typeid(Luna< osg::Referenced >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_releaseGLObjects(lua_State *L) {
		...
		osg::Image::UpdateCallback* self=Luna< osg::Referenced >::checkSubType< osg::Image::UpdateCallback >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void osg::Image::UpdateCallback::base_releaseGLObjects(osg::State *) const. Got : '%s'\n%s",typeid(Luna< osg::Referenced >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_cloneType(lua_State *L) {
		...
		osg::Image::UpdateCallback* self=Luna< osg::Referenced >::checkSubType< osg::Image::UpdateCallback >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call osg::Object * osg::Image::UpdateCallback::base_cloneType() const. Got : '%s'\n%s",typeid(Luna< osg::Referenced >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_clone(lua_State *L) {
		...
		osg::Image::UpdateCallback* self=Luna< osg::Referenced >::checkSubType< osg::Image::UpdateCallback >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call osg::Object * osg::Image::UpdateCallback::base_clone(const osg::CopyOp &) const. Got : '%s'\n%s",typeid(Luna< osg::Referenced >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_isSameKindAs(lua_State *L) {
		...
		osg::Image::UpdateCallback* self=Luna< osg::Referenced >::checkSubType< osg::Image::UpdateCallback >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call bool osg::Image::UpdateCallback::base_isSameKindAs(const osg::Object *) const. Got : '%s'\n%s",typeid(Luna< osg::Referenced >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_libraryName(lua_State *L) {
		...
		osg::Image::UpdateCallback* self=Luna< osg::Referenced >::checkSubType< osg::Image::UpdateCallback >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call const char * osg::Image::UpdateCallback::base_libraryName() const. Got : '%s'\n%s",typeid(Luna< osg::Referenced >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_className(lua_State *L) {
		...
		osg::Image::UpdateCallback* self=Luna< osg::Referenced >::checkSubType< osg::Image::UpdateCallback >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call const char * osg::Image::UpdateCallback::base_className() const. Got : '%s'\n%s",typeid(Luna< osg::Referenced >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_op_call(lua_State *L) {
		...
		osg::Image::UpdateCallback* self=Luna< osg::Referenced >::checkSubType< osg::Image::UpdateCallback >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void osg::Image::UpdateCallback::operator()(osg::StateAttribute *, osg::NodeVisitor *). Got : '%s'\n%s",typeid(Luna< osg::Referenced >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
