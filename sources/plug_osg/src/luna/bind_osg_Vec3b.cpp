...
public:
	...
	static int _bind_ptr_overload_1(lua_State *L) {
		...
		if(!self) {
			luna_printStack(L);
			luaL_error(L, "Invalid object in function call signed char * osg::Vec3b::ptr()");
		}
	...
	static int _bind_ptr_overload_2(lua_State *L) {
		...
		if(!self) {
			luna_printStack(L);
			luaL_error(L, "Invalid object in function call const signed char * osg::Vec3b::ptr() const");
		}
	...
	static int _bind_set_overload_1(lua_State *L) {
		...
		if(!self) {
			luna_printStack(L);
			luaL_error(L, "Invalid object in function call void osg::Vec3b::set(signed char, signed char, signed char)");
		}
		self->set(r, g, b);
	...
	static int _bind_set_overload_2(lua_State *L) {
		...
		if(!self) {
			luna_printStack(L);
			luaL_error(L, "Invalid object in function call void osg::Vec3b::set(const osg::Vec3b &)");
		}
		self->set(rhs);
	...
	static int _bind_x_overload_1(lua_State *L) {
		...
		if(!self) {
			luna_printStack(L);
			luaL_error(L, "Invalid object in function call signed char & osg::Vec3b::x()");
		}
	...
	static int _bind_x_overload_2(lua_State *L) {
		...
		if(!self) {
			luna_printStack(L);
			luaL_error(L, "Invalid object in function call signed char osg::Vec3b::x() const");
		}
		signed char lret = self->x();
		lua_pushnumber(L,lret);
	...
	static int _bind_y_overload_1(lua_State *L) {
		...
		if(!self) {
			luna_printStack(L);
			luaL_error(L, "Invalid object in function call signed char & osg::Vec3b::y()");
		}
	...
	static int _bind_y_overload_2(lua_State *L) {
		...
		if(!self) {
			luna_printStack(L);
			luaL_error(L, "Invalid object in function call signed char osg::Vec3b::y() const");
		}
		signed char lret = self->y();
		lua_pushnumber(L,lret);
	...
	static int _bind_z_overload_1(lua_State *L) {
		...
		if(!self) {
			luna_printStack(L);
			luaL_error(L, "Invalid object in function call signed char & osg::Vec3b::z()");
		}
	...
	static int _bind_z_overload_2(lua_State *L) {
		...
		if(!self) {
			luna_printStack(L);
			luaL_error(L, "Invalid object in function call signed char osg::Vec3b::z() const");
		}
		signed char lret = self->z();
		lua_pushnumber(L,lret);
	...
	static int _bind_r_overload_1(lua_State *L) {
		...
		if(!self) {
			luna_printStack(L);
			luaL_error(L, "Invalid object in function call signed char & osg::Vec3b::r()");
		}
	...
	static int _bind_r_overload_2(lua_State *L) {
		...
		if(!self) {
			luna_printStack(L);
			luaL_error(L, "Invalid object in function call signed char osg::Vec3b::r() const");
		}
		signed char lret = self->r();
		lua_pushnumber(L,lret);
	...
	static int _bind_g_overload_1(lua_State *L) {
		...
		if(!self) {
			luna_printStack(L);
			luaL_error(L, "Invalid object in function call signed char & osg::Vec3b::g()");
		}
	...
	static int _bind_g_overload_2(lua_State *L) {
		...
		if(!self) {
			luna_printStack(L);
			luaL_error(L, "Invalid object in function call signed char osg::Vec3b::g() const");
		}
		signed char lret = self->g();
		lua_pushnumber(L,lret);
	...
	static int _bind_b_overload_1(lua_State *L) {
		...
		if(!self) {
			luna_printStack(L);
			luaL_error(L, "Invalid object in function call signed char & osg::Vec3b::b()");
		}
	...
	static int _bind_b_overload_2(lua_State *L) {
		...
		if(!self) {
			luna_printStack(L);
			luaL_error(L, "Invalid object in function call signed char osg::Vec3b::b() const");
		}
		signed char lret = self->b();
		lua_pushnumber(L,lret);
	...
	static int _bind___eq(lua_State *L) {
		...
		if(!self) {
			luna_printStack(L);
			luaL_error(L, "Invalid object in function call bool osg::Vec3b::operator==(const osg::Vec3b &) const");
		}
	...
	static int _bind_op_index_overload_1(lua_State *L) {
		...
		if(!self) {
			luna_printStack(L);
			luaL_error(L, "Invalid object in function call signed char & osg::Vec3b::operator[](unsigned int)");
		}
	...
	static int _bind_op_index_overload_2(lua_State *L) {
		...
		if(!self) {
			luna_printStack(L);
			luaL_error(L, "Invalid object in function call signed char osg::Vec3b::operator[](unsigned int) const");
		}
		signed char lret = self->operator[](i);
		lua_pushnumber(L,lret);
	...
	static int _bind___mul(lua_State *L) {
		...
		if(!self) {
			luna_printStack(L);
			luaL_error(L, "Invalid object in function call osg::Vec3b osg::Vec3b::operator*(float) const");
		}
	...
	static int _bind_op_mult(lua_State *L) {
		...
		if(!self) {
			luna_printStack(L);
			luaL_error(L, "Invalid object in function call osg::Vec3b & osg::Vec3b::operator*=(float)");
		}
	...
	static int _bind___add(lua_State *L) {
		...
		if(!self) {
			luna_printStack(L);
			luaL_error(L, "Invalid object in function call osg::Vec3b osg::Vec3b::operator+(const osg::Vec3b &) const");
		}
		osg::Vec3b stack_lret = self->operator+(rhs);
		osg::Vec3b* lret = new osg::Vec3b(stack_lret);
		if(!lret) return 0; // Do not write NULL pointers.
	...
	static int _bind_op_add(lua_State *L) {
		...
		if(!self) {
			luna_printStack(L);
			luaL_error(L, "Invalid object in function call osg::Vec3b & osg::Vec3b::operator+=(const osg::Vec3b &)");
		}
		const osg::Vec3b* lret = &self->operator+=(rhs);
		if(!lret) return 0; // Do not write NULL pointers.
