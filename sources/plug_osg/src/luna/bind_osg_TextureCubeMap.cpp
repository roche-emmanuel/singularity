...
public:
	...
	inline static bool _lg_typecheck_ctor_overload_2(lua_State *L) {
		...
		if( !Luna<void>::has_uniqueid(L,1,50169651) ) return false;
		if( (!dynamic_cast< osg::TextureCubeMap* >(Luna< osg::Referenced >::check(L,1))) ) return false;
	...
	// osg::Object * osg::TextureCubeMap::clone(const osg::CopyOp & ) const
	static int _bind_clone(lua_State *L) {
		if (!_lg_typecheck_clone(L)) {
			luna_printStack(L);
			luaL_error(L, "luna typecheck failed in osg::Object * osg::TextureCubeMap::clone(const osg::CopyOp & ) const function, expected prototype:\nosg::Object * osg::TextureCubeMap::clone(const osg::CopyOp & ) const\nClass arguments details:\narg 1 ID = 27134364\n");
		}
