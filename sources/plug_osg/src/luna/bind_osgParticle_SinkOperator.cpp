...
public:
	...
	inline static bool _lg_typecheck_ctor_overload_2(lua_State *L) {
		...
		if( !Luna<void>::has_uniqueid(L,1,50169651) ) return false;
		if( (!dynamic_cast< osgParticle::SinkOperator* >(Luna< osg::Referenced >::check(L,1))) ) return false;
	...
	inline static bool _lg_typecheck_ctor_overload_4(lua_State *L) {
		...
		if( (!dynamic_cast< osgParticle::SinkOperator* >(Luna< osg::Referenced >::check(L,2))) ) return false;
	...
	static osgParticle::SinkOperator* _bind_ctor_overload_4(lua_State *L) {
		...
		const osgParticle::SinkOperator* copy_ptr=dynamic_cast< osgParticle::SinkOperator* >(Luna< osg::Referenced >::check(L,2));
		if( !copy_ptr ) {
			luaL_error(L, "Dereferencing NULL pointer for arg copy in osgParticle::SinkOperator::SinkOperator function");
		}
		const osgParticle::SinkOperator & copy=*copy_ptr;
...
luna_RegType LunaTraits< osgParticle::SinkOperator >::methods[] = {
	...
	{"__eq", &luna_wrapper_osgParticle_SinkOperator::_bind___eq},
	{0,0}
};
