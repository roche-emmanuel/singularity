...
public:
	...
	inline static bool _lg_typecheck_ctor_overload_2(lua_State *L) {
		...
		if( !Luna<void>::has_uniqueid(L,1,50169651) ) return false;
		if( (!dynamic_cast< osg::InfinitePlane* >(Luna< osg::Referenced >::check(L,1))) ) return false;
	...
	static int _bind_base_setName(lua_State *L) {
		...
		if(!self) {
			luna_printStack(L);
			luaL_error(L, "Invalid object in function call void osg::InfinitePlane::base_setName(const std::string &)");
		}
	...
	static int _bind_base_computeDataVariance(lua_State *L) {
		...
		if(!self) {
			luna_printStack(L);
			luaL_error(L, "Invalid object in function call void osg::InfinitePlane::base_computeDataVariance()");
		}
	...
	static int _bind_base_setUserData(lua_State *L) {
		...
		if(!self) {
			luna_printStack(L);
			luaL_error(L, "Invalid object in function call void osg::InfinitePlane::base_setUserData(osg::Referenced *)");
		}
	...
	static int _bind_base_getUserData_overload_1(lua_State *L) {
		...
		if(!self) {
			luna_printStack(L);
			luaL_error(L, "Invalid object in function call osg::Referenced * osg::InfinitePlane::base_getUserData()");
		}
	...
	static int _bind_base_getUserData_overload_2(lua_State *L) {
		...
		if(!self) {
			luna_printStack(L);
			luaL_error(L, "Invalid object in function call const osg::Referenced * osg::InfinitePlane::base_getUserData() const");
		}
	...
	static int _bind_base_releaseGLObjects(lua_State *L) {
		...
		if(!self) {
			luna_printStack(L);
			luaL_error(L, "Invalid object in function call void osg::InfinitePlane::base_releaseGLObjects(osg::State *) const");
		}
	...
	static int _bind_base_cloneType(lua_State *L) {
		...
		if(!self) {
			luna_printStack(L);
			luaL_error(L, "Invalid object in function call osg::Object * osg::InfinitePlane::base_cloneType() const");
		}
	...
	static int _bind_base_clone(lua_State *L) {
		...
		if(!self) {
			luna_printStack(L);
			luaL_error(L, "Invalid object in function call osg::Object * osg::InfinitePlane::base_clone(const osg::CopyOp &) const");
		}
	...
	static int _bind_base_isSameKindAs(lua_State *L) {
		...
		if(!self) {
			luna_printStack(L);
			luaL_error(L, "Invalid object in function call bool osg::InfinitePlane::base_isSameKindAs(const osg::Object *) const");
		}
	...
	static int _bind_base_libraryName(lua_State *L) {
		...
		if(!self) {
			luna_printStack(L);
			luaL_error(L, "Invalid object in function call const char * osg::InfinitePlane::base_libraryName() const");
		}
	...
	static int _bind_base_className(lua_State *L) {
		...
		if(!self) {
			luna_printStack(L);
			luaL_error(L, "Invalid object in function call const char * osg::InfinitePlane::base_className() const");
		}
	...
	static int _bind_base_accept_overload_1(lua_State *L) {
		...
		if(!self) {
			luna_printStack(L);
			luaL_error(L, "Invalid object in function call void osg::InfinitePlane::base_accept(osg::ShapeVisitor &)");
		}
	...
	static int _bind_base_accept_overload_2(lua_State *L) {
		...
		if(!self) {
			luna_printStack(L);
			luaL_error(L, "Invalid object in function call void osg::InfinitePlane::base_accept(osg::ConstShapeVisitor &) const");
		}
		self->InfinitePlane::accept(_arg1);
