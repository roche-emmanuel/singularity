...
public:
	...
	static int _bind_insertIntersection(lua_State *L) {
		...
		osgUtil::PlaneIntersector* self=dynamic_cast< osgUtil::PlaneIntersector* >(Luna< osg::Referenced >::check(L,1));
		if(!self) {
			luna_printStack(L);
	...
	static int _bind_setEllipsoidModel(lua_State *L) {
		...
		osg::EllipsoidModel* em=dynamic_cast< osg::EllipsoidModel* >(Luna< osg::Referenced >::check(L,2));
