...
public:
	...
	inline static bool _lg_typecheck_ctor_overload_2(lua_State *L) {
		...
		if( !Luna<void>::has_uniqueid(L,1,50169651) ) return false;
		if( (!dynamic_cast< osgParticle::SegmentPlacer* >(Luna< osg::Referenced >::check(L,1))) ) return false;
	...
	inline static bool _lg_typecheck_ctor_overload_4(lua_State *L) {
		...
		if( (!dynamic_cast< osgParticle::SegmentPlacer* >(Luna< osg::Referenced >::check(L,2))) ) return false;
	...
	static osgParticle::SegmentPlacer* _bind_ctor_overload_4(lua_State *L) {
		...
		const osgParticle::SegmentPlacer* copy_ptr=dynamic_cast< osgParticle::SegmentPlacer* >(Luna< osg::Referenced >::check(L,2));
		if( !copy_ptr ) {
			luaL_error(L, "Dereferencing NULL pointer for arg copy in osgParticle::SegmentPlacer::SegmentPlacer function");
		}
		const osgParticle::SegmentPlacer & copy=*copy_ptr;
...
luna_RegType LunaTraits< osgParticle::SegmentPlacer >::methods[] = {
	...
	{"__eq", &luna_wrapper_osgParticle_SegmentPlacer::_bind___eq},
	{0,0}
};
