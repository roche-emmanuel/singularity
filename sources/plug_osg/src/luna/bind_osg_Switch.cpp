...
public:
	...
	// osg::Switch::Switch(const osg::Switch & , const osg::CopyOp & copyop = osg::CopyOp::SHALLOW_COPY)
	static osg::Switch* _bind_ctor_overload_2(lua_State *L) {
		if (!_lg_typecheck_ctor_overload_2(L)) {
			luna_printStack(L);
			luaL_error(L, "luna typecheck failed in osg::Switch::Switch(const osg::Switch & , const osg::CopyOp & copyop = osg::CopyOp::SHALLOW_COPY) function, expected prototype:\nosg::Switch::Switch(const osg::Switch & , const osg::CopyOp & copyop = osg::CopyOp::SHALLOW_COPY)\nClass arguments details:\narg 1 ID = 50169651\narg 2 ID = 27134364\n");
		}
	...
	// void osg::Switch::traverse(osg::NodeVisitor & )
	static int _bind_traverse(lua_State *L) {
		if (!_lg_typecheck_traverse(L)) {
			luna_printStack(L);
			luaL_error(L, "luna typecheck failed in void osg::Switch::traverse(osg::NodeVisitor & ) function, expected prototype:\nvoid osg::Switch::traverse(osg::NodeVisitor & )\nClass arguments details:\narg 1 ID = 50169651\n");
		}
