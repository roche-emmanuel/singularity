...
public:
	...
	static int _bind_fromVoid(lua_State *L) {
		...
		osgGA::StandardManipulator* self= (osgGA::StandardManipulator*)(Luna< void >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call fromVoid(...)");
		}
		
		Luna< osgGA::StandardManipulator >::push(L,self,false);
		return 1;
	}
	...
	static int _bind_className(lua_State *L) {
		...
		if(!self) {
			luaL_error(L, "Invalid object in function call const char * osgGA::StandardManipulator::className() const. Got : '%s'\n%s",typeid(Luna< osg::Referenced >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_setTransformation_overload_1(lua_State *L) {
		...
		osgGA::StandardManipulator* self=Luna< osg::Referenced >::checkSubType< osgGA::StandardManipulator >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void osgGA::StandardManipulator::setTransformation(const osg::Vec3d &, const osg::Quat &). Got : '%s'\n%s",typeid(Luna< osg::Referenced >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_setTransformation_overload_2(lua_State *L) {
		...
		osgGA::StandardManipulator* self=Luna< osg::Referenced >::checkSubType< osgGA::StandardManipulator >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void osgGA::StandardManipulator::setTransformation(const osg::Vec3d &, const osg::Vec3d &, const osg::Vec3d &). Got : '%s'\n%s",typeid(Luna< osg::Referenced >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_getTransformation_overload_1(lua_State *L) {
		...
		osgGA::StandardManipulator* self=Luna< osg::Referenced >::checkSubType< osgGA::StandardManipulator >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void osgGA::StandardManipulator::getTransformation(osg::Vec3d &, osg::Quat &) const. Got : '%s'\n%s",typeid(Luna< osg::Referenced >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_getTransformation_overload_2(lua_State *L) {
		...
		osgGA::StandardManipulator* self=Luna< osg::Referenced >::checkSubType< osgGA::StandardManipulator >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void osgGA::StandardManipulator::getTransformation(osg::Vec3d &, osg::Vec3d &, osg::Vec3d &) const. Got : '%s'\n%s",typeid(Luna< osg::Referenced >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_setNode(lua_State *L) {
		...
		osgGA::StandardManipulator* self=Luna< osg::Referenced >::checkSubType< osgGA::StandardManipulator >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void osgGA::StandardManipulator::setNode(osg::Node *). Got : '%s'\n%s",typeid(Luna< osg::Referenced >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
		self->setNode(_arg1);
	...
	static int _bind_getNode_overload_1(lua_State *L) {
		...
		osgGA::StandardManipulator* self=Luna< osg::Referenced >::checkSubType< osgGA::StandardManipulator >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call const osg::Node * osgGA::StandardManipulator::getNode() const. Got : '%s'\n%s",typeid(Luna< osg::Referenced >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_getNode_overload_2(lua_State *L) {
		...
		osgGA::StandardManipulator* self=Luna< osg::Referenced >::checkSubType< osgGA::StandardManipulator >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call osg::Node * osgGA::StandardManipulator::getNode(). Got : '%s'\n%s",typeid(Luna< osg::Referenced >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_setVerticalAxisFixed(lua_State *L) {
		...
		osgGA::StandardManipulator* self=Luna< osg::Referenced >::checkSubType< osgGA::StandardManipulator >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void osgGA::StandardManipulator::setVerticalAxisFixed(bool). Got : '%s'\n%s",typeid(Luna< osg::Referenced >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_getVerticalAxisFixed(lua_State *L) {
		...
		osgGA::StandardManipulator* self=Luna< osg::Referenced >::checkSubType< osgGA::StandardManipulator >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call bool osgGA::StandardManipulator::getVerticalAxisFixed() const. Got : '%s'\n%s",typeid(Luna< osg::Referenced >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_getAllowThrow(lua_State *L) {
		...
		osgGA::StandardManipulator* self=Luna< osg::Referenced >::checkSubType< osgGA::StandardManipulator >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call bool osgGA::StandardManipulator::getAllowThrow() const. Got : '%s'\n%s",typeid(Luna< osg::Referenced >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_setAllowThrow(lua_State *L) {
		...
		osgGA::StandardManipulator* self=Luna< osg::Referenced >::checkSubType< osgGA::StandardManipulator >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void osgGA::StandardManipulator::setAllowThrow(bool). Got : '%s'\n%s",typeid(Luna< osg::Referenced >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_setAnimationTime(lua_State *L) {
		...
		osgGA::StandardManipulator* self=Luna< osg::Referenced >::checkSubType< osgGA::StandardManipulator >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void osgGA::StandardManipulator::setAnimationTime(const double). Got : '%s'\n%s",typeid(Luna< osg::Referenced >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_getAnimationTime(lua_State *L) {
		...
		osgGA::StandardManipulator* self=Luna< osg::Referenced >::checkSubType< osgGA::StandardManipulator >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call double osgGA::StandardManipulator::getAnimationTime() const. Got : '%s'\n%s",typeid(Luna< osg::Referenced >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_isAnimating(lua_State *L) {
		...
		osgGA::StandardManipulator* self=Luna< osg::Referenced >::checkSubType< osgGA::StandardManipulator >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call bool osgGA::StandardManipulator::isAnimating() const. Got : '%s'\n%s",typeid(Luna< osg::Referenced >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_finishAnimation(lua_State *L) {
		...
		osgGA::StandardManipulator* self=Luna< osg::Referenced >::checkSubType< osgGA::StandardManipulator >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void osgGA::StandardManipulator::finishAnimation(). Got : '%s'\n%s",typeid(Luna< osg::Referenced >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_home_overload_1(lua_State *L) {
		...
		osgGA::StandardManipulator* self=Luna< osg::Referenced >::checkSubType< osgGA::StandardManipulator >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void osgGA::StandardManipulator::home(const osgGA::GUIEventAdapter &, osgGA::GUIActionAdapter &). Got : '%s'\n%s",typeid(Luna< osg::Referenced >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_home_overload_2(lua_State *L) {
		...
		osgGA::StandardManipulator* self=Luna< osg::Referenced >::checkSubType< osgGA::StandardManipulator >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void osgGA::StandardManipulator::home(double). Got : '%s'\n%s",typeid(Luna< osg::Referenced >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
		self->home(_arg1);
	...
	static int _bind_init(lua_State *L) {
		...
		osgGA::StandardManipulator* self=Luna< osg::Referenced >::checkSubType< osgGA::StandardManipulator >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void osgGA::StandardManipulator::init(const osgGA::GUIEventAdapter &, osgGA::GUIActionAdapter &). Got : '%s'\n%s",typeid(Luna< osg::Referenced >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_handle(lua_State *L) {
		...
		osgGA::StandardManipulator* self=Luna< osg::Referenced >::checkSubType< osgGA::StandardManipulator >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call bool osgGA::StandardManipulator::handle(const osgGA::GUIEventAdapter &, osgGA::GUIActionAdapter &). Got : '%s'\n%s",typeid(Luna< osg::Referenced >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_getUsage(lua_State *L) {
		...
		osgGA::StandardManipulator* self=Luna< osg::Referenced >::checkSubType< osgGA::StandardManipulator >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void osgGA::StandardManipulator::getUsage(osg::ApplicationUsage &) const. Got : '%s'\n%s",typeid(Luna< osg::Referenced >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
		self->getUsage(_arg1);
	...
	// void osgGA::StandardManipulator::base_setThreadSafeRefUnref(bool threadSafe)
	static int _bind_base_setThreadSafeRefUnref(lua_State *L) {
		if (!_lg_typecheck_base_setThreadSafeRefUnref(L)) {
			luaL_error(L, "luna typecheck failed in void osgGA::StandardManipulator::base_setThreadSafeRefUnref(bool threadSafe) function, expected prototype:\nvoid osgGA::StandardManipulator::base_setThreadSafeRefUnref(bool threadSafe)\nClass arguments details:\n\n%s",luna_dumpStack(L).c_str());
		}
		...
		osgGA::StandardManipulator* self=Luna< osg::Referenced >::checkSubType< osgGA::StandardManipulator >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void osgGA::StandardManipulator::base_setThreadSafeRefUnref(bool). Got : '%s'\n%s",typeid(Luna< osg::Referenced >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
		self->StandardManipulator::setThreadSafeRefUnref(threadSafe);
	...
	static int _bind_base_setName(lua_State *L) {
		...
		osgGA::StandardManipulator* self=Luna< osg::Referenced >::checkSubType< osgGA::StandardManipulator >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void osgGA::StandardManipulator::base_setName(const std::string &). Got : '%s'\n%s",typeid(Luna< osg::Referenced >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_computeDataVariance(lua_State *L) {
		...
		osgGA::StandardManipulator* self=Luna< osg::Referenced >::checkSubType< osgGA::StandardManipulator >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void osgGA::StandardManipulator::base_computeDataVariance(). Got : '%s'\n%s",typeid(Luna< osg::Referenced >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_setUserData(lua_State *L) {
		...
		osgGA::StandardManipulator* self=Luna< osg::Referenced >::checkSubType< osgGA::StandardManipulator >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void osgGA::StandardManipulator::base_setUserData(osg::Referenced *). Got : '%s'\n%s",typeid(Luna< osg::Referenced >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_getUserData_overload_1(lua_State *L) {
		...
		osgGA::StandardManipulator* self=Luna< osg::Referenced >::checkSubType< osgGA::StandardManipulator >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call osg::Referenced * osgGA::StandardManipulator::base_getUserData(). Got : '%s'\n%s",typeid(Luna< osg::Referenced >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_getUserData_overload_2(lua_State *L) {
		...
		osgGA::StandardManipulator* self=Luna< osg::Referenced >::checkSubType< osgGA::StandardManipulator >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call const osg::Referenced * osgGA::StandardManipulator::base_getUserData() const. Got : '%s'\n%s",typeid(Luna< osg::Referenced >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_releaseGLObjects(lua_State *L) {
		...
		osgGA::StandardManipulator* self=Luna< osg::Referenced >::checkSubType< osgGA::StandardManipulator >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void osgGA::StandardManipulator::base_releaseGLObjects(osg::State *) const. Got : '%s'\n%s",typeid(Luna< osg::Referenced >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_cloneType(lua_State *L) {
		...
		osgGA::StandardManipulator* self=Luna< osg::Referenced >::checkSubType< osgGA::StandardManipulator >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call osg::Object * osgGA::StandardManipulator::base_cloneType() const. Got : '%s'\n%s",typeid(Luna< osg::Referenced >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_clone(lua_State *L) {
		...
		osgGA::StandardManipulator* self=Luna< osg::Referenced >::checkSubType< osgGA::StandardManipulator >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call osg::Object * osgGA::StandardManipulator::base_clone(const osg::CopyOp &) const. Got : '%s'\n%s",typeid(Luna< osg::Referenced >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_isSameKindAs(lua_State *L) {
		...
		osgGA::StandardManipulator* self=Luna< osg::Referenced >::checkSubType< osgGA::StandardManipulator >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call bool osgGA::StandardManipulator::base_isSameKindAs(const osg::Object *) const. Got : '%s'\n%s",typeid(Luna< osg::Referenced >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_libraryName(lua_State *L) {
		...
		osgGA::StandardManipulator* self=Luna< osg::Referenced >::checkSubType< osgGA::StandardManipulator >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call const char * osgGA::StandardManipulator::base_libraryName() const. Got : '%s'\n%s",typeid(Luna< osg::Referenced >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_event(lua_State *L) {
		...
		osgGA::StandardManipulator* self=Luna< osg::Referenced >::checkSubType< osgGA::StandardManipulator >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void osgGA::StandardManipulator::base_event(osg::NodeVisitor *, osg::Drawable *). Got : '%s'\n%s",typeid(Luna< osg::Referenced >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_setCoordinateFrameCallback(lua_State *L) {
		...
		osgGA::StandardManipulator* self=Luna< osg::Referenced >::checkSubType< osgGA::StandardManipulator >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void osgGA::StandardManipulator::base_setCoordinateFrameCallback(osgGA::CameraManipulator::CoordinateFrameCallback *). Got : '%s'\n%s",typeid(Luna< osg::Referenced >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_updateCamera(lua_State *L) {
		...
		osgGA::StandardManipulator* self=Luna< osg::Referenced >::checkSubType< osgGA::StandardManipulator >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void osgGA::StandardManipulator::base_updateCamera(osg::Camera &). Got : '%s'\n%s",typeid(Luna< osg::Referenced >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_getFusionDistanceMode(lua_State *L) {
		...
		osgGA::StandardManipulator* self=Luna< osg::Referenced >::checkSubType< osgGA::StandardManipulator >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call osgUtil::SceneView::FusionDistanceMode osgGA::StandardManipulator::base_getFusionDistanceMode() const. Got : '%s'\n%s",typeid(Luna< osg::Referenced >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_getFusionDistanceValue(lua_State *L) {
		...
		osgGA::StandardManipulator* self=Luna< osg::Referenced >::checkSubType< osgGA::StandardManipulator >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call float osgGA::StandardManipulator::base_getFusionDistanceValue() const. Got : '%s'\n%s",typeid(Luna< osg::Referenced >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_setHomePosition(lua_State *L) {
		...
		osgGA::StandardManipulator* self=Luna< osg::Referenced >::checkSubType< osgGA::StandardManipulator >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void osgGA::StandardManipulator::base_setHomePosition(const osg::Vec3d &, const osg::Vec3d &, const osg::Vec3d &, bool). Got : '%s'\n%s",typeid(Luna< osg::Referenced >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_getHomePosition(lua_State *L) {
		...
		osgGA::StandardManipulator* self=Luna< osg::Referenced >::checkSubType< osgGA::StandardManipulator >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void osgGA::StandardManipulator::base_getHomePosition(osg::Vec3d &, osg::Vec3d &, osg::Vec3d &) const. Got : '%s'\n%s",typeid(Luna< osg::Referenced >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_setAutoComputeHomePosition(lua_State *L) {
		...
		osgGA::StandardManipulator* self=Luna< osg::Referenced >::checkSubType< osgGA::StandardManipulator >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void osgGA::StandardManipulator::base_setAutoComputeHomePosition(bool). Got : '%s'\n%s",typeid(Luna< osg::Referenced >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_computeHomePosition(lua_State *L) {
		...
		osgGA::StandardManipulator* self=Luna< osg::Referenced >::checkSubType< osgGA::StandardManipulator >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void osgGA::StandardManipulator::base_computeHomePosition(const osg::Camera *, bool). Got : '%s'\n%s",typeid(Luna< osg::Referenced >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_className(lua_State *L) {
		...
		osgGA::StandardManipulator* self=Luna< osg::Referenced >::checkSubType< osgGA::StandardManipulator >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call const char * osgGA::StandardManipulator::base_className() const. Got : '%s'\n%s",typeid(Luna< osg::Referenced >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_setNode(lua_State *L) {
		...
		osgGA::StandardManipulator* self=Luna< osg::Referenced >::checkSubType< osgGA::StandardManipulator >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void osgGA::StandardManipulator::base_setNode(osg::Node *). Got : '%s'\n%s",typeid(Luna< osg::Referenced >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_getNode_overload_1(lua_State *L) {
		...
		osgGA::StandardManipulator* self=Luna< osg::Referenced >::checkSubType< osgGA::StandardManipulator >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call const osg::Node * osgGA::StandardManipulator::base_getNode() const. Got : '%s'\n%s",typeid(Luna< osg::Referenced >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_getNode_overload_2(lua_State *L) {
		...
		osgGA::StandardManipulator* self=Luna< osg::Referenced >::checkSubType< osgGA::StandardManipulator >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call osg::Node * osgGA::StandardManipulator::base_getNode(). Got : '%s'\n%s",typeid(Luna< osg::Referenced >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_setVerticalAxisFixed(lua_State *L) {
		...
		osgGA::StandardManipulator* self=Luna< osg::Referenced >::checkSubType< osgGA::StandardManipulator >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void osgGA::StandardManipulator::base_setVerticalAxisFixed(bool). Got : '%s'\n%s",typeid(Luna< osg::Referenced >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_setAllowThrow(lua_State *L) {
		...
		osgGA::StandardManipulator* self=Luna< osg::Referenced >::checkSubType< osgGA::StandardManipulator >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void osgGA::StandardManipulator::base_setAllowThrow(bool). Got : '%s'\n%s",typeid(Luna< osg::Referenced >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_setAnimationTime(lua_State *L) {
		...
		osgGA::StandardManipulator* self=Luna< osg::Referenced >::checkSubType< osgGA::StandardManipulator >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void osgGA::StandardManipulator::base_setAnimationTime(const double). Got : '%s'\n%s",typeid(Luna< osg::Referenced >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_finishAnimation(lua_State *L) {
		...
		osgGA::StandardManipulator* self=Luna< osg::Referenced >::checkSubType< osgGA::StandardManipulator >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void osgGA::StandardManipulator::base_finishAnimation(). Got : '%s'\n%s",typeid(Luna< osg::Referenced >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_home_overload_1(lua_State *L) {
		...
		osgGA::StandardManipulator* self=Luna< osg::Referenced >::checkSubType< osgGA::StandardManipulator >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void osgGA::StandardManipulator::base_home(const osgGA::GUIEventAdapter &, osgGA::GUIActionAdapter &). Got : '%s'\n%s",typeid(Luna< osg::Referenced >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_home_overload_2(lua_State *L) {
		...
		osgGA::StandardManipulator* self=Luna< osg::Referenced >::checkSubType< osgGA::StandardManipulator >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void osgGA::StandardManipulator::base_home(double). Got : '%s'\n%s",typeid(Luna< osg::Referenced >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_init(lua_State *L) {
		...
		osgGA::StandardManipulator* self=Luna< osg::Referenced >::checkSubType< osgGA::StandardManipulator >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void osgGA::StandardManipulator::base_init(const osgGA::GUIEventAdapter &, osgGA::GUIActionAdapter &). Got : '%s'\n%s",typeid(Luna< osg::Referenced >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_handle(lua_State *L) {
		...
		osgGA::StandardManipulator* self=Luna< osg::Referenced >::checkSubType< osgGA::StandardManipulator >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call bool osgGA::StandardManipulator::base_handle(const osgGA::GUIEventAdapter &, osgGA::GUIActionAdapter &). Got : '%s'\n%s",typeid(Luna< osg::Referenced >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_getUsage(lua_State *L) {
		...
		osgGA::StandardManipulator* self=Luna< osg::Referenced >::checkSubType< osgGA::StandardManipulator >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void osgGA::StandardManipulator::base_getUsage(osg::ApplicationUsage &) const. Got : '%s'\n%s",typeid(Luna< osg::Referenced >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
...
luna_RegType LunaTraits< osgGA::StandardManipulator >::methods[] = {
	...
	{"base_setThreadSafeRefUnref", &luna_wrapper_osgGA_StandardManipulator::_bind_base_setThreadSafeRefUnref},
	...
	{"fromVoid", &luna_wrapper_osgGA_StandardManipulator::_bind_fromVoid},
	{"asVoid", &luna_wrapper_osgGA_StandardManipulator::_bind_asVoid},
