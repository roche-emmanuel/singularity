...
public:
	...
	inline static bool _lg_typecheck_ctor_overload_2(lua_State *L) {
		...
		if( !Luna<void>::has_uniqueid(L,1,50169651) ) return false;
		if( (!dynamic_cast< osg::KdTree* >(Luna< osg::Referenced >::check(L,1))) ) return false;
	...
	inline static bool _lg_typecheck_ctor_overload_4(lua_State *L) {
		...
		if( (!dynamic_cast< osg::KdTree* >(Luna< osg::Referenced >::check(L,2))) ) return false;
	...
	static osg::KdTree* _bind_ctor_overload_4(lua_State *L) {
		...
		const osg::KdTree* rhs_ptr=dynamic_cast< osg::KdTree* >(Luna< osg::Referenced >::check(L,2));
		if( !rhs_ptr ) {
			luaL_error(L, "Dereferencing NULL pointer for arg rhs in osg::KdTree::KdTree function");
		}
		const osg::KdTree & rhs=*rhs_ptr;
...
luna_RegType LunaTraits< osg::KdTree >::methods[] = {
	...
	{"__eq", &luna_wrapper_osg_KdTree::_bind___eq},
	{0,0}
};
