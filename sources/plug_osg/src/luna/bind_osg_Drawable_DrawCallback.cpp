...
public:
	...
	// osg::Drawable::DrawCallback::DrawCallback(const osg::Drawable::DrawCallback & , const osg::CopyOp & )
	static osg::Drawable::DrawCallback* _bind_ctor_overload_2(lua_State *L) {
		if (!_lg_typecheck_ctor_overload_2(L)) {
			luna_printStack(L);
			luaL_error(L, "luna typecheck failed in osg::Drawable::DrawCallback::DrawCallback(const osg::Drawable::DrawCallback & , const osg::CopyOp & ) function, expected prototype:\nosg::Drawable::DrawCallback::DrawCallback(const osg::Drawable::DrawCallback & , const osg::CopyOp & )\nClass arguments details:\narg 1 ID = 50169651\narg 2 ID = 27134364\n");
		}
	...
	// osg::Object * osg::Drawable::DrawCallback::clone(const osg::CopyOp & ) const
	static int _bind_clone(lua_State *L) {
		if (!_lg_typecheck_clone(L)) {
			luna_printStack(L);
			luaL_error(L, "luna typecheck failed in osg::Object * osg::Drawable::DrawCallback::clone(const osg::CopyOp & ) const function, expected prototype:\nosg::Object * osg::Drawable::DrawCallback::clone(const osg::CopyOp & ) const\nClass arguments details:\narg 1 ID = 27134364\n");
		}
	...
	// void osg::Drawable::DrawCallback::drawImplementation(osg::RenderInfo & , const osg::Drawable * ) const
	static int _bind_drawImplementation(lua_State *L) {
		if (!_lg_typecheck_drawImplementation(L)) {
			luna_printStack(L);
			luaL_error(L, "luna typecheck failed in void osg::Drawable::DrawCallback::drawImplementation(osg::RenderInfo & , const osg::Drawable * ) const function, expected prototype:\nvoid osg::Drawable::DrawCallback::drawImplementation(osg::RenderInfo & , const osg::Drawable * ) const\nClass arguments details:\narg 1 ID = 2286263\narg 2 ID = 50169651\n");
		}
