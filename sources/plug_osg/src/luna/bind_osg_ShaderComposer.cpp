...
#include <luna/wrappers/wrapper_osg_ShaderComposer.h>
...
public:
	...
	static int _cast_from_Referenced(lua_State *L) {
		...
		osg::ShaderComposer* ptr= luna_caster< osg::Referenced, osg::ShaderComposer >::cast(Luna< osg::Referenced >::check(L,1));
		if(!ptr)
			return 0;
	...
	inline static bool _lg_typecheck_ctor_overload_2(lua_State *L) {
		...
		if( !Luna<void>::has_uniqueid(L,1,50169651) ) return false;
		if( (!dynamic_cast< osg::ShaderComposer* >(Luna< osg::Referenced >::check(L,1))) ) return false;
	...
	inline static bool _lg_typecheck_ctor_overload_4(lua_State *L) {
		...
		if( (!dynamic_cast< osg::ShaderComposer* >(Luna< osg::Referenced >::check(L,2))) ) return false;
	...
	static osg::ShaderComposer* _bind_ctor_overload_2(lua_State *L) {
		...
		const osg::ShaderComposer* sa_ptr=(Luna< osg::Referenced >::checkSubType< osg::ShaderComposer >(L,1));
		if( !sa_ptr ) {
	...
	static osg::ShaderComposer* _bind_ctor_overload_3(lua_State *L) {
		...
		return new wrapper_osg_ShaderComposer(L,NULL);
	}
	...
	static osg::ShaderComposer* _bind_ctor_overload_4(lua_State *L) {
		...
		const osg::ShaderComposer* sa_ptr=(Luna< osg::Referenced >::checkSubType< osg::ShaderComposer >(L,2));
		if( !sa_ptr ) {
			luaL_error(L, "Dereferencing NULL pointer for arg sa in osg::ShaderComposer::ShaderComposer function");
		}
		const osg::ShaderComposer & sa=*sa_ptr;
		...
		return new wrapper_osg_ShaderComposer(L,NULL, sa, copyop);
	}
	...
	static int _bind_base_setName(lua_State *L) {
		...
		if(!self) {
			luna_printStack(L);
			luaL_error(L, "Invalid object in function call void osg::ShaderComposer::base_setName(const std::string &)");
		}
	...
	static int _bind_base_computeDataVariance(lua_State *L) {
		...
		if(!self) {
			luna_printStack(L);
			luaL_error(L, "Invalid object in function call void osg::ShaderComposer::base_computeDataVariance()");
		}
	...
	static int _bind_base_setUserData(lua_State *L) {
		...
		if(!self) {
			luna_printStack(L);
			luaL_error(L, "Invalid object in function call void osg::ShaderComposer::base_setUserData(osg::Referenced *)");
		}
	...
	static int _bind_base_getUserData_overload_1(lua_State *L) {
		...
		if(!self) {
			luna_printStack(L);
			luaL_error(L, "Invalid object in function call osg::Referenced * osg::ShaderComposer::base_getUserData()");
		}
	...
	static int _bind_base_getUserData_overload_2(lua_State *L) {
		...
		if(!self) {
			luna_printStack(L);
			luaL_error(L, "Invalid object in function call const osg::Referenced * osg::ShaderComposer::base_getUserData() const");
		}
	...
	// Overload binder for osg::ShaderComposer::base_getUserData
	...
	static int _bind_base_releaseGLObjects(lua_State *L) {
		...
		if(!self) {
			luna_printStack(L);
			luaL_error(L, "Invalid object in function call void osg::ShaderComposer::base_releaseGLObjects(osg::State *) const");
		}
	...
	static int _bind_base_cloneType(lua_State *L) {
		...
		if(!self) {
			luna_printStack(L);
			luaL_error(L, "Invalid object in function call osg::Object * osg::ShaderComposer::base_cloneType() const");
		}
	...
	static int _bind_base_clone(lua_State *L) {
		...
		const osg::CopyOp* _arg1_ptr=(Luna< osg::CopyOp >::check(L,2));
		if( !_arg1_ptr ) {
			luaL_error(L, "Dereferencing NULL pointer for arg _arg1 in osg::ShaderComposer::base_clone function");
		}
		const osg::CopyOp & _arg1=*_arg1_ptr;
		...
		if(!self) {
			luna_printStack(L);
			luaL_error(L, "Invalid object in function call osg::Object * osg::ShaderComposer::base_clone(const osg::CopyOp &) const");
		}
	...
	static int _bind_base_isSameKindAs(lua_State *L) {
		...
		if(!self) {
			luna_printStack(L);
			luaL_error(L, "Invalid object in function call bool osg::ShaderComposer::base_isSameKindAs(const osg::Object *) const");
		}
	...
	static int _bind_base_libraryName(lua_State *L) {
		...
		if(!self) {
			luna_printStack(L);
			luaL_error(L, "Invalid object in function call const char * osg::ShaderComposer::base_libraryName() const");
		}
	...
	static int _bind_base_className(lua_State *L) {
		...
		if(!self) {
			luna_printStack(L);
			luaL_error(L, "Invalid object in function call const char * osg::ShaderComposer::base_className() const");
		}
	...
	static int _bind_base_getOrCreateProgram(lua_State *L) {
		...
		if(!self) {
			luna_printStack(L);
			luaL_error(L, "Invalid object in function call osg::Program * osg::ShaderComposer::base_getOrCreateProgram(const osg::ShaderComponents &)");
		}
...
luna_RegType LunaTraits< osg::ShaderComposer >::methods[] = {
	...
	{"base_getUserData", &luna_wrapper_osg_ShaderComposer::_bind_base_getUserData},
	{"base_releaseGLObjects", &luna_wrapper_osg_ShaderComposer::_bind_base_releaseGLObjects},
	{"base_cloneType", &luna_wrapper_osg_ShaderComposer::_bind_base_cloneType},
	{"base_clone", &luna_wrapper_osg_ShaderComposer::_bind_base_clone},
	{"base_isSameKindAs", &luna_wrapper_osg_ShaderComposer::_bind_base_isSameKindAs},
	{"base_libraryName", &luna_wrapper_osg_ShaderComposer::_bind_base_libraryName},
	{"base_className", &luna_wrapper_osg_ShaderComposer::_bind_base_className},
	{"base_getOrCreateProgram", &luna_wrapper_osg_ShaderComposer::_bind_base_getOrCreateProgram},
	{"__eq", &luna_wrapper_osg_ShaderComposer::_bind___eq},
	{"getTable", &luna_wrapper_osg_ShaderComposer::_bind_getTable},
	{0,0}
};
