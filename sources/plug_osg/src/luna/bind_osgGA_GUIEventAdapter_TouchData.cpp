...
public:
	...
	static int _bind_fromVoid(lua_State *L) {
		...
		Luna< osgGA::GUIEventAdapter::TouchData >::push(L,self,false);
		return 1;
	}
	...
	inline static bool _lg_typecheck_ctor_overload_2(lua_State *L) {
		...
		if( !Luna<void>::has_uniqueid(L,1,50169651) ) return false;
		if( (!(Luna< osg::Referenced >::checkSubType< osgGA::GUIEventAdapter::TouchData >(L,1))) ) return false;
	...
	inline static bool _lg_typecheck_ctor_overload_4(lua_State *L) {
		...
		if( (!(Luna< osg::Referenced >::checkSubType< osgGA::GUIEventAdapter::TouchData >(L,2))) ) return false;
	...
	static osgGA::GUIEventAdapter::TouchData* _bind_ctor_overload_2(lua_State *L) {
		...
		if( !td_ptr ) {
			luaL_error(L, "Dereferencing NULL pointer for arg td in osgGA::GUIEventAdapter::TouchData::TouchData function");
		}
		const osgGA::GUIEventAdapter::TouchData & td=*td_ptr;
		const osg::CopyOp* copyop_ptr=(Luna< osg::CopyOp >::check(L,2));
		if( !copyop_ptr ) {
			luaL_error(L, "Dereferencing NULL pointer for arg copyop in osgGA::GUIEventAdapter::TouchData::TouchData function");
		}
		const osg::CopyOp & copyop=*copyop_ptr;

		return new osgGA::GUIEventAdapter::TouchData(td, copyop);
	}
	...
	static osgGA::GUIEventAdapter::TouchData* _bind_ctor_overload_4(lua_State *L) {
		...
		return new wrapper_osgGA_GUIEventAdapter_TouchData(L,NULL, td, copyop);
	}
	...
	static osgGA::GUIEventAdapter::TouchData* _bind_ctor(lua_State *L) {
		...
		luaL_error(L, "error in function TouchData, cannot match any of the overloads for function TouchData:\n  TouchData()\n  TouchData(const osgGA::GUIEventAdapter::TouchData &, const osg::CopyOp &)\n  TouchData(lua_Table *)\n  TouchData(lua_Table *, const osgGA::GUIEventAdapter::TouchData &, const osg::CopyOp &)\n");
		return NULL;
	}
	...
	static int _bind_clone(lua_State *L) {
		...
		if( !_arg1_ptr ) {
			luaL_error(L, "Dereferencing NULL pointer for arg _arg1 in osgGA::GUIEventAdapter::TouchData::clone function");
		}
	...
	// Overload binder for osgGA::GUIEventAdapter::TouchData::base_getUserData
	...
	static int _bind_base_clone(lua_State *L) {
		...
		const osg::CopyOp* _arg1_ptr=(Luna< osg::CopyOp >::check(L,2));
		if( !_arg1_ptr ) {
			luaL_error(L, "Dereferencing NULL pointer for arg _arg1 in osgGA::GUIEventAdapter::TouchData::base_clone function");
		}
		const osg::CopyOp & _arg1=*_arg1_ptr;
...
const char* LunaTraits< osgGA::GUIEventAdapter::TouchData >::parents[] = {"osg.Object", 0};
...
luna_RegType LunaTraits< osgGA::GUIEventAdapter::TouchData >::methods[] = {
	{"cloneType", &luna_wrapper_osgGA_GUIEventAdapter_TouchData::_bind_cloneType},
	{"clone", &luna_wrapper_osgGA_GUIEventAdapter_TouchData::_bind_clone},
	{"isSameKindAs", &luna_wrapper_osgGA_GUIEventAdapter_TouchData::_bind_isSameKindAs},
	{"libraryName", &luna_wrapper_osgGA_GUIEventAdapter_TouchData::_bind_libraryName},
	{"className", &luna_wrapper_osgGA_GUIEventAdapter_TouchData::_bind_className},
	...
	{"base_setThreadSafeRefUnref", &luna_wrapper_osgGA_GUIEventAdapter_TouchData::_bind_base_setThreadSafeRefUnref},
	{"base_setName", &luna_wrapper_osgGA_GUIEventAdapter_TouchData::_bind_base_setName},
	{"base_computeDataVariance", &luna_wrapper_osgGA_GUIEventAdapter_TouchData::_bind_base_computeDataVariance},
	{"base_setUserData", &luna_wrapper_osgGA_GUIEventAdapter_TouchData::_bind_base_setUserData},
	{"base_getUserData", &luna_wrapper_osgGA_GUIEventAdapter_TouchData::_bind_base_getUserData},
	{"base_releaseGLObjects", &luna_wrapper_osgGA_GUIEventAdapter_TouchData::_bind_base_releaseGLObjects},
	{"base_cloneType", &luna_wrapper_osgGA_GUIEventAdapter_TouchData::_bind_base_cloneType},
	{"base_clone", &luna_wrapper_osgGA_GUIEventAdapter_TouchData::_bind_base_clone},
	{"base_isSameKindAs", &luna_wrapper_osgGA_GUIEventAdapter_TouchData::_bind_base_isSameKindAs},
	{"base_libraryName", &luna_wrapper_osgGA_GUIEventAdapter_TouchData::_bind_base_libraryName},
	{"base_className", &luna_wrapper_osgGA_GUIEventAdapter_TouchData::_bind_base_className},
	{"__eq", &luna_wrapper_osgGA_GUIEventAdapter_TouchData::_bind___eq},
	{"fromVoid", &luna_wrapper_osgGA_GUIEventAdapter_TouchData::_bind_fromVoid},
	{"asVoid", &luna_wrapper_osgGA_GUIEventAdapter_TouchData::_bind_asVoid},
	{"getTable", &luna_wrapper_osgGA_GUIEventAdapter_TouchData::_bind_getTable},
	{0,0}
};
