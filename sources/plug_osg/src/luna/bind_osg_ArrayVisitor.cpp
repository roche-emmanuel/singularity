...
public:
	...
	inline static bool _lg_typecheck_apply_overload_10(lua_State *L) {
		...
		if( (!dynamic_cast< osg::Vec2Array* >(Luna< osg::Vec2Array >::check(L,2))) ) return false;
		return true;
	}
	...
	inline static bool _lg_typecheck_apply_overload_11(lua_State *L) {
		...
		if( (!dynamic_cast< osg::Vec3Array* >(Luna< osg::Vec3Array >::check(L,2))) ) return false;
		return true;
	}
	...
	inline static bool _lg_typecheck_apply_overload_12(lua_State *L) {
		...
		if( (!dynamic_cast< osg::Vec4Array* >(Luna< osg::Vec4Array >::check(L,2))) ) return false;
		return true;
	}
