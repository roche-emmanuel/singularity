...
public:
	...
	wrapper_osg_Program(lua_State* L, lua_Table* dum) : osg::Program(), luna_wrapper_base(L) { register_protected_methods(L); };
	wrapper_osg_Program(lua_State* L, lua_Table* dum, const osg::Program & rhs, const osg::CopyOp & copyop = osg::CopyOp::SHALLOW_COPY) : osg::Program(rhs, copyop), luna_wrapper_base(L) { register_protected_methods(L); };
