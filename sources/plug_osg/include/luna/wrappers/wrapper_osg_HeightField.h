...
class wrapper_osg_HeightField : public osg::HeightField {
protected:
	sgt::LuaObject _obj;
...
public:
	...
	wrapper_osg_HeightField(lua_State* L, lua_Table* dum) : osg::HeightField(), _obj(L,-1) {};
	wrapper_osg_HeightField(lua_State* L, lua_Table* dum, const osg::HeightField & mesh, const osg::CopyOp & copyop = osg::CopyOp::SHALLOW_COPY) : osg::HeightField(mesh, copyop), _obj(L,-1) {};
