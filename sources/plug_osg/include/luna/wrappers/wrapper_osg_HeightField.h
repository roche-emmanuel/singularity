...
public:
	...
	wrapper_osg_HeightField(lua_State* L, lua_Table* dum) : osg::HeightField(), luna_wrapper_base(L) { register_protected_methods(L); };
	wrapper_osg_HeightField(lua_State* L, lua_Table* dum, const osg::HeightField & mesh, const osg::CopyOp & copyop = osg::CopyOp::SHALLOW_COPY) : osg::HeightField(mesh, copyop), luna_wrapper_base(L) { register_protected_methods(L); };
