...
public:
	...
	wrapper_osg_AlphaFunc(lua_State* L, lua_Table* dum) : osg::AlphaFunc(), luna_wrapper_base(L) { register_protected_methods(L); };
	wrapper_osg_AlphaFunc(lua_State* L, lua_Table* dum, osg::AlphaFunc::ComparisonFunction func, float ref) : osg::AlphaFunc(func, ref), luna_wrapper_base(L) { register_protected_methods(L); };
	wrapper_osg_AlphaFunc(lua_State* L, lua_Table* dum, const osg::AlphaFunc & af, const osg::CopyOp & copyop = osg::CopyOp::SHALLOW_COPY) : osg::AlphaFunc(af, copyop), luna_wrapper_base(L) { register_protected_methods(L); };
