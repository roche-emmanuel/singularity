#ifndef _WRAPPERS_WRAPPER_OSG_ALPHAFUNC_H_
#define _WRAPPERS_WRAPPER_OSG_ALPHAFUNC_H_
...
public:
	...
	~wrapper_osg_AlphaFunc() {
		logDEBUG3("Calling delete function for wrapper osg_AlphaFunc");
		if(_obj.pushFunction("delete")) {
			//_obj.pushArg((osg::AlphaFunc*)this); // No this argument or the object will be referenced again!
			_obj.callFunction<void>();
		}
	};
	
	wrapper_osg_AlphaFunc(lua_State* L, lua_Table* dum) 
		: osg::AlphaFunc(), luna_wrapper_base(L) { 
		register_protected_methods(L); 
		if(_obj.pushFunction("buildInstance")) {
			_obj.pushArg((osg::AlphaFunc*)this);
			_obj.callFunction<void>();
		}
	};
	wrapper_osg_AlphaFunc(lua_State* L, lua_Table* dum, osg::AlphaFunc::ComparisonFunction func, float ref) 
		: osg::AlphaFunc(func, ref), luna_wrapper_base(L) { 
		register_protected_methods(L);
		if(_obj.pushFunction("buildInstance")) {
			_obj.pushArg((osg::AlphaFunc*)this);
			_obj.callFunction<void>();
	...
	wrapper_osg_AlphaFunc(lua_State* L, lua_Table* dum, const osg::AlphaFunc & af, const osg::CopyOp & copyop = osg::CopyOp::SHALLOW_COPY) 
		: osg::AlphaFunc(af, copyop), luna_wrapper_base(L) { 
		register_protected_methods(L);
		if(_obj.pushFunction("buildInstance")) {
			_obj.pushArg((osg::AlphaFunc*)this);
			_obj.callFunction<void>();
	...
	void setThreadSafeRefUnref(bool threadSafe) {
		...
		return AlphaFunc::setThreadSafeRefUnref(threadSafe);
	};
	...
	void computeDataVariance() {
		...
		return AlphaFunc::computeDataVariance();
	};
	...
	void setUserData(osg::Referenced * obj) {
		...
		return AlphaFunc::setUserData(obj);
	};
	...
	bool isTextureAttribute() const {
		...
		return AlphaFunc::isTextureAttribute();
	};
	...
	bool checkValidityOfAssociatedModes(osg::State & arg1) const {
		...
		return AlphaFunc::checkValidityOfAssociatedModes(arg1);
	};
	...
	void compileGLObjects(osg::State & arg1) const {
		...
		return AlphaFunc::compileGLObjects(arg1);
	};
	...
	void releaseGLObjects(osg::State * arg1 = 0) const {
		...
		return AlphaFunc::releaseGLObjects(arg1);
	};
	...
	bool isSameKindAs(const osg::Object * obj) const {
		...
		return AlphaFunc::isSameKindAs(obj);
	};
	...
	bool getModeUsage(osg::StateAttribute::ModeUsage & arg1) const {
		...
		return AlphaFunc::getModeUsage(arg1);
	};
	...
	static int _bind_public_addParent(lua_State *L) {
		...
		wrapper_osg_AlphaFunc* self=Luna< osg::Referenced >::checkSubType< wrapper_osg_AlphaFunc >(L,1);
		if(!self) {
			luna_printStack(L);
