...
public:
	...
	wrapper_osgUtil_RenderBin(lua_State* L, lua_Table* dum) : osgUtil::RenderBin(), luna_wrapper_base(L) { register_protected_methods(L); };
	wrapper_osgUtil_RenderBin(lua_State* L, lua_Table* dum, osgUtil::RenderBin::SortMode mode) : osgUtil::RenderBin(mode), luna_wrapper_base(L) { register_protected_methods(L); };
	wrapper_osgUtil_RenderBin(lua_State* L, lua_Table* dum, const osgUtil::RenderBin & rhs, const osg::CopyOp & copyop = osg::CopyOp::SHALLOW_COPY) : osgUtil::RenderBin(rhs, copyop), luna_wrapper_base(L) { register_protected_methods(L); };
