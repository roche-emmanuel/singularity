...
public:
	...
	wrapper_osg_TexEnv(lua_State* L, lua_Table* dum, osg::TexEnv::Mode mode = osg::TexEnv::MODULATE) : osg::TexEnv(mode), luna_wrapper_base(L) { register_protected_methods(L); };
	wrapper_osg_TexEnv(lua_State* L, lua_Table* dum, const osg::TexEnv & texenv, const osg::CopyOp & copyop = osg::CopyOp::SHALLOW_COPY) : osg::TexEnv(texenv, copyop), luna_wrapper_base(L) { register_protected_methods(L); };
