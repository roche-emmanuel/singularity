...
public:
	...
	wrapper_osgUtil_TriStripVisitor(lua_State* L, lua_Table* dum, osgUtil::Optimizer * optimizer = 0) : osgUtil::TriStripVisitor(optimizer), luna_wrapper_base(L) { register_protected_methods(L); };
