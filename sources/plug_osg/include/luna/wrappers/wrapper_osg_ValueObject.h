...
class wrapper_osg_ValueObject : public osg::ValueObject, public luna_wrapper_base {
...
public:
	...
	~wrapper_osg_ValueObject() {
		...
		if(_obj.pushFunction("delete")) {
			//_obj.pushArg((osg::ValueObject*)this); // No this argument or the object will be referenced again!
			_obj.callFunction<void>();
		}
	};
	
	wrapper_osg_ValueObject(lua_State* L, lua_Table* dum) 
		: osg::ValueObject(), luna_wrapper_base(L) { 
		register_protected_methods(L); 
		if(_obj.pushFunction("buildInstance")) {
			_obj.pushArg((osg::ValueObject*)this);
			_obj.callFunction<void>();
		}
	};
	wrapper_osg_ValueObject(lua_State* L, lua_Table* dum, const std::string & name) 
		: osg::ValueObject(name), luna_wrapper_base(L) { 
		register_protected_methods(L);
		if(_obj.pushFunction("buildInstance")) {
			_obj.pushArg((osg::ValueObject*)this);
			_obj.callFunction<void>();
	...
	wrapper_osg_ValueObject(lua_State* L, lua_Table* dum, const osg::ValueObject & rhs, const osg::CopyOp copyop = osg::CopyOp::SHALLOW_COPY) 
		: osg::ValueObject(rhs, copyop), luna_wrapper_base(L) { 
		register_protected_methods(L);
		if(_obj.pushFunction("buildInstance")) {
			_obj.pushArg((osg::ValueObject*)this);
			_obj.callFunction<void>();
	...
	void setThreadSafeRefUnref(bool threadSafe) {
		...
		return ValueObject::setThreadSafeRefUnref(threadSafe);
	};
	...
	static int _bind_public_signalObserversAndDelete(lua_State *L) {
		...
		wrapper_osg_ValueObject* self=Luna< osg::Referenced >::checkSubType< wrapper_osg_ValueObject >(L,1);
		if(!self) {
			luna_printStack(L);
