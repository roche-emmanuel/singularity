...
public:
	...
	~wrapper_osg_UniformBufferObject() {
		logDEBUG3("Calling delete function for wrapper osg_UniformBufferObject");
		if(_obj.pushFunction("delete")) {
			//_obj.pushArg((osg::UniformBufferObject*)this); // No this argument or the object will be referenced again!
			_obj.callFunction<void>();
		}
	};
	
	wrapper_osg_UniformBufferObject(lua_State* L, lua_Table* dum) 
		: osg::UniformBufferObject(), luna_wrapper_base(L) { 
		register_protected_methods(L); 
		if(_obj.pushFunction("buildInstance")) {
			_obj.pushArg((osg::UniformBufferObject*)this);
			_obj.callFunction<void>();
		}
	};
	wrapper_osg_UniformBufferObject(lua_State* L, lua_Table* dum, const osg::UniformBufferObject & ubo, const osg::CopyOp & copyop = osg::CopyOp::SHALLOW_COPY) 
		: osg::UniformBufferObject(ubo, copyop), luna_wrapper_base(L) { 
		register_protected_methods(L);
		if(_obj.pushFunction("buildInstance")) {
			_obj.pushArg((osg::UniformBufferObject*)this);
			_obj.callFunction<void>();
	...
	void setThreadSafeRefUnref(bool threadSafe) {
		...
		return UniformBufferObject::setThreadSafeRefUnref(threadSafe);
	};
	...
	static int _bind_public_signalObserversAndDelete(lua_State *L) {
		...
		wrapper_osg_UniformBufferObject* self=Luna< osg::Referenced >::checkSubType< wrapper_osg_UniformBufferObject >(L,1);
		if(!self) {
			luna_printStack(L);
