...
public:
	...
	wrapper_osg_UniformBufferObject(lua_State* L, lua_Table* dum) : osg::UniformBufferObject(), luna_wrapper_base(L) { register_protected_methods(L); };
	wrapper_osg_UniformBufferObject(lua_State* L, lua_Table* dum, const osg::UniformBufferObject & ubo, const osg::CopyOp & copyop = osg::CopyOp::SHALLOW_COPY) : osg::UniformBufferObject(ubo, copyop), luna_wrapper_base(L) { register_protected_methods(L); };
