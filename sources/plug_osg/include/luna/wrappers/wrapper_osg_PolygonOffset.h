...
public:
	...
	~wrapper_osg_PolygonOffset() {
		logDEBUG3("Calling delete function for wrapper osg_PolygonOffset");
		if(_obj.pushFunction("delete")) {
			//_obj.pushArg((osg::PolygonOffset*)this); // No this argument or the object will be referenced again!
			_obj.callFunction<void>();
		}
	};
	
	wrapper_osg_PolygonOffset(lua_State* L, lua_Table* dum) 
		: osg::PolygonOffset(), luna_wrapper_base(L) { 
		register_protected_methods(L); 
		if(_obj.pushFunction("buildInstance")) {
			_obj.pushArg((osg::PolygonOffset*)this);
			_obj.callFunction<void>();
		}
	};
	wrapper_osg_PolygonOffset(lua_State* L, lua_Table* dum, float factor, float units) 
		: osg::PolygonOffset(factor, units), luna_wrapper_base(L) { 
		register_protected_methods(L);
		if(_obj.pushFunction("buildInstance")) {
			_obj.pushArg((osg::PolygonOffset*)this);
			_obj.callFunction<void>();
	...
	wrapper_osg_PolygonOffset(lua_State* L, lua_Table* dum, const osg::PolygonOffset & po, const osg::CopyOp & copyop = osg::CopyOp::SHALLOW_COPY) 
		: osg::PolygonOffset(po, copyop), luna_wrapper_base(L) { 
		register_protected_methods(L);
		if(_obj.pushFunction("buildInstance")) {
			_obj.pushArg((osg::PolygonOffset*)this);
			_obj.callFunction<void>();
	...
	void setThreadSafeRefUnref(bool threadSafe) {
		...
		return PolygonOffset::setThreadSafeRefUnref(threadSafe);
	};
	...
	static int _bind_public_addParent(lua_State *L) {
		...
		wrapper_osg_PolygonOffset* self=Luna< osg::Referenced >::checkSubType< wrapper_osg_PolygonOffset >(L,1);
		if(!self) {
			luna_printStack(L);
