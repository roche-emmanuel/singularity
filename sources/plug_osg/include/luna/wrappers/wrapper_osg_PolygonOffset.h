...
public:
	...
	wrapper_osg_PolygonOffset(lua_State* L, lua_Table* dum) : osg::PolygonOffset(), luna_wrapper_base(L) { register_protected_methods(L); };
	wrapper_osg_PolygonOffset(lua_State* L, lua_Table* dum, float factor, float units) : osg::PolygonOffset(factor, units), luna_wrapper_base(L) { register_protected_methods(L); };
	wrapper_osg_PolygonOffset(lua_State* L, lua_Table* dum, const osg::PolygonOffset & po, const osg::CopyOp & copyop = osg::CopyOp::SHALLOW_COPY) : osg::PolygonOffset(po, copyop), luna_wrapper_base(L) { register_protected_methods(L); };
