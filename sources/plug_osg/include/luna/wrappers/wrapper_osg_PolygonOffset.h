...
public:
	...
	osg::Object * clone(const osg::CopyOp & arg1) const {
		...
		return osg::PolygonOffset::clone(arg1);
	};
	...
	bool isSameKindAs(const osg::Object * obj) const {
		...
		return osg::PolygonOffset::isSameKindAs(obj);
	};
	...
	int compare(const osg::StateAttribute & sa) const {
		...
		return osg::PolygonOffset::compare(sa);
	};
	...
	bool getModeUsage(osg::StateAttribute::ModeUsage & arg1) const {
		...
		return osg::PolygonOffset::getModeUsage(arg1);
	};
	...
	void apply(osg::State & arg1) const {
		...
		return osg::PolygonOffset::apply(arg1);
	};
