...
public:
	...
	~wrapper_osgGA_CameraViewSwitchManipulator() {
		logDEBUG3("Calling delete function for wrapper osgGA_CameraViewSwitchManipulator");
		if(_obj.pushFunction("delete")) {
			//_obj.pushArg((osgGA::CameraViewSwitchManipulator*)this); // No this argument or the object will be referenced again!
			_obj.callFunction<void>();
		}
	};
	
	wrapper_osgGA_CameraViewSwitchManipulator(lua_State* L, lua_Table* dum) 
		: osgGA::CameraViewSwitchManipulator(), luna_wrapper_base(L) { 
		register_protected_methods(L); 
		if(_obj.pushFunction("buildInstance")) {
			_obj.pushArg((osgGA::CameraViewSwitchManipulator*)this);
			_obj.callFunction<void>();
		}
	};
	...
	void setThreadSafeRefUnref(bool threadSafe) {
		...
		return CameraViewSwitchManipulator::setThreadSafeRefUnref(threadSafe);
	};
	...
	void updateCamera(osg::Camera & camera) {
		...
		return CameraViewSwitchManipulator::updateCamera(camera);
	};
