...
public:
	...
	wrapper_osg_LightSource(lua_State* L, lua_Table* dum) : osg::LightSource(), luna_wrapper_base(L) { register_protected_methods(L); };
	wrapper_osg_LightSource(lua_State* L, lua_Table* dum, const osg::LightSource & ls, const osg::CopyOp & copyop = osg::CopyOp::SHALLOW_COPY) : osg::LightSource(ls, copyop), luna_wrapper_base(L) { register_protected_methods(L); };
