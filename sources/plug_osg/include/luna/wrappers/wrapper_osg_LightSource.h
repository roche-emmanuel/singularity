...
class wrapper_osg_LightSource : public osg::LightSource {
protected:
	sgt::LuaObject _obj;
...
public:
	...
	wrapper_osg_LightSource(lua_State* L, lua_Table* dum) : osg::LightSource(), _obj(L,-1) {};
	wrapper_osg_LightSource(lua_State* L, lua_Table* dum, const osg::LightSource & ls, const osg::CopyOp & copyop = osg::CopyOp::SHALLOW_COPY) : osg::LightSource(ls, copyop), _obj(L,-1) {};
	...
	osg::Object * clone(const osg::CopyOp & copyop) const {
		...
		return osg::LightSource::clone(copyop);
	};
	...
	bool isSameKindAs(const osg::Object * obj) const {
		...
		return osg::LightSource::isSameKindAs(obj);
	};
	...
	void accept(osg::NodeVisitor & nv) {
		...
		return osg::LightSource::accept(nv);
	};
