...
public:
	...
	wrapper_osg_UniformBufferBinding(lua_State* L, lua_Table* dum) : osg::UniformBufferBinding(), luna_wrapper_base(L) { register_protected_methods(L); };
	wrapper_osg_UniformBufferBinding(lua_State* L, lua_Table* dum, unsigned int index) : osg::UniformBufferBinding(index), luna_wrapper_base(L) { register_protected_methods(L); };
