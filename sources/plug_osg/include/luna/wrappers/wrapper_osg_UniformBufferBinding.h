...
public:
	...
	~wrapper_osg_UniformBufferBinding() {
		logDEBUG3("Calling delete function for wrapper osg_UniformBufferBinding");
		if(_obj.pushFunction("delete")) {
			//_obj.pushArg((osg::UniformBufferBinding*)this); // No this argument or the object will be referenced again!
			_obj.callFunction<void>();
		}
	};
	
	wrapper_osg_UniformBufferBinding(lua_State* L, lua_Table* dum) 
		: osg::UniformBufferBinding(), luna_wrapper_base(L) { 
		register_protected_methods(L); 
		if(_obj.pushFunction("buildInstance")) {
			_obj.pushArg((osg::UniformBufferBinding*)this);
			_obj.callFunction<void>();
		}
	};
	wrapper_osg_UniformBufferBinding(lua_State* L, lua_Table* dum, unsigned int index) 
		: osg::UniformBufferBinding(index), luna_wrapper_base(L) { 
		register_protected_methods(L);
		if(_obj.pushFunction("buildInstance")) {
			_obj.pushArg((osg::UniformBufferBinding*)this);
			_obj.callFunction<void>();
	...
	wrapper_osg_UniformBufferBinding(lua_State* L, lua_Table* dum, unsigned int index, osg::BufferObject * bo, int offset, int size) 
		: osg::UniformBufferBinding(index, bo, offset, size), luna_wrapper_base(L) { 
		register_protected_methods(L);
		if(_obj.pushFunction("buildInstance")) {
			_obj.pushArg((osg::UniformBufferBinding*)this);
			_obj.callFunction<void>();
	...
	wrapper_osg_UniformBufferBinding(lua_State* L, lua_Table* dum, const osg::UniformBufferBinding & rhs, const osg::CopyOp & copyop = osg::CopyOp::SHALLOW_COPY) 
		: osg::UniformBufferBinding(rhs, copyop), luna_wrapper_base(L) { 
		register_protected_methods(L);
		if(_obj.pushFunction("buildInstance")) {
			_obj.pushArg((osg::UniformBufferBinding*)this);
			_obj.callFunction<void>();
	...
	void setThreadSafeRefUnref(bool threadSafe) {
		...
		return UniformBufferBinding::setThreadSafeRefUnref(threadSafe);
	};
	...
	static int _bind_public_addParent(lua_State *L) {
		...
		wrapper_osg_UniformBufferBinding* self=Luna< osg::Referenced >::checkSubType< wrapper_osg_UniformBufferBinding >(L,1);
		if(!self) {
			luna_printStack(L);
