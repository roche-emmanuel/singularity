...
public:
	...
	~wrapper_osgUtil_IncrementalCompileOperation_CompileCompletedCallback() {
		...
		if(_obj.pushFunction("delete")) {
			//_obj.pushArg((osgUtil::IncrementalCompileOperation::CompileCompletedCallback*)this); // No this argument or the object will be referenced again!
	...
	void setThreadSafeRefUnref(bool threadSafe) {
		if(_obj.pushFunction("setThreadSafeRefUnref")) {
			_obj.pushArg((osgUtil::IncrementalCompileOperation::CompileCompletedCallback*)this);
			_obj.pushArg(threadSafe);
			return (_obj.callFunction<void>());
		}

		return CompileCompletedCallback::setThreadSafeRefUnref(threadSafe);
	};
	...
	static int _bind_public_signalObserversAndDelete(lua_State *L) {
		...
		wrapper_osgUtil_IncrementalCompileOperation_CompileCompletedCallback* self=Luna< osg::Referenced >::checkSubType< wrapper_osgUtil_IncrementalCompileOperation_CompileCompletedCallback >(L,1);
		if(!self) {
			luna_printStack(L);
