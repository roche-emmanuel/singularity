...
public:
	...
	wrapper_osg_ClusterCullingCallback(lua_State* L, lua_Table* dum) : osg::ClusterCullingCallback(), luna_wrapper_base(L) { register_protected_methods(L); };
	wrapper_osg_ClusterCullingCallback(lua_State* L, lua_Table* dum, const osg::ClusterCullingCallback & ccc, const osg::CopyOp & copyop) : osg::ClusterCullingCallback(ccc, copyop), luna_wrapper_base(L) { register_protected_methods(L); };
