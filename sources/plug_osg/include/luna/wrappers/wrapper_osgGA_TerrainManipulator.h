#ifndef _WRAPPERS_WRAPPER_OSGGA_TERRAINMANIPULATOR_H_
#define _WRAPPERS_WRAPPER_OSGGA_TERRAINMANIPULATOR_H_
...
public:
	...
	~wrapper_osgGA_TerrainManipulator() {
		logDEBUG3("Calling delete function for wrapper osgGA_TerrainManipulator");
		if(_obj.pushFunction("delete")) {
			//_obj.pushArg((osgGA::TerrainManipulator*)this); // No this argument or the object will be referenced again!
			_obj.callFunction<void>();
		}
	};
	
	wrapper_osgGA_TerrainManipulator(lua_State* L, lua_Table* dum, int flags = osgGA::StandardManipulator::DEFAULT_SETTINGS) 
		: osgGA::TerrainManipulator(flags), luna_wrapper_base(L) { 
	...
	wrapper_osgGA_TerrainManipulator(lua_State* L, lua_Table* dum, const osgGA::TerrainManipulator & tm, const osg::CopyOp & copyOp = osg::CopyOp::SHALLOW_COPY) 
		: osgGA::TerrainManipulator(tm, copyOp), luna_wrapper_base(L) { 
		register_protected_methods(L);
		if(_obj.pushFunction("buildInstance")) {
			_obj.pushArg((osgGA::TerrainManipulator*)this);
			_obj.callFunction<void>();
...
public:
	...
	void setThreadSafeRefUnref(bool threadSafe) {
		...
		return TerrainManipulator::setThreadSafeRefUnref(threadSafe);
	};
	...
	void setName(const std::string & name) {
		...
		return TerrainManipulator::setName(name);
	};
	...
	void computeDataVariance() {
		...
		return TerrainManipulator::computeDataVariance();
	};
	...
	void setUserData(osg::Referenced * obj) {
		...
		return TerrainManipulator::setUserData(obj);
	};
	...
	osg::Referenced * getUserData() {
		...
		return TerrainManipulator::getUserData();
	};
	...
	void releaseGLObjects(osg::State * arg1 = 0) const {
		...
		return TerrainManipulator::releaseGLObjects(arg1);
	};
	...
	void event(osg::NodeVisitor * nv, osg::Drawable * drawable) {
		...
		return TerrainManipulator::event(nv, drawable);
	};
	...
	void operator()(osg::Node * node, osg::NodeVisitor * nv) {
		...
		return TerrainManipulator::operator()(node, nv);
	};
	...
	void setCoordinateFrameCallback(osgGA::CameraManipulator::CoordinateFrameCallback * cb) {
		...
		return TerrainManipulator::setCoordinateFrameCallback(cb);
	};
	...
	void updateCamera(osg::Camera & camera) {
		...
		return TerrainManipulator::updateCamera(camera);
	};
	...
	void setHomePosition(const osg::Vec3d & eye, const osg::Vec3d & center, const osg::Vec3d & up, bool autoComputeHomePosition = false) {
		...
		return TerrainManipulator::setHomePosition(eye, center, up, autoComputeHomePosition);
	};
	...
	void getHomePosition(osg::Vec3d & eye, osg::Vec3d & center, osg::Vec3d & up) const {
		...
		return TerrainManipulator::getHomePosition(eye, center, up);
	};
	...
	void setAutoComputeHomePosition(bool flag) {
		...
		return TerrainManipulator::setAutoComputeHomePosition(flag);
	};
	...
	void computeHomePosition(const osg::Camera * camera = NULL, bool useBoundingBox = false) {
		...
		return TerrainManipulator::computeHomePosition(camera, useBoundingBox);
	};
	...
	const osg::Node * getNode() const {
		...
		return TerrainManipulator::getNode();
	};
	...
	void setVerticalAxisFixed(bool value) {
		...
		return TerrainManipulator::setVerticalAxisFixed(value);
	};
	...
	void setAllowThrow(bool allowThrow) {
		...
		return TerrainManipulator::setAllowThrow(allowThrow);
	};
	...
	void setAnimationTime(const double t) {
		...
		return TerrainManipulator::setAnimationTime(t);
	};
	...
	void finishAnimation() {
		...
		return TerrainManipulator::finishAnimation();
	};
	...
	void home(const osgGA::GUIEventAdapter & arg1, osgGA::GUIActionAdapter & arg2) {
		...
		return TerrainManipulator::home(arg1, arg2);
	};
	...
	void home(double arg1) {
		...
		return TerrainManipulator::home(arg1);
	};
	...
	void init(const osgGA::GUIEventAdapter & arg1, osgGA::GUIActionAdapter & arg2) {
		...
		return TerrainManipulator::init(arg1, arg2);
	};
	...
	bool handle(const osgGA::GUIEventAdapter & ea, osgGA::GUIActionAdapter & us) {
		...
		return TerrainManipulator::handle(ea, us);
	};
	...
	void getUsage(osg::ApplicationUsage & arg1) const {
		...
		return TerrainManipulator::getUsage(arg1);
	};
	...
	void setByInverseMatrix(const osg::Matrixd & matrix) {
		...
		return TerrainManipulator::setByInverseMatrix(matrix);
	};
	...
	osg::Matrixd getMatrix() const {
		...
		return TerrainManipulator::getMatrix();
	};
	...
	osg::Matrixd getInverseMatrix() const {
		...
		return TerrainManipulator::getInverseMatrix();
	};
	...
	void getTransformation(osg::Vec3d & eye, osg::Quat & rotation) const {
		...
		return TerrainManipulator::getTransformation(eye, rotation);
	};
	...
	void getTransformation(osg::Vec3d & eye, osg::Vec3d & center, osg::Vec3d & up) const {
		...
		return TerrainManipulator::getTransformation(eye, center, up);
	};
	...
	void setCenter(const osg::Vec3d & center) {
		...
		return TerrainManipulator::setCenter(center);
	};
	...
	void setRotation(const osg::Quat & rotation) {
		...
		return TerrainManipulator::setRotation(rotation);
	};
	...
	void setDistance(double distance) {
		...
		return TerrainManipulator::setDistance(distance);
	};
	...
	void setTrackballSize(const double & size) {
		...
		return TerrainManipulator::setTrackballSize(size);
	};
	...
	void setWheelZoomFactor(double wheelZoomFactor) {
		...
		return TerrainManipulator::setWheelZoomFactor(wheelZoomFactor);
	};
	...
	void setMinimumDistance(const double & minimumDistance, bool relativeToModelSize = false) {
		...
		return TerrainManipulator::setMinimumDistance(minimumDistance, relativeToModelSize);
	};
	...
	osgUtil::SceneView::FusionDistanceMode getFusionDistanceMode() const {
		...
		return TerrainManipulator::getFusionDistanceMode();
	};
	...
	float getFusionDistanceValue() const {
		...
		return TerrainManipulator::getFusionDistanceValue();
	};
	...
	osg::Object * cloneType() const {
		...
		return TerrainManipulator::cloneType();
	};
	...
	osg::Object * clone(const osg::CopyOp & arg1) const {
		...
		return TerrainManipulator::clone(arg1);
	};
	...
	bool isSameKindAs(const osg::Object * obj) const {
		...
		return TerrainManipulator::isSameKindAs(obj);
	};
	...
	const char * libraryName() const {
		...
		return TerrainManipulator::libraryName();
	};
	...
	const char * className() const {
		...
		return TerrainManipulator::className();
	};
	...
	void setRotationMode(osgGA::TerrainManipulator::RotationMode mode) {
		...
		return TerrainManipulator::setRotationMode(mode);
	};
	...
	void setByMatrix(const osg::Matrixd & matrix) {
		...
		return TerrainManipulator::setByMatrix(matrix);
	};
	...
	void setTransformation(const osg::Vec3d & eye, const osg::Vec3d & center, const osg::Vec3d & up) {
		...
		return TerrainManipulator::setTransformation(eye, center, up);
	};
	...
	void setNode(osg::Node * arg1) {
		...
		return TerrainManipulator::setNode(arg1);
	};
	...
	bool public_intersect(const osg::Vec3d & start, const osg::Vec3d & end, osg::Vec3d & intersection) const {
		return osgGA::TerrainManipulator::intersect(start, end, intersection);
	};

	// void osgGA::TerrainManipulator::clampOrientation()
	void public_clampOrientation() {
		return osgGA::TerrainManipulator::clampOrientation();
	};
	...
	inline static bool _lg_typecheck_public_clampOrientation(lua_State *L) {
	...
	// bool osgGA::TerrainManipulator::public_intersect(const osg::Vec3d & start, const osg::Vec3d & end, osg::Vec3d & intersection) const
	static int _bind_public_intersect(lua_State *L) {
		if (!_lg_typecheck_public_intersect(L)) {
			luaL_error(L, "luna typecheck failed in bool osgGA::TerrainManipulator::public_intersect(const osg::Vec3d & start, const osg::Vec3d & end, osg::Vec3d & intersection) const function, expected prototype:\nbool osgGA::TerrainManipulator::public_intersect(const osg::Vec3d & start, const osg::Vec3d & end, osg::Vec3d & intersection) const\nClass arguments details:\narg 1 ID = 92303202\narg 2 ID = 92303202\narg 3 ID = 92303202\n\n%s",luna_dumpStack(L).c_str());
		}

		const osg::Vec3d* start_ptr=(Luna< osg::Vec3d >::check(L,2));
		if( !start_ptr ) {
			luaL_error(L, "Dereferencing NULL pointer for arg start in osgGA::TerrainManipulator::public_intersect function");
		}
		const osg::Vec3d & start=*start_ptr;
		const osg::Vec3d* end_ptr=(Luna< osg::Vec3d >::check(L,3));
		if( !end_ptr ) {
			luaL_error(L, "Dereferencing NULL pointer for arg end in osgGA::TerrainManipulator::public_intersect function");
		}
		const osg::Vec3d & end=*end_ptr;
		osg::Vec3d* intersection_ptr=(Luna< osg::Vec3d >::check(L,4));
		if( !intersection_ptr ) {
			luaL_error(L, "Dereferencing NULL pointer for arg intersection in osgGA::TerrainManipulator::public_intersect function");
		}
		...
		if(!self) {
			luaL_error(L, "Invalid object in function call bool osgGA::TerrainManipulator::public_intersect(const osg::Vec3d &, const osg::Vec3d &, osg::Vec3d &) const. Got : '%s'\n%s",typeid(Luna< osg::Referenced >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	// void osgGA::TerrainManipulator::public_clampOrientation()
	static int _bind_public_clampOrientation(lua_State *L) {
		if (!_lg_typecheck_public_clampOrientation(L)) {
			luaL_error(L, "luna typecheck failed in void osgGA::TerrainManipulator::public_clampOrientation() function, expected prototype:\nvoid osgGA::TerrainManipulator::public_clampOrientation()\nClass arguments details:\n\n%s",luna_dumpStack(L).c_str());
		}


		wrapper_osgGA_TerrainManipulator* self=Luna< osg::Referenced >::checkSubType< wrapper_osgGA_TerrainManipulator >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void osgGA::TerrainManipulator::public_clampOrientation(). Got : '%s'\n%s",typeid(Luna< osg::Referenced >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	void register_protected_methods(lua_State* L) {
		...
		{"clampOrientation",_bind_public_clampOrientation},
