...
public:
	...
	wrapper_osg_BlendEquation(lua_State* L, lua_Table* dum) : osg::BlendEquation(), luna_wrapper_base(L) { register_protected_methods(L); };
	wrapper_osg_BlendEquation(lua_State* L, lua_Table* dum, osg::BlendEquation::Equation equation) : osg::BlendEquation(equation), luna_wrapper_base(L) { register_protected_methods(L); };
