...
public:
	...
	~wrapper_osg_BlendEquation() {
		logDEBUG3("Calling delete function for wrapper osg_BlendEquation");
		if(_obj.pushFunction("delete")) {
			//_obj.pushArg((osg::BlendEquation*)this); // No this argument or the object will be referenced again!
			_obj.callFunction<void>();
		}
	};
	
	wrapper_osg_BlendEquation(lua_State* L, lua_Table* dum) 
		: osg::BlendEquation(), luna_wrapper_base(L) { 
		register_protected_methods(L); 
		if(_obj.pushFunction("buildInstance")) {
			_obj.pushArg((osg::BlendEquation*)this);
			_obj.callFunction<void>();
		}
	};
	wrapper_osg_BlendEquation(lua_State* L, lua_Table* dum, osg::BlendEquation::Equation equation) 
		: osg::BlendEquation(equation), luna_wrapper_base(L) { 
		register_protected_methods(L);
		if(_obj.pushFunction("buildInstance")) {
			_obj.pushArg((osg::BlendEquation*)this);
			_obj.callFunction<void>();
	...
	wrapper_osg_BlendEquation(lua_State* L, lua_Table* dum, osg::BlendEquation::Equation equationRGB, osg::BlendEquation::Equation equationAlpha) 
		: osg::BlendEquation(equationRGB, equationAlpha), luna_wrapper_base(L) { 
		register_protected_methods(L);
		if(_obj.pushFunction("buildInstance")) {
			_obj.pushArg((osg::BlendEquation*)this);
			_obj.callFunction<void>();
	...
	wrapper_osg_BlendEquation(lua_State* L, lua_Table* dum, const osg::BlendEquation & trans, const osg::CopyOp & copyop = osg::CopyOp::SHALLOW_COPY) 
		: osg::BlendEquation(trans, copyop), luna_wrapper_base(L) { 
		register_protected_methods(L);
		if(_obj.pushFunction("buildInstance")) {
			_obj.pushArg((osg::BlendEquation*)this);
			_obj.callFunction<void>();
	...
	void setThreadSafeRefUnref(bool threadSafe) {
		...
		return BlendEquation::setThreadSafeRefUnref(threadSafe);
	};
	...
	static int _bind_public_addParent(lua_State *L) {
		...
		wrapper_osg_BlendEquation* self=Luna< osg::Referenced >::checkSubType< wrapper_osg_BlendEquation >(L,1);
		if(!self) {
			luna_printStack(L);
