...
public:
	...
	void setThreadSafeRefUnref(bool threadSafe) {
		...
		return EventCallback::setThreadSafeRefUnref(threadSafe);
	};
	...
	static int _bind_public_signalObserversAndDelete(lua_State *L) {
		...
		wrapper_osg_Drawable_EventCallback* self=Luna< osg::Referenced >::checkSubType< wrapper_osg_Drawable_EventCallback >(L,1);
		if(!self) {
			luna_printStack(L);
