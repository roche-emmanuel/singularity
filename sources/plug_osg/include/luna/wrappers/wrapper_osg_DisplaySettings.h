...
public:
	...
	void setThreadSafeRefUnref(bool threadSafe) {
		...
		return DisplaySettings::setThreadSafeRefUnref(threadSafe);
	};
	...
	static int _bind_public_signalObserversAndDelete(lua_State *L) {
		...
		wrapper_osg_DisplaySettings* self=Luna< osg::Referenced >::checkSubType< wrapper_osg_DisplaySettings >(L,1);
		if(!self) {
			luna_printStack(L);
