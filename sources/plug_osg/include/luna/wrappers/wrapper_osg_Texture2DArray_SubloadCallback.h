...
public:
	...
	wrapper_osg_Texture2DArray_SubloadCallback(lua_State* L, lua_Table* dum) : osg::Texture2DArray::SubloadCallback(), luna_wrapper_base(L) { register_protected_methods(L); };
