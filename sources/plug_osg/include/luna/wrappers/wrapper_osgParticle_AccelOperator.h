...
class wrapper_osgParticle_AccelOperator : public osgParticle::AccelOperator {
protected:
	sgt::LuaObject _obj;
...
public:
	...
	wrapper_osgParticle_AccelOperator(lua_State* L, lua_Table* dum) : osgParticle::AccelOperator(), _obj(L,-1) {};
	wrapper_osgParticle_AccelOperator(lua_State* L, lua_Table* dum, const osgParticle::AccelOperator & copy, const osg::CopyOp & copyop = osg::CopyOp::SHALLOW_COPY) : osgParticle::AccelOperator(copy, copyop), _obj(L,-1) {};
	...
	osg::Object * cloneType() const {
		...
		return osgParticle::AccelOperator::cloneType();
	};
	...
	osg::Object * clone(const osg::CopyOp & arg1) const {
		...
		return osgParticle::AccelOperator::clone(arg1);
	};
	...
	bool isSameKindAs(const osg::Object * obj) const {
		...
		return osgParticle::AccelOperator::isSameKindAs(obj);
	};
	...
	const char * libraryName() const {
		...
		return osgParticle::AccelOperator::libraryName();
	};
	...
	const char * className() const {
		...
		return osgParticle::AccelOperator::className();
	};
	...
	void operate(osgParticle::Particle * P, double dt) {
		...
		return osgParticle::AccelOperator::operate(P, dt);
	};
	...
	void beginOperate(osgParticle::Program * prg) {
		...
		return osgParticle::AccelOperator::beginOperate(prg);
	};
