...
public:
	...
	wrapper_osg_Node_ComputeBoundingSphereCallback(lua_State* L, lua_Table* dum) : osg::Node::ComputeBoundingSphereCallback(), luna_wrapper_base(L) { register_protected_methods(L); };
	wrapper_osg_Node_ComputeBoundingSphereCallback(lua_State* L, lua_Table* dum, const osg::Node::ComputeBoundingSphereCallback & arg1, const osg::CopyOp & arg2) : osg::Node::ComputeBoundingSphereCallback(arg1, arg2), luna_wrapper_base(L) { register_protected_methods(L); };
