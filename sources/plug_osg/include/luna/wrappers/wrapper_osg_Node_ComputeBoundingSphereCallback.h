...
public:
	...
	~wrapper_osg_Node_ComputeBoundingSphereCallback() {
		logDEBUG3("Calling delete function for wrapper osg_Node_ComputeBoundingSphereCallback");
		if(_obj.pushFunction("delete")) {
			//_obj.pushArg((osg::Node::ComputeBoundingSphereCallback*)this); // No this argument or the object will be referenced again!
			_obj.callFunction<void>();
		}
	};
	
	wrapper_osg_Node_ComputeBoundingSphereCallback(lua_State* L, lua_Table* dum) 
		: osg::Node::ComputeBoundingSphereCallback(), luna_wrapper_base(L) { 
		register_protected_methods(L); 
		if(_obj.pushFunction("buildInstance")) {
			_obj.pushArg((osg::Node::ComputeBoundingSphereCallback*)this);
			_obj.callFunction<void>();
		}
	};
	wrapper_osg_Node_ComputeBoundingSphereCallback(lua_State* L, lua_Table* dum, const osg::Node::ComputeBoundingSphereCallback & arg1, const osg::CopyOp & arg2) 
		: osg::Node::ComputeBoundingSphereCallback(arg1, arg2), luna_wrapper_base(L) { 
		register_protected_methods(L);
		if(_obj.pushFunction("buildInstance")) {
			_obj.pushArg((osg::Node::ComputeBoundingSphereCallback*)this);
			_obj.callFunction<void>();
	...
	void setThreadSafeRefUnref(bool threadSafe) {
		...
		return ComputeBoundingSphereCallback::setThreadSafeRefUnref(threadSafe);
	};
	...
	static int _bind_public_signalObserversAndDelete(lua_State *L) {
		...
		wrapper_osg_Node_ComputeBoundingSphereCallback* self=Luna< osg::Referenced >::checkSubType< wrapper_osg_Node_ComputeBoundingSphereCallback >(L,1);
		if(!self) {
			luna_printStack(L);
