...
public:
	...
	~wrapper_osgParticle_Counter() {
		logDEBUG3("Calling delete function for wrapper osgParticle_Counter");
		if(_obj.pushFunction("delete")) {
			//_obj.pushArg((osgParticle::Counter*)this); // No this argument or the object will be referenced again!
			_obj.callFunction<void>();
		}
	};
	
	wrapper_osgParticle_Counter(lua_State* L, lua_Table* dum) 
		: osgParticle::Counter(), luna_wrapper_base(L) { 
		register_protected_methods(L); 
		if(_obj.pushFunction("buildInstance")) {
			_obj.pushArg((osgParticle::Counter*)this);
			_obj.callFunction<void>();
		}
	};
	wrapper_osgParticle_Counter(lua_State* L, lua_Table* dum, const osgParticle::Counter & copy, const osg::CopyOp & copyop = osg::CopyOp::SHALLOW_COPY) 
		: osgParticle::Counter(copy, copyop), luna_wrapper_base(L) { 
		register_protected_methods(L);
		if(_obj.pushFunction("buildInstance")) {
			_obj.pushArg((osgParticle::Counter*)this);
			_obj.callFunction<void>();
	...
	void setThreadSafeRefUnref(bool threadSafe) {
		...
		return Counter::setThreadSafeRefUnref(threadSafe);
	};
