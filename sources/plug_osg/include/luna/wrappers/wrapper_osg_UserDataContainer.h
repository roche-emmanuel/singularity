...
class wrapper_osg_UserDataContainer : public osg::UserDataContainer {
protected:
	sgt::LuaObject _obj;
...
public:
	...
	wrapper_osg_UserDataContainer(lua_State* L, lua_Table* dum) : osg::UserDataContainer(), _obj(L,-1) {};
	wrapper_osg_UserDataContainer(lua_State* L, lua_Table* dum, const osg::UserDataContainer & udc, const osg::CopyOp & copyop = osg::CopyOp::SHALLOW_COPY) : osg::UserDataContainer(udc, copyop), _obj(L,-1) {};
