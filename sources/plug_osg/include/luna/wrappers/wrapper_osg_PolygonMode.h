...
public:
	...
	~wrapper_osg_PolygonMode() {
		logDEBUG3("Calling delete function for wrapper osg_PolygonMode");
		if(_obj.pushFunction("delete")) {
			//_obj.pushArg((osg::PolygonMode*)this); // No this argument or the object will be referenced again!
			_obj.callFunction<void>();
		}
	};
	
	wrapper_osg_PolygonMode(lua_State* L, lua_Table* dum) 
		: osg::PolygonMode(), luna_wrapper_base(L) { 
		register_protected_methods(L); 
		if(_obj.pushFunction("buildInstance")) {
			_obj.pushArg((osg::PolygonMode*)this);
			_obj.callFunction<void>();
		}
	};
	wrapper_osg_PolygonMode(lua_State* L, lua_Table* dum, osg::PolygonMode::Face face, osg::PolygonMode::Mode mode) 
		: osg::PolygonMode(face, mode), luna_wrapper_base(L) { 
		register_protected_methods(L);
		if(_obj.pushFunction("buildInstance")) {
			_obj.pushArg((osg::PolygonMode*)this);
			_obj.callFunction<void>();
	...
	wrapper_osg_PolygonMode(lua_State* L, lua_Table* dum, const osg::PolygonMode & pm, const osg::CopyOp & copyop = osg::CopyOp::SHALLOW_COPY) 
		: osg::PolygonMode(pm, copyop), luna_wrapper_base(L) { 
		register_protected_methods(L);
		if(_obj.pushFunction("buildInstance")) {
			_obj.pushArg((osg::PolygonMode*)this);
			_obj.callFunction<void>();
	...
	void setThreadSafeRefUnref(bool threadSafe) {
		...
		return PolygonMode::setThreadSafeRefUnref(threadSafe);
	};
	...
	static int _bind_public_addParent(lua_State *L) {
		...
		wrapper_osg_PolygonMode* self=Luna< osg::Referenced >::checkSubType< wrapper_osg_PolygonMode >(L,1);
		if(!self) {
			luna_printStack(L);
