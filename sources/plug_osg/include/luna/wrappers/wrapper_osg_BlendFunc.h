...
public:
	...
	~wrapper_osg_BlendFunc() {
		logDEBUG3("Calling delete function for wrapper osg_BlendFunc");
		if(_obj.pushFunction("delete")) {
			//_obj.pushArg((osg::BlendFunc*)this); // No this argument or the object will be referenced again!
			_obj.callFunction<void>();
		}
	};
	
	wrapper_osg_BlendFunc(lua_State* L, lua_Table* dum) 
		: osg::BlendFunc(), luna_wrapper_base(L) { 
		register_protected_methods(L); 
		if(_obj.pushFunction("buildInstance")) {
			_obj.pushArg((osg::BlendFunc*)this);
			_obj.callFunction<void>();
		}
	};
	wrapper_osg_BlendFunc(lua_State* L, lua_Table* dum, unsigned int source, unsigned int destination) 
		: osg::BlendFunc(source, destination), luna_wrapper_base(L) { 
		register_protected_methods(L);
		if(_obj.pushFunction("buildInstance")) {
			_obj.pushArg((osg::BlendFunc*)this);
			_obj.callFunction<void>();
	...
	wrapper_osg_BlendFunc(lua_State* L, lua_Table* dum, unsigned int source, unsigned int destination, unsigned int source_alpha, unsigned int destination_alpha) 
		: osg::BlendFunc(source, destination, source_alpha, destination_alpha), luna_wrapper_base(L) { 
		register_protected_methods(L);
		if(_obj.pushFunction("buildInstance")) {
			_obj.pushArg((osg::BlendFunc*)this);
			_obj.callFunction<void>();
	...
	wrapper_osg_BlendFunc(lua_State* L, lua_Table* dum, const osg::BlendFunc & trans, const osg::CopyOp & copyop = osg::CopyOp::SHALLOW_COPY) 
		: osg::BlendFunc(trans, copyop), luna_wrapper_base(L) { 
		register_protected_methods(L);
		if(_obj.pushFunction("buildInstance")) {
			_obj.pushArg((osg::BlendFunc*)this);
			_obj.callFunction<void>();
	...
	void setThreadSafeRefUnref(bool threadSafe) {
		...
		return BlendFunc::setThreadSafeRefUnref(threadSafe);
	};
