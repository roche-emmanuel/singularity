...
public:
	...
	wrapper_osg_BlendFunc(lua_State* L, lua_Table* dum) : osg::BlendFunc(), luna_wrapper_base(L) { register_protected_methods(L); };
	wrapper_osg_BlendFunc(lua_State* L, lua_Table* dum, unsigned int source, unsigned int destination) : osg::BlendFunc(source, destination), luna_wrapper_base(L) { register_protected_methods(L); };
