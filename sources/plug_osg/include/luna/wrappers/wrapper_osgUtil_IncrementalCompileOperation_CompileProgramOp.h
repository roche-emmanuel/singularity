...
public:
	...
	void setThreadSafeRefUnref(bool threadSafe) {
		...
		return CompileProgramOp::setThreadSafeRefUnref(threadSafe);
	};
	...
	static int _bind_public_signalObserversAndDelete(lua_State *L) {
		...
		wrapper_osgUtil_IncrementalCompileOperation_CompileProgramOp* self=Luna< osg::Referenced >::checkSubType< wrapper_osgUtil_IncrementalCompileOperation_CompileProgramOp >(L,1);
		if(!self) {
			luna_printStack(L);
