...
public:
	...
	wrapper_osg_OccluderNode(lua_State* L, lua_Table* dum) : osg::OccluderNode(), luna_wrapper_base(L) { register_protected_methods(L); };
	wrapper_osg_OccluderNode(lua_State* L, lua_Table* dum, const osg::OccluderNode & arg1, const osg::CopyOp & copyop = osg::CopyOp::SHALLOW_COPY) : osg::OccluderNode(arg1, copyop), luna_wrapper_base(L) { register_protected_methods(L); };
