...
public:
	...
	~wrapper_osg_Texture1D() {
		...
		if(_obj.pushFunction("delete")) {
			//_obj.pushArg((osg::Texture1D*)this); // No this argument or the object will be referenced again!
			_obj.callFunction<void>();
		}
	};
	
	wrapper_osg_Texture1D(lua_State* L, lua_Table* dum) 
		: osg::Texture1D(), luna_wrapper_base(L) { 
		register_protected_methods(L); 
		if(_obj.pushFunction("buildInstance")) {
			_obj.pushArg((osg::Texture1D*)this);
			_obj.callFunction<void>();
		}
	};
	wrapper_osg_Texture1D(lua_State* L, lua_Table* dum, osg::Image * image) 
		: osg::Texture1D(image), luna_wrapper_base(L) { 
		register_protected_methods(L);
		if(_obj.pushFunction("buildInstance")) {
			_obj.pushArg((osg::Texture1D*)this);
			_obj.callFunction<void>();
	...
	wrapper_osg_Texture1D(lua_State* L, lua_Table* dum, const osg::Texture1D & text, const osg::CopyOp & copyop = osg::CopyOp::SHALLOW_COPY) 
		: osg::Texture1D(text, copyop), luna_wrapper_base(L) { 
		register_protected_methods(L);
		if(_obj.pushFunction("buildInstance")) {
			_obj.pushArg((osg::Texture1D*)this);
			_obj.callFunction<void>();
...
public:
	...
	void setThreadSafeRefUnref(bool threadSafe) {
		...
		return Texture1D::setThreadSafeRefUnref(threadSafe);
	};
	...
	void computeDataVariance() {
		...
		return Texture1D::computeDataVariance();
	};
	...
	void setUserData(osg::Referenced * obj) {
		...
		return Texture1D::setUserData(obj);
	};
	...
	bool checkValidityOfAssociatedModes(osg::State & arg1) const {
		...
		return Texture1D::checkValidityOfAssociatedModes(arg1);
	};
	...
	bool isTextureAttribute() const {
		...
		return Texture1D::isTextureAttribute();
	};
	...
	bool getModeUsage(osg::StateAttribute::ModeUsage & arg1) const {
		...
		return Texture1D::getModeUsage(arg1);
	};
	...
	void compileGLObjects(osg::State & state) const {
		...
		return Texture1D::compileGLObjects(state);
	};
	...
	void releaseGLObjects(osg::State * state = 0) const {
		...
		return Texture1D::releaseGLObjects(state);
	};
	...
	bool isSameKindAs(const osg::Object * obj) const {
		...
		return Texture1D::isSameKindAs(obj);
	};
	...
	unsigned int getTextureTarget() const {
		...
		return Texture1D::getTextureTarget();
	};
	...
	void setImage(unsigned int arg1, osg::Image * image) {
		...
		return Texture1D::setImage(arg1, image);
	};
	...
	osg::Image * getImage(unsigned int arg1) {
		...
		return Texture1D::getImage(arg1);
	};
	...
	int getTextureDepth() const {
		...
		return Texture1D::getTextureDepth();
	};
	...
	void public_applyTexImage1D(unsigned int target, osg::Image * image, osg::State & state, int & width, int & numMipmapLevels) const {
		return osg::Texture1D::applyTexImage1D(target, image, state, width, numMipmapLevels);
	};
	...
	inline static bool _lg_typecheck_public_applyTexImage1D(lua_State *L) {
	...
	// void osg::Texture1D::public_applyTexImage1D(unsigned int target, osg::Image * image, osg::State & state, int & width, int & numMipmapLevels) const
	static int _bind_public_applyTexImage1D(lua_State *L) {
		if (!_lg_typecheck_public_applyTexImage1D(L)) {
			luna_printStack(L);
			luaL_error(L, "luna typecheck failed in void osg::Texture1D::public_applyTexImage1D(unsigned int target, osg::Image * image, osg::State & state, int & width, int & numMipmapLevels) const function, expected prototype:\nvoid osg::Texture1D::public_applyTexImage1D(unsigned int target, osg::Image * image, osg::State & state, int & width, int & numMipmapLevels) const\nClass arguments details:\narg 2 ID = 50169651\narg 3 ID = 50169651\n");
		}
		...
		if( !state_ptr ) {
			luaL_error(L, "Dereferencing NULL pointer for arg state in osg::Texture1D::public_applyTexImage1D function");
		}
		osg::State & state=*state_ptr;
		int width=(int)lua_tointeger(L,5);
		int numMipmapLevels=(int)lua_tointeger(L,6);

		wrapper_osg_Texture1D* self=Luna< osg::Referenced >::checkSubType< wrapper_osg_Texture1D >(L,1);
		if(!self) {
			luna_printStack(L);
			luaL_error(L, "Invalid object in function call void osg::Texture1D::public_applyTexImage1D(unsigned int, osg::Image *, osg::State &, int &, int &) const. Got : '%s'",typeid(Luna< osg::Referenced >::check(L,1)).name());
		}
		self->public_applyTexImage1D(target, image, state, width, numMipmapLevels);
