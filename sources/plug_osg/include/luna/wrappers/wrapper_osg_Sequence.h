...
class wrapper_osg_Sequence : public osg::Sequence {
protected:
	sgt::LuaObject _obj;
...
public:
	...
	wrapper_osg_Sequence(lua_State* L, lua_Table* dum) : osg::Sequence(), _obj(L,-1) {};
	wrapper_osg_Sequence(lua_State* L, lua_Table* dum, const osg::Sequence & arg1, const osg::CopyOp & copyop = osg::CopyOp::SHALLOW_COPY) : osg::Sequence(arg1, copyop), _obj(L,-1) {};
	...
	osg::Object * clone(const osg::CopyOp & copyop) const {
		...
		return osg::Sequence::clone(copyop);
	};
	...
	bool isSameKindAs(const osg::Object * obj) const {
		...
		return osg::Sequence::isSameKindAs(obj);
	};
	...
	void traverse(osg::NodeVisitor & arg1) {
		...
		return osg::Sequence::traverse(arg1);
	};
	...
	bool addChild(osg::Node * child, double t) {
		...
		return osg::Sequence::addChild(child, t);
	};
	...
	bool insertChild(unsigned int index, osg::Node * child) {
		...
		return osg::Sequence::insertChild(index, child);
	};
	...
	bool insertChild(unsigned int index, osg::Node * child, double t) {
		...
		return osg::Sequence::insertChild(index, child, t);
	};
	...
	bool removeChild(osg::Node * child) {
		...
		return osg::Sequence::removeChild(child);
	};
