...
public:
	...
	void setThreadSafeRefUnref(bool threadSafe) {
		...
		return DeprecatedDotOsgWrapperManager::setThreadSafeRefUnref(threadSafe);
	};
	...
	static int _bind_public_signalObserversAndDelete(lua_State *L) {
		...
		wrapper_osgDB_DeprecatedDotOsgWrapperManager* self=Luna< osg::Referenced >::checkSubType< wrapper_osgDB_DeprecatedDotOsgWrapperManager >(L,1);
		if(!self) {
			luna_printStack(L);
