...
public:
	...
	wrapper_osg_Shader(lua_State* L, lua_Table* dum, osg::Shader::Type type = osg::Shader::UNDEFINED) : osg::Shader(type), luna_wrapper_base(L) { register_protected_methods(L); };
	wrapper_osg_Shader(lua_State* L, lua_Table* dum, osg::Shader::Type type, const std::string & source) : osg::Shader(type, source), luna_wrapper_base(L) { register_protected_methods(L); };
