...
class wrapper_osg_StateAttributeCallback : public osg::StateAttributeCallback, public luna_wrapper_base {

public:
	

	wrapper_osg_StateAttributeCallback(lua_State* L, lua_Table* dum) : osg::StateAttributeCallback(), luna_wrapper_base(L) {};
	wrapper_osg_StateAttributeCallback(lua_State* L, lua_Table* dum, const osg::StateAttributeCallback & arg1, const osg::CopyOp & arg2) : osg::StateAttributeCallback(arg1, arg2), luna_wrapper_base(L) {};
