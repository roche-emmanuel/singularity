...
public:
	...
	wrapper_osg_LightModel(lua_State* L, lua_Table* dum) : osg::LightModel(), luna_wrapper_base(L) { register_protected_methods(L); };
	wrapper_osg_LightModel(lua_State* L, lua_Table* dum, const osg::LightModel & lw, const osg::CopyOp & copyop = osg::CopyOp::SHALLOW_COPY) : osg::LightModel(lw, copyop), luna_wrapper_base(L) { register_protected_methods(L); };
