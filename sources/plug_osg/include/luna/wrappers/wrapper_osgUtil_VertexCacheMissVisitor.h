...
public:
	...
	wrapper_osgUtil_VertexCacheMissVisitor(lua_State* L, lua_Table* dum, unsigned int cacheSize = 16) : osgUtil::VertexCacheMissVisitor(cacheSize), luna_wrapper_base(L) { register_protected_methods(L); };
