...
public:
	...
	~wrapper_osg_CullFace() {
		logDEBUG3("Calling delete function for wrapper osg_CullFace");
		if(_obj.pushFunction("delete")) {
			//_obj.pushArg((osg::CullFace*)this); // No this argument or the object will be referenced again!
			_obj.callFunction<void>();
		}
	};
	
	wrapper_osg_CullFace(lua_State* L, lua_Table* dum, osg::CullFace::Mode mode = osg::CullFace::BACK) 
		: osg::CullFace(mode), luna_wrapper_base(L) { 
		register_protected_methods(L);
		if(_obj.pushFunction("buildInstance")) {
			_obj.pushArg((osg::CullFace*)this);
			_obj.callFunction<void>();
		}
	};
	wrapper_osg_CullFace(lua_State* L, lua_Table* dum, const osg::CullFace & cf, const osg::CopyOp & copyop = osg::CopyOp::SHALLOW_COPY) 
		: osg::CullFace(cf, copyop), luna_wrapper_base(L) { 
		register_protected_methods(L);
		if(_obj.pushFunction("buildInstance")) {
			_obj.pushArg((osg::CullFace*)this);
			_obj.callFunction<void>();
	...
	void setThreadSafeRefUnref(bool threadSafe) {
		...
		return CullFace::setThreadSafeRefUnref(threadSafe);
	};
	...
	static int _bind_public_addParent(lua_State *L) {
		...
		wrapper_osg_CullFace* self=Luna< osg::Referenced >::checkSubType< wrapper_osg_CullFace >(L,1);
		if(!self) {
			luna_printStack(L);
