...
public:
	...
	wrapper_osg_Billboard(lua_State* L, lua_Table* dum) : osg::Billboard(), luna_wrapper_base(L) {};
	wrapper_osg_Billboard(lua_State* L, lua_Table* dum, const osg::Billboard & arg1, const osg::CopyOp & copyop = osg::CopyOp::SHALLOW_COPY) : osg::Billboard(arg1, copyop), luna_wrapper_base(L) {};
