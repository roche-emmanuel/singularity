...
public:
	...
	wrapper_osg_Multisample(lua_State* L, lua_Table* dum) : osg::Multisample(), luna_wrapper_base(L) { register_protected_methods(L); };
	wrapper_osg_Multisample(lua_State* L, lua_Table* dum, const osg::Multisample & trans, const osg::CopyOp & copyop = osg::CopyOp::SHALLOW_COPY) : osg::Multisample(trans, copyop), luna_wrapper_base(L) { register_protected_methods(L); };
