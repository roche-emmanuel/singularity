...
public:
	...
	wrapper_osg_LineWidth(lua_State* L, lua_Table* dum, float width = 1.0f) : osg::LineWidth(width), luna_wrapper_base(L) { register_protected_methods(L); };
	wrapper_osg_LineWidth(lua_State* L, lua_Table* dum, const osg::LineWidth & lw, const osg::CopyOp & copyop = osg::CopyOp::SHALLOW_COPY) : osg::LineWidth(lw, copyop), luna_wrapper_base(L) { register_protected_methods(L); };
