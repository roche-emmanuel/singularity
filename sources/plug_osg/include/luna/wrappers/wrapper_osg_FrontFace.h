...
public:
	...
	wrapper_osg_FrontFace(lua_State* L, lua_Table* dum, osg::FrontFace::Mode face = osg::FrontFace::COUNTER_CLOCKWISE) : osg::FrontFace(face), luna_wrapper_base(L) { register_protected_methods(L); };
	wrapper_osg_FrontFace(lua_State* L, lua_Table* dum, const osg::FrontFace & ff, const osg::CopyOp & copyop = osg::CopyOp::SHALLOW_COPY) : osg::FrontFace(ff, copyop), luna_wrapper_base(L) { register_protected_methods(L); };
