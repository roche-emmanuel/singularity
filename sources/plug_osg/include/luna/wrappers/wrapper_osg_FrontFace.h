#ifndef _WRAPPERS_WRAPPER_OSG_FRONTFACE_H_
#define _WRAPPERS_WRAPPER_OSG_FRONTFACE_H_
...
public:
	...
	~wrapper_osg_FrontFace() {
		logDEBUG3("Calling delete function for wrapper osg_FrontFace");
		if(_obj.pushFunction("delete")) {
			//_obj.pushArg((osg::FrontFace*)this); // No this argument or the object will be referenced again!
			_obj.callFunction<void>();
		}
	};
	
	wrapper_osg_FrontFace(lua_State* L, lua_Table* dum, osg::FrontFace::Mode face = osg::FrontFace::COUNTER_CLOCKWISE) 
		: osg::FrontFace(face), luna_wrapper_base(L) { 
		register_protected_methods(L);
		if(_obj.pushFunction("buildInstance")) {
			_obj.pushArg((osg::FrontFace*)this);
			_obj.callFunction<void>();
		}
	};
	wrapper_osg_FrontFace(lua_State* L, lua_Table* dum, const osg::FrontFace & ff, const osg::CopyOp & copyop = osg::CopyOp::SHALLOW_COPY) 
		: osg::FrontFace(ff, copyop), luna_wrapper_base(L) { 
		register_protected_methods(L);
		if(_obj.pushFunction("buildInstance")) {
			_obj.pushArg((osg::FrontFace*)this);
			_obj.callFunction<void>();
	...
	void setThreadSafeRefUnref(bool threadSafe) {
		...
		return FrontFace::setThreadSafeRefUnref(threadSafe);
	};
	...
	void computeDataVariance() {
		...
		return FrontFace::computeDataVariance();
	};
	...
	void setUserData(osg::Referenced * obj) {
		...
		return FrontFace::setUserData(obj);
	};
	...
	bool isTextureAttribute() const {
		...
		return FrontFace::isTextureAttribute();
	};
	...
	bool getModeUsage(osg::StateAttribute::ModeUsage & arg1) const {
		...
		return FrontFace::getModeUsage(arg1);
	};
	...
	bool checkValidityOfAssociatedModes(osg::State & arg1) const {
		...
		return FrontFace::checkValidityOfAssociatedModes(arg1);
	};
	...
	void compileGLObjects(osg::State & arg1) const {
		...
		return FrontFace::compileGLObjects(arg1);
	};
	...
	void releaseGLObjects(osg::State * arg1 = 0) const {
		...
		return FrontFace::releaseGLObjects(arg1);
	};
	...
	bool isSameKindAs(const osg::Object * obj) const {
		...
		return FrontFace::isSameKindAs(obj);
	};
	...
	static int _bind_public_addParent(lua_State *L) {
		...
		wrapper_osg_FrontFace* self=Luna< osg::Referenced >::checkSubType< wrapper_osg_FrontFace >(L,1);
		if(!self) {
			luna_printStack(L);
