...
public:
	...
	wrapper_osgParticle_BoxPlacer(lua_State* L, lua_Table* dum) : osgParticle::BoxPlacer(), luna_wrapper_base(L) {};
	wrapper_osgParticle_BoxPlacer(lua_State* L, lua_Table* dum, const osgParticle::BoxPlacer & copy, const osg::CopyOp & copyop = osg::CopyOp::SHALLOW_COPY) : osgParticle::BoxPlacer(copy, copyop), luna_wrapper_base(L) {};
