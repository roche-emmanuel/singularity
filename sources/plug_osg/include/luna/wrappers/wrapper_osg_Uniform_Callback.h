...
public:
	...
	~wrapper_osg_Uniform_Callback() {
		logDEBUG3("Calling delete function for wrapper osg_Uniform_Callback");
		if(_obj.pushFunction("delete")) {
			//_obj.pushArg((osg::Uniform::Callback*)this); // No this argument or the object will be referenced again!
			_obj.callFunction<void>();
		}
	};
	
	wrapper_osg_Uniform_Callback(lua_State* L, lua_Table* dum) 
		: osg::Uniform::Callback(), luna_wrapper_base(L) { 
		register_protected_methods(L); 
		if(_obj.pushFunction("buildInstance")) {
			_obj.pushArg((osg::Uniform::Callback*)this);
			_obj.callFunction<void>();
		}
	};
	wrapper_osg_Uniform_Callback(lua_State* L, lua_Table* dum, const osg::Uniform::Callback & arg1, const osg::CopyOp & arg2) 
		: osg::Uniform::Callback(arg1, arg2), luna_wrapper_base(L) { 
		register_protected_methods(L);
		if(_obj.pushFunction("buildInstance")) {
			_obj.pushArg((osg::Uniform::Callback*)this);
			_obj.callFunction<void>();
	...
	static int _bind_public_signalObserversAndDelete(lua_State *L) {
		...
		wrapper_osg_Uniform_Callback* self=Luna< osg::Referenced >::checkSubType< wrapper_osg_Uniform_Callback >(L,1);
		if(!self) {
			luna_printStack(L);
