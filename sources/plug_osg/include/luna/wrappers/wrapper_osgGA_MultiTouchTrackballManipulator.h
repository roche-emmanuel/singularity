...
class wrapper_osgGA_MultiTouchTrackballManipulator : public osgGA::MultiTouchTrackballManipulator {
protected:
	sgt::LuaObject _obj;
...
public:
	...
	wrapper_osgGA_MultiTouchTrackballManipulator(lua_State* L, lua_Table* dum, int flags = osgGA::StandardManipulator::DEFAULT_SETTINGS) : osgGA::MultiTouchTrackballManipulator(flags), _obj(L,-1) {};
	wrapper_osgGA_MultiTouchTrackballManipulator(lua_State* L, lua_Table* dum, const osgGA::MultiTouchTrackballManipulator & tm, const osg::CopyOp & copyOp = osg::CopyOp::SHALLOW_COPY) : osgGA::MultiTouchTrackballManipulator(tm, copyOp), _obj(L,-1) {};
	...
	osg::Object * cloneType() const {
		...
		return osgGA::MultiTouchTrackballManipulator::cloneType();
	};
	...
	osg::Object * clone(const osg::CopyOp & arg1) const {
		...
		return osgGA::MultiTouchTrackballManipulator::clone(arg1);
	};
	...
	bool isSameKindAs(const osg::Object * obj) const {
		...
		return osgGA::MultiTouchTrackballManipulator::isSameKindAs(obj);
	};
	...
	const char * libraryName() const {
		...
		return osgGA::MultiTouchTrackballManipulator::libraryName();
	};
	...
	const char * className() const {
		...
		return osgGA::MultiTouchTrackballManipulator::className();
	};
	...
	bool handle(const osgGA::GUIEventAdapter & ea, osgGA::GUIActionAdapter & us) {
		...
		return osgGA::MultiTouchTrackballManipulator::handle(ea, us);
	};
