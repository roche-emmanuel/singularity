...
public:
	...
	~wrapper_osg_View_Slave_UpdateSlaveCallback() {
		logDEBUG3("Calling delete function for wrapper osg_View_Slave_UpdateSlaveCallback");
		if(_obj.pushFunction("delete")) {
			//_obj.pushArg((osg::View::Slave::UpdateSlaveCallback*)this); // No this argument or the object will be referenced again!
			_obj.callFunction<void>();
		}
	};
	
	wrapper_osg_View_Slave_UpdateSlaveCallback(lua_State* L, lua_Table* dum) 
		: osg::View::Slave::UpdateSlaveCallback(), luna_wrapper_base(L) { 
		register_protected_methods(L); 
		if(_obj.pushFunction("buildInstance")) {
			_obj.pushArg((osg::View::Slave::UpdateSlaveCallback*)this);
			_obj.callFunction<void>();
		}
	};
	...
	static int _bind_public_signalObserversAndDelete(lua_State *L) {
		...
		wrapper_osg_View_Slave_UpdateSlaveCallback* self=Luna< osg::Referenced >::checkSubType< wrapper_osg_View_Slave_UpdateSlaveCallback >(L,1);
		if(!self) {
			luna_printStack(L);
