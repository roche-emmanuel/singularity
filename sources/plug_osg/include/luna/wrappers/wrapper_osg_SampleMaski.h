#ifndef _WRAPPERS_WRAPPER_OSG_SAMPLEMASKI_H_
#define _WRAPPERS_WRAPPER_OSG_SAMPLEMASKI_H_
...
class wrapper_osg_SampleMaski : public osg::SampleMaski, public luna_wrapper_base {

public:
		

	~wrapper_osg_SampleMaski() {
		logDEBUG3("Calling delete function for wrapper osg_SampleMaski");
		if(_obj.pushFunction("delete")) {
			//_obj.pushArg((osg::SampleMaski*)this); // No this argument or the object will be referenced again!
			_obj.callFunction<void>();
		}
	};
	
	wrapper_osg_SampleMaski(lua_State* L, lua_Table* dum) 
		: osg::SampleMaski(), luna_wrapper_base(L) { 
		register_protected_methods(L); 
		if(_obj.pushFunction("buildInstance")) {
			_obj.pushArg((osg::SampleMaski*)this);
			_obj.callFunction<void>();
		}
	};
	wrapper_osg_SampleMaski(lua_State* L, lua_Table* dum, const osg::SampleMaski & sampleMaski, const osg::CopyOp & copyop = osg::CopyOp::SHALLOW_COPY) 
		: osg::SampleMaski(sampleMaski, copyop), luna_wrapper_base(L) { 
		register_protected_methods(L);
		if(_obj.pushFunction("buildInstance")) {
			_obj.pushArg((osg::SampleMaski*)this);
			_obj.callFunction<void>();
	...
	void setThreadSafeRefUnref(bool threadSafe) {
		...
		return SampleMaski::setThreadSafeRefUnref(threadSafe);
	};
	...
	void setName(const std::string & name) {
		...
		return SampleMaski::setName(name);
	};
	...
	void computeDataVariance() {
		...
		return SampleMaski::computeDataVariance();
	};
	...
	void setUserData(osg::Referenced * obj) {
		...
		return SampleMaski::setUserData(obj);
	};
	...
	osg::Referenced * getUserData() {
		...
		return SampleMaski::getUserData();
	};
	...
	bool isTextureAttribute() const {
		...
		return SampleMaski::isTextureAttribute();
	};
	...
	bool getModeUsage(osg::StateAttribute::ModeUsage & arg1) const {
		...
		return SampleMaski::getModeUsage(arg1);
	};
	...
	bool checkValidityOfAssociatedModes(osg::State & arg1) const {
		...
		return SampleMaski::checkValidityOfAssociatedModes(arg1);
	};
	...
	void compileGLObjects(osg::State & arg1) const {
		...
		return SampleMaski::compileGLObjects(arg1);
	};
	...
	void releaseGLObjects(osg::State * arg1 = 0) const {
		...
		return SampleMaski::releaseGLObjects(arg1);
	};
	...
	bool isSameKindAs(const osg::Object * obj) const {
		...
		return SampleMaski::isSameKindAs(obj);
	};
	...
	const char * libraryName() const {
		...
		return SampleMaski::libraryName();
	};
	...
	static int _bind_public_addParent(lua_State *L) {
		...
		wrapper_osg_SampleMaski* self=Luna< osg::Referenced >::checkSubType< wrapper_osg_SampleMaski >(L,1);
		if(!self) {
			luna_printStack(L);
