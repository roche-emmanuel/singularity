...
public:
	...
	wrapper_osg_CompositeShape(lua_State* L, lua_Table* dum) : osg::CompositeShape(), luna_wrapper_base(L) { register_protected_methods(L); };
	wrapper_osg_CompositeShape(lua_State* L, lua_Table* dum, const osg::CompositeShape & cs, const osg::CopyOp & copyop = osg::CopyOp::SHALLOW_COPY) : osg::CompositeShape(cs, copyop), luna_wrapper_base(L) { register_protected_methods(L); };
