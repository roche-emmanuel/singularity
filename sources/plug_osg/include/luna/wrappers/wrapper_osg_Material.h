...
public:
	...
	wrapper_osg_Material(lua_State* L, lua_Table* dum) : osg::Material(), luna_wrapper_base(L) { register_protected_methods(L); };
	wrapper_osg_Material(lua_State* L, lua_Table* dum, const osg::Material & mat, const osg::CopyOp & copyop = osg::CopyOp::SHALLOW_COPY) : osg::Material(mat, copyop), luna_wrapper_base(L) { register_protected_methods(L); };
