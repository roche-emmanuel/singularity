...
class wrapper_osgViewer_WindowSizeHandler : public osgViewer::WindowSizeHandler {
protected:
	sgt::LuaObject _obj;
...
public:
	...
	wrapper_osgViewer_WindowSizeHandler(lua_State* L, lua_Table* dum) : osgViewer::WindowSizeHandler(), _obj(L,-1) {};
	...
	void getUsage(osg::ApplicationUsage & usage) const {
		...
		return osgViewer::WindowSizeHandler::getUsage(usage);
	};
	...
	bool handle(const osgGA::GUIEventAdapter & arg1, osgGA::GUIActionAdapter & arg2) {
		...
		return osgViewer::WindowSizeHandler::handle(arg1, arg2);
	};
