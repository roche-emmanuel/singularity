...
public:
	...
	~wrapper_osg_TransferFunction() {
		logDEBUG3("Calling delete function for wrapper osg_TransferFunction");
		if(_obj.pushFunction("delete")) {
			//_obj.pushArg((osg::TransferFunction*)this); // No this argument or the object will be referenced again!
			_obj.callFunction<void>();
		}
	};
	
	wrapper_osg_TransferFunction(lua_State* L, lua_Table* dum) 
		: osg::TransferFunction(), luna_wrapper_base(L) { 
		register_protected_methods(L); 
		if(_obj.pushFunction("buildInstance")) {
			_obj.pushArg((osg::TransferFunction*)this);
			_obj.callFunction<void>();
		}
	};
	wrapper_osg_TransferFunction(lua_State* L, lua_Table* dum, const osg::TransferFunction & tf, const osg::CopyOp & copyop = osg::CopyOp::SHALLOW_COPY) 
		: osg::TransferFunction(tf, copyop), luna_wrapper_base(L) { 
		register_protected_methods(L);
		if(_obj.pushFunction("buildInstance")) {
			_obj.pushArg((osg::TransferFunction*)this);
			_obj.callFunction<void>();
	...
	void setThreadSafeRefUnref(bool threadSafe) {
		...
		return TransferFunction::setThreadSafeRefUnref(threadSafe);
	};
	...
	static int _bind_public_signalObserversAndDelete(lua_State *L) {
		...
		wrapper_osg_TransferFunction* self=Luna< osg::Referenced >::checkSubType< wrapper_osg_TransferFunction >(L,1);
		if(!self) {
			luna_printStack(L);
