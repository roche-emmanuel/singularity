...
class wrapper_osg_VertexProgram : public osg::VertexProgram, public luna_wrapper_base {
...
public:
	...
	wrapper_osg_VertexProgram(lua_State* L, lua_Table* dum) : osg::VertexProgram(), luna_wrapper_base(L) {};
	wrapper_osg_VertexProgram(lua_State* L, lua_Table* dum, const osg::VertexProgram & vp, const osg::CopyOp & copyop = osg::CopyOp::SHALLOW_COPY) : osg::VertexProgram(vp, copyop), luna_wrapper_base(L) {};
