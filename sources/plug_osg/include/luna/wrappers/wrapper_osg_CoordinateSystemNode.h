...
public:
	...
	wrapper_osg_CoordinateSystemNode(lua_State* L, lua_Table* dum) : osg::CoordinateSystemNode(), luna_wrapper_base(L) { register_protected_methods(L); };
	wrapper_osg_CoordinateSystemNode(lua_State* L, lua_Table* dum, const std::string & format, const std::string & cs) : osg::CoordinateSystemNode(format, cs), luna_wrapper_base(L) { register_protected_methods(L); };
	wrapper_osg_CoordinateSystemNode(lua_State* L, lua_Table* dum, const osg::CoordinateSystemNode & arg1, const osg::CopyOp & copyop = osg::CopyOp::SHALLOW_COPY) : osg::CoordinateSystemNode(arg1, copyop), luna_wrapper_base(L) { register_protected_methods(L); };
