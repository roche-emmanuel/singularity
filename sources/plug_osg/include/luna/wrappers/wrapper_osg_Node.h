...
class wrapper_osg_Node : public osg::Node {
protected:
	sgt::LuaObject _obj;
...
public:
	...
	wrapper_osg_Node(lua_State* L, lua_Table* dum) : osg::Node(), _obj(L,-1) {};
	wrapper_osg_Node(lua_State* L, lua_Table* dum, const osg::Node & arg1, const osg::CopyOp & copyop = osg::CopyOp::SHALLOW_COPY) : osg::Node(arg1, copyop), _obj(L,-1) {};
