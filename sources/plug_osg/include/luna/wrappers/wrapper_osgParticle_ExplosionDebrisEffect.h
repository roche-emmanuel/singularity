#ifndef _WRAPPERS_WRAPPER_OSGPARTICLE_EXPLOSIONDEBRISEFFECT_H_
#define _WRAPPERS_WRAPPER_OSGPARTICLE_EXPLOSIONDEBRISEFFECT_H_
...
public:
	...
	~wrapper_osgParticle_ExplosionDebrisEffect() {
		logDEBUG3("Calling delete function for wrapper osgParticle_ExplosionDebrisEffect");
		if(_obj.pushFunction("delete")) {
			//_obj.pushArg((osgParticle::ExplosionDebrisEffect*)this); // No this argument or the object will be referenced again!
			_obj.callFunction<void>();
		}
	};
	
	wrapper_osgParticle_ExplosionDebrisEffect(lua_State* L, lua_Table* dum, bool automaticSetup = true) 
		: osgParticle::ExplosionDebrisEffect(automaticSetup), luna_wrapper_base(L) { 
		register_protected_methods(L);
		if(_obj.pushFunction("buildInstance")) {
			_obj.pushArg((osgParticle::ExplosionDebrisEffect*)this);
			_obj.callFunction<void>();
		}
	};
	wrapper_osgParticle_ExplosionDebrisEffect(lua_State* L, lua_Table* dum, const osg::Vec3f & position, float scale = 1.0f, float intensity = 1.0f) 
		: osgParticle::ExplosionDebrisEffect(position, scale, intensity), luna_wrapper_base(L) { 
		register_protected_methods(L);
		if(_obj.pushFunction("buildInstance")) {
			_obj.pushArg((osgParticle::ExplosionDebrisEffect*)this);
			_obj.callFunction<void>();
	...
	wrapper_osgParticle_ExplosionDebrisEffect(lua_State* L, lua_Table* dum, const osgParticle::ExplosionDebrisEffect & copy, const osg::CopyOp & copyop = osg::CopyOp::SHALLOW_COPY) 
		: osgParticle::ExplosionDebrisEffect(copy, copyop), luna_wrapper_base(L) { 
		register_protected_methods(L);
		if(_obj.pushFunction("buildInstance")) {
			_obj.pushArg((osgParticle::ExplosionDebrisEffect*)this);
			_obj.callFunction<void>();
...
protected:
	...
	void childRemoved(unsigned int arg1, unsigned int arg2) {
		...
		return ExplosionDebrisEffect::childRemoved(arg1, arg2);
	};
...
public:
	...
	void setName(const std::string & name) {
		...
		return ExplosionDebrisEffect::setName(name);
	};
	...
	void computeDataVariance() {
		...
		return ExplosionDebrisEffect::computeDataVariance();
	};
	...
	void setUserData(osg::Referenced * obj) {
		...
		return ExplosionDebrisEffect::setUserData(obj);
	};
	...
	osg::Referenced * getUserData() {
		...
		return ExplosionDebrisEffect::getUserData();
	};
	...
	osg::Transform * asTransform() {
		...
		return ExplosionDebrisEffect::asTransform();
	};
	...
	osg::Camera * asCamera() {
		...
		return ExplosionDebrisEffect::asCamera();
	};
	...
	osg::Switch * asSwitch() {
		...
		return ExplosionDebrisEffect::asSwitch();
	};
	...
	osg::Geode * asGeode() {
		...
		return ExplosionDebrisEffect::asGeode();
	};
	...
	void ascend(osg::NodeVisitor & nv) {
		...
		return ExplosionDebrisEffect::ascend(nv);
	};
	...
	osg::Group * asGroup() {
		...
		return ExplosionDebrisEffect::asGroup();
	};
	...
	void traverse(osg::NodeVisitor & arg1) {
		...
		return ExplosionDebrisEffect::traverse(arg1);
	};
	...
	bool addChild(osg::Node * child) {
		...
		return ExplosionDebrisEffect::addChild(child);
	};
	...
	bool insertChild(unsigned int index, osg::Node * child) {
		...
		return ExplosionDebrisEffect::insertChild(index, child);
	};
	...
	bool removeChildren(unsigned int pos, unsigned int numChildrenToRemove) {
		...
		return ExplosionDebrisEffect::removeChildren(pos, numChildrenToRemove);
	};
	...
	bool replaceChild(osg::Node * origChild, osg::Node * newChild) {
		...
		return ExplosionDebrisEffect::replaceChild(origChild, newChild);
	};
	...
	bool setChild(unsigned int i, osg::Node * node) {
		...
		return ExplosionDebrisEffect::setChild(i, node);
	};
	...
	void setThreadSafeRefUnref(bool threadSafe) {
		...
		return ExplosionDebrisEffect::setThreadSafeRefUnref(threadSafe);
	};
	...
	void releaseGLObjects(osg::State * arg1 = 0) const {
		...
		return ExplosionDebrisEffect::releaseGLObjects(arg1);
	};
	...
	osg::BoundingSphered computeBound() const {
		...
		return ExplosionDebrisEffect::computeBound();
	};
	...
	void buildEffect() {
		...
		return ExplosionDebrisEffect::buildEffect();
	};
	...
	osg::Object * cloneType() const {
		...
		return ExplosionDebrisEffect::cloneType();
	};
	...
	osg::Object * clone(const osg::CopyOp & copyop) const {
		...
		return ExplosionDebrisEffect::clone(copyop);
	};
	...
	bool isSameKindAs(const osg::Object * obj) const {
		...
		return ExplosionDebrisEffect::isSameKindAs(obj);
	};
	...
	const char * className() const {
		...
		return ExplosionDebrisEffect::className();
	};
	...
	const char * libraryName() const {
		...
		return ExplosionDebrisEffect::libraryName();
	};
	...
	void accept(osg::NodeVisitor & nv) {
		...
		return ExplosionDebrisEffect::accept(nv);
	};
	...
	void setDefaults() {
		...
		return ExplosionDebrisEffect::setDefaults();
	};
	...
	void setUpEmitterAndProgram() {
		...
		return ExplosionDebrisEffect::setUpEmitterAndProgram();
	};
	...
	osgParticle::Emitter * getEmitter() {
		...
		return ExplosionDebrisEffect::getEmitter();
	};
	...
	osgParticle::Program * getProgram() {
		...
		return ExplosionDebrisEffect::getProgram();
	};
	...
	static int _bind_public_addParent(lua_State *L) {
		...
		wrapper_osgParticle_ExplosionDebrisEffect* self=Luna< osg::Referenced >::checkSubType< wrapper_osgParticle_ExplosionDebrisEffect >(L,1);
		if(!self) {
			luna_printStack(L);
