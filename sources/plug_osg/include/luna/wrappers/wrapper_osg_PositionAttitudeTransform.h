...
public:
	...
	~wrapper_osg_PositionAttitudeTransform() {
		logDEBUG3("Calling delete function for wrapper osg_PositionAttitudeTransform");
		if(_obj.pushFunction("delete")) {
			//_obj.pushArg((osg::PositionAttitudeTransform*)this); // No this argument or the object will be referenced again!
			_obj.callFunction<void>();
		}
	};
	
	wrapper_osg_PositionAttitudeTransform(lua_State* L, lua_Table* dum) 
		: osg::PositionAttitudeTransform(), luna_wrapper_base(L) { 
		register_protected_methods(L); 
		if(_obj.pushFunction("buildInstance")) {
			_obj.pushArg((osg::PositionAttitudeTransform*)this);
			_obj.callFunction<void>();
		}
	};
	wrapper_osg_PositionAttitudeTransform(lua_State* L, lua_Table* dum, const osg::PositionAttitudeTransform & pat, const osg::CopyOp & copyop = osg::CopyOp::SHALLOW_COPY) 
		: osg::PositionAttitudeTransform(pat, copyop), luna_wrapper_base(L) { 
		register_protected_methods(L);
		if(_obj.pushFunction("buildInstance")) {
			_obj.pushArg((osg::PositionAttitudeTransform*)this);
			_obj.callFunction<void>();
...
public:
	...
	osg::Camera * asCamera() {
		...
		return PositionAttitudeTransform::asCamera();
	};
	...
	void setThreadSafeRefUnref(bool threadSafe) {
		...
		return PositionAttitudeTransform::setThreadSafeRefUnref(threadSafe);
	};
	...
	static int _bind_public_addParent(lua_State *L) {
		...
		wrapper_osg_PositionAttitudeTransform* self=Luna< osg::Referenced >::checkSubType< wrapper_osg_PositionAttitudeTransform >(L,1);
		if(!self) {
			luna_printStack(L);
