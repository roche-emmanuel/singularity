...
public:
	...
	wrapper_osg_PositionAttitudeTransform(lua_State* L, lua_Table* dum) : osg::PositionAttitudeTransform(), luna_wrapper_base(L) { register_protected_methods(L); };
	wrapper_osg_PositionAttitudeTransform(lua_State* L, lua_Table* dum, const osg::PositionAttitudeTransform & pat, const osg::CopyOp & copyop = osg::CopyOp::SHALLOW_COPY) : osg::PositionAttitudeTransform(pat, copyop), luna_wrapper_base(L) { register_protected_methods(L); };
