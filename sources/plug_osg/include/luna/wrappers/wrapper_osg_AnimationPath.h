...
public:
	...
	wrapper_osg_AnimationPath(lua_State* L, lua_Table* dum) : osg::AnimationPath(), luna_wrapper_base(L) { register_protected_methods(L); };
	wrapper_osg_AnimationPath(lua_State* L, lua_Table* dum, const osg::AnimationPath & ap, const osg::CopyOp & copyop = osg::CopyOp::SHALLOW_COPY) : osg::AnimationPath(ap, copyop), luna_wrapper_base(L) { register_protected_methods(L); };
