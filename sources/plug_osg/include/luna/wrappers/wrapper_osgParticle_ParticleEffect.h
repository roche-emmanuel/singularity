...
public:
	...
	wrapper_osgParticle_ParticleEffect(lua_State* L, lua_Table* dum, bool automaticSetup = true) : osgParticle::ParticleEffect(automaticSetup), luna_wrapper_base(L) { register_protected_methods(L); };
	wrapper_osgParticle_ParticleEffect(lua_State* L, lua_Table* dum, const osgParticle::ParticleEffect & copy, const osg::CopyOp & copyop = osg::CopyOp::SHALLOW_COPY) : osgParticle::ParticleEffect(copy, copyop), luna_wrapper_base(L) { register_protected_methods(L); };
