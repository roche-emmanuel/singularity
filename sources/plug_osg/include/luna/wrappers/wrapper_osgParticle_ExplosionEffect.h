...
public:
	...
	~wrapper_osgParticle_ExplosionEffect() {
		...
		if(_obj.pushFunction("delete")) {
			//_obj.pushArg((osgParticle::ExplosionEffect*)this); // No this argument or the object will be referenced again!
			_obj.callFunction<void>();
		}
	};
	
	wrapper_osgParticle_ExplosionEffect(lua_State* L, lua_Table* dum, bool automaticSetup = true) 
		: osgParticle::ExplosionEffect(automaticSetup), luna_wrapper_base(L) { 
		register_protected_methods(L);
		if(_obj.pushFunction("buildInstance")) {
			_obj.pushArg((osgParticle::ExplosionEffect*)this);
			_obj.callFunction<void>();
		}
	};
	wrapper_osgParticle_ExplosionEffect(lua_State* L, lua_Table* dum, const osg::Vec3f & position, float scale = 1.0f, float intensity = 1.0f) 
		: osgParticle::ExplosionEffect(position, scale, intensity), luna_wrapper_base(L) { 
		register_protected_methods(L);
		if(_obj.pushFunction("buildInstance")) {
			_obj.pushArg((osgParticle::ExplosionEffect*)this);
			_obj.callFunction<void>();
	...
	wrapper_osgParticle_ExplosionEffect(lua_State* L, lua_Table* dum, const osgParticle::ExplosionEffect & copy, const osg::CopyOp & copyop = osg::CopyOp::SHALLOW_COPY) 
		: osgParticle::ExplosionEffect(copy, copyop), luna_wrapper_base(L) { 
		register_protected_methods(L);
		if(_obj.pushFunction("buildInstance")) {
			_obj.pushArg((osgParticle::ExplosionEffect*)this);
			_obj.callFunction<void>();
...
public:
	...
	osg::Camera * asCamera() {
		...
		return ExplosionEffect::asCamera();
	};
