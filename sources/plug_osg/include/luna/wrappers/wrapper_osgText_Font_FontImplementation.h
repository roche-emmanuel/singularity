...
class wrapper_osgText_Font_FontImplementation : public osgText::Font::FontImplementation {
protected:
	sgt::LuaObject _obj;
...
public:
	...
	wrapper_osgText_Font_FontImplementation(lua_State* L, lua_Table* dum) : osgText::Font::FontImplementation(), _obj(L,-1) {};
