...
public:
	...
	wrapper_osg_Switch(lua_State* L, lua_Table* dum) : osg::Switch(), luna_wrapper_base(L) { register_protected_methods(L); };
	wrapper_osg_Switch(lua_State* L, lua_Table* dum, const osg::Switch & arg1, const osg::CopyOp & copyop = osg::CopyOp::SHALLOW_COPY) : osg::Switch(arg1, copyop), luna_wrapper_base(L) { register_protected_methods(L); };
