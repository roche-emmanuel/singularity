...
class wrapper_osg_AutoTransform : public osg::AutoTransform {
protected:
	sgt::LuaObject _obj;
...
public:
	...
	wrapper_osg_AutoTransform(lua_State* L, lua_Table* dum) : osg::AutoTransform(), _obj(L,-1) {};
	wrapper_osg_AutoTransform(lua_State* L, lua_Table* dum, const osg::AutoTransform & pat, const osg::CopyOp & copyop = osg::CopyOp::SHALLOW_COPY) : osg::AutoTransform(pat, copyop), _obj(L,-1) {};
	...
	osg::Object * clone(const osg::CopyOp & copyop) const {
		...
		return osg::AutoTransform::clone(copyop);
	};
	...
	bool isSameKindAs(const osg::Object * obj) const {
		...
		return osg::AutoTransform::isSameKindAs(obj);
	};
	...
	void accept(osg::NodeVisitor & nv) {
		...
		return osg::AutoTransform::accept(nv);
	};
	...
	bool computeLocalToWorldMatrix(osg::Matrixd & matrix, osg::NodeVisitor * nv) const {
		...
		return osg::AutoTransform::computeLocalToWorldMatrix(matrix, nv);
	};
	...
	bool computeWorldToLocalMatrix(osg::Matrixd & matrix, osg::NodeVisitor * nv) const {
		...
		return osg::AutoTransform::computeWorldToLocalMatrix(matrix, nv);
	};
