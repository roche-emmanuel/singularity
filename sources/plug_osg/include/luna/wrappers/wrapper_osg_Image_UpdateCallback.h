...
public:
	...
	~wrapper_osg_Image_UpdateCallback() {
		logDEBUG3("Calling delete function for wrapper osg_Image_UpdateCallback");
		if(_obj.pushFunction("delete")) {
			//_obj.pushArg((osg::Image::UpdateCallback*)this); // No this argument or the object will be referenced again!
			_obj.callFunction<void>();
		}
	};
	
	wrapper_osg_Image_UpdateCallback(lua_State* L, lua_Table* dum) 
		: osg::Image::UpdateCallback(), luna_wrapper_base(L) { 
		register_protected_methods(L); 
		if(_obj.pushFunction("buildInstance")) {
			_obj.pushArg((osg::Image::UpdateCallback*)this);
			_obj.callFunction<void>();
		}
	};
	...
	static int _bind_public_signalObserversAndDelete(lua_State *L) {
		...
		wrapper_osg_Image_UpdateCallback* self=Luna< osg::Referenced >::checkSubType< wrapper_osg_Image_UpdateCallback >(L,1);
		if(!self) {
			luna_printStack(L);
