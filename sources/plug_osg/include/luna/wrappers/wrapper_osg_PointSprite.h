...
public:
	...
	wrapper_osg_PointSprite(lua_State* L, lua_Table* dum) : osg::PointSprite(), luna_wrapper_base(L) { register_protected_methods(L); };
	wrapper_osg_PointSprite(lua_State* L, lua_Table* dum, const osg::PointSprite & ps, const osg::CopyOp & copyop = osg::CopyOp::SHALLOW_COPY) : osg::PointSprite(ps, copyop), luna_wrapper_base(L) { register_protected_methods(L); };
