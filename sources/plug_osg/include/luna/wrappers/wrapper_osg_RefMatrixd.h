...
public:
	...
	wrapper_osg_RefMatrixd(lua_State* L, lua_Table* dum) : osg::RefMatrixd(), luna_wrapper_base(L) { register_protected_methods(L); };
	wrapper_osg_RefMatrixd(lua_State* L, lua_Table* dum, const osg::Matrixd & other) : osg::RefMatrixd(other), luna_wrapper_base(L) { register_protected_methods(L); };
	wrapper_osg_RefMatrixd(lua_State* L, lua_Table* dum, const osg::Matrixf & other) : osg::RefMatrixd(other), luna_wrapper_base(L) { register_protected_methods(L); };
	wrapper_osg_RefMatrixd(lua_State* L, lua_Table* dum, const osg::RefMatrixd & other) : osg::RefMatrixd(other), luna_wrapper_base(L) { register_protected_methods(L); };
