...
public:
	...
	~wrapper_osgParticle_LinearInterpolator() {
		logDEBUG3("Calling delete function for wrapper osgParticle_LinearInterpolator");
		if(_obj.pushFunction("delete")) {
			//_obj.pushArg((osgParticle::LinearInterpolator*)this); // No this argument or the object will be referenced again!
			_obj.callFunction<void>();
		}
	};
	
	wrapper_osgParticle_LinearInterpolator(lua_State* L, lua_Table* dum) 
		: osgParticle::LinearInterpolator(), luna_wrapper_base(L) { 
		register_protected_methods(L); 
		if(_obj.pushFunction("buildInstance")) {
			_obj.pushArg((osgParticle::LinearInterpolator*)this);
			_obj.callFunction<void>();
		}
	};
	wrapper_osgParticle_LinearInterpolator(lua_State* L, lua_Table* dum, const osgParticle::LinearInterpolator & copy, const osg::CopyOp & copyop = osg::CopyOp::SHALLOW_COPY) 
		: osgParticle::LinearInterpolator(copy, copyop), luna_wrapper_base(L) { 
		register_protected_methods(L);
		if(_obj.pushFunction("buildInstance")) {
			_obj.pushArg((osgParticle::LinearInterpolator*)this);
			_obj.callFunction<void>();
	...
	void setThreadSafeRefUnref(bool threadSafe) {
		...
		return LinearInterpolator::setThreadSafeRefUnref(threadSafe);
	};
