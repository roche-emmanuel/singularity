...
public:
	...
	wrapper_osg_StencilTwoSided(lua_State* L, lua_Table* dum) : osg::StencilTwoSided(), luna_wrapper_base(L) { register_protected_methods(L); };
	wrapper_osg_StencilTwoSided(lua_State* L, lua_Table* dum, const osg::StencilTwoSided & stencil, const osg::CopyOp & copyop = osg::CopyOp::SHALLOW_COPY) : osg::StencilTwoSided(stencil, copyop), luna_wrapper_base(L) { register_protected_methods(L); };
