...
class wrapper_osg_StencilTwoSided : public osg::StencilTwoSided {
protected:
	sgt::LuaObject _obj;
...
public:
	...
	wrapper_osg_StencilTwoSided(lua_State* L, lua_Table* dum) : osg::StencilTwoSided(), _obj(L,-1) {};
	wrapper_osg_StencilTwoSided(lua_State* L, lua_Table* dum, const osg::StencilTwoSided & stencil, const osg::CopyOp & copyop = osg::CopyOp::SHALLOW_COPY) : osg::StencilTwoSided(stencil, copyop), _obj(L,-1) {};
