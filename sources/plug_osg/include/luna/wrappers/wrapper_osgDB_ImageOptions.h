...
public:
	...
	wrapper_osgDB_ImageOptions(lua_State* L, lua_Table* dum) : osgDB::ImageOptions(), luna_wrapper_base(L) { register_protected_methods(L); };
	wrapper_osgDB_ImageOptions(lua_State* L, lua_Table* dum, const std::string & str) : osgDB::ImageOptions(str), luna_wrapper_base(L) { register_protected_methods(L); };
	wrapper_osgDB_ImageOptions(lua_State* L, lua_Table* dum, const osgDB::ImageOptions & options, const osg::CopyOp & copyop = osg::CopyOp::SHALLOW_COPY) : osgDB::ImageOptions(options, copyop), luna_wrapper_base(L) { register_protected_methods(L); };
