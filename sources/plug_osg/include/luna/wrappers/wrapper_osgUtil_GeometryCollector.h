...
public:
	...
	wrapper_osgUtil_GeometryCollector(lua_State* L, lua_Table* dum, osgUtil::Optimizer * optimizer, osgUtil::Optimizer::OptimizationOptions options) : osgUtil::GeometryCollector(optimizer, options), luna_wrapper_base(L) { register_protected_methods(L); };
