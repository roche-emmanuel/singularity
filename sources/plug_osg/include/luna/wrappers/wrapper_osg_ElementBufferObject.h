...
public:
	...
	wrapper_osg_ElementBufferObject(lua_State* L, lua_Table* dum) : osg::ElementBufferObject(), luna_wrapper_base(L) { register_protected_methods(L); };
	wrapper_osg_ElementBufferObject(lua_State* L, lua_Table* dum, const osg::ElementBufferObject & pbo, const osg::CopyOp & copyop = osg::CopyOp::SHALLOW_COPY) : osg::ElementBufferObject(pbo, copyop), luna_wrapper_base(L) { register_protected_methods(L); };
