...
public:
	...
	wrapper_osg_Hint(lua_State* L, lua_Table* dum) : osg::Hint(), luna_wrapper_base(L) { register_protected_methods(L); };
	wrapper_osg_Hint(lua_State* L, lua_Table* dum, unsigned int target, unsigned int mode) : osg::Hint(target, mode), luna_wrapper_base(L) { register_protected_methods(L); };
	wrapper_osg_Hint(lua_State* L, lua_Table* dum, const osg::Hint & hint, const osg::CopyOp & copyop = osg::CopyOp::SHALLOW_COPY) : osg::Hint(hint, copyop), luna_wrapper_base(L) { register_protected_methods(L); };
