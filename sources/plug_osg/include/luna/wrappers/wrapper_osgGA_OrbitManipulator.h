...
public:
	...
	~wrapper_osgGA_OrbitManipulator() {
		...
		if(_obj.pushFunction("delete")) {
			//_obj.pushArg((osgGA::OrbitManipulator*)this); // No this argument or the object will be referenced again!
			_obj.callFunction<void>();
		}
	};
	
	wrapper_osgGA_OrbitManipulator(lua_State* L, lua_Table* dum, int flags = osgGA::StandardManipulator::DEFAULT_SETTINGS) 
		: osgGA::OrbitManipulator(flags), luna_wrapper_base(L) { 
		register_protected_methods(L);
		if(_obj.pushFunction("buildInstance")) {
			_obj.pushArg((osgGA::OrbitManipulator*)this);
			_obj.callFunction<void>();
		}
	};
	wrapper_osgGA_OrbitManipulator(lua_State* L, lua_Table* dum, const osgGA::OrbitManipulator & om, const osg::CopyOp & copyOp = osg::CopyOp::SHALLOW_COPY) 
		: osgGA::OrbitManipulator(om, copyOp), luna_wrapper_base(L) { 
		register_protected_methods(L);
		if(_obj.pushFunction("buildInstance")) {
			_obj.pushArg((osgGA::OrbitManipulator*)this);
			_obj.callFunction<void>();
...
protected:
	...
	bool handleFrame(const osgGA::GUIEventAdapter & ea, osgGA::GUIActionAdapter & us) {
		...
		return OrbitManipulator::handleFrame(ea, us);
	};
	...
	bool handleResize(const osgGA::GUIEventAdapter & ea, osgGA::GUIActionAdapter & us) {
		...
		return OrbitManipulator::handleResize(ea, us);
	};
	...
	bool handleMouseMove(const osgGA::GUIEventAdapter & ea, osgGA::GUIActionAdapter & us) {
		...
		return OrbitManipulator::handleMouseMove(ea, us);
	};
	...
	bool handleMouseDrag(const osgGA::GUIEventAdapter & ea, osgGA::GUIActionAdapter & us) {
		...
		return OrbitManipulator::handleMouseDrag(ea, us);
	};
	...
	bool handleMouseRelease(const osgGA::GUIEventAdapter & ea, osgGA::GUIActionAdapter & us) {
		...
		return OrbitManipulator::handleMouseRelease(ea, us);
	};
	...
	bool handleKeyDown(const osgGA::GUIEventAdapter & ea, osgGA::GUIActionAdapter & us) {
		...
		return OrbitManipulator::handleKeyDown(ea, us);
	};
	...
	bool handleKeyUp(const osgGA::GUIEventAdapter & ea, osgGA::GUIActionAdapter & us) {
		...
		return OrbitManipulator::handleKeyUp(ea, us);
	};
	...
	bool handleMouseDeltaMovement(const osgGA::GUIEventAdapter & ea, osgGA::GUIActionAdapter & us) {
		...
		return OrbitManipulator::handleMouseDeltaMovement(ea, us);
	};
	...
	bool performMovement() {
		...
		return OrbitManipulator::performMovement();
	};
	...
	bool performAnimationMovement(const osgGA::GUIEventAdapter & ea, osgGA::GUIActionAdapter & us) {
		...
		return OrbitManipulator::performAnimationMovement(ea, us);
	};
	...
	bool isMouseMoving() const {
		...
		return OrbitManipulator::isMouseMoving();
	};
	...
	void centerMousePointer(const osgGA::GUIEventAdapter & ea, osgGA::GUIActionAdapter & us) {
		...
		return OrbitManipulator::centerMousePointer(ea, us);
	};
	...
	bool setCenterByMousePointerIntersection(const osgGA::GUIEventAdapter & ea, osgGA::GUIActionAdapter & us) {
		...
		return OrbitManipulator::setCenterByMousePointerIntersection(ea, us);
	};
	...
	bool handleMouseWheel(const osgGA::GUIEventAdapter & ea, osgGA::GUIActionAdapter & us) {
		...
		return OrbitManipulator::handleMouseWheel(ea, us);
	};
	...
	bool performMovementRightMouseButton(const double eventTimeDelta, const double dx, const double dy) {
		...
		return OrbitManipulator::performMovementRightMouseButton(eventTimeDelta, dx, dy);
	};
	...
	bool performMouseDeltaMovement(const float dx, const float dy) {
		...
		return OrbitManipulator::performMouseDeltaMovement(dx, dy);
	};
	...
	void applyAnimationStep(const double currentProgress, const double prevProgress) {
		...
		return OrbitManipulator::applyAnimationStep(currentProgress, prevProgress);
	};
	...
	void rotateTrackball(const float px0, const float py0, const float px1, const float py1, const float scale) {
		...
		return OrbitManipulator::rotateTrackball(px0, py0, px1, py1, scale);
	};
	...
	void rotateWithFixedVertical(const float dx, const float dy) {
		...
		return OrbitManipulator::rotateWithFixedVertical(dx, dy);
	};
	...
	void rotateWithFixedVertical(const float dx, const float dy, const osg::Vec3f & up) {
		...
		return OrbitManipulator::rotateWithFixedVertical(dx, dy, up);
	};
	...
	void panModel(const float dx, const float dy, const float dz = 0.f) {
		...
		return OrbitManipulator::panModel(dx, dy, dz);
	};
	...
	void zoomModel(const float dy, bool pushForwardIfNeeded = true) {
		...
		return OrbitManipulator::zoomModel(dy, pushForwardIfNeeded);
	};
	...
	bool startAnimationByMousePointerIntersection(const osgGA::GUIEventAdapter & ea, osgGA::GUIActionAdapter & us) {
		...
		return OrbitManipulator::startAnimationByMousePointerIntersection(ea, us);
	};
	...
	void allocAnimationData() {
		...
		return OrbitManipulator::allocAnimationData();
	};
...
public:
	...
	void setThreadSafeRefUnref(bool threadSafe) {
		...
		return OrbitManipulator::setThreadSafeRefUnref(threadSafe);
	};
	...
	void setName(const std::string & name) {
		...
		return OrbitManipulator::setName(name);
	};
	...
	void computeDataVariance() {
		...
		return OrbitManipulator::computeDataVariance();
	};
	...
	void setUserData(osg::Referenced * obj) {
		...
		return OrbitManipulator::setUserData(obj);
	};
	...
	osg::Referenced * getUserData() {
		...
		return OrbitManipulator::getUserData();
	};
	...
	void releaseGLObjects(osg::State * arg1 = 0) const {
		...
		return OrbitManipulator::releaseGLObjects(arg1);
	};
	...
	void event(osg::NodeVisitor * nv, osg::Drawable * drawable) {
		...
		return OrbitManipulator::event(nv, drawable);
	};
	...
	void operator()(osg::Node * node, osg::NodeVisitor * nv) {
		...
		return OrbitManipulator::operator()(node, nv);
	};
	...
	void setCoordinateFrameCallback(osgGA::CameraManipulator::CoordinateFrameCallback * cb) {
		...
		return OrbitManipulator::setCoordinateFrameCallback(cb);
	};
	...
	void updateCamera(osg::Camera & camera) {
		...
		return OrbitManipulator::updateCamera(camera);
	};
	...
	void setHomePosition(const osg::Vec3d & eye, const osg::Vec3d & center, const osg::Vec3d & up, bool autoComputeHomePosition = false) {
		...
		return OrbitManipulator::setHomePosition(eye, center, up, autoComputeHomePosition);
	};
	...
	void getHomePosition(osg::Vec3d & eye, osg::Vec3d & center, osg::Vec3d & up) const {
		...
		return OrbitManipulator::getHomePosition(eye, center, up);
	};
	...
	void setAutoComputeHomePosition(bool flag) {
		...
		return OrbitManipulator::setAutoComputeHomePosition(flag);
	};
	...
	void computeHomePosition(const osg::Camera * camera = NULL, bool useBoundingBox = false) {
		...
		return OrbitManipulator::computeHomePosition(camera, useBoundingBox);
	};
	...
	void setNode(osg::Node * arg1) {
		...
		return OrbitManipulator::setNode(arg1);
	};
	...
	const osg::Node * getNode() const {
		...
		return OrbitManipulator::getNode();
	};
	...
	void setVerticalAxisFixed(bool value) {
		...
		return OrbitManipulator::setVerticalAxisFixed(value);
	};
	...
	void setAllowThrow(bool allowThrow) {
		...
		return OrbitManipulator::setAllowThrow(allowThrow);
	};
	...
	void setAnimationTime(const double t) {
		...
		return OrbitManipulator::setAnimationTime(t);
	};
	...
	void finishAnimation() {
		...
		return OrbitManipulator::finishAnimation();
	};
	...
	void home(const osgGA::GUIEventAdapter & arg1, osgGA::GUIActionAdapter & arg2) {
		...
		return OrbitManipulator::home(arg1, arg2);
	};
	...
	void home(double arg1) {
		...
		return OrbitManipulator::home(arg1);
	};
	...
	void init(const osgGA::GUIEventAdapter & arg1, osgGA::GUIActionAdapter & arg2) {
		...
		return OrbitManipulator::init(arg1, arg2);
	};
	...
	void getUsage(osg::ApplicationUsage & arg1) const {
		...
		return OrbitManipulator::getUsage(arg1);
	};
	...
	osg::Object * cloneType() const {
		...
		return OrbitManipulator::cloneType();
	};
	...
	osg::Object * clone(const osg::CopyOp & arg1) const {
		...
		return OrbitManipulator::clone(arg1);
	};
	...
	bool isSameKindAs(const osg::Object * obj) const {
		...
		return OrbitManipulator::isSameKindAs(obj);
	};
	...
	const char * libraryName() const {
		...
		return OrbitManipulator::libraryName();
	};
	...
	const char * className() const {
		...
		return OrbitManipulator::className();
	};
	...
	void setByMatrix(const osg::Matrixd & matrix) {
		...
		return OrbitManipulator::setByMatrix(matrix);
	};
	...
	void setByInverseMatrix(const osg::Matrixd & matrix) {
		...
		return OrbitManipulator::setByInverseMatrix(matrix);
	};
	...
	osg::Matrixd getMatrix() const {
		...
		return OrbitManipulator::getMatrix();
	};
	...
	osg::Matrixd getInverseMatrix() const {
		...
		return OrbitManipulator::getInverseMatrix();
	};
	...
	void setTransformation(const osg::Vec3d & eye, const osg::Quat & rotation) {
		...
		return OrbitManipulator::setTransformation(eye, rotation);
	};
	...
	void setTransformation(const osg::Vec3d & eye, const osg::Vec3d & center, const osg::Vec3d & up) {
		...
		return OrbitManipulator::setTransformation(eye, center, up);
	};
	...
	void getTransformation(osg::Vec3d & eye, osg::Quat & rotation) const {
		...
		return OrbitManipulator::getTransformation(eye, rotation);
	};
	...
	void getTransformation(osg::Vec3d & eye, osg::Vec3d & center, osg::Vec3d & up) const {
		...
		return OrbitManipulator::getTransformation(eye, center, up);
	};
	...
	void setCenter(const osg::Vec3d & center) {
		...
		return OrbitManipulator::setCenter(center);
	};
	...
	void setRotation(const osg::Quat & rotation) {
		...
		return OrbitManipulator::setRotation(rotation);
	};
	...
	void setDistance(double distance) {
		...
		return OrbitManipulator::setDistance(distance);
	};
	...
	void setTrackballSize(const double & size) {
		...
		return OrbitManipulator::setTrackballSize(size);
	};
	...
	void setWheelZoomFactor(double wheelZoomFactor) {
		...
		return OrbitManipulator::setWheelZoomFactor(wheelZoomFactor);
	};
	...
	void setMinimumDistance(const double & minimumDistance, bool relativeToModelSize = false) {
		...
		return OrbitManipulator::setMinimumDistance(minimumDistance, relativeToModelSize);
	};
	...
	osgUtil::SceneView::FusionDistanceMode getFusionDistanceMode() const {
		...
		return OrbitManipulator::getFusionDistanceMode();
	};
	...
	float getFusionDistanceValue() const {
		...
		return OrbitManipulator::getFusionDistanceValue();
	};
	...
	static int _bind_public_trackball(lua_State *L) {
		...
		wrapper_osgGA_OrbitManipulator* self=Luna< osg::Referenced >::checkSubType< wrapper_osgGA_OrbitManipulator >(L,1);
		if(!self) {
			luna_printStack(L);
