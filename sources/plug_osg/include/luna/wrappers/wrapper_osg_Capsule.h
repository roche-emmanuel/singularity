...
public:
	...
	wrapper_osg_Capsule(lua_State* L, lua_Table* dum) : osg::Capsule(), luna_wrapper_base(L) { register_protected_methods(L); };
	wrapper_osg_Capsule(lua_State* L, lua_Table* dum, const osg::Vec3f & center, float radius, float height) : osg::Capsule(center, radius, height), luna_wrapper_base(L) { register_protected_methods(L); };
	wrapper_osg_Capsule(lua_State* L, lua_Table* dum, const osg::Capsule & capsule, const osg::CopyOp & copyop = osg::CopyOp::SHALLOW_COPY) : osg::Capsule(capsule, copyop), luna_wrapper_base(L) { register_protected_methods(L); };
