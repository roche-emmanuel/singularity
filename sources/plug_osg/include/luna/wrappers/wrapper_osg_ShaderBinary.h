...
class wrapper_osg_ShaderBinary : public osg::ShaderBinary {
protected:
	sgt::LuaObject _obj;
...
public:
	...
	wrapper_osg_ShaderBinary(lua_State* L, lua_Table* dum) : osg::ShaderBinary(), _obj(L,-1) {};
	wrapper_osg_ShaderBinary(lua_State* L, lua_Table* dum, const osg::ShaderBinary & rhs, const osg::CopyOp & copyop = osg::CopyOp::SHALLOW_COPY) : osg::ShaderBinary(rhs, copyop), _obj(L,-1) {};
	...
	osg::Object * clone(const osg::CopyOp & arg1) const {
		...
		return osg::ShaderBinary::clone(arg1);
	};
	...
	bool isSameKindAs(const osg::Object * obj) const {
		...
		return osg::ShaderBinary::isSameKindAs(obj);
	};
