...
public:
	...
	wrapper_osg_ShaderBinary(lua_State* L, lua_Table* dum) : osg::ShaderBinary(), luna_wrapper_base(L) { register_protected_methods(L); };
	wrapper_osg_ShaderBinary(lua_State* L, lua_Table* dum, const osg::ShaderBinary & rhs, const osg::CopyOp & copyop = osg::CopyOp::SHALLOW_COPY) : osg::ShaderBinary(rhs, copyop), luna_wrapper_base(L) { register_protected_methods(L); };
