...
// ViewBlendColourMap & osgText::FadeText::getViewBlendColourMap()
ViewBlendColourMap & public_getViewBlendColourMap() {
	return osgText::FadeText::getViewBlendColourMap();
};

// const ViewBlendColourMap & osgText::FadeText::getViewBlendColourMap() const
const ViewBlendColourMap & public_getViewBlendColourMap() const {
	return osgText::FadeText::getViewBlendColourMap();
};
