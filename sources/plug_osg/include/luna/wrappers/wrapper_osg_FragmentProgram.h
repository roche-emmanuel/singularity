...
public:
	...
	wrapper_osg_FragmentProgram(lua_State* L, lua_Table* dum) : osg::FragmentProgram(), luna_wrapper_base(L) { register_protected_methods(L); };
	wrapper_osg_FragmentProgram(lua_State* L, lua_Table* dum, const osg::FragmentProgram & vp, const osg::CopyOp & copyop = osg::CopyOp::SHALLOW_COPY) : osg::FragmentProgram(vp, copyop), luna_wrapper_base(L) { register_protected_methods(L); };
