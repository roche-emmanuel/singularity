...
public:
	...
	wrapper_osg_ConvexHull(lua_State* L, lua_Table* dum) : osg::ConvexHull(), luna_wrapper_base(L) { register_protected_methods(L); };
	wrapper_osg_ConvexHull(lua_State* L, lua_Table* dum, const osg::ConvexHull & hull, const osg::CopyOp & copyop = osg::CopyOp::SHALLOW_COPY) : osg::ConvexHull(hull, copyop), luna_wrapper_base(L) { register_protected_methods(L); };
