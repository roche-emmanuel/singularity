...
public:
	...
	wrapper_osg_Projection(lua_State* L, lua_Table* dum) : osg::Projection(), luna_wrapper_base(L) { register_protected_methods(L); };
	wrapper_osg_Projection(lua_State* L, lua_Table* dum, const osg::Projection & arg1, const osg::CopyOp & copyop = osg::CopyOp::SHALLOW_COPY) : osg::Projection(arg1, copyop), luna_wrapper_base(L) { register_protected_methods(L); };
	wrapper_osg_Projection(lua_State* L, lua_Table* dum, const osg::Matrixd & matix) : osg::Projection(matix), luna_wrapper_base(L) { register_protected_methods(L); };
