...
public:
	...
	wrapper_osg_TessellationHints(lua_State* L, lua_Table* dum) : osg::TessellationHints(), luna_wrapper_base(L) { register_protected_methods(L); };
	wrapper_osg_TessellationHints(lua_State* L, lua_Table* dum, const osg::TessellationHints & tess, const osg::CopyOp & copyop = osg::CopyOp::SHALLOW_COPY) : osg::TessellationHints(tess, copyop), luna_wrapper_base(L) { register_protected_methods(L); };
