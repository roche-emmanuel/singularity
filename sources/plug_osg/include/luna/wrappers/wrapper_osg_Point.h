...
class wrapper_osg_Point : public osg::Point {
protected:
	sgt::LuaObject _obj;
...
public:
	...
	wrapper_osg_Point(lua_State* L, lua_Table* dum) : osg::Point(), _obj(L,-1) {};
	wrapper_osg_Point(lua_State* L, lua_Table* dum, float size) : osg::Point(size), _obj(L,-1) {};
	wrapper_osg_Point(lua_State* L, lua_Table* dum, const osg::Point & point, const osg::CopyOp & copyop = osg::CopyOp::SHALLOW_COPY) : osg::Point(point, copyop), _obj(L,-1) {};
