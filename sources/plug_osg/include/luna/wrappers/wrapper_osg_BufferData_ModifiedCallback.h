...
public:
	...
	~wrapper_osg_BufferData_ModifiedCallback() {
		...
		if(_obj.pushFunction("delete")) {
			//_obj.pushArg((osg::BufferData::ModifiedCallback*)this); // No this argument or the object will be referenced again!
			_obj.callFunction<void>();
		}
	};
	
	wrapper_osg_BufferData_ModifiedCallback(lua_State* L, lua_Table* dum) 
		: osg::BufferData::ModifiedCallback(), luna_wrapper_base(L) { 
		register_protected_methods(L); 
		if(_obj.pushFunction("buildInstance")) {
			_obj.pushArg((osg::BufferData::ModifiedCallback*)this);
			_obj.callFunction<void>();
		}
	};
	wrapper_osg_BufferData_ModifiedCallback(lua_State* L, lua_Table* dum, const osg::BufferData::ModifiedCallback & arg1, const osg::CopyOp & arg2) 
		: osg::BufferData::ModifiedCallback(arg1, arg2), luna_wrapper_base(L) { 
		register_protected_methods(L);
		if(_obj.pushFunction("buildInstance")) {
			_obj.pushArg((osg::BufferData::ModifiedCallback*)this);
			_obj.callFunction<void>();
	...
	void setThreadSafeRefUnref(bool threadSafe) {
		...
		return ModifiedCallback::setThreadSafeRefUnref(threadSafe);
	};
	...
	static int _bind_public_signalObserversAndDelete(lua_State *L) {
		...
		wrapper_osg_BufferData_ModifiedCallback* self=Luna< osg::Referenced >::checkSubType< wrapper_osg_BufferData_ModifiedCallback >(L,1);
		if(!self) {
			luna_printStack(L);
