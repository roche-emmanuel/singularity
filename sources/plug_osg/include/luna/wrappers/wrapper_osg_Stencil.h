#ifndef _WRAPPERS_WRAPPER_OSG_STENCIL_H_
#define _WRAPPERS_WRAPPER_OSG_STENCIL_H_
...
public:
	...
	~wrapper_osg_Stencil() {
		logDEBUG3("Calling delete function for wrapper osg_Stencil");
		if(_obj.pushFunction("delete")) {
			//_obj.pushArg((osg::Stencil*)this); // No this argument or the object will be referenced again!
			_obj.callFunction<void>();
		}
	};
	
	wrapper_osg_Stencil(lua_State* L, lua_Table* dum) 
		: osg::Stencil(), luna_wrapper_base(L) { 
		register_protected_methods(L); 
		if(_obj.pushFunction("buildInstance")) {
			_obj.pushArg((osg::Stencil*)this);
			_obj.callFunction<void>();
		}
	};
	wrapper_osg_Stencil(lua_State* L, lua_Table* dum, const osg::Stencil & stencil, const osg::CopyOp & copyop = osg::CopyOp::SHALLOW_COPY) 
		: osg::Stencil(stencil, copyop), luna_wrapper_base(L) { 
		register_protected_methods(L);
		if(_obj.pushFunction("buildInstance")) {
			_obj.pushArg((osg::Stencil*)this);
			_obj.callFunction<void>();
	...
	void setThreadSafeRefUnref(bool threadSafe) {
		...
		return Stencil::setThreadSafeRefUnref(threadSafe);
	};
	...
	void computeDataVariance() {
		...
		return Stencil::computeDataVariance();
	};
	...
	void setUserData(osg::Referenced * obj) {
		...
		return Stencil::setUserData(obj);
	};
	...
	bool isTextureAttribute() const {
		...
		return Stencil::isTextureAttribute();
	};
	...
	bool checkValidityOfAssociatedModes(osg::State & arg1) const {
		...
		return Stencil::checkValidityOfAssociatedModes(arg1);
	};
	...
	void compileGLObjects(osg::State & arg1) const {
		...
		return Stencil::compileGLObjects(arg1);
	};
	...
	void releaseGLObjects(osg::State * arg1 = 0) const {
		...
		return Stencil::releaseGLObjects(arg1);
	};
	...
	bool isSameKindAs(const osg::Object * obj) const {
		...
		return Stencil::isSameKindAs(obj);
	};
	...
	bool getModeUsage(osg::StateAttribute::ModeUsage & arg1) const {
		...
		return Stencil::getModeUsage(arg1);
	};
	...
	static int _bind_public_addParent(lua_State *L) {
		...
		wrapper_osg_Stencil* self=Luna< osg::Referenced >::checkSubType< wrapper_osg_Stencil >(L,1);
		if(!self) {
			luna_printStack(L);
