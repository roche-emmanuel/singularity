...
public:
	...
	wrapper_osg_Stencil(lua_State* L, lua_Table* dum) : osg::Stencil(), luna_wrapper_base(L) { register_protected_methods(L); };
	wrapper_osg_Stencil(lua_State* L, lua_Table* dum, const osg::Stencil & stencil, const osg::CopyOp & copyop = osg::CopyOp::SHALLOW_COPY) : osg::Stencil(stencil, copyop), luna_wrapper_base(L) { register_protected_methods(L); };
