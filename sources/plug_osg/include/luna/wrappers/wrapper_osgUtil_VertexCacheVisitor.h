...
class wrapper_osgUtil_VertexCacheVisitor : public osgUtil::VertexCacheVisitor {
protected:
	sgt::LuaObject _obj;
...
public:
	...
	wrapper_osgUtil_VertexCacheVisitor(lua_State* L, lua_Table* dum, osgUtil::Optimizer * optimizer = 0) : osgUtil::VertexCacheVisitor(optimizer), _obj(L,-1) {};
