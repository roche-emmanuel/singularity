...
public:
	...
	wrapper_osgUtil_VertexCacheVisitor(lua_State* L, lua_Table* dum, osgUtil::Optimizer * optimizer = 0) : osgUtil::VertexCacheVisitor(optimizer), luna_wrapper_base(L) { register_protected_methods(L); };
