...
public:
	...
	void setThreadSafeRefUnref(bool threadSafe) {
		...
		return ApplicationUsage::setThreadSafeRefUnref(threadSafe);
	};
	...
	static int _bind_public_signalObserversAndDelete(lua_State *L) {
		...
		wrapper_osg_ApplicationUsage* self=Luna< osg::Referenced >::checkSubType< wrapper_osg_ApplicationUsage >(L,1);
		if(!self) {
			luna_printStack(L);
