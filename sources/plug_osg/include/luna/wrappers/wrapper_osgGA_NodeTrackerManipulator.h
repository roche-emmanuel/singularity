...
public:
	...
	static int _bind_public_computeNodeWorldToLocal(lua_State *L) {
		...
		if(!self) {
			luaL_error(L, "Invalid object in function call void osgGA::NodeTrackerManipulator::public_computeNodeWorldToLocal(osg::Matrixd &) const. Got : '%s'\n%s",typeid(Luna< osg::Referenced >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_public_computeNodeLocalToWorld(lua_State *L) {
		...
		wrapper_osgGA_NodeTrackerManipulator* self=Luna< osg::Referenced >::checkSubType< wrapper_osgGA_NodeTrackerManipulator >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void osgGA::NodeTrackerManipulator::public_computeNodeLocalToWorld(osg::Matrixd &) const. Got : '%s'\n%s",typeid(Luna< osg::Referenced >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_public_computeNodeCenterAndRotation(lua_State *L) {
		...
		wrapper_osgGA_NodeTrackerManipulator* self=Luna< osg::Referenced >::checkSubType< wrapper_osgGA_NodeTrackerManipulator >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void osgGA::NodeTrackerManipulator::public_computeNodeCenterAndRotation(osg::Vec3d &, osg::Quat &) const. Got : '%s'\n%s",typeid(Luna< osg::Referenced >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_public_computePosition(lua_State *L) {
		...
		wrapper_osgGA_NodeTrackerManipulator* self=Luna< osg::Referenced >::checkSubType< wrapper_osgGA_NodeTrackerManipulator >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void osgGA::NodeTrackerManipulator::public_computePosition(const osg::Vec3d &, const osg::Vec3d &, const osg::Vec3d &). Got : '%s'\n%s",typeid(Luna< osg::Referenced >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
