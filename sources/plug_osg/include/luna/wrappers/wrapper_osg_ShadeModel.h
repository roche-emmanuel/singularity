...
class wrapper_osg_ShadeModel : public osg::ShadeModel {
protected:
	sgt::LuaObject _obj;
...
public:
	...
	wrapper_osg_ShadeModel(lua_State* L, lua_Table* dum, osg::ShadeModel::Mode mode = osg::ShadeModel::SMOOTH) : osg::ShadeModel(mode), _obj(L,-1) {};
	wrapper_osg_ShadeModel(lua_State* L, lua_Table* dum, const osg::ShadeModel & sm, const osg::CopyOp & copyop = osg::CopyOp::SHALLOW_COPY) : osg::ShadeModel(sm, copyop), _obj(L,-1) {};
