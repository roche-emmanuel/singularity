...
public:
	...
	wrapper_osg_TriangleMesh(lua_State* L, lua_Table* dum) : osg::TriangleMesh(), luna_wrapper_base(L) { register_protected_methods(L); };
	wrapper_osg_TriangleMesh(lua_State* L, lua_Table* dum, const osg::TriangleMesh & mesh, const osg::CopyOp & copyop = osg::CopyOp::SHALLOW_COPY) : osg::TriangleMesh(mesh, copyop), luna_wrapper_base(L) { register_protected_methods(L); };
