...
public:
	...
	wrapper_osg_BufferData(lua_State* L, lua_Table* dum) : osg::BufferData(), luna_wrapper_base(L) {};
	wrapper_osg_BufferData(lua_State* L, lua_Table* dum, const osg::BufferData & bd, const osg::CopyOp & copyop = osg::CopyOp::SHALLOW_COPY) : osg::BufferData(bd, copyop), luna_wrapper_base(L) {};
