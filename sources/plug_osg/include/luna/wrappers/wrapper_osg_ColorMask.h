#ifndef _WRAPPERS_WRAPPER_OSG_COLORMASK_H_
#define _WRAPPERS_WRAPPER_OSG_COLORMASK_H_
...
public:
	...
	~wrapper_osg_ColorMask() {
		logDEBUG3("Calling delete function for wrapper osg_ColorMask");
		if(_obj.pushFunction("delete")) {
			//_obj.pushArg((osg::ColorMask*)this); // No this argument or the object will be referenced again!
			_obj.callFunction<void>();
		}
	};
	
	wrapper_osg_ColorMask(lua_State* L, lua_Table* dum) 
		: osg::ColorMask(), luna_wrapper_base(L) { 
		register_protected_methods(L); 
		if(_obj.pushFunction("buildInstance")) {
			_obj.pushArg((osg::ColorMask*)this);
			_obj.callFunction<void>();
		}
	};
	wrapper_osg_ColorMask(lua_State* L, lua_Table* dum, bool red, bool green, bool blue, bool alpha) 
		: osg::ColorMask(red, green, blue, alpha), luna_wrapper_base(L) { 
		register_protected_methods(L);
		if(_obj.pushFunction("buildInstance")) {
			_obj.pushArg((osg::ColorMask*)this);
			_obj.callFunction<void>();
	...
	wrapper_osg_ColorMask(lua_State* L, lua_Table* dum, const osg::ColorMask & cm, const osg::CopyOp & copyop = osg::CopyOp::SHALLOW_COPY) 
		: osg::ColorMask(cm, copyop), luna_wrapper_base(L) { 
		register_protected_methods(L);
		if(_obj.pushFunction("buildInstance")) {
			_obj.pushArg((osg::ColorMask*)this);
			_obj.callFunction<void>();
	...
	void setThreadSafeRefUnref(bool threadSafe) {
		...
		return ColorMask::setThreadSafeRefUnref(threadSafe);
	};
	...
	void computeDataVariance() {
		...
		return ColorMask::computeDataVariance();
	};
	...
	void setUserData(osg::Referenced * obj) {
		...
		return ColorMask::setUserData(obj);
	};
	...
	bool isTextureAttribute() const {
		...
		return ColorMask::isTextureAttribute();
	};
	...
	bool getModeUsage(osg::StateAttribute::ModeUsage & arg1) const {
		...
		return ColorMask::getModeUsage(arg1);
	};
	...
	bool checkValidityOfAssociatedModes(osg::State & arg1) const {
		...
		return ColorMask::checkValidityOfAssociatedModes(arg1);
	};
	...
	void compileGLObjects(osg::State & arg1) const {
		...
		return ColorMask::compileGLObjects(arg1);
	};
	...
	void releaseGLObjects(osg::State * arg1 = 0) const {
		...
		return ColorMask::releaseGLObjects(arg1);
	};
	...
	bool isSameKindAs(const osg::Object * obj) const {
		...
		return ColorMask::isSameKindAs(obj);
	};
	...
	static int _bind_public_addParent(lua_State *L) {
		...
		wrapper_osg_ColorMask* self=Luna< osg::Referenced >::checkSubType< wrapper_osg_ColorMask >(L,1);
		if(!self) {
			luna_printStack(L);
