...
public:
	...
	wrapper_osgParticle_ConstantRateCounter(lua_State* L, lua_Table* dum) : osgParticle::ConstantRateCounter(), luna_wrapper_base(L) { register_protected_methods(L); };
	wrapper_osgParticle_ConstantRateCounter(lua_State* L, lua_Table* dum, const osgParticle::ConstantRateCounter & copy, const osg::CopyOp & copyop = osg::CopyOp::SHALLOW_COPY) : osgParticle::ConstantRateCounter(copy, copyop), luna_wrapper_base(L) { register_protected_methods(L); };
