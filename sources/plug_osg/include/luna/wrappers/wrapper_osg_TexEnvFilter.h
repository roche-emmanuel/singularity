...
public:
	...
	wrapper_osg_TexEnvFilter(lua_State* L, lua_Table* dum, float lodBias = 0.0f) : osg::TexEnvFilter(lodBias), luna_wrapper_base(L) { register_protected_methods(L); };
	wrapper_osg_TexEnvFilter(lua_State* L, lua_Table* dum, const osg::TexEnvFilter & texenv, const osg::CopyOp & copyop = osg::CopyOp::SHALLOW_COPY) : osg::TexEnvFilter(texenv, copyop), luna_wrapper_base(L) { register_protected_methods(L); };
