...
public:
	...
	~wrapper_osg_Cylinder() {
		logDEBUG3("Calling delete function for wrapper osg_Cylinder");
		if(_obj.pushFunction("delete")) {
			//_obj.pushArg((osg::Cylinder*)this); // No this argument or the object will be referenced again!
			_obj.callFunction<void>();
		}
	};
	
	wrapper_osg_Cylinder(lua_State* L, lua_Table* dum) 
		: osg::Cylinder(), luna_wrapper_base(L) { 
		register_protected_methods(L); 
		if(_obj.pushFunction("buildInstance")) {
			_obj.pushArg((osg::Cylinder*)this);
			_obj.callFunction<void>();
		}
	};
	wrapper_osg_Cylinder(lua_State* L, lua_Table* dum, const osg::Vec3f & center, float radius, float height) 
		: osg::Cylinder(center, radius, height), luna_wrapper_base(L) { 
		register_protected_methods(L);
		if(_obj.pushFunction("buildInstance")) {
			_obj.pushArg((osg::Cylinder*)this);
			_obj.callFunction<void>();
	...
	wrapper_osg_Cylinder(lua_State* L, lua_Table* dum, const osg::Cylinder & cylinder, const osg::CopyOp & copyop = osg::CopyOp::SHALLOW_COPY) 
		: osg::Cylinder(cylinder, copyop), luna_wrapper_base(L) { 
		register_protected_methods(L);
		if(_obj.pushFunction("buildInstance")) {
			_obj.pushArg((osg::Cylinder*)this);
			_obj.callFunction<void>();
	...
	void setThreadSafeRefUnref(bool threadSafe) {
		...
		return Cylinder::setThreadSafeRefUnref(threadSafe);
	};
