...
public:
	...
	~wrapper_osg_ColorMatrix() {
		...
		if(_obj.pushFunction("delete")) {
			//_obj.pushArg((osg::ColorMatrix*)this); // No this argument or the object will be referenced again!
			_obj.callFunction<void>();
		}
	};
	
	wrapper_osg_ColorMatrix(lua_State* L, lua_Table* dum) 
		: osg::ColorMatrix(), luna_wrapper_base(L) { 
		register_protected_methods(L); 
		if(_obj.pushFunction("buildInstance")) {
			_obj.pushArg((osg::ColorMatrix*)this);
			_obj.callFunction<void>();
		}
	};
	wrapper_osg_ColorMatrix(lua_State* L, lua_Table* dum, const osg::ColorMatrix & cm, const osg::CopyOp & copyop = osg::CopyOp::SHALLOW_COPY) 
		: osg::ColorMatrix(cm, copyop), luna_wrapper_base(L) { 
		register_protected_methods(L);
		if(_obj.pushFunction("buildInstance")) {
			_obj.pushArg((osg::ColorMatrix*)this);
			_obj.callFunction<void>();
