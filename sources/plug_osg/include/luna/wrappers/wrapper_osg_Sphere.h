...
public:
	...
	wrapper_osg_Sphere(lua_State* L, lua_Table* dum) : osg::Sphere(), luna_wrapper_base(L) { register_protected_methods(L); };
	wrapper_osg_Sphere(lua_State* L, lua_Table* dum, const osg::Vec3f & center, float radius) : osg::Sphere(center, radius), luna_wrapper_base(L) { register_protected_methods(L); };
	wrapper_osg_Sphere(lua_State* L, lua_Table* dum, const osg::Sphere & sphere, const osg::CopyOp & copyop = osg::CopyOp::SHALLOW_COPY) : osg::Sphere(sphere, copyop), luna_wrapper_base(L) { register_protected_methods(L); };
