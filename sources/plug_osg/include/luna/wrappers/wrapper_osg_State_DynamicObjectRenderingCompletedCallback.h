...
public:
	...
	wrapper_osg_State_DynamicObjectRenderingCompletedCallback(lua_State* L, lua_Table* dum) : osg::State::DynamicObjectRenderingCompletedCallback(), luna_wrapper_base(L) { register_protected_methods(L); };
