...
class wrapper_osgViewer_StatsHandler : public osgViewer::StatsHandler {
protected:
	sgt::LuaObject _obj;
...
public:
	...
	wrapper_osgViewer_StatsHandler(lua_State* L, lua_Table* dum) : osgViewer::StatsHandler(), _obj(L,-1) {};
	...
	bool handle(const osgGA::GUIEventAdapter & arg1, osgGA::GUIActionAdapter & arg2) {
		...
		return osgViewer::StatsHandler::handle(arg1, arg2);
	};
	...
	void getUsage(osg::ApplicationUsage & usage) const {
		...
		return osgViewer::StatsHandler::getUsage(usage);
	};
