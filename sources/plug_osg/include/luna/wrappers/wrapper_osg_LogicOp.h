...
public:
	...
	wrapper_osg_LogicOp(lua_State* L, lua_Table* dum) : osg::LogicOp(), luna_wrapper_base(L) { register_protected_methods(L); };
	wrapper_osg_LogicOp(lua_State* L, lua_Table* dum, osg::LogicOp::Opcode opcode) : osg::LogicOp(opcode), luna_wrapper_base(L) { register_protected_methods(L); };
	wrapper_osg_LogicOp(lua_State* L, lua_Table* dum, const osg::LogicOp & trans, const osg::CopyOp & copyop = osg::CopyOp::SHALLOW_COPY) : osg::LogicOp(trans, copyop), luna_wrapper_base(L) { register_protected_methods(L); };
