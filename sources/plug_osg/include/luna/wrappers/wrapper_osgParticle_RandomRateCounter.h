...
public:
	...
	wrapper_osgParticle_RandomRateCounter(lua_State* L, lua_Table* dum) : osgParticle::RandomRateCounter(), luna_wrapper_base(L) { register_protected_methods(L); };
	wrapper_osgParticle_RandomRateCounter(lua_State* L, lua_Table* dum, const osgParticle::RandomRateCounter & copy, const osg::CopyOp & copyop = osg::CopyOp::SHALLOW_COPY) : osgParticle::RandomRateCounter(copy, copyop), luna_wrapper_base(L) { register_protected_methods(L); };
