...
class wrapper_osgViewer_LODScaleHandler : public osgViewer::LODScaleHandler {
protected:
	sgt::LuaObject _obj;
...
public:
	...
	wrapper_osgViewer_LODScaleHandler(lua_State* L, lua_Table* dum) : osgViewer::LODScaleHandler(), _obj(L,-1) {};
	...
	bool handle(const osgGA::GUIEventAdapter & arg1, osgGA::GUIActionAdapter & arg2) {
		...
		return osgViewer::LODScaleHandler::handle(arg1, arg2);
	};
	...
	void getUsage(osg::ApplicationUsage & usage) const {
		...
		return osgViewer::LODScaleHandler::getUsage(usage);
	};
