...
public:
	...
	~wrapper_osg_TexGenNode() {
		...
		if(_obj.pushFunction("delete")) {
			//_obj.pushArg((osg::TexGenNode*)this); // No this argument or the object will be referenced again!
			_obj.callFunction<void>();
		}
	};
	
	wrapper_osg_TexGenNode(lua_State* L, lua_Table* dum) 
		: osg::TexGenNode(), luna_wrapper_base(L) { 
	...
	wrapper_osg_TexGenNode(lua_State* L, lua_Table* dum, osg::TexGen * texgen) 
		: osg::TexGenNode(texgen), luna_wrapper_base(L) { 
		register_protected_methods(L);
		if(_obj.pushFunction("buildInstance")) {
			_obj.pushArg((osg::TexGenNode*)this);
			_obj.callFunction<void>();
	...
	wrapper_osg_TexGenNode(lua_State* L, lua_Table* dum, const osg::TexGenNode & tgb, const osg::CopyOp & copyop = osg::CopyOp::SHALLOW_COPY) 
		: osg::TexGenNode(tgb, copyop), luna_wrapper_base(L) { 
		register_protected_methods(L);
		if(_obj.pushFunction("buildInstance")) {
			_obj.pushArg((osg::TexGenNode*)this);
			_obj.callFunction<void>();
