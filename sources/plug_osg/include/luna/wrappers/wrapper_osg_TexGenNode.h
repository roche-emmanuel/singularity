#ifndef _WRAPPERS_WRAPPER_OSG_TEXGENNODE_H_
#define _WRAPPERS_WRAPPER_OSG_TEXGENNODE_H_
...
public:
	...
	wrapper_osg_TexGenNode(lua_State* L, lua_Table* dum) : osg::TexGenNode(), luna_wrapper_base(L) { register_protected_methods(L); };
	wrapper_osg_TexGenNode(lua_State* L, lua_Table* dum, osg::TexGen * texgen) : osg::TexGenNode(texgen), luna_wrapper_base(L) { register_protected_methods(L); };
	wrapper_osg_TexGenNode(lua_State* L, lua_Table* dum, const osg::TexGenNode & tgb, const osg::CopyOp & copyop = osg::CopyOp::SHALLOW_COPY) : osg::TexGenNode(tgb, copyop), luna_wrapper_base(L) { register_protected_methods(L); };
	...
	void setName(const std::string & name) {
		...
		return TexGenNode::setName(name);
	};
	...
	void computeDataVariance() {
		...
		return TexGenNode::computeDataVariance();
	};
	...
	void setUserData(osg::Referenced * obj) {
		...
		return TexGenNode::setUserData(obj);
	};
	...
	void traverse(osg::NodeVisitor & arg1) {
		...
		return TexGenNode::traverse(arg1);
	};
	...
	bool addChild(osg::Node * child) {
		...
		return TexGenNode::addChild(child);
	};
	...
	bool insertChild(unsigned int index, osg::Node * child) {
		...
		return TexGenNode::insertChild(index, child);
	};
	...
	bool removeChildren(unsigned int pos, unsigned int numChildrenToRemove) {
		...
		return TexGenNode::removeChildren(pos, numChildrenToRemove);
	};
	...
	bool replaceChild(osg::Node * origChild, osg::Node * newChild) {
		...
		return TexGenNode::replaceChild(origChild, newChild);
	};
	...
	bool setChild(unsigned int i, osg::Node * node) {
		...
		return TexGenNode::setChild(i, node);
	};
	...
	void releaseGLObjects(osg::State * arg1 = 0) const {
		...
		return TexGenNode::releaseGLObjects(arg1);
	};
	...
	osg::BoundingSphered computeBound() const {
		...
		return TexGenNode::computeBound();
	};
	...
	osg::Object * clone(const osg::CopyOp & copyop) const {
		...
		return TexGenNode::clone(copyop);
	};
	...
	bool isSameKindAs(const osg::Object * obj) const {
		...
		return TexGenNode::isSameKindAs(obj);
	};
...
protected:
	...
	void childRemoved(unsigned int arg1, unsigned int arg2) {
		...
		return TexGenNode::childRemoved(arg1, arg2);
	};
	...
	void childInserted(unsigned int arg1) {
		...
		return TexGenNode::childInserted(arg1);
	};
...
public:
	...
	static int _bind_public_addParent(lua_State *L) {
		...
		wrapper_osg_TexGenNode* self=Luna< osg::Referenced >::checkSubType< wrapper_osg_TexGenNode >(L,1);
		if(!self) {
			luna_printStack(L);
