...
public:
	...
	wrapper_osg_StateAttribute(lua_State* L, lua_Table* dum) : osg::StateAttribute(), luna_wrapper_base(L) { register_protected_methods(L); };
	wrapper_osg_StateAttribute(lua_State* L, lua_Table* dum, const osg::StateAttribute & sa, const osg::CopyOp & copyop = osg::CopyOp::SHALLOW_COPY) : osg::StateAttribute(sa, copyop), luna_wrapper_base(L) { register_protected_methods(L); };
