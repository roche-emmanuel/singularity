...
public:
	...
	wrapper_osg_TexGen(lua_State* L, lua_Table* dum) : osg::TexGen(), luna_wrapper_base(L) { register_protected_methods(L); };
	wrapper_osg_TexGen(lua_State* L, lua_Table* dum, const osg::TexGen & texgen, const osg::CopyOp & copyop = osg::CopyOp::SHALLOW_COPY) : osg::TexGen(texgen, copyop), luna_wrapper_base(L) { register_protected_methods(L); };
