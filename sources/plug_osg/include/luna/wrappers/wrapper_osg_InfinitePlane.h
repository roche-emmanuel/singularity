...
class wrapper_osg_InfinitePlane : public osg::InfinitePlane, public luna_wrapper_base {

public:
		

	~wrapper_osg_InfinitePlane() {
		logDEBUG3("Calling delete function for wrapper osg_InfinitePlane");
		if(_obj.pushFunction("delete")) {
			//_obj.pushArg((osg::InfinitePlane*)this); // No this argument or the object will be referenced again!
			_obj.callFunction<void>();
		}
	};
	
	wrapper_osg_InfinitePlane(lua_State* L, lua_Table* dum) 
		: osg::InfinitePlane(), luna_wrapper_base(L) { 
		register_protected_methods(L); 
		if(_obj.pushFunction("buildInstance")) {
			_obj.pushArg((osg::InfinitePlane*)this);
			_obj.callFunction<void>();
		}
	};
	wrapper_osg_InfinitePlane(lua_State* L, lua_Table* dum, const osg::InfinitePlane & plane, const osg::CopyOp & copyop = osg::CopyOp::SHALLOW_COPY) 
		: osg::InfinitePlane(plane, copyop), luna_wrapper_base(L) { 
		register_protected_methods(L);
		if(_obj.pushFunction("buildInstance")) {
			_obj.pushArg((osg::InfinitePlane*)this);
			_obj.callFunction<void>();
	...
	void setThreadSafeRefUnref(bool threadSafe) {
		...
		return InfinitePlane::setThreadSafeRefUnref(threadSafe);
	};
	...
	static int _bind_public_signalObserversAndDelete(lua_State *L) {
		...
		wrapper_osg_InfinitePlane* self=Luna< osg::Referenced >::checkSubType< wrapper_osg_InfinitePlane >(L,1);
		if(!self) {
			luna_printStack(L);
