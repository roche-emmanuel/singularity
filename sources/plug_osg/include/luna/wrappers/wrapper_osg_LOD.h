...
public:
	...
	wrapper_osg_LOD(lua_State* L, lua_Table* dum) : osg::LOD(), luna_wrapper_base(L) { register_protected_methods(L); };
	wrapper_osg_LOD(lua_State* L, lua_Table* dum, const osg::LOD & arg1, const osg::CopyOp & copyop = osg::CopyOp::SHALLOW_COPY) : osg::LOD(arg1, copyop), luna_wrapper_base(L) { register_protected_methods(L); };
