...
public:
	...
	bool isSameKindAs(const osg::Object * obj) const {
		...
		return osg::LOD::isSameKindAs(obj);
	};
	...
	bool addChild(osg::Node * child, float min, float max) {
		...
		return osg::LOD::addChild(child, min, max);
	};
