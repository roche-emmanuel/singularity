...
public:
	...
	~wrapper_osgUtil_DrawElementTypeSimplifierVisitor() {
		logDEBUG3("Calling delete function for wrapper osgUtil_DrawElementTypeSimplifierVisitor");
		if(_obj.pushFunction("delete")) {
			//_obj.pushArg((osgUtil::DrawElementTypeSimplifierVisitor*)this); // No this argument or the object will be referenced again!
			_obj.callFunction<void>();
		}
	};
	
	wrapper_osgUtil_DrawElementTypeSimplifierVisitor(lua_State* L, lua_Table* dum) 
		: osgUtil::DrawElementTypeSimplifierVisitor(), luna_wrapper_base(L) { 
		register_protected_methods(L); 
		if(_obj.pushFunction("buildInstance")) {
			_obj.pushArg((osgUtil::DrawElementTypeSimplifierVisitor*)this);
			_obj.callFunction<void>();
		}
	};
