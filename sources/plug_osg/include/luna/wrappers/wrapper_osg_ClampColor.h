#ifndef _WRAPPERS_WRAPPER_OSG_CLAMPCOLOR_H_
#define _WRAPPERS_WRAPPER_OSG_CLAMPCOLOR_H_
...
public:
	...
	void setThreadSafeRefUnref(bool threadSafe) {
		...
		return ClampColor::setThreadSafeRefUnref(threadSafe);
	};
	...
	static int _bind_public_addParent(lua_State *L) {
		...
		wrapper_osg_ClampColor* self=Luna< osg::Referenced >::checkSubType< wrapper_osg_ClampColor >(L,1);
		if(!self) {
			luna_printStack(L);
