...
public:
	...
	wrapper_osg_TexMat(lua_State* L, lua_Table* dum) : osg::TexMat(), luna_wrapper_base(L) { register_protected_methods(L); };
	wrapper_osg_TexMat(lua_State* L, lua_Table* dum, const osg::Matrixd & matrix) : osg::TexMat(matrix), luna_wrapper_base(L) { register_protected_methods(L); };
	wrapper_osg_TexMat(lua_State* L, lua_Table* dum, const osg::TexMat & texmat, const osg::CopyOp & copyop = osg::CopyOp::SHALLOW_COPY) : osg::TexMat(texmat, copyop), luna_wrapper_base(L) { register_protected_methods(L); };
