...
public:
	...
	~wrapper_osg_LineStipple() {
		...
		if(_obj.pushFunction("delete")) {
			//_obj.pushArg((osg::LineStipple*)this); // No this argument or the object will be referenced again!
			_obj.callFunction<void>();
		}
	};
	
	wrapper_osg_LineStipple(lua_State* L, lua_Table* dum) 
		: osg::LineStipple(), luna_wrapper_base(L) { 
		register_protected_methods(L); 
		if(_obj.pushFunction("buildInstance")) {
			_obj.pushArg((osg::LineStipple*)this);
			_obj.callFunction<void>();
		}
	};
	wrapper_osg_LineStipple(lua_State* L, lua_Table* dum, int factor, unsigned short pattern) 
		: osg::LineStipple(factor, pattern), luna_wrapper_base(L) { 
		register_protected_methods(L);
		if(_obj.pushFunction("buildInstance")) {
			_obj.pushArg((osg::LineStipple*)this);
			_obj.callFunction<void>();
	...
	wrapper_osg_LineStipple(lua_State* L, lua_Table* dum, const osg::LineStipple & lw, const osg::CopyOp & copyop = osg::CopyOp::SHALLOW_COPY) 
		: osg::LineStipple(lw, copyop), luna_wrapper_base(L) { 
		register_protected_methods(L);
		if(_obj.pushFunction("buildInstance")) {
			_obj.pushArg((osg::LineStipple*)this);
			_obj.callFunction<void>();
	...
	void setThreadSafeRefUnref(bool threadSafe) {
		...
		return LineStipple::setThreadSafeRefUnref(threadSafe);
	};
