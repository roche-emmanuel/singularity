...
public:
	...
	wrapper_osg_VertexBufferObject(lua_State* L, lua_Table* dum) : osg::VertexBufferObject(), luna_wrapper_base(L) { register_protected_methods(L); };
	wrapper_osg_VertexBufferObject(lua_State* L, lua_Table* dum, const osg::VertexBufferObject & vbo, const osg::CopyOp & copyop = osg::CopyOp::SHALLOW_COPY) : osg::VertexBufferObject(vbo, copyop), luna_wrapper_base(L) { register_protected_methods(L); };
