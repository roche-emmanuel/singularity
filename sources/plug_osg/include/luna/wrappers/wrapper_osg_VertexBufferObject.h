...
class wrapper_osg_VertexBufferObject : public osg::VertexBufferObject {
protected:
	sgt::LuaObject _obj;
...
public:
	...
	wrapper_osg_VertexBufferObject(lua_State* L, lua_Table* dum) : osg::VertexBufferObject(), _obj(L,-1) {};
	wrapper_osg_VertexBufferObject(lua_State* L, lua_Table* dum, const osg::VertexBufferObject & vbo, const osg::CopyOp & copyop = osg::CopyOp::SHALLOW_COPY) : osg::VertexBufferObject(vbo, copyop), _obj(L,-1) {};
	...
	osg::Object * clone(const osg::CopyOp & arg1) const {
		...
		return osg::VertexBufferObject::clone(arg1);
	};
	...
	bool isSameKindAs(const osg::Object * obj) const {
		...
		return osg::VertexBufferObject::isSameKindAs(obj);
	};
