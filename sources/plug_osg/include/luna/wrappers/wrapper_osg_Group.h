...
public:
	...
	wrapper_osg_Group(lua_State* L, lua_Table* dum) : osg::Group(), luna_wrapper_base(L) { register_protected_methods(L); };
	wrapper_osg_Group(lua_State* L, lua_Table* dum, const osg::Group & arg1, const osg::CopyOp & copyop = osg::CopyOp::SHALLOW_COPY) : osg::Group(arg1, copyop), luna_wrapper_base(L) { register_protected_methods(L); };
