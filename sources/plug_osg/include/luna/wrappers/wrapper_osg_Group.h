...
class wrapper_osg_Group : public osg::Group {
protected:
	sgt::LuaObject _obj;
...
public:
	...
	wrapper_osg_Group(lua_State* L, lua_Table* dum) : osg::Group(), _obj(L,-1) {};
	wrapper_osg_Group(lua_State* L, lua_Table* dum, const osg::Group & arg1, const osg::CopyOp & copyop = osg::CopyOp::SHALLOW_COPY) : osg::Group(arg1, copyop), _obj(L,-1) {};
