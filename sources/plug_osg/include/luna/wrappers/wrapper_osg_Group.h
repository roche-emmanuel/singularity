#ifndef _WRAPPERS_WRAPPER_OSG_GROUP_H_
#define _WRAPPERS_WRAPPER_OSG_GROUP_H_
...
public:
	...
	~wrapper_osg_Group() {
		logDEBUG3("Calling delete function for wrapper osg_Group");
		if(_obj.pushFunction("delete")) {
			//_obj.pushArg((osg::Group*)this); // No this argument or the object will be referenced again!
			_obj.callFunction<void>();
		}
	};
	
	wrapper_osg_Group(lua_State* L, lua_Table* dum) 
		: osg::Group(), luna_wrapper_base(L) { 
		register_protected_methods(L); 
		if(_obj.pushFunction("buildInstance")) {
			_obj.pushArg((osg::Group*)this);
			_obj.callFunction<void>();
		}
	};
	wrapper_osg_Group(lua_State* L, lua_Table* dum, const osg::Group & arg1, const osg::CopyOp & copyop = osg::CopyOp::SHALLOW_COPY) 
		: osg::Group(arg1, copyop), luna_wrapper_base(L) { 
		register_protected_methods(L);
		if(_obj.pushFunction("buildInstance")) {
			_obj.pushArg((osg::Group*)this);
			_obj.callFunction<void>();
...
protected:
	...
	void childRemoved(unsigned int arg1, unsigned int arg2) {
		...
		return Group::childRemoved(arg1, arg2);
	};
	...
	void childInserted(unsigned int arg1) {
		...
		return Group::childInserted(arg1);
	};
...
public:
	...
	void computeDataVariance() {
		...
		return Group::computeDataVariance();
	};
	...
	void setThreadSafeRefUnref(bool threadSafe) {
		...
		return Group::setThreadSafeRefUnref(threadSafe);
	};
	...
	void releaseGLObjects(osg::State * arg1 = 0) const {
		...
		return Group::releaseGLObjects(arg1);
	};
	...
	static int _bind_public_addParent(lua_State *L) {
		...
		wrapper_osg_Group* self=Luna< osg::Referenced >::checkSubType< wrapper_osg_Group >(L,1);
		if(!self) {
			luna_printStack(L);
