...
public:
	...
	bool handle(const osgGA::GUIEventAdapter & arg1, osgGA::GUIActionAdapter & arg2) {
		...
		return osgViewer::ScreenCaptureHandler::handle(arg1, arg2);
	};
	...
	void captureNextFrame(osgViewer::ViewerBase & viewer) {
		...
		return osgViewer::ScreenCaptureHandler::captureNextFrame(viewer);
	};
	...
	void getUsage(osg::ApplicationUsage & usage) const {
		...
		return osgViewer::ScreenCaptureHandler::getUsage(usage);
	};
