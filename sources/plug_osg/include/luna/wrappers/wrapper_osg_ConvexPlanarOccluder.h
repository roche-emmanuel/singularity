...
public:
	...
	wrapper_osg_ConvexPlanarOccluder(lua_State* L, lua_Table* dum) : osg::ConvexPlanarOccluder(), luna_wrapper_base(L) { register_protected_methods(L); };
	wrapper_osg_ConvexPlanarOccluder(lua_State* L, lua_Table* dum, const osg::ConvexPlanarOccluder & cpo, const osg::CopyOp & copyop = osg::CopyOp::SHALLOW_COPY) : osg::ConvexPlanarOccluder(cpo, copyop), luna_wrapper_base(L) { register_protected_methods(L); };
