...
class wrapper_osg_ClearNode : public osg::ClearNode {
protected:
	sgt::LuaObject _obj;
...
public:
	...
	wrapper_osg_ClearNode(lua_State* L, lua_Table* dum) : osg::ClearNode(), _obj(L,-1) {};
	wrapper_osg_ClearNode(lua_State* L, lua_Table* dum, const osg::ClearNode & cs, const osg::CopyOp & copyop = osg::CopyOp::SHALLOW_COPY) : osg::ClearNode(cs, copyop), _obj(L,-1) {};
