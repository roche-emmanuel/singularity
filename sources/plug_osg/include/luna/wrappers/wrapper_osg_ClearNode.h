#ifndef _WRAPPERS_WRAPPER_OSG_CLEARNODE_H_
#define _WRAPPERS_WRAPPER_OSG_CLEARNODE_H_
...
class wrapper_osg_ClearNode : public osg::ClearNode, public luna_wrapper_base {

public:
		

	~wrapper_osg_ClearNode() {
		logDEBUG3("Calling delete function for wrapper osg_ClearNode");
		if(_obj.pushFunction("delete")) {
			//_obj.pushArg((osg::ClearNode*)this); // No this argument or the object will be referenced again!
			_obj.callFunction<void>();
		}
	};
	
	wrapper_osg_ClearNode(lua_State* L, lua_Table* dum) 
		: osg::ClearNode(), luna_wrapper_base(L) { 
		register_protected_methods(L); 
		if(_obj.pushFunction("buildInstance")) {
			_obj.pushArg((osg::ClearNode*)this);
			_obj.callFunction<void>();
		}
	};
	wrapper_osg_ClearNode(lua_State* L, lua_Table* dum, const osg::ClearNode & cs, const osg::CopyOp & copyop = osg::CopyOp::SHALLOW_COPY) 
		: osg::ClearNode(cs, copyop), luna_wrapper_base(L) { 
		register_protected_methods(L);
		if(_obj.pushFunction("buildInstance")) {
			_obj.pushArg((osg::ClearNode*)this);
			_obj.callFunction<void>();
...
protected:
	...
	void childRemoved(unsigned int arg1, unsigned int arg2) {
		...
		return ClearNode::childRemoved(arg1, arg2);
	};
	...
	void childInserted(unsigned int arg1) {
		...
		return ClearNode::childInserted(arg1);
	};
...
public:
	...
	void computeDataVariance() {
		...
		return ClearNode::computeDataVariance();
	};
	...
	void setUserData(osg::Referenced * obj) {
		...
		return ClearNode::setUserData(obj);
	};
	...
	void traverse(osg::NodeVisitor & arg1) {
		...
		return ClearNode::traverse(arg1);
	};
	...
	bool addChild(osg::Node * child) {
		...
		return ClearNode::addChild(child);
	};
	...
	bool insertChild(unsigned int index, osg::Node * child) {
		...
		return ClearNode::insertChild(index, child);
	};
	...
	bool removeChildren(unsigned int pos, unsigned int numChildrenToRemove) {
		...
		return ClearNode::removeChildren(pos, numChildrenToRemove);
	};
	...
	bool replaceChild(osg::Node * origChild, osg::Node * newChild) {
		...
		return ClearNode::replaceChild(origChild, newChild);
	};
	...
	bool setChild(unsigned int i, osg::Node * node) {
		...
		return ClearNode::setChild(i, node);
	};
	...
	void setThreadSafeRefUnref(bool threadSafe) {
		...
		return ClearNode::setThreadSafeRefUnref(threadSafe);
	};
	...
	void releaseGLObjects(osg::State * arg1 = 0) const {
		...
		return ClearNode::releaseGLObjects(arg1);
	};
	...
	bool isSameKindAs(const osg::Object * obj) const {
		...
		return ClearNode::isSameKindAs(obj);
	};
	...
	static int _bind_public_addParent(lua_State *L) {
		...
		wrapper_osg_ClearNode* self=Luna< osg::Referenced >::checkSubType< wrapper_osg_ClearNode >(L,1);
		if(!self) {
			luna_printStack(L);
