...
public:
	...
	wrapper_osg_ClearNode(lua_State* L, lua_Table* dum) : osg::ClearNode(), luna_wrapper_base(L) {};
	wrapper_osg_ClearNode(lua_State* L, lua_Table* dum, const osg::ClearNode & cs, const osg::CopyOp & copyop = osg::CopyOp::SHALLOW_COPY) : osg::ClearNode(cs, copyop), luna_wrapper_base(L) {};
