...
public:
	...
	wrapper_osg_Camera(lua_State* L, lua_Table* dum) : osg::Camera(), luna_wrapper_base(L) { register_protected_methods(L); };
	wrapper_osg_Camera(lua_State* L, lua_Table* dum, const osg::Camera & arg1, const osg::CopyOp & copyop = osg::CopyOp::SHALLOW_COPY) : osg::Camera(arg1, copyop), luna_wrapper_base(L) { register_protected_methods(L); };
