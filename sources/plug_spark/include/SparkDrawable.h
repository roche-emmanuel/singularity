...
public:
	...
	public:
		virtual SPK::SPK_ID operator()( const TextureIDMap&, int width, int height ) = 0;
	};
...
public:
    ...
    void setBaseSystemCreator( BaseSystemCreator* func, bool useProtoSystem=false )
...
protected:
    ...
    osg::ref_ptr<BaseSystemCreator> _baseSystemCreator;
