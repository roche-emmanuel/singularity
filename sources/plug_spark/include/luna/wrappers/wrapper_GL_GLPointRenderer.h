#ifndef _WRAPPERS_WRAPPER_GL_GLPOINTRENDERER_H_
#define _WRAPPERS_WRAPPER_GL_GLPOINTRENDERER_H_
...
class wrapper_GL_GLPointRenderer : public GL::GLPointRenderer, public luna_wrapper_base {
...
public:
	...
	static int _bind_public_initBlending(lua_State *L) {
		...
		wrapper_GL_GLPointRenderer* self=Luna< SPK::Registerable >::checkSubType< wrapper_GL_GLPointRenderer >(L,1);
		if(!self) {
			luna_printStack(L);
	...
	static int _bind_public_prepareBuffers(lua_State *L) {
		...
		wrapper_GL_GLPointRenderer* self=Luna< SPK::BufferHandler >::checkSubType< wrapper_GL_GLPointRenderer >(L,1);
		if(!self) {
			luna_printStack(L);
	...
	static int _bind_public_glGetProcAddress(lua_State *L) {
		...
		wrapper_GL_GLPointRenderer* self=Luna< GL::GLExtHandler >::checkSubType< wrapper_GL_GLPointRenderer >(L,1);
		if(!self) {
			luna_printStack(L);
