...
public:
	...
	wrapper_SPK_Sphere(lua_State* L, lua_Table* dum, const SPK::Vector3D & position = SPK::Vector3D (0.0f, 0.0f, 0.0f), float radius = 0.0f) : SPK::Sphere(position, radius), luna_wrapper_base(L) { register_protected_methods(L); };
