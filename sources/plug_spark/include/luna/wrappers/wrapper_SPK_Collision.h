...
public:
	...
	wrapper_SPK_Collision(lua_State* L, lua_Table* dum, float scale = 1.0f, float elasticity = 1.0f) : SPK::Collision(scale, elasticity), luna_wrapper_base(L) { register_protected_methods(L); };
