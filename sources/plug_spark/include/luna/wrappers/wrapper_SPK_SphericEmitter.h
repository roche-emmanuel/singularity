...
public:
	...
	wrapper_SPK_SphericEmitter(lua_State* L, lua_Table* dum, const SPK::Vector3D & direction = SPK::Vector3D (0.0f, 0.0f,-1.0f), float angleA = 0.0f, float angleB = 0.0f) : SPK::SphericEmitter(direction, angleA, angleB), luna_wrapper_base(L) { register_protected_methods(L); };
