#ifndef _WRAPPERS_WRAPPER_SPK_GL_GLLINETRAILRENDERER_H_
#define _WRAPPERS_WRAPPER_SPK_GL_GLLINETRAILRENDERER_H_
...
class wrapper_SPK_GL_GLLineTrailRenderer : public SPK::GL::GLLineTrailRenderer, public luna_wrapper_base {

public:
		

	~wrapper_SPK_GL_GLLineTrailRenderer() {
		logDEBUG3("Calling delete function for wrapper SPK_GL_GLLineTrailRenderer");
		if(_obj.pushFunction("delete")) {
			//_obj.pushArg((SPK::GL::GLLineTrailRenderer*)this); // No this argument or the object will be referenced again!
			_obj.callFunction<void>();
		}
	};
	
	wrapper_SPK_GL_GLLineTrailRenderer(lua_State* L, lua_Table* dum) 
		: SPK::GL::GLLineTrailRenderer(), luna_wrapper_base(L) { 
		register_protected_methods(L); 
		if(_obj.pushFunction("buildInstance")) {
			_obj.pushArg((SPK::GL::GLLineTrailRenderer*)this);
			_obj.callFunction<void>();
		}
	};
...
private:
	...
	// SPK::GL::GLLineTrailRenderer * SPK::GL::GLLineTrailRenderer::clone(bool createBase) const
	SPK::GL::GLLineTrailRenderer * clone(bool createBase) const {
		THROW_IF(!_obj.pushFunction("clone"),"No implementation for abstract function SPK::GL::GLLineTrailRenderer::clone");
		_obj.pushArg((SPK::GL::GLLineTrailRenderer*)this);
		_obj.pushArg(createBase);
		return (_obj.callFunction<SPK::GL::GLLineTrailRenderer*>());
	};
...
protected:
	...
	// bool SPK::GL::GLLineTrailRenderer::checkBuffers(const SPK::Group & group)
...
public:
	...
	static int _bind_public_initBlending(lua_State *L) {
		...
		wrapper_SPK_GL_GLLineTrailRenderer* self=Luna< SPK::Registerable >::checkSubType< wrapper_SPK_GL_GLLineTrailRenderer >(L,1);
		if(!self) {
			luna_printStack(L);
	...
	static int _bind_public_prepareBuffers(lua_State *L) {
		...
		wrapper_SPK_GL_GLLineTrailRenderer* self=Luna< SPK::BufferHandler >::checkSubType< wrapper_SPK_GL_GLLineTrailRenderer >(L,1);
		if(!self) {
			luna_printStack(L);
