...
public:
	...
	wrapper_SPK_Model(lua_State* L, lua_Table* dum, int enableFlag = SPK::FLAG_RED | SPK::FLAG_GREEN | SPK::FLAG_BLUE, int mutableFlag = SPK::FLAG_NONE, int randomFlag = SPK::FLAG_NONE, int interpolatedFlag = SPK::FLAG_NONE) : SPK::Model(enableFlag, mutableFlag, randomFlag, interpolatedFlag), luna_wrapper_base(L) { register_protected_methods(L); };
	wrapper_SPK_Model(lua_State* L, lua_Table* dum, const SPK::Model & model) : SPK::Model(model), luna_wrapper_base(L) { register_protected_methods(L); };
