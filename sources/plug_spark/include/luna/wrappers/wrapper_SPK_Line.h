...
public:
	...
	wrapper_SPK_Line(lua_State* L, lua_Table* dum, const SPK::Vector3D & p0 = SPK::Vector3D (0.0f, 0.0f, 0.0f), const SPK::Vector3D & p1 = SPK::Vector3D (0.0f, 0.0f, 0.0f)) : SPK::Line(p0, p1), luna_wrapper_base(L) { register_protected_methods(L); };
