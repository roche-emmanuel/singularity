...
public:
	...
	wrapper_SPK_PointMass(lua_State* L, lua_Table* dum, SPK::Zone * zone = NULL, SPK::ModifierTrigger trigger = SPK::INSIDE_ZONE, float mass = 1.0f, float minDistance = 0.05f) : SPK::PointMass(zone, trigger, mass, minDistance), luna_wrapper_base(L) { register_protected_methods(L); };
