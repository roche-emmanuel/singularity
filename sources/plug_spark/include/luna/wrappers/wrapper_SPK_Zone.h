...
public:
	...
	wrapper_SPK_Zone(lua_State* L, lua_Table* dum, const SPK::Vector3D & position = SPK::Vector3D ()) : SPK::Zone(position), luna_wrapper_base(L) { register_protected_methods(L); };
