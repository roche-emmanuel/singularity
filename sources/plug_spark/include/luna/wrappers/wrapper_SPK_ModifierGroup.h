...
public:
	...
	wrapper_SPK_ModifierGroup(lua_State* L, lua_Table* dum, SPK::Zone * zone = NULL, SPK::ModifierTrigger trigger = SPK::INSIDE_ZONE) : SPK::ModifierGroup(zone, trigger), luna_wrapper_base(L) { register_protected_methods(L); };
