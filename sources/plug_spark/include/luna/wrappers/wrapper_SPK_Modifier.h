...
public:
	...
	wrapper_SPK_Modifier(lua_State* L, lua_Table* dum, int availableTriggers = SPK::ALWAYS, SPK::ModifierTrigger trigger = SPK::ALWAYS, bool needsIntersection = false, bool needsNormal = false, SPK::Zone * zone = NULL) : SPK::Modifier(availableTriggers, trigger, needsIntersection, needsNormal, zone), luna_wrapper_base(L) { register_protected_methods(L); };
