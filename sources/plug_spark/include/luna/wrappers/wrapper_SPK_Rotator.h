#ifndef _WRAPPERS_WRAPPER_SPK_ROTATOR_H_
#define _WRAPPERS_WRAPPER_SPK_ROTATOR_H_
...
class wrapper_SPK_Rotator : public SPK::Rotator, public luna_wrapper_base {
...
protected:
	...
	void innerUpdateTransform() {
		...
		return Rotator::innerUpdateTransform();
	};
	...
	bool checkBuffers(const SPK::Group & group) {
		...
		return Rotator::checkBuffers(group);
	};
	...
	void registerChildren(bool registerAll) {
		...
		return Rotator::registerChildren(registerAll);
	};
	...
	void copyChildren(const SPK::Registerable & object, bool createBase) {
		...
		return Rotator::copyChildren(object, createBase);
	};
	...
	void destroyChildren(bool keepChildren) {
		...
		return Rotator::destroyChildren(keepChildren);
	};
	...
	void propagateUpdateTransform() {
		...
		return Rotator::propagateUpdateTransform();
	};
...
public:
	...
	void createBuffers(const SPK::Group & group) {
		...
		return Rotator::createBuffers(group);
	};
	...
	void destroyBuffers(const SPK::Group & group) {
		...
		return Rotator::destroyBuffers(group);
	};
	...
	SPK::Registerable * findByName(const std::string & name) {
		...
		return Rotator::findByName(name);
	};
	...
	static int _bind_public_registerChild(lua_State *L) {
		...
		wrapper_SPK_Rotator* self=Luna< SPK::Registerable >::checkSubType< wrapper_SPK_Rotator >(L,1);
		if(!self) {
			luna_printStack(L);
	...
	static int _bind_public_transformPos(lua_State *L) {
		...
		wrapper_SPK_Rotator* self=Luna< SPK::Transformable >::checkSubType< wrapper_SPK_Rotator >(L,1);
		if(!self) {
			luna_printStack(L);
	...
	static int _bind_public_prepareBuffers(lua_State *L) {
		...
		wrapper_SPK_Rotator* self=Luna< SPK::BufferHandler >::checkSubType< wrapper_SPK_Rotator >(L,1);
		if(!self) {
			luna_printStack(L);
