...
public:
	...
	wrapper_SPK_Destroyer(lua_State* L, lua_Table* dum, SPK::Zone * zone = NULL, SPK::ModifierTrigger trigger = SPK::INSIDE_ZONE) : SPK::Destroyer(zone, trigger), luna_wrapper_base(L) { register_protected_methods(L); };
