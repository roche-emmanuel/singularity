#ifndef _WRAPPERS_WRAPPER_SPK_GROUP_H_
#define _WRAPPERS_WRAPPER_SPK_GROUP_H_
...
class wrapper_SPK_Group : public SPK::Group, public luna_wrapper_base {
...
protected:
	...
	void innerUpdateTransform() {
		...
		return Group::innerUpdateTransform();
	};
	...
	void registerChildren(bool registerAll) {
		...
		return Group::registerChildren(registerAll);
	};
	...
	void copyChildren(const SPK::Registerable & object, bool createBase) {
		...
		return Group::copyChildren(object, createBase);
	};
	...
	void destroyChildren(bool keepChildren) {
		...
		return Group::destroyChildren(keepChildren);
	};
	...
	void propagateUpdateTransform() {
		...
		return Group::propagateUpdateTransform();
	};
...
public:
	...
	static int _bind_public_registerChild(lua_State *L) {
		...
		wrapper_SPK_Group* self=Luna< SPK::Registerable >::checkSubType< wrapper_SPK_Group >(L,1);
		if(!self) {
	...
	static int _bind_public_transformPos(lua_State *L) {
		...
		wrapper_SPK_Group* self=Luna< SPK::Transformable >::checkSubType< wrapper_SPK_Group >(L,1);
		if(!self) {
