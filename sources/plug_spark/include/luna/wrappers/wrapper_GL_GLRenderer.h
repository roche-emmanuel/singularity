#ifndef _WRAPPERS_WRAPPER_GL_GLRENDERER_H_
#define _WRAPPERS_WRAPPER_GL_GLRENDERER_H_
...
class wrapper_GL_GLRenderer : public GL::GLRenderer, public luna_wrapper_base {

public:
		

	~wrapper_GL_GLRenderer() {
		logDEBUG3("Calling delete function for wrapper GL_GLRenderer");
		if(_obj.pushFunction("delete")) {
			//_obj.pushArg((GL::GLRenderer*)this); // No this argument or the object will be referenced again!
			_obj.callFunction<void>();
		}
	};
	
	wrapper_GL_GLRenderer(lua_State* L, lua_Table* dum) 
		: GL::GLRenderer(), luna_wrapper_base(L) { 
		register_protected_methods(L); 
		if(_obj.pushFunction("buildInstance")) {
			_obj.pushArg((GL::GLRenderer*)this);
			_obj.callFunction<void>();
		}
	};
