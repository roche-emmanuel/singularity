#ifndef _WRAPPERS_WRAPPER_SPK_GL_GLPOINTRENDERER_H_
#define _WRAPPERS_WRAPPER_SPK_GL_GLPOINTRENDERER_H_
...
class wrapper_SPK_GL_GLPointRenderer : public SPK::GL::GLPointRenderer, public luna_wrapper_base {

public:
		

	~wrapper_SPK_GL_GLPointRenderer() {
		logDEBUG3("Calling delete function for wrapper SPK_GL_GLPointRenderer");
		if(_obj.pushFunction("delete")) {
			//_obj.pushArg((SPK::GL::GLPointRenderer*)this); // No this argument or the object will be referenced again!
			_obj.callFunction<void>();
		}
	};
	
	wrapper_SPK_GL_GLPointRenderer(lua_State* L, lua_Table* dum, float size = 1.0f) 
		: SPK::GL::GLPointRenderer(size), luna_wrapper_base(L) { 
		register_protected_methods(L);
		if(_obj.pushFunction("buildInstance")) {
			_obj.pushArg((SPK::GL::GLPointRenderer*)this);
			_obj.callFunction<void>();
		}
	};
...
private:
	...
	// SPK::GL::GLPointRenderer * SPK::GL::GLPointRenderer::clone(bool createBase) const
	SPK::GL::GLPointRenderer * clone(bool createBase) const {
		THROW_IF(!_obj.pushFunction("clone"),"No implementation for abstract function SPK::GL::GLPointRenderer::clone");
		_obj.pushArg((SPK::GL::GLPointRenderer*)this);
		_obj.pushArg(createBase);
		return (_obj.callFunction<SPK::GL::GLPointRenderer*>());
	};
...
protected:
	...
	void registerChildren(bool registerAll) {
		...
		return GLPointRenderer::registerChildren(registerAll);
	};
	...
	void copyChildren(const SPK::Registerable & object, bool createBase) {
		...
		return GLPointRenderer::copyChildren(object, createBase);
	};
	...
	void destroyChildren(bool keepChildren) {
		...
		return GLPointRenderer::destroyChildren(keepChildren);
	};
	...
	bool checkBuffers(const SPK::Group & group) {
		...
		return GLPointRenderer::checkBuffers(group);
	};
...
public:
	...
	SPK::Registerable * findByName(const std::string & name) {
		...
		return GLPointRenderer::findByName(name);
	};
	...
	void createBuffers(const SPK::Group & group) {
		...
		return GLPointRenderer::createBuffers(group);
	};
	...
	void destroyBuffers(const SPK::Group & group) {
		...
		return GLPointRenderer::destroyBuffers(group);
	};
	...
	void enableRenderingHint(SPK::RenderingHint renderingHint, bool enable) {
		...
		return GLPointRenderer::enableRenderingHint(renderingHint, enable);
	};
	...
	void setAlphaTestThreshold(float alphaThreshold) {
		...
		return GLPointRenderer::setAlphaTestThreshold(alphaThreshold);
	};
	...
	bool isRenderingHintEnabled(SPK::RenderingHint renderingHint) const {
		...
		return GLPointRenderer::isRenderingHintEnabled(renderingHint);
	};
	...
	void enableBlending(bool blendingEnabled) {
		...
		return GLPointRenderer::enableBlending(blendingEnabled);
	};
	...
	void setBlending(SPK::BlendingMode blendMode) {
		...
		return GLPointRenderer::setBlending(blendMode);
	};
	...
	void setSize(float size) {
		...
		return GLPointRenderer::setSize(size);
	};
	...
	void render(const SPK::Group & group) {
		...
		return GLPointRenderer::render(group);
	};
	...
	// static void * SPK::GL::GLExtHandler::glGetProcAddress(const char * name)
	static void * public_glGetProcAddress(const char * name) {
		return SPK::GL::GLExtHandler::glGetProcAddress(name);
	};

	// static GLExtension SPK::GL::GLExtHandler::getPointSpriteGLExt()
	static GLExtension public_getPointSpriteGLExt() {
		return SPK::GL::GLExtHandler::getPointSpriteGLExt();
	};

	// static void SPK::GL::GLExtHandler::enablePointSpriteGLExt()
	static void public_enablePointSpriteGLExt() {
		return SPK::GL::GLExtHandler::enablePointSpriteGLExt();
	};

	// static void SPK::GL::GLExtHandler::disablePointSpriteGLExt()
	static void public_disablePointSpriteGLExt() {
		return SPK::GL::GLExtHandler::disablePointSpriteGLExt();
	};

	// static GLExtension SPK::GL::GLExtHandler::getPointParameterGLExt()
	static GLExtension public_getPointParameterGLExt() {
		return SPK::GL::GLExtHandler::getPointParameterGLExt();
	};

	// static void SPK::GL::GLExtHandler::enablePointParameterGLExt(float size, bool distance)
	static void public_enablePointParameterGLExt(float size, bool distance) {
		return SPK::GL::GLExtHandler::enablePointParameterGLExt(size, distance);
	};

	// static void SPK::GL::GLExtHandler::disablePointParameterGLExt()
	static void public_disablePointParameterGLExt() {
		return SPK::GL::GLExtHandler::disablePointParameterGLExt();
	};

	// static GLExtension SPK::GL::GLExtHandler::getTexture3DGLExt()
	static GLExtension public_getTexture3DGLExt() {
		return SPK::GL::GLExtHandler::getTexture3DGLExt();
	};

	// static GLExtension SPK::GL::GLExtHandler::getShaderGLExt()
	static GLExtension public_getShaderGLExt() {
		return SPK::GL::GLExtHandler::getShaderGLExt();
	};
