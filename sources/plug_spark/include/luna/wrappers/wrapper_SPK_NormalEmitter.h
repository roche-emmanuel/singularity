...
public:
	...
	wrapper_SPK_NormalEmitter(lua_State* L, lua_Table* dum, SPK::Zone * normalZone = NULL, bool inverted = false) : SPK::NormalEmitter(normalZone, inverted), luna_wrapper_base(L) { register_protected_methods(L); };
