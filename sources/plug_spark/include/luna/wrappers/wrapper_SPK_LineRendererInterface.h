...
public:
	...
	wrapper_SPK_LineRendererInterface(lua_State* L, lua_Table* dum, float length = 1.0f, float width = 1.0f) : SPK::LineRendererInterface(length, width), luna_wrapper_base(L) { register_protected_methods(L); };
