...
public:
	...
	wrapper_SPK_Obstacle(lua_State* L, lua_Table* dum, SPK::Zone * zone = NULL, SPK::ModifierTrigger trigger = SPK::INTERSECT_ZONE, float bouncingRatio = 1.0f, float friction = 1.0f) : SPK::Obstacle(zone, trigger, bouncingRatio, friction), luna_wrapper_base(L) { register_protected_methods(L); };
