#ifndef _WRAPPERS_WRAPPER_GL_GLLINERENDERER_H_
#define _WRAPPERS_WRAPPER_GL_GLLINERENDERER_H_
...
class wrapper_GL_GLLineRenderer : public GL::GLLineRenderer, public luna_wrapper_base {
...
public:
	...
	static int _bind_public_initBlending(lua_State *L) {
		...
		wrapper_GL_GLLineRenderer* self=Luna< SPK::Registerable >::checkSubType< wrapper_GL_GLLineRenderer >(L,1);
		if(!self) {
			luna_printStack(L);
	...
	static int _bind_public_prepareBuffers(lua_State *L) {
		...
		wrapper_GL_GLLineRenderer* self=Luna< SPK::BufferHandler >::checkSubType< wrapper_GL_GLLineRenderer >(L,1);
		if(!self) {
			luna_printStack(L);
