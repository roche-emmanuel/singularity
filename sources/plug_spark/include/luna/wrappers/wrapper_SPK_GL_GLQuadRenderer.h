#ifndef _WRAPPERS_WRAPPER_SPK_GL_GLQUADRENDERER_H_
#define _WRAPPERS_WRAPPER_SPK_GL_GLQUADRENDERER_H_
...
class wrapper_SPK_GL_GLQuadRenderer : public SPK::GL::GLQuadRenderer, public luna_wrapper_base {

public:
		

	~wrapper_SPK_GL_GLQuadRenderer() {
		logDEBUG3("Calling delete function for wrapper SPK_GL_GLQuadRenderer");
		if(_obj.pushFunction("delete")) {
			//_obj.pushArg((SPK::GL::GLQuadRenderer*)this); // No this argument or the object will be referenced again!
			_obj.callFunction<void>();
		}
	};
	
	wrapper_SPK_GL_GLQuadRenderer(lua_State* L, lua_Table* dum, float scaleX = 1.0f, float scaleY = 1.0f) 
		: SPK::GL::GLQuadRenderer(scaleX, scaleY), luna_wrapper_base(L) { 
		register_protected_methods(L);
		if(_obj.pushFunction("buildInstance")) {
			_obj.pushArg((SPK::GL::GLQuadRenderer*)this);
			_obj.callFunction<void>();
		}
	};
...
private:
	...
	// SPK::GL::GLQuadRenderer * SPK::GL::GLQuadRenderer::clone(bool createBase) const
	SPK::GL::GLQuadRenderer * clone(bool createBase) const {
		THROW_IF(!_obj.pushFunction("clone"),"No implementation for abstract function SPK::GL::GLQuadRenderer::clone");
		_obj.pushArg((SPK::GL::GLQuadRenderer*)this);
		_obj.pushArg(createBase);
		return (_obj.callFunction<SPK::GL::GLQuadRenderer*>());
	};
...
protected:
	...
	// bool SPK::GL::GLQuadRenderer::checkBuffers(const SPK::Group & group)
...
public:
	...
	static int _bind_public_initBlending(lua_State *L) {
		...
		wrapper_SPK_GL_GLQuadRenderer* self=Luna< SPK::Registerable >::checkSubType< wrapper_SPK_GL_GLQuadRenderer >(L,1);
		if(!self) {
			luna_printStack(L);
	...
	static int _bind_public_prepareBuffers(lua_State *L) {
		...
		wrapper_SPK_GL_GLQuadRenderer* self=Luna< SPK::BufferHandler >::checkSubType< wrapper_SPK_GL_GLQuadRenderer >(L,1);
		if(!self) {
			luna_printStack(L);
	...
	static int _bind_public_computeAtlasCoordinates(lua_State *L) {
		...
		wrapper_SPK_GL_GLQuadRenderer* self=Luna< SPK::QuadRendererInterface >::checkSubType< wrapper_SPK_GL_GLQuadRenderer >(L,1);
		if(!self) {
			luna_printStack(L);
	...
	static int _bind_public_precomputeOrientation3D(lua_State *L) {
		...
		wrapper_SPK_GL_GLQuadRenderer* self=Luna< SPK::Oriented3DRendererInterface >::checkSubType< wrapper_SPK_GL_GLQuadRenderer >(L,1);
		if(!self) {
			luna_printStack(L);
	...
	static int _bind_public_glGetProcAddress(lua_State *L) {
		...
		wrapper_SPK_GL_GLQuadRenderer* self=Luna< SPK::GL::GLExtHandler >::checkSubType< wrapper_SPK_GL_GLQuadRenderer >(L,1);
		if(!self) {
			luna_printStack(L);
