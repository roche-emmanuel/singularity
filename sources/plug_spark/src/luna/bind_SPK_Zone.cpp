...
public:
	...
	static int _bind_setPosition(lua_State *L) {
		...
		if(!self) {
			luaL_error(L, "Invalid object in function call void SPK::Zone::setPosition(const SPK::Vector3D &). Got : '%s'\n%s",typeid(Luna< SPK::Registerable >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
		self->setPosition(v);
	...
	static int _bind_getPosition(lua_State *L) {
		...
		SPK::Zone* self=Luna< SPK::Registerable >::checkSubType< SPK::Zone >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call const SPK::Vector3D & SPK::Zone::getPosition() const. Got : '%s'\n%s",typeid(Luna< SPK::Registerable >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_getTransformedPosition(lua_State *L) {
		...
		SPK::Zone* self=Luna< SPK::Registerable >::checkSubType< SPK::Zone >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call const SPK::Vector3D & SPK::Zone::getTransformedPosition() const. Got : '%s'\n%s",typeid(Luna< SPK::Registerable >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_generatePosition(lua_State *L) {
		...
		SPK::Zone* self=Luna< SPK::Registerable >::checkSubType< SPK::Zone >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void SPK::Zone::generatePosition(SPK::Particle &, bool) const. Got : '%s'\n%s",typeid(Luna< SPK::Registerable >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_contains(lua_State *L) {
		...
		SPK::Zone* self=Luna< SPK::Registerable >::checkSubType< SPK::Zone >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call bool SPK::Zone::contains(const SPK::Vector3D &) const. Got : '%s'\n%s",typeid(Luna< SPK::Registerable >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_intersects(lua_State *L) {
		...
		SPK::Zone* self=Luna< SPK::Registerable >::checkSubType< SPK::Zone >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call bool SPK::Zone::intersects(const SPK::Vector3D &, const SPK::Vector3D &, SPK::Vector3D *, SPK::Vector3D *) const. Got : '%s'\n%s",typeid(Luna< SPK::Registerable >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_moveAtBorder(lua_State *L) {
		...
		SPK::Zone* self=Luna< SPK::Registerable >::checkSubType< SPK::Zone >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void SPK::Zone::moveAtBorder(SPK::Vector3D &, bool) const. Got : '%s'\n%s",typeid(Luna< SPK::Registerable >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_computeNormal(lua_State *L) {
		...
		SPK::Zone* self=Luna< SPK::Registerable >::checkSubType< SPK::Zone >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call SPK::Vector3D SPK::Zone::computeNormal(const SPK::Vector3D &) const. Got : '%s'\n%s",typeid(Luna< SPK::Registerable >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_findByName(lua_State *L) {
		...
		SPK::Zone* self=Luna< SPK::Registerable >::checkSubType< SPK::Zone >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call SPK::Registerable * SPK::Zone::base_findByName(const std::string &). Got : '%s'\n%s",typeid(Luna< SPK::Registerable >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_setPosition(lua_State *L) {
		...
		SPK::Zone* self=Luna< SPK::Registerable >::checkSubType< SPK::Zone >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void SPK::Zone::base_setPosition(const SPK::Vector3D &). Got : '%s'\n%s",typeid(Luna< SPK::Registerable >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
