...
public:
	...
	static int _bind___eq(lua_State *L) {
		if (!_lg_typecheck___eq(L)) {
			luaL_error(L, "luna typecheck failed in __eq function, expected prototype:\n__eq(SPK::Particle*). Got arguments:\n%s",luna_dumpStack(L).c_str());
		}
	...
	static int _bind_setParamCurrentValue(lua_State *L) {
		...
		SPK::Particle* self=(Luna< SPK::Particle >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call bool SPK::Particle::setParamCurrentValue(SPK::ModelParam, float). Got : '%s'\n%s",typeid(Luna< SPK::Particle >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_setParamFinalValue(lua_State *L) {
		...
		SPK::Particle* self=(Luna< SPK::Particle >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call bool SPK::Particle::setParamFinalValue(SPK::ModelParam, float). Got : '%s'\n%s",typeid(Luna< SPK::Particle >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_changeParamCurrentValue(lua_State *L) {
		...
		SPK::Particle* self=(Luna< SPK::Particle >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call bool SPK::Particle::changeParamCurrentValue(SPK::ModelParam, float). Got : '%s'\n%s",typeid(Luna< SPK::Particle >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_changeParamFinalValue(lua_State *L) {
		...
		SPK::Particle* self=(Luna< SPK::Particle >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call bool SPK::Particle::changeParamFinalValue(SPK::ModelParam, float). Got : '%s'\n%s",typeid(Luna< SPK::Particle >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_setLifeLeft(lua_State *L) {
		...
		SPK::Particle* self=(Luna< SPK::Particle >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call void SPK::Particle::setLifeLeft(float). Got : '%s'\n%s",typeid(Luna< SPK::Particle >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_position_overload_1(lua_State *L) {
		...
		SPK::Particle* self=(Luna< SPK::Particle >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call SPK::Vector3D & SPK::Particle::position(). Got : '%s'\n%s",typeid(Luna< SPK::Particle >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_position_overload_2(lua_State *L) {
		...
		SPK::Particle* self=(Luna< SPK::Particle >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call const SPK::Vector3D & SPK::Particle::position() const. Got : '%s'\n%s",typeid(Luna< SPK::Particle >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
		const SPK::Vector3D* lret = &self->position();
		if(!lret) return 0; // Do not write NULL pointers.
	...
	static int _bind_velocity_overload_1(lua_State *L) {
		...
		SPK::Particle* self=(Luna< SPK::Particle >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call SPK::Vector3D & SPK::Particle::velocity(). Got : '%s'\n%s",typeid(Luna< SPK::Particle >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_velocity_overload_2(lua_State *L) {
		...
		SPK::Particle* self=(Luna< SPK::Particle >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call const SPK::Vector3D & SPK::Particle::velocity() const. Got : '%s'\n%s",typeid(Luna< SPK::Particle >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
		const SPK::Vector3D* lret = &self->velocity();
		if(!lret) return 0; // Do not write NULL pointers.
	...
	static int _bind_oldPosition_overload_1(lua_State *L) {
		...
		SPK::Particle* self=(Luna< SPK::Particle >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call SPK::Vector3D & SPK::Particle::oldPosition(). Got : '%s'\n%s",typeid(Luna< SPK::Particle >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_oldPosition_overload_2(lua_State *L) {
		...
		SPK::Particle* self=(Luna< SPK::Particle >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call const SPK::Vector3D & SPK::Particle::oldPosition() const. Got : '%s'\n%s",typeid(Luna< SPK::Particle >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
		const SPK::Vector3D* lret = &self->oldPosition();
		if(!lret) return 0; // Do not write NULL pointers.
	...
	static int _bind_getParamCurrentValue(lua_State *L) {
		...
		SPK::Particle* self=(Luna< SPK::Particle >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call float SPK::Particle::getParamCurrentValue(SPK::ModelParam) const. Got : '%s'\n%s",typeid(Luna< SPK::Particle >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_getParamFinalValue(lua_State *L) {
		...
		SPK::Particle* self=(Luna< SPK::Particle >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call float SPK::Particle::getParamFinalValue(SPK::ModelParam) const. Got : '%s'\n%s",typeid(Luna< SPK::Particle >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_getModel(lua_State *L) {
		...
		SPK::Particle* self=(Luna< SPK::Particle >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call SPK::Model * SPK::Particle::getModel() const. Got : '%s'\n%s",typeid(Luna< SPK::Particle >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_getGroup(lua_State *L) {
		...
		SPK::Particle* self=(Luna< SPK::Particle >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call SPK::Group * SPK::Particle::getGroup() const. Got : '%s'\n%s",typeid(Luna< SPK::Particle >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_getIndex(lua_State *L) {
		...
		SPK::Particle* self=(Luna< SPK::Particle >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call size_t SPK::Particle::getIndex() const. Got : '%s'\n%s",typeid(Luna< SPK::Particle >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_getLifeLeft(lua_State *L) {
		...
		SPK::Particle* self=(Luna< SPK::Particle >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call float SPK::Particle::getLifeLeft() const. Got : '%s'\n%s",typeid(Luna< SPK::Particle >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_getAge(lua_State *L) {
		...
		SPK::Particle* self=(Luna< SPK::Particle >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call float SPK::Particle::getAge() const. Got : '%s'\n%s",typeid(Luna< SPK::Particle >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_getDistanceFromCamera(lua_State *L) {
		...
		SPK::Particle* self=(Luna< SPK::Particle >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call float SPK::Particle::getDistanceFromCamera() const. Got : '%s'\n%s",typeid(Luna< SPK::Particle >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_getSqrDistanceFromCamera(lua_State *L) {
		...
		SPK::Particle* self=(Luna< SPK::Particle >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call float SPK::Particle::getSqrDistanceFromCamera() const. Got : '%s'\n%s",typeid(Luna< SPK::Particle >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_isNewBorn(lua_State *L) {
		...
		SPK::Particle* self=(Luna< SPK::Particle >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call bool SPK::Particle::isNewBorn() const. Got : '%s'\n%s",typeid(Luna< SPK::Particle >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_isAlive(lua_State *L) {
		...
		SPK::Particle* self=(Luna< SPK::Particle >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call bool SPK::Particle::isAlive() const. Got : '%s'\n%s",typeid(Luna< SPK::Particle >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_init(lua_State *L) {
		...
		SPK::Particle* self=(Luna< SPK::Particle >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call void SPK::Particle::init(). Got : '%s'\n%s",typeid(Luna< SPK::Particle >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
		self->init();
	...
	static int _bind_kill(lua_State *L) {
		...
		SPK::Particle* self=(Luna< SPK::Particle >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call void SPK::Particle::kill(). Got : '%s'\n%s",typeid(Luna< SPK::Particle >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
		self->kill();
	...
	static int _bind_getR(lua_State *L) {
		...
		SPK::Particle* self=(Luna< SPK::Particle >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call float SPK::Particle::getR() const. Got : '%s'\n%s",typeid(Luna< SPK::Particle >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_getG(lua_State *L) {
		...
		SPK::Particle* self=(Luna< SPK::Particle >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call float SPK::Particle::getG() const. Got : '%s'\n%s",typeid(Luna< SPK::Particle >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_getB(lua_State *L) {
		...
		SPK::Particle* self=(Luna< SPK::Particle >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call float SPK::Particle::getB() const. Got : '%s'\n%s",typeid(Luna< SPK::Particle >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
