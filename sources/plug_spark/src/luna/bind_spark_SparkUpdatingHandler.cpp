...
public:
	...
	static int _bind_fromVoid(lua_State *L) {
		...
		Luna< spark::SparkUpdatingHandler >::push(L,self,false);
		return 1;
	}
...
luna_RegType LunaTraits< spark::SparkUpdatingHandler >::methods[] = {
	...
	{"fromVoid", &luna_wrapper_spark_SparkUpdatingHandler::_bind_fromVoid},
	{"asVoid", &luna_wrapper_spark_SparkUpdatingHandler::_bind_asVoid},
