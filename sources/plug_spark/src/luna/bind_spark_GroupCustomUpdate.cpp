...
public:
	...
	static int _bind_fromVoid(lua_State *L) {
		...
		Luna< spark::GroupCustomUpdate >::push(L,self,false);
		return 1;
	}
...
luna_RegType LunaTraits< spark::GroupCustomUpdate >::methods[] = {
	...
	{"fromVoid", &luna_wrapper_spark_GroupCustomUpdate::_bind_fromVoid},
	{"asVoid", &luna_wrapper_spark_GroupCustomUpdate::_bind_asVoid},
