...
public:
	...
	static int _bind_getClassName(lua_State *L) {
		...
		if(!self) {
			luaL_error(L, "Invalid object in function call std::string SPK::Collision::getClassName() const. Got : '%s'\n%s",typeid(Luna< SPK::Registerable >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_setScale(lua_State *L) {
		...
		SPK::Collision* self=Luna< SPK::Registerable >::checkSubType< SPK::Collision >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void SPK::Collision::setScale(float). Got : '%s'\n%s",typeid(Luna< SPK::Registerable >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
		self->setScale(scale);
	...
	static int _bind_setElasticity(lua_State *L) {
		...
		SPK::Collision* self=Luna< SPK::Registerable >::checkSubType< SPK::Collision >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void SPK::Collision::setElasticity(float). Got : '%s'\n%s",typeid(Luna< SPK::Registerable >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_getElasticity(lua_State *L) {
		...
		SPK::Collision* self=Luna< SPK::Registerable >::checkSubType< SPK::Collision >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call float SPK::Collision::getElasticity() const. Got : '%s'\n%s",typeid(Luna< SPK::Registerable >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_getScale(lua_State *L) {
		...
		SPK::Collision* self=Luna< SPK::Registerable >::checkSubType< SPK::Collision >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call float SPK::Collision::getScale() const. Got : '%s'\n%s",typeid(Luna< SPK::Registerable >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_createBuffers(lua_State *L) {
		...
		SPK::Collision* self=Luna< SPK::Registerable >::checkSubType< SPK::Collision >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void SPK::Collision::base_createBuffers(const SPK::Group &). Got : '%s'\n%s",typeid(Luna< SPK::Registerable >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_destroyBuffers(lua_State *L) {
		...
		SPK::Collision* self=Luna< SPK::Registerable >::checkSubType< SPK::Collision >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void SPK::Collision::base_destroyBuffers(const SPK::Group &). Got : '%s'\n%s",typeid(Luna< SPK::Registerable >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_findByName(lua_State *L) {
		...
		SPK::Collision* self=Luna< SPK::Registerable >::checkSubType< SPK::Collision >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call SPK::Registerable * SPK::Collision::base_findByName(const std::string &). Got : '%s'\n%s",typeid(Luna< SPK::Registerable >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_getClassName(lua_State *L) {
		...
		SPK::Collision* self=Luna< SPK::Registerable >::checkSubType< SPK::Collision >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call std::string SPK::Collision::base_getClassName() const. Got : '%s'\n%s",typeid(Luna< SPK::Registerable >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
