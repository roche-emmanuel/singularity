...
public:
	...
	static int _bind_fromVoid(lua_State *L) {
		...
		Luna< SPK::GL::GLPointRenderer >::push(L,self,false);
		return 1;
	}
...
luna_RegType LunaTraits< SPK::GL::GLPointRenderer >::methods[] = {
	...
	{"fromVoid", &luna_wrapper_SPK_GL_GLPointRenderer::_bind_fromVoid},
	{"asVoid", &luna_wrapper_SPK_GL_GLPointRenderer::_bind_asVoid},
