...
public:
	...
	static int _bind_getClassName(lua_State *L) {
		...
		if(!self) {
			luaL_error(L, "Invalid object in function call std::string SPK::AABox::getClassName() const. Got : '%s'\n%s",typeid(Luna< SPK::Registerable >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_setDimension(lua_State *L) {
		...
		SPK::AABox* self=Luna< SPK::Registerable >::checkSubType< SPK::AABox >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void SPK::AABox::setDimension(const SPK::Vector3D &). Got : '%s'\n%s",typeid(Luna< SPK::Registerable >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_getDimension(lua_State *L) {
		...
		SPK::AABox* self=Luna< SPK::Registerable >::checkSubType< SPK::AABox >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call const SPK::Vector3D & SPK::AABox::getDimension() const. Got : '%s'\n%s",typeid(Luna< SPK::Registerable >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_generatePosition(lua_State *L) {
		...
		SPK::AABox* self=Luna< SPK::Registerable >::checkSubType< SPK::AABox >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void SPK::AABox::generatePosition(SPK::Particle &, bool) const. Got : '%s'\n%s",typeid(Luna< SPK::Registerable >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_contains(lua_State *L) {
		...
		SPK::AABox* self=Luna< SPK::Registerable >::checkSubType< SPK::AABox >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call bool SPK::AABox::contains(const SPK::Vector3D &) const. Got : '%s'\n%s",typeid(Luna< SPK::Registerable >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_intersects(lua_State *L) {
		...
		SPK::AABox* self=Luna< SPK::Registerable >::checkSubType< SPK::AABox >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call bool SPK::AABox::intersects(const SPK::Vector3D &, const SPK::Vector3D &, SPK::Vector3D *, SPK::Vector3D *) const. Got : '%s'\n%s",typeid(Luna< SPK::Registerable >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_moveAtBorder(lua_State *L) {
		...
		SPK::AABox* self=Luna< SPK::Registerable >::checkSubType< SPK::AABox >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void SPK::AABox::moveAtBorder(SPK::Vector3D &, bool) const. Got : '%s'\n%s",typeid(Luna< SPK::Registerable >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_computeNormal(lua_State *L) {
		...
		SPK::AABox* self=Luna< SPK::Registerable >::checkSubType< SPK::AABox >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call SPK::Vector3D SPK::AABox::computeNormal(const SPK::Vector3D &) const. Got : '%s'\n%s",typeid(Luna< SPK::Registerable >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_findByName(lua_State *L) {
		...
		SPK::AABox* self=Luna< SPK::Registerable >::checkSubType< SPK::AABox >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call SPK::Registerable * SPK::AABox::base_findByName(const std::string &). Got : '%s'\n%s",typeid(Luna< SPK::Registerable >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_setPosition(lua_State *L) {
		...
		SPK::AABox* self=Luna< SPK::Registerable >::checkSubType< SPK::AABox >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void SPK::AABox::base_setPosition(const SPK::Vector3D &). Got : '%s'\n%s",typeid(Luna< SPK::Registerable >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_getClassName(lua_State *L) {
		...
		SPK::AABox* self=Luna< SPK::Registerable >::checkSubType< SPK::AABox >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call std::string SPK::AABox::base_getClassName() const. Got : '%s'\n%s",typeid(Luna< SPK::Registerable >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_generatePosition(lua_State *L) {
		...
		SPK::AABox* self=Luna< SPK::Registerable >::checkSubType< SPK::AABox >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void SPK::AABox::base_generatePosition(SPK::Particle &, bool) const. Got : '%s'\n%s",typeid(Luna< SPK::Registerable >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_contains(lua_State *L) {
		...
		SPK::AABox* self=Luna< SPK::Registerable >::checkSubType< SPK::AABox >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call bool SPK::AABox::base_contains(const SPK::Vector3D &) const. Got : '%s'\n%s",typeid(Luna< SPK::Registerable >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_intersects(lua_State *L) {
		...
		SPK::AABox* self=Luna< SPK::Registerable >::checkSubType< SPK::AABox >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call bool SPK::AABox::base_intersects(const SPK::Vector3D &, const SPK::Vector3D &, SPK::Vector3D *, SPK::Vector3D *) const. Got : '%s'\n%s",typeid(Luna< SPK::Registerable >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_moveAtBorder(lua_State *L) {
		...
		SPK::AABox* self=Luna< SPK::Registerable >::checkSubType< SPK::AABox >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void SPK::AABox::base_moveAtBorder(SPK::Vector3D &, bool) const. Got : '%s'\n%s",typeid(Luna< SPK::Registerable >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_computeNormal(lua_State *L) {
		...
		SPK::AABox* self=Luna< SPK::Registerable >::checkSubType< SPK::AABox >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call SPK::Vector3D SPK::AABox::base_computeNormal(const SPK::Vector3D &) const. Got : '%s'\n%s",typeid(Luna< SPK::Registerable >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
