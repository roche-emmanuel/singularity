...
class luna_wrapper_std_vector_SPK_System {
public:
...
const char LunaTraits< std::vector< SPK::System * > >::className[] = "std_vector_SPK_System";
...
luna_RegType LunaTraits< std::vector< SPK::System * > >::methods[] = {
	{"dynCast", &luna_wrapper_std_vector_SPK_System::_bind_dynCast},
	{"__eq", &luna_wrapper_std_vector_SPK_System::_bind___eq},
	{0,0}
};
