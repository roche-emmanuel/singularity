...
public:
	...
	static int _bind_getTable(lua_State *L) {
		...
		luna_wrapper_base* wrapper = luna_caster<SPK::PointRendererInterface,luna_wrapper_base>::cast(self); //dynamic_cast<luna_wrapper_base*>(self);
		if(wrapper) {
	...
	static int _bind_fromVoid(lua_State *L) {
		...
		Luna< SPK::PointRendererInterface >::push(L,self,false);
		return 1;
	}
...
luna_RegType LunaTraits< SPK::PointRendererInterface >::methods[] = {
	...
	{"fromVoid", &luna_wrapper_SPK_PointRendererInterface::_bind_fromVoid},
	{"asVoid", &luna_wrapper_SPK_PointRendererInterface::_bind_asVoid},
