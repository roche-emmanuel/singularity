...
public:
	...
	wrapper_ork_Program(lua_State* L, lua_Table* dum, const std::vector< ptr< ork::Module > > & modules, bool separable = false) 
	...
	wrapper_ork_Program(lua_State* L, lua_Table* dum, ptr< ork::Module > module, bool separable = false) 
	...
	wrapper_ork_Program(lua_State* L, lua_Table* dum, ptr< ork::Program > vertex, ptr< ork::Program > tessControl, ptr< ork::Program > tessEval, ptr< ork::Program > geometry, ptr< ork::Program > fragment) 
...
protected:
	...
	// void ork::Program::swap(ptr< ork::Program > t)
...
public:
	...
	// void ork::Program::init(const std::vector< ptr< ork::Module > > & modules, bool separable)
	void public_init(const std::vector< ptr< ork::Module > > & modules, bool separable) {
	...
	// void ork::Program::public_init(const std::vector< ptr< ork::Module > > & modules, bool separable)
	static int _bind_public_init(lua_State *L) {
		if (!_lg_typecheck_public_init(L)) {
			luaL_error(L, "luna typecheck failed in void ork::Program::public_init(const std::vector< ptr< ork::Module > > & modules, bool separable) function, expected prototype:\nvoid ork::Program::public_init(const std::vector< ptr< ork::Module > > & modules, bool separable)\nClass arguments details:\narg 1 ID = [unknown]\n\n%s",luna_dumpStack(L).c_str());
		}
		...
		if(!self) {
			luaL_error(L, "Invalid object in function call void ork::Program::public_init(const std::vector< ptr< ork::Module > > &, bool). Got : '%s'\n%s",typeid(Luna< ork::Object >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
