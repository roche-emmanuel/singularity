...
public:
	...
	wrapper_proland_TileSampler(lua_State* L, lua_Table* dum, const std::string & name, ptr< proland::TileProducer > producer = NULL) 
...
protected:
	...
	// void proland::TileSampler::init(const std::string & name, ptr< proland::TileProducer > producer = NULL)
	...
	// bool proland::TileSampler::needTile(ptr< proland::TerrainQuad > q)
