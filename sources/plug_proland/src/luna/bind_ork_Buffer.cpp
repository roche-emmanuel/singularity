...
public:
	...
	static int _bind_bind(lua_State *L) {
		if (!_lg_typecheck_bind(L)) {
			luaL_error(L, "luna typecheck failed in void ork::Buffer::bind(int target) const function, expected prototype:\nvoid ork::Buffer::bind(int target) const\nClass arguments details:\n\n%s",luna_dumpStack(L).c_str());
		}
		...
		if(!self) {
			luaL_error(L, "Invalid object in function call void ork::Buffer::bind(int) const. Got : '%s'\n%s",typeid(Luna< ork::Object >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
		self->bind(target);
	...
	static int _bind_data(lua_State *L) {
		if (!_lg_typecheck_data(L)) {
			luaL_error(L, "luna typecheck failed in void * ork::Buffer::data(int offset) const function, expected prototype:\nvoid * ork::Buffer::data(int offset) const\nClass arguments details:\n\n%s",luna_dumpStack(L).c_str());
		}
		...
		ork::Buffer* self=Luna< ork::Object >::checkSubType< ork::Buffer >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void * ork::Buffer::data(int) const. Got : '%s'\n%s",typeid(Luna< ork::Object >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_unbind(lua_State *L) {
		if (!_lg_typecheck_unbind(L)) {
			luaL_error(L, "luna typecheck failed in void ork::Buffer::unbind(int target) const function, expected prototype:\nvoid ork::Buffer::unbind(int target) const\nClass arguments details:\n\n%s",luna_dumpStack(L).c_str());
		}
		...
		ork::Buffer* self=Luna< ork::Object >::checkSubType< ork::Buffer >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void ork::Buffer::unbind(int) const. Got : '%s'\n%s",typeid(Luna< ork::Object >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
		self->unbind(target);
	...
	static int _bind_dirty(lua_State *L) {
		if (!_lg_typecheck_dirty(L)) {
			luaL_error(L, "luna typecheck failed in void ork::Buffer::dirty() const function, expected prototype:\nvoid ork::Buffer::dirty() const\nClass arguments details:\n\n%s",luna_dumpStack(L).c_str());
		}


		ork::Buffer* self=Luna< ork::Object >::checkSubType< ork::Buffer >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void ork::Buffer::dirty() const. Got : '%s'\n%s",typeid(Luna< ork::Object >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
		self->dirty();
...
luna_RegType LunaTraits< ork::Buffer >::methods[] = {
	{"bind", &luna_wrapper_ork_Buffer::_bind_bind},
	{"data", &luna_wrapper_ork_Buffer::_bind_data},
	{"unbind", &luna_wrapper_ork_Buffer::_bind_unbind},
	{"dirty", &luna_wrapper_ork_Buffer::_bind_dirty},
