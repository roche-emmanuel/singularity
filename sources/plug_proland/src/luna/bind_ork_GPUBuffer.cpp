...
public:
	...
	static int _bind_bind(lua_State *L) {
		if (!_lg_typecheck_bind(L)) {
			luaL_error(L, "luna typecheck failed in void ork::GPUBuffer::bind(int target) const function, expected prototype:\nvoid ork::GPUBuffer::bind(int target) const\nClass arguments details:\n\n%s",luna_dumpStack(L).c_str());
		}
		...
		ork::GPUBuffer* self=Luna< ork::Object >::checkSubType< ork::GPUBuffer >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void ork::GPUBuffer::bind(int) const. Got : '%s'\n%s",typeid(Luna< ork::Object >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
		self->bind(target);
	...
	static int _bind_data(lua_State *L) {
		if (!_lg_typecheck_data(L)) {
			luaL_error(L, "luna typecheck failed in void * ork::GPUBuffer::data(int offset) const function, expected prototype:\nvoid * ork::GPUBuffer::data(int offset) const\nClass arguments details:\n\n%s",luna_dumpStack(L).c_str());
		}
		...
		ork::GPUBuffer* self=Luna< ork::Object >::checkSubType< ork::GPUBuffer >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void * ork::GPUBuffer::data(int) const. Got : '%s'\n%s",typeid(Luna< ork::Object >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_unbind(lua_State *L) {
		if (!_lg_typecheck_unbind(L)) {
			luaL_error(L, "luna typecheck failed in void ork::GPUBuffer::unbind(int target) const function, expected prototype:\nvoid ork::GPUBuffer::unbind(int target) const\nClass arguments details:\n\n%s",luna_dumpStack(L).c_str());
		}
		...
		ork::GPUBuffer* self=Luna< ork::Object >::checkSubType< ork::GPUBuffer >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void ork::GPUBuffer::unbind(int) const. Got : '%s'\n%s",typeid(Luna< ork::Object >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
		self->unbind(target);
	...
	static int _bind_dirty(lua_State *L) {
		if (!_lg_typecheck_dirty(L)) {
			luaL_error(L, "luna typecheck failed in void ork::GPUBuffer::dirty() const function, expected prototype:\nvoid ork::GPUBuffer::dirty() const\nClass arguments details:\n\n%s",luna_dumpStack(L).c_str());
		}


		ork::GPUBuffer* self=Luna< ork::Object >::checkSubType< ork::GPUBuffer >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void ork::GPUBuffer::dirty() const. Got : '%s'\n%s",typeid(Luna< ork::Object >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
		self->dirty();
	...
	// void ork::GPUBuffer::base_bind(int target) const
	static int _bind_base_bind(lua_State *L) {
		if (!_lg_typecheck_base_bind(L)) {
			luaL_error(L, "luna typecheck failed in void ork::GPUBuffer::base_bind(int target) const function, expected prototype:\nvoid ork::GPUBuffer::base_bind(int target) const\nClass arguments details:\n\n%s",luna_dumpStack(L).c_str());
		}
		...
		ork::GPUBuffer* self=Luna< ork::Object >::checkSubType< ork::GPUBuffer >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void ork::GPUBuffer::base_bind(int) const. Got : '%s'\n%s",typeid(Luna< ork::Object >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
		self->GPUBuffer::bind(target);

		return 0;
	}

	// void * ork::GPUBuffer::base_data(int offset) const
	static int _bind_base_data(lua_State *L) {
		if (!_lg_typecheck_base_data(L)) {
			luaL_error(L, "luna typecheck failed in void * ork::GPUBuffer::base_data(int offset) const function, expected prototype:\nvoid * ork::GPUBuffer::base_data(int offset) const\nClass arguments details:\n\n%s",luna_dumpStack(L).c_str());
		}
		...
		ork::GPUBuffer* self=Luna< ork::Object >::checkSubType< ork::GPUBuffer >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void * ork::GPUBuffer::base_data(int) const. Got : '%s'\n%s",typeid(Luna< ork::Object >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
		void * lret = self->GPUBuffer::data(offset);
		if(!lret) return 0; // Do not write NULL pointers.
	...
	// void ork::GPUBuffer::base_unbind(int target) const
	static int _bind_base_unbind(lua_State *L) {
		if (!_lg_typecheck_base_unbind(L)) {
			luaL_error(L, "luna typecheck failed in void ork::GPUBuffer::base_unbind(int target) const function, expected prototype:\nvoid ork::GPUBuffer::base_unbind(int target) const\nClass arguments details:\n\n%s",luna_dumpStack(L).c_str());
		}
		...
		ork::GPUBuffer* self=Luna< ork::Object >::checkSubType< ork::GPUBuffer >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void ork::GPUBuffer::base_unbind(int) const. Got : '%s'\n%s",typeid(Luna< ork::Object >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
		self->GPUBuffer::unbind(target);

		return 0;
	}

	// void ork::GPUBuffer::base_dirty() const
	static int _bind_base_dirty(lua_State *L) {
		if (!_lg_typecheck_base_dirty(L)) {
			luaL_error(L, "luna typecheck failed in void ork::GPUBuffer::base_dirty() const function, expected prototype:\nvoid ork::GPUBuffer::base_dirty() const\nClass arguments details:\n\n%s",luna_dumpStack(L).c_str());
		}


		ork::GPUBuffer* self=Luna< ork::Object >::checkSubType< ork::GPUBuffer >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void ork::GPUBuffer::base_dirty() const. Got : '%s'\n%s",typeid(Luna< ork::Object >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
		self->GPUBuffer::dirty();
...
luna_RegType LunaTraits< ork::GPUBuffer >::methods[] = {
	...
	{"bind", &luna_wrapper_ork_GPUBuffer::_bind_bind},
	{"data", &luna_wrapper_ork_GPUBuffer::_bind_data},
	{"unbind", &luna_wrapper_ork_GPUBuffer::_bind_unbind},
	{"dirty", &luna_wrapper_ork_GPUBuffer::_bind_dirty},
	{"base_bind", &luna_wrapper_ork_GPUBuffer::_bind_base_bind},
	{"base_data", &luna_wrapper_ork_GPUBuffer::_bind_base_data},
	{"base_unbind", &luna_wrapper_ork_GPUBuffer::_bind_base_unbind},
	{"base_dirty", &luna_wrapper_ork_GPUBuffer::_bind_base_dirty},
