...
public:
	...
	inline static bool _lg_typecheck_ctor_overload_1(lua_State *L) {
		...
		if( (!(Luna< std::vector< ptr< ork::Module > > >::check(L,1))) ) return false;
	...
	inline static bool _lg_typecheck_ctor_overload_5(lua_State *L) {
		...
		if( !Luna<void>::has_uniqueid(L,2,16940072) ) return false;
		if( (!(Luna< std::vector< ptr< ork::Module > > >::check(L,2))) ) return false;
	...
	// Constructor binds:
	// ork::Program::Program(const std::vector< ptr< ork::Module > > & modules, bool separable = false)
	static ork::Program* _bind_ctor_overload_1(lua_State *L) {
		if (!_lg_typecheck_ctor_overload_1(L)) {
			luaL_error(L, "luna typecheck failed in ork::Program::Program(const std::vector< ptr< ork::Module > > & modules, bool separable = false) function, expected prototype:\nork::Program::Program(const std::vector< ptr< ork::Module > > & modules, bool separable = false)\nClass arguments details:\narg 1 ID = [unknown]\n\n%s",luna_dumpStack(L).c_str());
		}

		int luatop = lua_gettop(L);

		const std::vector< ptr< ork::Module > >* modules_ptr=(Luna< std::vector< ptr< ork::Module > > >::check(L,1));
		if( !modules_ptr ) {
			luaL_error(L, "Dereferencing NULL pointer for arg modules in ork::Program::Program function");
		}
		const std::vector< ptr< ork::Module > > & modules=*modules_ptr;
		bool separable=luatop>1 ? (bool)(lua_toboolean(L,2)==1) : (bool)false;

		return new ork::Program(modules, separable);
	}

	// ork::Program::Program(ptr< ork::Module > module, bool separable = false)
	static ork::Program* _bind_ctor_overload_2(lua_State *L) {
		if (!_lg_typecheck_ctor_overload_2(L)) {
			luaL_error(L, "luna typecheck failed in ork::Program::Program(ptr< ork::Module > module, bool separable = false) function, expected prototype:\nork::Program::Program(ptr< ork::Module > module, bool separable = false)\nClass arguments details:\narg 1 ID = [unknown]\n\n%s",luna_dumpStack(L).c_str());
		}
	...
	// ork::Program::Program(lua_Table * data, const std::vector< ptr< ork::Module > > & modules, bool separable = false)
	static ork::Program* _bind_ctor_overload_5(lua_State *L) {
		if (!_lg_typecheck_ctor_overload_5(L)) {
			luaL_error(L, "luna typecheck failed in ork::Program::Program(lua_Table * data, const std::vector< ptr< ork::Module > > & modules, bool separable = false) function, expected prototype:\nork::Program::Program(lua_Table * data, const std::vector< ptr< ork::Module > > & modules, bool separable = false)\nClass arguments details:\narg 2 ID = [unknown]\n\n%s",luna_dumpStack(L).c_str());
		}

		int luatop = lua_gettop(L);

		const std::vector< ptr< ork::Module > >* modules_ptr=(Luna< std::vector< ptr< ork::Module > > >::check(L,2));
		if( !modules_ptr ) {
			luaL_error(L, "Dereferencing NULL pointer for arg modules in ork::Program::Program function");
		}
		const std::vector< ptr< ork::Module > > & modules=*modules_ptr;
	...
	// ork::Program::Program(lua_Table * data, ptr< ork::Module > module, bool separable = false)
	static ork::Program* _bind_ctor_overload_6(lua_State *L) {
		if (!_lg_typecheck_ctor_overload_6(L)) {
			luaL_error(L, "luna typecheck failed in ork::Program::Program(lua_Table * data, ptr< ork::Module > module, bool separable = false) function, expected prototype:\nork::Program::Program(lua_Table * data, ptr< ork::Module > module, bool separable = false)\nClass arguments details:\narg 2 ID = [unknown]\n\n%s",luna_dumpStack(L).c_str());
		}
	...
	static ork::Program* _bind_ctor(lua_State *L) {
		...
		luaL_error(L, "error in function Program, cannot match any of the overloads for function Program:\n  Program(const std::vector< ptr< ork::Module > > &, bool)\n  Program(ptr< ork::Module >, bool)\n  Program(unsigned int, int, unsigned char *, bool)\n  Program(ptr< ork::Program >, ptr< ork::Program >, ptr< ork::Program >, ptr< ork::Program >, ptr< ork::Program >)\n  Program(lua_Table *, const std::vector< ptr< ork::Module > > &, bool)\n  Program(lua_Table *, ptr< ork::Module >, bool)\n  Program(lua_Table *, unsigned int, int, unsigned char *, bool)\n  Program(lua_Table *, ptr< ork::Program >, ptr< ork::Program >, ptr< ork::Program >, ptr< ork::Program >, ptr< ork::Program >)\n");
		return NULL;
	}
	...
	// ptr< ork::Module > ork::Program::getModule(int index) const
	static int _bind_getModule(lua_State *L) {
		if (!_lg_typecheck_getModule(L)) {
			luaL_error(L, "luna typecheck failed in ptr< ork::Module > ork::Program::getModule(int index) const function, expected prototype:\nptr< ork::Module > ork::Program::getModule(int index) const\nClass arguments details:\n\n%s",luna_dumpStack(L).c_str());
		}
