...
#include <luna/wrappers/wrapper_ork_Texture_Parameters.h>

class luna_wrapper_ork_Texture_Parameters {
public:
	typedef Luna< ork::Texture::Parameters > luna_t;
	...
	static int _bind_fromVoid(lua_State *L) {
		...
		ork::Texture::Parameters* self= (ork::Texture::Parameters*)(Luna< void >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call fromVoid(...)");
		}
		
		Luna< ork::Texture::Parameters >::push(L,self,false);
		return 1;
	}
	...
	inline static bool _lg_typecheck_swizzle_overload_1(lua_State *L) {
		if( lua_gettop(L)!=1 ) return false;

		return true;
	}

	inline static bool _lg_typecheck_swizzle_overload_2(lua_State *L) {
	...
	inline static bool _lg_typecheck_minLevel_overload_1(lua_State *L) {
		if( lua_gettop(L)!=1 ) return false;

		return true;
	}

	inline static bool _lg_typecheck_minLevel_overload_2(lua_State *L) {
		if( lua_gettop(L)!=2 ) return false;
	...
	inline static bool _lg_typecheck_maxLevel_overload_1(lua_State *L) {
		if( lua_gettop(L)!=1 ) return false;

		return true;
	}

	inline static bool _lg_typecheck_maxLevel_overload_2(lua_State *L) {
		if( lua_gettop(L)!=2 ) return false;
	...
	inline static bool _lg_typecheck_base_swizzle(lua_State *L) {
		if( lua_gettop(L)!=5 ) return false;
	...
	inline static bool _lg_typecheck_base_minLevel(lua_State *L) {
		if( lua_gettop(L)!=2 ) return false;
	...
	inline static bool _lg_typecheck_base_maxLevel(lua_State *L) {
		if( lua_gettop(L)!=2 ) return false;
	...
	static ork::Texture::Parameters* _bind_ctor_overload_1(lua_State *L) {
		if (!_lg_typecheck_ctor_overload_1(L)) {
			luaL_error(L, "luna typecheck failed in ork::Texture::Parameters::Parameters() function, expected prototype:\nork::Texture::Parameters::Parameters()\nClass arguments details:\n\n%s",luna_dumpStack(L).c_str());
		}


		return new ork::Texture::Parameters();
	}

	// ork::Texture::Parameters::Parameters(lua_Table * data)
	static ork::Texture::Parameters* _bind_ctor_overload_2(lua_State *L) {
		if (!_lg_typecheck_ctor_overload_2(L)) {
			luaL_error(L, "luna typecheck failed in ork::Texture::Parameters::Parameters(lua_Table * data) function, expected prototype:\nork::Texture::Parameters::Parameters(lua_Table * data)\nClass arguments details:\n\n%s",luna_dumpStack(L).c_str());
		}


		return new wrapper_ork_Texture_Parameters(L,NULL);
	}

	// Overload binder for ork::Texture::Parameters::Parameters
	...
	// Function binds:
	// ork::TextureWrap ork::Texture::Parameters::wrapS() const
	static int _bind_wrapS_overload_1(lua_State *L) {
		if (!_lg_typecheck_wrapS_overload_1(L)) {
			luaL_error(L, "luna typecheck failed in ork::TextureWrap ork::Texture::Parameters::wrapS() const function, expected prototype:\nork::TextureWrap ork::Texture::Parameters::wrapS() const\nClass arguments details:\n\n%s",luna_dumpStack(L).c_str());
		}
	...
	static int _bind_wrapS_overload_2(lua_State *L) {
		if (!_lg_typecheck_wrapS_overload_2(L)) {
			luaL_error(L, "luna typecheck failed in ork::Texture::Parameters & ork::Texture::Parameters::wrapS(ork::TextureWrap wrapS) function, expected prototype:\nork::Texture::Parameters & ork::Texture::Parameters::wrapS(ork::TextureWrap wrapS)\nClass arguments details:\n\n%s",luna_dumpStack(L).c_str());
		}
		...
		Luna< ork::Texture::Parameters >::push(L,lret,false);

		return 1;
	}

	// Overload binder for ork::Texture::Parameters::wrapS
	...
	// ork::TextureWrap ork::Texture::Parameters::wrapT() const
	static int _bind_wrapT_overload_1(lua_State *L) {
		if (!_lg_typecheck_wrapT_overload_1(L)) {
			luaL_error(L, "luna typecheck failed in ork::TextureWrap ork::Texture::Parameters::wrapT() const function, expected prototype:\nork::TextureWrap ork::Texture::Parameters::wrapT() const\nClass arguments details:\n\n%s",luna_dumpStack(L).c_str());
		}
	...
	static int _bind_wrapT_overload_2(lua_State *L) {
		if (!_lg_typecheck_wrapT_overload_2(L)) {
			luaL_error(L, "luna typecheck failed in ork::Texture::Parameters & ork::Texture::Parameters::wrapT(ork::TextureWrap wrapT) function, expected prototype:\nork::Texture::Parameters & ork::Texture::Parameters::wrapT(ork::TextureWrap wrapT)\nClass arguments details:\n\n%s",luna_dumpStack(L).c_str());
		}
	...
	// Overload binder for ork::Texture::Parameters::wrapT
	...
	// ork::TextureWrap ork::Texture::Parameters::wrapR() const
	static int _bind_wrapR_overload_1(lua_State *L) {
		if (!_lg_typecheck_wrapR_overload_1(L)) {
			luaL_error(L, "luna typecheck failed in ork::TextureWrap ork::Texture::Parameters::wrapR() const function, expected prototype:\nork::TextureWrap ork::Texture::Parameters::wrapR() const\nClass arguments details:\n\n%s",luna_dumpStack(L).c_str());
		}
	...
	static int _bind_wrapR_overload_2(lua_State *L) {
		if (!_lg_typecheck_wrapR_overload_2(L)) {
			luaL_error(L, "luna typecheck failed in ork::Texture::Parameters & ork::Texture::Parameters::wrapR(ork::TextureWrap wrapR) function, expected prototype:\nork::Texture::Parameters & ork::Texture::Parameters::wrapR(ork::TextureWrap wrapR)\nClass arguments details:\n\n%s",luna_dumpStack(L).c_str());
		}
	...
	// Overload binder for ork::Texture::Parameters::wrapR
	...
	// ork::TextureFilter ork::Texture::Parameters::min() const
	static int _bind_min_overload_1(lua_State *L) {
		if (!_lg_typecheck_min_overload_1(L)) {
			luaL_error(L, "luna typecheck failed in ork::TextureFilter ork::Texture::Parameters::min() const function, expected prototype:\nork::TextureFilter ork::Texture::Parameters::min() const\nClass arguments details:\n\n%s",luna_dumpStack(L).c_str());
		}
	...
	static int _bind_min_overload_2(lua_State *L) {
		if (!_lg_typecheck_min_overload_2(L)) {
			luaL_error(L, "luna typecheck failed in ork::Texture::Parameters & ork::Texture::Parameters::min(ork::TextureFilter min) function, expected prototype:\nork::Texture::Parameters & ork::Texture::Parameters::min(ork::TextureFilter min)\nClass arguments details:\n\n%s",luna_dumpStack(L).c_str());
		}
	...
	// Overload binder for ork::Texture::Parameters::min
	...
	// ork::TextureFilter ork::Texture::Parameters::mag() const
	static int _bind_mag_overload_1(lua_State *L) {
		if (!_lg_typecheck_mag_overload_1(L)) {
			luaL_error(L, "luna typecheck failed in ork::TextureFilter ork::Texture::Parameters::mag() const function, expected prototype:\nork::TextureFilter ork::Texture::Parameters::mag() const\nClass arguments details:\n\n%s",luna_dumpStack(L).c_str());
		}
	...
	static int _bind_mag_overload_2(lua_State *L) {
		if (!_lg_typecheck_mag_overload_2(L)) {
			luaL_error(L, "luna typecheck failed in ork::Texture::Parameters & ork::Texture::Parameters::mag(ork::TextureFilter mag) function, expected prototype:\nork::Texture::Parameters & ork::Texture::Parameters::mag(ork::TextureFilter mag)\nClass arguments details:\n\n%s",luna_dumpStack(L).c_str());
		}
	...
	// Overload binder for ork::Texture::Parameters::mag
	...
	static int _bind_borderType(lua_State *L) {
		if (!_lg_typecheck_borderType(L)) {
			luaL_error(L, "luna typecheck failed in unsigned int ork::Texture::Parameters::borderType() const function, expected prototype:\nunsigned int ork::Texture::Parameters::borderType() const\nClass arguments details:\n\n%s",luna_dumpStack(L).c_str());
		}
	...
	// float ork::Texture::Parameters::lodMin() const
	static int _bind_lodMin_overload_1(lua_State *L) {
		if (!_lg_typecheck_lodMin_overload_1(L)) {
			luaL_error(L, "luna typecheck failed in float ork::Texture::Parameters::lodMin() const function, expected prototype:\nfloat ork::Texture::Parameters::lodMin() const\nClass arguments details:\n\n%s",luna_dumpStack(L).c_str());
		}
	...
	static int _bind_lodMin_overload_2(lua_State *L) {
		if (!_lg_typecheck_lodMin_overload_2(L)) {
			luaL_error(L, "luna typecheck failed in ork::Texture::Parameters & ork::Texture::Parameters::lodMin(float lodMin) function, expected prototype:\nork::Texture::Parameters & ork::Texture::Parameters::lodMin(float lodMin)\nClass arguments details:\n\n%s",luna_dumpStack(L).c_str());
		}
	...
	// Overload binder for ork::Texture::Parameters::lodMin
	...
	// float ork::Texture::Parameters::lodMax() const
	static int _bind_lodMax_overload_1(lua_State *L) {
		if (!_lg_typecheck_lodMax_overload_1(L)) {
			luaL_error(L, "luna typecheck failed in float ork::Texture::Parameters::lodMax() const function, expected prototype:\nfloat ork::Texture::Parameters::lodMax() const\nClass arguments details:\n\n%s",luna_dumpStack(L).c_str());
		}
	...
	static int _bind_lodMax_overload_2(lua_State *L) {
		if (!_lg_typecheck_lodMax_overload_2(L)) {
			luaL_error(L, "luna typecheck failed in ork::Texture::Parameters & ork::Texture::Parameters::lodMax(float lodMax) function, expected prototype:\nork::Texture::Parameters & ork::Texture::Parameters::lodMax(float lodMax)\nClass arguments details:\n\n%s",luna_dumpStack(L).c_str());
		}
	...
	// Overload binder for ork::Texture::Parameters::lodMax
	...
	// float ork::Texture::Parameters::lodBias() const
	static int _bind_lodBias_overload_1(lua_State *L) {
		if (!_lg_typecheck_lodBias_overload_1(L)) {
			luaL_error(L, "luna typecheck failed in float ork::Texture::Parameters::lodBias() const function, expected prototype:\nfloat ork::Texture::Parameters::lodBias() const\nClass arguments details:\n\n%s",luna_dumpStack(L).c_str());
		}
	...
	static int _bind_lodBias_overload_2(lua_State *L) {
		if (!_lg_typecheck_lodBias_overload_2(L)) {
			luaL_error(L, "luna typecheck failed in ork::Texture::Parameters & ork::Texture::Parameters::lodBias(float lodBias) function, expected prototype:\nork::Texture::Parameters & ork::Texture::Parameters::lodBias(float lodBias)\nClass arguments details:\n\n%s",luna_dumpStack(L).c_str());
		}
	...
	// Overload binder for ork::Texture::Parameters::lodBias
	...
	// ork::Function ork::Texture::Parameters::compareFunc() const
	static int _bind_compareFunc_overload_1(lua_State *L) {
		if (!_lg_typecheck_compareFunc_overload_1(L)) {
			luaL_error(L, "luna typecheck failed in ork::Function ork::Texture::Parameters::compareFunc() const function, expected prototype:\nork::Function ork::Texture::Parameters::compareFunc() const\nClass arguments details:\n\n%s",luna_dumpStack(L).c_str());
		}
	...
	static int _bind_compareFunc_overload_2(lua_State *L) {
		if (!_lg_typecheck_compareFunc_overload_2(L)) {
			luaL_error(L, "luna typecheck failed in ork::Texture::Parameters & ork::Texture::Parameters::compareFunc(ork::Function compareFunc) function, expected prototype:\nork::Texture::Parameters & ork::Texture::Parameters::compareFunc(ork::Function compareFunc)\nClass arguments details:\n\n%s",luna_dumpStack(L).c_str());
		}
	...
	// Overload binder for ork::Texture::Parameters::compareFunc
	...
	// float ork::Texture::Parameters::maxAnisotropyEXT() const
	static int _bind_maxAnisotropyEXT_overload_1(lua_State *L) {
		if (!_lg_typecheck_maxAnisotropyEXT_overload_1(L)) {
			luaL_error(L, "luna typecheck failed in float ork::Texture::Parameters::maxAnisotropyEXT() const function, expected prototype:\nfloat ork::Texture::Parameters::maxAnisotropyEXT() const\nClass arguments details:\n\n%s",luna_dumpStack(L).c_str());
		}
	...
	static int _bind_maxAnisotropyEXT_overload_2(lua_State *L) {
		if (!_lg_typecheck_maxAnisotropyEXT_overload_2(L)) {
			luaL_error(L, "luna typecheck failed in ork::Texture::Parameters & ork::Texture::Parameters::maxAnisotropyEXT(float maxAnisotropy) function, expected prototype:\nork::Texture::Parameters & ork::Texture::Parameters::maxAnisotropyEXT(float maxAnisotropy)\nClass arguments details:\n\n%s",luna_dumpStack(L).c_str());
		}
	...
	// Overload binder for ork::Texture::Parameters::maxAnisotropyEXT
	...
	static int _bind_swizzle_overload_1(lua_State *L) {
		if (!_lg_typecheck_swizzle_overload_1(L)) {
			luaL_error(L, "luna typecheck failed in const char * ork::Texture::Parameters::swizzle() const function, expected prototype:\nconst char * ork::Texture::Parameters::swizzle() const\nClass arguments details:\n\n%s",luna_dumpStack(L).c_str());
		}
	...
	static int _bind_swizzle_overload_2(lua_State *L) {
		if (!_lg_typecheck_swizzle_overload_2(L)) {
			luaL_error(L, "luna typecheck failed in ork::Texture::Parameters & ork::Texture::Parameters::swizzle(char r, char g, char b, char a) function, expected prototype:\nork::Texture::Parameters & ork::Texture::Parameters::swizzle(char r, char g, char b, char a)\nClass arguments details:\n\n%s",luna_dumpStack(L).c_str());
		}

		char r=(char)lua_tointeger(L,2);
		char g=(char)lua_tointeger(L,3);
	...
	// Overload binder for ork::Texture::Parameters::swizzle
	static int _bind_swizzle(lua_State *L) {
		if (_lg_typecheck_swizzle_overload_1(L)) return _bind_swizzle_overload_1(L);
		if (_lg_typecheck_swizzle_overload_2(L)) return _bind_swizzle_overload_2(L);

		luaL_error(L, "error in function swizzle, cannot match any of the overloads for function swizzle:\n  swizzle()\n  swizzle(char, char, char, char)\n");
		return 0;
	}

	// int ork::Texture::Parameters::minLevel() const
	static int _bind_minLevel_overload_1(lua_State *L) {
		if (!_lg_typecheck_minLevel_overload_1(L)) {
			luaL_error(L, "luna typecheck failed in int ork::Texture::Parameters::minLevel() const function, expected prototype:\nint ork::Texture::Parameters::minLevel() const\nClass arguments details:\n\n%s",luna_dumpStack(L).c_str());
		}
	...
	static int _bind_minLevel_overload_2(lua_State *L) {
		if (!_lg_typecheck_minLevel_overload_2(L)) {
			luaL_error(L, "luna typecheck failed in ork::Texture::Parameters & ork::Texture::Parameters::minLevel(int minLevel) function, expected prototype:\nork::Texture::Parameters & ork::Texture::Parameters::minLevel(int minLevel)\nClass arguments details:\n\n%s",luna_dumpStack(L).c_str());
		}
	...
	// Overload binder for ork::Texture::Parameters::minLevel
	static int _bind_minLevel(lua_State *L) {
		if (_lg_typecheck_minLevel_overload_1(L)) return _bind_minLevel_overload_1(L);
		if (_lg_typecheck_minLevel_overload_2(L)) return _bind_minLevel_overload_2(L);

		luaL_error(L, "error in function minLevel, cannot match any of the overloads for function minLevel:\n  minLevel()\n  minLevel(int)\n");
		return 0;
	}

	// int ork::Texture::Parameters::maxLevel() const
	static int _bind_maxLevel_overload_1(lua_State *L) {
		if (!_lg_typecheck_maxLevel_overload_1(L)) {
			luaL_error(L, "luna typecheck failed in int ork::Texture::Parameters::maxLevel() const function, expected prototype:\nint ork::Texture::Parameters::maxLevel() const\nClass arguments details:\n\n%s",luna_dumpStack(L).c_str());
		}
	...
	static int _bind_maxLevel_overload_2(lua_State *L) {
		if (!_lg_typecheck_maxLevel_overload_2(L)) {
			luaL_error(L, "luna typecheck failed in ork::Texture::Parameters & ork::Texture::Parameters::maxLevel(int maxLevel) function, expected prototype:\nork::Texture::Parameters & ork::Texture::Parameters::maxLevel(int maxLevel)\nClass arguments details:\n\n%s",luna_dumpStack(L).c_str());
		}
	...
	// Overload binder for ork::Texture::Parameters::maxLevel
	static int _bind_maxLevel(lua_State *L) {
		if (_lg_typecheck_maxLevel_overload_1(L)) return _bind_maxLevel_overload_1(L);
		if (_lg_typecheck_maxLevel_overload_2(L)) return _bind_maxLevel_overload_2(L);

		luaL_error(L, "error in function maxLevel, cannot match any of the overloads for function maxLevel:\n  maxLevel()\n  maxLevel(int)\n");
		return 0;
	}
	...
	static int _bind_borderi(lua_State *L) {
		if (!_lg_typecheck_borderi(L)) {
			luaL_error(L, "luna typecheck failed in ork::Texture::Parameters & ork::Texture::Parameters::borderi(int r = 0, int g = 0, int b = 0, int a = 0) function, expected prototype:\nork::Texture::Parameters & ork::Texture::Parameters::borderi(int r = 0, int g = 0, int b = 0, int a = 0)\nClass arguments details:\n\n%s",luna_dumpStack(L).c_str());
		}
	...
	static int _bind_borderf(lua_State *L) {
		if (!_lg_typecheck_borderf(L)) {
			luaL_error(L, "luna typecheck failed in ork::Texture::Parameters & ork::Texture::Parameters::borderf(float r = 0.0f, float g = 0.0f, float b = 0.0f, float a = 0.0f) function, expected prototype:\nork::Texture::Parameters & ork::Texture::Parameters::borderf(float r = 0.0f, float g = 0.0f, float b = 0.0f, float a = 0.0f)\nClass arguments details:\n\n%s",luna_dumpStack(L).c_str());
		}
	...
	static int _bind_borderIi(lua_State *L) {
		if (!_lg_typecheck_borderIi(L)) {
			luaL_error(L, "luna typecheck failed in ork::Texture::Parameters & ork::Texture::Parameters::borderIi(int r = 0, int g = 0, int b = 0, int a = 0) function, expected prototype:\nork::Texture::Parameters & ork::Texture::Parameters::borderIi(int r = 0, int g = 0, int b = 0, int a = 0)\nClass arguments details:\n\n%s",luna_dumpStack(L).c_str());
		}
	...
	static int _bind_borderIui(lua_State *L) {
		if (!_lg_typecheck_borderIui(L)) {
			luaL_error(L, "luna typecheck failed in ork::Texture::Parameters & ork::Texture::Parameters::borderIui(unsigned int r = 0, unsigned int g = 0, unsigned int b = 0, unsigned int a = 0) function, expected prototype:\nork::Texture::Parameters & ork::Texture::Parameters::borderIui(unsigned int r = 0, unsigned int g = 0, unsigned int b = 0, unsigned int a = 0)\nClass arguments details:\n\n%s",luna_dumpStack(L).c_str());
		}
	...
	// ork::Texture::Parameters & ork::Texture::Parameters::base_wrapS(ork::TextureWrap wrapS)
	static int _bind_base_wrapS(lua_State *L) {
		if (!_lg_typecheck_base_wrapS(L)) {
			luaL_error(L, "luna typecheck failed in ork::Texture::Parameters & ork::Texture::Parameters::base_wrapS(ork::TextureWrap wrapS) function, expected prototype:\nork::Texture::Parameters & ork::Texture::Parameters::base_wrapS(ork::TextureWrap wrapS)\nClass arguments details:\n\n%s",luna_dumpStack(L).c_str());
		}
	...
	// ork::Texture::Parameters & ork::Texture::Parameters::base_wrapT(ork::TextureWrap wrapT)
	static int _bind_base_wrapT(lua_State *L) {
		if (!_lg_typecheck_base_wrapT(L)) {
			luaL_error(L, "luna typecheck failed in ork::Texture::Parameters & ork::Texture::Parameters::base_wrapT(ork::TextureWrap wrapT) function, expected prototype:\nork::Texture::Parameters & ork::Texture::Parameters::base_wrapT(ork::TextureWrap wrapT)\nClass arguments details:\n\n%s",luna_dumpStack(L).c_str());
		}
	...
	// ork::Texture::Parameters & ork::Texture::Parameters::base_wrapR(ork::TextureWrap wrapR)
	static int _bind_base_wrapR(lua_State *L) {
		if (!_lg_typecheck_base_wrapR(L)) {
			luaL_error(L, "luna typecheck failed in ork::Texture::Parameters & ork::Texture::Parameters::base_wrapR(ork::TextureWrap wrapR) function, expected prototype:\nork::Texture::Parameters & ork::Texture::Parameters::base_wrapR(ork::TextureWrap wrapR)\nClass arguments details:\n\n%s",luna_dumpStack(L).c_str());
		}
	...
	// ork::Texture::Parameters & ork::Texture::Parameters::base_min(ork::TextureFilter min)
	static int _bind_base_min(lua_State *L) {
		if (!_lg_typecheck_base_min(L)) {
			luaL_error(L, "luna typecheck failed in ork::Texture::Parameters & ork::Texture::Parameters::base_min(ork::TextureFilter min) function, expected prototype:\nork::Texture::Parameters & ork::Texture::Parameters::base_min(ork::TextureFilter min)\nClass arguments details:\n\n%s",luna_dumpStack(L).c_str());
		}
	...
	// ork::Texture::Parameters & ork::Texture::Parameters::base_mag(ork::TextureFilter mag)
	static int _bind_base_mag(lua_State *L) {
		if (!_lg_typecheck_base_mag(L)) {
			luaL_error(L, "luna typecheck failed in ork::Texture::Parameters & ork::Texture::Parameters::base_mag(ork::TextureFilter mag) function, expected prototype:\nork::Texture::Parameters & ork::Texture::Parameters::base_mag(ork::TextureFilter mag)\nClass arguments details:\n\n%s",luna_dumpStack(L).c_str());
		}
	...
	// ork::Texture::Parameters & ork::Texture::Parameters::base_borderi(int r = 0, int g = 0, int b = 0, int a = 0)
	static int _bind_base_borderi(lua_State *L) {
		if (!_lg_typecheck_base_borderi(L)) {
			luaL_error(L, "luna typecheck failed in ork::Texture::Parameters & ork::Texture::Parameters::base_borderi(int r = 0, int g = 0, int b = 0, int a = 0) function, expected prototype:\nork::Texture::Parameters & ork::Texture::Parameters::base_borderi(int r = 0, int g = 0, int b = 0, int a = 0)\nClass arguments details:\n\n%s",luna_dumpStack(L).c_str());
		}
	...
	// ork::Texture::Parameters & ork::Texture::Parameters::base_borderf(float r = 0.0f, float g = 0.0f, float b = 0.0f, float a = 0.0f)
	static int _bind_base_borderf(lua_State *L) {
		if (!_lg_typecheck_base_borderf(L)) {
			luaL_error(L, "luna typecheck failed in ork::Texture::Parameters & ork::Texture::Parameters::base_borderf(float r = 0.0f, float g = 0.0f, float b = 0.0f, float a = 0.0f) function, expected prototype:\nork::Texture::Parameters & ork::Texture::Parameters::base_borderf(float r = 0.0f, float g = 0.0f, float b = 0.0f, float a = 0.0f)\nClass arguments details:\n\n%s",luna_dumpStack(L).c_str());
		}
	...
	// ork::Texture::Parameters & ork::Texture::Parameters::base_borderIi(int r = 0, int g = 0, int b = 0, int a = 0)
	static int _bind_base_borderIi(lua_State *L) {
		if (!_lg_typecheck_base_borderIi(L)) {
			luaL_error(L, "luna typecheck failed in ork::Texture::Parameters & ork::Texture::Parameters::base_borderIi(int r = 0, int g = 0, int b = 0, int a = 0) function, expected prototype:\nork::Texture::Parameters & ork::Texture::Parameters::base_borderIi(int r = 0, int g = 0, int b = 0, int a = 0)\nClass arguments details:\n\n%s",luna_dumpStack(L).c_str());
		}
	...
	// ork::Texture::Parameters & ork::Texture::Parameters::base_borderIui(unsigned int r = 0, unsigned int g = 0, unsigned int b = 0, unsigned int a = 0)
	static int _bind_base_borderIui(lua_State *L) {
		if (!_lg_typecheck_base_borderIui(L)) {
			luaL_error(L, "luna typecheck failed in ork::Texture::Parameters & ork::Texture::Parameters::base_borderIui(unsigned int r = 0, unsigned int g = 0, unsigned int b = 0, unsigned int a = 0) function, expected prototype:\nork::Texture::Parameters & ork::Texture::Parameters::base_borderIui(unsigned int r = 0, unsigned int g = 0, unsigned int b = 0, unsigned int a = 0)\nClass arguments details:\n\n%s",luna_dumpStack(L).c_str());
		}
	...
	// ork::Texture::Parameters & ork::Texture::Parameters::base_lodMin(float lodMin)
	static int _bind_base_lodMin(lua_State *L) {
		if (!_lg_typecheck_base_lodMin(L)) {
			luaL_error(L, "luna typecheck failed in ork::Texture::Parameters & ork::Texture::Parameters::base_lodMin(float lodMin) function, expected prototype:\nork::Texture::Parameters & ork::Texture::Parameters::base_lodMin(float lodMin)\nClass arguments details:\n\n%s",luna_dumpStack(L).c_str());
		}
	...
	// ork::Texture::Parameters & ork::Texture::Parameters::base_lodMax(float lodMax)
	static int _bind_base_lodMax(lua_State *L) {
		if (!_lg_typecheck_base_lodMax(L)) {
			luaL_error(L, "luna typecheck failed in ork::Texture::Parameters & ork::Texture::Parameters::base_lodMax(float lodMax) function, expected prototype:\nork::Texture::Parameters & ork::Texture::Parameters::base_lodMax(float lodMax)\nClass arguments details:\n\n%s",luna_dumpStack(L).c_str());
		}
	...
	// ork::Texture::Parameters & ork::Texture::Parameters::base_lodBias(float lodBias)
	static int _bind_base_lodBias(lua_State *L) {
		if (!_lg_typecheck_base_lodBias(L)) {
			luaL_error(L, "luna typecheck failed in ork::Texture::Parameters & ork::Texture::Parameters::base_lodBias(float lodBias) function, expected prototype:\nork::Texture::Parameters & ork::Texture::Parameters::base_lodBias(float lodBias)\nClass arguments details:\n\n%s",luna_dumpStack(L).c_str());
		}
	...
	// ork::Texture::Parameters & ork::Texture::Parameters::base_compareFunc(ork::Function compareFunc)
	static int _bind_base_compareFunc(lua_State *L) {
		if (!_lg_typecheck_base_compareFunc(L)) {
			luaL_error(L, "luna typecheck failed in ork::Texture::Parameters & ork::Texture::Parameters::base_compareFunc(ork::Function compareFunc) function, expected prototype:\nork::Texture::Parameters & ork::Texture::Parameters::base_compareFunc(ork::Function compareFunc)\nClass arguments details:\n\n%s",luna_dumpStack(L).c_str());
		}
	...
	// ork::Texture::Parameters & ork::Texture::Parameters::base_maxAnisotropyEXT(float maxAnisotropy)
	static int _bind_base_maxAnisotropyEXT(lua_State *L) {
		if (!_lg_typecheck_base_maxAnisotropyEXT(L)) {
			luaL_error(L, "luna typecheck failed in ork::Texture::Parameters & ork::Texture::Parameters::base_maxAnisotropyEXT(float maxAnisotropy) function, expected prototype:\nork::Texture::Parameters & ork::Texture::Parameters::base_maxAnisotropyEXT(float maxAnisotropy)\nClass arguments details:\n\n%s",luna_dumpStack(L).c_str());
		}
	...
	// ork::Texture::Parameters & ork::Texture::Parameters::base_swizzle(char r, char g, char b, char a)
	static int _bind_base_swizzle(lua_State *L) {
		if (!_lg_typecheck_base_swizzle(L)) {
			luaL_error(L, "luna typecheck failed in ork::Texture::Parameters & ork::Texture::Parameters::base_swizzle(char r, char g, char b, char a) function, expected prototype:\nork::Texture::Parameters & ork::Texture::Parameters::base_swizzle(char r, char g, char b, char a)\nClass arguments details:\n\n%s",luna_dumpStack(L).c_str());
		}
	...
	// ork::Texture::Parameters & ork::Texture::Parameters::base_minLevel(int minLevel)
	static int _bind_base_minLevel(lua_State *L) {
		if (!_lg_typecheck_base_minLevel(L)) {
			luaL_error(L, "luna typecheck failed in ork::Texture::Parameters & ork::Texture::Parameters::base_minLevel(int minLevel) function, expected prototype:\nork::Texture::Parameters & ork::Texture::Parameters::base_minLevel(int minLevel)\nClass arguments details:\n\n%s",luna_dumpStack(L).c_str());
		}
	...
	// ork::Texture::Parameters & ork::Texture::Parameters::base_maxLevel(int maxLevel)
	static int _bind_base_maxLevel(lua_State *L) {
		if (!_lg_typecheck_base_maxLevel(L)) {
			luaL_error(L, "luna typecheck failed in ork::Texture::Parameters & ork::Texture::Parameters::base_maxLevel(int maxLevel) function, expected prototype:\nork::Texture::Parameters & ork::Texture::Parameters::base_maxLevel(int maxLevel)\nClass arguments details:\n\n%s",luna_dumpStack(L).c_str());
		}
...
ork::Texture::Parameters* LunaTraits< ork::Texture::Parameters >::_bind_ctor(lua_State *L) {
	return luna_wrapper_ork_Texture_Parameters::_bind_ctor(L);
}

void LunaTraits< ork::Texture::Parameters >::_bind_dtor(ork::Texture::Parameters* obj) {
	delete obj;
}
...
luna_RegType LunaTraits< ork::Texture::Parameters >::methods[] = {
	...
	{"wrapT", &luna_wrapper_ork_Texture_Parameters::_bind_wrapT},
	{"wrapR", &luna_wrapper_ork_Texture_Parameters::_bind_wrapR},
	{"min", &luna_wrapper_ork_Texture_Parameters::_bind_min},
	{"mag", &luna_wrapper_ork_Texture_Parameters::_bind_mag},
	{"borderType", &luna_wrapper_ork_Texture_Parameters::_bind_borderType},
	{"lodMin", &luna_wrapper_ork_Texture_Parameters::_bind_lodMin},
	{"lodMax", &luna_wrapper_ork_Texture_Parameters::_bind_lodMax},
	{"lodBias", &luna_wrapper_ork_Texture_Parameters::_bind_lodBias},
	{"compareFunc", &luna_wrapper_ork_Texture_Parameters::_bind_compareFunc},
	{"maxAnisotropyEXT", &luna_wrapper_ork_Texture_Parameters::_bind_maxAnisotropyEXT},
	{"swizzle", &luna_wrapper_ork_Texture_Parameters::_bind_swizzle},
	{"minLevel", &luna_wrapper_ork_Texture_Parameters::_bind_minLevel},
	{"maxLevel", &luna_wrapper_ork_Texture_Parameters::_bind_maxLevel},
	{"borderi", &luna_wrapper_ork_Texture_Parameters::_bind_borderi},
	{"borderf", &luna_wrapper_ork_Texture_Parameters::_bind_borderf},
	{"borderIi", &luna_wrapper_ork_Texture_Parameters::_bind_borderIi},
	{"borderIui", &luna_wrapper_ork_Texture_Parameters::_bind_borderIui},
	{"base_wrapS", &luna_wrapper_ork_Texture_Parameters::_bind_base_wrapS},
	{"base_wrapT", &luna_wrapper_ork_Texture_Parameters::_bind_base_wrapT},
	{"base_wrapR", &luna_wrapper_ork_Texture_Parameters::_bind_base_wrapR},
	{"base_min", &luna_wrapper_ork_Texture_Parameters::_bind_base_min},
	{"base_mag", &luna_wrapper_ork_Texture_Parameters::_bind_base_mag},
	{"base_borderi", &luna_wrapper_ork_Texture_Parameters::_bind_base_borderi},
	{"base_borderf", &luna_wrapper_ork_Texture_Parameters::_bind_base_borderf},
	{"base_borderIi", &luna_wrapper_ork_Texture_Parameters::_bind_base_borderIi},
	{"base_borderIui", &luna_wrapper_ork_Texture_Parameters::_bind_base_borderIui},
	{"base_lodMin", &luna_wrapper_ork_Texture_Parameters::_bind_base_lodMin},
	{"base_lodMax", &luna_wrapper_ork_Texture_Parameters::_bind_base_lodMax},
	{"base_lodBias", &luna_wrapper_ork_Texture_Parameters::_bind_base_lodBias},
	{"base_compareFunc", &luna_wrapper_ork_Texture_Parameters::_bind_base_compareFunc},
	{"base_maxAnisotropyEXT", &luna_wrapper_ork_Texture_Parameters::_bind_base_maxAnisotropyEXT},
...
luna_RegEnumType LunaTraits< ork::Texture::Parameters >::enumValues[] = {
	{0,0}
};
