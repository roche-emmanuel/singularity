...
public:
	...
	inline static bool _lg_typecheck_unset(lua_State *L) {
		if( lua_gettop(L)!=1 ) return false;
	...
	// vec3< int > ork::Buffer::Parameters::subImage2D() const
	static int _bind_subImage2D_overload_1(lua_State *L) {
		if (!_lg_typecheck_subImage2D_overload_1(L)) {
			luaL_error(L, "luna typecheck failed in vec3< int > ork::Buffer::Parameters::subImage2D() const function, expected prototype:\nvec3< int > ork::Buffer::Parameters::subImage2D() const\nClass arguments details:\n\n%s",luna_dumpStack(L).c_str());
		}


		ork::Buffer::Parameters* self=(Luna< ork::Buffer::Parameters >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call vec3< int > ork::Buffer::Parameters::subImage2D() const. Got : '%s'\n%s",typeid(Luna< ork::Buffer::Parameters >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
		vec3< int > stack_lret = self->subImage2D();
		vec3< int >* lret = new vec3< int >(stack_lret);
		if(!lret) return 0; // Do not write NULL pointers.

		Luna< vec3< int > >::push(L,lret,true);
	...
	// vec2< int > ork::Buffer::Parameters::subImage3D() const
	static int _bind_subImage3D_overload_1(lua_State *L) {
		if (!_lg_typecheck_subImage3D_overload_1(L)) {
			luaL_error(L, "luna typecheck failed in vec2< int > ork::Buffer::Parameters::subImage3D() const function, expected prototype:\nvec2< int > ork::Buffer::Parameters::subImage3D() const\nClass arguments details:\n\n%s",luna_dumpStack(L).c_str());
		}


		ork::Buffer::Parameters* self=(Luna< ork::Buffer::Parameters >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call vec2< int > ork::Buffer::Parameters::subImage3D() const. Got : '%s'\n%s",typeid(Luna< ork::Buffer::Parameters >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
		vec2< int > stack_lret = self->subImage3D();
		vec2< int >* lret = new vec2< int >(stack_lret);
		if(!lret) return 0; // Do not write NULL pointers.

		Luna< vec2< int > >::push(L,lret,true);
	...
	// void ork::Buffer::Parameters::set() const
	static int _bind_set(lua_State *L) {
		if (!_lg_typecheck_set(L)) {
			luaL_error(L, "luna typecheck failed in void ork::Buffer::Parameters::set() const function, expected prototype:\nvoid ork::Buffer::Parameters::set() const\nClass arguments details:\n\n%s",luna_dumpStack(L).c_str());
		}


		ork::Buffer::Parameters* self=(Luna< ork::Buffer::Parameters >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call void ork::Buffer::Parameters::set() const. Got : '%s'\n%s",typeid(Luna< ork::Buffer::Parameters >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
		self->set();
	...
	// void ork::Buffer::Parameters::unset() const
	static int _bind_unset(lua_State *L) {
		if (!_lg_typecheck_unset(L)) {
			luaL_error(L, "luna typecheck failed in void ork::Buffer::Parameters::unset() const function, expected prototype:\nvoid ork::Buffer::Parameters::unset() const\nClass arguments details:\n\n%s",luna_dumpStack(L).c_str());
		}


		ork::Buffer::Parameters* self=(Luna< ork::Buffer::Parameters >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call void ork::Buffer::Parameters::unset() const. Got : '%s'\n%s",typeid(Luna< ork::Buffer::Parameters >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
		self->unset();
...
luna_RegType LunaTraits< ork::Buffer::Parameters >::methods[] = {
	...
	{"set", &luna_wrapper_ork_Buffer_Parameters::_bind_set},
	{"unset", &luna_wrapper_ork_Buffer_Parameters::_bind_unset},
