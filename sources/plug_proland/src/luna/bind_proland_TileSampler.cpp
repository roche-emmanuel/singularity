...
public:
	...
	// Constructor binds:
	// proland::TileSampler::TileSampler(const std::string & name, ptr< proland::TileProducer > producer = NULL)
	static proland::TileSampler* _bind_ctor_overload_1(lua_State *L) {
		if (!_lg_typecheck_ctor_overload_1(L)) {
			luaL_error(L, "luna typecheck failed in proland::TileSampler::TileSampler(const std::string & name, ptr< proland::TileProducer > producer = NULL) function, expected prototype:\nproland::TileSampler::TileSampler(const std::string & name, ptr< proland::TileProducer > producer = NULL)\nClass arguments details:\narg 2 ID = [unknown]\n\n%s",luna_dumpStack(L).c_str());
		}
	...
	// proland::TileSampler::TileSampler(lua_Table * data, const std::string & name, ptr< proland::TileProducer > producer = NULL)
	static proland::TileSampler* _bind_ctor_overload_2(lua_State *L) {
		if (!_lg_typecheck_ctor_overload_2(L)) {
			luaL_error(L, "luna typecheck failed in proland::TileSampler::TileSampler(lua_Table * data, const std::string & name, ptr< proland::TileProducer > producer = NULL) function, expected prototype:\nproland::TileSampler::TileSampler(lua_Table * data, const std::string & name, ptr< proland::TileProducer > producer = NULL)\nClass arguments details:\narg 3 ID = [unknown]\n\n%s",luna_dumpStack(L).c_str());
		}
	...
	static proland::TileSampler* _bind_ctor(lua_State *L) {
		...
		luaL_error(L, "error in function TileSampler, cannot match any of the overloads for function TileSampler:\n  TileSampler(const std::string &, ptr< proland::TileProducer >)\n  TileSampler(lua_Table *, const std::string &, ptr< proland::TileProducer >)\n");
		return NULL;
	}


	// Function binds:
	// ptr< proland::TileProducer > proland::TileSampler::get()
	static int _bind_get(lua_State *L) {
		if (!_lg_typecheck_get(L)) {
			luaL_error(L, "luna typecheck failed in ptr< proland::TileProducer > proland::TileSampler::get() function, expected prototype:\nptr< proland::TileProducer > proland::TileSampler::get()\nClass arguments details:\n\n%s",luna_dumpStack(L).c_str());
		}
	...
	// ptr< proland::TerrainNode > proland::TileSampler::getTerrain(int i)
	static int _bind_getTerrain(lua_State *L) {
		if (!_lg_typecheck_getTerrain(L)) {
			luaL_error(L, "luna typecheck failed in ptr< proland::TerrainNode > proland::TileSampler::getTerrain(int i) function, expected prototype:\nptr< proland::TerrainNode > proland::TileSampler::getTerrain(int i)\nClass arguments details:\n\n%s",luna_dumpStack(L).c_str());
		}
	...
	static int _bind_set(lua_State *L) {
		...
		proland::TileSampler* self=Luna< ork::Object >::checkSubType< proland::TileSampler >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void proland::TileSampler::set(ptr< proland::TileProducer >). Got : '%s'\n%s",typeid(Luna< ork::Object >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
		self->set(producer);
	...
	static int _bind_addTerrain(lua_State *L) {
		...
		proland::TileSampler* self=Luna< ork::Object >::checkSubType< proland::TileSampler >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void proland::TileSampler::addTerrain(ptr< proland::TerrainNode >). Got : '%s'\n%s",typeid(Luna< ork::Object >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
