...
public:
	...
	static int _bind_toFirst(lua_State *L) {
		...
		if(!self) {
			luna_printStack(L);
			luaL_error(L, "Invalid object in function call IEdgeLabel * IEdgeLabelIterator::toFirst(). Got : '%s'",typeid(Luna< IEdgeLabelIterator >::check(L,1)).name());
		}
	...
	static int _bind_toLast(lua_State *L) {
		...
		if(!self) {
			luna_printStack(L);
			luaL_error(L, "Invalid object in function call IEdgeLabel * IEdgeLabelIterator::toLast(). Got : '%s'",typeid(Luna< IEdgeLabelIterator >::check(L,1)).name());
		}
	...
	static int _bind_toNext(lua_State *L) {
		...
		if(!self) {
			luna_printStack(L);
			luaL_error(L, "Invalid object in function call IEdgeLabel * IEdgeLabelIterator::toNext(). Got : '%s'",typeid(Luna< IEdgeLabelIterator >::check(L,1)).name());
		}
	...
	static int _bind_toPrev(lua_State *L) {
		...
		if(!self) {
			luna_printStack(L);
			luaL_error(L, "Invalid object in function call IEdgeLabel * IEdgeLabelIterator::toPrev(). Got : '%s'",typeid(Luna< IEdgeLabelIterator >::check(L,1)).name());
		}
	...
	static int _bind_current(lua_State *L) {
		...
		if(!self) {
			luna_printStack(L);
			luaL_error(L, "Invalid object in function call IEdgeLabel * IEdgeLabelIterator::current() const. Got : '%s'",typeid(Luna< IEdgeLabelIterator >::check(L,1)).name());
		}
	...
	static int _bind_release(lua_State *L) {
		...
		if(!self) {
			luna_printStack(L);
			luaL_error(L, "Invalid object in function call void IEdgeLabelIterator::release(). Got : '%s'",typeid(Luna< IEdgeLabelIterator >::check(L,1)).name());
		}
		self->release();
