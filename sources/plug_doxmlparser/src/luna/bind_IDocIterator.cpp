...
public:
	...
	static int _bind_toFirst(lua_State *L) {
		...
		if(!self) {
			luna_printStack(L);
			luaL_error(L, "Invalid object in function call IDoc * IDocIterator::toFirst(). Got : '%s'",typeid(Luna< IDocIterator >::check(L,1)).name());
		}
	...
	static int _bind_toLast(lua_State *L) {
		...
		if(!self) {
			luna_printStack(L);
			luaL_error(L, "Invalid object in function call IDoc * IDocIterator::toLast(). Got : '%s'",typeid(Luna< IDocIterator >::check(L,1)).name());
		}
	...
	static int _bind_toNext(lua_State *L) {
		...
		if(!self) {
			luna_printStack(L);
			luaL_error(L, "Invalid object in function call IDoc * IDocIterator::toNext(). Got : '%s'",typeid(Luna< IDocIterator >::check(L,1)).name());
		}
	...
	static int _bind_toPrev(lua_State *L) {
		...
		if(!self) {
			luna_printStack(L);
			luaL_error(L, "Invalid object in function call IDoc * IDocIterator::toPrev(). Got : '%s'",typeid(Luna< IDocIterator >::check(L,1)).name());
		}
	...
	static int _bind_current(lua_State *L) {
		...
		if(!self) {
			luna_printStack(L);
			luaL_error(L, "Invalid object in function call IDoc * IDocIterator::current() const. Got : '%s'",typeid(Luna< IDocIterator >::check(L,1)).name());
		}
	...
	static int _bind_release(lua_State *L) {
		...
		if(!self) {
			luna_printStack(L);
			luaL_error(L, "Invalid object in function call void IDocIterator::release(). Got : '%s'",typeid(Luna< IDocIterator >::check(L,1)).name());
		}
		self->release();
