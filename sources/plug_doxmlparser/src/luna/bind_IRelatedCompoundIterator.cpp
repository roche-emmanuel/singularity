...
public:
	...
	static int _bind_toFirst(lua_State *L) {
		...
		if(!self) {
			luna_printStack(L);
			luaL_error(L, "Invalid object in function call IRelatedCompound * IRelatedCompoundIterator::toFirst(). Got : '%s'",typeid(Luna< IRelatedCompoundIterator >::check(L,1)).name());
		}
	...
	static int _bind_toLast(lua_State *L) {
		...
		if(!self) {
			luna_printStack(L);
			luaL_error(L, "Invalid object in function call IRelatedCompound * IRelatedCompoundIterator::toLast(). Got : '%s'",typeid(Luna< IRelatedCompoundIterator >::check(L,1)).name());
		}
	...
	static int _bind_toNext(lua_State *L) {
		...
		if(!self) {
			luna_printStack(L);
			luaL_error(L, "Invalid object in function call IRelatedCompound * IRelatedCompoundIterator::toNext(). Got : '%s'",typeid(Luna< IRelatedCompoundIterator >::check(L,1)).name());
		}
	...
	static int _bind_toPrev(lua_State *L) {
		...
		if(!self) {
			luna_printStack(L);
			luaL_error(L, "Invalid object in function call IRelatedCompound * IRelatedCompoundIterator::toPrev(). Got : '%s'",typeid(Luna< IRelatedCompoundIterator >::check(L,1)).name());
		}
	...
	static int _bind_current(lua_State *L) {
		...
		if(!self) {
			luna_printStack(L);
			luaL_error(L, "Invalid object in function call IRelatedCompound * IRelatedCompoundIterator::current() const. Got : '%s'",typeid(Luna< IRelatedCompoundIterator >::check(L,1)).name());
		}
	...
	static int _bind_release(lua_State *L) {
		...
		if(!self) {
			luna_printStack(L);
			luaL_error(L, "Invalid object in function call void IRelatedCompoundIterator::release(). Got : '%s'",typeid(Luna< IRelatedCompoundIterator >::check(L,1)).name());
		}
		self->release();
