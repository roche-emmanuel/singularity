...
#include <luna/wrappers/wrapper_IVariable.h>
...
public:
	...
	static int _bind_fromVoid(lua_State *L) {
		...
		IVariable* self= (IVariable*)(Luna< void >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call fromVoid(...)");
		}
		
		Luna< IVariable >::push(L,self,false);
		return 1;
	}
	...
	static int _cast_from_IMember(lua_State *L) {
		...
		//IVariable* ptr= dynamic_cast< IVariable* >(Luna< IMember >::check(L,1));
		IVariable* ptr= luna_caster< IMember, IVariable >::cast(Luna< IMember >::check(L,1));
		if(!ptr)
			return 0;
		
		// Otherwise push the pointer:
		Luna< IVariable >::push(L,ptr,false);
		return 1;
	};
	...
	// Constructor binds:
	// IVariable::IVariable(lua_Table * data)
	static IVariable* _bind_ctor(lua_State *L) {
		if (!_lg_typecheck_ctor(L)) {
			luna_printStack(L);
			luaL_error(L, "luna typecheck failed in IVariable::IVariable(lua_Table * data) function, expected prototype:\nIVariable::IVariable(lua_Table * data)\nClass arguments details:\n");
		}


		return new wrapper_IVariable(L,NULL);
	}
...
IVariable* LunaTraits< IVariable >::_bind_ctor(lua_State *L) {
	return luna_wrapper_IVariable::_bind_ctor(L);
...
const char LunaTraits< IVariable >::fullName[] = "IVariable";
const char LunaTraits< IVariable >::moduleName[] = "doxmlparser";
const char* LunaTraits< IVariable >::parents[] = {"doxmlparser.IMember", 0};
const int LunaTraits< IVariable >::hash = 78179104;
const int LunaTraits< IVariable >::uniqueIDs[] = {88829564,0};

luna_RegType LunaTraits< IVariable >::methods[] = {
	{"__eq", &luna_wrapper_IVariable::_bind___eq},
	{"fromVoid", &luna_wrapper_IVariable::_bind_fromVoid},
	{"asVoid", &luna_wrapper_IVariable::_bind_asVoid},
	{"getTable", &luna_wrapper_IVariable::_bind_getTable},
	{0,0}
};

luna_ConverterType LunaTraits< IVariable >::converters[] = {
	{"IMember", &luna_wrapper_IVariable::_cast_from_IMember},
	{0,0}
};
