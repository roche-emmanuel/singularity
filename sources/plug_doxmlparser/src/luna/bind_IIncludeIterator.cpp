...
public:
	...
	static int _bind_toFirst(lua_State *L) {
		...
		if(!self) {
			luna_printStack(L);
			luaL_error(L, "Invalid object in function call IInclude * IIncludeIterator::toFirst(). Got : '%s'",typeid(Luna< IIncludeIterator >::check(L,1)).name());
		}
	...
	static int _bind_toLast(lua_State *L) {
		...
		if(!self) {
			luna_printStack(L);
			luaL_error(L, "Invalid object in function call IInclude * IIncludeIterator::toLast(). Got : '%s'",typeid(Luna< IIncludeIterator >::check(L,1)).name());
		}
	...
	static int _bind_toNext(lua_State *L) {
		...
		if(!self) {
			luna_printStack(L);
			luaL_error(L, "Invalid object in function call IInclude * IIncludeIterator::toNext(). Got : '%s'",typeid(Luna< IIncludeIterator >::check(L,1)).name());
		}
	...
	static int _bind_toPrev(lua_State *L) {
		...
		if(!self) {
			luna_printStack(L);
			luaL_error(L, "Invalid object in function call IInclude * IIncludeIterator::toPrev(). Got : '%s'",typeid(Luna< IIncludeIterator >::check(L,1)).name());
		}
	...
	static int _bind_current(lua_State *L) {
		...
		if(!self) {
			luna_printStack(L);
			luaL_error(L, "Invalid object in function call IInclude * IIncludeIterator::current() const. Got : '%s'",typeid(Luna< IIncludeIterator >::check(L,1)).name());
		}
	...
	static int _bind_release(lua_State *L) {
		...
		if(!self) {
			luna_printStack(L);
			luaL_error(L, "Invalid object in function call void IIncludeIterator::release(). Got : '%s'",typeid(Luna< IIncludeIterator >::check(L,1)).name());
		}
		self->release();
