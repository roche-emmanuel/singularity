...
public:
	...
	static int _bind_fromVoid(lua_State *L) {
		...
		IException* self= (IException*)(Luna< void >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call fromVoid(...)");
		}
		
		Luna< IException >::push(L,self,false);
		return 1;
	}
...
luna_RegType LunaTraits< IException >::methods[] = {
	{"fromVoid", &luna_wrapper_IException::_bind_fromVoid},
	{"asVoid", &luna_wrapper_IException::_bind_asVoid},
