#ifndef _WRAPPERS_WRAPPER_B_GEARJOINT_H_
#define _WRAPPERS_WRAPPER_B_GEARJOINT_H_
...
class wrapper_b2GearJoint : public b2GearJoint, public luna_wrapper_base {

public:
		

	~wrapper_b2GearJoint() {
		logDEBUG3("Calling delete function for wrapper b2GearJoint");
		if(_obj.pushFunction("delete")) {
			//_obj.pushArg((b2GearJoint*)this); // No this argument or the object will be referenced again!
			_obj.callFunction<void>();
		}
	};
	
	wrapper_b2GearJoint(lua_State* L, lua_Table* dum, const b2GearJointDef * data) 
		: b2GearJoint(data), luna_wrapper_base(L) { 
		register_protected_methods(L);
		if(_obj.pushFunction("buildInstance")) {
			_obj.pushArg((b2GearJoint*)this);
			_obj.callFunction<void>();
		}
	};
...
protected:
	...
	void InitVelocityConstraints(const b2SolverData & data) {
		...
		return b2GearJoint::InitVelocityConstraints(data);
	};
	...
	void SolveVelocityConstraints(const b2SolverData & data) {
		...
		return b2GearJoint::SolveVelocityConstraints(data);
	};
	...
	bool SolvePositionConstraints(const b2SolverData & data) {
		...
		return b2GearJoint::SolvePositionConstraints(data);
	};
...
public:
	...
	b2Vec2 GetReactionForce(float inv_dt) const {
		...
		return b2GearJoint::GetReactionForce(inv_dt);
	};
	...
	float GetReactionTorque(float inv_dt) const {
		...
		return b2GearJoint::GetReactionTorque(inv_dt);
	};
	...
	static int _bind_public_Create(lua_State *L) {
		...
		wrapper_b2GearJoint* self=Luna< b2Joint >::checkSubType< wrapper_b2GearJoint >(L,1);
		if(!self) {
