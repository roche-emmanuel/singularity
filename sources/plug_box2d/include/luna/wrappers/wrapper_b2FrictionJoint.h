#ifndef _WRAPPERS_WRAPPER_B_FRICTIONJOINT_H_
#define _WRAPPERS_WRAPPER_B_FRICTIONJOINT_H_
...
class wrapper_b2FrictionJoint : public b2FrictionJoint, public luna_wrapper_base {

public:
		

	~wrapper_b2FrictionJoint() {
		logDEBUG3("Calling delete function for wrapper b2FrictionJoint");
		if(_obj.pushFunction("delete")) {
			//_obj.pushArg((b2FrictionJoint*)this); // No this argument or the object will be referenced again!
			_obj.callFunction<void>();
		}
	};
	
	wrapper_b2FrictionJoint(lua_State* L, lua_Table* dum, const b2FrictionJointDef * def) 
		: b2FrictionJoint(def), luna_wrapper_base(L) { 
		register_protected_methods(L);
		if(_obj.pushFunction("buildInstance")) {
			_obj.pushArg((b2FrictionJoint*)this);
			_obj.callFunction<void>();
		}
	};
...
protected:
	...
	void InitVelocityConstraints(const b2SolverData & data) {
		...
		return b2FrictionJoint::InitVelocityConstraints(data);
	};
	...
	void SolveVelocityConstraints(const b2SolverData & data) {
		...
		return b2FrictionJoint::SolveVelocityConstraints(data);
	};
	...
	bool SolvePositionConstraints(const b2SolverData & data) {
		...
		return b2FrictionJoint::SolvePositionConstraints(data);
	};
...
public:
	...
	b2Vec2 GetAnchorA() const {
		...
		return b2FrictionJoint::GetAnchorA();
	};
	...
	b2Vec2 GetAnchorB() const {
		...
		return b2FrictionJoint::GetAnchorB();
	};
	...
	b2Vec2 GetReactionForce(float inv_dt) const {
		...
		return b2FrictionJoint::GetReactionForce(inv_dt);
	};
	...
	float GetReactionTorque(float inv_dt) const {
		...
		return b2FrictionJoint::GetReactionTorque(inv_dt);
	};
	...
	static int _bind_public_Create(lua_State *L) {
		...
		wrapper_b2FrictionJoint* self=Luna< b2Joint >::checkSubType< wrapper_b2FrictionJoint >(L,1);
		if(!self) {
