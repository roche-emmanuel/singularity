#ifndef _WRAPPERS_WRAPPER_B_PRISMATICJOINT_H_
#define _WRAPPERS_WRAPPER_B_PRISMATICJOINT_H_
...
class wrapper_b2PrismaticJoint : public b2PrismaticJoint, public luna_wrapper_base {

public:
		

	~wrapper_b2PrismaticJoint() {
		logDEBUG3("Calling delete function for wrapper b2PrismaticJoint");
		if(_obj.pushFunction("delete")) {
			//_obj.pushArg((b2PrismaticJoint*)this); // No this argument or the object will be referenced again!
			_obj.callFunction<void>();
		}
	};
	
	wrapper_b2PrismaticJoint(lua_State* L, lua_Table* dum, const b2PrismaticJointDef * def) 
		: b2PrismaticJoint(def), luna_wrapper_base(L) { 
		register_protected_methods(L);
		if(_obj.pushFunction("buildInstance")) {
			_obj.pushArg((b2PrismaticJoint*)this);
			_obj.callFunction<void>();
		}
	};
...
protected:
	...
	void InitVelocityConstraints(const b2SolverData & data) {
		...
		return b2PrismaticJoint::InitVelocityConstraints(data);
	};
	...
	void SolveVelocityConstraints(const b2SolverData & data) {
		...
		return b2PrismaticJoint::SolveVelocityConstraints(data);
	};
	...
	bool SolvePositionConstraints(const b2SolverData & data) {
		...
		return b2PrismaticJoint::SolvePositionConstraints(data);
	};
...
public:
	...
	b2Vec2 GetAnchorA() const {
		...
		return b2PrismaticJoint::GetAnchorA();
	};
	...
	b2Vec2 GetAnchorB() const {
		...
		return b2PrismaticJoint::GetAnchorB();
	};
	...
	b2Vec2 GetReactionForce(float inv_dt) const {
		...
		return b2PrismaticJoint::GetReactionForce(inv_dt);
	};
	...
	float GetReactionTorque(float inv_dt) const {
		...
		return b2PrismaticJoint::GetReactionTorque(inv_dt);
	};
	...
	static int _bind_public_Create(lua_State *L) {
		...
		wrapper_b2PrismaticJoint* self=Luna< b2Joint >::checkSubType< wrapper_b2PrismaticJoint >(L,1);
		if(!self) {
			luna_printStack(L);
