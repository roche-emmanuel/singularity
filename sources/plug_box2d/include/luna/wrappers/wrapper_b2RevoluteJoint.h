#ifndef _WRAPPERS_WRAPPER_B_REVOLUTEJOINT_H_
#define _WRAPPERS_WRAPPER_B_REVOLUTEJOINT_H_
...
class wrapper_b2RevoluteJoint : public b2RevoluteJoint, public luna_wrapper_base {

public:
		

	~wrapper_b2RevoluteJoint() {
		logDEBUG3("Calling delete function for wrapper b2RevoluteJoint");
		if(_obj.pushFunction("delete")) {
			//_obj.pushArg((b2RevoluteJoint*)this); // No this argument or the object will be referenced again!
			_obj.callFunction<void>();
		}
	};
	
	wrapper_b2RevoluteJoint(lua_State* L, lua_Table* dum, const b2RevoluteJointDef * def) 
		: b2RevoluteJoint(def), luna_wrapper_base(L) { 
		register_protected_methods(L);
		if(_obj.pushFunction("buildInstance")) {
			_obj.pushArg((b2RevoluteJoint*)this);
			_obj.callFunction<void>();
		}
	};
...
protected:
	...
	void InitVelocityConstraints(const b2SolverData & data) {
		...
		return b2RevoluteJoint::InitVelocityConstraints(data);
	};
	...
	void SolveVelocityConstraints(const b2SolverData & data) {
		...
		return b2RevoluteJoint::SolveVelocityConstraints(data);
	};
	...
	bool SolvePositionConstraints(const b2SolverData & data) {
		...
		return b2RevoluteJoint::SolvePositionConstraints(data);
	};
...
public:
	...
	b2Vec2 GetAnchorA() const {
		...
		return b2RevoluteJoint::GetAnchorA();
	};
	...
	b2Vec2 GetAnchorB() const {
		...
		return b2RevoluteJoint::GetAnchorB();
	};
	...
	b2Vec2 GetReactionForce(float inv_dt) const {
		...
		return b2RevoluteJoint::GetReactionForce(inv_dt);
	};
	...
	float GetReactionTorque(float inv_dt) const {
		...
		return b2RevoluteJoint::GetReactionTorque(inv_dt);
	};
	...
	static int _bind_public_Create(lua_State *L) {
		...
		wrapper_b2RevoluteJoint* self=Luna< b2Joint >::checkSubType< wrapper_b2RevoluteJoint >(L,1);
		if(!self) {
