...
public:
	...
	static int _bind_GetAnchorA(lua_State *L) {
		...
		if(!self) {
			luaL_error(L, "Invalid object in function call b2Vec2 b2RopeJoint::GetAnchorA() const. Got : '%s'\n%s",typeid(Luna< b2Joint >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_GetAnchorB(lua_State *L) {
		...
		b2RopeJoint* self=Luna< b2Joint >::checkSubType< b2RopeJoint >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call b2Vec2 b2RopeJoint::GetAnchorB() const. Got : '%s'\n%s",typeid(Luna< b2Joint >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_GetReactionForce(lua_State *L) {
		...
		b2RopeJoint* self=Luna< b2Joint >::checkSubType< b2RopeJoint >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call b2Vec2 b2RopeJoint::GetReactionForce(float) const. Got : '%s'\n%s",typeid(Luna< b2Joint >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_GetReactionTorque(lua_State *L) {
		...
		b2RopeJoint* self=Luna< b2Joint >::checkSubType< b2RopeJoint >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call float b2RopeJoint::GetReactionTorque(float) const. Got : '%s'\n%s",typeid(Luna< b2Joint >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_GetLocalAnchorA(lua_State *L) {
		...
		b2RopeJoint* self=Luna< b2Joint >::checkSubType< b2RopeJoint >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call const b2Vec2 & b2RopeJoint::GetLocalAnchorA() const. Got : '%s'\n%s",typeid(Luna< b2Joint >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_GetLocalAnchorB(lua_State *L) {
		...
		b2RopeJoint* self=Luna< b2Joint >::checkSubType< b2RopeJoint >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call const b2Vec2 & b2RopeJoint::GetLocalAnchorB() const. Got : '%s'\n%s",typeid(Luna< b2Joint >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_SetMaxLength(lua_State *L) {
		...
		b2RopeJoint* self=Luna< b2Joint >::checkSubType< b2RopeJoint >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void b2RopeJoint::SetMaxLength(float). Got : '%s'\n%s",typeid(Luna< b2Joint >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_GetMaxLength(lua_State *L) {
		...
		b2RopeJoint* self=Luna< b2Joint >::checkSubType< b2RopeJoint >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call float b2RopeJoint::GetMaxLength() const. Got : '%s'\n%s",typeid(Luna< b2Joint >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_GetLimitState(lua_State *L) {
		...
		b2RopeJoint* self=Luna< b2Joint >::checkSubType< b2RopeJoint >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call b2LimitState b2RopeJoint::GetLimitState() const. Got : '%s'\n%s",typeid(Luna< b2Joint >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_Dump(lua_State *L) {
		...
		b2RopeJoint* self=Luna< b2Joint >::checkSubType< b2RopeJoint >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void b2RopeJoint::Dump(). Got : '%s'\n%s",typeid(Luna< b2Joint >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
		self->Dump();
	...
	static int _bind_base_GetAnchorA(lua_State *L) {
		...
		b2RopeJoint* self=Luna< b2Joint >::checkSubType< b2RopeJoint >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call b2Vec2 b2RopeJoint::base_GetAnchorA() const. Got : '%s'\n%s",typeid(Luna< b2Joint >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_GetAnchorB(lua_State *L) {
		...
		b2RopeJoint* self=Luna< b2Joint >::checkSubType< b2RopeJoint >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call b2Vec2 b2RopeJoint::base_GetAnchorB() const. Got : '%s'\n%s",typeid(Luna< b2Joint >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_GetReactionForce(lua_State *L) {
		...
		b2RopeJoint* self=Luna< b2Joint >::checkSubType< b2RopeJoint >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call b2Vec2 b2RopeJoint::base_GetReactionForce(float) const. Got : '%s'\n%s",typeid(Luna< b2Joint >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_GetReactionTorque(lua_State *L) {
		...
		b2RopeJoint* self=Luna< b2Joint >::checkSubType< b2RopeJoint >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call float b2RopeJoint::base_GetReactionTorque(float) const. Got : '%s'\n%s",typeid(Luna< b2Joint >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_Dump(lua_State *L) {
		...
		b2RopeJoint* self=Luna< b2Joint >::checkSubType< b2RopeJoint >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void b2RopeJoint::base_Dump(). Got : '%s'\n%s",typeid(Luna< b2Joint >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
