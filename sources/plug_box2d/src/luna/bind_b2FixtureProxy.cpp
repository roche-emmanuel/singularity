...
public:
	...
	static int _bind___eq(lua_State *L) {
		if (!_lg_typecheck___eq(L)) {
			luaL_error(L, "luna typecheck failed in __eq function, expected prototype:\n__eq(b2FixtureProxy*). Got arguments:\n%s",luna_dumpStack(L).c_str());
		}
	...
	static int _bind_getAabb(lua_State *L) {
		...
		b2FixtureProxy* self=(Luna< b2FixtureProxy >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call b2AABB b2FixtureProxy::aabb(). Got : '%s'\n%s",typeid(Luna< b2FixtureProxy >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_getFixture(lua_State *L) {
		...
		b2FixtureProxy* self=(Luna< b2FixtureProxy >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call b2Fixture * b2FixtureProxy::fixture(). Got : '%s'\n%s",typeid(Luna< b2FixtureProxy >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_getChildIndex(lua_State *L) {
		...
		b2FixtureProxy* self=(Luna< b2FixtureProxy >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call signed int b2FixtureProxy::childIndex(). Got : '%s'\n%s",typeid(Luna< b2FixtureProxy >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_getProxyId(lua_State *L) {
		...
		b2FixtureProxy* self=(Luna< b2FixtureProxy >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call signed int b2FixtureProxy::proxyId(). Got : '%s'\n%s",typeid(Luna< b2FixtureProxy >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_setAabb(lua_State *L) {
		...
		b2FixtureProxy* self=(Luna< b2FixtureProxy >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call void b2FixtureProxy::aabb(b2AABB). Got : '%s'\n%s",typeid(Luna< b2FixtureProxy >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
		self->aabb = value;
	...
	static int _bind_setFixture(lua_State *L) {
		...
		b2FixtureProxy* self=(Luna< b2FixtureProxy >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call void b2FixtureProxy::fixture(b2Fixture *). Got : '%s'\n%s",typeid(Luna< b2FixtureProxy >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
		self->fixture = value;
	...
	static int _bind_setChildIndex(lua_State *L) {
		...
		b2FixtureProxy* self=(Luna< b2FixtureProxy >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call void b2FixtureProxy::childIndex(signed int). Got : '%s'\n%s",typeid(Luna< b2FixtureProxy >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_setProxyId(lua_State *L) {
		...
		b2FixtureProxy* self=(Luna< b2FixtureProxy >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call void b2FixtureProxy::proxyId(signed int). Got : '%s'\n%s",typeid(Luna< b2FixtureProxy >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
		self->proxyId = value;
