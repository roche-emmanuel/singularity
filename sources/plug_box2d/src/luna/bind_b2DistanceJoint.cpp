...
public:
	...
	static int _bind_fromVoid(lua_State *L) {
		...
		b2DistanceJoint* self= (b2DistanceJoint*)(Luna< void >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call fromVoid(...)");
		}
		
		Luna< b2DistanceJoint >::push(L,self,false);
		return 1;
	}
	...
	static int _bind_GetAnchorA(lua_State *L) {
		...
		if(!self) {
			luaL_error(L, "Invalid object in function call b2Vec2 b2DistanceJoint::GetAnchorA() const. Got : '%s'\n%s",typeid(Luna< b2Joint >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_GetAnchorB(lua_State *L) {
		...
		b2DistanceJoint* self=Luna< b2Joint >::checkSubType< b2DistanceJoint >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call b2Vec2 b2DistanceJoint::GetAnchorB() const. Got : '%s'\n%s",typeid(Luna< b2Joint >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_GetReactionForce(lua_State *L) {
		...
		b2DistanceJoint* self=Luna< b2Joint >::checkSubType< b2DistanceJoint >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call b2Vec2 b2DistanceJoint::GetReactionForce(float) const. Got : '%s'\n%s",typeid(Luna< b2Joint >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_GetReactionTorque(lua_State *L) {
		...
		b2DistanceJoint* self=Luna< b2Joint >::checkSubType< b2DistanceJoint >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call float b2DistanceJoint::GetReactionTorque(float) const. Got : '%s'\n%s",typeid(Luna< b2Joint >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_GetLocalAnchorA(lua_State *L) {
		...
		b2DistanceJoint* self=Luna< b2Joint >::checkSubType< b2DistanceJoint >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call const b2Vec2 & b2DistanceJoint::GetLocalAnchorA() const. Got : '%s'\n%s",typeid(Luna< b2Joint >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_GetLocalAnchorB(lua_State *L) {
		...
		b2DistanceJoint* self=Luna< b2Joint >::checkSubType< b2DistanceJoint >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call const b2Vec2 & b2DistanceJoint::GetLocalAnchorB() const. Got : '%s'\n%s",typeid(Luna< b2Joint >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_SetLength(lua_State *L) {
		...
		b2DistanceJoint* self=Luna< b2Joint >::checkSubType< b2DistanceJoint >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void b2DistanceJoint::SetLength(float). Got : '%s'\n%s",typeid(Luna< b2Joint >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_GetLength(lua_State *L) {
		...
		b2DistanceJoint* self=Luna< b2Joint >::checkSubType< b2DistanceJoint >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call float b2DistanceJoint::GetLength() const. Got : '%s'\n%s",typeid(Luna< b2Joint >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_SetFrequency(lua_State *L) {
		...
		b2DistanceJoint* self=Luna< b2Joint >::checkSubType< b2DistanceJoint >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void b2DistanceJoint::SetFrequency(float). Got : '%s'\n%s",typeid(Luna< b2Joint >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_GetFrequency(lua_State *L) {
		...
		b2DistanceJoint* self=Luna< b2Joint >::checkSubType< b2DistanceJoint >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call float b2DistanceJoint::GetFrequency() const. Got : '%s'\n%s",typeid(Luna< b2Joint >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_SetDampingRatio(lua_State *L) {
		...
		b2DistanceJoint* self=Luna< b2Joint >::checkSubType< b2DistanceJoint >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void b2DistanceJoint::SetDampingRatio(float). Got : '%s'\n%s",typeid(Luna< b2Joint >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_GetDampingRatio(lua_State *L) {
		...
		b2DistanceJoint* self=Luna< b2Joint >::checkSubType< b2DistanceJoint >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call float b2DistanceJoint::GetDampingRatio() const. Got : '%s'\n%s",typeid(Luna< b2Joint >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_Dump(lua_State *L) {
		...
		b2DistanceJoint* self=Luna< b2Joint >::checkSubType< b2DistanceJoint >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void b2DistanceJoint::Dump(). Got : '%s'\n%s",typeid(Luna< b2Joint >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
		self->Dump();
	...
	static int _bind_base_GetAnchorA(lua_State *L) {
		...
		b2DistanceJoint* self=Luna< b2Joint >::checkSubType< b2DistanceJoint >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call b2Vec2 b2DistanceJoint::base_GetAnchorA() const. Got : '%s'\n%s",typeid(Luna< b2Joint >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_GetAnchorB(lua_State *L) {
		...
		b2DistanceJoint* self=Luna< b2Joint >::checkSubType< b2DistanceJoint >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call b2Vec2 b2DistanceJoint::base_GetAnchorB() const. Got : '%s'\n%s",typeid(Luna< b2Joint >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_GetReactionForce(lua_State *L) {
		...
		b2DistanceJoint* self=Luna< b2Joint >::checkSubType< b2DistanceJoint >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call b2Vec2 b2DistanceJoint::base_GetReactionForce(float) const. Got : '%s'\n%s",typeid(Luna< b2Joint >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_GetReactionTorque(lua_State *L) {
		...
		b2DistanceJoint* self=Luna< b2Joint >::checkSubType< b2DistanceJoint >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call float b2DistanceJoint::base_GetReactionTorque(float) const. Got : '%s'\n%s",typeid(Luna< b2Joint >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_Dump(lua_State *L) {
		...
		b2DistanceJoint* self=Luna< b2Joint >::checkSubType< b2DistanceJoint >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void b2DistanceJoint::base_Dump(). Got : '%s'\n%s",typeid(Luna< b2Joint >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
...
luna_RegType LunaTraits< b2DistanceJoint >::methods[] = {
	...
	{"fromVoid", &luna_wrapper_b2DistanceJoint::_bind_fromVoid},
	{"asVoid", &luna_wrapper_b2DistanceJoint::_bind_asVoid},
