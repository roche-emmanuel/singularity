...
public:
	...
	static int _bind_fromVoid(lua_State *L) {
		...
		b2FrictionJoint* self= (b2FrictionJoint*)(Luna< void >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call fromVoid(...)");
		}
		
		Luna< b2FrictionJoint >::push(L,self,false);
		return 1;
	}
	...
	static int _bind_GetAnchorA(lua_State *L) {
		...
		if(!self) {
			luaL_error(L, "Invalid object in function call b2Vec2 b2FrictionJoint::GetAnchorA() const. Got : '%s'\n%s",typeid(Luna< b2Joint >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_GetAnchorB(lua_State *L) {
		...
		b2FrictionJoint* self=Luna< b2Joint >::checkSubType< b2FrictionJoint >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call b2Vec2 b2FrictionJoint::GetAnchorB() const. Got : '%s'\n%s",typeid(Luna< b2Joint >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_GetReactionForce(lua_State *L) {
		...
		b2FrictionJoint* self=Luna< b2Joint >::checkSubType< b2FrictionJoint >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call b2Vec2 b2FrictionJoint::GetReactionForce(float) const. Got : '%s'\n%s",typeid(Luna< b2Joint >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_GetReactionTorque(lua_State *L) {
		...
		b2FrictionJoint* self=Luna< b2Joint >::checkSubType< b2FrictionJoint >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call float b2FrictionJoint::GetReactionTorque(float) const. Got : '%s'\n%s",typeid(Luna< b2Joint >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_GetLocalAnchorA(lua_State *L) {
		...
		b2FrictionJoint* self=Luna< b2Joint >::checkSubType< b2FrictionJoint >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call const b2Vec2 & b2FrictionJoint::GetLocalAnchorA() const. Got : '%s'\n%s",typeid(Luna< b2Joint >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_GetLocalAnchorB(lua_State *L) {
		...
		b2FrictionJoint* self=Luna< b2Joint >::checkSubType< b2FrictionJoint >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call const b2Vec2 & b2FrictionJoint::GetLocalAnchorB() const. Got : '%s'\n%s",typeid(Luna< b2Joint >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_SetMaxForce(lua_State *L) {
		...
		b2FrictionJoint* self=Luna< b2Joint >::checkSubType< b2FrictionJoint >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void b2FrictionJoint::SetMaxForce(float). Got : '%s'\n%s",typeid(Luna< b2Joint >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_GetMaxForce(lua_State *L) {
		...
		b2FrictionJoint* self=Luna< b2Joint >::checkSubType< b2FrictionJoint >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call float b2FrictionJoint::GetMaxForce() const. Got : '%s'\n%s",typeid(Luna< b2Joint >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_SetMaxTorque(lua_State *L) {
		...
		b2FrictionJoint* self=Luna< b2Joint >::checkSubType< b2FrictionJoint >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void b2FrictionJoint::SetMaxTorque(float). Got : '%s'\n%s",typeid(Luna< b2Joint >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_GetMaxTorque(lua_State *L) {
		...
		b2FrictionJoint* self=Luna< b2Joint >::checkSubType< b2FrictionJoint >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call float b2FrictionJoint::GetMaxTorque() const. Got : '%s'\n%s",typeid(Luna< b2Joint >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_Dump(lua_State *L) {
		...
		b2FrictionJoint* self=Luna< b2Joint >::checkSubType< b2FrictionJoint >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void b2FrictionJoint::Dump(). Got : '%s'\n%s",typeid(Luna< b2Joint >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
		self->Dump();
	...
	static int _bind_base_GetAnchorA(lua_State *L) {
		...
		b2FrictionJoint* self=Luna< b2Joint >::checkSubType< b2FrictionJoint >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call b2Vec2 b2FrictionJoint::base_GetAnchorA() const. Got : '%s'\n%s",typeid(Luna< b2Joint >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_GetAnchorB(lua_State *L) {
		...
		b2FrictionJoint* self=Luna< b2Joint >::checkSubType< b2FrictionJoint >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call b2Vec2 b2FrictionJoint::base_GetAnchorB() const. Got : '%s'\n%s",typeid(Luna< b2Joint >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_GetReactionForce(lua_State *L) {
		...
		b2FrictionJoint* self=Luna< b2Joint >::checkSubType< b2FrictionJoint >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call b2Vec2 b2FrictionJoint::base_GetReactionForce(float) const. Got : '%s'\n%s",typeid(Luna< b2Joint >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_GetReactionTorque(lua_State *L) {
		...
		b2FrictionJoint* self=Luna< b2Joint >::checkSubType< b2FrictionJoint >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call float b2FrictionJoint::base_GetReactionTorque(float) const. Got : '%s'\n%s",typeid(Luna< b2Joint >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_Dump(lua_State *L) {
		...
		b2FrictionJoint* self=Luna< b2Joint >::checkSubType< b2FrictionJoint >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void b2FrictionJoint::base_Dump(). Got : '%s'\n%s",typeid(Luna< b2Joint >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
...
luna_RegType LunaTraits< b2FrictionJoint >::methods[] = {
	...
	{"fromVoid", &luna_wrapper_b2FrictionJoint::_bind_fromVoid},
	{"asVoid", &luna_wrapper_b2FrictionJoint::_bind_asVoid},
