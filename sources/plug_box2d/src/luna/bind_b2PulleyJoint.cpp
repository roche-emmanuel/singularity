...
public:
	...
	static int _bind_GetAnchorA(lua_State *L) {
		...
		if(!self) {
			luaL_error(L, "Invalid object in function call b2Vec2 b2PulleyJoint::GetAnchorA() const. Got : '%s'\n%s",typeid(Luna< b2Joint >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_GetAnchorB(lua_State *L) {
		...
		b2PulleyJoint* self=Luna< b2Joint >::checkSubType< b2PulleyJoint >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call b2Vec2 b2PulleyJoint::GetAnchorB() const. Got : '%s'\n%s",typeid(Luna< b2Joint >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_GetReactionForce(lua_State *L) {
		...
		b2PulleyJoint* self=Luna< b2Joint >::checkSubType< b2PulleyJoint >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call b2Vec2 b2PulleyJoint::GetReactionForce(float) const. Got : '%s'\n%s",typeid(Luna< b2Joint >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_GetReactionTorque(lua_State *L) {
		...
		b2PulleyJoint* self=Luna< b2Joint >::checkSubType< b2PulleyJoint >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call float b2PulleyJoint::GetReactionTorque(float) const. Got : '%s'\n%s",typeid(Luna< b2Joint >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_GetGroundAnchorA(lua_State *L) {
		...
		b2PulleyJoint* self=Luna< b2Joint >::checkSubType< b2PulleyJoint >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call b2Vec2 b2PulleyJoint::GetGroundAnchorA() const. Got : '%s'\n%s",typeid(Luna< b2Joint >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_GetGroundAnchorB(lua_State *L) {
		...
		b2PulleyJoint* self=Luna< b2Joint >::checkSubType< b2PulleyJoint >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call b2Vec2 b2PulleyJoint::GetGroundAnchorB() const. Got : '%s'\n%s",typeid(Luna< b2Joint >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_GetLengthA(lua_State *L) {
		...
		b2PulleyJoint* self=Luna< b2Joint >::checkSubType< b2PulleyJoint >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call float b2PulleyJoint::GetLengthA() const. Got : '%s'\n%s",typeid(Luna< b2Joint >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_GetLengthB(lua_State *L) {
		...
		b2PulleyJoint* self=Luna< b2Joint >::checkSubType< b2PulleyJoint >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call float b2PulleyJoint::GetLengthB() const. Got : '%s'\n%s",typeid(Luna< b2Joint >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_GetRatio(lua_State *L) {
		...
		b2PulleyJoint* self=Luna< b2Joint >::checkSubType< b2PulleyJoint >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call float b2PulleyJoint::GetRatio() const. Got : '%s'\n%s",typeid(Luna< b2Joint >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_Dump(lua_State *L) {
		...
		b2PulleyJoint* self=Luna< b2Joint >::checkSubType< b2PulleyJoint >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void b2PulleyJoint::Dump(). Got : '%s'\n%s",typeid(Luna< b2Joint >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
		self->Dump();
	...
	static int _bind_base_GetAnchorA(lua_State *L) {
		...
		b2PulleyJoint* self=Luna< b2Joint >::checkSubType< b2PulleyJoint >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call b2Vec2 b2PulleyJoint::base_GetAnchorA() const. Got : '%s'\n%s",typeid(Luna< b2Joint >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_GetAnchorB(lua_State *L) {
		...
		b2PulleyJoint* self=Luna< b2Joint >::checkSubType< b2PulleyJoint >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call b2Vec2 b2PulleyJoint::base_GetAnchorB() const. Got : '%s'\n%s",typeid(Luna< b2Joint >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_GetReactionForce(lua_State *L) {
		...
		b2PulleyJoint* self=Luna< b2Joint >::checkSubType< b2PulleyJoint >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call b2Vec2 b2PulleyJoint::base_GetReactionForce(float) const. Got : '%s'\n%s",typeid(Luna< b2Joint >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_GetReactionTorque(lua_State *L) {
		...
		b2PulleyJoint* self=Luna< b2Joint >::checkSubType< b2PulleyJoint >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call float b2PulleyJoint::base_GetReactionTorque(float) const. Got : '%s'\n%s",typeid(Luna< b2Joint >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_Dump(lua_State *L) {
		...
		b2PulleyJoint* self=Luna< b2Joint >::checkSubType< b2PulleyJoint >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void b2PulleyJoint::base_Dump(). Got : '%s'\n%s",typeid(Luna< b2Joint >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
