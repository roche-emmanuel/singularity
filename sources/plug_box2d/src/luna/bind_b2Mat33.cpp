...
public:
	...
	static int _bind_SetZero(lua_State *L) {
		...
		if(!self) {
			luna_printStack(L);
			luaL_error(L, "Invalid object in function call void b2Mat33::SetZero(). Got : '%s'",typeid(Luna< b2Mat33 >::check(L,1)).name());
		}
		self->SetZero();
	...
	static int _bind_Solve33(lua_State *L) {
		...
		if(!self) {
			luna_printStack(L);
			luaL_error(L, "Invalid object in function call b2Vec3 b2Mat33::Solve33(const b2Vec3 &) const. Got : '%s'",typeid(Luna< b2Mat33 >::check(L,1)).name());
		}
	...
	static int _bind_Solve22(lua_State *L) {
		...
		if(!self) {
			luna_printStack(L);
			luaL_error(L, "Invalid object in function call b2Vec2 b2Mat33::Solve22(const b2Vec2 &) const. Got : '%s'",typeid(Luna< b2Mat33 >::check(L,1)).name());
		}
	...
	static int _bind_GetInverse22(lua_State *L) {
		...
		if(!self) {
			luna_printStack(L);
			luaL_error(L, "Invalid object in function call void b2Mat33::GetInverse22(b2Mat33 *) const. Got : '%s'",typeid(Luna< b2Mat33 >::check(L,1)).name());
		}
		self->GetInverse22(M);
	...
	static int _bind_GetSymInverse33(lua_State *L) {
		...
		if(!self) {
			luna_printStack(L);
			luaL_error(L, "Invalid object in function call void b2Mat33::GetSymInverse33(b2Mat33 *) const. Got : '%s'",typeid(Luna< b2Mat33 >::check(L,1)).name());
		}
	...
	static int _bind_getEx(lua_State *L) {
		...
		if(!self) {
			luna_printStack(L);
			luaL_error(L, "Invalid object in function call b2Vec3 b2Mat33::ex(). Got : '%s'",typeid(Luna< b2Mat33 >::check(L,1)).name());
		}
	...
	static int _bind_getEy(lua_State *L) {
		...
		if(!self) {
			luna_printStack(L);
			luaL_error(L, "Invalid object in function call b2Vec3 b2Mat33::ey(). Got : '%s'",typeid(Luna< b2Mat33 >::check(L,1)).name());
		}
	...
	static int _bind_getEz(lua_State *L) {
		...
		if(!self) {
			luna_printStack(L);
			luaL_error(L, "Invalid object in function call b2Vec3 b2Mat33::ez(). Got : '%s'",typeid(Luna< b2Mat33 >::check(L,1)).name());
		}
	...
	static int _bind_setEx(lua_State *L) {
		...
		if(!self) {
			luna_printStack(L);
			luaL_error(L, "Invalid object in function call void b2Mat33::ex(b2Vec3). Got : '%s'",typeid(Luna< b2Mat33 >::check(L,1)).name());
		}
		self->ex = value;
	...
	static int _bind_setEy(lua_State *L) {
		...
		if(!self) {
			luna_printStack(L);
			luaL_error(L, "Invalid object in function call void b2Mat33::ey(b2Vec3). Got : '%s'",typeid(Luna< b2Mat33 >::check(L,1)).name());
		}
		self->ey = value;
	...
	static int _bind_setEz(lua_State *L) {
		...
		if(!self) {
			luna_printStack(L);
			luaL_error(L, "Invalid object in function call void b2Mat33::ez(b2Vec3). Got : '%s'",typeid(Luna< b2Mat33 >::check(L,1)).name());
		}
		self->ez = value;
