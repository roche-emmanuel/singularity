...
public:
	...
	static int _bind_GetAnchorA(lua_State *L) {
		...
		if(!self) {
			luaL_error(L, "Invalid object in function call b2Vec2 b2WeldJoint::GetAnchorA() const. Got : '%s'\n%s",typeid(Luna< b2Joint >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_GetAnchorB(lua_State *L) {
		...
		b2WeldJoint* self=Luna< b2Joint >::checkSubType< b2WeldJoint >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call b2Vec2 b2WeldJoint::GetAnchorB() const. Got : '%s'\n%s",typeid(Luna< b2Joint >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_GetReactionForce(lua_State *L) {
		...
		b2WeldJoint* self=Luna< b2Joint >::checkSubType< b2WeldJoint >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call b2Vec2 b2WeldJoint::GetReactionForce(float) const. Got : '%s'\n%s",typeid(Luna< b2Joint >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_GetReactionTorque(lua_State *L) {
		...
		b2WeldJoint* self=Luna< b2Joint >::checkSubType< b2WeldJoint >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call float b2WeldJoint::GetReactionTorque(float) const. Got : '%s'\n%s",typeid(Luna< b2Joint >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_GetLocalAnchorA(lua_State *L) {
		...
		b2WeldJoint* self=Luna< b2Joint >::checkSubType< b2WeldJoint >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call const b2Vec2 & b2WeldJoint::GetLocalAnchorA() const. Got : '%s'\n%s",typeid(Luna< b2Joint >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_GetLocalAnchorB(lua_State *L) {
		...
		b2WeldJoint* self=Luna< b2Joint >::checkSubType< b2WeldJoint >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call const b2Vec2 & b2WeldJoint::GetLocalAnchorB() const. Got : '%s'\n%s",typeid(Luna< b2Joint >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_GetReferenceAngle(lua_State *L) {
		...
		b2WeldJoint* self=Luna< b2Joint >::checkSubType< b2WeldJoint >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call float b2WeldJoint::GetReferenceAngle() const. Got : '%s'\n%s",typeid(Luna< b2Joint >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_SetFrequency(lua_State *L) {
		...
		b2WeldJoint* self=Luna< b2Joint >::checkSubType< b2WeldJoint >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void b2WeldJoint::SetFrequency(float). Got : '%s'\n%s",typeid(Luna< b2Joint >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_GetFrequency(lua_State *L) {
		...
		b2WeldJoint* self=Luna< b2Joint >::checkSubType< b2WeldJoint >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call float b2WeldJoint::GetFrequency() const. Got : '%s'\n%s",typeid(Luna< b2Joint >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_SetDampingRatio(lua_State *L) {
		...
		b2WeldJoint* self=Luna< b2Joint >::checkSubType< b2WeldJoint >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void b2WeldJoint::SetDampingRatio(float). Got : '%s'\n%s",typeid(Luna< b2Joint >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_GetDampingRatio(lua_State *L) {
		...
		b2WeldJoint* self=Luna< b2Joint >::checkSubType< b2WeldJoint >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call float b2WeldJoint::GetDampingRatio() const. Got : '%s'\n%s",typeid(Luna< b2Joint >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_Dump(lua_State *L) {
		...
		b2WeldJoint* self=Luna< b2Joint >::checkSubType< b2WeldJoint >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void b2WeldJoint::Dump(). Got : '%s'\n%s",typeid(Luna< b2Joint >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
		self->Dump();
	...
	static int _bind_base_GetAnchorA(lua_State *L) {
		...
		b2WeldJoint* self=Luna< b2Joint >::checkSubType< b2WeldJoint >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call b2Vec2 b2WeldJoint::base_GetAnchorA() const. Got : '%s'\n%s",typeid(Luna< b2Joint >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_GetAnchorB(lua_State *L) {
		...
		b2WeldJoint* self=Luna< b2Joint >::checkSubType< b2WeldJoint >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call b2Vec2 b2WeldJoint::base_GetAnchorB() const. Got : '%s'\n%s",typeid(Luna< b2Joint >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_GetReactionForce(lua_State *L) {
		...
		b2WeldJoint* self=Luna< b2Joint >::checkSubType< b2WeldJoint >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call b2Vec2 b2WeldJoint::base_GetReactionForce(float) const. Got : '%s'\n%s",typeid(Luna< b2Joint >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_GetReactionTorque(lua_State *L) {
		...
		b2WeldJoint* self=Luna< b2Joint >::checkSubType< b2WeldJoint >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call float b2WeldJoint::base_GetReactionTorque(float) const. Got : '%s'\n%s",typeid(Luna< b2Joint >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_Dump(lua_State *L) {
		...
		b2WeldJoint* self=Luna< b2Joint >::checkSubType< b2WeldJoint >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void b2WeldJoint::base_Dump(). Got : '%s'\n%s",typeid(Luna< b2Joint >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
