...
public:
	...
	static int _bind_IsLeaf(lua_State *L) {
		...
		b2TreeNode* self=(Luna< b2TreeNode >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call bool b2TreeNode::IsLeaf() const. Got : '%s'\n%s",typeid(Luna< b2TreeNode >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_getAabb(lua_State *L) {
		...
		b2TreeNode* self=(Luna< b2TreeNode >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call b2AABB b2TreeNode::aabb(). Got : '%s'\n%s",typeid(Luna< b2TreeNode >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_getUserData(lua_State *L) {
		...
		b2TreeNode* self=(Luna< b2TreeNode >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call void * b2TreeNode::userData(). Got : '%s'\n%s",typeid(Luna< b2TreeNode >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_getParent(lua_State *L) {
		...
		b2TreeNode* self=(Luna< b2TreeNode >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call signed int b2TreeNode::parent(). Got : '%s'\n%s",typeid(Luna< b2TreeNode >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_getNext(lua_State *L) {
		...
		b2TreeNode* self=(Luna< b2TreeNode >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call signed int b2TreeNode::next(). Got : '%s'\n%s",typeid(Luna< b2TreeNode >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_getChild1(lua_State *L) {
		...
		b2TreeNode* self=(Luna< b2TreeNode >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call signed int b2TreeNode::child1(). Got : '%s'\n%s",typeid(Luna< b2TreeNode >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_getChild2(lua_State *L) {
		...
		b2TreeNode* self=(Luna< b2TreeNode >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call signed int b2TreeNode::child2(). Got : '%s'\n%s",typeid(Luna< b2TreeNode >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_getHeight(lua_State *L) {
		...
		b2TreeNode* self=(Luna< b2TreeNode >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call signed int b2TreeNode::height(). Got : '%s'\n%s",typeid(Luna< b2TreeNode >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_setAabb(lua_State *L) {
		...
		b2TreeNode* self=(Luna< b2TreeNode >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call void b2TreeNode::aabb(b2AABB). Got : '%s'\n%s",typeid(Luna< b2TreeNode >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
		self->aabb = value;
	...
	static int _bind_setUserData(lua_State *L) {
		...
		b2TreeNode* self=(Luna< b2TreeNode >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call void b2TreeNode::userData(void *). Got : '%s'\n%s",typeid(Luna< b2TreeNode >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
		self->userData = value;
	...
	static int _bind_setParent(lua_State *L) {
		...
		b2TreeNode* self=(Luna< b2TreeNode >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call void b2TreeNode::parent(signed int). Got : '%s'\n%s",typeid(Luna< b2TreeNode >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
		self->parent = value;
	...
	static int _bind_setNext(lua_State *L) {
		...
		b2TreeNode* self=(Luna< b2TreeNode >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call void b2TreeNode::next(signed int). Got : '%s'\n%s",typeid(Luna< b2TreeNode >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
		self->next = value;
	...
	static int _bind_setChild1(lua_State *L) {
		...
		b2TreeNode* self=(Luna< b2TreeNode >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call void b2TreeNode::child1(signed int). Got : '%s'\n%s",typeid(Luna< b2TreeNode >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
		self->child1 = value;
	...
	static int _bind_setChild2(lua_State *L) {
		...
		b2TreeNode* self=(Luna< b2TreeNode >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call void b2TreeNode::child2(signed int). Got : '%s'\n%s",typeid(Luna< b2TreeNode >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
		self->child2 = value;
	...
	static int _bind_setHeight(lua_State *L) {
		...
		b2TreeNode* self=(Luna< b2TreeNode >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call void b2TreeNode::height(signed int). Got : '%s'\n%s",typeid(Luna< b2TreeNode >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
		self->height = value;
