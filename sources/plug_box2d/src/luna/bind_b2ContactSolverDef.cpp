...
public:
	...
	static int _bind___eq(lua_State *L) {
		if (!_lg_typecheck___eq(L)) {
			luaL_error(L, "luna typecheck failed in __eq function, expected prototype:\n__eq(b2ContactSolverDef*). Got arguments:\n%s",luna_dumpStack(L).c_str());
		}
	...
	static int _bind_fromVoid(lua_State *L) {
		...
		b2ContactSolverDef* self= (b2ContactSolverDef*)(Luna< void >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call fromVoid(...)");
		}
		
		Luna< b2ContactSolverDef >::push(L,self,false);
		return 1;
	}
	...
	static int _bind_asVoid(lua_State *L) {
		...
		void* self= (void*)(Luna< b2ContactSolverDef >::check(L,1));
		if(!self) {
	...
	static int _bind_getStep(lua_State *L) {
		...
		b2ContactSolverDef* self=(Luna< b2ContactSolverDef >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call b2TimeStep b2ContactSolverDef::step(). Got : '%s'\n%s",typeid(Luna< b2ContactSolverDef >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_getCount(lua_State *L) {
		...
		b2ContactSolverDef* self=(Luna< b2ContactSolverDef >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call signed int b2ContactSolverDef::count(). Got : '%s'\n%s",typeid(Luna< b2ContactSolverDef >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_getPositions(lua_State *L) {
		...
		b2ContactSolverDef* self=(Luna< b2ContactSolverDef >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call b2Position * b2ContactSolverDef::positions(). Got : '%s'\n%s",typeid(Luna< b2ContactSolverDef >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_getVelocities(lua_State *L) {
		...
		b2ContactSolverDef* self=(Luna< b2ContactSolverDef >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call b2Velocity * b2ContactSolverDef::velocities(). Got : '%s'\n%s",typeid(Luna< b2ContactSolverDef >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_getAllocator(lua_State *L) {
		...
		b2ContactSolverDef* self=(Luna< b2ContactSolverDef >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call b2StackAllocator * b2ContactSolverDef::allocator(). Got : '%s'\n%s",typeid(Luna< b2ContactSolverDef >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_setStep(lua_State *L) {
		...
		b2ContactSolverDef* self=(Luna< b2ContactSolverDef >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call void b2ContactSolverDef::step(b2TimeStep). Got : '%s'\n%s",typeid(Luna< b2ContactSolverDef >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
		self->step = value;
	...
	static int _bind_setCount(lua_State *L) {
		...
		b2ContactSolverDef* self=(Luna< b2ContactSolverDef >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call void b2ContactSolverDef::count(signed int). Got : '%s'\n%s",typeid(Luna< b2ContactSolverDef >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
		self->count = value;
	...
	static int _bind_setPositions(lua_State *L) {
		...
		b2ContactSolverDef* self=(Luna< b2ContactSolverDef >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call void b2ContactSolverDef::positions(b2Position *). Got : '%s'\n%s",typeid(Luna< b2ContactSolverDef >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_setVelocities(lua_State *L) {
		...
		b2ContactSolverDef* self=(Luna< b2ContactSolverDef >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call void b2ContactSolverDef::velocities(b2Velocity *). Got : '%s'\n%s",typeid(Luna< b2ContactSolverDef >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_setAllocator(lua_State *L) {
		...
		b2ContactSolverDef* self=(Luna< b2ContactSolverDef >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call void b2ContactSolverDef::allocator(b2StackAllocator *). Got : '%s'\n%s",typeid(Luna< b2ContactSolverDef >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
...
luna_RegType LunaTraits< b2ContactSolverDef >::methods[] = {
	...
	{"fromVoid", &luna_wrapper_b2ContactSolverDef::_bind_fromVoid},
	{"asVoid", &luna_wrapper_b2ContactSolverDef::_bind_asVoid},
	{0,0}
};
