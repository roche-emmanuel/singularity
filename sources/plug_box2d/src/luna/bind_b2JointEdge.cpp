...
public:
	...
	static int _bind___eq(lua_State *L) {
		if (!_lg_typecheck___eq(L)) {
			luaL_error(L, "luna typecheck failed in __eq function, expected prototype:\n__eq(b2JointEdge*). Got arguments:\n%s",luna_dumpStack(L).c_str());
		}
	...
	static int _bind_fromVoid(lua_State *L) {
		...
		b2JointEdge* self= (b2JointEdge*)(Luna< void >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call fromVoid(...)");
		}
		
		Luna< b2JointEdge >::push(L,self,false);
		return 1;
	}
	...
	static int _bind_asVoid(lua_State *L) {
		...
		void* self= (void*)(Luna< b2JointEdge >::check(L,1));
		if(!self) {
	...
	static int _bind_getOther(lua_State *L) {
		...
		b2JointEdge* self=(Luna< b2JointEdge >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call b2Body * b2JointEdge::other(). Got : '%s'\n%s",typeid(Luna< b2JointEdge >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_getJoint(lua_State *L) {
		...
		b2JointEdge* self=(Luna< b2JointEdge >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call b2Joint * b2JointEdge::joint(). Got : '%s'\n%s",typeid(Luna< b2JointEdge >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_getPrev(lua_State *L) {
		...
		b2JointEdge* self=(Luna< b2JointEdge >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call b2JointEdge * b2JointEdge::prev(). Got : '%s'\n%s",typeid(Luna< b2JointEdge >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_getNext(lua_State *L) {
		...
		b2JointEdge* self=(Luna< b2JointEdge >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call b2JointEdge * b2JointEdge::next(). Got : '%s'\n%s",typeid(Luna< b2JointEdge >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_setOther(lua_State *L) {
		...
		b2JointEdge* self=(Luna< b2JointEdge >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call void b2JointEdge::other(b2Body *). Got : '%s'\n%s",typeid(Luna< b2JointEdge >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
		self->other = value;
	...
	static int _bind_setJoint(lua_State *L) {
		...
		b2JointEdge* self=(Luna< b2JointEdge >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call void b2JointEdge::joint(b2Joint *). Got : '%s'\n%s",typeid(Luna< b2JointEdge >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
		self->joint = value;
	...
	static int _bind_setPrev(lua_State *L) {
		...
		b2JointEdge* self=(Luna< b2JointEdge >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call void b2JointEdge::prev(b2JointEdge *). Got : '%s'\n%s",typeid(Luna< b2JointEdge >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
		self->prev = value;
	...
	static int _bind_setNext(lua_State *L) {
		...
		b2JointEdge* self=(Luna< b2JointEdge >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call void b2JointEdge::next(b2JointEdge *). Got : '%s'\n%s",typeid(Luna< b2JointEdge >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
		self->next = value;
...
luna_RegType LunaTraits< b2JointEdge >::methods[] = {
	...
	{"fromVoid", &luna_wrapper_b2JointEdge::_bind_fromVoid},
	{"asVoid", &luna_wrapper_b2JointEdge::_bind_asVoid},
	{0,0}
};
