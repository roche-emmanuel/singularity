...
public:
	...
	static int _bind_Initialize(lua_State *L) {
		...
		if(!self) {
			luna_printStack(L);
			luaL_error(L, "Invalid object in function call void b2PrismaticJointDef::Initialize(b2Body *, b2Body *, const b2Vec2 &, const b2Vec2 &). Got : '%s'",typeid(Luna< b2JointDef >::check(L,1)).name());
		}
	...
	static int _bind_getLocalAnchorA(lua_State *L) {
		...
		if(!self) {
			luna_printStack(L);
			luaL_error(L, "Invalid object in function call b2Vec2 b2PrismaticJointDef::localAnchorA(). Got : '%s'",typeid(Luna< b2JointDef >::check(L,1)).name());
		}
	...
	static int _bind_getLocalAnchorB(lua_State *L) {
		...
		if(!self) {
			luna_printStack(L);
			luaL_error(L, "Invalid object in function call b2Vec2 b2PrismaticJointDef::localAnchorB(). Got : '%s'",typeid(Luna< b2JointDef >::check(L,1)).name());
		}
	...
	static int _bind_getLocalAxisA(lua_State *L) {
		...
		if(!self) {
			luna_printStack(L);
			luaL_error(L, "Invalid object in function call b2Vec2 b2PrismaticJointDef::localAxisA(). Got : '%s'",typeid(Luna< b2JointDef >::check(L,1)).name());
		}
	...
	static int _bind_getReferenceAngle(lua_State *L) {
		...
		if(!self) {
			luna_printStack(L);
			luaL_error(L, "Invalid object in function call float b2PrismaticJointDef::referenceAngle(). Got : '%s'",typeid(Luna< b2JointDef >::check(L,1)).name());
		}
	...
	static int _bind_getEnableLimit(lua_State *L) {
		...
		if(!self) {
			luna_printStack(L);
			luaL_error(L, "Invalid object in function call bool b2PrismaticJointDef::enableLimit(). Got : '%s'",typeid(Luna< b2JointDef >::check(L,1)).name());
		}
	...
	static int _bind_getLowerTranslation(lua_State *L) {
		...
		if(!self) {
			luna_printStack(L);
			luaL_error(L, "Invalid object in function call float b2PrismaticJointDef::lowerTranslation(). Got : '%s'",typeid(Luna< b2JointDef >::check(L,1)).name());
		}
	...
	static int _bind_getUpperTranslation(lua_State *L) {
		...
		if(!self) {
			luna_printStack(L);
			luaL_error(L, "Invalid object in function call float b2PrismaticJointDef::upperTranslation(). Got : '%s'",typeid(Luna< b2JointDef >::check(L,1)).name());
		}
	...
	static int _bind_getEnableMotor(lua_State *L) {
		...
		if(!self) {
			luna_printStack(L);
			luaL_error(L, "Invalid object in function call bool b2PrismaticJointDef::enableMotor(). Got : '%s'",typeid(Luna< b2JointDef >::check(L,1)).name());
		}
	...
	static int _bind_getMaxMotorForce(lua_State *L) {
		...
		if(!self) {
			luna_printStack(L);
			luaL_error(L, "Invalid object in function call float b2PrismaticJointDef::maxMotorForce(). Got : '%s'",typeid(Luna< b2JointDef >::check(L,1)).name());
		}
	...
	static int _bind_getMotorSpeed(lua_State *L) {
		...
		if(!self) {
			luna_printStack(L);
			luaL_error(L, "Invalid object in function call float b2PrismaticJointDef::motorSpeed(). Got : '%s'",typeid(Luna< b2JointDef >::check(L,1)).name());
		}
	...
	static int _bind_setLocalAnchorA(lua_State *L) {
		...
		if(!self) {
			luna_printStack(L);
			luaL_error(L, "Invalid object in function call void b2PrismaticJointDef::localAnchorA(b2Vec2). Got : '%s'",typeid(Luna< b2JointDef >::check(L,1)).name());
		}
	...
	static int _bind_setLocalAnchorB(lua_State *L) {
		...
		if(!self) {
			luna_printStack(L);
			luaL_error(L, "Invalid object in function call void b2PrismaticJointDef::localAnchorB(b2Vec2). Got : '%s'",typeid(Luna< b2JointDef >::check(L,1)).name());
		}
	...
	static int _bind_setLocalAxisA(lua_State *L) {
		...
		if(!self) {
			luna_printStack(L);
			luaL_error(L, "Invalid object in function call void b2PrismaticJointDef::localAxisA(b2Vec2). Got : '%s'",typeid(Luna< b2JointDef >::check(L,1)).name());
		}
	...
	static int _bind_setReferenceAngle(lua_State *L) {
		...
		if(!self) {
			luna_printStack(L);
			luaL_error(L, "Invalid object in function call void b2PrismaticJointDef::referenceAngle(float). Got : '%s'",typeid(Luna< b2JointDef >::check(L,1)).name());
		}
	...
	static int _bind_setEnableLimit(lua_State *L) {
		...
		if(!self) {
			luna_printStack(L);
			luaL_error(L, "Invalid object in function call void b2PrismaticJointDef::enableLimit(bool). Got : '%s'",typeid(Luna< b2JointDef >::check(L,1)).name());
		}
	...
	static int _bind_setLowerTranslation(lua_State *L) {
		...
		if(!self) {
			luna_printStack(L);
			luaL_error(L, "Invalid object in function call void b2PrismaticJointDef::lowerTranslation(float). Got : '%s'",typeid(Luna< b2JointDef >::check(L,1)).name());
		}
	...
	static int _bind_setUpperTranslation(lua_State *L) {
		...
		if(!self) {
			luna_printStack(L);
			luaL_error(L, "Invalid object in function call void b2PrismaticJointDef::upperTranslation(float). Got : '%s'",typeid(Luna< b2JointDef >::check(L,1)).name());
		}
	...
	static int _bind_setEnableMotor(lua_State *L) {
		...
		if(!self) {
			luna_printStack(L);
			luaL_error(L, "Invalid object in function call void b2PrismaticJointDef::enableMotor(bool). Got : '%s'",typeid(Luna< b2JointDef >::check(L,1)).name());
		}
	...
	static int _bind_setMaxMotorForce(lua_State *L) {
		...
		if(!self) {
			luna_printStack(L);
			luaL_error(L, "Invalid object in function call void b2PrismaticJointDef::maxMotorForce(float). Got : '%s'",typeid(Luna< b2JointDef >::check(L,1)).name());
		}
	...
	static int _bind_setMotorSpeed(lua_State *L) {
		...
		if(!self) {
			luna_printStack(L);
			luaL_error(L, "Invalid object in function call void b2PrismaticJointDef::motorSpeed(float). Got : '%s'",typeid(Luna< b2JointDef >::check(L,1)).name());
		}
