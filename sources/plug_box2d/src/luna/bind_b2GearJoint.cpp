...
public:
	...
	static int _bind_fromVoid(lua_State *L) {
		...
		b2GearJoint* self= (b2GearJoint*)(Luna< void >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call fromVoid(...)");
		}
		
		Luna< b2GearJoint >::push(L,self,false);
		return 1;
	}
	...
	static int _bind_GetAnchorA(lua_State *L) {
		...
		if(!self) {
			luaL_error(L, "Invalid object in function call b2Vec2 b2GearJoint::GetAnchorA() const. Got : '%s'\n%s",typeid(Luna< b2Joint >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_GetAnchorB(lua_State *L) {
		...
		b2GearJoint* self=Luna< b2Joint >::checkSubType< b2GearJoint >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call b2Vec2 b2GearJoint::GetAnchorB() const. Got : '%s'\n%s",typeid(Luna< b2Joint >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_GetReactionForce(lua_State *L) {
		...
		b2GearJoint* self=Luna< b2Joint >::checkSubType< b2GearJoint >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call b2Vec2 b2GearJoint::GetReactionForce(float) const. Got : '%s'\n%s",typeid(Luna< b2Joint >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_GetReactionTorque(lua_State *L) {
		...
		b2GearJoint* self=Luna< b2Joint >::checkSubType< b2GearJoint >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call float b2GearJoint::GetReactionTorque(float) const. Got : '%s'\n%s",typeid(Luna< b2Joint >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_GetJoint1(lua_State *L) {
		...
		b2GearJoint* self=Luna< b2Joint >::checkSubType< b2GearJoint >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call b2Joint * b2GearJoint::GetJoint1(). Got : '%s'\n%s",typeid(Luna< b2Joint >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_GetJoint2(lua_State *L) {
		...
		b2GearJoint* self=Luna< b2Joint >::checkSubType< b2GearJoint >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call b2Joint * b2GearJoint::GetJoint2(). Got : '%s'\n%s",typeid(Luna< b2Joint >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_SetRatio(lua_State *L) {
		...
		b2GearJoint* self=Luna< b2Joint >::checkSubType< b2GearJoint >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void b2GearJoint::SetRatio(float). Got : '%s'\n%s",typeid(Luna< b2Joint >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
		self->SetRatio(ratio);
	...
	static int _bind_GetRatio(lua_State *L) {
		...
		b2GearJoint* self=Luna< b2Joint >::checkSubType< b2GearJoint >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call float b2GearJoint::GetRatio() const. Got : '%s'\n%s",typeid(Luna< b2Joint >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_Dump(lua_State *L) {
		...
		b2GearJoint* self=Luna< b2Joint >::checkSubType< b2GearJoint >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void b2GearJoint::Dump(). Got : '%s'\n%s",typeid(Luna< b2Joint >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
		self->Dump();
	...
	static int _bind_base_GetAnchorA(lua_State *L) {
		...
		b2GearJoint* self=Luna< b2Joint >::checkSubType< b2GearJoint >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call b2Vec2 b2GearJoint::base_GetAnchorA() const. Got : '%s'\n%s",typeid(Luna< b2Joint >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_GetAnchorB(lua_State *L) {
		...
		b2GearJoint* self=Luna< b2Joint >::checkSubType< b2GearJoint >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call b2Vec2 b2GearJoint::base_GetAnchorB() const. Got : '%s'\n%s",typeid(Luna< b2Joint >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_GetReactionForce(lua_State *L) {
		...
		b2GearJoint* self=Luna< b2Joint >::checkSubType< b2GearJoint >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call b2Vec2 b2GearJoint::base_GetReactionForce(float) const. Got : '%s'\n%s",typeid(Luna< b2Joint >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_GetReactionTorque(lua_State *L) {
		...
		b2GearJoint* self=Luna< b2Joint >::checkSubType< b2GearJoint >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call float b2GearJoint::base_GetReactionTorque(float) const. Got : '%s'\n%s",typeid(Luna< b2Joint >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_Dump(lua_State *L) {
		...
		b2GearJoint* self=Luna< b2Joint >::checkSubType< b2GearJoint >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void b2GearJoint::base_Dump(). Got : '%s'\n%s",typeid(Luna< b2Joint >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
...
luna_RegType LunaTraits< b2GearJoint >::methods[] = {
	...
	{"fromVoid", &luna_wrapper_b2GearJoint::_bind_fromVoid},
	{"asVoid", &luna_wrapper_b2GearJoint::_bind_asVoid},
