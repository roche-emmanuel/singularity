...
public:
	...
	static int _bind_fromVoid(lua_State *L) {
		...
		b2CircleContact* self= (b2CircleContact*)(Luna< void >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call fromVoid(...)");
		}
		
		Luna< b2CircleContact >::push(L,self,false);
		return 1;
	}
	...
	static int _bind_Evaluate(lua_State *L) {
		...
		if(!self) {
			luaL_error(L, "Invalid object in function call void b2CircleContact::Evaluate(b2Manifold *, const b2Transform &, const b2Transform &). Got : '%s'\n%s",typeid(Luna< b2Contact >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_Evaluate(lua_State *L) {
		...
		b2CircleContact* self=Luna< b2Contact >::checkSubType< b2CircleContact >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void b2CircleContact::base_Evaluate(b2Manifold *, const b2Transform &, const b2Transform &). Got : '%s'\n%s",typeid(Luna< b2Contact >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
...
luna_RegType LunaTraits< b2CircleContact >::methods[] = {
	...
	{"fromVoid", &luna_wrapper_b2CircleContact::_bind_fromVoid},
	{"asVoid", &luna_wrapper_b2CircleContact::_bind_asVoid},
