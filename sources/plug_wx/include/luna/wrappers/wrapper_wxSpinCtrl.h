...
class wrapper_wxSpinCtrl : public wxSpinCtrl {
protected:
	sgt::LuaObject _obj;
...
public:
	...
	bool SetBackgroundColour(const wxColour & colour) {
		...
		return wxSpinCtrl::SetBackgroundColour(colour);
	};
	...
	bool SetForegroundColour(const wxColour & colour) {
		...
		return wxSpinCtrl::SetForegroundColour(colour);
	};
