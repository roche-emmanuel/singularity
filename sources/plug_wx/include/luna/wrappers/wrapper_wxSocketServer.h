...
class wrapper_wxSocketServer : public wxSocketServer {
protected:
	sgt::LuaObject _obj;
...
public:
	...
	wrapper_wxSocketServer(lua_State* L, lua_Table* dum, const wxSockAddress & address, int flags = ::wxSOCKET_NONE) : wxSocketServer(address, flags), _obj(L,-1) {};
