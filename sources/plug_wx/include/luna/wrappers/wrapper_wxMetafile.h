...
public:
	...
	wrapper_wxMetafile(lua_State* L, lua_Table* dum, const wxString & filename = wxEmptyString) : wxMetafile(filename), luna_wrapper_base(L) { register_protected_methods(L); };
