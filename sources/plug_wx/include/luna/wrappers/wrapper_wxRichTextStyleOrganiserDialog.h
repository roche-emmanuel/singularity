...
public:
	...
	~wrapper_wxRichTextStyleOrganiserDialog() {
		...
		if(_obj.pushFunction("delete")) {
			//_obj.pushArg((wxRichTextStyleOrganiserDialog*)this); // No this argument or the object will be referenced again!
...
protected:
	...
	wxObjectRefData * CreateRefData() const {
		if(_obj.pushFunction("CreateRefData")) {
			_obj.pushArg((wxRichTextStyleOrganiserDialog*)this);
