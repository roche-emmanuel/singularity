...
public:
	...
	wrapper_wxClipboardTextEvent(lua_State* L, lua_Table* dum, int commandType = wxEVT_NULL, int id = 0) : wxClipboardTextEvent(commandType, id), luna_wrapper_base(L) { register_protected_methods(L); };
