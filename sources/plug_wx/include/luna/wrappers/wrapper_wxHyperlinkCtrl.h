...
class wrapper_wxHyperlinkCtrl : public wxHyperlinkCtrl {
protected:
	sgt::LuaObject _obj;
...
public:
	...
	bool SetBackgroundColour(const wxColour & colour) {
		...
		return wxHyperlinkCtrl::SetBackgroundColour(colour);
	};
	...
	bool SetForegroundColour(const wxColour & colour) {
		...
		return wxHyperlinkCtrl::SetForegroundColour(colour);
	};
