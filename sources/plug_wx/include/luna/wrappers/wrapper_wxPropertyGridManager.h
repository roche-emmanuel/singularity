...
class wrapper_wxPropertyGridManager : public wxPropertyGridManager, public luna_wrapper_base {
...
public:
	...
	~wrapper_wxPropertyGridManager() {
		...
		if(_obj.pushFunction("delete")) {
			//_obj.pushArg((wxPropertyGridManager*)this); // No this argument or the object will be referenced again!
...
protected:
	...
	wxObjectRefData * CreateRefData() const {
		if(_obj.pushFunction("CreateRefData")) {
			_obj.pushArg((wxPropertyGridManager*)this);
