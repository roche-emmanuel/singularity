...
public:
	...
	wrapper_wxDataViewTreeCtrl(lua_State* L, lua_Table* dum) : wxDataViewTreeCtrl(), luna_wrapper_base(L) { register_protected_methods(L); };
	wrapper_wxDataViewTreeCtrl(lua_State* L, lua_Table* dum, wxWindow * parent, int id, const wxPoint & pos = wxDefaultPosition, const wxSize & size = wxDefaultSize, long style = 0x0002|0x0010, const wxValidator & validator = wxDefaultValidator) : wxDataViewTreeCtrl(parent, id, pos, size, style, validator), luna_wrapper_base(L) { register_protected_methods(L); };
