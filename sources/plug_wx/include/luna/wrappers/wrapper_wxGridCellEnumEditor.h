...
class wrapper_wxGridCellEnumEditor : public wxGridCellEnumEditor {
protected:
	sgt::LuaObject _obj;
...
public:
	...
	wrapper_wxGridCellEnumEditor(lua_State* L, lua_Table* dum, const wxString & choices = wxEmptyString) : wxGridCellEnumEditor(choices), _obj(L,-1) {};
