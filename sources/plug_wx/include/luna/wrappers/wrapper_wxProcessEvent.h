...
public:
	...
	wrapper_wxProcessEvent(lua_State* L, lua_Table* dum, int id = 0, int pid = 0, int exitcode = 0) : wxProcessEvent(id, pid, exitcode), luna_wrapper_base(L) { register_protected_methods(L); };
