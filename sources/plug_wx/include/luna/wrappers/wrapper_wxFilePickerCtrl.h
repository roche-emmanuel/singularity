...
class wrapper_wxFilePickerCtrl : public wxFilePickerCtrl {
protected:
	sgt::LuaObject _obj;
...
public:
	...
	bool SetBackgroundColour(const wxColour & colour) {
		...
		return wxFilePickerCtrl::SetBackgroundColour(colour);
	};
	...
	bool SetForegroundColour(const wxColour & colour) {
		...
		return wxFilePickerCtrl::SetForegroundColour(colour);
	};
