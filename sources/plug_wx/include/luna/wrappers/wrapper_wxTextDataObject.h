...
class wrapper_wxTextDataObject : public wxTextDataObject {
protected:
	sgt::LuaObject _obj;
...
public:
	...
	wrapper_wxTextDataObject(lua_State* L, lua_Table* dum, const wxString & text = wxEmptyString) : wxTextDataObject(text), _obj(L,-1) {};
