...
class wrapper_wxDataViewCtrl : public wxDataViewCtrl {
protected:
	sgt::LuaObject _obj;
...
public:
	...
	wrapper_wxDataViewCtrl(lua_State* L, lua_Table* dum) : wxDataViewCtrl(), _obj(L,-1) {};
	wrapper_wxDataViewCtrl(lua_State* L, lua_Table* dum, wxWindow * parent, int id, const wxPoint & pos = wxDefaultPosition, const wxSize & size = wxDefaultSize, long style = 0, const wxValidator & validator = wxDefaultValidator, const wxString & name = wxDataViewCtrlNameStr) : wxDataViewCtrl(parent, id, pos, size, style, validator, name), _obj(L,-1) {};
	...
	bool SetBackgroundColour(const wxColour & colour) {
		...
		return wxDataViewCtrl::SetBackgroundColour(colour);
	};
	...
	bool SetForegroundColour(const wxColour & colour) {
		...
		return wxDataViewCtrl::SetForegroundColour(colour);
	};
