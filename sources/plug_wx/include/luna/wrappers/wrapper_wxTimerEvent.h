...
public:
	...
	wrapper_wxTimerEvent(lua_State* L, lua_Table* dum) : wxTimerEvent(), luna_wrapper_base(L) { register_protected_methods(L); };
	wrapper_wxTimerEvent(lua_State* L, lua_Table* dum, wxTimer & timer) : wxTimerEvent(timer), luna_wrapper_base(L) { register_protected_methods(L); };
