...
public:
	...
	wrapper_wxDataViewBitmapRenderer(lua_State* L, lua_Table* dum, const wxString & varianttype = "wxBitmap", wxDataViewCellMode mode = ::wxDATAVIEW_CELL_INERT, int align = -1) : wxDataViewBitmapRenderer(varianttype, mode, align), luna_wrapper_base(L) { register_protected_methods(L); };
