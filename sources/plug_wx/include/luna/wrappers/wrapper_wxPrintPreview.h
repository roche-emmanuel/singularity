...
public:
	...
	~wrapper_wxPrintPreview() {
		logDEBUG3("Calling delete function for wrapper wxPrintPreview");
		if(_obj.pushFunction("delete")) {
			//_obj.pushArg((wxPrintPreview*)this); // No this argument or the object will be referenced again!
...
protected:
	...
	wxObjectRefData * CreateRefData() const {
		if(_obj.pushFunction("CreateRefData")) {
			_obj.pushArg((wxPrintPreview*)this);
