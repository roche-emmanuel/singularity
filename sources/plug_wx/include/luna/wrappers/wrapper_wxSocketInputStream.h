...
class wrapper_wxSocketInputStream : public wxSocketInputStream {
protected:
	sgt::LuaObject _obj;
...
public:
	...
	wrapper_wxSocketInputStream(lua_State* L, lua_Table* dum, wxSocketBase & s) : wxSocketInputStream(s), _obj(L,-1) {};
