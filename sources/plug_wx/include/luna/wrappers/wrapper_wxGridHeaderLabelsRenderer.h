...
class wrapper_wxGridHeaderLabelsRenderer : public wxGridHeaderLabelsRenderer {
protected:
	sgt::LuaObject _obj;
...
public:
	...
	wrapper_wxGridHeaderLabelsRenderer(lua_State* L, lua_Table* dum) : wxGridHeaderLabelsRenderer(), _obj(L,-1) {};
