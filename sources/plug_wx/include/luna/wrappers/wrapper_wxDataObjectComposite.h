...
class wrapper_wxDataObjectComposite : public wxDataObjectComposite {
protected:
	sgt::LuaObject _obj;
...
public:
	...
	wrapper_wxDataObjectComposite(lua_State* L, lua_Table* dum) : wxDataObjectComposite(), _obj(L,-1) {};
