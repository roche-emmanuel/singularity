...
class wrapper_wxNotifyEvent : public wxNotifyEvent {
protected:
	sgt::LuaObject _obj;
...
public:
	...
	wrapper_wxNotifyEvent(lua_State* L, lua_Table* dum, int eventType = wxEVT_NULL, int id = 0) : wxNotifyEvent(eventType, id), _obj(L,-1) {};
