...
public:
	...
	wrapper_wxNotifyEvent(lua_State* L, lua_Table* dum, int eventType = wxEVT_NULL, int id = 0) : wxNotifyEvent(eventType, id), luna_wrapper_base(L) { register_protected_methods(L); };
