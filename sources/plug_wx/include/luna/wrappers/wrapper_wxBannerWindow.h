...
class wrapper_wxBannerWindow : public wxBannerWindow {
protected:
	sgt::LuaObject _obj;
...
public:
	...
	wrapper_wxBannerWindow(lua_State* L, lua_Table* dum) : wxBannerWindow(), _obj(L,-1) {};
	wrapper_wxBannerWindow(lua_State* L, lua_Table* dum, wxWindow * parent, wxDirection dir = ::wxLEFT) : wxBannerWindow(parent, dir), _obj(L,-1) {};
	wrapper_wxBannerWindow(lua_State* L, lua_Table* dum, wxWindow * parent, int winid, wxDirection dir = ::wxLEFT, const wxPoint & pos = wxDefaultPosition, const wxSize & size = wxDefaultSize, long style = 0, const wxString & name = wxBannerWindowNameStr) : wxBannerWindow(parent, winid, dir, pos, size, style, name), _obj(L,-1) {};
