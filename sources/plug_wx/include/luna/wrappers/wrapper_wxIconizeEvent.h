...
public:
	...
	wrapper_wxIconizeEvent(lua_State* L, lua_Table* dum, int id = 0, bool iconized = true) : wxIconizeEvent(id, iconized), luna_wrapper_base(L) { register_protected_methods(L); };
