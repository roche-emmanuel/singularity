...
public:
	...
	wrapper_wxActivateEvent(lua_State* L, lua_Table* dum, int eventType = wxEVT_NULL, bool active = true, int id = 0) : wxActivateEvent(eventType, active, id), luna_wrapper_base(L) {};
