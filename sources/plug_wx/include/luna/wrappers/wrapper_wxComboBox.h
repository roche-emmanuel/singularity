...
class wrapper_wxComboBox : public wxComboBox {
protected:
	sgt::LuaObject _obj;
...
public:
	...
	wrapper_wxComboBox(lua_State* L, lua_Table* dum) : wxComboBox(), _obj(L,-1) {};
	wrapper_wxComboBox(lua_State* L, lua_Table* dum, wxWindow * parent, int id, const wxString & value, const wxPoint & pos, const wxSize & size, const wxArrayString & choices, long style = 0, const wxValidator & validator = wxDefaultValidator, const wxString & name = wxComboBoxNameStr) : wxComboBox(parent, id, value, pos, size, choices, style, validator, name), _obj(L,-1) {};
	...
	bool SetBackgroundColour(const wxColour & colour) {
		...
		return wxComboBox::SetBackgroundColour(colour);
	};
	...
	bool SetForegroundColour(const wxColour & colour) {
		...
		return wxComboBox::SetForegroundColour(colour);
	};
