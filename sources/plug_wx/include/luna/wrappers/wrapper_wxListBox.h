...
public:
	...
	wrapper_wxListBox(lua_State* L, lua_Table* dum) : wxListBox(), luna_wrapper_base(L) { register_protected_methods(L); };
	wrapper_wxListBox(lua_State* L, lua_Table* dum, wxWindow * parent, int id, const wxPoint & pos, const wxSize & size, const wxArrayString & choices, long style = 0, const wxValidator & validator = wxDefaultValidator, const wxString & name = wxListBoxNameStr) : wxListBox(parent, id, pos, size, choices, style, validator, name), luna_wrapper_base(L) { register_protected_methods(L); };
