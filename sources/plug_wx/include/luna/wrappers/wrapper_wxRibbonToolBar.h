...
public:
	...
	wxRibbonToolBarToolBase * AddTool(int tool_id, const wxBitmap & bitmap, const wxString & help_string, wxRibbonButtonKind kind = ::wxRIBBON_BUTTON_NORMAL) {
		if(_obj.pushFunction("AddTool")) {
			_obj.pushArg(tool_id);
			_obj.pushArg(&bitmap);
			_obj.pushArg(help_string);
			_obj.pushArg(kind);
			return (_obj.callFunction<wxRibbonToolBarToolBase*>());
		}

		return wxRibbonToolBar::AddTool(tool_id, bitmap, help_string, kind);
	};
	...
	wxRibbonToolBarToolBase * AddDropdownTool(int tool_id, const wxBitmap & bitmap, const wxString & help_string = wxEmptyString) {
		if(_obj.pushFunction("AddDropdownTool")) {
			_obj.pushArg(tool_id);
			_obj.pushArg(&bitmap);
			_obj.pushArg(help_string);
			return (_obj.callFunction<wxRibbonToolBarToolBase*>());
		...
		return wxRibbonToolBar::AddDropdownTool(tool_id, bitmap, help_string);
	};
	...
	wxRibbonToolBarToolBase * AddHybridTool(int tool_id, const wxBitmap & bitmap, const wxString & help_string = wxEmptyString) {
		if(_obj.pushFunction("AddHybridTool")) {
			_obj.pushArg(tool_id);
			_obj.pushArg(&bitmap);
			_obj.pushArg(help_string);
			return (_obj.callFunction<wxRibbonToolBarToolBase*>());
		...
		return wxRibbonToolBar::AddHybridTool(tool_id, bitmap, help_string);
	};
	...
	wxRibbonToolBarToolBase * AddTool(int tool_id, const wxBitmap & bitmap, const wxBitmap & bitmap_disabled = wxNullBitmap, const wxString & help_string = wxEmptyString, wxRibbonButtonKind kind = ::wxRIBBON_BUTTON_NORMAL, wxObject * client_data = NULL) {
		if(_obj.pushFunction("AddTool")) {
			_obj.pushArg(tool_id);
			_obj.pushArg(&bitmap);
		...
		return wxRibbonToolBar::AddTool(tool_id, bitmap, bitmap_disabled, help_string, kind, client_data);
	};
	...
	wxRibbonToolBarToolBase * AddSeparator() {
		...
		return wxRibbonToolBar::AddSeparator();
	};
