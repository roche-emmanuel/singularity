...
public:
	...
	wrapper_wxTarEntry(lua_State* L, lua_Table* dum, const wxString & name = wxEmptyString, const wxDateTime & dt = wxDateTime::Now (), long long size = wxInvalidOffset) : wxTarEntry(name, dt, size), _obj(L,-1) {};
