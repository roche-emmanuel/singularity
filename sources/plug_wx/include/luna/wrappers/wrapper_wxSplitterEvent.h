...
public:
	...
	wrapper_wxSplitterEvent(lua_State* L, lua_Table* dum, int eventType = wxEVT_NULL, wxSplitterWindow * splitter = NULL) : wxSplitterEvent(eventType, splitter), luna_wrapper_base(L) { register_protected_methods(L); };
