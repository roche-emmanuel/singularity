...
class wrapper_wxGridCellBoolRenderer : public wxGridCellBoolRenderer {
protected:
	sgt::LuaObject _obj;
...
public:
	...
	wrapper_wxGridCellBoolRenderer(lua_State* L, lua_Table* dum) : wxGridCellBoolRenderer(), _obj(L,-1) {};
