...
public:
	...
	wrapper_wxMenuEvent(lua_State* L, lua_Table* dum, int type = wxEVT_NULL, int id = 0, wxMenu * menu = NULL) : wxMenuEvent(type, id, menu), luna_wrapper_base(L) { register_protected_methods(L); };
