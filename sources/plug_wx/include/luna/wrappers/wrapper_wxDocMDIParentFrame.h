...
public:
	...
	bool HasTransparentBackground() {
		...
		return wxDocMDIParentFrame::HasTransparentBackground();
	};
	...
	bool SetBackgroundColour(const wxColour & colour) {
		...
		return wxDocMDIParentFrame::SetBackgroundColour(colour);
	};
	...
	bool SetForegroundColour(const wxColour & colour) {
		...
		return wxDocMDIParentFrame::SetForegroundColour(colour);
	};
