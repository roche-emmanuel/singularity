...
class wrapper_wxDirPickerCtrl : public wxDirPickerCtrl {
protected:
	sgt::LuaObject _obj;
...
public:
	...
	bool SetBackgroundColour(const wxColour & colour) {
		...
		return wxDirPickerCtrl::SetBackgroundColour(colour);
	};
	...
	bool SetForegroundColour(const wxColour & colour) {
		...
		return wxDirPickerCtrl::SetForegroundColour(colour);
	};
