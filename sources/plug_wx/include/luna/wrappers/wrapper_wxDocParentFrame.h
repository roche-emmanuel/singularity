...
public:
	...
	wrapper_wxDocParentFrame(lua_State* L, lua_Table* dum) : wxDocParentFrame(), luna_wrapper_base(L) { register_protected_methods(L); };
	wrapper_wxDocParentFrame(lua_State* L, lua_Table* dum, wxDocManager * manager, wxFrame * parent, int id, const wxString & title, const wxPoint & pos = wxDefaultPosition, const wxSize & size = wxDefaultSize, long style = wxDEFAULT_FRAME_STYLE, const wxString & name = wxFrameNameStr) : wxDocParentFrame(manager, parent, id, title, pos, size, style, name), luna_wrapper_base(L) { register_protected_methods(L); };
