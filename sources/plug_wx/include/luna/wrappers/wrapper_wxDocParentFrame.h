...
class wrapper_wxDocParentFrame : public wxDocParentFrame {
protected:
	sgt::LuaObject _obj;
...
public:
	...
	bool HasTransparentBackground() {
		...
		return wxDocParentFrame::HasTransparentBackground();
	};
	...
	bool SetBackgroundColour(const wxColour & colour) {
		...
		return wxDocParentFrame::SetBackgroundColour(colour);
	};
	...
	bool SetForegroundColour(const wxColour & colour) {
		...
		return wxDocParentFrame::SetForegroundColour(colour);
	};
