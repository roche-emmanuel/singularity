...
public:
	...
	wrapper_wxCloseEvent(lua_State* L, lua_Table* dum, int commandEventType = wxEVT_NULL, int id = 0) : wxCloseEvent(commandEventType, id), luna_wrapper_base(L) { register_protected_methods(L); };
