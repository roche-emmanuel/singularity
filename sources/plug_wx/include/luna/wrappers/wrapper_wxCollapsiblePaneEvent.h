...
public:
	...
	wrapper_wxCollapsiblePaneEvent(lua_State* L, lua_Table* dum, wxObject * generator, int id, bool collapsed) : wxCollapsiblePaneEvent(generator, id, collapsed), luna_wrapper_base(L) { register_protected_methods(L); };
