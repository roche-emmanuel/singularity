...
public:
	...
	wrapper_wxPropertyGridEvent(lua_State* L, lua_Table* dum, int commandType = 0, int id = 0) : wxPropertyGridEvent(commandType, id), luna_wrapper_base(L) { register_protected_methods(L); };
	wrapper_wxPropertyGridEvent(lua_State* L, lua_Table* dum, const wxPropertyGridEvent & event) : wxPropertyGridEvent(event), luna_wrapper_base(L) { register_protected_methods(L); };
