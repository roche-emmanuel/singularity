...
public:
	...
	wrapper_wxTaskBarIconEvent(lua_State* L, lua_Table* dum, int evtType, wxTaskBarIcon * tbIcon) : wxTaskBarIconEvent(evtType, tbIcon), luna_wrapper_base(L) { register_protected_methods(L); };
