...
public:
	...
	wrapper_wxDataViewEvent(lua_State* L, lua_Table* dum, int commandType = wxEVT_NULL, int winid = 0) : wxDataViewEvent(commandType, winid), luna_wrapper_base(L) { register_protected_methods(L); };
