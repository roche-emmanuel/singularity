...
public:
	...
	wrapper_wxBookCtrlEvent(lua_State* L, lua_Table* dum, int eventType = wxEVT_NULL, int id = 0, int sel = wxNOT_FOUND, int oldSel = wxNOT_FOUND) : wxBookCtrlEvent(eventType, id, sel, oldSel), luna_wrapper_base(L) { register_protected_methods(L); };
