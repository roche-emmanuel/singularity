...
public:
	...
	wrapper_wxContextMenuEvent(lua_State* L, lua_Table* dum, int type = wxEVT_NULL, int id = 0, const wxPoint & pos = wxDefaultPosition) : wxContextMenuEvent(type, id, pos), luna_wrapper_base(L) { register_protected_methods(L); };
