...
public:
	...
	wrapper_wxPopupTransientWindow(lua_State* L, lua_Table* dum, wxWindow * parent, int flags = ::wxBORDER_NONE) : wxPopupTransientWindow(parent, flags), luna_wrapper_base(L) { register_protected_methods(L); };
