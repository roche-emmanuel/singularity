...
public:
	...
	wrapper_wxMouseEvent(lua_State* L, lua_Table* dum, int mouseEventType = wxEVT_NULL) : wxMouseEvent(mouseEventType), luna_wrapper_base(L) { register_protected_methods(L); };
