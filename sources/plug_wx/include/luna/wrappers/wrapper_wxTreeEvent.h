...
public:
	...
	wrapper_wxTreeEvent(lua_State* L, lua_Table* dum, int commandType, wxTreeCtrl * tree, const wxTreeItemId & item = wxTreeItemId ()) : wxTreeEvent(commandType, tree, item), luna_wrapper_base(L) { register_protected_methods(L); };
