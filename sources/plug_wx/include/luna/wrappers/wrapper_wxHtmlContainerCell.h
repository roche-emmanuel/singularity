...
public:
	...
	wrapper_wxHtmlContainerCell(lua_State* L, lua_Table* dum, wxHtmlContainerCell * parent) : wxHtmlContainerCell(parent), luna_wrapper_base(L) { register_protected_methods(L); };
