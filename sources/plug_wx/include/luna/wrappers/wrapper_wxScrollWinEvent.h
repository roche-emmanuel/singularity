...
public:
	...
	wrapper_wxScrollWinEvent(lua_State* L, lua_Table* dum, int commandType = wxEVT_NULL, int pos = 0, int orientation = 0) : wxScrollWinEvent(commandType, pos, orientation), luna_wrapper_base(L) {};
