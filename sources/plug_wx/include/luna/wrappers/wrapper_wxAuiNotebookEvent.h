...
public:
	...
	wrapper_wxAuiNotebookEvent(lua_State* L, lua_Table* dum, int command_type = wxEVT_NULL, int win_id = 0) : wxAuiNotebookEvent(command_type, win_id), luna_wrapper_base(L) { register_protected_methods(L); };
