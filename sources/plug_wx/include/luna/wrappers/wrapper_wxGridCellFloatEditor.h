...
class wrapper_wxGridCellFloatEditor : public wxGridCellFloatEditor {
protected:
	sgt::LuaObject _obj;
...
public:
	...
	wrapper_wxGridCellFloatEditor(lua_State* L, lua_Table* dum, int width = -1, int precision = -1, int format = ::wxGRID_FLOAT_FORMAT_DEFAULT) : wxGridCellFloatEditor(width, precision, format), _obj(L,-1) {};
