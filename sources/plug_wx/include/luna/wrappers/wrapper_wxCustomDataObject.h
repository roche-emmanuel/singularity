...
class wrapper_wxCustomDataObject : public wxCustomDataObject {
protected:
	sgt::LuaObject _obj;
...
public:
	...
	wrapper_wxCustomDataObject(lua_State* L, lua_Table* dum, const wxDataFormat & format = wxFormatInvalid) : wxCustomDataObject(format), _obj(L,-1) {};
