...
public:
	...
	wrapper_wxCommandEvent(lua_State* L, lua_Table* dum, int commandEventType = wxEVT_NULL, int id = 0) : wxCommandEvent(commandEventType, id), luna_wrapper_base(L) { register_protected_methods(L); };
