...
public:
	...
	wrapper_wxTempFileOutputStream(lua_State* L, lua_Table* dum, const wxString & fileName) : wxTempFileOutputStream(fileName), luna_wrapper_base(L) { register_protected_methods(L); };
