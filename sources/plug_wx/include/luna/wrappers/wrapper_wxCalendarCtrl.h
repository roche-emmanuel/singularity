...
public:
	...
	wrapper_wxCalendarCtrl(lua_State* L, lua_Table* dum) : wxCalendarCtrl(), luna_wrapper_base(L) { register_protected_methods(L); };
	wrapper_wxCalendarCtrl(lua_State* L, lua_Table* dum, wxWindow * parent, int id, const wxDateTime & date = wxDefaultDateTime, const wxPoint & pos = wxDefaultPosition, const wxSize & size = wxDefaultSize, long style = ::wxCAL_SHOW_HOLIDAYS, const wxString & name = wxCalendarNameStr) : wxCalendarCtrl(parent, id, date, pos, size, style, name), luna_wrapper_base(L) { register_protected_methods(L); };
