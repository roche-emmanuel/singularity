...
class wrapper_wxScrollBar : public wxScrollBar {
protected:
	sgt::LuaObject _obj;
...
public:
	...
	wrapper_wxScrollBar(lua_State* L, lua_Table* dum) : wxScrollBar(), _obj(L,-1) {};
	wrapper_wxScrollBar(lua_State* L, lua_Table* dum, wxWindow * parent, int id, const wxPoint & pos = wxDefaultPosition, const wxSize & size = wxDefaultSize, long style = wxSB_HORIZONTAL, const wxValidator & validator = wxDefaultValidator, const wxString & name = wxScrollBarNameStr) : wxScrollBar(parent, id, pos, size, style, validator, name), _obj(L,-1) {};
	...
	bool SetBackgroundColour(const wxColour & colour) {
		...
		return wxScrollBar::SetBackgroundColour(colour);
	};
	...
	bool SetForegroundColour(const wxColour & colour) {
		...
		return wxScrollBar::SetForegroundColour(colour);
	};
