...
public:
	...
	wrapper_wxFontPickerEvent(lua_State* L, lua_Table* dum, wxObject * generator, int id, const wxFont & font) : wxFontPickerEvent(generator, id, font), luna_wrapper_base(L) { register_protected_methods(L); };
