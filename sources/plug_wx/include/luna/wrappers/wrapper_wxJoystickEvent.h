...
public:
	...
	wrapper_wxJoystickEvent(lua_State* L, lua_Table* dum, int eventType = wxEVT_NULL, int state = 0, int joystick = ::wxJOYSTICK1, int change = 0) : wxJoystickEvent(eventType, state, joystick, change), luna_wrapper_base(L) { register_protected_methods(L); };
