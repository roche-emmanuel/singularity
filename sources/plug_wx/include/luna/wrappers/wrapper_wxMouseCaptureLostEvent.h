...
public:
	...
	wrapper_wxMouseCaptureLostEvent(lua_State* L, lua_Table* dum, int windowId = 0) : wxMouseCaptureLostEvent(windowId), luna_wrapper_base(L) { register_protected_methods(L); };
