...
class wrapper_wxStaticText : public wxStaticText {
protected:
	sgt::LuaObject _obj;
...
public:
	...
	wrapper_wxStaticText(lua_State* L, lua_Table* dum) : wxStaticText(), _obj(L,-1) {};
	wrapper_wxStaticText(lua_State* L, lua_Table* dum, wxWindow * parent, int id, const wxString & label, const wxPoint & pos = wxDefaultPosition, const wxSize & size = wxDefaultSize, long style = 0, const wxString & name = wxStaticTextNameStr) : wxStaticText(parent, id, label, pos, size, style, name), _obj(L,-1) {};
	...
	bool SetBackgroundColour(const wxColour & colour) {
		...
		return wxStaticText::SetBackgroundColour(colour);
	};
