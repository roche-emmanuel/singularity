...
public:
	...
	wrapper_wxDatagramSocket(lua_State* L, lua_Table* dum, const wxSockAddress & addr, int flags = ::wxSOCKET_NONE) : wxDatagramSocket(addr, flags), luna_wrapper_base(L) { register_protected_methods(L); };
