...
public:
	...
	wrapper_wxFocusEvent(lua_State* L, lua_Table* dum, int eventType = wxEVT_NULL, int id = 0) : wxFocusEvent(eventType, id), luna_wrapper_base(L) { register_protected_methods(L); };
