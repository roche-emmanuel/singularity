...
public:
	...
	wrapper_wxMediaEvent(lua_State* L, lua_Table* dum, int commandType = wxEVT_NULL, int winid = 0) : wxMediaEvent(commandType, winid), luna_wrapper_base(L) { register_protected_methods(L); };
