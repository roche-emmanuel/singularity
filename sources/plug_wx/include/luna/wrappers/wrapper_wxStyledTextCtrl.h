...
class wrapper_wxStyledTextCtrl : public wxStyledTextCtrl {
protected:
	sgt::LuaObject _obj;
...
public:
	...
	wrapper_wxStyledTextCtrl(lua_State* L, lua_Table* dum, wxWindow * parent, int id = ::wxID_ANY, const wxPoint & pos = wxDefaultPosition, const wxSize & size = wxDefaultSize, long style = 0, const wxString & name = wxSTCNameStr) : wxStyledTextCtrl(parent, id, pos, size, style, name), _obj(L,-1) {};
	...
	bool SetBackgroundColour(const wxColour & colour) {
		...
		return wxStyledTextCtrl::SetBackgroundColour(colour);
	};
	...
	bool SetForegroundColour(const wxColour & colour) {
		...
		return wxStyledTextCtrl::SetForegroundColour(colour);
	};
