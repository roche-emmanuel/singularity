...
public:
	...
	wrapper_wxDropFilesEvent(lua_State* L, lua_Table* dum, int id = 0, int noFiles = 0, wxString * files = NULL) : wxDropFilesEvent(id, noFiles, files), luna_wrapper_base(L) { register_protected_methods(L); };
