...
public:
	...
	wrapper_wxTextEntryDialog(lua_State* L, lua_Table* dum, wxWindow * parent, const wxString & message, const wxString & caption = wxGetTextFromUserPromptStr, const wxString & value = wxEmptyString, long style = wxOK | wxCANCEL | ::wxCENTRE, const wxPoint & pos = wxDefaultPosition) : wxTextEntryDialog(parent, message, caption, value, style, pos), luna_wrapper_base(L) { register_protected_methods(L); };
