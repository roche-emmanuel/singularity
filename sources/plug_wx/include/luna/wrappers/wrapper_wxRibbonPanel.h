...
class wrapper_wxRibbonPanel : public wxRibbonPanel {
protected:
	sgt::LuaObject _obj;
...
public:
	...
	bool SetBackgroundColour(const wxColour & colour) {
		...
		return wxRibbonPanel::SetBackgroundColour(colour);
	};
	...
	bool SetForegroundColour(const wxColour & colour) {
		...
		return wxRibbonPanel::SetForegroundColour(colour);
	};
