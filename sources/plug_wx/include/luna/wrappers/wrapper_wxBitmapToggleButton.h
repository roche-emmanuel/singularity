...
class wrapper_wxBitmapToggleButton : public wxBitmapToggleButton {
protected:
	sgt::LuaObject _obj;
...
public:
	...
	bool SetBackgroundColour(const wxColour & colour) {
		...
		return wxBitmapToggleButton::SetBackgroundColour(colour);
	};
	...
	bool SetForegroundColour(const wxColour & colour) {
		...
		return wxBitmapToggleButton::SetForegroundColour(colour);
	};
