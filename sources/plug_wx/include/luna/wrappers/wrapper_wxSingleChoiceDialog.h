#ifndef _WRAPPERS_WRAPPER_WXSINGLECHOICEDIALOG_H_
#define _WRAPPERS_WRAPPER_WXSINGLECHOICEDIALOG_H_
...
public:
	...
	~wrapper_wxSingleChoiceDialog() {
		logDEBUG3("Calling delete function for wrapper wxSingleChoiceDialog");
		if(_obj.pushFunction("delete")) {
			//_obj.pushArg((wxSingleChoiceDialog*)this); // No this argument or the object will be referenced again!
