...
public:
	...
	static int _bind_fromVoid(lua_State *L) {
		...
		wxRichTextListStyleDefinition* self= (wxRichTextListStyleDefinition*)(Luna< void >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call fromVoid(...)");
		}
		
		Luna< wxRichTextListStyleDefinition >::push(L,self,false);
		return 1;
	}
...
luna_RegType LunaTraits< wxRichTextListStyleDefinition >::methods[] = {
	...
	{"fromVoid", &luna_wrapper_wxRichTextListStyleDefinition::_bind_fromVoid},
	{"asVoid", &luna_wrapper_wxRichTextListStyleDefinition::_bind_asVoid},
	{"getTable", &luna_wrapper_wxRichTextListStyleDefinition::_bind_getTable},
	{0,0}
};
