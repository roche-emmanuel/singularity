...
public:
	...
	static int _bind_fromVoid(lua_State *L) {
		...
		wxFFileOutputStream* self= (wxFFileOutputStream*)(Luna< void >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call fromVoid(...)");
		}
		
		Luna< wxFFileOutputStream >::push(L,self,false);
		return 1;
	}
...
luna_RegType LunaTraits< wxFFileOutputStream >::methods[] = {
	...
	{"fromVoid", &luna_wrapper_wxFFileOutputStream::_bind_fromVoid},
	{"asVoid", &luna_wrapper_wxFFileOutputStream::_bind_asVoid},
