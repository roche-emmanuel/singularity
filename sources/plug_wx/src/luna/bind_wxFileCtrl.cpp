...
public:
	...
	static wxFileCtrl* _bind_ctor_overload_2(lua_State *L) {
		...
		long style=luatop>5 ? (long)lua_tointeger(L,6) : (long)wxFC_DEFAULT_STYLE;
	...
	static wxFileCtrl* _bind_ctor_overload_4(lua_State *L) {
		...
		long style=luatop>6 ? (long)lua_tointeger(L,7) : (long)wxFC_DEFAULT_STYLE;
...
luna_RegType LunaTraits< wxFileCtrl >::methods[] = {
	...
	{"__eq", &luna_wrapper_wxFileCtrl::_bind___eq},
