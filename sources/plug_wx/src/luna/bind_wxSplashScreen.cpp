...
public:
	...
	static wxSplashScreen* _bind_ctor_overload_1(lua_State *L) {
		...
		long style=luatop>7 ? (long)lua_tointeger(L,8) : (long)::wxBORDER_SIMPLE | wxFRAME_NO_TASKBAR | wxSTAY_ON_TOP;
	...
	static wxSplashScreen* _bind_ctor_overload_2(lua_State *L) {
		...
		long style=luatop>8 ? (long)lua_tointeger(L,9) : (long)::wxBORDER_SIMPLE | wxFRAME_NO_TASKBAR | wxSTAY_ON_TOP;
