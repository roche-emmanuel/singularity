...
public:
	...
	static int _bind_Create(lua_State *L) {
		...
		if(!self) {
			luaL_error(L, "Invalid object in function call bool wxRibbonToolBar::Create(wxWindow *, int, const wxPoint &, const wxSize &, long). Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_AddTool_overload_1(lua_State *L) {
		...
		wxRibbonToolBar* self=Luna< wxObject >::checkSubType< wxRibbonToolBar >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call wxRibbonToolBarToolBase * wxRibbonToolBar::AddTool(int, const wxBitmap &, const wxString &, wxRibbonButtonKind). Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_AddTool_overload_2(lua_State *L) {
		...
		wxRibbonToolBar* self=Luna< wxObject >::checkSubType< wxRibbonToolBar >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call wxRibbonToolBarToolBase * wxRibbonToolBar::AddTool(int, const wxBitmap &, const wxBitmap &, const wxString &, wxRibbonButtonKind, wxObject *). Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_AddDropdownTool(lua_State *L) {
		...
		wxRibbonToolBar* self=Luna< wxObject >::checkSubType< wxRibbonToolBar >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call wxRibbonToolBarToolBase * wxRibbonToolBar::AddDropdownTool(int, const wxBitmap &, const wxString &). Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_AddHybridTool(lua_State *L) {
		...
		wxRibbonToolBar* self=Luna< wxObject >::checkSubType< wxRibbonToolBar >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call wxRibbonToolBarToolBase * wxRibbonToolBar::AddHybridTool(int, const wxBitmap &, const wxString &). Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_AddSeparator(lua_State *L) {
		...
		wxRibbonToolBar* self=Luna< wxObject >::checkSubType< wxRibbonToolBar >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call wxRibbonToolBarToolBase * wxRibbonToolBar::AddSeparator(). Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_SetRows(lua_State *L) {
		...
		wxRibbonToolBar* self=Luna< wxObject >::checkSubType< wxRibbonToolBar >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void wxRibbonToolBar::SetRows(int, int). Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_GetClassInfo(lua_State *L) {
		...
		wxRibbonToolBar* self=Luna< wxObject >::checkSubType< wxRibbonToolBar >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call wxClassInfo * wxRibbonToolBar::base_GetClassInfo() const. Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_AcceptsFocus(lua_State *L) {
		...
		wxRibbonToolBar* self=Luna< wxObject >::checkSubType< wxRibbonToolBar >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call bool wxRibbonToolBar::base_AcceptsFocus() const. Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_AcceptsFocusFromKeyboard(lua_State *L) {
		...
		wxRibbonToolBar* self=Luna< wxObject >::checkSubType< wxRibbonToolBar >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call bool wxRibbonToolBar::base_AcceptsFocusFromKeyboard() const. Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_AcceptsFocusRecursively(lua_State *L) {
		...
		wxRibbonToolBar* self=Luna< wxObject >::checkSubType< wxRibbonToolBar >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call bool wxRibbonToolBar::base_AcceptsFocusRecursively() const. Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_HasFocus(lua_State *L) {
		...
		wxRibbonToolBar* self=Luna< wxObject >::checkSubType< wxRibbonToolBar >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call bool wxRibbonToolBar::base_HasFocus() const. Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_SetCanFocus(lua_State *L) {
		...
		wxRibbonToolBar* self=Luna< wxObject >::checkSubType< wxRibbonToolBar >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void wxRibbonToolBar::base_SetCanFocus(bool). Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_SetFocus(lua_State *L) {
		...
		wxRibbonToolBar* self=Luna< wxObject >::checkSubType< wxRibbonToolBar >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void wxRibbonToolBar::base_SetFocus(). Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_SetFocusFromKbd(lua_State *L) {
		...
		wxRibbonToolBar* self=Luna< wxObject >::checkSubType< wxRibbonToolBar >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void wxRibbonToolBar::base_SetFocusFromKbd(). Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_AddChild(lua_State *L) {
		...
		wxRibbonToolBar* self=Luna< wxObject >::checkSubType< wxRibbonToolBar >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void wxRibbonToolBar::base_AddChild(wxWindow *). Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_RemoveChild(lua_State *L) {
		...
		wxRibbonToolBar* self=Luna< wxObject >::checkSubType< wxRibbonToolBar >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void wxRibbonToolBar::base_RemoveChild(wxWindow *). Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_Reparent(lua_State *L) {
		...
		wxRibbonToolBar* self=Luna< wxObject >::checkSubType< wxRibbonToolBar >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call bool wxRibbonToolBar::base_Reparent(wxWindow *). Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_AlwaysShowScrollbars(lua_State *L) {
		...
		wxRibbonToolBar* self=Luna< wxObject >::checkSubType< wxRibbonToolBar >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void wxRibbonToolBar::base_AlwaysShowScrollbars(bool, bool). Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_GetScrollPos(lua_State *L) {
		...
		wxRibbonToolBar* self=Luna< wxObject >::checkSubType< wxRibbonToolBar >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call int wxRibbonToolBar::base_GetScrollPos(int) const. Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_GetScrollRange(lua_State *L) {
		...
		wxRibbonToolBar* self=Luna< wxObject >::checkSubType< wxRibbonToolBar >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call int wxRibbonToolBar::base_GetScrollRange(int) const. Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_GetScrollThumb(lua_State *L) {
		...
		wxRibbonToolBar* self=Luna< wxObject >::checkSubType< wxRibbonToolBar >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call int wxRibbonToolBar::base_GetScrollThumb(int) const. Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_IsScrollbarAlwaysShown(lua_State *L) {
		...
		wxRibbonToolBar* self=Luna< wxObject >::checkSubType< wxRibbonToolBar >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call bool wxRibbonToolBar::base_IsScrollbarAlwaysShown(int) const. Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_ScrollLines(lua_State *L) {
		...
		wxRibbonToolBar* self=Luna< wxObject >::checkSubType< wxRibbonToolBar >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call bool wxRibbonToolBar::base_ScrollLines(int). Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_ScrollPages(lua_State *L) {
		...
		wxRibbonToolBar* self=Luna< wxObject >::checkSubType< wxRibbonToolBar >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call bool wxRibbonToolBar::base_ScrollPages(int). Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_ScrollWindow(lua_State *L) {
		...
		wxRibbonToolBar* self=Luna< wxObject >::checkSubType< wxRibbonToolBar >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void wxRibbonToolBar::base_ScrollWindow(int, int, const wxRect *). Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_SetScrollPos(lua_State *L) {
		...
		wxRibbonToolBar* self=Luna< wxObject >::checkSubType< wxRibbonToolBar >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void wxRibbonToolBar::base_SetScrollPos(int, int, bool). Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_SetScrollbar(lua_State *L) {
		...
		wxRibbonToolBar* self=Luna< wxObject >::checkSubType< wxRibbonToolBar >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void wxRibbonToolBar::base_SetScrollbar(int, int, int, int, bool). Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_ClientToWindowSize(lua_State *L) {
		...
		wxRibbonToolBar* self=Luna< wxObject >::checkSubType< wxRibbonToolBar >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call wxSize wxRibbonToolBar::base_ClientToWindowSize(const wxSize &) const. Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_WindowToClientSize(lua_State *L) {
		...
		wxRibbonToolBar* self=Luna< wxObject >::checkSubType< wxRibbonToolBar >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call wxSize wxRibbonToolBar::base_WindowToClientSize(const wxSize &) const. Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_Fit(lua_State *L) {
		...
		wxRibbonToolBar* self=Luna< wxObject >::checkSubType< wxRibbonToolBar >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void wxRibbonToolBar::base_Fit(). Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_FitInside(lua_State *L) {
		...
		wxRibbonToolBar* self=Luna< wxObject >::checkSubType< wxRibbonToolBar >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void wxRibbonToolBar::base_FitInside(). Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_GetEffectiveMinSize(lua_State *L) {
		...
		wxRibbonToolBar* self=Luna< wxObject >::checkSubType< wxRibbonToolBar >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call wxSize wxRibbonToolBar::base_GetEffectiveMinSize() const. Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_GetMaxClientSize(lua_State *L) {
		...
		wxRibbonToolBar* self=Luna< wxObject >::checkSubType< wxRibbonToolBar >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call wxSize wxRibbonToolBar::base_GetMaxClientSize() const. Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_GetMaxSize(lua_State *L) {
		...
		wxRibbonToolBar* self=Luna< wxObject >::checkSubType< wxRibbonToolBar >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call wxSize wxRibbonToolBar::base_GetMaxSize() const. Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_GetMinClientSize(lua_State *L) {
		...
		wxRibbonToolBar* self=Luna< wxObject >::checkSubType< wxRibbonToolBar >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call wxSize wxRibbonToolBar::base_GetMinClientSize() const. Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_GetMinSize(lua_State *L) {
		...
		wxRibbonToolBar* self=Luna< wxObject >::checkSubType< wxRibbonToolBar >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call wxSize wxRibbonToolBar::base_GetMinSize() const. Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_GetBestVirtualSize(lua_State *L) {
		...
		wxRibbonToolBar* self=Luna< wxObject >::checkSubType< wxRibbonToolBar >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call wxSize wxRibbonToolBar::base_GetBestVirtualSize() const. Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_GetWindowBorderSize(lua_State *L) {
		...
		wxRibbonToolBar* self=Luna< wxObject >::checkSubType< wxRibbonToolBar >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call wxSize wxRibbonToolBar::base_GetWindowBorderSize() const. Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_InformFirstDirection(lua_State *L) {
		...
		wxRibbonToolBar* self=Luna< wxObject >::checkSubType< wxRibbonToolBar >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call bool wxRibbonToolBar::base_InformFirstDirection(int, int, int). Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_SendSizeEvent(lua_State *L) {
		...
		wxRibbonToolBar* self=Luna< wxObject >::checkSubType< wxRibbonToolBar >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void wxRibbonToolBar::base_SendSizeEvent(int). Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_SetMaxClientSize(lua_State *L) {
		...
		wxRibbonToolBar* self=Luna< wxObject >::checkSubType< wxRibbonToolBar >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void wxRibbonToolBar::base_SetMaxClientSize(const wxSize &). Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_SetMaxSize(lua_State *L) {
		...
		wxRibbonToolBar* self=Luna< wxObject >::checkSubType< wxRibbonToolBar >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void wxRibbonToolBar::base_SetMaxSize(const wxSize &). Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_SetMinClientSize(lua_State *L) {
		...
		wxRibbonToolBar* self=Luna< wxObject >::checkSubType< wxRibbonToolBar >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void wxRibbonToolBar::base_SetMinClientSize(const wxSize &). Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_SetMinSize(lua_State *L) {
		...
		wxRibbonToolBar* self=Luna< wxObject >::checkSubType< wxRibbonToolBar >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void wxRibbonToolBar::base_SetMinSize(const wxSize &). Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_SetSizeHints_overload_1(lua_State *L) {
		...
		wxRibbonToolBar* self=Luna< wxObject >::checkSubType< wxRibbonToolBar >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void wxRibbonToolBar::base_SetSizeHints(const wxSize &, const wxSize &, const wxSize &). Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_SetSizeHints_overload_2(lua_State *L) {
		...
		wxRibbonToolBar* self=Luna< wxObject >::checkSubType< wxRibbonToolBar >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void wxRibbonToolBar::base_SetSizeHints(int, int, int, int, int, int). Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_GetClientAreaOrigin(lua_State *L) {
		...
		wxRibbonToolBar* self=Luna< wxObject >::checkSubType< wxRibbonToolBar >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call wxPoint wxRibbonToolBar::base_GetClientAreaOrigin() const. Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_ClearBackground(lua_State *L) {
		...
		wxRibbonToolBar* self=Luna< wxObject >::checkSubType< wxRibbonToolBar >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void wxRibbonToolBar::base_ClearBackground(). Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_GetBackgroundStyle(lua_State *L) {
		...
		wxRibbonToolBar* self=Luna< wxObject >::checkSubType< wxRibbonToolBar >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call wxBackgroundStyle wxRibbonToolBar::base_GetBackgroundStyle() const. Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_GetCharHeight(lua_State *L) {
		...
		wxRibbonToolBar* self=Luna< wxObject >::checkSubType< wxRibbonToolBar >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call int wxRibbonToolBar::base_GetCharHeight() const. Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_GetCharWidth(lua_State *L) {
		...
		wxRibbonToolBar* self=Luna< wxObject >::checkSubType< wxRibbonToolBar >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call int wxRibbonToolBar::base_GetCharWidth() const. Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_GetDefaultAttributes(lua_State *L) {
		...
		wxRibbonToolBar* self=Luna< wxObject >::checkSubType< wxRibbonToolBar >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call wxVisualAttributes wxRibbonToolBar::base_GetDefaultAttributes() const. Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_Refresh(lua_State *L) {
		...
		wxRibbonToolBar* self=Luna< wxObject >::checkSubType< wxRibbonToolBar >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void wxRibbonToolBar::base_Refresh(bool, const wxRect *). Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_Update(lua_State *L) {
		...
		wxRibbonToolBar* self=Luna< wxObject >::checkSubType< wxRibbonToolBar >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void wxRibbonToolBar::base_Update(). Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_SetBackgroundStyle(lua_State *L) {
		...
		wxRibbonToolBar* self=Luna< wxObject >::checkSubType< wxRibbonToolBar >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call bool wxRibbonToolBar::base_SetBackgroundStyle(wxBackgroundStyle). Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_SetFont(lua_State *L) {
		...
		wxRibbonToolBar* self=Luna< wxObject >::checkSubType< wxRibbonToolBar >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call bool wxRibbonToolBar::base_SetFont(const wxFont &). Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_ShouldInheritColours(lua_State *L) {
		...
		wxRibbonToolBar* self=Luna< wxObject >::checkSubType< wxRibbonToolBar >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call bool wxRibbonToolBar::base_ShouldInheritColours() const. Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_SetThemeEnabled(lua_State *L) {
		...
		wxRibbonToolBar* self=Luna< wxObject >::checkSubType< wxRibbonToolBar >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void wxRibbonToolBar::base_SetThemeEnabled(bool). Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_GetThemeEnabled(lua_State *L) {
		...
		wxRibbonToolBar* self=Luna< wxObject >::checkSubType< wxRibbonToolBar >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call bool wxRibbonToolBar::base_GetThemeEnabled() const. Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_CanSetTransparent(lua_State *L) {
		...
		wxRibbonToolBar* self=Luna< wxObject >::checkSubType< wxRibbonToolBar >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call bool wxRibbonToolBar::base_CanSetTransparent(). Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_SetTransparent(lua_State *L) {
		...
		wxRibbonToolBar* self=Luna< wxObject >::checkSubType< wxRibbonToolBar >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call bool wxRibbonToolBar::base_SetTransparent(unsigned char). Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_SetNextHandler(lua_State *L) {
		...
		wxRibbonToolBar* self=Luna< wxObject >::checkSubType< wxRibbonToolBar >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void wxRibbonToolBar::base_SetNextHandler(wxEvtHandler *). Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_SetPreviousHandler(lua_State *L) {
		...
		wxRibbonToolBar* self=Luna< wxObject >::checkSubType< wxRibbonToolBar >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void wxRibbonToolBar::base_SetPreviousHandler(wxEvtHandler *). Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_GetWindowStyleFlag(lua_State *L) {
		...
		wxRibbonToolBar* self=Luna< wxObject >::checkSubType< wxRibbonToolBar >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call long wxRibbonToolBar::base_GetWindowStyleFlag() const. Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_SetExtraStyle(lua_State *L) {
		...
		wxRibbonToolBar* self=Luna< wxObject >::checkSubType< wxRibbonToolBar >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void wxRibbonToolBar::base_SetExtraStyle(long). Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_SetWindowStyleFlag(lua_State *L) {
		...
		wxRibbonToolBar* self=Luna< wxObject >::checkSubType< wxRibbonToolBar >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void wxRibbonToolBar::base_SetWindowStyleFlag(long). Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_Lower(lua_State *L) {
		...
		wxRibbonToolBar* self=Luna< wxObject >::checkSubType< wxRibbonToolBar >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void wxRibbonToolBar::base_Lower(). Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_Raise(lua_State *L) {
		...
		wxRibbonToolBar* self=Luna< wxObject >::checkSubType< wxRibbonToolBar >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void wxRibbonToolBar::base_Raise(). Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_HideWithEffect(lua_State *L) {
		...
		wxRibbonToolBar* self=Luna< wxObject >::checkSubType< wxRibbonToolBar >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call bool wxRibbonToolBar::base_HideWithEffect(wxShowEffect, unsigned int). Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_IsShown(lua_State *L) {
		...
		wxRibbonToolBar* self=Luna< wxObject >::checkSubType< wxRibbonToolBar >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call bool wxRibbonToolBar::base_IsShown() const. Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_IsShownOnScreen(lua_State *L) {
		...
		wxRibbonToolBar* self=Luna< wxObject >::checkSubType< wxRibbonToolBar >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call bool wxRibbonToolBar::base_IsShownOnScreen() const. Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_Enable(lua_State *L) {
		...
		wxRibbonToolBar* self=Luna< wxObject >::checkSubType< wxRibbonToolBar >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call bool wxRibbonToolBar::base_Enable(bool). Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_Show(lua_State *L) {
		...
		wxRibbonToolBar* self=Luna< wxObject >::checkSubType< wxRibbonToolBar >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call bool wxRibbonToolBar::base_Show(bool). Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_ShowWithEffect(lua_State *L) {
		...
		wxRibbonToolBar* self=Luna< wxObject >::checkSubType< wxRibbonToolBar >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call bool wxRibbonToolBar::base_ShowWithEffect(wxShowEffect, unsigned int). Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_GetHelpTextAtPoint(lua_State *L) {
		...
		wxRibbonToolBar* self=Luna< wxObject >::checkSubType< wxRibbonToolBar >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call wxString wxRibbonToolBar::base_GetHelpTextAtPoint(const wxPoint &, wxHelpEvent::Origin) const. Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_GetValidator(lua_State *L) {
		...
		wxRibbonToolBar* self=Luna< wxObject >::checkSubType< wxRibbonToolBar >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call wxValidator * wxRibbonToolBar::base_GetValidator(). Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_SetValidator(lua_State *L) {
		...
		wxRibbonToolBar* self=Luna< wxObject >::checkSubType< wxRibbonToolBar >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void wxRibbonToolBar::base_SetValidator(const wxValidator &). Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_TransferDataFromWindow(lua_State *L) {
		...
		wxRibbonToolBar* self=Luna< wxObject >::checkSubType< wxRibbonToolBar >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call bool wxRibbonToolBar::base_TransferDataFromWindow(). Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_TransferDataToWindow(lua_State *L) {
		...
		wxRibbonToolBar* self=Luna< wxObject >::checkSubType< wxRibbonToolBar >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call bool wxRibbonToolBar::base_TransferDataToWindow(). Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_Validate(lua_State *L) {
		...
		wxRibbonToolBar* self=Luna< wxObject >::checkSubType< wxRibbonToolBar >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call bool wxRibbonToolBar::base_Validate(). Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_GetLayoutDirection(lua_State *L) {
		...
		wxRibbonToolBar* self=Luna< wxObject >::checkSubType< wxRibbonToolBar >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call wxLayoutDirection wxRibbonToolBar::base_GetLayoutDirection() const. Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_GetName(lua_State *L) {
		...
		wxRibbonToolBar* self=Luna< wxObject >::checkSubType< wxRibbonToolBar >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call wxString wxRibbonToolBar::base_GetName() const. Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_SetLayoutDirection(lua_State *L) {
		...
		wxRibbonToolBar* self=Luna< wxObject >::checkSubType< wxRibbonToolBar >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void wxRibbonToolBar::base_SetLayoutDirection(wxLayoutDirection). Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_SetName(lua_State *L) {
		...
		wxRibbonToolBar* self=Luna< wxObject >::checkSubType< wxRibbonToolBar >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void wxRibbonToolBar::base_SetName(const wxString &). Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_SetAcceleratorTable(lua_State *L) {
		...
		wxRibbonToolBar* self=Luna< wxObject >::checkSubType< wxRibbonToolBar >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void wxRibbonToolBar::base_SetAcceleratorTable(const wxAcceleratorTable &). Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_Destroy(lua_State *L) {
		...
		wxRibbonToolBar* self=Luna< wxObject >::checkSubType< wxRibbonToolBar >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call bool wxRibbonToolBar::base_Destroy(). Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_GetDropTarget(lua_State *L) {
		...
		wxRibbonToolBar* self=Luna< wxObject >::checkSubType< wxRibbonToolBar >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call wxDropTarget * wxRibbonToolBar::base_GetDropTarget() const. Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_SetDropTarget(lua_State *L) {
		...
		wxRibbonToolBar* self=Luna< wxObject >::checkSubType< wxRibbonToolBar >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void wxRibbonToolBar::base_SetDropTarget(wxDropTarget *). Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_DragAcceptFiles(lua_State *L) {
		...
		wxRibbonToolBar* self=Luna< wxObject >::checkSubType< wxRibbonToolBar >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void wxRibbonToolBar::base_DragAcceptFiles(bool). Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_Layout(lua_State *L) {
		...
		wxRibbonToolBar* self=Luna< wxObject >::checkSubType< wxRibbonToolBar >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call bool wxRibbonToolBar::base_Layout(). Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_HasCapture(lua_State *L) {
		...
		wxRibbonToolBar* self=Luna< wxObject >::checkSubType< wxRibbonToolBar >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call bool wxRibbonToolBar::base_HasCapture() const. Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_SetCursor(lua_State *L) {
		...
		wxRibbonToolBar* self=Luna< wxObject >::checkSubType< wxRibbonToolBar >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call bool wxRibbonToolBar::base_SetCursor(const wxCursor &). Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_WarpPointer(lua_State *L) {
		...
		wxRibbonToolBar* self=Luna< wxObject >::checkSubType< wxRibbonToolBar >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void wxRibbonToolBar::base_WarpPointer(int, int). Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_DoUpdateWindowUI(lua_State *L) {
		...
		wxRibbonToolBar* self=Luna< wxObject >::checkSubType< wxRibbonToolBar >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void wxRibbonToolBar::base_DoUpdateWindowUI(wxUpdateUIEvent &). Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	// HWND wxRibbonToolBar::base_GetHandle() const
	static int _bind_base_GetHandle(lua_State *L) {
		if (!_lg_typecheck_base_GetHandle(L)) {
			luaL_error(L, "luna typecheck failed in HWND wxRibbonToolBar::base_GetHandle() const function, expected prototype:\nHWND wxRibbonToolBar::base_GetHandle() const\nClass arguments details:\n\n%s",luna_dumpStack(L).c_str());
		}


		wxRibbonToolBar* self=Luna< wxObject >::checkSubType< wxRibbonToolBar >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call HWND wxRibbonToolBar::base_GetHandle() const. Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
		HWND stack_lret = self->wxRibbonToolBar::GetHandle();
	...
	static int _bind_base_HasMultiplePages(lua_State *L) {
		...
		wxRibbonToolBar* self=Luna< wxObject >::checkSubType< wxRibbonToolBar >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call bool wxRibbonToolBar::base_HasMultiplePages() const. Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_InheritAttributes(lua_State *L) {
		...
		wxRibbonToolBar* self=Luna< wxObject >::checkSubType< wxRibbonToolBar >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void wxRibbonToolBar::base_InheritAttributes(). Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_InitDialog(lua_State *L) {
		...
		wxRibbonToolBar* self=Luna< wxObject >::checkSubType< wxRibbonToolBar >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void wxRibbonToolBar::base_InitDialog(). Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_IsRetained(lua_State *L) {
		...
		wxRibbonToolBar* self=Luna< wxObject >::checkSubType< wxRibbonToolBar >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call bool wxRibbonToolBar::base_IsRetained() const. Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_IsTopLevel(lua_State *L) {
		...
		wxRibbonToolBar* self=Luna< wxObject >::checkSubType< wxRibbonToolBar >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call bool wxRibbonToolBar::base_IsTopLevel() const. Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_MakeModal(lua_State *L) {
		...
		wxRibbonToolBar* self=Luna< wxObject >::checkSubType< wxRibbonToolBar >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void wxRibbonToolBar::base_MakeModal(bool). Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_OnInternalIdle(lua_State *L) {
		...
		wxRibbonToolBar* self=Luna< wxObject >::checkSubType< wxRibbonToolBar >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void wxRibbonToolBar::base_OnInternalIdle(). Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_RegisterHotKey(lua_State *L) {
		...
		wxRibbonToolBar* self=Luna< wxObject >::checkSubType< wxRibbonToolBar >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call bool wxRibbonToolBar::base_RegisterHotKey(int, int, int). Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_UnregisterHotKey(lua_State *L) {
		...
		wxRibbonToolBar* self=Luna< wxObject >::checkSubType< wxRibbonToolBar >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call bool wxRibbonToolBar::base_UnregisterHotKey(int). Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_UpdateWindowUI(lua_State *L) {
		...
		wxRibbonToolBar* self=Luna< wxObject >::checkSubType< wxRibbonToolBar >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void wxRibbonToolBar::base_UpdateWindowUI(long). Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_Command(lua_State *L) {
		...
		wxRibbonToolBar* self=Luna< wxObject >::checkSubType< wxRibbonToolBar >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void wxRibbonToolBar::base_Command(wxCommandEvent &). Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_GetLabel(lua_State *L) {
		...
		wxRibbonToolBar* self=Luna< wxObject >::checkSubType< wxRibbonToolBar >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call wxString wxRibbonToolBar::base_GetLabel() const. Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_SetLabel(lua_State *L) {
		...
		wxRibbonToolBar* self=Luna< wxObject >::checkSubType< wxRibbonToolBar >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void wxRibbonToolBar::base_SetLabel(const wxString &). Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_SetArtProvider(lua_State *L) {
		...
		wxRibbonToolBar* self=Luna< wxObject >::checkSubType< wxRibbonToolBar >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void wxRibbonToolBar::base_SetArtProvider(wxRibbonArtProvider *). Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_IsSizingContinuous(lua_State *L) {
		...
		wxRibbonToolBar* self=Luna< wxObject >::checkSubType< wxRibbonToolBar >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call bool wxRibbonToolBar::base_IsSizingContinuous() const. Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_Realize(lua_State *L) {
		...
		wxRibbonToolBar* self=Luna< wxObject >::checkSubType< wxRibbonToolBar >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call bool wxRibbonToolBar::base_Realize(). Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_SetRows(lua_State *L) {
		...
		wxRibbonToolBar* self=Luna< wxObject >::checkSubType< wxRibbonToolBar >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void wxRibbonToolBar::base_SetRows(int, int). Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
...
luna_RegType LunaTraits< wxRibbonToolBar >::methods[] = {
	...
	{"base_GetHandle", &luna_wrapper_wxRibbonToolBar::_bind_base_GetHandle},
