...
void register_enums(lua_State* L) {
	...
	lua_pushnumber(L,wxAutomationInstance_UseExistingOnly); lua_setfield(L,-2,"wxAutomationInstance_UseExistingOnly");
	lua_pushnumber(L,wxAutomationInstance_CreateIfNeeded); lua_setfield(L,-2,"wxAutomationInstance_CreateIfNeeded");
	lua_pushnumber(L,wxAutomationInstance_SilentIfNone); lua_setfield(L,-2,"wxAutomationInstance_SilentIfNone");
	...
	lua_pushnumber(L,wxRIBBON_BUTTONBAR_BUTTON_ACTIVE_MASK); lua_setfield(L,-2,"wxRIBBON_BUTTONBAR_BUTTON_ACTIVE_MASK");
	...
	lua_pushnumber(L,wxCMD_SWITCH_NOT_FOUND); lua_setfield(L,-2,"wxCMD_SWITCH_NOT_FOUND");
	...
	lua_pushnumber(L,wxBG_STYLE_CUSTOM); lua_setfield(L,-2,"wxBG_STYLE_CUSTOM");
	...
	lua_pushnumber(L,wxID_OSX_MENU_FIRST); lua_setfield(L,-2,"wxID_OSX_MENU_FIRST");
	lua_pushnumber(L,wxID_OSX_HIDE); lua_setfield(L,-2,"wxID_OSX_HIDE");
	lua_pushnumber(L,wxID_OSX_HIDEOTHERS); lua_setfield(L,-2,"wxID_OSX_HIDEOTHERS");
	lua_pushnumber(L,wxID_OSX_SHOWALL); lua_setfield(L,-2,"wxID_OSX_SHOWALL");
	lua_pushnumber(L,wxID_OSX_MENU_LAST); lua_setfield(L,-2,"wxID_OSX_MENU_LAST");
	...
	lua_pushnumber(L,WXK_CONTROL_A); lua_setfield(L,-2,"WXK_CONTROL_A");
	lua_pushnumber(L,WXK_CONTROL_B); lua_setfield(L,-2,"WXK_CONTROL_B");
	lua_pushnumber(L,WXK_CONTROL_C); lua_setfield(L,-2,"WXK_CONTROL_C");
	lua_pushnumber(L,WXK_CONTROL_D); lua_setfield(L,-2,"WXK_CONTROL_D");
	lua_pushnumber(L,WXK_CONTROL_E); lua_setfield(L,-2,"WXK_CONTROL_E");
	lua_pushnumber(L,WXK_CONTROL_F); lua_setfield(L,-2,"WXK_CONTROL_F");
	lua_pushnumber(L,WXK_CONTROL_G); lua_setfield(L,-2,"WXK_CONTROL_G");
	lua_pushnumber(L,WXK_CONTROL_H); lua_setfield(L,-2,"WXK_CONTROL_H");
	lua_pushnumber(L,WXK_CONTROL_I); lua_setfield(L,-2,"WXK_CONTROL_I");
	lua_pushnumber(L,WXK_CONTROL_J); lua_setfield(L,-2,"WXK_CONTROL_J");
	lua_pushnumber(L,WXK_CONTROL_K); lua_setfield(L,-2,"WXK_CONTROL_K");
	lua_pushnumber(L,WXK_CONTROL_L); lua_setfield(L,-2,"WXK_CONTROL_L");
	lua_pushnumber(L,WXK_CONTROL_M); lua_setfield(L,-2,"WXK_CONTROL_M");
	lua_pushnumber(L,WXK_CONTROL_N); lua_setfield(L,-2,"WXK_CONTROL_N");
	lua_pushnumber(L,WXK_CONTROL_O); lua_setfield(L,-2,"WXK_CONTROL_O");
	lua_pushnumber(L,WXK_CONTROL_P); lua_setfield(L,-2,"WXK_CONTROL_P");
	lua_pushnumber(L,WXK_CONTROL_Q); lua_setfield(L,-2,"WXK_CONTROL_Q");
	lua_pushnumber(L,WXK_CONTROL_R); lua_setfield(L,-2,"WXK_CONTROL_R");
	lua_pushnumber(L,WXK_CONTROL_S); lua_setfield(L,-2,"WXK_CONTROL_S");
	lua_pushnumber(L,WXK_CONTROL_T); lua_setfield(L,-2,"WXK_CONTROL_T");
	lua_pushnumber(L,WXK_CONTROL_U); lua_setfield(L,-2,"WXK_CONTROL_U");
	lua_pushnumber(L,WXK_CONTROL_V); lua_setfield(L,-2,"WXK_CONTROL_V");
	lua_pushnumber(L,WXK_CONTROL_W); lua_setfield(L,-2,"WXK_CONTROL_W");
	lua_pushnumber(L,WXK_CONTROL_X); lua_setfield(L,-2,"WXK_CONTROL_X");
	lua_pushnumber(L,WXK_CONTROL_Y); lua_setfield(L,-2,"WXK_CONTROL_Y");
	lua_pushnumber(L,WXK_CONTROL_Z); lua_setfield(L,-2,"WXK_CONTROL_Z");
	lua_pushnumber(L,WXK_RAW_CONTROL); lua_setfield(L,-2,"WXK_RAW_CONTROL");
	...
	lua_pushnumber(L,wxAUI_BUTTON_STATE_DISABLED); lua_setfield(L,-2,"wxAUI_BUTTON_STATE_DISABLED");
	lua_pushnumber(L,wxAUI_BUTTON_STATE_HIDDEN); lua_setfield(L,-2,"wxAUI_BUTTON_STATE_HIDDEN");
	lua_pushnumber(L,wxAUI_BUTTON_STATE_CHECKED); lua_setfield(L,-2,"wxAUI_BUTTON_STATE_CHECKED");
	...
	lua_pushnumber(L,wxBITMAP_TYPE_MAX); lua_setfield(L,-2,"wxBITMAP_TYPE_MAX");
	...
	lua_pushnumber(L,wxGRID_FLOAT_FORMAT_MASK); lua_setfield(L,-2,"wxGRID_FLOAT_FORMAT_MASK");
	...
	lua_pushnumber(L,wxLOCALE_CAT_MAX); lua_setfield(L,-2,"wxLOCALE_CAT_MAX");
	...
	lua_pushnumber(L,wxOS_PALM_OS); lua_setfield(L,-2,"wxOS_PALM_OS");
	lua_pushnumber(L,wxOS_PALM_LINUX); lua_setfield(L,-2,"wxOS_PALM_LINUX");
	lua_pushnumber(L,wxOS_PALM); lua_setfield(L,-2,"wxOS_PALM");
	...
	lua_pushnumber(L,wxPORT_PM); lua_setfield(L,-2,"wxPORT_PM");
	lua_pushnumber(L,wxPORT_OSX); lua_setfield(L,-2,"wxPORT_OSX");
	...
	lua_pushnumber(L,wxSIGIOT); lua_setfield(L,-2,"wxSIGIOT");
	...
	lua_pushnumber(L,wxSYS_DEFAULT_PALETTE); lua_setfield(L,-2,"wxSYS_DEFAULT_PALETTE");
	lua_pushnumber(L,wxSYS_SYSTEM_FIXED_FONT); lua_setfield(L,-2,"wxSYS_SYSTEM_FIXED_FONT");
	lua_pushnumber(L,wxSYS_ICONTITLE_FONT); lua_setfield(L,-2,"wxSYS_ICONTITLE_FONT");
	...
	lua_pushnumber(L,wxSYS_COLOUR_MAX); lua_setfield(L,-2,"wxSYS_COLOUR_MAX");
	...
	lua_pushnumber(L,wxSOCKET_OPTERR); lua_setfield(L,-2,"wxSOCKET_OPTERR");
	...
	lua_pushnumber(L,wxSHOW_EFFECT_MAX); lua_setfield(L,-2,"wxSHOW_EFFECT_MAX");
	...
	lua_newtable(L); // enum wxAnimationDisposal

	lua_pushnumber(L,wxANIM_UNSPECIFIED); lua_setfield(L,-2,"wxANIM_UNSPECIFIED");
	lua_pushnumber(L,wxANIM_DONOTREMOVE); lua_setfield(L,-2,"wxANIM_DONOTREMOVE");
	lua_pushnumber(L,wxANIM_TOBACKGROUND); lua_setfield(L,-2,"wxANIM_TOBACKGROUND");
	lua_pushnumber(L,wxANIM_TOPREVIOUS); lua_setfield(L,-2,"wxANIM_TOPREVIOUS");

	lua_setfield(L,-2,"wxAnimationDisposal");
	...
	lua_newtable(L); // enum unnamed_24

	lua_pushnumber(L,WX_ANY_VALUE_BUFFER_SIZE); lua_setfield(L,-2,"WX_ANY_VALUE_BUFFER_SIZE");

	lua_setfield(L,-2,"unnamed_24");

	lua_pushnumber(L,WX_ANY_VALUE_BUFFER_SIZE); lua_setfield(L,-2,"WX_ANY_VALUE_BUFFER_SIZE");


	lua_newtable(L); // enum unnamed_25

	lua_pushnumber(L,wxPRINT_WINDOWS); lua_setfield(L,-2,"wxPRINT_WINDOWS");
	lua_pushnumber(L,wxPRINT_POSTSCRIPT); lua_setfield(L,-2,"wxPRINT_POSTSCRIPT");

	lua_setfield(L,-2,"unnamed_25");
	...
	lua_newtable(L); // enum wxAuiNotebookOption

	lua_pushnumber(L,wxAUI_NB_TOP); lua_setfield(L,-2,"wxAUI_NB_TOP");
	lua_pushnumber(L,wxAUI_NB_LEFT); lua_setfield(L,-2,"wxAUI_NB_LEFT");
	lua_pushnumber(L,wxAUI_NB_RIGHT); lua_setfield(L,-2,"wxAUI_NB_RIGHT");
	lua_pushnumber(L,wxAUI_NB_BOTTOM); lua_setfield(L,-2,"wxAUI_NB_BOTTOM");
	lua_pushnumber(L,wxAUI_NB_TAB_SPLIT); lua_setfield(L,-2,"wxAUI_NB_TAB_SPLIT");
	lua_pushnumber(L,wxAUI_NB_TAB_MOVE); lua_setfield(L,-2,"wxAUI_NB_TAB_MOVE");
	lua_pushnumber(L,wxAUI_NB_TAB_EXTERNAL_MOVE); lua_setfield(L,-2,"wxAUI_NB_TAB_EXTERNAL_MOVE");
	lua_pushnumber(L,wxAUI_NB_TAB_FIXED_WIDTH); lua_setfield(L,-2,"wxAUI_NB_TAB_FIXED_WIDTH");
	lua_pushnumber(L,wxAUI_NB_SCROLL_BUTTONS); lua_setfield(L,-2,"wxAUI_NB_SCROLL_BUTTONS");
	lua_pushnumber(L,wxAUI_NB_WINDOWLIST_BUTTON); lua_setfield(L,-2,"wxAUI_NB_WINDOWLIST_BUTTON");
	lua_pushnumber(L,wxAUI_NB_CLOSE_BUTTON); lua_setfield(L,-2,"wxAUI_NB_CLOSE_BUTTON");
	lua_pushnumber(L,wxAUI_NB_CLOSE_ON_ACTIVE_TAB); lua_setfield(L,-2,"wxAUI_NB_CLOSE_ON_ACTIVE_TAB");
	lua_pushnumber(L,wxAUI_NB_CLOSE_ON_ALL_TABS); lua_setfield(L,-2,"wxAUI_NB_CLOSE_ON_ALL_TABS");
	lua_pushnumber(L,wxAUI_NB_MIDDLE_CLICK_CLOSE); lua_setfield(L,-2,"wxAUI_NB_MIDDLE_CLICK_CLOSE");
	lua_pushnumber(L,wxAUI_NB_DEFAULT_STYLE); lua_setfield(L,-2,"wxAUI_NB_DEFAULT_STYLE");

	lua_setfield(L,-2,"wxAuiNotebookOption");
	...
	lua_newtable(L); // enum wxAuiPaneInsertLevel

	lua_pushnumber(L,wxAUI_INSERT_PANE); lua_setfield(L,-2,"wxAUI_INSERT_PANE");
	lua_pushnumber(L,wxAUI_INSERT_ROW); lua_setfield(L,-2,"wxAUI_INSERT_ROW");
	lua_pushnumber(L,wxAUI_INSERT_DOCK); lua_setfield(L,-2,"wxAUI_INSERT_DOCK");

	lua_setfield(L,-2,"wxAuiPaneInsertLevel");
	...
	lua_newtable(L); // enum unnamed_26

	lua_pushnumber(L,wxBK_HITTEST_NOWHERE); lua_setfield(L,-2,"wxBK_HITTEST_NOWHERE");
	lua_pushnumber(L,wxBK_HITTEST_ONICON); lua_setfield(L,-2,"wxBK_HITTEST_ONICON");
	lua_pushnumber(L,wxBK_HITTEST_ONLABEL); lua_setfield(L,-2,"wxBK_HITTEST_ONLABEL");
	lua_pushnumber(L,wxBK_HITTEST_ONITEM); lua_setfield(L,-2,"wxBK_HITTEST_ONITEM");
	lua_pushnumber(L,wxBK_HITTEST_ONPAGE); lua_setfield(L,-2,"wxBK_HITTEST_ONPAGE");

	lua_setfield(L,-2,"unnamed_26");
	...
	lua_newtable(L); // enum unnamed_27

	lua_pushnumber(L,wxCAL_SUNDAY_FIRST); lua_setfield(L,-2,"wxCAL_SUNDAY_FIRST");
	lua_pushnumber(L,wxCAL_MONDAY_FIRST); lua_setfield(L,-2,"wxCAL_MONDAY_FIRST");
	lua_pushnumber(L,wxCAL_SHOW_HOLIDAYS); lua_setfield(L,-2,"wxCAL_SHOW_HOLIDAYS");
	lua_pushnumber(L,wxCAL_NO_YEAR_CHANGE); lua_setfield(L,-2,"wxCAL_NO_YEAR_CHANGE");
	lua_pushnumber(L,wxCAL_NO_MONTH_CHANGE); lua_setfield(L,-2,"wxCAL_NO_MONTH_CHANGE");
	lua_pushnumber(L,wxCAL_SEQUENTIAL_MONTH_SELECTION); lua_setfield(L,-2,"wxCAL_SEQUENTIAL_MONTH_SELECTION");
	lua_pushnumber(L,wxCAL_SHOW_SURROUNDING_WEEKS); lua_setfield(L,-2,"wxCAL_SHOW_SURROUNDING_WEEKS");
	lua_pushnumber(L,wxCAL_SHOW_WEEK_NUMBERS); lua_setfield(L,-2,"wxCAL_SHOW_WEEK_NUMBERS");

	lua_setfield(L,-2,"unnamed_27");
	...
	lua_newtable(L); // enum wxClientDataType

	lua_pushnumber(L,wxClientData_None); lua_setfield(L,-2,"wxClientData_None");
	lua_pushnumber(L,wxClientData_Object); lua_setfield(L,-2,"wxClientData_Object");
	lua_pushnumber(L,wxClientData_Void); lua_setfield(L,-2,"wxClientData_Void");

	lua_setfield(L,-2,"wxClientDataType");
	...
	lua_newtable(L); // enum unnamed_28

	lua_pushnumber(L,wxC2S_NAME); lua_setfield(L,-2,"wxC2S_NAME");
	lua_pushnumber(L,wxC2S_CSS_SYNTAX); lua_setfield(L,-2,"wxC2S_CSS_SYNTAX");
	lua_pushnumber(L,wxC2S_HTML_SYNTAX); lua_setfield(L,-2,"wxC2S_HTML_SYNTAX");

	lua_setfield(L,-2,"unnamed_28");
	...
	lua_newtable(L); // enum unnamed_29

	lua_pushnumber(L,wxCC_SPECIAL_DCLICK); lua_setfield(L,-2,"wxCC_SPECIAL_DCLICK");
	lua_pushnumber(L,wxCC_STD_BUTTON); lua_setfield(L,-2,"wxCC_STD_BUTTON");

	lua_setfield(L,-2,"unnamed_29");

	lua_pushnumber(L,wxCC_SPECIAL_DCLICK); lua_setfield(L,-2,"wxCC_SPECIAL_DCLICK");
	lua_pushnumber(L,wxCC_STD_BUTTON); lua_setfield(L,-2,"wxCC_STD_BUTTON");


	lua_newtable(L); // enum unnamed_30

	lua_pushnumber(L,wxCC_BUTTON_OUTSIDE_BORDER); lua_setfield(L,-2,"wxCC_BUTTON_OUTSIDE_BORDER");
	lua_pushnumber(L,wxCC_POPUP_ON_MOUSE_UP); lua_setfield(L,-2,"wxCC_POPUP_ON_MOUSE_UP");
	lua_pushnumber(L,wxCC_NO_TEXT_AUTO_SELECT); lua_setfield(L,-2,"wxCC_NO_TEXT_AUTO_SELECT");
	lua_pushnumber(L,wxCC_BUTTON_STAYS_DOWN); lua_setfield(L,-2,"wxCC_BUTTON_STAYS_DOWN");
	lua_pushnumber(L,wxCC_FULL_BUTTON); lua_setfield(L,-2,"wxCC_FULL_BUTTON");
	lua_pushnumber(L,wxCC_BUTTON_COVERS_BORDER); lua_setfield(L,-2,"wxCC_BUTTON_COVERS_BORDER");
	lua_pushnumber(L,wxCC_IFLAG_CREATED); lua_setfield(L,-2,"wxCC_IFLAG_CREATED");
	lua_pushnumber(L,wxCC_IFLAG_BUTTON_OUTSIDE); lua_setfield(L,-2,"wxCC_IFLAG_BUTTON_OUTSIDE");
	lua_pushnumber(L,wxCC_IFLAG_LEFT_MARGIN_SET); lua_setfield(L,-2,"wxCC_IFLAG_LEFT_MARGIN_SET");
	lua_pushnumber(L,wxCC_IFLAG_PARENT_TAB_TRAVERSAL); lua_setfield(L,-2,"wxCC_IFLAG_PARENT_TAB_TRAVERSAL");
	lua_pushnumber(L,wxCC_IFLAG_USE_ALT_POPUP); lua_setfield(L,-2,"wxCC_IFLAG_USE_ALT_POPUP");
	lua_pushnumber(L,wxCC_IFLAG_DISABLE_POPUP_ANIM); lua_setfield(L,-2,"wxCC_IFLAG_DISABLE_POPUP_ANIM");
	lua_pushnumber(L,wxCC_IFLAG_HAS_NONSTANDARD_BUTTON); lua_setfield(L,-2,"wxCC_IFLAG_HAS_NONSTANDARD_BUTTON");

	lua_setfield(L,-2,"unnamed_30");
	...
	lua_newtable(L); // enum unnamed_31

	lua_pushnumber(L,wxCC_MF_ON_BUTTON); lua_setfield(L,-2,"wxCC_MF_ON_BUTTON");
	lua_pushnumber(L,wxCC_MF_ON_CLICK_AREA); lua_setfield(L,-2,"wxCC_MF_ON_CLICK_AREA");

	lua_setfield(L,-2,"unnamed_31");

	lua_pushnumber(L,wxCC_MF_ON_BUTTON); lua_setfield(L,-2,"wxCC_MF_ON_BUTTON");
	lua_pushnumber(L,wxCC_MF_ON_CLICK_AREA); lua_setfield(L,-2,"wxCC_MF_ON_CLICK_AREA");


	lua_newtable(L); // enum unnamed_32

	lua_pushnumber(L,wxCP_IFLAG_CREATED); lua_setfield(L,-2,"wxCP_IFLAG_CREATED");

	lua_setfield(L,-2,"unnamed_32");

	lua_pushnumber(L,wxCP_IFLAG_CREATED); lua_setfield(L,-2,"wxCP_IFLAG_CREATED");


	lua_newtable(L); // enum unnamed_33

	lua_pushnumber(L,wxCONFIG_USE_LOCAL_FILE); lua_setfield(L,-2,"wxCONFIG_USE_LOCAL_FILE");
	lua_pushnumber(L,wxCONFIG_USE_GLOBAL_FILE); lua_setfield(L,-2,"wxCONFIG_USE_GLOBAL_FILE");
	lua_pushnumber(L,wxCONFIG_USE_RELATIVE_PATH); lua_setfield(L,-2,"wxCONFIG_USE_RELATIVE_PATH");
	lua_pushnumber(L,wxCONFIG_USE_NO_ESCAPE_CHARACTERS); lua_setfield(L,-2,"wxCONFIG_USE_NO_ESCAPE_CHARACTERS");
	lua_pushnumber(L,wxCONFIG_USE_SUBDIR); lua_setfield(L,-2,"wxCONFIG_USE_SUBDIR");

	lua_setfield(L,-2,"unnamed_33");
	...
	lua_newtable(L); // enum unnamed_34

	lua_pushnumber(L,wxDP_DEFAULT); lua_setfield(L,-2,"wxDP_DEFAULT");
	lua_pushnumber(L,wxDP_SPIN); lua_setfield(L,-2,"wxDP_SPIN");
	lua_pushnumber(L,wxDP_DROPDOWN); lua_setfield(L,-2,"wxDP_DROPDOWN");
	lua_pushnumber(L,wxDP_SHOWCENTURY); lua_setfield(L,-2,"wxDP_SHOWCENTURY");
	lua_pushnumber(L,wxDP_ALLOWNONE); lua_setfield(L,-2,"wxDP_ALLOWNONE");

	lua_setfield(L,-2,"unnamed_34");
	...
	lua_newtable(L); // enum unnamed_35

	lua_pushnumber(L,wxDefaultCoord); lua_setfield(L,-2,"wxDefaultCoord");

	lua_setfield(L,-2,"unnamed_35");
	...
	lua_newtable(L); // enum wxKeyType

	lua_pushnumber(L,wxKEY_NONE); lua_setfield(L,-2,"wxKEY_NONE");
	lua_pushnumber(L,wxKEY_INTEGER); lua_setfield(L,-2,"wxKEY_INTEGER");
	lua_pushnumber(L,wxKEY_STRING); lua_setfield(L,-2,"wxKEY_STRING");

	lua_setfield(L,-2,"wxKeyType");
	...
	lua_newtable(L); // enum wxDeprecatedGUIConstants

	lua_pushnumber(L,wxDEFAULT); lua_setfield(L,-2,"wxDEFAULT");
	lua_pushnumber(L,wxDECORATIVE); lua_setfield(L,-2,"wxDECORATIVE");
	lua_pushnumber(L,wxROMAN); lua_setfield(L,-2,"wxROMAN");
	lua_pushnumber(L,wxSCRIPT); lua_setfield(L,-2,"wxSCRIPT");
	lua_pushnumber(L,wxSWISS); lua_setfield(L,-2,"wxSWISS");
	lua_pushnumber(L,wxMODERN); lua_setfield(L,-2,"wxMODERN");
	lua_pushnumber(L,wxTELETYPE); lua_setfield(L,-2,"wxTELETYPE");
	lua_pushnumber(L,wxVARIABLE); lua_setfield(L,-2,"wxVARIABLE");
	lua_pushnumber(L,wxFIXED); lua_setfield(L,-2,"wxFIXED");
	lua_pushnumber(L,wxNORMAL); lua_setfield(L,-2,"wxNORMAL");
	lua_pushnumber(L,wxLIGHT); lua_setfield(L,-2,"wxLIGHT");
	lua_pushnumber(L,wxBOLD); lua_setfield(L,-2,"wxBOLD");
	lua_pushnumber(L,wxITALIC); lua_setfield(L,-2,"wxITALIC");
	lua_pushnumber(L,wxSLANT); lua_setfield(L,-2,"wxSLANT");
	lua_pushnumber(L,wxSOLID); lua_setfield(L,-2,"wxSOLID");
	lua_pushnumber(L,wxDOT); lua_setfield(L,-2,"wxDOT");
	lua_pushnumber(L,wxLONG_DASH); lua_setfield(L,-2,"wxLONG_DASH");
	lua_pushnumber(L,wxSHORT_DASH); lua_setfield(L,-2,"wxSHORT_DASH");
	lua_pushnumber(L,wxDOT_DASH); lua_setfield(L,-2,"wxDOT_DASH");
	lua_pushnumber(L,wxUSER_DASH); lua_setfield(L,-2,"wxUSER_DASH");
	lua_pushnumber(L,wxTRANSPARENT); lua_setfield(L,-2,"wxTRANSPARENT");
	lua_pushnumber(L,wxSTIPPLE_MASK_OPAQUE); lua_setfield(L,-2,"wxSTIPPLE_MASK_OPAQUE");
	lua_pushnumber(L,wxSTIPPLE_MASK); lua_setfield(L,-2,"wxSTIPPLE_MASK");
	lua_pushnumber(L,wxSTIPPLE); lua_setfield(L,-2,"wxSTIPPLE");
	lua_pushnumber(L,wxBDIAGONAL_HATCH); lua_setfield(L,-2,"wxBDIAGONAL_HATCH");
	lua_pushnumber(L,wxCROSSDIAG_HATCH); lua_setfield(L,-2,"wxCROSSDIAG_HATCH");
	lua_pushnumber(L,wxFDIAGONAL_HATCH); lua_setfield(L,-2,"wxFDIAGONAL_HATCH");
	lua_pushnumber(L,wxCROSS_HATCH); lua_setfield(L,-2,"wxCROSS_HATCH");
	lua_pushnumber(L,wxHORIZONTAL_HATCH); lua_setfield(L,-2,"wxHORIZONTAL_HATCH");
	lua_pushnumber(L,wxVERTICAL_HATCH); lua_setfield(L,-2,"wxVERTICAL_HATCH");
	lua_pushnumber(L,wxFIRST_HATCH); lua_setfield(L,-2,"wxFIRST_HATCH");
	lua_pushnumber(L,wxLAST_HATCH); lua_setfield(L,-2,"wxLAST_HATCH");

	lua_setfield(L,-2,"wxDeprecatedGUIConstants");
	...
	lua_newtable(L); // enum unnamed_36

	lua_pushnumber(L,wxTOOL_TOP); lua_setfield(L,-2,"wxTOOL_TOP");
	lua_pushnumber(L,wxTOOL_BOTTOM); lua_setfield(L,-2,"wxTOOL_BOTTOM");
	lua_pushnumber(L,wxTOOL_LEFT); lua_setfield(L,-2,"wxTOOL_LEFT");
	lua_pushnumber(L,wxTOOL_RIGHT); lua_setfield(L,-2,"wxTOOL_RIGHT");

	lua_setfield(L,-2,"unnamed_36");
	...
	lua_newtable(L); // enum wxDialogModality

	lua_pushnumber(L,wxDIALOG_MODALITY_NONE); lua_setfield(L,-2,"wxDIALOG_MODALITY_NONE");
	lua_pushnumber(L,wxDIALOG_MODALITY_WINDOW_MODAL); lua_setfield(L,-2,"wxDIALOG_MODALITY_WINDOW_MODAL");
	lua_pushnumber(L,wxDIALOG_MODALITY_APP_MODAL); lua_setfield(L,-2,"wxDIALOG_MODALITY_APP_MODAL");

	lua_setfield(L,-2,"wxDialogModality");
	...
	lua_newtable(L); // enum unnamed_37

	lua_pushnumber(L,wxDrag_CopyOnly); lua_setfield(L,-2,"wxDrag_CopyOnly");
	lua_pushnumber(L,wxDrag_AllowMove); lua_setfield(L,-2,"wxDrag_AllowMove");
	lua_pushnumber(L,wxDrag_DefaultMove); lua_setfield(L,-2,"wxDrag_DefaultMove");

	lua_setfield(L,-2,"unnamed_37");
	...
	lua_newtable(L); // enum unnamed_38

	lua_pushnumber(L,wxDOC_NEW); lua_setfield(L,-2,"wxDOC_NEW");
	lua_pushnumber(L,wxDOC_SILENT); lua_setfield(L,-2,"wxDOC_SILENT");

	lua_setfield(L,-2,"unnamed_38");

	lua_pushnumber(L,wxDOC_NEW); lua_setfield(L,-2,"wxDOC_NEW");
	lua_pushnumber(L,wxDOC_SILENT); lua_setfield(L,-2,"wxDOC_SILENT");


	lua_newtable(L); // enum unnamed_39

	lua_pushnumber(L,wxTEMPLATE_VISIBLE); lua_setfield(L,-2,"wxTEMPLATE_VISIBLE");
	lua_pushnumber(L,wxTEMPLATE_INVISIBLE); lua_setfield(L,-2,"wxTEMPLATE_INVISIBLE");
	lua_pushnumber(L,wxDEFAULT_TEMPLATE_FLAGS); lua_setfield(L,-2,"wxDEFAULT_TEMPLATE_FLAGS");

	lua_setfield(L,-2,"unnamed_39");
	...
	lua_newtable(L); // enum unnamed_40

	lua_pushnumber(L,wxDOC_SDI); lua_setfield(L,-2,"wxDOC_SDI");
	lua_pushnumber(L,wxDOC_MDI); lua_setfield(L,-2,"wxDOC_MDI");
	lua_pushnumber(L,wxDEFAULT_DOCMAN_FLAGS); lua_setfield(L,-2,"wxDEFAULT_DOCMAN_FLAGS");

	lua_setfield(L,-2,"unnamed_40");
	...
	lua_newtable(L); // enum wxDLFlags

	lua_pushnumber(L,wxDL_LAZY); lua_setfield(L,-2,"wxDL_LAZY");
	lua_pushnumber(L,wxDL_NOW); lua_setfield(L,-2,"wxDL_NOW");
	lua_pushnumber(L,wxDL_GLOBAL); lua_setfield(L,-2,"wxDL_GLOBAL");
	lua_pushnumber(L,wxDL_VERBATIM); lua_setfield(L,-2,"wxDL_VERBATIM");
	lua_pushnumber(L,wxDL_NOSHARE); lua_setfield(L,-2,"wxDL_NOSHARE");
	lua_pushnumber(L,wxDL_QUIET); lua_setfield(L,-2,"wxDL_QUIET");
	lua_pushnumber(L,wxDL_GET_LOADED); lua_setfield(L,-2,"wxDL_GET_LOADED");
	lua_pushnumber(L,wxDL_DEFAULT); lua_setfield(L,-2,"wxDL_DEFAULT");

	lua_setfield(L,-2,"wxDLFlags");
	...
	lua_newtable(L); // enum unnamed_41

	lua_pushnumber(L,wxCONVERT_STRICT); lua_setfield(L,-2,"wxCONVERT_STRICT");
	lua_pushnumber(L,wxCONVERT_SUBSTITUTE); lua_setfield(L,-2,"wxCONVERT_SUBSTITUTE");

	lua_setfield(L,-2,"unnamed_41");

	lua_pushnumber(L,wxCONVERT_STRICT); lua_setfield(L,-2,"wxCONVERT_STRICT");
	lua_pushnumber(L,wxCONVERT_SUBSTITUTE); lua_setfield(L,-2,"wxCONVERT_SUBSTITUTE");


	lua_newtable(L); // enum unnamed_42

	lua_pushnumber(L,wxPLATFORM_CURRENT); lua_setfield(L,-2,"wxPLATFORM_CURRENT");
	lua_pushnumber(L,wxPLATFORM_UNIX); lua_setfield(L,-2,"wxPLATFORM_UNIX");
	lua_pushnumber(L,wxPLATFORM_WINDOWS); lua_setfield(L,-2,"wxPLATFORM_WINDOWS");
	lua_pushnumber(L,wxPLATFORM_OS2); lua_setfield(L,-2,"wxPLATFORM_OS2");
	lua_pushnumber(L,wxPLATFORM_MAC); lua_setfield(L,-2,"wxPLATFORM_MAC");

	lua_setfield(L,-2,"unnamed_42");
	...
	lua_newtable(L); // enum unnamed_43

	lua_pushnumber(L,wxJOYSTICK1); lua_setfield(L,-2,"wxJOYSTICK1");
	lua_pushnumber(L,wxJOYSTICK2); lua_setfield(L,-2,"wxJOYSTICK2");

	lua_setfield(L,-2,"unnamed_43");

	lua_pushnumber(L,wxJOYSTICK1); lua_setfield(L,-2,"wxJOYSTICK1");
	lua_pushnumber(L,wxJOYSTICK2); lua_setfield(L,-2,"wxJOYSTICK2");


	lua_newtable(L); // enum unnamed_44

	lua_pushnumber(L,wxJOY_BUTTON_ANY); lua_setfield(L,-2,"wxJOY_BUTTON_ANY");
	lua_pushnumber(L,wxJOY_BUTTON1); lua_setfield(L,-2,"wxJOY_BUTTON1");
	lua_pushnumber(L,wxJOY_BUTTON2); lua_setfield(L,-2,"wxJOY_BUTTON2");
	lua_pushnumber(L,wxJOY_BUTTON3); lua_setfield(L,-2,"wxJOY_BUTTON3");
	lua_pushnumber(L,wxJOY_BUTTON4); lua_setfield(L,-2,"wxJOY_BUTTON4");

	lua_setfield(L,-2,"unnamed_44");
	...
	lua_newtable(L); // enum wxFindReplaceDialogStyles

	lua_pushnumber(L,wxFR_REPLACEDIALOG); lua_setfield(L,-2,"wxFR_REPLACEDIALOG");
	lua_pushnumber(L,wxFR_NOUPDOWN); lua_setfield(L,-2,"wxFR_NOUPDOWN");
	lua_pushnumber(L,wxFR_NOMATCHCASE); lua_setfield(L,-2,"wxFR_NOMATCHCASE");
	lua_pushnumber(L,wxFR_NOWHOLEWORD); lua_setfield(L,-2,"wxFR_NOWHOLEWORD");

	lua_setfield(L,-2,"wxFindReplaceDialogStyles");
	...
	lua_newtable(L); // enum unnamed_45

	lua_pushnumber(L,wxFC_OPEN); lua_setfield(L,-2,"wxFC_OPEN");
	lua_pushnumber(L,wxFC_SAVE); lua_setfield(L,-2,"wxFC_SAVE");
	lua_pushnumber(L,wxFC_MULTIPLE); lua_setfield(L,-2,"wxFC_MULTIPLE");
	lua_pushnumber(L,wxFC_NOSHOWHIDDEN); lua_setfield(L,-2,"wxFC_NOSHOWHIDDEN");

	lua_setfield(L,-2,"unnamed_45");
	...
	lua_newtable(L); // enum unnamed_46
	...
	lua_newtable(L); // enum unnamed_47

	lua_pushnumber(L,wxPATH_NO_SEPARATOR); lua_setfield(L,-2,"wxPATH_NO_SEPARATOR");
	lua_pushnumber(L,wxPATH_GET_VOLUME); lua_setfield(L,-2,"wxPATH_GET_VOLUME");
	lua_pushnumber(L,wxPATH_GET_SEPARATOR); lua_setfield(L,-2,"wxPATH_GET_SEPARATOR");

	lua_setfield(L,-2,"unnamed_47");
	...
	lua_newtable(L); // enum unnamed_48

	lua_pushnumber(L,wxPATH_MKDIR_FULL); lua_setfield(L,-2,"wxPATH_MKDIR_FULL");

	lua_setfield(L,-2,"unnamed_48");

	lua_pushnumber(L,wxPATH_MKDIR_FULL); lua_setfield(L,-2,"wxPATH_MKDIR_FULL");


	lua_newtable(L); // enum unnamed_49

	lua_pushnumber(L,wxPATH_RMDIR_FULL); lua_setfield(L,-2,"wxPATH_RMDIR_FULL");
	lua_pushnumber(L,wxPATH_RMDIR_RECURSIVE); lua_setfield(L,-2,"wxPATH_RMDIR_RECURSIVE");

	lua_setfield(L,-2,"unnamed_49");
	...
	lua_newtable(L); // enum unnamed_50
	...
	lua_newtable(L); // enum wxFSWPathType

	lua_pushnumber(L,wxFSWPath_None); lua_setfield(L,-2,"wxFSWPath_None");
	lua_pushnumber(L,wxFSWPath_File); lua_setfield(L,-2,"wxFSWPath_File");
	lua_pushnumber(L,wxFSWPath_Dir); lua_setfield(L,-2,"wxFSWPath_Dir");
	lua_pushnumber(L,wxFSWPath_Tree); lua_setfield(L,-2,"wxFSWPath_Tree");

	lua_setfield(L,-2,"wxFSWPathType");
	...
	lua_newtable(L); // enum wxGridDirection

	lua_pushnumber(L,wxGRID_COLUMN); lua_setfield(L,-2,"wxGRID_COLUMN");
	lua_pushnumber(L,wxGRID_ROW); lua_setfield(L,-2,"wxGRID_ROW");

	lua_setfield(L,-2,"wxGridDirection");

	lua_pushnumber(L,wxGRID_COLUMN); lua_setfield(L,-2,"wxGRID_COLUMN");
	lua_pushnumber(L,wxGRID_ROW); lua_setfield(L,-2,"wxGRID_ROW");


	lua_newtable(L); // enum wxGridTableRequest

	lua_pushnumber(L,wxGRIDTABLE_REQUEST_VIEW_GET_VALUES); lua_setfield(L,-2,"wxGRIDTABLE_REQUEST_VIEW_GET_VALUES");
	lua_pushnumber(L,wxGRIDTABLE_REQUEST_VIEW_SEND_VALUES); lua_setfield(L,-2,"wxGRIDTABLE_REQUEST_VIEW_SEND_VALUES");
	lua_pushnumber(L,wxGRIDTABLE_NOTIFY_ROWS_INSERTED); lua_setfield(L,-2,"wxGRIDTABLE_NOTIFY_ROWS_INSERTED");
	lua_pushnumber(L,wxGRIDTABLE_NOTIFY_ROWS_APPENDED); lua_setfield(L,-2,"wxGRIDTABLE_NOTIFY_ROWS_APPENDED");
	lua_pushnumber(L,wxGRIDTABLE_NOTIFY_ROWS_DELETED); lua_setfield(L,-2,"wxGRIDTABLE_NOTIFY_ROWS_DELETED");
	lua_pushnumber(L,wxGRIDTABLE_NOTIFY_COLS_INSERTED); lua_setfield(L,-2,"wxGRIDTABLE_NOTIFY_COLS_INSERTED");
	lua_pushnumber(L,wxGRIDTABLE_NOTIFY_COLS_APPENDED); lua_setfield(L,-2,"wxGRIDTABLE_NOTIFY_COLS_APPENDED");
	lua_pushnumber(L,wxGRIDTABLE_NOTIFY_COLS_DELETED); lua_setfield(L,-2,"wxGRIDTABLE_NOTIFY_COLS_DELETED");

	lua_setfield(L,-2,"wxGridTableRequest");
	...
	lua_newtable(L); // enum wxGIFErrorCode

	lua_pushnumber(L,wxGIF_OK); lua_setfield(L,-2,"wxGIF_OK");
	lua_pushnumber(L,wxGIF_INVFORMAT); lua_setfield(L,-2,"wxGIF_INVFORMAT");
	lua_pushnumber(L,wxGIF_MEMERR); lua_setfield(L,-2,"wxGIF_MEMERR");
	lua_pushnumber(L,wxGIF_TRUNCATED); lua_setfield(L,-2,"wxGIF_TRUNCATED");

	lua_setfield(L,-2,"wxGIFErrorCode");
	...
	lua_newtable(L); // enum unnamed_51
	...
	lua_newtable(L); // enum unnamed_52

	lua_pushnumber(L,wxCOL_WIDTH_DEFAULT); lua_setfield(L,-2,"wxCOL_WIDTH_DEFAULT");
	lua_pushnumber(L,wxCOL_WIDTH_AUTOSIZE); lua_setfield(L,-2,"wxCOL_WIDTH_AUTOSIZE");

	lua_setfield(L,-2,"unnamed_52");

	lua_pushnumber(L,wxCOL_WIDTH_DEFAULT); lua_setfield(L,-2,"wxCOL_WIDTH_DEFAULT");
	lua_pushnumber(L,wxCOL_WIDTH_AUTOSIZE); lua_setfield(L,-2,"wxCOL_WIDTH_AUTOSIZE");


	lua_newtable(L); // enum unnamed_53
	...
	lua_newtable(L); // enum unnamed_54

	lua_pushnumber(L,wxHD_ALLOW_REORDER); lua_setfield(L,-2,"wxHD_ALLOW_REORDER");
	lua_pushnumber(L,wxHD_ALLOW_HIDE); lua_setfield(L,-2,"wxHD_ALLOW_HIDE");
	lua_pushnumber(L,wxHD_DEFAULT_STYLE); lua_setfield(L,-2,"wxHD_DEFAULT_STYLE");

	lua_setfield(L,-2,"unnamed_54");
	...
	lua_newtable(L); // enum unnamed_55

	lua_pushnumber(L,wxID_HTML_PANEL); lua_setfield(L,-2,"wxID_HTML_PANEL");
	lua_pushnumber(L,wxID_HTML_BACK); lua_setfield(L,-2,"wxID_HTML_BACK");
	lua_pushnumber(L,wxID_HTML_FORWARD); lua_setfield(L,-2,"wxID_HTML_FORWARD");
	lua_pushnumber(L,wxID_HTML_UPNODE); lua_setfield(L,-2,"wxID_HTML_UPNODE");
	lua_pushnumber(L,wxID_HTML_UP); lua_setfield(L,-2,"wxID_HTML_UP");
	lua_pushnumber(L,wxID_HTML_DOWN); lua_setfield(L,-2,"wxID_HTML_DOWN");
	lua_pushnumber(L,wxID_HTML_PRINT); lua_setfield(L,-2,"wxID_HTML_PRINT");
	lua_pushnumber(L,wxID_HTML_OPENFILE); lua_setfield(L,-2,"wxID_HTML_OPENFILE");
	lua_pushnumber(L,wxID_HTML_OPTIONS); lua_setfield(L,-2,"wxID_HTML_OPTIONS");
	lua_pushnumber(L,wxID_HTML_BOOKMARKSLIST); lua_setfield(L,-2,"wxID_HTML_BOOKMARKSLIST");
	lua_pushnumber(L,wxID_HTML_BOOKMARKSADD); lua_setfield(L,-2,"wxID_HTML_BOOKMARKSADD");
	lua_pushnumber(L,wxID_HTML_BOOKMARKSREMOVE); lua_setfield(L,-2,"wxID_HTML_BOOKMARKSREMOVE");
	lua_pushnumber(L,wxID_HTML_TREECTRL); lua_setfield(L,-2,"wxID_HTML_TREECTRL");
	lua_pushnumber(L,wxID_HTML_INDEXPAGE); lua_setfield(L,-2,"wxID_HTML_INDEXPAGE");
	lua_pushnumber(L,wxID_HTML_INDEXLIST); lua_setfield(L,-2,"wxID_HTML_INDEXLIST");
	lua_pushnumber(L,wxID_HTML_INDEXTEXT); lua_setfield(L,-2,"wxID_HTML_INDEXTEXT");
	lua_pushnumber(L,wxID_HTML_INDEXBUTTON); lua_setfield(L,-2,"wxID_HTML_INDEXBUTTON");
	lua_pushnumber(L,wxID_HTML_INDEXBUTTONALL); lua_setfield(L,-2,"wxID_HTML_INDEXBUTTONALL");
	lua_pushnumber(L,wxID_HTML_NOTEBOOK); lua_setfield(L,-2,"wxID_HTML_NOTEBOOK");
	lua_pushnumber(L,wxID_HTML_SEARCHPAGE); lua_setfield(L,-2,"wxID_HTML_SEARCHPAGE");
	lua_pushnumber(L,wxID_HTML_SEARCHTEXT); lua_setfield(L,-2,"wxID_HTML_SEARCHTEXT");
	lua_pushnumber(L,wxID_HTML_SEARCHLIST); lua_setfield(L,-2,"wxID_HTML_SEARCHLIST");
	lua_pushnumber(L,wxID_HTML_SEARCHBUTTON); lua_setfield(L,-2,"wxID_HTML_SEARCHBUTTON");
	lua_pushnumber(L,wxID_HTML_SEARCHCHOICE); lua_setfield(L,-2,"wxID_HTML_SEARCHCHOICE");
	lua_pushnumber(L,wxID_HTML_COUNTINFO); lua_setfield(L,-2,"wxID_HTML_COUNTINFO");

	lua_setfield(L,-2,"unnamed_55");
	...
	lua_newtable(L); // enum wxHtmlSelectionState

	lua_pushnumber(L,wxHTML_SEL_OUT); lua_setfield(L,-2,"wxHTML_SEL_OUT");
	lua_pushnumber(L,wxHTML_SEL_IN); lua_setfield(L,-2,"wxHTML_SEL_IN");
	lua_pushnumber(L,wxHTML_SEL_CHANGING); lua_setfield(L,-2,"wxHTML_SEL_CHANGING");

	lua_setfield(L,-2,"wxHtmlSelectionState");
	...
	lua_newtable(L); // enum unnamed_56

	lua_pushnumber(L,wxHTML_FIND_EXACT); lua_setfield(L,-2,"wxHTML_FIND_EXACT");
	lua_pushnumber(L,wxHTML_FIND_NEAREST_BEFORE); lua_setfield(L,-2,"wxHTML_FIND_NEAREST_BEFORE");
	lua_pushnumber(L,wxHTML_FIND_NEAREST_AFTER); lua_setfield(L,-2,"wxHTML_FIND_NEAREST_AFTER");

	lua_setfield(L,-2,"unnamed_56");
	...
	lua_newtable(L); // enum wxHtmlScriptMode

	lua_pushnumber(L,wxHTML_SCRIPT_NORMAL); lua_setfield(L,-2,"wxHTML_SCRIPT_NORMAL");
	lua_pushnumber(L,wxHTML_SCRIPT_SUB); lua_setfield(L,-2,"wxHTML_SCRIPT_SUB");
	lua_pushnumber(L,wxHTML_SCRIPT_SUP); lua_setfield(L,-2,"wxHTML_SCRIPT_SUP");

	lua_setfield(L,-2,"wxHtmlScriptMode");
	...
	lua_newtable(L); // enum wxHtmlURLType

	lua_pushnumber(L,wxHTML_URL_PAGE); lua_setfield(L,-2,"wxHTML_URL_PAGE");
	lua_pushnumber(L,wxHTML_URL_IMAGE); lua_setfield(L,-2,"wxHTML_URL_IMAGE");
	lua_pushnumber(L,wxHTML_URL_OTHER); lua_setfield(L,-2,"wxHTML_URL_OTHER");

	lua_setfield(L,-2,"wxHtmlURLType");
	...
	lua_newtable(L); // enum unnamed_57

	lua_pushnumber(L,wxHTML_PRIORITY_DONTCARE); lua_setfield(L,-2,"wxHTML_PRIORITY_DONTCARE");
	lua_pushnumber(L,wxHTML_PRIORITY_SYSTEM); lua_setfield(L,-2,"wxHTML_PRIORITY_SYSTEM");

	lua_setfield(L,-2,"unnamed_57");

	lua_pushnumber(L,wxHTML_PRIORITY_DONTCARE); lua_setfield(L,-2,"wxHTML_PRIORITY_DONTCARE");
	lua_pushnumber(L,wxHTML_PRIORITY_SYSTEM); lua_setfield(L,-2,"wxHTML_PRIORITY_SYSTEM");


	lua_newtable(L); // enum wxHtmlOpeningStatus

	lua_pushnumber(L,wxHTML_OPEN); lua_setfield(L,-2,"wxHTML_OPEN");
	lua_pushnumber(L,wxHTML_BLOCK); lua_setfield(L,-2,"wxHTML_BLOCK");
	lua_pushnumber(L,wxHTML_REDIRECT); lua_setfield(L,-2,"wxHTML_REDIRECT");

	lua_setfield(L,-2,"wxHtmlOpeningStatus");
	...
	lua_newtable(L); // enum unnamed_58

	lua_pushnumber(L,wxPAGE_ODD); lua_setfield(L,-2,"wxPAGE_ODD");
	lua_pushnumber(L,wxPAGE_EVEN); lua_setfield(L,-2,"wxPAGE_EVEN");
	lua_pushnumber(L,wxPAGE_ALL); lua_setfield(L,-2,"wxPAGE_ALL");

	lua_setfield(L,-2,"unnamed_58");
	...
	lua_newtable(L); // enum unnamed_59
	...
	lua_newtable(L); // enum unnamed_60

	lua_pushnumber(L,wxIMAGE_LIST_NORMAL); lua_setfield(L,-2,"wxIMAGE_LIST_NORMAL");
	lua_pushnumber(L,wxIMAGE_LIST_SMALL); lua_setfield(L,-2,"wxIMAGE_LIST_SMALL");
	lua_pushnumber(L,wxIMAGE_LIST_STATE); lua_setfield(L,-2,"wxIMAGE_LIST_STATE");

	lua_setfield(L,-2,"unnamed_60");
	...
	lua_newtable(L); // enum unnamed_61
	...
	lua_newtable(L); // enum wxLocaleInitFlags

	lua_pushnumber(L,wxLOCALE_DONT_LOAD_DEFAULT); lua_setfield(L,-2,"wxLOCALE_DONT_LOAD_DEFAULT");
	lua_pushnumber(L,wxLOCALE_LOAD_DEFAULT); lua_setfield(L,-2,"wxLOCALE_LOAD_DEFAULT");

	lua_setfield(L,-2,"wxLocaleInitFlags");
	...
	lua_newtable(L); // enum unnamed_62

	lua_pushnumber(L,wxLIST_NEXT_ABOVE); lua_setfield(L,-2,"wxLIST_NEXT_ABOVE");
	lua_pushnumber(L,wxLIST_NEXT_ALL); lua_setfield(L,-2,"wxLIST_NEXT_ALL");
	lua_pushnumber(L,wxLIST_NEXT_BELOW); lua_setfield(L,-2,"wxLIST_NEXT_BELOW");
	lua_pushnumber(L,wxLIST_NEXT_LEFT); lua_setfield(L,-2,"wxLIST_NEXT_LEFT");
	lua_pushnumber(L,wxLIST_NEXT_RIGHT); lua_setfield(L,-2,"wxLIST_NEXT_RIGHT");

	lua_setfield(L,-2,"unnamed_62");
	...
	lua_newtable(L); // enum unnamed_63

	lua_pushnumber(L,wxLIST_ALIGN_DEFAULT); lua_setfield(L,-2,"wxLIST_ALIGN_DEFAULT");
	lua_pushnumber(L,wxLIST_ALIGN_LEFT); lua_setfield(L,-2,"wxLIST_ALIGN_LEFT");
	lua_pushnumber(L,wxLIST_ALIGN_TOP); lua_setfield(L,-2,"wxLIST_ALIGN_TOP");
	lua_pushnumber(L,wxLIST_ALIGN_SNAP_TO_GRID); lua_setfield(L,-2,"wxLIST_ALIGN_SNAP_TO_GRID");

	lua_setfield(L,-2,"unnamed_63");
	...
	lua_newtable(L); // enum unnamed_64

	lua_pushnumber(L,wxLIST_AUTOSIZE); lua_setfield(L,-2,"wxLIST_AUTOSIZE");
	lua_pushnumber(L,wxLIST_AUTOSIZE_USEHEADER); lua_setfield(L,-2,"wxLIST_AUTOSIZE_USEHEADER");

	lua_setfield(L,-2,"unnamed_64");

	lua_pushnumber(L,wxLIST_AUTOSIZE); lua_setfield(L,-2,"wxLIST_AUTOSIZE");
	lua_pushnumber(L,wxLIST_AUTOSIZE_USEHEADER); lua_setfield(L,-2,"wxLIST_AUTOSIZE_USEHEADER");


	lua_newtable(L); // enum unnamed_65

	lua_pushnumber(L,wxLIST_RECT_BOUNDS); lua_setfield(L,-2,"wxLIST_RECT_BOUNDS");
	lua_pushnumber(L,wxLIST_RECT_ICON); lua_setfield(L,-2,"wxLIST_RECT_ICON");
	lua_pushnumber(L,wxLIST_RECT_LABEL); lua_setfield(L,-2,"wxLIST_RECT_LABEL");

	lua_setfield(L,-2,"unnamed_65");
	...
	lua_newtable(L); // enum unnamed_66

	lua_pushnumber(L,wxLIST_FIND_UP); lua_setfield(L,-2,"wxLIST_FIND_UP");
	lua_pushnumber(L,wxLIST_FIND_DOWN); lua_setfield(L,-2,"wxLIST_FIND_DOWN");
	lua_pushnumber(L,wxLIST_FIND_LEFT); lua_setfield(L,-2,"wxLIST_FIND_LEFT");
	lua_pushnumber(L,wxLIST_FIND_RIGHT); lua_setfield(L,-2,"wxLIST_FIND_RIGHT");

	lua_setfield(L,-2,"unnamed_66");
	...
	lua_newtable(L); // enum wxMediaState

	lua_pushnumber(L,wxMEDIASTATE_STOPPED); lua_setfield(L,-2,"wxMEDIASTATE_STOPPED");
	lua_pushnumber(L,wxMEDIASTATE_PAUSED); lua_setfield(L,-2,"wxMEDIASTATE_PAUSED");
	lua_pushnumber(L,wxMEDIASTATE_PLAYING); lua_setfield(L,-2,"wxMEDIASTATE_PLAYING");

	lua_setfield(L,-2,"wxMediaState");
	...
	lua_newtable(L); // enum wxMailcapStyle

	lua_pushnumber(L,wxMAILCAP_STANDARD); lua_setfield(L,-2,"wxMAILCAP_STANDARD");
	lua_pushnumber(L,wxMAILCAP_NETSCAPE); lua_setfield(L,-2,"wxMAILCAP_NETSCAPE");
	lua_pushnumber(L,wxMAILCAP_KDE); lua_setfield(L,-2,"wxMAILCAP_KDE");
	lua_pushnumber(L,wxMAILCAP_GNOME); lua_setfield(L,-2,"wxMAILCAP_GNOME");
	lua_pushnumber(L,wxMAILCAP_ALL); lua_setfield(L,-2,"wxMAILCAP_ALL");

	lua_setfield(L,-2,"wxMailcapStyle");
	...
	lua_newtable(L); // enum wxMessageOutputFlags

	lua_pushnumber(L,wxMSGOUT_PREFER_STDERR); lua_setfield(L,-2,"wxMSGOUT_PREFER_STDERR");
	lua_pushnumber(L,wxMSGOUT_PREFER_MSGBOX); lua_setfield(L,-2,"wxMSGOUT_PREFER_MSGBOX");

	lua_setfield(L,-2,"wxMessageOutputFlags");
	...
	lua_newtable(L); // enum wxBitmapTransparency

	lua_pushnumber(L,wxBitmapTransparency_Auto); lua_setfield(L,-2,"wxBitmapTransparency_Auto");
	lua_pushnumber(L,wxBitmapTransparency_None); lua_setfield(L,-2,"wxBitmapTransparency_None");
	lua_pushnumber(L,wxBitmapTransparency_Always); lua_setfield(L,-2,"wxBitmapTransparency_Always");

	lua_setfield(L,-2,"wxBitmapTransparency");
	...
	lua_newtable(L); // enum unnamed_67
	...
	lua_newtable(L); // enum unnamed_68

	lua_pushnumber(L,wxODCB_DCLICK_CYCLES); lua_setfield(L,-2,"wxODCB_DCLICK_CYCLES");
	lua_pushnumber(L,wxODCB_STD_CONTROL_PAINT); lua_setfield(L,-2,"wxODCB_STD_CONTROL_PAINT");

	lua_setfield(L,-2,"unnamed_68");
	...
	lua_newtable(L); // enum wxPrinterError

	lua_pushnumber(L,wxPRINTER_NO_ERROR); lua_setfield(L,-2,"wxPRINTER_NO_ERROR");
	lua_pushnumber(L,wxPRINTER_CANCELLED); lua_setfield(L,-2,"wxPRINTER_CANCELLED");
	lua_pushnumber(L,wxPRINTER_ERROR); lua_setfield(L,-2,"wxPRINTER_ERROR");

	lua_setfield(L,-2,"wxPrinterError");
	...
	lua_newtable(L); // enum unnamed_69

	lua_pushnumber(L,wxPROCESS_DEFAULT); lua_setfield(L,-2,"wxPROCESS_DEFAULT");
	lua_pushnumber(L,wxPROCESS_REDIRECT); lua_setfield(L,-2,"wxPROCESS_REDIRECT");

	lua_setfield(L,-2,"unnamed_69");
	...
	lua_newtable(L); // enum wxPG_GETPROPERTYVALUES_FLAGS

	lua_pushnumber(L,wxPG_KEEP_STRUCTURE); lua_setfield(L,-2,"wxPG_KEEP_STRUCTURE");
	lua_pushnumber(L,wxPG_RECURSE); lua_setfield(L,-2,"wxPG_RECURSE");
	lua_pushnumber(L,wxPG_INC_ATTRIBUTES); lua_setfield(L,-2,"wxPG_INC_ATTRIBUTES");
	lua_pushnumber(L,wxPG_RECURSE_STARTS); lua_setfield(L,-2,"wxPG_RECURSE_STARTS");
	lua_pushnumber(L,wxPG_FORCE); lua_setfield(L,-2,"wxPG_FORCE");
	lua_pushnumber(L,wxPG_SORT_TOP_LEVEL_ONLY); lua_setfield(L,-2,"wxPG_SORT_TOP_LEVEL_ONLY");

	lua_setfield(L,-2,"wxPG_GETPROPERTYVALUES_FLAGS");
	...
	lua_newtable(L); // enum wxPG_MISC_ARG_FLAGS

	lua_pushnumber(L,wxPG_FULL_VALUE); lua_setfield(L,-2,"wxPG_FULL_VALUE");
	lua_pushnumber(L,wxPG_REPORT_ERROR); lua_setfield(L,-2,"wxPG_REPORT_ERROR");
	lua_pushnumber(L,wxPG_PROPERTY_SPECIFIC); lua_setfield(L,-2,"wxPG_PROPERTY_SPECIFIC");
	lua_pushnumber(L,wxPG_EDITABLE_VALUE); lua_setfield(L,-2,"wxPG_EDITABLE_VALUE");
	lua_pushnumber(L,wxPG_COMPOSITE_FRAGMENT); lua_setfield(L,-2,"wxPG_COMPOSITE_FRAGMENT");
	lua_pushnumber(L,wxPG_UNEDITABLE_COMPOSITE_FRAGMENT); lua_setfield(L,-2,"wxPG_UNEDITABLE_COMPOSITE_FRAGMENT");
	lua_pushnumber(L,wxPG_VALUE_IS_CURRENT); lua_setfield(L,-2,"wxPG_VALUE_IS_CURRENT");
	lua_pushnumber(L,wxPG_PROGRAMMATIC_VALUE); lua_setfield(L,-2,"wxPG_PROGRAMMATIC_VALUE");

	lua_setfield(L,-2,"wxPG_MISC_ARG_FLAGS");
	...
	lua_newtable(L); // enum wxPG_SETVALUE_FLAGS

	lua_pushnumber(L,wxPG_SETVAL_REFRESH_EDITOR); lua_setfield(L,-2,"wxPG_SETVAL_REFRESH_EDITOR");
	lua_pushnumber(L,wxPG_SETVAL_AGGREGATED); lua_setfield(L,-2,"wxPG_SETVAL_AGGREGATED");
	lua_pushnumber(L,wxPG_SETVAL_FROM_PARENT); lua_setfield(L,-2,"wxPG_SETVAL_FROM_PARENT");
	lua_pushnumber(L,wxPG_SETVAL_BY_USER); lua_setfield(L,-2,"wxPG_SETVAL_BY_USER");

	lua_setfield(L,-2,"wxPG_SETVALUE_FLAGS");
	...
	lua_newtable(L); // enum wxPGNumericValidationConstants

	lua_pushnumber(L,wxPG_PROPERTY_VALIDATION_ERROR_MESSAGE); lua_setfield(L,-2,"wxPG_PROPERTY_VALIDATION_ERROR_MESSAGE");
	lua_pushnumber(L,wxPG_PROPERTY_VALIDATION_SATURATE); lua_setfield(L,-2,"wxPG_PROPERTY_VALIDATION_SATURATE");
	lua_pushnumber(L,wxPG_PROPERTY_VALIDATION_WRAP); lua_setfield(L,-2,"wxPG_PROPERTY_VALIDATION_WRAP");

	lua_setfield(L,-2,"wxPGNumericValidationConstants");
	...
	lua_newtable(L); // enum unnamed_70
	...
	lua_newtable(L); // enum unnamed_71

	lua_pushnumber(L,wxRE_NOTBOL); lua_setfield(L,-2,"wxRE_NOTBOL");
	lua_pushnumber(L,wxRE_NOTEOL); lua_setfield(L,-2,"wxRE_NOTEOL");

	lua_setfield(L,-2,"unnamed_71");
	...
	lua_newtable(L); // enum wxRegionOp

	lua_pushnumber(L,wxRGN_AND); lua_setfield(L,-2,"wxRGN_AND");
	lua_pushnumber(L,wxRGN_COPY); lua_setfield(L,-2,"wxRGN_COPY");
	lua_pushnumber(L,wxRGN_DIFF); lua_setfield(L,-2,"wxRGN_DIFF");
	lua_pushnumber(L,wxRGN_OR); lua_setfield(L,-2,"wxRGN_OR");
	lua_pushnumber(L,wxRGN_XOR); lua_setfield(L,-2,"wxRGN_XOR");

	lua_setfield(L,-2,"wxRegionOp");
	...
	lua_newtable(L); // enum unnamed_72
	...
	lua_pushnumber(L,wxCONTROL_CHECKABLE); lua_setfield(L,-2,"wxCONTROL_CHECKABLE");
	lua_pushnumber(L,wxCONTROL_UNDETERMINED); lua_setfield(L,-2,"wxCONTROL_UNDETERMINED");
	lua_pushnumber(L,wxCONTROL_FLAGS_MASK); lua_setfield(L,-2,"wxCONTROL_FLAGS_MASK");
	lua_pushnumber(L,wxCONTROL_DIRTY); lua_setfield(L,-2,"wxCONTROL_DIRTY");

	lua_setfield(L,-2,"unnamed_72");
	...
	lua_newtable(L); // enum wxRibbonBarOption

	lua_pushnumber(L,wxRIBBON_BAR_SHOW_PAGE_LABELS); lua_setfield(L,-2,"wxRIBBON_BAR_SHOW_PAGE_LABELS");
	lua_pushnumber(L,wxRIBBON_BAR_SHOW_PAGE_ICONS); lua_setfield(L,-2,"wxRIBBON_BAR_SHOW_PAGE_ICONS");
	lua_pushnumber(L,wxRIBBON_BAR_FLOW_HORIZONTAL); lua_setfield(L,-2,"wxRIBBON_BAR_FLOW_HORIZONTAL");
	lua_pushnumber(L,wxRIBBON_BAR_FLOW_VERTICAL); lua_setfield(L,-2,"wxRIBBON_BAR_FLOW_VERTICAL");
	lua_pushnumber(L,wxRIBBON_BAR_SHOW_PANEL_EXT_BUTTONS); lua_setfield(L,-2,"wxRIBBON_BAR_SHOW_PANEL_EXT_BUTTONS");
	lua_pushnumber(L,wxRIBBON_BAR_SHOW_PANEL_MINIMISE_BUTTONS); lua_setfield(L,-2,"wxRIBBON_BAR_SHOW_PANEL_MINIMISE_BUTTONS");
	lua_pushnumber(L,wxRIBBON_BAR_ALWAYS_SHOW_TABS); lua_setfield(L,-2,"wxRIBBON_BAR_ALWAYS_SHOW_TABS");
	lua_pushnumber(L,wxRIBBON_BAR_DEFAULT_STYLE); lua_setfield(L,-2,"wxRIBBON_BAR_DEFAULT_STYLE");
	lua_pushnumber(L,wxRIBBON_BAR_FOLDBAR_STYLE); lua_setfield(L,-2,"wxRIBBON_BAR_FOLDBAR_STYLE");

	lua_setfield(L,-2,"wxRibbonBarOption");
	...
	lua_newtable(L); // enum wxRibbonPanelOption

	lua_pushnumber(L,wxRIBBON_PANEL_NO_AUTO_MINIMISE); lua_setfield(L,-2,"wxRIBBON_PANEL_NO_AUTO_MINIMISE");
	lua_pushnumber(L,wxRIBBON_PANEL_EXT_BUTTON); lua_setfield(L,-2,"wxRIBBON_PANEL_EXT_BUTTON");
	lua_pushnumber(L,wxRIBBON_PANEL_MINIMISE_BUTTON); lua_setfield(L,-2,"wxRIBBON_PANEL_MINIMISE_BUTTON");
	lua_pushnumber(L,wxRIBBON_PANEL_DEFAULT_STYLE); lua_setfield(L,-2,"wxRIBBON_PANEL_DEFAULT_STYLE");

	lua_setfield(L,-2,"wxRibbonPanelOption");
	...
	lua_newtable(L); // enum wxRibbonToolBarToolState

	lua_pushnumber(L,wxRIBBON_TOOLBAR_TOOL_FIRST); lua_setfield(L,-2,"wxRIBBON_TOOLBAR_TOOL_FIRST");
	lua_pushnumber(L,wxRIBBON_TOOLBAR_TOOL_LAST); lua_setfield(L,-2,"wxRIBBON_TOOLBAR_TOOL_LAST");
	lua_pushnumber(L,wxRIBBON_TOOLBAR_TOOL_POSITION_MASK); lua_setfield(L,-2,"wxRIBBON_TOOLBAR_TOOL_POSITION_MASK");
	lua_pushnumber(L,wxRIBBON_TOOLBAR_TOOL_NORMAL_HOVERED); lua_setfield(L,-2,"wxRIBBON_TOOLBAR_TOOL_NORMAL_HOVERED");
	lua_pushnumber(L,wxRIBBON_TOOLBAR_TOOL_DROPDOWN_HOVERED); lua_setfield(L,-2,"wxRIBBON_TOOLBAR_TOOL_DROPDOWN_HOVERED");
	lua_pushnumber(L,wxRIBBON_TOOLBAR_TOOL_HOVER_MASK); lua_setfield(L,-2,"wxRIBBON_TOOLBAR_TOOL_HOVER_MASK");
	lua_pushnumber(L,wxRIBBON_TOOLBAR_TOOL_NORMAL_ACTIVE); lua_setfield(L,-2,"wxRIBBON_TOOLBAR_TOOL_NORMAL_ACTIVE");
	lua_pushnumber(L,wxRIBBON_TOOLBAR_TOOL_DROPDOWN_ACTIVE); lua_setfield(L,-2,"wxRIBBON_TOOLBAR_TOOL_DROPDOWN_ACTIVE");
	lua_pushnumber(L,wxRIBBON_TOOLBAR_TOOL_ACTIVE_MASK); lua_setfield(L,-2,"wxRIBBON_TOOLBAR_TOOL_ACTIVE_MASK");
	lua_pushnumber(L,wxRIBBON_TOOLBAR_TOOL_DISABLED); lua_setfield(L,-2,"wxRIBBON_TOOLBAR_TOOL_DISABLED");
	lua_pushnumber(L,wxRIBBON_TOOLBAR_TOOL_STATE_MASK); lua_setfield(L,-2,"wxRIBBON_TOOLBAR_TOOL_STATE_MASK");

	lua_setfield(L,-2,"wxRibbonToolBarToolState");
	...
	lua_newtable(L); // enum unnamed_73

	lua_pushnumber(L,wxRICHTEXT_BULLETINDEX_NONE); lua_setfield(L,-2,"wxRICHTEXT_BULLETINDEX_NONE");
	lua_pushnumber(L,wxRICHTEXT_BULLETINDEX_ARABIC); lua_setfield(L,-2,"wxRICHTEXT_BULLETINDEX_ARABIC");
	lua_pushnumber(L,wxRICHTEXT_BULLETINDEX_UPPER_CASE); lua_setfield(L,-2,"wxRICHTEXT_BULLETINDEX_UPPER_CASE");
	lua_pushnumber(L,wxRICHTEXT_BULLETINDEX_LOWER_CASE); lua_setfield(L,-2,"wxRICHTEXT_BULLETINDEX_LOWER_CASE");
	lua_pushnumber(L,wxRICHTEXT_BULLETINDEX_UPPER_CASE_ROMAN); lua_setfield(L,-2,"wxRICHTEXT_BULLETINDEX_UPPER_CASE_ROMAN");
	lua_pushnumber(L,wxRICHTEXT_BULLETINDEX_LOWER_CASE_ROMAN); lua_setfield(L,-2,"wxRICHTEXT_BULLETINDEX_LOWER_CASE_ROMAN");
	lua_pushnumber(L,wxRICHTEXT_BULLETINDEX_OUTLINE); lua_setfield(L,-2,"wxRICHTEXT_BULLETINDEX_OUTLINE");
	lua_pushnumber(L,wxRICHTEXT_BULLETINDEX_SYMBOL); lua_setfield(L,-2,"wxRICHTEXT_BULLETINDEX_SYMBOL");
	lua_pushnumber(L,wxRICHTEXT_BULLETINDEX_BITMAP); lua_setfield(L,-2,"wxRICHTEXT_BULLETINDEX_BITMAP");
	lua_pushnumber(L,wxRICHTEXT_BULLETINDEX_STANDARD); lua_setfield(L,-2,"wxRICHTEXT_BULLETINDEX_STANDARD");

	lua_setfield(L,-2,"unnamed_73");
	...
	lua_newtable(L); // enum wxRichTextOddEvenPage

	lua_pushnumber(L,wxRICHTEXT_PAGE_ODD); lua_setfield(L,-2,"wxRICHTEXT_PAGE_ODD");
	lua_pushnumber(L,wxRICHTEXT_PAGE_EVEN); lua_setfield(L,-2,"wxRICHTEXT_PAGE_EVEN");
	lua_pushnumber(L,wxRICHTEXT_PAGE_ALL); lua_setfield(L,-2,"wxRICHTEXT_PAGE_ALL");

	lua_setfield(L,-2,"wxRichTextOddEvenPage");
	...
	lua_newtable(L); // enum wxRichTextPageLocation

	lua_pushnumber(L,wxRICHTEXT_PAGE_LEFT); lua_setfield(L,-2,"wxRICHTEXT_PAGE_LEFT");
	lua_pushnumber(L,wxRICHTEXT_PAGE_CENTRE); lua_setfield(L,-2,"wxRICHTEXT_PAGE_CENTRE");
	lua_pushnumber(L,wxRICHTEXT_PAGE_RIGHT); lua_setfield(L,-2,"wxRICHTEXT_PAGE_RIGHT");

	lua_setfield(L,-2,"wxRichTextPageLocation");
	...
	lua_newtable(L); // enum wxSocketNotify
	...
	lua_setfield(L,-2,"wxSocketNotify");
	...
	lua_newtable(L); // enum unnamed_74

	lua_pushnumber(L,wxSOCKET_INPUT_FLAG); lua_setfield(L,-2,"wxSOCKET_INPUT_FLAG");
	lua_pushnumber(L,wxSOCKET_OUTPUT_FLAG); lua_setfield(L,-2,"wxSOCKET_OUTPUT_FLAG");
	lua_pushnumber(L,wxSOCKET_CONNECTION_FLAG); lua_setfield(L,-2,"wxSOCKET_CONNECTION_FLAG");
	lua_pushnumber(L,wxSOCKET_LOST_FLAG); lua_setfield(L,-2,"wxSOCKET_LOST_FLAG");

	lua_setfield(L,-2,"unnamed_74");
	...
	lua_newtable(L); // enum unnamed_75
	...
	lua_newtable(L); // enum wxSocketType

	lua_pushnumber(L,wxSOCKET_UNINIT); lua_setfield(L,-2,"wxSOCKET_UNINIT");
	lua_pushnumber(L,wxSOCKET_CLIENT); lua_setfield(L,-2,"wxSOCKET_CLIENT");
	lua_pushnumber(L,wxSOCKET_SERVER); lua_setfield(L,-2,"wxSOCKET_SERVER");
	lua_pushnumber(L,wxSOCKET_BASE); lua_setfield(L,-2,"wxSOCKET_BASE");
	lua_pushnumber(L,wxSOCKET_DATAGRAM); lua_setfield(L,-2,"wxSOCKET_DATAGRAM");

	lua_setfield(L,-2,"wxSocketType");
	...
	lua_newtable(L); // enum wxStockHelpStringClient

	lua_pushnumber(L,wxSTOCK_MENU); lua_setfield(L,-2,"wxSTOCK_MENU");

	lua_setfield(L,-2,"wxStockHelpStringClient");
	...
	lua_newtable(L); // enum wxToolBarToolStyle

	lua_pushnumber(L,wxTOOL_STYLE_BUTTON); lua_setfield(L,-2,"wxTOOL_STYLE_BUTTON");
	lua_pushnumber(L,wxTOOL_STYLE_SEPARATOR); lua_setfield(L,-2,"wxTOOL_STYLE_SEPARATOR");
	lua_pushnumber(L,wxTOOL_STYLE_CONTROL); lua_setfield(L,-2,"wxTOOL_STYLE_CONTROL");

	lua_setfield(L,-2,"wxToolBarToolStyle");
	...
	lua_newtable(L); // enum unnamed_76

	lua_pushnumber(L,WXTHREAD_MIN_PRIORITY); lua_setfield(L,-2,"WXTHREAD_MIN_PRIORITY");
	lua_pushnumber(L,WXTHREAD_DEFAULT_PRIORITY); lua_setfield(L,-2,"WXTHREAD_DEFAULT_PRIORITY");
	lua_pushnumber(L,WXTHREAD_MAX_PRIORITY); lua_setfield(L,-2,"WXTHREAD_MAX_PRIORITY");

	lua_setfield(L,-2,"unnamed_76");
	...
	lua_newtable(L); // enum unnamed_77

	lua_pushnumber(L,wxTP_DEFAULT); lua_setfield(L,-2,"wxTP_DEFAULT");

	lua_setfield(L,-2,"unnamed_77");
	...
	lua_newtable(L); // enum unnamed_78

	lua_pushnumber(L,wxTB_HORIZONTAL); lua_setfield(L,-2,"wxTB_HORIZONTAL");
	lua_pushnumber(L,wxTB_TOP); lua_setfield(L,-2,"wxTB_TOP");
	lua_pushnumber(L,wxTB_VERTICAL); lua_setfield(L,-2,"wxTB_VERTICAL");
	lua_pushnumber(L,wxTB_LEFT); lua_setfield(L,-2,"wxTB_LEFT");
	lua_pushnumber(L,wxTB_3DBUTTONS); lua_setfield(L,-2,"wxTB_3DBUTTONS");
	lua_pushnumber(L,wxTB_FLAT); lua_setfield(L,-2,"wxTB_FLAT");
	lua_pushnumber(L,wxTB_DOCKABLE); lua_setfield(L,-2,"wxTB_DOCKABLE");
	lua_pushnumber(L,wxTB_NOICONS); lua_setfield(L,-2,"wxTB_NOICONS");
	lua_pushnumber(L,wxTB_TEXT); lua_setfield(L,-2,"wxTB_TEXT");
	lua_pushnumber(L,wxTB_NODIVIDER); lua_setfield(L,-2,"wxTB_NODIVIDER");
	lua_pushnumber(L,wxTB_NOALIGN); lua_setfield(L,-2,"wxTB_NOALIGN");
	lua_pushnumber(L,wxTB_HORZ_LAYOUT); lua_setfield(L,-2,"wxTB_HORZ_LAYOUT");
	lua_pushnumber(L,wxTB_HORZ_TEXT); lua_setfield(L,-2,"wxTB_HORZ_TEXT");
	lua_pushnumber(L,wxTB_NO_TOOLTIPS); lua_setfield(L,-2,"wxTB_NO_TOOLTIPS");
	lua_pushnumber(L,wxTB_BOTTOM); lua_setfield(L,-2,"wxTB_BOTTOM");
	lua_pushnumber(L,wxTB_RIGHT); lua_setfield(L,-2,"wxTB_RIGHT");

	lua_setfield(L,-2,"unnamed_78");
	...
	lua_newtable(L); // enum unnamed_79
	...
	lua_newtable(L); // enum unnamed_80

	lua_pushnumber(L,wxUSER_ATTENTION_INFO); lua_setfield(L,-2,"wxUSER_ATTENTION_INFO");
	lua_pushnumber(L,wxUSER_ATTENTION_ERROR); lua_setfield(L,-2,"wxUSER_ATTENTION_ERROR");

	lua_setfield(L,-2,"unnamed_80");
	...
	lua_newtable(L); // enum unnamed_81

	lua_pushnumber(L,wxTL_SINGLE); lua_setfield(L,-2,"wxTL_SINGLE");
	lua_pushnumber(L,wxTL_MULTIPLE); lua_setfield(L,-2,"wxTL_MULTIPLE");
	lua_pushnumber(L,wxTL_CHECKBOX); lua_setfield(L,-2,"wxTL_CHECKBOX");
	lua_pushnumber(L,wxTL_3STATE); lua_setfield(L,-2,"wxTL_3STATE");
	lua_pushnumber(L,wxTL_USER_3STATE); lua_setfield(L,-2,"wxTL_USER_3STATE");
	lua_pushnumber(L,wxTL_DEFAULT_STYLE); lua_setfield(L,-2,"wxTL_DEFAULT_STYLE");
	lua_pushnumber(L,wxTL_STYLE_MASK); lua_setfield(L,-2,"wxTL_STYLE_MASK");

	lua_setfield(L,-2,"unnamed_81");
	...
	lua_newtable(L); // enum wxURIFieldType

	lua_pushnumber(L,wxURI_SCHEME); lua_setfield(L,-2,"wxURI_SCHEME");
	lua_pushnumber(L,wxURI_USERINFO); lua_setfield(L,-2,"wxURI_USERINFO");
	lua_pushnumber(L,wxURI_SERVER); lua_setfield(L,-2,"wxURI_SERVER");
	lua_pushnumber(L,wxURI_PORT); lua_setfield(L,-2,"wxURI_PORT");
	lua_pushnumber(L,wxURI_PATH); lua_setfield(L,-2,"wxURI_PATH");
	lua_pushnumber(L,wxURI_QUERY); lua_setfield(L,-2,"wxURI_QUERY");
	lua_pushnumber(L,wxURI_FRAGMENT); lua_setfield(L,-2,"wxURI_FRAGMENT");

	lua_setfield(L,-2,"wxURIFieldType");
	...
	lua_newtable(L); // enum wxURIFlags

	lua_pushnumber(L,wxURI_STRICT); lua_setfield(L,-2,"wxURI_STRICT");

	lua_setfield(L,-2,"wxURIFlags");

	lua_pushnumber(L,wxURI_STRICT); lua_setfield(L,-2,"wxURI_STRICT");


	lua_newtable(L); // enum unnamed_82

	lua_pushnumber(L,wxEXEC_ASYNC); lua_setfield(L,-2,"wxEXEC_ASYNC");
	lua_pushnumber(L,wxEXEC_SYNC); lua_setfield(L,-2,"wxEXEC_SYNC");
	lua_pushnumber(L,wxEXEC_SHOW_CONSOLE); lua_setfield(L,-2,"wxEXEC_SHOW_CONSOLE");
	lua_pushnumber(L,wxEXEC_NOHIDE); lua_setfield(L,-2,"wxEXEC_NOHIDE");
	lua_pushnumber(L,wxEXEC_MAKE_GROUP_LEADER); lua_setfield(L,-2,"wxEXEC_MAKE_GROUP_LEADER");
	lua_pushnumber(L,wxEXEC_NODISABLE); lua_setfield(L,-2,"wxEXEC_NODISABLE");
	lua_pushnumber(L,wxEXEC_NOEVENTS); lua_setfield(L,-2,"wxEXEC_NOEVENTS");
	lua_pushnumber(L,wxEXEC_HIDE_CONSOLE); lua_setfield(L,-2,"wxEXEC_HIDE_CONSOLE");
	...
	lua_newtable(L); // enum wxKillFlags

	lua_pushnumber(L,wxKILL_NOCHILDREN); lua_setfield(L,-2,"wxKILL_NOCHILDREN");
	lua_pushnumber(L,wxKILL_CHILDREN); lua_setfield(L,-2,"wxKILL_CHILDREN");

	lua_setfield(L,-2,"wxKillFlags");

	lua_pushnumber(L,wxKILL_NOCHILDREN); lua_setfield(L,-2,"wxKILL_NOCHILDREN");
	lua_pushnumber(L,wxKILL_CHILDREN); lua_setfield(L,-2,"wxKILL_CHILDREN");


	lua_newtable(L); // enum wxShutdownFlags

	lua_pushnumber(L,wxSHUTDOWN_FORCE); lua_setfield(L,-2,"wxSHUTDOWN_FORCE");
	lua_pushnumber(L,wxSHUTDOWN_POWEROFF); lua_setfield(L,-2,"wxSHUTDOWN_POWEROFF");
	lua_pushnumber(L,wxSHUTDOWN_REBOOT); lua_setfield(L,-2,"wxSHUTDOWN_REBOOT");
	lua_pushnumber(L,wxSHUTDOWN_LOGOFF); lua_setfield(L,-2,"wxSHUTDOWN_LOGOFF");

	lua_setfield(L,-2,"wxShutdownFlags");
	...
	lua_newtable(L); // enum unnamed_83

	lua_pushnumber(L,wxBROWSER_NEW_WINDOW); lua_setfield(L,-2,"wxBROWSER_NEW_WINDOW");
	lua_pushnumber(L,wxBROWSER_NOBUSYCURSOR); lua_setfield(L,-2,"wxBROWSER_NOBUSYCURSOR");

	lua_setfield(L,-2,"unnamed_83");

	lua_pushnumber(L,wxBROWSER_NEW_WINDOW); lua_setfield(L,-2,"wxBROWSER_NEW_WINDOW");
	lua_pushnumber(L,wxBROWSER_NOBUSYCURSOR); lua_setfield(L,-2,"wxBROWSER_NOBUSYCURSOR");


	lua_newtable(L); // enum unnamed_84

	lua_pushnumber(L,wxStrip_Mnemonics); lua_setfield(L,-2,"wxStrip_Mnemonics");
	lua_pushnumber(L,wxStrip_Accel); lua_setfield(L,-2,"wxStrip_Accel");
	lua_pushnumber(L,wxStrip_All); lua_setfield(L,-2,"wxStrip_All");

	lua_setfield(L,-2,"unnamed_84");
	...
	lua_newtable(L); // enum unnamed_85

	lua_pushnumber(L,wxSEND_EVENT_POST); lua_setfield(L,-2,"wxSEND_EVENT_POST");

	lua_setfield(L,-2,"unnamed_85");

	lua_pushnumber(L,wxSEND_EVENT_POST); lua_setfield(L,-2,"wxSEND_EVENT_POST");


	lua_newtable(L); // enum unnamed_86

	lua_pushnumber(L,wxEXTEND_LAST_ON_EACH_LINE); lua_setfield(L,-2,"wxEXTEND_LAST_ON_EACH_LINE");
	lua_pushnumber(L,wxREMOVE_LEADING_SPACES); lua_setfield(L,-2,"wxREMOVE_LEADING_SPACES");
	lua_pushnumber(L,wxWRAPSIZER_DEFAULT_FLAGS); lua_setfield(L,-2,"wxWRAPSIZER_DEFAULT_FLAGS");

	lua_setfield(L,-2,"unnamed_86");
	...
	lua_newtable(L); // enum wxXmlDocumentLoadFlag

	lua_pushnumber(L,wxXMLDOC_NONE); lua_setfield(L,-2,"wxXMLDOC_NONE");
	lua_pushnumber(L,wxXMLDOC_KEEP_WHITESPACE_NODES); lua_setfield(L,-2,"wxXMLDOC_KEEP_WHITESPACE_NODES");

	lua_setfield(L,-2,"wxXmlDocumentLoadFlag");
