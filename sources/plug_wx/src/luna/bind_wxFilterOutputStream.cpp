...
public:
	...
	static int _bind_base_GetClassInfo(lua_State *L) {
		...
		if(!self) {
			luaL_error(L, "Invalid object in function call wxClassInfo * wxFilterOutputStream::base_GetClassInfo() const. Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_GetLength(lua_State *L) {
		...
		wxFilterOutputStream* self=Luna< wxObject >::checkSubType< wxFilterOutputStream >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call long long wxFilterOutputStream::base_GetLength() const. Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_GetSize(lua_State *L) {
		...
		wxFilterOutputStream* self=Luna< wxObject >::checkSubType< wxFilterOutputStream >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call size_t wxFilterOutputStream::base_GetSize() const. Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_IsOk(lua_State *L) {
		...
		wxFilterOutputStream* self=Luna< wxObject >::checkSubType< wxFilterOutputStream >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call bool wxFilterOutputStream::base_IsOk() const. Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_IsSeekable(lua_State *L) {
		...
		wxFilterOutputStream* self=Luna< wxObject >::checkSubType< wxFilterOutputStream >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call bool wxFilterOutputStream::base_IsSeekable() const. Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_Close(lua_State *L) {
		...
		wxFilterOutputStream* self=Luna< wxObject >::checkSubType< wxFilterOutputStream >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call bool wxFilterOutputStream::base_Close(). Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_LastWrite(lua_State *L) {
		...
		wxFilterOutputStream* self=Luna< wxObject >::checkSubType< wxFilterOutputStream >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call size_t wxFilterOutputStream::base_LastWrite() const. Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_SeekO(lua_State *L) {
		...
		wxFilterOutputStream* self=Luna< wxObject >::checkSubType< wxFilterOutputStream >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call long long wxFilterOutputStream::base_SeekO(long long, wxSeekMode). Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_TellO(lua_State *L) {
		...
		wxFilterOutputStream* self=Luna< wxObject >::checkSubType< wxFilterOutputStream >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call long long wxFilterOutputStream::base_TellO() const. Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_Write(lua_State *L) {
		...
		wxFilterOutputStream* self=Luna< wxObject >::checkSubType< wxFilterOutputStream >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call wxOutputStream & wxFilterOutputStream::base_Write(const void *, size_t). Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
