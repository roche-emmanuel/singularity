...
public:
	...
	// Constructor binds:
	// wxFTP::wxFTP()
	static wxFTP* _bind_ctor_overload_1(lua_State *L) {
	...
	static wxFTP* _bind_ctor_overload_2(lua_State *L) {
	...
	// Overload binder for wxFTP::wxFTP
	static wxFTP* _bind_ctor(lua_State *L) {
		if (_lg_typecheck_ctor_overload_1(L)) return _bind_ctor_overload_1(L);
		if (_lg_typecheck_ctor_overload_2(L)) return _bind_ctor_overload_2(L);

		luaL_error(L, "error in function wxFTP, cannot match any of the overloads for function wxFTP:\n  wxFTP()\n  wxFTP(lua_Table *)\n");
		return NULL;
	}
