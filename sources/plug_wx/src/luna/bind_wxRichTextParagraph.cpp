...
public:
	...
	static int _bind_fromVoid(lua_State *L) {
		...
		wxRichTextParagraph* self= (wxRichTextParagraph*)(Luna< void >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call fromVoid(...)");
		}
		
		Luna< wxRichTextParagraph >::push(L,self,false);
		return 1;
	}
...
luna_RegType LunaTraits< wxRichTextParagraph >::methods[] = {
	...
	{"fromVoid", &luna_wrapper_wxRichTextParagraph::_bind_fromVoid},
	{"asVoid", &luna_wrapper_wxRichTextParagraph::_bind_asVoid},
