...
public:
	...
	static int _bind_fromVoid(lua_State *L) {
		...
		wxRichTextEvent* self= (wxRichTextEvent*)(Luna< void >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call fromVoid(...)");
		}
		
		Luna< wxRichTextEvent >::push(L,self,false);
		return 1;
	}
...
luna_RegType LunaTraits< wxRichTextEvent >::methods[] = {
	...
	{"fromVoid", &luna_wrapper_wxRichTextEvent::_bind_fromVoid},
	{"asVoid", &luna_wrapper_wxRichTextEvent::_bind_asVoid},
	{"getTable", &luna_wrapper_wxRichTextEvent::_bind_getTable},
	{0,0}
};
