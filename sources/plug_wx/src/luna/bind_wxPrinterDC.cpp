...
public:
	...
	static int _bind_fromVoid(lua_State *L) {
		...
		wxPrinterDC* self= (wxPrinterDC*)(Luna< void >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call fromVoid(...)");
		}
		
		Luna< wxPrinterDC >::push(L,self,false);
		return 1;
	}
...
luna_RegType LunaTraits< wxPrinterDC >::methods[] = {
	...
	{"fromVoid", &luna_wrapper_wxPrinterDC::_bind_fromVoid},
	{"asVoid", &luna_wrapper_wxPrinterDC::_bind_asVoid},
	{"getTable", &luna_wrapper_wxPrinterDC::_bind_getTable},
	{0,0}
};
