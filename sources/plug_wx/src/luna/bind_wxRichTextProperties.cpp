...
public:
	...
	static int _bind_fromVoid(lua_State *L) {
		...
		wxRichTextProperties* self= (wxRichTextProperties*)(Luna< void >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call fromVoid(...)");
		}
		
		Luna< wxRichTextProperties >::push(L,self,false);
		return 1;
	}
...
luna_RegType LunaTraits< wxRichTextProperties >::methods[] = {
	...
	{"fromVoid", &luna_wrapper_wxRichTextProperties::_bind_fromVoid},
	{"asVoid", &luna_wrapper_wxRichTextProperties::_bind_asVoid},
