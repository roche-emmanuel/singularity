...
public:
	...
	static int _bind_fromVoid(lua_State *L) {
		...
		wxTextEntryDialog* self= (wxTextEntryDialog*)(Luna< void >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call fromVoid(...)");
		}
		
		Luna< wxTextEntryDialog >::push(L,self,false);
		return 1;
	}
	...
	static int _bind_GetValue(lua_State *L) {
		...
		if(!self) {
			luaL_error(L, "Invalid object in function call wxString wxTextEntryDialog::GetValue() const. Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_SetValue(lua_State *L) {
		...
		wxTextEntryDialog* self=Luna< wxObject >::checkSubType< wxTextEntryDialog >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void wxTextEntryDialog::SetValue(const wxString &). Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
		self->SetValue(value);
	...
	static int _bind_ShowModal(lua_State *L) {
		...
		wxTextEntryDialog* self=Luna< wxObject >::checkSubType< wxTextEntryDialog >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call int wxTextEntryDialog::ShowModal(). Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_GetClassInfo(lua_State *L) {
		...
		wxTextEntryDialog* self=Luna< wxObject >::checkSubType< wxTextEntryDialog >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call wxClassInfo * wxTextEntryDialog::base_GetClassInfo() const. Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_AcceptsFocus(lua_State *L) {
		...
		wxTextEntryDialog* self=Luna< wxObject >::checkSubType< wxTextEntryDialog >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call bool wxTextEntryDialog::base_AcceptsFocus() const. Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_AcceptsFocusFromKeyboard(lua_State *L) {
		...
		wxTextEntryDialog* self=Luna< wxObject >::checkSubType< wxTextEntryDialog >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call bool wxTextEntryDialog::base_AcceptsFocusFromKeyboard() const. Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_AcceptsFocusRecursively(lua_State *L) {
		...
		wxTextEntryDialog* self=Luna< wxObject >::checkSubType< wxTextEntryDialog >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call bool wxTextEntryDialog::base_AcceptsFocusRecursively() const. Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_HasFocus(lua_State *L) {
		...
		wxTextEntryDialog* self=Luna< wxObject >::checkSubType< wxTextEntryDialog >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call bool wxTextEntryDialog::base_HasFocus() const. Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_SetCanFocus(lua_State *L) {
		...
		wxTextEntryDialog* self=Luna< wxObject >::checkSubType< wxTextEntryDialog >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void wxTextEntryDialog::base_SetCanFocus(bool). Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_SetFocus(lua_State *L) {
		...
		wxTextEntryDialog* self=Luna< wxObject >::checkSubType< wxTextEntryDialog >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void wxTextEntryDialog::base_SetFocus(). Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_SetFocusFromKbd(lua_State *L) {
		...
		wxTextEntryDialog* self=Luna< wxObject >::checkSubType< wxTextEntryDialog >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void wxTextEntryDialog::base_SetFocusFromKbd(). Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_AddChild(lua_State *L) {
		...
		wxTextEntryDialog* self=Luna< wxObject >::checkSubType< wxTextEntryDialog >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void wxTextEntryDialog::base_AddChild(wxWindow *). Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_RemoveChild(lua_State *L) {
		...
		wxTextEntryDialog* self=Luna< wxObject >::checkSubType< wxTextEntryDialog >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void wxTextEntryDialog::base_RemoveChild(wxWindow *). Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_Reparent(lua_State *L) {
		...
		wxTextEntryDialog* self=Luna< wxObject >::checkSubType< wxTextEntryDialog >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call bool wxTextEntryDialog::base_Reparent(wxWindow *). Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_AlwaysShowScrollbars(lua_State *L) {
		...
		wxTextEntryDialog* self=Luna< wxObject >::checkSubType< wxTextEntryDialog >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void wxTextEntryDialog::base_AlwaysShowScrollbars(bool, bool). Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_GetScrollPos(lua_State *L) {
		...
		wxTextEntryDialog* self=Luna< wxObject >::checkSubType< wxTextEntryDialog >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call int wxTextEntryDialog::base_GetScrollPos(int) const. Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_GetScrollRange(lua_State *L) {
		...
		wxTextEntryDialog* self=Luna< wxObject >::checkSubType< wxTextEntryDialog >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call int wxTextEntryDialog::base_GetScrollRange(int) const. Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_GetScrollThumb(lua_State *L) {
		...
		wxTextEntryDialog* self=Luna< wxObject >::checkSubType< wxTextEntryDialog >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call int wxTextEntryDialog::base_GetScrollThumb(int) const. Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_IsScrollbarAlwaysShown(lua_State *L) {
		...
		wxTextEntryDialog* self=Luna< wxObject >::checkSubType< wxTextEntryDialog >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call bool wxTextEntryDialog::base_IsScrollbarAlwaysShown(int) const. Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_ScrollLines(lua_State *L) {
		...
		wxTextEntryDialog* self=Luna< wxObject >::checkSubType< wxTextEntryDialog >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call bool wxTextEntryDialog::base_ScrollLines(int). Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_ScrollPages(lua_State *L) {
		...
		wxTextEntryDialog* self=Luna< wxObject >::checkSubType< wxTextEntryDialog >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call bool wxTextEntryDialog::base_ScrollPages(int). Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_ScrollWindow(lua_State *L) {
		...
		wxTextEntryDialog* self=Luna< wxObject >::checkSubType< wxTextEntryDialog >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void wxTextEntryDialog::base_ScrollWindow(int, int, const wxRect *). Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_SetScrollPos(lua_State *L) {
		...
		wxTextEntryDialog* self=Luna< wxObject >::checkSubType< wxTextEntryDialog >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void wxTextEntryDialog::base_SetScrollPos(int, int, bool). Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_SetScrollbar(lua_State *L) {
		...
		wxTextEntryDialog* self=Luna< wxObject >::checkSubType< wxTextEntryDialog >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void wxTextEntryDialog::base_SetScrollbar(int, int, int, int, bool). Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_ClientToWindowSize(lua_State *L) {
		...
		wxTextEntryDialog* self=Luna< wxObject >::checkSubType< wxTextEntryDialog >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call wxSize wxTextEntryDialog::base_ClientToWindowSize(const wxSize &) const. Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_WindowToClientSize(lua_State *L) {
		...
		wxTextEntryDialog* self=Luna< wxObject >::checkSubType< wxTextEntryDialog >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call wxSize wxTextEntryDialog::base_WindowToClientSize(const wxSize &) const. Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_Fit(lua_State *L) {
		...
		wxTextEntryDialog* self=Luna< wxObject >::checkSubType< wxTextEntryDialog >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void wxTextEntryDialog::base_Fit(). Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_FitInside(lua_State *L) {
		...
		wxTextEntryDialog* self=Luna< wxObject >::checkSubType< wxTextEntryDialog >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void wxTextEntryDialog::base_FitInside(). Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_GetEffectiveMinSize(lua_State *L) {
		...
		wxTextEntryDialog* self=Luna< wxObject >::checkSubType< wxTextEntryDialog >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call wxSize wxTextEntryDialog::base_GetEffectiveMinSize() const. Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_GetMaxClientSize(lua_State *L) {
		...
		wxTextEntryDialog* self=Luna< wxObject >::checkSubType< wxTextEntryDialog >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call wxSize wxTextEntryDialog::base_GetMaxClientSize() const. Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_GetMaxSize(lua_State *L) {
		...
		wxTextEntryDialog* self=Luna< wxObject >::checkSubType< wxTextEntryDialog >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call wxSize wxTextEntryDialog::base_GetMaxSize() const. Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_GetMinClientSize(lua_State *L) {
		...
		wxTextEntryDialog* self=Luna< wxObject >::checkSubType< wxTextEntryDialog >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call wxSize wxTextEntryDialog::base_GetMinClientSize() const. Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_GetMinSize(lua_State *L) {
		...
		wxTextEntryDialog* self=Luna< wxObject >::checkSubType< wxTextEntryDialog >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call wxSize wxTextEntryDialog::base_GetMinSize() const. Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_GetBestVirtualSize(lua_State *L) {
		...
		wxTextEntryDialog* self=Luna< wxObject >::checkSubType< wxTextEntryDialog >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call wxSize wxTextEntryDialog::base_GetBestVirtualSize() const. Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_GetWindowBorderSize(lua_State *L) {
		...
		wxTextEntryDialog* self=Luna< wxObject >::checkSubType< wxTextEntryDialog >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call wxSize wxTextEntryDialog::base_GetWindowBorderSize() const. Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_InformFirstDirection(lua_State *L) {
		...
		wxTextEntryDialog* self=Luna< wxObject >::checkSubType< wxTextEntryDialog >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call bool wxTextEntryDialog::base_InformFirstDirection(int, int, int). Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_SendSizeEvent(lua_State *L) {
		...
		wxTextEntryDialog* self=Luna< wxObject >::checkSubType< wxTextEntryDialog >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void wxTextEntryDialog::base_SendSizeEvent(int). Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_SetMaxClientSize(lua_State *L) {
		...
		wxTextEntryDialog* self=Luna< wxObject >::checkSubType< wxTextEntryDialog >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void wxTextEntryDialog::base_SetMaxClientSize(const wxSize &). Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_SetMinClientSize(lua_State *L) {
		...
		wxTextEntryDialog* self=Luna< wxObject >::checkSubType< wxTextEntryDialog >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void wxTextEntryDialog::base_SetMinClientSize(const wxSize &). Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_GetClientAreaOrigin(lua_State *L) {
		...
		wxTextEntryDialog* self=Luna< wxObject >::checkSubType< wxTextEntryDialog >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call wxPoint wxTextEntryDialog::base_GetClientAreaOrigin() const. Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_ClearBackground(lua_State *L) {
		...
		wxTextEntryDialog* self=Luna< wxObject >::checkSubType< wxTextEntryDialog >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void wxTextEntryDialog::base_ClearBackground(). Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_GetBackgroundStyle(lua_State *L) {
		...
		wxTextEntryDialog* self=Luna< wxObject >::checkSubType< wxTextEntryDialog >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call wxBackgroundStyle wxTextEntryDialog::base_GetBackgroundStyle() const. Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_GetCharHeight(lua_State *L) {
		...
		wxTextEntryDialog* self=Luna< wxObject >::checkSubType< wxTextEntryDialog >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call int wxTextEntryDialog::base_GetCharHeight() const. Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_GetCharWidth(lua_State *L) {
		...
		wxTextEntryDialog* self=Luna< wxObject >::checkSubType< wxTextEntryDialog >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call int wxTextEntryDialog::base_GetCharWidth() const. Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_GetDefaultAttributes(lua_State *L) {
		...
		wxTextEntryDialog* self=Luna< wxObject >::checkSubType< wxTextEntryDialog >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call wxVisualAttributes wxTextEntryDialog::base_GetDefaultAttributes() const. Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_Refresh(lua_State *L) {
		...
		wxTextEntryDialog* self=Luna< wxObject >::checkSubType< wxTextEntryDialog >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void wxTextEntryDialog::base_Refresh(bool, const wxRect *). Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_Update(lua_State *L) {
		...
		wxTextEntryDialog* self=Luna< wxObject >::checkSubType< wxTextEntryDialog >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void wxTextEntryDialog::base_Update(). Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_SetBackgroundStyle(lua_State *L) {
		...
		wxTextEntryDialog* self=Luna< wxObject >::checkSubType< wxTextEntryDialog >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call bool wxTextEntryDialog::base_SetBackgroundStyle(wxBackgroundStyle). Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_SetFont(lua_State *L) {
		...
		wxTextEntryDialog* self=Luna< wxObject >::checkSubType< wxTextEntryDialog >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call bool wxTextEntryDialog::base_SetFont(const wxFont &). Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_ShouldInheritColours(lua_State *L) {
		...
		wxTextEntryDialog* self=Luna< wxObject >::checkSubType< wxTextEntryDialog >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call bool wxTextEntryDialog::base_ShouldInheritColours() const. Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_SetThemeEnabled(lua_State *L) {
		...
		wxTextEntryDialog* self=Luna< wxObject >::checkSubType< wxTextEntryDialog >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void wxTextEntryDialog::base_SetThemeEnabled(bool). Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_GetThemeEnabled(lua_State *L) {
		...
		wxTextEntryDialog* self=Luna< wxObject >::checkSubType< wxTextEntryDialog >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call bool wxTextEntryDialog::base_GetThemeEnabled() const. Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_SetNextHandler(lua_State *L) {
		...
		wxTextEntryDialog* self=Luna< wxObject >::checkSubType< wxTextEntryDialog >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void wxTextEntryDialog::base_SetNextHandler(wxEvtHandler *). Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_SetPreviousHandler(lua_State *L) {
		...
		wxTextEntryDialog* self=Luna< wxObject >::checkSubType< wxTextEntryDialog >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void wxTextEntryDialog::base_SetPreviousHandler(wxEvtHandler *). Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_GetWindowStyleFlag(lua_State *L) {
		...
		wxTextEntryDialog* self=Luna< wxObject >::checkSubType< wxTextEntryDialog >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call long wxTextEntryDialog::base_GetWindowStyleFlag() const. Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_SetExtraStyle(lua_State *L) {
		...
		wxTextEntryDialog* self=Luna< wxObject >::checkSubType< wxTextEntryDialog >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void wxTextEntryDialog::base_SetExtraStyle(long). Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_SetWindowStyleFlag(lua_State *L) {
		...
		wxTextEntryDialog* self=Luna< wxObject >::checkSubType< wxTextEntryDialog >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void wxTextEntryDialog::base_SetWindowStyleFlag(long). Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_Lower(lua_State *L) {
		...
		wxTextEntryDialog* self=Luna< wxObject >::checkSubType< wxTextEntryDialog >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void wxTextEntryDialog::base_Lower(). Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_Raise(lua_State *L) {
		...
		wxTextEntryDialog* self=Luna< wxObject >::checkSubType< wxTextEntryDialog >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void wxTextEntryDialog::base_Raise(). Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_HideWithEffect(lua_State *L) {
		...
		wxTextEntryDialog* self=Luna< wxObject >::checkSubType< wxTextEntryDialog >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call bool wxTextEntryDialog::base_HideWithEffect(wxShowEffect, unsigned int). Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_IsShown(lua_State *L) {
		...
		wxTextEntryDialog* self=Luna< wxObject >::checkSubType< wxTextEntryDialog >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call bool wxTextEntryDialog::base_IsShown() const. Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_IsShownOnScreen(lua_State *L) {
		...
		wxTextEntryDialog* self=Luna< wxObject >::checkSubType< wxTextEntryDialog >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call bool wxTextEntryDialog::base_IsShownOnScreen() const. Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_Enable(lua_State *L) {
		...
		wxTextEntryDialog* self=Luna< wxObject >::checkSubType< wxTextEntryDialog >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call bool wxTextEntryDialog::base_Enable(bool). Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_ShowWithEffect(lua_State *L) {
		...
		wxTextEntryDialog* self=Luna< wxObject >::checkSubType< wxTextEntryDialog >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call bool wxTextEntryDialog::base_ShowWithEffect(wxShowEffect, unsigned int). Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_GetHelpTextAtPoint(lua_State *L) {
		...
		wxTextEntryDialog* self=Luna< wxObject >::checkSubType< wxTextEntryDialog >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call wxString wxTextEntryDialog::base_GetHelpTextAtPoint(const wxPoint &, wxHelpEvent::Origin) const. Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_GetValidator(lua_State *L) {
		...
		wxTextEntryDialog* self=Luna< wxObject >::checkSubType< wxTextEntryDialog >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call wxValidator * wxTextEntryDialog::base_GetValidator(). Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_SetValidator(lua_State *L) {
		...
		wxTextEntryDialog* self=Luna< wxObject >::checkSubType< wxTextEntryDialog >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void wxTextEntryDialog::base_SetValidator(const wxValidator &). Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_TransferDataFromWindow(lua_State *L) {
		...
		wxTextEntryDialog* self=Luna< wxObject >::checkSubType< wxTextEntryDialog >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call bool wxTextEntryDialog::base_TransferDataFromWindow(). Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_TransferDataToWindow(lua_State *L) {
		...
		wxTextEntryDialog* self=Luna< wxObject >::checkSubType< wxTextEntryDialog >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call bool wxTextEntryDialog::base_TransferDataToWindow(). Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_Validate(lua_State *L) {
		...
		wxTextEntryDialog* self=Luna< wxObject >::checkSubType< wxTextEntryDialog >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call bool wxTextEntryDialog::base_Validate(). Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_GetLabel(lua_State *L) {
		...
		wxTextEntryDialog* self=Luna< wxObject >::checkSubType< wxTextEntryDialog >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call wxString wxTextEntryDialog::base_GetLabel() const. Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_GetLayoutDirection(lua_State *L) {
		...
		wxTextEntryDialog* self=Luna< wxObject >::checkSubType< wxTextEntryDialog >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call wxLayoutDirection wxTextEntryDialog::base_GetLayoutDirection() const. Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_GetName(lua_State *L) {
		...
		wxTextEntryDialog* self=Luna< wxObject >::checkSubType< wxTextEntryDialog >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call wxString wxTextEntryDialog::base_GetName() const. Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_SetLabel(lua_State *L) {
		...
		wxTextEntryDialog* self=Luna< wxObject >::checkSubType< wxTextEntryDialog >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void wxTextEntryDialog::base_SetLabel(const wxString &). Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_SetLayoutDirection(lua_State *L) {
		...
		wxTextEntryDialog* self=Luna< wxObject >::checkSubType< wxTextEntryDialog >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void wxTextEntryDialog::base_SetLayoutDirection(wxLayoutDirection). Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_SetName(lua_State *L) {
		...
		wxTextEntryDialog* self=Luna< wxObject >::checkSubType< wxTextEntryDialog >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void wxTextEntryDialog::base_SetName(const wxString &). Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_SetAcceleratorTable(lua_State *L) {
		...
		wxTextEntryDialog* self=Luna< wxObject >::checkSubType< wxTextEntryDialog >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void wxTextEntryDialog::base_SetAcceleratorTable(const wxAcceleratorTable &). Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_Destroy(lua_State *L) {
		...
		wxTextEntryDialog* self=Luna< wxObject >::checkSubType< wxTextEntryDialog >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call bool wxTextEntryDialog::base_Destroy(). Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_GetDropTarget(lua_State *L) {
		...
		wxTextEntryDialog* self=Luna< wxObject >::checkSubType< wxTextEntryDialog >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call wxDropTarget * wxTextEntryDialog::base_GetDropTarget() const. Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_SetDropTarget(lua_State *L) {
		...
		wxTextEntryDialog* self=Luna< wxObject >::checkSubType< wxTextEntryDialog >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void wxTextEntryDialog::base_SetDropTarget(wxDropTarget *). Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_DragAcceptFiles(lua_State *L) {
		...
		wxTextEntryDialog* self=Luna< wxObject >::checkSubType< wxTextEntryDialog >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void wxTextEntryDialog::base_DragAcceptFiles(bool). Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_HasCapture(lua_State *L) {
		...
		wxTextEntryDialog* self=Luna< wxObject >::checkSubType< wxTextEntryDialog >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call bool wxTextEntryDialog::base_HasCapture() const. Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_SetCursor(lua_State *L) {
		...
		wxTextEntryDialog* self=Luna< wxObject >::checkSubType< wxTextEntryDialog >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call bool wxTextEntryDialog::base_SetCursor(const wxCursor &). Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_WarpPointer(lua_State *L) {
		...
		wxTextEntryDialog* self=Luna< wxObject >::checkSubType< wxTextEntryDialog >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void wxTextEntryDialog::base_WarpPointer(int, int). Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_DoUpdateWindowUI(lua_State *L) {
		...
		wxTextEntryDialog* self=Luna< wxObject >::checkSubType< wxTextEntryDialog >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void wxTextEntryDialog::base_DoUpdateWindowUI(wxUpdateUIEvent &). Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	// HWND wxTextEntryDialog::base_GetHandle() const
	static int _bind_base_GetHandle(lua_State *L) {
		if (!_lg_typecheck_base_GetHandle(L)) {
			luaL_error(L, "luna typecheck failed in HWND wxTextEntryDialog::base_GetHandle() const function, expected prototype:\nHWND wxTextEntryDialog::base_GetHandle() const\nClass arguments details:\n\n%s",luna_dumpStack(L).c_str());
		}


		wxTextEntryDialog* self=Luna< wxObject >::checkSubType< wxTextEntryDialog >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call HWND wxTextEntryDialog::base_GetHandle() const. Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
		HWND stack_lret = self->wxTextEntryDialog::GetHandle();
	...
	static int _bind_base_HasMultiplePages(lua_State *L) {
		...
		wxTextEntryDialog* self=Luna< wxObject >::checkSubType< wxTextEntryDialog >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call bool wxTextEntryDialog::base_HasMultiplePages() const. Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_InheritAttributes(lua_State *L) {
		...
		wxTextEntryDialog* self=Luna< wxObject >::checkSubType< wxTextEntryDialog >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void wxTextEntryDialog::base_InheritAttributes(). Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_InitDialog(lua_State *L) {
		...
		wxTextEntryDialog* self=Luna< wxObject >::checkSubType< wxTextEntryDialog >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void wxTextEntryDialog::base_InitDialog(). Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_IsRetained(lua_State *L) {
		...
		wxTextEntryDialog* self=Luna< wxObject >::checkSubType< wxTextEntryDialog >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call bool wxTextEntryDialog::base_IsRetained() const. Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_IsTopLevel(lua_State *L) {
		...
		wxTextEntryDialog* self=Luna< wxObject >::checkSubType< wxTextEntryDialog >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call bool wxTextEntryDialog::base_IsTopLevel() const. Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_MakeModal(lua_State *L) {
		...
		wxTextEntryDialog* self=Luna< wxObject >::checkSubType< wxTextEntryDialog >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void wxTextEntryDialog::base_MakeModal(bool). Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_OnInternalIdle(lua_State *L) {
		...
		wxTextEntryDialog* self=Luna< wxObject >::checkSubType< wxTextEntryDialog >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void wxTextEntryDialog::base_OnInternalIdle(). Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_RegisterHotKey(lua_State *L) {
		...
		wxTextEntryDialog* self=Luna< wxObject >::checkSubType< wxTextEntryDialog >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call bool wxTextEntryDialog::base_RegisterHotKey(int, int, int). Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_UnregisterHotKey(lua_State *L) {
		...
		wxTextEntryDialog* self=Luna< wxObject >::checkSubType< wxTextEntryDialog >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call bool wxTextEntryDialog::base_UnregisterHotKey(int). Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_UpdateWindowUI(lua_State *L) {
		...
		wxTextEntryDialog* self=Luna< wxObject >::checkSubType< wxTextEntryDialog >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void wxTextEntryDialog::base_UpdateWindowUI(long). Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_CanSetTransparent(lua_State *L) {
		...
		wxTextEntryDialog* self=Luna< wxObject >::checkSubType< wxTextEntryDialog >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call bool wxTextEntryDialog::base_CanSetTransparent(). Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_EnableCloseButton(lua_State *L) {
		...
		wxTextEntryDialog* self=Luna< wxObject >::checkSubType< wxTextEntryDialog >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call bool wxTextEntryDialog::base_EnableCloseButton(bool). Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_GetTitle(lua_State *L) {
		...
		wxTextEntryDialog* self=Luna< wxObject >::checkSubType< wxTextEntryDialog >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call wxString wxTextEntryDialog::base_GetTitle() const. Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_IsActive(lua_State *L) {
		...
		wxTextEntryDialog* self=Luna< wxObject >::checkSubType< wxTextEntryDialog >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call bool wxTextEntryDialog::base_IsActive(). Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_IsAlwaysMaximized(lua_State *L) {
		...
		wxTextEntryDialog* self=Luna< wxObject >::checkSubType< wxTextEntryDialog >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call bool wxTextEntryDialog::base_IsAlwaysMaximized() const. Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_IsFullScreen(lua_State *L) {
		...
		wxTextEntryDialog* self=Luna< wxObject >::checkSubType< wxTextEntryDialog >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call bool wxTextEntryDialog::base_IsFullScreen() const. Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_IsMaximized(lua_State *L) {
		...
		wxTextEntryDialog* self=Luna< wxObject >::checkSubType< wxTextEntryDialog >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call bool wxTextEntryDialog::base_IsMaximized() const. Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_Layout(lua_State *L) {
		...
		wxTextEntryDialog* self=Luna< wxObject >::checkSubType< wxTextEntryDialog >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call bool wxTextEntryDialog::base_Layout(). Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_Maximize(lua_State *L) {
		...
		wxTextEntryDialog* self=Luna< wxObject >::checkSubType< wxTextEntryDialog >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void wxTextEntryDialog::base_Maximize(bool). Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_RequestUserAttention(lua_State *L) {
		...
		wxTextEntryDialog* self=Luna< wxObject >::checkSubType< wxTextEntryDialog >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void wxTextEntryDialog::base_RequestUserAttention(int). Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_SetMaxSize(lua_State *L) {
		...
		wxTextEntryDialog* self=Luna< wxObject >::checkSubType< wxTextEntryDialog >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void wxTextEntryDialog::base_SetMaxSize(const wxSize &). Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_SetMinSize(lua_State *L) {
		...
		wxTextEntryDialog* self=Luna< wxObject >::checkSubType< wxTextEntryDialog >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void wxTextEntryDialog::base_SetMinSize(const wxSize &). Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_SetSizeHints_overload_1(lua_State *L) {
		...
		wxTextEntryDialog* self=Luna< wxObject >::checkSubType< wxTextEntryDialog >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void wxTextEntryDialog::base_SetSizeHints(int, int, int, int, int, int). Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_SetSizeHints_overload_2(lua_State *L) {
		...
		wxTextEntryDialog* self=Luna< wxObject >::checkSubType< wxTextEntryDialog >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void wxTextEntryDialog::base_SetSizeHints(const wxSize &, const wxSize &, const wxSize &). Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_SetTitle(lua_State *L) {
		...
		wxTextEntryDialog* self=Luna< wxObject >::checkSubType< wxTextEntryDialog >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void wxTextEntryDialog::base_SetTitle(const wxString &). Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_SetTransparent(lua_State *L) {
		...
		wxTextEntryDialog* self=Luna< wxObject >::checkSubType< wxTextEntryDialog >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call bool wxTextEntryDialog::base_SetTransparent(unsigned char). Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_ShouldPreventAppExit(lua_State *L) {
		...
		wxTextEntryDialog* self=Luna< wxObject >::checkSubType< wxTextEntryDialog >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call bool wxTextEntryDialog::base_ShouldPreventAppExit() const. Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_OSXSetModified(lua_State *L) {
		...
		wxTextEntryDialog* self=Luna< wxObject >::checkSubType< wxTextEntryDialog >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void wxTextEntryDialog::base_OSXSetModified(bool). Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_OSXIsModified(lua_State *L) {
		...
		wxTextEntryDialog* self=Luna< wxObject >::checkSubType< wxTextEntryDialog >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call bool wxTextEntryDialog::base_OSXIsModified() const. Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_ShowFullScreen(lua_State *L) {
		...
		wxTextEntryDialog* self=Luna< wxObject >::checkSubType< wxTextEntryDialog >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call bool wxTextEntryDialog::base_ShowFullScreen(bool, long). Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_CanDoLayoutAdaptation(lua_State *L) {
		...
		wxTextEntryDialog* self=Luna< wxObject >::checkSubType< wxTextEntryDialog >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call bool wxTextEntryDialog::base_CanDoLayoutAdaptation(). Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_DoLayoutAdaptation(lua_State *L) {
		...
		wxTextEntryDialog* self=Luna< wxObject >::checkSubType< wxTextEntryDialog >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call bool wxTextEntryDialog::base_DoLayoutAdaptation(). Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_EndModal(lua_State *L) {
		...
		wxTextEntryDialog* self=Luna< wxObject >::checkSubType< wxTextEntryDialog >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void wxTextEntryDialog::base_EndModal(int). Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_GetContentWindow(lua_State *L) {
		...
		wxTextEntryDialog* self=Luna< wxObject >::checkSubType< wxTextEntryDialog >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call wxWindow * wxTextEntryDialog::base_GetContentWindow() const. Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_Iconize(lua_State *L) {
		...
		wxTextEntryDialog* self=Luna< wxObject >::checkSubType< wxTextEntryDialog >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void wxTextEntryDialog::base_Iconize(bool). Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_IsIconized(lua_State *L) {
		...
		wxTextEntryDialog* self=Luna< wxObject >::checkSubType< wxTextEntryDialog >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call bool wxTextEntryDialog::base_IsIconized() const. Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_IsModal(lua_State *L) {
		...
		wxTextEntryDialog* self=Luna< wxObject >::checkSubType< wxTextEntryDialog >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call bool wxTextEntryDialog::base_IsModal() const. Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_SetIcons(lua_State *L) {
		...
		wxTextEntryDialog* self=Luna< wxObject >::checkSubType< wxTextEntryDialog >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void wxTextEntryDialog::base_SetIcons(const wxIconBundle &). Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_Show(lua_State *L) {
		...
		wxTextEntryDialog* self=Luna< wxObject >::checkSubType< wxTextEntryDialog >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call bool wxTextEntryDialog::base_Show(bool). Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_ShowModal(lua_State *L) {
		...
		wxTextEntryDialog* self=Luna< wxObject >::checkSubType< wxTextEntryDialog >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call int wxTextEntryDialog::base_ShowModal(). Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
...
luna_RegType LunaTraits< wxTextEntryDialog >::methods[] = {
	...
	{"base_GetHandle", &luna_wrapper_wxTextEntryDialog::_bind_base_GetHandle},
	...
	{"fromVoid", &luna_wrapper_wxTextEntryDialog::_bind_fromVoid},
	{"asVoid", &luna_wrapper_wxTextEntryDialog::_bind_asVoid},
