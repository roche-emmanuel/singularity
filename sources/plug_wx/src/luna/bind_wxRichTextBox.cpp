...
public:
	...
	static int _bind_fromVoid(lua_State *L) {
		...
		wxRichTextBox* self= (wxRichTextBox*)(Luna< void >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call fromVoid(...)");
		}
		
		Luna< wxRichTextBox >::push(L,self,false);
		return 1;
	}
...
luna_RegType LunaTraits< wxRichTextBox >::methods[] = {
	{"fromVoid", &luna_wrapper_wxRichTextBox::_bind_fromVoid},
	{"asVoid", &luna_wrapper_wxRichTextBox::_bind_asVoid},
