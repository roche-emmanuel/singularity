...
public:
	...
	static int _bind_getTable(lua_State *L) {
		...
		luna_wrapper_base* wrapper = luna_caster<wxZipEntry,luna_wrapper_base>::cast(self); //dynamic_cast<luna_wrapper_base*>(self);
		if(wrapper) {
	...
	static int _bind_fromVoid(lua_State *L) {
		...
		wxZipEntry* self= (wxZipEntry*)(Luna< void >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call fromVoid(...)");
		}
		
		Luna< wxZipEntry >::push(L,self,false);
		return 1;
	}
	...
	static int _bind_asVoid(lua_State *L) {
		...
		void* self= (void*)(Luna< wxZipEntry >::check(L,1));
		if(!self) {
...
luna_RegType LunaTraits< wxZipEntry >::methods[] = {
	...
	{"fromVoid", &luna_wrapper_wxZipEntry::_bind_fromVoid},
	{"asVoid", &luna_wrapper_wxZipEntry::_bind_asVoid},
	{"getTable", &luna_wrapper_wxZipEntry::_bind_getTable},
	{0,0}
};
