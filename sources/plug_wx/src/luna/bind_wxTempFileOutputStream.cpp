...
public:
	...
	static int _bind_Commit(lua_State *L) {
		...
		if(!self) {
			luaL_error(L, "Invalid object in function call bool wxTempFileOutputStream::Commit(). Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_Discard(lua_State *L) {
		...
		wxTempFileOutputStream* self=Luna< wxObject >::checkSubType< wxTempFileOutputStream >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void wxTempFileOutputStream::Discard(). Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
		self->Discard();
	...
	static int _bind_base_GetClassInfo(lua_State *L) {
		...
		wxTempFileOutputStream* self=Luna< wxObject >::checkSubType< wxTempFileOutputStream >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call wxClassInfo * wxTempFileOutputStream::base_GetClassInfo() const. Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_GetLength(lua_State *L) {
		...
		wxTempFileOutputStream* self=Luna< wxObject >::checkSubType< wxTempFileOutputStream >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call long long wxTempFileOutputStream::base_GetLength() const. Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_GetSize(lua_State *L) {
		...
		wxTempFileOutputStream* self=Luna< wxObject >::checkSubType< wxTempFileOutputStream >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call size_t wxTempFileOutputStream::base_GetSize() const. Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_IsOk(lua_State *L) {
		...
		wxTempFileOutputStream* self=Luna< wxObject >::checkSubType< wxTempFileOutputStream >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call bool wxTempFileOutputStream::base_IsOk() const. Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_IsSeekable(lua_State *L) {
		...
		wxTempFileOutputStream* self=Luna< wxObject >::checkSubType< wxTempFileOutputStream >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call bool wxTempFileOutputStream::base_IsSeekable() const. Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_Close(lua_State *L) {
		...
		wxTempFileOutputStream* self=Luna< wxObject >::checkSubType< wxTempFileOutputStream >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call bool wxTempFileOutputStream::base_Close(). Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_LastWrite(lua_State *L) {
		...
		wxTempFileOutputStream* self=Luna< wxObject >::checkSubType< wxTempFileOutputStream >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call size_t wxTempFileOutputStream::base_LastWrite() const. Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_SeekO(lua_State *L) {
		...
		wxTempFileOutputStream* self=Luna< wxObject >::checkSubType< wxTempFileOutputStream >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call long long wxTempFileOutputStream::base_SeekO(long long, wxSeekMode). Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_TellO(lua_State *L) {
		...
		wxTempFileOutputStream* self=Luna< wxObject >::checkSubType< wxTempFileOutputStream >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call long long wxTempFileOutputStream::base_TellO() const. Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_Write(lua_State *L) {
		...
		wxTempFileOutputStream* self=Luna< wxObject >::checkSubType< wxTempFileOutputStream >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call wxOutputStream & wxTempFileOutputStream::base_Write(const void *, size_t). Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_Commit(lua_State *L) {
		...
		wxTempFileOutputStream* self=Luna< wxObject >::checkSubType< wxTempFileOutputStream >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call bool wxTempFileOutputStream::base_Commit(). Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_Discard(lua_State *L) {
		...
		wxTempFileOutputStream* self=Luna< wxObject >::checkSubType< wxTempFileOutputStream >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void wxTempFileOutputStream::base_Discard(). Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
