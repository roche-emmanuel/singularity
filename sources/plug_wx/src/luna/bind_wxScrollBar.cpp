...
public:
	...
	static wxScrollBar* _bind_ctor_overload_2(lua_State *L) {
		...
		long style=luatop>4 ? (long)lua_tointeger(L,5) : (long)wxSB_HORIZONTAL;
	...
	static wxScrollBar* _bind_ctor_overload_4(lua_State *L) {
		...
		long style=luatop>5 ? (long)lua_tointeger(L,6) : (long)wxSB_HORIZONTAL;
...
luna_RegType LunaTraits< wxScrollBar >::methods[] = {
	...
	{"__eq", &luna_wrapper_wxScrollBar::_bind___eq},
