...
public:
	...
	static int _bind_fromVoid(lua_State *L) {
		...
		wxGraphicsPen* self= (wxGraphicsPen*)(Luna< void >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call fromVoid(...)");
		}
		
		Luna< wxGraphicsPen >::push(L,self,false);
		return 1;
	}
...
luna_RegType LunaTraits< wxGraphicsPen >::methods[] = {
	...
	{"fromVoid", &luna_wrapper_wxGraphicsPen::_bind_fromVoid},
	{"asVoid", &luna_wrapper_wxGraphicsPen::_bind_asVoid},
