...
public:
	...
	static int _bind_fromVoid(lua_State *L) {
		...
		wxMediaCtrl* self= (wxMediaCtrl*)(Luna< void >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call fromVoid(...)");
		}
		
		Luna< wxMediaCtrl >::push(L,self,false);
		return 1;
	}
	...
	static int _bind_Create(lua_State *L) {
		...
		if(!self) {
			luaL_error(L, "Invalid object in function call bool wxMediaCtrl::Create(wxWindow *, int, const wxString &, const wxPoint &, const wxSize &, long, const wxString &, const wxValidator &, const wxString &). Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_GetBestSize(lua_State *L) {
		...
		wxMediaCtrl* self=Luna< wxObject >::checkSubType< wxMediaCtrl >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call wxSize wxMediaCtrl::GetBestSize() const. Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_GetState(lua_State *L) {
		...
		wxMediaCtrl* self=Luna< wxObject >::checkSubType< wxMediaCtrl >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call wxMediaState wxMediaCtrl::GetState(). Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_GetVolume(lua_State *L) {
		...
		wxMediaCtrl* self=Luna< wxObject >::checkSubType< wxMediaCtrl >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call double wxMediaCtrl::GetVolume(). Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_Length(lua_State *L) {
		...
		wxMediaCtrl* self=Luna< wxObject >::checkSubType< wxMediaCtrl >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call long long wxMediaCtrl::Length(). Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_Load_overload_1(lua_State *L) {
		...
		wxMediaCtrl* self=Luna< wxObject >::checkSubType< wxMediaCtrl >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call bool wxMediaCtrl::Load(const wxString &). Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_Load_overload_2(lua_State *L) {
		...
		wxMediaCtrl* self=Luna< wxObject >::checkSubType< wxMediaCtrl >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call bool wxMediaCtrl::Load(const wxURI &). Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_Load_overload_3(lua_State *L) {
		...
		wxMediaCtrl* self=Luna< wxObject >::checkSubType< wxMediaCtrl >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call bool wxMediaCtrl::Load(const wxURI &, const wxURI &). Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_LoadURI(lua_State *L) {
		...
		wxMediaCtrl* self=Luna< wxObject >::checkSubType< wxMediaCtrl >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call bool wxMediaCtrl::LoadURI(const wxString &). Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_LoadURIWithProxy(lua_State *L) {
		...
		wxMediaCtrl* self=Luna< wxObject >::checkSubType< wxMediaCtrl >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call bool wxMediaCtrl::LoadURIWithProxy(const wxString &, const wxString &). Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_Pause(lua_State *L) {
		...
		wxMediaCtrl* self=Luna< wxObject >::checkSubType< wxMediaCtrl >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call bool wxMediaCtrl::Pause(). Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_Play(lua_State *L) {
		...
		wxMediaCtrl* self=Luna< wxObject >::checkSubType< wxMediaCtrl >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call bool wxMediaCtrl::Play(). Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
		bool lret = self->Play();
		lua_pushboolean(L,lret?1:0);
	...
	static int _bind_Seek(lua_State *L) {
		...
		long long where=(long long)lua_tonumber(L,2);
		wxSeekMode mode=luatop>2 ? (wxSeekMode)lua_tointeger(L,3) : (wxSeekMode)::wxFromStart;

		wxMediaCtrl* self=Luna< wxObject >::checkSubType< wxMediaCtrl >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call long long wxMediaCtrl::Seek(long long, wxSeekMode). Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_SetPlaybackRate(lua_State *L) {
		...
		wxMediaCtrl* self=Luna< wxObject >::checkSubType< wxMediaCtrl >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call bool wxMediaCtrl::SetPlaybackRate(double). Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_SetVolume(lua_State *L) {
		...
		wxMediaCtrl* self=Luna< wxObject >::checkSubType< wxMediaCtrl >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call bool wxMediaCtrl::SetVolume(double). Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_ShowPlayerControls(lua_State *L) {
		...
		wxMediaCtrlPlayerControls flags=luatop>1 ? (wxMediaCtrlPlayerControls)lua_tointeger(L,2) : (wxMediaCtrlPlayerControls)::wxMEDIACTRLPLAYERCONTROLS_DEFAULT;

		wxMediaCtrl* self=Luna< wxObject >::checkSubType< wxMediaCtrl >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call bool wxMediaCtrl::ShowPlayerControls(wxMediaCtrlPlayerControls). Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_Stop(lua_State *L) {
		...
		wxMediaCtrl* self=Luna< wxObject >::checkSubType< wxMediaCtrl >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call bool wxMediaCtrl::Stop(). Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
		bool lret = self->Stop();
		lua_pushboolean(L,lret?1:0);
	...
	static int _bind_Tell(lua_State *L) {
		...
		wxMediaCtrl* self=Luna< wxObject >::checkSubType< wxMediaCtrl >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call long long wxMediaCtrl::Tell(). Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_GetClassInfo(lua_State *L) {
		...
		wxMediaCtrl* self=Luna< wxObject >::checkSubType< wxMediaCtrl >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call wxClassInfo * wxMediaCtrl::base_GetClassInfo() const. Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_AcceptsFocus(lua_State *L) {
		...
		wxMediaCtrl* self=Luna< wxObject >::checkSubType< wxMediaCtrl >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call bool wxMediaCtrl::base_AcceptsFocus() const. Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_AcceptsFocusFromKeyboard(lua_State *L) {
		...
		wxMediaCtrl* self=Luna< wxObject >::checkSubType< wxMediaCtrl >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call bool wxMediaCtrl::base_AcceptsFocusFromKeyboard() const. Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_AcceptsFocusRecursively(lua_State *L) {
		...
		wxMediaCtrl* self=Luna< wxObject >::checkSubType< wxMediaCtrl >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call bool wxMediaCtrl::base_AcceptsFocusRecursively() const. Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_HasFocus(lua_State *L) {
		...
		wxMediaCtrl* self=Luna< wxObject >::checkSubType< wxMediaCtrl >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call bool wxMediaCtrl::base_HasFocus() const. Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_SetCanFocus(lua_State *L) {
		...
		wxMediaCtrl* self=Luna< wxObject >::checkSubType< wxMediaCtrl >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void wxMediaCtrl::base_SetCanFocus(bool). Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_SetFocus(lua_State *L) {
		...
		wxMediaCtrl* self=Luna< wxObject >::checkSubType< wxMediaCtrl >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void wxMediaCtrl::base_SetFocus(). Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_SetFocusFromKbd(lua_State *L) {
		...
		wxMediaCtrl* self=Luna< wxObject >::checkSubType< wxMediaCtrl >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void wxMediaCtrl::base_SetFocusFromKbd(). Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_AddChild(lua_State *L) {
		...
		wxMediaCtrl* self=Luna< wxObject >::checkSubType< wxMediaCtrl >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void wxMediaCtrl::base_AddChild(wxWindow *). Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_RemoveChild(lua_State *L) {
		...
		wxMediaCtrl* self=Luna< wxObject >::checkSubType< wxMediaCtrl >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void wxMediaCtrl::base_RemoveChild(wxWindow *). Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_Reparent(lua_State *L) {
		...
		wxMediaCtrl* self=Luna< wxObject >::checkSubType< wxMediaCtrl >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call bool wxMediaCtrl::base_Reparent(wxWindow *). Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_AlwaysShowScrollbars(lua_State *L) {
		...
		wxMediaCtrl* self=Luna< wxObject >::checkSubType< wxMediaCtrl >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void wxMediaCtrl::base_AlwaysShowScrollbars(bool, bool). Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_GetScrollPos(lua_State *L) {
		...
		wxMediaCtrl* self=Luna< wxObject >::checkSubType< wxMediaCtrl >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call int wxMediaCtrl::base_GetScrollPos(int) const. Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_GetScrollRange(lua_State *L) {
		...
		wxMediaCtrl* self=Luna< wxObject >::checkSubType< wxMediaCtrl >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call int wxMediaCtrl::base_GetScrollRange(int) const. Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_GetScrollThumb(lua_State *L) {
		...
		wxMediaCtrl* self=Luna< wxObject >::checkSubType< wxMediaCtrl >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call int wxMediaCtrl::base_GetScrollThumb(int) const. Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_IsScrollbarAlwaysShown(lua_State *L) {
		...
		wxMediaCtrl* self=Luna< wxObject >::checkSubType< wxMediaCtrl >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call bool wxMediaCtrl::base_IsScrollbarAlwaysShown(int) const. Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_ScrollLines(lua_State *L) {
		...
		wxMediaCtrl* self=Luna< wxObject >::checkSubType< wxMediaCtrl >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call bool wxMediaCtrl::base_ScrollLines(int). Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_ScrollPages(lua_State *L) {
		...
		wxMediaCtrl* self=Luna< wxObject >::checkSubType< wxMediaCtrl >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call bool wxMediaCtrl::base_ScrollPages(int). Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_ScrollWindow(lua_State *L) {
		...
		wxMediaCtrl* self=Luna< wxObject >::checkSubType< wxMediaCtrl >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void wxMediaCtrl::base_ScrollWindow(int, int, const wxRect *). Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_SetScrollPos(lua_State *L) {
		...
		wxMediaCtrl* self=Luna< wxObject >::checkSubType< wxMediaCtrl >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void wxMediaCtrl::base_SetScrollPos(int, int, bool). Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_SetScrollbar(lua_State *L) {
		...
		wxMediaCtrl* self=Luna< wxObject >::checkSubType< wxMediaCtrl >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void wxMediaCtrl::base_SetScrollbar(int, int, int, int, bool). Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_ClientToWindowSize(lua_State *L) {
		...
		wxMediaCtrl* self=Luna< wxObject >::checkSubType< wxMediaCtrl >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call wxSize wxMediaCtrl::base_ClientToWindowSize(const wxSize &) const. Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_WindowToClientSize(lua_State *L) {
		...
		wxMediaCtrl* self=Luna< wxObject >::checkSubType< wxMediaCtrl >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call wxSize wxMediaCtrl::base_WindowToClientSize(const wxSize &) const. Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_Fit(lua_State *L) {
		...
		wxMediaCtrl* self=Luna< wxObject >::checkSubType< wxMediaCtrl >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void wxMediaCtrl::base_Fit(). Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_FitInside(lua_State *L) {
		...
		wxMediaCtrl* self=Luna< wxObject >::checkSubType< wxMediaCtrl >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void wxMediaCtrl::base_FitInside(). Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_GetEffectiveMinSize(lua_State *L) {
		...
		wxMediaCtrl* self=Luna< wxObject >::checkSubType< wxMediaCtrl >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call wxSize wxMediaCtrl::base_GetEffectiveMinSize() const. Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_GetMaxClientSize(lua_State *L) {
		...
		wxMediaCtrl* self=Luna< wxObject >::checkSubType< wxMediaCtrl >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call wxSize wxMediaCtrl::base_GetMaxClientSize() const. Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_GetMaxSize(lua_State *L) {
		...
		wxMediaCtrl* self=Luna< wxObject >::checkSubType< wxMediaCtrl >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call wxSize wxMediaCtrl::base_GetMaxSize() const. Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_GetMinClientSize(lua_State *L) {
		...
		wxMediaCtrl* self=Luna< wxObject >::checkSubType< wxMediaCtrl >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call wxSize wxMediaCtrl::base_GetMinClientSize() const. Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_GetMinSize(lua_State *L) {
		...
		wxMediaCtrl* self=Luna< wxObject >::checkSubType< wxMediaCtrl >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call wxSize wxMediaCtrl::base_GetMinSize() const. Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_GetBestVirtualSize(lua_State *L) {
		...
		wxMediaCtrl* self=Luna< wxObject >::checkSubType< wxMediaCtrl >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call wxSize wxMediaCtrl::base_GetBestVirtualSize() const. Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_GetWindowBorderSize(lua_State *L) {
		...
		wxMediaCtrl* self=Luna< wxObject >::checkSubType< wxMediaCtrl >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call wxSize wxMediaCtrl::base_GetWindowBorderSize() const. Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_InformFirstDirection(lua_State *L) {
		...
		wxMediaCtrl* self=Luna< wxObject >::checkSubType< wxMediaCtrl >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call bool wxMediaCtrl::base_InformFirstDirection(int, int, int). Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_SendSizeEvent(lua_State *L) {
		...
		wxMediaCtrl* self=Luna< wxObject >::checkSubType< wxMediaCtrl >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void wxMediaCtrl::base_SendSizeEvent(int). Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_SetMaxClientSize(lua_State *L) {
		...
		wxMediaCtrl* self=Luna< wxObject >::checkSubType< wxMediaCtrl >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void wxMediaCtrl::base_SetMaxClientSize(const wxSize &). Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_SetMaxSize(lua_State *L) {
		...
		wxMediaCtrl* self=Luna< wxObject >::checkSubType< wxMediaCtrl >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void wxMediaCtrl::base_SetMaxSize(const wxSize &). Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_SetMinClientSize(lua_State *L) {
		...
		wxMediaCtrl* self=Luna< wxObject >::checkSubType< wxMediaCtrl >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void wxMediaCtrl::base_SetMinClientSize(const wxSize &). Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_SetMinSize(lua_State *L) {
		...
		wxMediaCtrl* self=Luna< wxObject >::checkSubType< wxMediaCtrl >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void wxMediaCtrl::base_SetMinSize(const wxSize &). Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_SetSizeHints_overload_1(lua_State *L) {
		...
		wxMediaCtrl* self=Luna< wxObject >::checkSubType< wxMediaCtrl >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void wxMediaCtrl::base_SetSizeHints(const wxSize &, const wxSize &, const wxSize &). Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_SetSizeHints_overload_2(lua_State *L) {
		...
		wxMediaCtrl* self=Luna< wxObject >::checkSubType< wxMediaCtrl >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void wxMediaCtrl::base_SetSizeHints(int, int, int, int, int, int). Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_GetClientAreaOrigin(lua_State *L) {
		...
		wxMediaCtrl* self=Luna< wxObject >::checkSubType< wxMediaCtrl >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call wxPoint wxMediaCtrl::base_GetClientAreaOrigin() const. Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_ClearBackground(lua_State *L) {
		...
		wxMediaCtrl* self=Luna< wxObject >::checkSubType< wxMediaCtrl >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void wxMediaCtrl::base_ClearBackground(). Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_GetBackgroundStyle(lua_State *L) {
		...
		wxMediaCtrl* self=Luna< wxObject >::checkSubType< wxMediaCtrl >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call wxBackgroundStyle wxMediaCtrl::base_GetBackgroundStyle() const. Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_GetCharHeight(lua_State *L) {
		...
		wxMediaCtrl* self=Luna< wxObject >::checkSubType< wxMediaCtrl >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call int wxMediaCtrl::base_GetCharHeight() const. Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_GetCharWidth(lua_State *L) {
		...
		wxMediaCtrl* self=Luna< wxObject >::checkSubType< wxMediaCtrl >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call int wxMediaCtrl::base_GetCharWidth() const. Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_GetDefaultAttributes(lua_State *L) {
		...
		wxMediaCtrl* self=Luna< wxObject >::checkSubType< wxMediaCtrl >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call wxVisualAttributes wxMediaCtrl::base_GetDefaultAttributes() const. Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_Refresh(lua_State *L) {
		...
		wxMediaCtrl* self=Luna< wxObject >::checkSubType< wxMediaCtrl >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void wxMediaCtrl::base_Refresh(bool, const wxRect *). Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_Update(lua_State *L) {
		...
		wxMediaCtrl* self=Luna< wxObject >::checkSubType< wxMediaCtrl >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void wxMediaCtrl::base_Update(). Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_SetBackgroundStyle(lua_State *L) {
		...
		wxMediaCtrl* self=Luna< wxObject >::checkSubType< wxMediaCtrl >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call bool wxMediaCtrl::base_SetBackgroundStyle(wxBackgroundStyle). Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_SetFont(lua_State *L) {
		...
		wxMediaCtrl* self=Luna< wxObject >::checkSubType< wxMediaCtrl >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call bool wxMediaCtrl::base_SetFont(const wxFont &). Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_ShouldInheritColours(lua_State *L) {
		...
		wxMediaCtrl* self=Luna< wxObject >::checkSubType< wxMediaCtrl >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call bool wxMediaCtrl::base_ShouldInheritColours() const. Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_SetThemeEnabled(lua_State *L) {
		...
		wxMediaCtrl* self=Luna< wxObject >::checkSubType< wxMediaCtrl >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void wxMediaCtrl::base_SetThemeEnabled(bool). Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_GetThemeEnabled(lua_State *L) {
		...
		wxMediaCtrl* self=Luna< wxObject >::checkSubType< wxMediaCtrl >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call bool wxMediaCtrl::base_GetThemeEnabled() const. Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_CanSetTransparent(lua_State *L) {
		...
		wxMediaCtrl* self=Luna< wxObject >::checkSubType< wxMediaCtrl >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call bool wxMediaCtrl::base_CanSetTransparent(). Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_SetTransparent(lua_State *L) {
		...
		wxMediaCtrl* self=Luna< wxObject >::checkSubType< wxMediaCtrl >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call bool wxMediaCtrl::base_SetTransparent(unsigned char). Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_SetNextHandler(lua_State *L) {
		...
		wxMediaCtrl* self=Luna< wxObject >::checkSubType< wxMediaCtrl >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void wxMediaCtrl::base_SetNextHandler(wxEvtHandler *). Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_SetPreviousHandler(lua_State *L) {
		...
		wxMediaCtrl* self=Luna< wxObject >::checkSubType< wxMediaCtrl >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void wxMediaCtrl::base_SetPreviousHandler(wxEvtHandler *). Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_GetWindowStyleFlag(lua_State *L) {
		...
		wxMediaCtrl* self=Luna< wxObject >::checkSubType< wxMediaCtrl >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call long wxMediaCtrl::base_GetWindowStyleFlag() const. Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_SetExtraStyle(lua_State *L) {
		...
		wxMediaCtrl* self=Luna< wxObject >::checkSubType< wxMediaCtrl >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void wxMediaCtrl::base_SetExtraStyle(long). Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_SetWindowStyleFlag(lua_State *L) {
		...
		wxMediaCtrl* self=Luna< wxObject >::checkSubType< wxMediaCtrl >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void wxMediaCtrl::base_SetWindowStyleFlag(long). Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_Lower(lua_State *L) {
		...
		wxMediaCtrl* self=Luna< wxObject >::checkSubType< wxMediaCtrl >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void wxMediaCtrl::base_Lower(). Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_Raise(lua_State *L) {
		...
		wxMediaCtrl* self=Luna< wxObject >::checkSubType< wxMediaCtrl >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void wxMediaCtrl::base_Raise(). Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_HideWithEffect(lua_State *L) {
		...
		wxMediaCtrl* self=Luna< wxObject >::checkSubType< wxMediaCtrl >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call bool wxMediaCtrl::base_HideWithEffect(wxShowEffect, unsigned int). Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_IsShown(lua_State *L) {
		...
		wxMediaCtrl* self=Luna< wxObject >::checkSubType< wxMediaCtrl >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call bool wxMediaCtrl::base_IsShown() const. Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_IsShownOnScreen(lua_State *L) {
		...
		wxMediaCtrl* self=Luna< wxObject >::checkSubType< wxMediaCtrl >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call bool wxMediaCtrl::base_IsShownOnScreen() const. Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_Enable(lua_State *L) {
		...
		wxMediaCtrl* self=Luna< wxObject >::checkSubType< wxMediaCtrl >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call bool wxMediaCtrl::base_Enable(bool). Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_Show(lua_State *L) {
		...
		wxMediaCtrl* self=Luna< wxObject >::checkSubType< wxMediaCtrl >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call bool wxMediaCtrl::base_Show(bool). Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_ShowWithEffect(lua_State *L) {
		...
		wxMediaCtrl* self=Luna< wxObject >::checkSubType< wxMediaCtrl >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call bool wxMediaCtrl::base_ShowWithEffect(wxShowEffect, unsigned int). Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_GetHelpTextAtPoint(lua_State *L) {
		...
		wxMediaCtrl* self=Luna< wxObject >::checkSubType< wxMediaCtrl >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call wxString wxMediaCtrl::base_GetHelpTextAtPoint(const wxPoint &, wxHelpEvent::Origin) const. Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_GetValidator(lua_State *L) {
		...
		wxMediaCtrl* self=Luna< wxObject >::checkSubType< wxMediaCtrl >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call wxValidator * wxMediaCtrl::base_GetValidator(). Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_SetValidator(lua_State *L) {
		...
		wxMediaCtrl* self=Luna< wxObject >::checkSubType< wxMediaCtrl >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void wxMediaCtrl::base_SetValidator(const wxValidator &). Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_TransferDataFromWindow(lua_State *L) {
		...
		wxMediaCtrl* self=Luna< wxObject >::checkSubType< wxMediaCtrl >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call bool wxMediaCtrl::base_TransferDataFromWindow(). Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_TransferDataToWindow(lua_State *L) {
		...
		wxMediaCtrl* self=Luna< wxObject >::checkSubType< wxMediaCtrl >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call bool wxMediaCtrl::base_TransferDataToWindow(). Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_Validate(lua_State *L) {
		...
		wxMediaCtrl* self=Luna< wxObject >::checkSubType< wxMediaCtrl >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call bool wxMediaCtrl::base_Validate(). Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_GetLayoutDirection(lua_State *L) {
		...
		wxMediaCtrl* self=Luna< wxObject >::checkSubType< wxMediaCtrl >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call wxLayoutDirection wxMediaCtrl::base_GetLayoutDirection() const. Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_GetName(lua_State *L) {
		...
		wxMediaCtrl* self=Luna< wxObject >::checkSubType< wxMediaCtrl >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call wxString wxMediaCtrl::base_GetName() const. Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_SetLayoutDirection(lua_State *L) {
		...
		wxMediaCtrl* self=Luna< wxObject >::checkSubType< wxMediaCtrl >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void wxMediaCtrl::base_SetLayoutDirection(wxLayoutDirection). Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_SetName(lua_State *L) {
		...
		wxMediaCtrl* self=Luna< wxObject >::checkSubType< wxMediaCtrl >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void wxMediaCtrl::base_SetName(const wxString &). Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_SetAcceleratorTable(lua_State *L) {
		...
		wxMediaCtrl* self=Luna< wxObject >::checkSubType< wxMediaCtrl >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void wxMediaCtrl::base_SetAcceleratorTable(const wxAcceleratorTable &). Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_Destroy(lua_State *L) {
		...
		wxMediaCtrl* self=Luna< wxObject >::checkSubType< wxMediaCtrl >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call bool wxMediaCtrl::base_Destroy(). Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_GetDropTarget(lua_State *L) {
		...
		wxMediaCtrl* self=Luna< wxObject >::checkSubType< wxMediaCtrl >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call wxDropTarget * wxMediaCtrl::base_GetDropTarget() const. Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_SetDropTarget(lua_State *L) {
		...
		wxMediaCtrl* self=Luna< wxObject >::checkSubType< wxMediaCtrl >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void wxMediaCtrl::base_SetDropTarget(wxDropTarget *). Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_DragAcceptFiles(lua_State *L) {
		...
		wxMediaCtrl* self=Luna< wxObject >::checkSubType< wxMediaCtrl >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void wxMediaCtrl::base_DragAcceptFiles(bool). Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_Layout(lua_State *L) {
		...
		wxMediaCtrl* self=Luna< wxObject >::checkSubType< wxMediaCtrl >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call bool wxMediaCtrl::base_Layout(). Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_HasCapture(lua_State *L) {
		...
		wxMediaCtrl* self=Luna< wxObject >::checkSubType< wxMediaCtrl >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call bool wxMediaCtrl::base_HasCapture() const. Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_SetCursor(lua_State *L) {
		...
		wxMediaCtrl* self=Luna< wxObject >::checkSubType< wxMediaCtrl >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call bool wxMediaCtrl::base_SetCursor(const wxCursor &). Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_WarpPointer(lua_State *L) {
		...
		wxMediaCtrl* self=Luna< wxObject >::checkSubType< wxMediaCtrl >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void wxMediaCtrl::base_WarpPointer(int, int). Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_DoUpdateWindowUI(lua_State *L) {
		...
		wxMediaCtrl* self=Luna< wxObject >::checkSubType< wxMediaCtrl >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void wxMediaCtrl::base_DoUpdateWindowUI(wxUpdateUIEvent &). Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	// HWND wxMediaCtrl::base_GetHandle() const
	static int _bind_base_GetHandle(lua_State *L) {
		if (!_lg_typecheck_base_GetHandle(L)) {
			luaL_error(L, "luna typecheck failed in HWND wxMediaCtrl::base_GetHandle() const function, expected prototype:\nHWND wxMediaCtrl::base_GetHandle() const\nClass arguments details:\n\n%s",luna_dumpStack(L).c_str());
		}


		wxMediaCtrl* self=Luna< wxObject >::checkSubType< wxMediaCtrl >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call HWND wxMediaCtrl::base_GetHandle() const. Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
		HWND stack_lret = self->wxMediaCtrl::GetHandle();
	...
	static int _bind_base_HasMultiplePages(lua_State *L) {
		...
		wxMediaCtrl* self=Luna< wxObject >::checkSubType< wxMediaCtrl >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call bool wxMediaCtrl::base_HasMultiplePages() const. Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_InheritAttributes(lua_State *L) {
		...
		wxMediaCtrl* self=Luna< wxObject >::checkSubType< wxMediaCtrl >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void wxMediaCtrl::base_InheritAttributes(). Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_InitDialog(lua_State *L) {
		...
		wxMediaCtrl* self=Luna< wxObject >::checkSubType< wxMediaCtrl >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void wxMediaCtrl::base_InitDialog(). Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_IsRetained(lua_State *L) {
		...
		wxMediaCtrl* self=Luna< wxObject >::checkSubType< wxMediaCtrl >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call bool wxMediaCtrl::base_IsRetained() const. Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_IsTopLevel(lua_State *L) {
		...
		wxMediaCtrl* self=Luna< wxObject >::checkSubType< wxMediaCtrl >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call bool wxMediaCtrl::base_IsTopLevel() const. Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_MakeModal(lua_State *L) {
		...
		wxMediaCtrl* self=Luna< wxObject >::checkSubType< wxMediaCtrl >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void wxMediaCtrl::base_MakeModal(bool). Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_OnInternalIdle(lua_State *L) {
		...
		wxMediaCtrl* self=Luna< wxObject >::checkSubType< wxMediaCtrl >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void wxMediaCtrl::base_OnInternalIdle(). Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_RegisterHotKey(lua_State *L) {
		...
		wxMediaCtrl* self=Luna< wxObject >::checkSubType< wxMediaCtrl >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call bool wxMediaCtrl::base_RegisterHotKey(int, int, int). Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_UnregisterHotKey(lua_State *L) {
		...
		wxMediaCtrl* self=Luna< wxObject >::checkSubType< wxMediaCtrl >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call bool wxMediaCtrl::base_UnregisterHotKey(int). Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_UpdateWindowUI(lua_State *L) {
		...
		wxMediaCtrl* self=Luna< wxObject >::checkSubType< wxMediaCtrl >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void wxMediaCtrl::base_UpdateWindowUI(long). Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_Command(lua_State *L) {
		...
		wxMediaCtrl* self=Luna< wxObject >::checkSubType< wxMediaCtrl >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void wxMediaCtrl::base_Command(wxCommandEvent &). Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_GetLabel(lua_State *L) {
		...
		wxMediaCtrl* self=Luna< wxObject >::checkSubType< wxMediaCtrl >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call wxString wxMediaCtrl::base_GetLabel() const. Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_SetLabel(lua_State *L) {
		...
		wxMediaCtrl* self=Luna< wxObject >::checkSubType< wxMediaCtrl >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void wxMediaCtrl::base_SetLabel(const wxString &). Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
...
luna_RegType LunaTraits< wxMediaCtrl >::methods[] = {
	...
	{"base_GetHandle", &luna_wrapper_wxMediaCtrl::_bind_base_GetHandle},
	...
	{"fromVoid", &luna_wrapper_wxMediaCtrl::_bind_fromVoid},
	{"asVoid", &luna_wrapper_wxMediaCtrl::_bind_asVoid},
