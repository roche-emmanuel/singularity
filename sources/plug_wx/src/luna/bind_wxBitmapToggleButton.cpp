...
public:
	...
	static int _cast_from_wxTrackable(lua_State *L) {
		// all checked are already performed before reaching this point.
		wxBitmapToggleButton* ptr= static_cast< wxBitmapToggleButton* >(Luna< wxTrackable >::check(L,1));
		if(!ptr)
			return 0;
...
luna_ConverterType LunaTraits< wxBitmapToggleButton >::converters[] = {
	...
	{"wxTrackable", &luna_wrapper_wxBitmapToggleButton::_cast_from_wxTrackable},
	{0,0}
};
