...
public:
	...
	static int _bind_fromVoid(lua_State *L) {
		...
		Luna< wxPreviewControlBar >::push(L,self,false);
		return 1;
	}
	...
	// HWND wxPreviewControlBar::base_GetHandle() const
	static int _bind_base_GetHandle(lua_State *L) {
		if (!_lg_typecheck_base_GetHandle(L)) {
			luaL_error(L, "luna typecheck failed in HWND wxPreviewControlBar::base_GetHandle() const function, expected prototype:\nHWND wxPreviewControlBar::base_GetHandle() const\nClass arguments details:\n\n%s",luna_dumpStack(L).c_str());
		}


		wxPreviewControlBar* self=Luna< wxObject >::checkSubType< wxPreviewControlBar >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call HWND wxPreviewControlBar::base_GetHandle() const. Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
		HWND stack_lret = self->wxPreviewControlBar::GetHandle();
...
luna_RegType LunaTraits< wxPreviewControlBar >::methods[] = {
	...
	{"base_GetHandle", &luna_wrapper_wxPreviewControlBar::_bind_base_GetHandle},
	...
	{"fromVoid", &luna_wrapper_wxPreviewControlBar::_bind_fromVoid},
	{"asVoid", &luna_wrapper_wxPreviewControlBar::_bind_asVoid},
