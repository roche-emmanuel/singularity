...
public:
	...
	static int _bind_fromVoid(lua_State *L) {
		...
		wxPrintout* self= (wxPrintout*)(Luna< void >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call fromVoid(...)");
		}
		
		Luna< wxPrintout >::push(L,self,false);
		return 1;
	}
...
luna_RegType LunaTraits< wxPrintout >::methods[] = {
	{"fromVoid", &luna_wrapper_wxPrintout::_bind_fromVoid},
	{"asVoid", &luna_wrapper_wxPrintout::_bind_asVoid},
	{"getTable", &luna_wrapper_wxPrintout::_bind_getTable},
	{0,0}
};
