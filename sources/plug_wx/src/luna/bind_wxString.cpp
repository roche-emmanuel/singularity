...
public:
	...
	static int _bind_fromVoid(lua_State *L) {
		...
		wxString* self= (wxString*)(Luna< void >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call fromVoid(...)");
		}
		
		Luna< wxString >::push(L,self,false);
		return 1;
	}
	...
	static int _bind_asVoid(lua_State *L) {
		...
		void* self= (void*)(Luna< wxString >::check(L,1));
		if(!self) {
...
luna_RegType LunaTraits< wxString >::methods[] = {
	...
	{"fromVoid", &luna_wrapper_wxString::_bind_fromVoid},
	{"asVoid", &luna_wrapper_wxString::_bind_asVoid},
	{0,0}
};
