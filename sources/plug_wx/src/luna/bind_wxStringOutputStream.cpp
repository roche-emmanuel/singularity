...
public:
	...
	static int _bind_fromVoid(lua_State *L) {
		...
		wxStringOutputStream* self= (wxStringOutputStream*)(Luna< void >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call fromVoid(...)");
		}
		
		Luna< wxStringOutputStream >::push(L,self,false);
		return 1;
	}
	...
	static int _bind_GetString(lua_State *L) {
		...
		if(!self) {
			luaL_error(L, "Invalid object in function call const wxString & wxStringOutputStream::GetString() const. Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_GetClassInfo(lua_State *L) {
		...
		wxStringOutputStream* self=Luna< wxObject >::checkSubType< wxStringOutputStream >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call wxClassInfo * wxStringOutputStream::base_GetClassInfo() const. Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_GetLength(lua_State *L) {
		...
		wxStringOutputStream* self=Luna< wxObject >::checkSubType< wxStringOutputStream >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call long long wxStringOutputStream::base_GetLength() const. Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_GetSize(lua_State *L) {
		...
		wxStringOutputStream* self=Luna< wxObject >::checkSubType< wxStringOutputStream >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call size_t wxStringOutputStream::base_GetSize() const. Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_IsOk(lua_State *L) {
		...
		wxStringOutputStream* self=Luna< wxObject >::checkSubType< wxStringOutputStream >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call bool wxStringOutputStream::base_IsOk() const. Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_IsSeekable(lua_State *L) {
		...
		wxStringOutputStream* self=Luna< wxObject >::checkSubType< wxStringOutputStream >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call bool wxStringOutputStream::base_IsSeekable() const. Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_Close(lua_State *L) {
		...
		wxStringOutputStream* self=Luna< wxObject >::checkSubType< wxStringOutputStream >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call bool wxStringOutputStream::base_Close(). Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_LastWrite(lua_State *L) {
		...
		wxStringOutputStream* self=Luna< wxObject >::checkSubType< wxStringOutputStream >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call size_t wxStringOutputStream::base_LastWrite() const. Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_SeekO(lua_State *L) {
		...
		wxStringOutputStream* self=Luna< wxObject >::checkSubType< wxStringOutputStream >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call long long wxStringOutputStream::base_SeekO(long long, wxSeekMode). Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_TellO(lua_State *L) {
		...
		wxStringOutputStream* self=Luna< wxObject >::checkSubType< wxStringOutputStream >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call long long wxStringOutputStream::base_TellO() const. Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_Write(lua_State *L) {
		...
		wxStringOutputStream* self=Luna< wxObject >::checkSubType< wxStringOutputStream >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call wxOutputStream & wxStringOutputStream::base_Write(const void *, size_t). Got : '%s'\n%s",typeid(Luna< wxObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
...
luna_RegType LunaTraits< wxStringOutputStream >::methods[] = {
	...
	{"fromVoid", &luna_wrapper_wxStringOutputStream::_bind_fromVoid},
	{"asVoid", &luna_wrapper_wxStringOutputStream::_bind_asVoid},
