...
#include <luna/wrappers/wrapper_wxRichTextPrinting.h>
...
public:
	...
	static int _bind_fromVoid(lua_State *L) {
		...
		wxRichTextPrinting* self= (wxRichTextPrinting*)(Luna< void >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call fromVoid(...)");
		}
		
		Luna< wxRichTextPrinting >::push(L,self,false);
		return 1;
	}
	...
	static int _cast_from_wxObject(lua_State *L) {
		...
		wxRichTextPrinting* ptr= luna_caster< wxObject, wxRichTextPrinting >::cast(Luna< wxObject >::check(L,1));
		if(!ptr)
			return 0;
...
luna_RegType LunaTraits< wxRichTextPrinting >::methods[] = {
	...
	{"fromVoid", &luna_wrapper_wxRichTextPrinting::_bind_fromVoid},
	{"asVoid", &luna_wrapper_wxRichTextPrinting::_bind_asVoid},
	{"getTable", &luna_wrapper_wxRichTextPrinting::_bind_getTable},
	{0,0}
};
