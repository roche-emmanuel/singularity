...
public:
	...
	static int _bind_fromVoid(lua_State *L) {
		...
		DoubleCallback* self= (DoubleCallback*)(Luna< void >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call fromVoid(...)");
		}
		
		Luna< DoubleCallback >::push(L,self,false);
		return 1;
	}
	...
	static int _bind_setValue(lua_State *L) {
		...
		if(!self) {
			luaL_error(L, "Invalid object in function call void DoubleCallback::setValue(double). Got : '%s'\n%s",typeid(Luna< osg::Referenced >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
		self->setValue(val);
	...
	static int _bind_getValue(lua_State *L) {
		...
		DoubleCallback* self=Luna< osg::Referenced >::checkSubType< DoubleCallback >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call double DoubleCallback::getValue(). Got : '%s'\n%s",typeid(Luna< osg::Referenced >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
...
luna_RegType LunaTraits< DoubleCallback >::methods[] = {
	...
	{"fromVoid", &luna_wrapper_DoubleCallback::_bind_fromVoid},
	{"asVoid", &luna_wrapper_DoubleCallback::_bind_asVoid},
