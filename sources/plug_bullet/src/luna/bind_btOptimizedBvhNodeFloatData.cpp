...
public:
	...
	static int _bind___eq(lua_State *L) {
		if (!_lg_typecheck___eq(L)) {
			luaL_error(L, "luna typecheck failed in __eq function, expected prototype:\n__eq(btOptimizedBvhNodeFloatData*). Got arguments:\n%s",luna_dumpStack(L).c_str());
		}
	...
	static int _bind_getAabbMinOrg(lua_State *L) {
		...
		btOptimizedBvhNodeFloatData* self=(Luna< btOptimizedBvhNodeFloatData >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call btVector3FloatData btOptimizedBvhNodeFloatData::m_aabbMinOrg(). Got : '%s'\n%s",typeid(Luna< btOptimizedBvhNodeFloatData >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_getAabbMaxOrg(lua_State *L) {
		...
		btOptimizedBvhNodeFloatData* self=(Luna< btOptimizedBvhNodeFloatData >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call btVector3FloatData btOptimizedBvhNodeFloatData::m_aabbMaxOrg(). Got : '%s'\n%s",typeid(Luna< btOptimizedBvhNodeFloatData >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_getEscapeIndex(lua_State *L) {
		...
		btOptimizedBvhNodeFloatData* self=(Luna< btOptimizedBvhNodeFloatData >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call int btOptimizedBvhNodeFloatData::m_escapeIndex(). Got : '%s'\n%s",typeid(Luna< btOptimizedBvhNodeFloatData >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_getSubPart(lua_State *L) {
		...
		btOptimizedBvhNodeFloatData* self=(Luna< btOptimizedBvhNodeFloatData >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call int btOptimizedBvhNodeFloatData::m_subPart(). Got : '%s'\n%s",typeid(Luna< btOptimizedBvhNodeFloatData >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_getTriangleIndex(lua_State *L) {
		...
		btOptimizedBvhNodeFloatData* self=(Luna< btOptimizedBvhNodeFloatData >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call int btOptimizedBvhNodeFloatData::m_triangleIndex(). Got : '%s'\n%s",typeid(Luna< btOptimizedBvhNodeFloatData >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_setAabbMinOrg(lua_State *L) {
		...
		btOptimizedBvhNodeFloatData* self=(Luna< btOptimizedBvhNodeFloatData >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call void btOptimizedBvhNodeFloatData::m_aabbMinOrg(btVector3FloatData). Got : '%s'\n%s",typeid(Luna< btOptimizedBvhNodeFloatData >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_setAabbMaxOrg(lua_State *L) {
		...
		btOptimizedBvhNodeFloatData* self=(Luna< btOptimizedBvhNodeFloatData >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call void btOptimizedBvhNodeFloatData::m_aabbMaxOrg(btVector3FloatData). Got : '%s'\n%s",typeid(Luna< btOptimizedBvhNodeFloatData >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_setEscapeIndex(lua_State *L) {
		...
		btOptimizedBvhNodeFloatData* self=(Luna< btOptimizedBvhNodeFloatData >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call void btOptimizedBvhNodeFloatData::m_escapeIndex(int). Got : '%s'\n%s",typeid(Luna< btOptimizedBvhNodeFloatData >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_setSubPart(lua_State *L) {
		...
		btOptimizedBvhNodeFloatData* self=(Luna< btOptimizedBvhNodeFloatData >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call void btOptimizedBvhNodeFloatData::m_subPart(int). Got : '%s'\n%s",typeid(Luna< btOptimizedBvhNodeFloatData >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_setTriangleIndex(lua_State *L) {
		...
		btOptimizedBvhNodeFloatData* self=(Luna< btOptimizedBvhNodeFloatData >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call void btOptimizedBvhNodeFloatData::m_triangleIndex(int). Got : '%s'\n%s",typeid(Luna< btOptimizedBvhNodeFloatData >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
