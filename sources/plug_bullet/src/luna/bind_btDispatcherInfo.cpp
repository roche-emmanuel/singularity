...
public:
	...
	static int _bind___eq(lua_State *L) {
		if (!_lg_typecheck___eq(L)) {
			luaL_error(L, "luna typecheck failed in __eq function, expected prototype:\n__eq(btDispatcherInfo*). Got arguments:\n%s",luna_dumpStack(L).c_str());
		}
	...
	static int _bind_fromVoid(lua_State *L) {
		...
		btDispatcherInfo* self= (btDispatcherInfo*)(Luna< void >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call fromVoid(...)");
		}
		
		Luna< btDispatcherInfo >::push(L,self,false);
		return 1;
	}
	...
	static int _bind_asVoid(lua_State *L) {
		...
		void* self= (void*)(Luna< btDispatcherInfo >::check(L,1));
		if(!self) {
	...
	static int _bind_getTimeStep(lua_State *L) {
		...
		btDispatcherInfo* self=(Luna< btDispatcherInfo >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call float btDispatcherInfo::m_timeStep(). Got : '%s'\n%s",typeid(Luna< btDispatcherInfo >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_getStepCount(lua_State *L) {
		...
		btDispatcherInfo* self=(Luna< btDispatcherInfo >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call int btDispatcherInfo::m_stepCount(). Got : '%s'\n%s",typeid(Luna< btDispatcherInfo >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_getDispatchFunc(lua_State *L) {
		...
		btDispatcherInfo* self=(Luna< btDispatcherInfo >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call int btDispatcherInfo::m_dispatchFunc(). Got : '%s'\n%s",typeid(Luna< btDispatcherInfo >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_getTimeOfImpact(lua_State *L) {
		...
		btDispatcherInfo* self=(Luna< btDispatcherInfo >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call float btDispatcherInfo::m_timeOfImpact(). Got : '%s'\n%s",typeid(Luna< btDispatcherInfo >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_getUseContinuous(lua_State *L) {
		...
		btDispatcherInfo* self=(Luna< btDispatcherInfo >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call bool btDispatcherInfo::m_useContinuous(). Got : '%s'\n%s",typeid(Luna< btDispatcherInfo >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_getDebugDraw(lua_State *L) {
		...
		btDispatcherInfo* self=(Luna< btDispatcherInfo >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call class btIDebugDraw * btDispatcherInfo::m_debugDraw(). Got : '%s'\n%s",typeid(Luna< btDispatcherInfo >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_getEnableSatConvex(lua_State *L) {
		...
		btDispatcherInfo* self=(Luna< btDispatcherInfo >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call bool btDispatcherInfo::m_enableSatConvex(). Got : '%s'\n%s",typeid(Luna< btDispatcherInfo >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_getEnableSPU(lua_State *L) {
		...
		btDispatcherInfo* self=(Luna< btDispatcherInfo >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call bool btDispatcherInfo::m_enableSPU(). Got : '%s'\n%s",typeid(Luna< btDispatcherInfo >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_getUseEpa(lua_State *L) {
		...
		btDispatcherInfo* self=(Luna< btDispatcherInfo >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call bool btDispatcherInfo::m_useEpa(). Got : '%s'\n%s",typeid(Luna< btDispatcherInfo >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_getAllowedCcdPenetration(lua_State *L) {
		...
		btDispatcherInfo* self=(Luna< btDispatcherInfo >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call float btDispatcherInfo::m_allowedCcdPenetration(). Got : '%s'\n%s",typeid(Luna< btDispatcherInfo >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_getUseConvexConservativeDistanceUtil(lua_State *L) {
		...
		btDispatcherInfo* self=(Luna< btDispatcherInfo >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call bool btDispatcherInfo::m_useConvexConservativeDistanceUtil(). Got : '%s'\n%s",typeid(Luna< btDispatcherInfo >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_getConvexConservativeDistanceThreshold(lua_State *L) {
		...
		btDispatcherInfo* self=(Luna< btDispatcherInfo >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call float btDispatcherInfo::m_convexConservativeDistanceThreshold(). Got : '%s'\n%s",typeid(Luna< btDispatcherInfo >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_getStackAllocator(lua_State *L) {
		...
		btDispatcherInfo* self=(Luna< btDispatcherInfo >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call btStackAlloc * btDispatcherInfo::m_stackAllocator(). Got : '%s'\n%s",typeid(Luna< btDispatcherInfo >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_setTimeStep(lua_State *L) {
		...
		btDispatcherInfo* self=(Luna< btDispatcherInfo >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call void btDispatcherInfo::m_timeStep(float). Got : '%s'\n%s",typeid(Luna< btDispatcherInfo >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_setStepCount(lua_State *L) {
		...
		btDispatcherInfo* self=(Luna< btDispatcherInfo >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call void btDispatcherInfo::m_stepCount(int). Got : '%s'\n%s",typeid(Luna< btDispatcherInfo >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_setDispatchFunc(lua_State *L) {
		...
		btDispatcherInfo* self=(Luna< btDispatcherInfo >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call void btDispatcherInfo::m_dispatchFunc(int). Got : '%s'\n%s",typeid(Luna< btDispatcherInfo >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_setTimeOfImpact(lua_State *L) {
		...
		btDispatcherInfo* self=(Luna< btDispatcherInfo >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call void btDispatcherInfo::m_timeOfImpact(float). Got : '%s'\n%s",typeid(Luna< btDispatcherInfo >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_setUseContinuous(lua_State *L) {
		...
		btDispatcherInfo* self=(Luna< btDispatcherInfo >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call void btDispatcherInfo::m_useContinuous(bool). Got : '%s'\n%s",typeid(Luna< btDispatcherInfo >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_setDebugDraw(lua_State *L) {
		...
		btDispatcherInfo* self=(Luna< btDispatcherInfo >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call void btDispatcherInfo::m_debugDraw(class btIDebugDraw *). Got : '%s'\n%s",typeid(Luna< btDispatcherInfo >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_setEnableSatConvex(lua_State *L) {
		...
		btDispatcherInfo* self=(Luna< btDispatcherInfo >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call void btDispatcherInfo::m_enableSatConvex(bool). Got : '%s'\n%s",typeid(Luna< btDispatcherInfo >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_setEnableSPU(lua_State *L) {
		...
		btDispatcherInfo* self=(Luna< btDispatcherInfo >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call void btDispatcherInfo::m_enableSPU(bool). Got : '%s'\n%s",typeid(Luna< btDispatcherInfo >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_setUseEpa(lua_State *L) {
		...
		btDispatcherInfo* self=(Luna< btDispatcherInfo >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call void btDispatcherInfo::m_useEpa(bool). Got : '%s'\n%s",typeid(Luna< btDispatcherInfo >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
		self->m_useEpa = value;
	...
	static int _bind_setAllowedCcdPenetration(lua_State *L) {
		...
		btDispatcherInfo* self=(Luna< btDispatcherInfo >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call void btDispatcherInfo::m_allowedCcdPenetration(float). Got : '%s'\n%s",typeid(Luna< btDispatcherInfo >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_setUseConvexConservativeDistanceUtil(lua_State *L) {
		...
		btDispatcherInfo* self=(Luna< btDispatcherInfo >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call void btDispatcherInfo::m_useConvexConservativeDistanceUtil(bool). Got : '%s'\n%s",typeid(Luna< btDispatcherInfo >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_setConvexConservativeDistanceThreshold(lua_State *L) {
		...
		btDispatcherInfo* self=(Luna< btDispatcherInfo >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call void btDispatcherInfo::m_convexConservativeDistanceThreshold(float). Got : '%s'\n%s",typeid(Luna< btDispatcherInfo >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_setStackAllocator(lua_State *L) {
		...
		btDispatcherInfo* self=(Luna< btDispatcherInfo >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call void btDispatcherInfo::m_stackAllocator(btStackAlloc *). Got : '%s'\n%s",typeid(Luna< btDispatcherInfo >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
...
luna_RegType LunaTraits< btDispatcherInfo >::methods[] = {
	...
	{"fromVoid", &luna_wrapper_btDispatcherInfo::_bind_fromVoid},
	{"asVoid", &luna_wrapper_btDispatcherInfo::_bind_asVoid},
	{0,0}
};
