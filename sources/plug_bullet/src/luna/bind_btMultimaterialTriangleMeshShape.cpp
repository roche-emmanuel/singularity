...
public:
	...
	static int _bind_fromVoid(lua_State *L) {
		...
		Luna< btMultimaterialTriangleMeshShape >::push(L,self,false);
		return 1;
	}
...
luna_RegType LunaTraits< btMultimaterialTriangleMeshShape >::methods[] = {
	...
	{"fromVoid", &luna_wrapper_btMultimaterialTriangleMeshShape::_bind_fromVoid},
	{"asVoid", &luna_wrapper_btMultimaterialTriangleMeshShape::_bind_asVoid},
