...
public:
	...
	static int _bind_fromVoid(lua_State *L) {
		...
		Luna< btConvexHullComputer >::push(L,self,false);
		return 1;
	}
...
luna_RegType LunaTraits< btConvexHullComputer >::methods[] = {
	...
	{"fromVoid", &luna_wrapper_btConvexHullComputer::_bind_fromVoid},
	{"asVoid", &luna_wrapper_btConvexHullComputer::_bind_asVoid},
	{0,0}
};
