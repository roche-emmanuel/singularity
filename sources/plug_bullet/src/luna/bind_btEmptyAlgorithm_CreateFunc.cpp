...
public:
	...
	static int _bind_fromVoid(lua_State *L) {
		...
		btEmptyAlgorithm::CreateFunc* self= (btEmptyAlgorithm::CreateFunc*)(Luna< void >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call fromVoid(...)");
		}
		
		Luna< btEmptyAlgorithm::CreateFunc >::push(L,self,false);
		return 1;
	}
	...
	static int _bind_CreateCollisionAlgorithm(lua_State *L) {
		...
		if(!self) {
			luaL_error(L, "Invalid object in function call btCollisionAlgorithm * btEmptyAlgorithm::CreateFunc::CreateCollisionAlgorithm(btCollisionAlgorithmConstructionInfo &, const btCollisionObjectWrapper *, const btCollisionObjectWrapper *). Got : '%s'\n%s",typeid(Luna< btCollisionAlgorithmCreateFunc >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_CreateCollisionAlgorithm(lua_State *L) {
		...
		btEmptyAlgorithm::CreateFunc* self=Luna< btCollisionAlgorithmCreateFunc >::checkSubType< btEmptyAlgorithm::CreateFunc >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call btCollisionAlgorithm * btEmptyAlgorithm::CreateFunc::base_CreateCollisionAlgorithm(btCollisionAlgorithmConstructionInfo &, const btCollisionObjectWrapper *, const btCollisionObjectWrapper *). Got : '%s'\n%s",typeid(Luna< btCollisionAlgorithmCreateFunc >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
...
luna_RegType LunaTraits< btEmptyAlgorithm::CreateFunc >::methods[] = {
	...
	{"fromVoid", &luna_wrapper_btEmptyAlgorithm_CreateFunc::_bind_fromVoid},
	{"asVoid", &luna_wrapper_btEmptyAlgorithm_CreateFunc::_bind_asVoid},
