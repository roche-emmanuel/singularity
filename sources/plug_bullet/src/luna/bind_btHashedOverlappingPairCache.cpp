...
public:
	...
	static int _bind_fromVoid(lua_State *L) {
		...
		Luna< btHashedOverlappingPairCache >::push(L,self,false);
		return 1;
	}
...
luna_RegType LunaTraits< btHashedOverlappingPairCache >::methods[] = {
	...
	{"fromVoid", &luna_wrapper_btHashedOverlappingPairCache::_bind_fromVoid},
	{"asVoid", &luna_wrapper_btHashedOverlappingPairCache::_bind_asVoid},
