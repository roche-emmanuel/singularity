...
public:
	...
	static int _bind_getName(lua_State *L) {
		...
		if(!self) {
			luaL_error(L, "Invalid object in function call const char * btCapsuleShapeX::getName() const. Got : '%s'\n%s",typeid(Luna< btCollisionShape >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_getBoundingSphere(lua_State *L) {
		...
		btCapsuleShapeX* self=Luna< btCollisionShape >::checkSubType< btCapsuleShapeX >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void btCapsuleShapeX::base_getBoundingSphere(btVector3 &, float &) const. Got : '%s'\n%s",typeid(Luna< btCollisionShape >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_getAngularMotionDisc(lua_State *L) {
		...
		btCapsuleShapeX* self=Luna< btCollisionShape >::checkSubType< btCapsuleShapeX >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call float btCapsuleShapeX::base_getAngularMotionDisc() const. Got : '%s'\n%s",typeid(Luna< btCollisionShape >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_getContactBreakingThreshold(lua_State *L) {
		...
		btCapsuleShapeX* self=Luna< btCollisionShape >::checkSubType< btCapsuleShapeX >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call float btCapsuleShapeX::base_getContactBreakingThreshold(float) const. Got : '%s'\n%s",typeid(Luna< btCollisionShape >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_project(lua_State *L) {
		...
		btCapsuleShapeX* self=Luna< btCollisionShape >::checkSubType< btCapsuleShapeX >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void btCapsuleShapeX::base_project(const btTransform &, const btVector3 &, float &, float &) const. Got : '%s'\n%s",typeid(Luna< btCollisionShape >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_localGetSupportingVertex(lua_State *L) {
		...
		btCapsuleShapeX* self=Luna< btCollisionShape >::checkSubType< btCapsuleShapeX >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call btVector3 btCapsuleShapeX::base_localGetSupportingVertex(const btVector3 &) const. Got : '%s'\n%s",typeid(Luna< btCollisionShape >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_getAabbSlow(lua_State *L) {
		...
		btCapsuleShapeX* self=Luna< btCollisionShape >::checkSubType< btCapsuleShapeX >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void btCapsuleShapeX::base_getAabbSlow(const btTransform &, btVector3 &, btVector3 &) const. Got : '%s'\n%s",typeid(Luna< btCollisionShape >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_getLocalScaling(lua_State *L) {
		...
		btCapsuleShapeX* self=Luna< btCollisionShape >::checkSubType< btCapsuleShapeX >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call const btVector3 & btCapsuleShapeX::base_getLocalScaling() const. Got : '%s'\n%s",typeid(Luna< btCollisionShape >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_getMargin(lua_State *L) {
		...
		btCapsuleShapeX* self=Luna< btCollisionShape >::checkSubType< btCapsuleShapeX >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call float btCapsuleShapeX::base_getMargin() const. Got : '%s'\n%s",typeid(Luna< btCollisionShape >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_getNumPreferredPenetrationDirections(lua_State *L) {
		...
		btCapsuleShapeX* self=Luna< btCollisionShape >::checkSubType< btCapsuleShapeX >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call int btCapsuleShapeX::base_getNumPreferredPenetrationDirections() const. Got : '%s'\n%s",typeid(Luna< btCollisionShape >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_getPreferredPenetrationDirection(lua_State *L) {
		...
		btCapsuleShapeX* self=Luna< btCollisionShape >::checkSubType< btCapsuleShapeX >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void btCapsuleShapeX::base_getPreferredPenetrationDirection(int, btVector3 &) const. Got : '%s'\n%s",typeid(Luna< btCollisionShape >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_calculateLocalInertia(lua_State *L) {
		...
		btCapsuleShapeX* self=Luna< btCollisionShape >::checkSubType< btCapsuleShapeX >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void btCapsuleShapeX::base_calculateLocalInertia(float, btVector3 &) const. Got : '%s'\n%s",typeid(Luna< btCollisionShape >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_localGetSupportingVertexWithoutMargin(lua_State *L) {
		...
		btCapsuleShapeX* self=Luna< btCollisionShape >::checkSubType< btCapsuleShapeX >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call btVector3 btCapsuleShapeX::base_localGetSupportingVertexWithoutMargin(const btVector3 &) const. Got : '%s'\n%s",typeid(Luna< btCollisionShape >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_batchedUnitVectorGetSupportingVertexWithoutMargin(lua_State *L) {
		...
		btCapsuleShapeX* self=Luna< btCollisionShape >::checkSubType< btCapsuleShapeX >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void btCapsuleShapeX::base_batchedUnitVectorGetSupportingVertexWithoutMargin(const btVector3 *, btVector3 *, int) const. Got : '%s'\n%s",typeid(Luna< btCollisionShape >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_setMargin(lua_State *L) {
		...
		btCapsuleShapeX* self=Luna< btCollisionShape >::checkSubType< btCapsuleShapeX >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void btCapsuleShapeX::base_setMargin(float). Got : '%s'\n%s",typeid(Luna< btCollisionShape >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_getAabb(lua_State *L) {
		...
		btCapsuleShapeX* self=Luna< btCollisionShape >::checkSubType< btCapsuleShapeX >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void btCapsuleShapeX::base_getAabb(const btTransform &, btVector3 &, btVector3 &) const. Got : '%s'\n%s",typeid(Luna< btCollisionShape >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_setLocalScaling(lua_State *L) {
		...
		btCapsuleShapeX* self=Luna< btCollisionShape >::checkSubType< btCapsuleShapeX >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void btCapsuleShapeX::base_setLocalScaling(const btVector3 &). Got : '%s'\n%s",typeid(Luna< btCollisionShape >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_getAnisotropicRollingFrictionDirection(lua_State *L) {
		...
		btCapsuleShapeX* self=Luna< btCollisionShape >::checkSubType< btCapsuleShapeX >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call btVector3 btCapsuleShapeX::base_getAnisotropicRollingFrictionDirection() const. Got : '%s'\n%s",typeid(Luna< btCollisionShape >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_calculateSerializeBufferSize(lua_State *L) {
		...
		btCapsuleShapeX* self=Luna< btCollisionShape >::checkSubType< btCapsuleShapeX >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call int btCapsuleShapeX::base_calculateSerializeBufferSize() const. Got : '%s'\n%s",typeid(Luna< btCollisionShape >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_getName(lua_State *L) {
		...
		btCapsuleShapeX* self=Luna< btCollisionShape >::checkSubType< btCapsuleShapeX >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call const char * btCapsuleShapeX::base_getName() const. Got : '%s'\n%s",typeid(Luna< btCollisionShape >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
