...
public:
	...
	static int _bind_fromVoid(lua_State *L) {
		...
		Luna< btCollisionDispatcher >::push(L,self,false);
		return 1;
	}
...
luna_RegType LunaTraits< btCollisionDispatcher >::methods[] = {
	...
	{"fromVoid", &luna_wrapper_btCollisionDispatcher::_bind_fromVoid},
	{"asVoid", &luna_wrapper_btCollisionDispatcher::_bind_asVoid},
