...
public:
	...
	static int _bind_writeHeader(lua_State *L) {
		...
		if(!self) {
			luaL_error(L, "Invalid object in function call void btDefaultSerializer::writeHeader(unsigned char *) const. Got : '%s'\n%s",typeid(Luna< btSerializer >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_startSerialization(lua_State *L) {
		...
		btDefaultSerializer* self=Luna< btSerializer >::checkSubType< btDefaultSerializer >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void btDefaultSerializer::startSerialization(). Got : '%s'\n%s",typeid(Luna< btSerializer >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_finishSerialization(lua_State *L) {
		...
		btDefaultSerializer* self=Luna< btSerializer >::checkSubType< btDefaultSerializer >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void btDefaultSerializer::finishSerialization(). Got : '%s'\n%s",typeid(Luna< btSerializer >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_getUniquePointer(lua_State *L) {
		...
		btDefaultSerializer* self=Luna< btSerializer >::checkSubType< btDefaultSerializer >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void * btDefaultSerializer::getUniquePointer(void *). Got : '%s'\n%s",typeid(Luna< btSerializer >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_getBufferPointer(lua_State *L) {
		...
		btDefaultSerializer* self=Luna< btSerializer >::checkSubType< btDefaultSerializer >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call const unsigned char * btDefaultSerializer::getBufferPointer() const. Got : '%s'\n%s",typeid(Luna< btSerializer >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_getCurrentBufferSize(lua_State *L) {
		...
		btDefaultSerializer* self=Luna< btSerializer >::checkSubType< btDefaultSerializer >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call int btDefaultSerializer::getCurrentBufferSize() const. Got : '%s'\n%s",typeid(Luna< btSerializer >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_finalizeChunk(lua_State *L) {
		...
		btDefaultSerializer* self=Luna< btSerializer >::checkSubType< btDefaultSerializer >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void btDefaultSerializer::finalizeChunk(btChunk *, const char *, int, void *). Got : '%s'\n%s",typeid(Luna< btSerializer >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_internalAlloc(lua_State *L) {
		...
		btDefaultSerializer* self=Luna< btSerializer >::checkSubType< btDefaultSerializer >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call unsigned char * btDefaultSerializer::internalAlloc(size_t). Got : '%s'\n%s",typeid(Luna< btSerializer >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_allocate(lua_State *L) {
		...
		btDefaultSerializer* self=Luna< btSerializer >::checkSubType< btDefaultSerializer >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call btChunk * btDefaultSerializer::allocate(size_t, int). Got : '%s'\n%s",typeid(Luna< btSerializer >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_findNameForPointer(lua_State *L) {
		...
		btDefaultSerializer* self=Luna< btSerializer >::checkSubType< btDefaultSerializer >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call const char * btDefaultSerializer::findNameForPointer(const void *) const. Got : '%s'\n%s",typeid(Luna< btSerializer >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_registerNameForPointer(lua_State *L) {
		...
		btDefaultSerializer* self=Luna< btSerializer >::checkSubType< btDefaultSerializer >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void btDefaultSerializer::registerNameForPointer(const void *, const char *). Got : '%s'\n%s",typeid(Luna< btSerializer >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_getSerializationFlags(lua_State *L) {
		...
		btDefaultSerializer* self=Luna< btSerializer >::checkSubType< btDefaultSerializer >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call int btDefaultSerializer::getSerializationFlags() const. Got : '%s'\n%s",typeid(Luna< btSerializer >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_setSerializationFlags(lua_State *L) {
		...
		btDefaultSerializer* self=Luna< btSerializer >::checkSubType< btDefaultSerializer >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void btDefaultSerializer::setSerializationFlags(int). Got : '%s'\n%s",typeid(Luna< btSerializer >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_startSerialization(lua_State *L) {
		...
		btDefaultSerializer* self=Luna< btSerializer >::checkSubType< btDefaultSerializer >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void btDefaultSerializer::base_startSerialization(). Got : '%s'\n%s",typeid(Luna< btSerializer >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_finishSerialization(lua_State *L) {
		...
		btDefaultSerializer* self=Luna< btSerializer >::checkSubType< btDefaultSerializer >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void btDefaultSerializer::base_finishSerialization(). Got : '%s'\n%s",typeid(Luna< btSerializer >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_getUniquePointer(lua_State *L) {
		...
		btDefaultSerializer* self=Luna< btSerializer >::checkSubType< btDefaultSerializer >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void * btDefaultSerializer::base_getUniquePointer(void *). Got : '%s'\n%s",typeid(Luna< btSerializer >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_getBufferPointer(lua_State *L) {
		...
		btDefaultSerializer* self=Luna< btSerializer >::checkSubType< btDefaultSerializer >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call const unsigned char * btDefaultSerializer::base_getBufferPointer() const. Got : '%s'\n%s",typeid(Luna< btSerializer >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_getCurrentBufferSize(lua_State *L) {
		...
		btDefaultSerializer* self=Luna< btSerializer >::checkSubType< btDefaultSerializer >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call int btDefaultSerializer::base_getCurrentBufferSize() const. Got : '%s'\n%s",typeid(Luna< btSerializer >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_finalizeChunk(lua_State *L) {
		...
		btDefaultSerializer* self=Luna< btSerializer >::checkSubType< btDefaultSerializer >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void btDefaultSerializer::base_finalizeChunk(btChunk *, const char *, int, void *). Got : '%s'\n%s",typeid(Luna< btSerializer >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_internalAlloc(lua_State *L) {
		...
		btDefaultSerializer* self=Luna< btSerializer >::checkSubType< btDefaultSerializer >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call unsigned char * btDefaultSerializer::base_internalAlloc(size_t). Got : '%s'\n%s",typeid(Luna< btSerializer >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_allocate(lua_State *L) {
		...
		btDefaultSerializer* self=Luna< btSerializer >::checkSubType< btDefaultSerializer >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call btChunk * btDefaultSerializer::base_allocate(size_t, int). Got : '%s'\n%s",typeid(Luna< btSerializer >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_findNameForPointer(lua_State *L) {
		...
		btDefaultSerializer* self=Luna< btSerializer >::checkSubType< btDefaultSerializer >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call const char * btDefaultSerializer::base_findNameForPointer(const void *) const. Got : '%s'\n%s",typeid(Luna< btSerializer >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_registerNameForPointer(lua_State *L) {
		...
		btDefaultSerializer* self=Luna< btSerializer >::checkSubType< btDefaultSerializer >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void btDefaultSerializer::base_registerNameForPointer(const void *, const char *). Got : '%s'\n%s",typeid(Luna< btSerializer >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_getSerializationFlags(lua_State *L) {
		...
		btDefaultSerializer* self=Luna< btSerializer >::checkSubType< btDefaultSerializer >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call int btDefaultSerializer::base_getSerializationFlags() const. Got : '%s'\n%s",typeid(Luna< btSerializer >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_setSerializationFlags(lua_State *L) {
		...
		btDefaultSerializer* self=Luna< btSerializer >::checkSubType< btDefaultSerializer >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void btDefaultSerializer::base_setSerializationFlags(int). Got : '%s'\n%s",typeid(Luna< btSerializer >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
