...
public:
	...
	static int _bind_fromVoid(lua_State *L) {
		...
		Luna< btGeneric6DofConstraintData >::push(L,self,false);
		return 1;
	}
...
luna_RegType LunaTraits< btGeneric6DofConstraintData >::methods[] = {
	...
	{"fromVoid", &luna_wrapper_btGeneric6DofConstraintData::_bind_fromVoid},
	{"asVoid", &luna_wrapper_btGeneric6DofConstraintData::_bind_asVoid},
	{0,0}
};
