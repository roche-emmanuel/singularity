...
public:
	...
	static int _bind_fromVoid(lua_State *L) {
		...
		Luna< btGImpactShapeInterface >::push(L,self,false);
		return 1;
	}
...
luna_RegType LunaTraits< btGImpactShapeInterface >::methods[] = {
	...
	{"fromVoid", &luna_wrapper_btGImpactShapeInterface::_bind_fromVoid},
	{"asVoid", &luna_wrapper_btGImpactShapeInterface::_bind_asVoid},
