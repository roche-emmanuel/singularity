...
public:
	...
	static int _bind_fromVoid(lua_State *L) {
		...
		Luna< btPoint2PointConstraint >::push(L,self,false);
		return 1;
	}
...
luna_RegType LunaTraits< btPoint2PointConstraint >::methods[] = {
	...
	{"fromVoid", &luna_wrapper_btPoint2PointConstraint::_bind_fromVoid},
	{"asVoid", &luna_wrapper_btPoint2PointConstraint::_bind_asVoid},
