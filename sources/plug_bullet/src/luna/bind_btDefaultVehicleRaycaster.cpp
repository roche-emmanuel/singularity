...
public:
	...
	static int _bind_fromVoid(lua_State *L) {
		...
		Luna< btDefaultVehicleRaycaster >::push(L,self,false);
		return 1;
	}
...
luna_RegType LunaTraits< btDefaultVehicleRaycaster >::methods[] = {
	...
	{"fromVoid", &luna_wrapper_btDefaultVehicleRaycaster::_bind_fromVoid},
	{"asVoid", &luna_wrapper_btDefaultVehicleRaycaster::_bind_asVoid},
