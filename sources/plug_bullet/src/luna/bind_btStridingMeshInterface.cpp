...
public:
	...
	static int _bind_fromVoid(lua_State *L) {
		...
		Luna< btStridingMeshInterface >::push(L,self,false);
		return 1;
	}
...
luna_RegType LunaTraits< btStridingMeshInterface >::methods[] = {
	...
	{"fromVoid", &luna_wrapper_btStridingMeshInterface::_bind_fromVoid},
	{"asVoid", &luna_wrapper_btStridingMeshInterface::_bind_asVoid},
