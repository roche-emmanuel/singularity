...
public:
	...
	static int _bind___eq(lua_State *L) {
		if (!_lg_typecheck___eq(L)) {
			luaL_error(L, "luna typecheck failed in __eq function, expected prototype:\n__eq(btPoint2PointConstraintDoubleData*). Got arguments:\n%s",luna_dumpStack(L).c_str());
		}
	...
	static int _bind_getTypeConstraintData(lua_State *L) {
		...
		btPoint2PointConstraintDoubleData* self=(Luna< btPoint2PointConstraintDoubleData >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call btTypedConstraintData btPoint2PointConstraintDoubleData::m_typeConstraintData(). Got : '%s'\n%s",typeid(Luna< btPoint2PointConstraintDoubleData >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_getPivotInA(lua_State *L) {
		...
		btPoint2PointConstraintDoubleData* self=(Luna< btPoint2PointConstraintDoubleData >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call btVector3DoubleData btPoint2PointConstraintDoubleData::m_pivotInA(). Got : '%s'\n%s",typeid(Luna< btPoint2PointConstraintDoubleData >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_getPivotInB(lua_State *L) {
		...
		btPoint2PointConstraintDoubleData* self=(Luna< btPoint2PointConstraintDoubleData >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call btVector3DoubleData btPoint2PointConstraintDoubleData::m_pivotInB(). Got : '%s'\n%s",typeid(Luna< btPoint2PointConstraintDoubleData >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_setTypeConstraintData(lua_State *L) {
		...
		btPoint2PointConstraintDoubleData* self=(Luna< btPoint2PointConstraintDoubleData >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call void btPoint2PointConstraintDoubleData::m_typeConstraintData(btTypedConstraintData). Got : '%s'\n%s",typeid(Luna< btPoint2PointConstraintDoubleData >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_setPivotInA(lua_State *L) {
		...
		btPoint2PointConstraintDoubleData* self=(Luna< btPoint2PointConstraintDoubleData >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call void btPoint2PointConstraintDoubleData::m_pivotInA(btVector3DoubleData). Got : '%s'\n%s",typeid(Luna< btPoint2PointConstraintDoubleData >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_setPivotInB(lua_State *L) {
		...
		btPoint2PointConstraintDoubleData* self=(Luna< btPoint2PointConstraintDoubleData >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call void btPoint2PointConstraintDoubleData::m_pivotInB(btVector3DoubleData). Got : '%s'\n%s",typeid(Luna< btPoint2PointConstraintDoubleData >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
