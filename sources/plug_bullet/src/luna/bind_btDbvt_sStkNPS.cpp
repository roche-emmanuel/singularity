...
public:
	...
	static int _bind___eq(lua_State *L) {
		if (!_lg_typecheck___eq(L)) {
			luaL_error(L, "luna typecheck failed in __eq function, expected prototype:\n__eq(btDbvt::sStkNPS*). Got arguments:\n%s",luna_dumpStack(L).c_str());
		}
	...
	static int _bind_getNode(lua_State *L) {
		...
		btDbvt::sStkNPS* self=(Luna< btDbvt::sStkNPS >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call const btDbvtNode * btDbvt::sStkNPS::node(). Got : '%s'\n%s",typeid(Luna< btDbvt::sStkNPS >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_getMask(lua_State *L) {
		...
		btDbvt::sStkNPS* self=(Luna< btDbvt::sStkNPS >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call int btDbvt::sStkNPS::mask(). Got : '%s'\n%s",typeid(Luna< btDbvt::sStkNPS >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
		int lret = self->mask;
	...
	static int _bind_getValue(lua_State *L) {
		...
		btDbvt::sStkNPS* self=(Luna< btDbvt::sStkNPS >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call float btDbvt::sStkNPS::value(). Got : '%s'\n%s",typeid(Luna< btDbvt::sStkNPS >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_setMask(lua_State *L) {
		...
		btDbvt::sStkNPS* self=(Luna< btDbvt::sStkNPS >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call void btDbvt::sStkNPS::mask(int). Got : '%s'\n%s",typeid(Luna< btDbvt::sStkNPS >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
		self->mask = value;
	...
	static int _bind_setValue(lua_State *L) {
		...
		btDbvt::sStkNPS* self=(Luna< btDbvt::sStkNPS >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call void btDbvt::sStkNPS::value(float). Got : '%s'\n%s",typeid(Luna< btDbvt::sStkNPS >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
		self->value = value;
