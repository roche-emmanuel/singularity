...
public:
	...
	static int _bind_localGetSupportingVertex(lua_State *L) {
		...
		if(!self) {
			luaL_error(L, "Invalid object in function call btVector3 btTriangleMeshShape::localGetSupportingVertex(const btVector3 &) const. Got : '%s'\n%s",typeid(Luna< btCollisionShape >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_localGetSupportingVertexWithoutMargin(lua_State *L) {
		...
		btTriangleMeshShape* self=Luna< btCollisionShape >::checkSubType< btTriangleMeshShape >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call btVector3 btTriangleMeshShape::localGetSupportingVertexWithoutMargin(const btVector3 &) const. Got : '%s'\n%s",typeid(Luna< btCollisionShape >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_recalcLocalAabb(lua_State *L) {
		...
		btTriangleMeshShape* self=Luna< btCollisionShape >::checkSubType< btTriangleMeshShape >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void btTriangleMeshShape::recalcLocalAabb(). Got : '%s'\n%s",typeid(Luna< btCollisionShape >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_getAabb(lua_State *L) {
		...
		btTriangleMeshShape* self=Luna< btCollisionShape >::checkSubType< btTriangleMeshShape >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void btTriangleMeshShape::getAabb(const btTransform &, btVector3 &, btVector3 &) const. Got : '%s'\n%s",typeid(Luna< btCollisionShape >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_processAllTriangles(lua_State *L) {
		...
		btTriangleMeshShape* self=Luna< btCollisionShape >::checkSubType< btTriangleMeshShape >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void btTriangleMeshShape::processAllTriangles(btTriangleCallback *, const btVector3 &, const btVector3 &) const. Got : '%s'\n%s",typeid(Luna< btCollisionShape >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_calculateLocalInertia(lua_State *L) {
		...
		btTriangleMeshShape* self=Luna< btCollisionShape >::checkSubType< btTriangleMeshShape >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void btTriangleMeshShape::calculateLocalInertia(float, btVector3 &) const. Got : '%s'\n%s",typeid(Luna< btCollisionShape >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_setLocalScaling(lua_State *L) {
		...
		btTriangleMeshShape* self=Luna< btCollisionShape >::checkSubType< btTriangleMeshShape >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void btTriangleMeshShape::setLocalScaling(const btVector3 &). Got : '%s'\n%s",typeid(Luna< btCollisionShape >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_getLocalScaling(lua_State *L) {
		...
		btTriangleMeshShape* self=Luna< btCollisionShape >::checkSubType< btTriangleMeshShape >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call const btVector3 & btTriangleMeshShape::getLocalScaling() const. Got : '%s'\n%s",typeid(Luna< btCollisionShape >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_getMeshInterface_overload_1(lua_State *L) {
		...
		btTriangleMeshShape* self=Luna< btCollisionShape >::checkSubType< btTriangleMeshShape >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call btStridingMeshInterface * btTriangleMeshShape::getMeshInterface(). Got : '%s'\n%s",typeid(Luna< btCollisionShape >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_getMeshInterface_overload_2(lua_State *L) {
		...
		btTriangleMeshShape* self=Luna< btCollisionShape >::checkSubType< btTriangleMeshShape >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call const btStridingMeshInterface * btTriangleMeshShape::getMeshInterface() const. Got : '%s'\n%s",typeid(Luna< btCollisionShape >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_getLocalAabbMin(lua_State *L) {
		...
		btTriangleMeshShape* self=Luna< btCollisionShape >::checkSubType< btTriangleMeshShape >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call const btVector3 & btTriangleMeshShape::getLocalAabbMin() const. Got : '%s'\n%s",typeid(Luna< btCollisionShape >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_getLocalAabbMax(lua_State *L) {
		...
		btTriangleMeshShape* self=Luna< btCollisionShape >::checkSubType< btTriangleMeshShape >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call const btVector3 & btTriangleMeshShape::getLocalAabbMax() const. Got : '%s'\n%s",typeid(Luna< btCollisionShape >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_getName(lua_State *L) {
		...
		btTriangleMeshShape* self=Luna< btCollisionShape >::checkSubType< btTriangleMeshShape >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call const char * btTriangleMeshShape::getName() const. Got : '%s'\n%s",typeid(Luna< btCollisionShape >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_getBoundingSphere(lua_State *L) {
		...
		btTriangleMeshShape* self=Luna< btCollisionShape >::checkSubType< btTriangleMeshShape >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void btTriangleMeshShape::base_getBoundingSphere(btVector3 &, float &) const. Got : '%s'\n%s",typeid(Luna< btCollisionShape >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_getAngularMotionDisc(lua_State *L) {
		...
		btTriangleMeshShape* self=Luna< btCollisionShape >::checkSubType< btTriangleMeshShape >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call float btTriangleMeshShape::base_getAngularMotionDisc() const. Got : '%s'\n%s",typeid(Luna< btCollisionShape >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_getContactBreakingThreshold(lua_State *L) {
		...
		btTriangleMeshShape* self=Luna< btCollisionShape >::checkSubType< btTriangleMeshShape >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call float btTriangleMeshShape::base_getContactBreakingThreshold(float) const. Got : '%s'\n%s",typeid(Luna< btCollisionShape >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_getAnisotropicRollingFrictionDirection(lua_State *L) {
		...
		btTriangleMeshShape* self=Luna< btCollisionShape >::checkSubType< btTriangleMeshShape >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call btVector3 btTriangleMeshShape::base_getAnisotropicRollingFrictionDirection() const. Got : '%s'\n%s",typeid(Luna< btCollisionShape >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_calculateSerializeBufferSize(lua_State *L) {
		...
		btTriangleMeshShape* self=Luna< btCollisionShape >::checkSubType< btTriangleMeshShape >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call int btTriangleMeshShape::base_calculateSerializeBufferSize() const. Got : '%s'\n%s",typeid(Luna< btCollisionShape >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_getMargin(lua_State *L) {
		...
		btTriangleMeshShape* self=Luna< btCollisionShape >::checkSubType< btTriangleMeshShape >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call float btTriangleMeshShape::base_getMargin() const. Got : '%s'\n%s",typeid(Luna< btCollisionShape >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_setMargin(lua_State *L) {
		...
		btTriangleMeshShape* self=Luna< btCollisionShape >::checkSubType< btTriangleMeshShape >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void btTriangleMeshShape::base_setMargin(float). Got : '%s'\n%s",typeid(Luna< btCollisionShape >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_localGetSupportingVertex(lua_State *L) {
		...
		btTriangleMeshShape* self=Luna< btCollisionShape >::checkSubType< btTriangleMeshShape >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call btVector3 btTriangleMeshShape::base_localGetSupportingVertex(const btVector3 &) const. Got : '%s'\n%s",typeid(Luna< btCollisionShape >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_localGetSupportingVertexWithoutMargin(lua_State *L) {
		...
		btTriangleMeshShape* self=Luna< btCollisionShape >::checkSubType< btTriangleMeshShape >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call btVector3 btTriangleMeshShape::base_localGetSupportingVertexWithoutMargin(const btVector3 &) const. Got : '%s'\n%s",typeid(Luna< btCollisionShape >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_getAabb(lua_State *L) {
		...
		btTriangleMeshShape* self=Luna< btCollisionShape >::checkSubType< btTriangleMeshShape >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void btTriangleMeshShape::base_getAabb(const btTransform &, btVector3 &, btVector3 &) const. Got : '%s'\n%s",typeid(Luna< btCollisionShape >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_processAllTriangles(lua_State *L) {
		...
		btTriangleMeshShape* self=Luna< btCollisionShape >::checkSubType< btTriangleMeshShape >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void btTriangleMeshShape::base_processAllTriangles(btTriangleCallback *, const btVector3 &, const btVector3 &) const. Got : '%s'\n%s",typeid(Luna< btCollisionShape >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_calculateLocalInertia(lua_State *L) {
		...
		btTriangleMeshShape* self=Luna< btCollisionShape >::checkSubType< btTriangleMeshShape >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void btTriangleMeshShape::base_calculateLocalInertia(float, btVector3 &) const. Got : '%s'\n%s",typeid(Luna< btCollisionShape >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_setLocalScaling(lua_State *L) {
		...
		btTriangleMeshShape* self=Luna< btCollisionShape >::checkSubType< btTriangleMeshShape >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void btTriangleMeshShape::base_setLocalScaling(const btVector3 &). Got : '%s'\n%s",typeid(Luna< btCollisionShape >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_getLocalScaling(lua_State *L) {
		...
		btTriangleMeshShape* self=Luna< btCollisionShape >::checkSubType< btTriangleMeshShape >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call const btVector3 & btTriangleMeshShape::base_getLocalScaling() const. Got : '%s'\n%s",typeid(Luna< btCollisionShape >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_getName(lua_State *L) {
		...
		btTriangleMeshShape* self=Luna< btCollisionShape >::checkSubType< btTriangleMeshShape >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call const char * btTriangleMeshShape::base_getName() const. Got : '%s'\n%s",typeid(Luna< btCollisionShape >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
