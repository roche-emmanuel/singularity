...
public:
	...
	static int _bind_collide(lua_State *L) {
		...
		if(!self) {
			luaL_error(L, "Invalid object in function call void btDbvtBroadphase::collide(btDispatcher *). Got : '%s'\n%s",typeid(Luna< btBroadphaseInterface >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_optimize(lua_State *L) {
		...
		btDbvtBroadphase* self=Luna< btBroadphaseInterface >::checkSubType< btDbvtBroadphase >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void btDbvtBroadphase::optimize(). Got : '%s'\n%s",typeid(Luna< btBroadphaseInterface >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
		self->optimize();
	...
	static int _bind_createProxy(lua_State *L) {
		...
		btDbvtBroadphase* self=Luna< btBroadphaseInterface >::checkSubType< btDbvtBroadphase >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call btBroadphaseProxy * btDbvtBroadphase::createProxy(const btVector3 &, const btVector3 &, int, void *, short int, short int, btDispatcher *, void *). Got : '%s'\n%s",typeid(Luna< btBroadphaseInterface >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_destroyProxy(lua_State *L) {
		...
		btDbvtBroadphase* self=Luna< btBroadphaseInterface >::checkSubType< btDbvtBroadphase >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void btDbvtBroadphase::destroyProxy(btBroadphaseProxy *, btDispatcher *). Got : '%s'\n%s",typeid(Luna< btBroadphaseInterface >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_setAabb(lua_State *L) {
		...
		btDbvtBroadphase* self=Luna< btBroadphaseInterface >::checkSubType< btDbvtBroadphase >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void btDbvtBroadphase::setAabb(btBroadphaseProxy *, const btVector3 &, const btVector3 &, btDispatcher *). Got : '%s'\n%s",typeid(Luna< btBroadphaseInterface >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_rayTest(lua_State *L) {
		...
		btDbvtBroadphase* self=Luna< btBroadphaseInterface >::checkSubType< btDbvtBroadphase >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void btDbvtBroadphase::rayTest(const btVector3 &, const btVector3 &, btBroadphaseRayCallback &, const btVector3 &, const btVector3 &). Got : '%s'\n%s",typeid(Luna< btBroadphaseInterface >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_aabbTest(lua_State *L) {
		...
		btDbvtBroadphase* self=Luna< btBroadphaseInterface >::checkSubType< btDbvtBroadphase >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void btDbvtBroadphase::aabbTest(const btVector3 &, const btVector3 &, btBroadphaseAabbCallback &). Got : '%s'\n%s",typeid(Luna< btBroadphaseInterface >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_getAabb(lua_State *L) {
		...
		btDbvtBroadphase* self=Luna< btBroadphaseInterface >::checkSubType< btDbvtBroadphase >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void btDbvtBroadphase::getAabb(btBroadphaseProxy *, btVector3 &, btVector3 &) const. Got : '%s'\n%s",typeid(Luna< btBroadphaseInterface >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_calculateOverlappingPairs(lua_State *L) {
		...
		btDbvtBroadphase* self=Luna< btBroadphaseInterface >::checkSubType< btDbvtBroadphase >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void btDbvtBroadphase::calculateOverlappingPairs(btDispatcher *). Got : '%s'\n%s",typeid(Luna< btBroadphaseInterface >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_getOverlappingPairCache_overload_1(lua_State *L) {
		...
		btDbvtBroadphase* self=Luna< btBroadphaseInterface >::checkSubType< btDbvtBroadphase >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call btOverlappingPairCache * btDbvtBroadphase::getOverlappingPairCache(). Got : '%s'\n%s",typeid(Luna< btBroadphaseInterface >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_getOverlappingPairCache_overload_2(lua_State *L) {
		...
		btDbvtBroadphase* self=Luna< btBroadphaseInterface >::checkSubType< btDbvtBroadphase >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call const btOverlappingPairCache * btDbvtBroadphase::getOverlappingPairCache() const. Got : '%s'\n%s",typeid(Luna< btBroadphaseInterface >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_getBroadphaseAabb(lua_State *L) {
		...
		btDbvtBroadphase* self=Luna< btBroadphaseInterface >::checkSubType< btDbvtBroadphase >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void btDbvtBroadphase::getBroadphaseAabb(btVector3 &, btVector3 &) const. Got : '%s'\n%s",typeid(Luna< btBroadphaseInterface >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_printStats(lua_State *L) {
		...
		btDbvtBroadphase* self=Luna< btBroadphaseInterface >::checkSubType< btDbvtBroadphase >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void btDbvtBroadphase::printStats(). Got : '%s'\n%s",typeid(Luna< btBroadphaseInterface >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
		self->printStats();
	...
	static int _bind_resetPool(lua_State *L) {
		...
		btDbvtBroadphase* self=Luna< btBroadphaseInterface >::checkSubType< btDbvtBroadphase >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void btDbvtBroadphase::resetPool(btDispatcher *). Got : '%s'\n%s",typeid(Luna< btBroadphaseInterface >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_performDeferredRemoval(lua_State *L) {
		...
		btDbvtBroadphase* self=Luna< btBroadphaseInterface >::checkSubType< btDbvtBroadphase >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void btDbvtBroadphase::performDeferredRemoval(btDispatcher *). Got : '%s'\n%s",typeid(Luna< btBroadphaseInterface >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_setVelocityPrediction(lua_State *L) {
		...
		btDbvtBroadphase* self=Luna< btBroadphaseInterface >::checkSubType< btDbvtBroadphase >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void btDbvtBroadphase::setVelocityPrediction(float). Got : '%s'\n%s",typeid(Luna< btBroadphaseInterface >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_getVelocityPrediction(lua_State *L) {
		...
		btDbvtBroadphase* self=Luna< btBroadphaseInterface >::checkSubType< btDbvtBroadphase >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call float btDbvtBroadphase::getVelocityPrediction() const. Got : '%s'\n%s",typeid(Luna< btBroadphaseInterface >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_setAabbForceUpdate(lua_State *L) {
		...
		btDbvtBroadphase* self=Luna< btBroadphaseInterface >::checkSubType< btDbvtBroadphase >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void btDbvtBroadphase::setAabbForceUpdate(btBroadphaseProxy *, const btVector3 &, const btVector3 &, btDispatcher *). Got : '%s'\n%s",typeid(Luna< btBroadphaseInterface >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_getPaircache(lua_State *L) {
		...
		btDbvtBroadphase* self=Luna< btBroadphaseInterface >::checkSubType< btDbvtBroadphase >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call btOverlappingPairCache * btDbvtBroadphase::m_paircache(). Got : '%s'\n%s",typeid(Luna< btBroadphaseInterface >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_getPrediction(lua_State *L) {
		...
		btDbvtBroadphase* self=Luna< btBroadphaseInterface >::checkSubType< btDbvtBroadphase >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call float btDbvtBroadphase::m_prediction(). Got : '%s'\n%s",typeid(Luna< btBroadphaseInterface >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_getStageCurrent(lua_State *L) {
		...
		btDbvtBroadphase* self=Luna< btBroadphaseInterface >::checkSubType< btDbvtBroadphase >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call int btDbvtBroadphase::m_stageCurrent(). Got : '%s'\n%s",typeid(Luna< btBroadphaseInterface >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_getFupdates(lua_State *L) {
		...
		btDbvtBroadphase* self=Luna< btBroadphaseInterface >::checkSubType< btDbvtBroadphase >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call int btDbvtBroadphase::m_fupdates(). Got : '%s'\n%s",typeid(Luna< btBroadphaseInterface >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_getDupdates(lua_State *L) {
		...
		btDbvtBroadphase* self=Luna< btBroadphaseInterface >::checkSubType< btDbvtBroadphase >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call int btDbvtBroadphase::m_dupdates(). Got : '%s'\n%s",typeid(Luna< btBroadphaseInterface >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_getCupdates(lua_State *L) {
		...
		btDbvtBroadphase* self=Luna< btBroadphaseInterface >::checkSubType< btDbvtBroadphase >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call int btDbvtBroadphase::m_cupdates(). Got : '%s'\n%s",typeid(Luna< btBroadphaseInterface >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_getNewpairs(lua_State *L) {
		...
		btDbvtBroadphase* self=Luna< btBroadphaseInterface >::checkSubType< btDbvtBroadphase >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call int btDbvtBroadphase::m_newpairs(). Got : '%s'\n%s",typeid(Luna< btBroadphaseInterface >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_getFixedleft(lua_State *L) {
		...
		btDbvtBroadphase* self=Luna< btBroadphaseInterface >::checkSubType< btDbvtBroadphase >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call int btDbvtBroadphase::m_fixedleft(). Got : '%s'\n%s",typeid(Luna< btBroadphaseInterface >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_get_updates_call(lua_State *L) {
		...
		btDbvtBroadphase* self=Luna< btBroadphaseInterface >::checkSubType< btDbvtBroadphase >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call unsigned int btDbvtBroadphase::m_updates_call(). Got : '%s'\n%s",typeid(Luna< btBroadphaseInterface >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_get_updates_done(lua_State *L) {
		...
		btDbvtBroadphase* self=Luna< btBroadphaseInterface >::checkSubType< btDbvtBroadphase >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call unsigned int btDbvtBroadphase::m_updates_done(). Got : '%s'\n%s",typeid(Luna< btBroadphaseInterface >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_get_updates_ratio(lua_State *L) {
		...
		btDbvtBroadphase* self=Luna< btBroadphaseInterface >::checkSubType< btDbvtBroadphase >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call float btDbvtBroadphase::m_updates_ratio(). Got : '%s'\n%s",typeid(Luna< btBroadphaseInterface >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_getPid(lua_State *L) {
		...
		btDbvtBroadphase* self=Luna< btBroadphaseInterface >::checkSubType< btDbvtBroadphase >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call int btDbvtBroadphase::m_pid(). Got : '%s'\n%s",typeid(Luna< btBroadphaseInterface >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
		int lret = self->m_pid;
		lua_pushnumber(L,lret);
	...
	static int _bind_getCid(lua_State *L) {
		...
		btDbvtBroadphase* self=Luna< btBroadphaseInterface >::checkSubType< btDbvtBroadphase >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call int btDbvtBroadphase::m_cid(). Got : '%s'\n%s",typeid(Luna< btBroadphaseInterface >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
		int lret = self->m_cid;
		lua_pushnumber(L,lret);
	...
	static int _bind_getGid(lua_State *L) {
		...
		btDbvtBroadphase* self=Luna< btBroadphaseInterface >::checkSubType< btDbvtBroadphase >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call int btDbvtBroadphase::m_gid(). Got : '%s'\n%s",typeid(Luna< btBroadphaseInterface >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
		int lret = self->m_gid;
		lua_pushnumber(L,lret);
	...
	static int _bind_getReleasepaircache(lua_State *L) {
		...
		btDbvtBroadphase* self=Luna< btBroadphaseInterface >::checkSubType< btDbvtBroadphase >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call bool btDbvtBroadphase::m_releasepaircache(). Got : '%s'\n%s",typeid(Luna< btBroadphaseInterface >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_getDeferedcollide(lua_State *L) {
		...
		btDbvtBroadphase* self=Luna< btBroadphaseInterface >::checkSubType< btDbvtBroadphase >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call bool btDbvtBroadphase::m_deferedcollide(). Got : '%s'\n%s",typeid(Luna< btBroadphaseInterface >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_getNeedcleanup(lua_State *L) {
		...
		btDbvtBroadphase* self=Luna< btBroadphaseInterface >::checkSubType< btDbvtBroadphase >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call bool btDbvtBroadphase::m_needcleanup(). Got : '%s'\n%s",typeid(Luna< btBroadphaseInterface >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_setPaircache(lua_State *L) {
		...
		btDbvtBroadphase* self=Luna< btBroadphaseInterface >::checkSubType< btDbvtBroadphase >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void btDbvtBroadphase::m_paircache(btOverlappingPairCache *). Got : '%s'\n%s",typeid(Luna< btBroadphaseInterface >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_setPrediction(lua_State *L) {
		...
		btDbvtBroadphase* self=Luna< btBroadphaseInterface >::checkSubType< btDbvtBroadphase >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void btDbvtBroadphase::m_prediction(float). Got : '%s'\n%s",typeid(Luna< btBroadphaseInterface >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_setStageCurrent(lua_State *L) {
		...
		btDbvtBroadphase* self=Luna< btBroadphaseInterface >::checkSubType< btDbvtBroadphase >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void btDbvtBroadphase::m_stageCurrent(int). Got : '%s'\n%s",typeid(Luna< btBroadphaseInterface >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_setFupdates(lua_State *L) {
		...
		btDbvtBroadphase* self=Luna< btBroadphaseInterface >::checkSubType< btDbvtBroadphase >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void btDbvtBroadphase::m_fupdates(int). Got : '%s'\n%s",typeid(Luna< btBroadphaseInterface >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_setDupdates(lua_State *L) {
		...
		btDbvtBroadphase* self=Luna< btBroadphaseInterface >::checkSubType< btDbvtBroadphase >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void btDbvtBroadphase::m_dupdates(int). Got : '%s'\n%s",typeid(Luna< btBroadphaseInterface >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_setCupdates(lua_State *L) {
		...
		btDbvtBroadphase* self=Luna< btBroadphaseInterface >::checkSubType< btDbvtBroadphase >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void btDbvtBroadphase::m_cupdates(int). Got : '%s'\n%s",typeid(Luna< btBroadphaseInterface >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_setNewpairs(lua_State *L) {
		...
		btDbvtBroadphase* self=Luna< btBroadphaseInterface >::checkSubType< btDbvtBroadphase >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void btDbvtBroadphase::m_newpairs(int). Got : '%s'\n%s",typeid(Luna< btBroadphaseInterface >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_setFixedleft(lua_State *L) {
		...
		btDbvtBroadphase* self=Luna< btBroadphaseInterface >::checkSubType< btDbvtBroadphase >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void btDbvtBroadphase::m_fixedleft(int). Got : '%s'\n%s",typeid(Luna< btBroadphaseInterface >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_set_updates_call(lua_State *L) {
		...
		btDbvtBroadphase* self=Luna< btBroadphaseInterface >::checkSubType< btDbvtBroadphase >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void btDbvtBroadphase::m_updates_call(unsigned int). Got : '%s'\n%s",typeid(Luna< btBroadphaseInterface >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_set_updates_done(lua_State *L) {
		...
		btDbvtBroadphase* self=Luna< btBroadphaseInterface >::checkSubType< btDbvtBroadphase >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void btDbvtBroadphase::m_updates_done(unsigned int). Got : '%s'\n%s",typeid(Luna< btBroadphaseInterface >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_set_updates_ratio(lua_State *L) {
		...
		btDbvtBroadphase* self=Luna< btBroadphaseInterface >::checkSubType< btDbvtBroadphase >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void btDbvtBroadphase::m_updates_ratio(float). Got : '%s'\n%s",typeid(Luna< btBroadphaseInterface >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_setPid(lua_State *L) {
		...
		btDbvtBroadphase* self=Luna< btBroadphaseInterface >::checkSubType< btDbvtBroadphase >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void btDbvtBroadphase::m_pid(int). Got : '%s'\n%s",typeid(Luna< btBroadphaseInterface >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
		self->m_pid = value;
	...
	static int _bind_setCid(lua_State *L) {
		...
		btDbvtBroadphase* self=Luna< btBroadphaseInterface >::checkSubType< btDbvtBroadphase >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void btDbvtBroadphase::m_cid(int). Got : '%s'\n%s",typeid(Luna< btBroadphaseInterface >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
		self->m_cid = value;
	...
	static int _bind_setGid(lua_State *L) {
		...
		btDbvtBroadphase* self=Luna< btBroadphaseInterface >::checkSubType< btDbvtBroadphase >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void btDbvtBroadphase::m_gid(int). Got : '%s'\n%s",typeid(Luna< btBroadphaseInterface >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
		self->m_gid = value;
	...
	static int _bind_setReleasepaircache(lua_State *L) {
		...
		btDbvtBroadphase* self=Luna< btBroadphaseInterface >::checkSubType< btDbvtBroadphase >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void btDbvtBroadphase::m_releasepaircache(bool). Got : '%s'\n%s",typeid(Luna< btBroadphaseInterface >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_setDeferedcollide(lua_State *L) {
		...
		btDbvtBroadphase* self=Luna< btBroadphaseInterface >::checkSubType< btDbvtBroadphase >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void btDbvtBroadphase::m_deferedcollide(bool). Got : '%s'\n%s",typeid(Luna< btBroadphaseInterface >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_setNeedcleanup(lua_State *L) {
		...
		btDbvtBroadphase* self=Luna< btBroadphaseInterface >::checkSubType< btDbvtBroadphase >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void btDbvtBroadphase::m_needcleanup(bool). Got : '%s'\n%s",typeid(Luna< btBroadphaseInterface >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_createProxy(lua_State *L) {
		...
		btDbvtBroadphase* self=Luna< btBroadphaseInterface >::checkSubType< btDbvtBroadphase >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call btBroadphaseProxy * btDbvtBroadphase::base_createProxy(const btVector3 &, const btVector3 &, int, void *, short int, short int, btDispatcher *, void *). Got : '%s'\n%s",typeid(Luna< btBroadphaseInterface >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_destroyProxy(lua_State *L) {
		...
		btDbvtBroadphase* self=Luna< btBroadphaseInterface >::checkSubType< btDbvtBroadphase >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void btDbvtBroadphase::base_destroyProxy(btBroadphaseProxy *, btDispatcher *). Got : '%s'\n%s",typeid(Luna< btBroadphaseInterface >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_setAabb(lua_State *L) {
		...
		btDbvtBroadphase* self=Luna< btBroadphaseInterface >::checkSubType< btDbvtBroadphase >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void btDbvtBroadphase::base_setAabb(btBroadphaseProxy *, const btVector3 &, const btVector3 &, btDispatcher *). Got : '%s'\n%s",typeid(Luna< btBroadphaseInterface >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_rayTest(lua_State *L) {
		...
		btDbvtBroadphase* self=Luna< btBroadphaseInterface >::checkSubType< btDbvtBroadphase >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void btDbvtBroadphase::base_rayTest(const btVector3 &, const btVector3 &, btBroadphaseRayCallback &, const btVector3 &, const btVector3 &). Got : '%s'\n%s",typeid(Luna< btBroadphaseInterface >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_aabbTest(lua_State *L) {
		...
		btDbvtBroadphase* self=Luna< btBroadphaseInterface >::checkSubType< btDbvtBroadphase >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void btDbvtBroadphase::base_aabbTest(const btVector3 &, const btVector3 &, btBroadphaseAabbCallback &). Got : '%s'\n%s",typeid(Luna< btBroadphaseInterface >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_getAabb(lua_State *L) {
		...
		btDbvtBroadphase* self=Luna< btBroadphaseInterface >::checkSubType< btDbvtBroadphase >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void btDbvtBroadphase::base_getAabb(btBroadphaseProxy *, btVector3 &, btVector3 &) const. Got : '%s'\n%s",typeid(Luna< btBroadphaseInterface >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_calculateOverlappingPairs(lua_State *L) {
		...
		btDbvtBroadphase* self=Luna< btBroadphaseInterface >::checkSubType< btDbvtBroadphase >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void btDbvtBroadphase::base_calculateOverlappingPairs(btDispatcher *). Got : '%s'\n%s",typeid(Luna< btBroadphaseInterface >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_getOverlappingPairCache_overload_1(lua_State *L) {
		...
		btDbvtBroadphase* self=Luna< btBroadphaseInterface >::checkSubType< btDbvtBroadphase >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call btOverlappingPairCache * btDbvtBroadphase::base_getOverlappingPairCache(). Got : '%s'\n%s",typeid(Luna< btBroadphaseInterface >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_getOverlappingPairCache_overload_2(lua_State *L) {
		...
		btDbvtBroadphase* self=Luna< btBroadphaseInterface >::checkSubType< btDbvtBroadphase >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call const btOverlappingPairCache * btDbvtBroadphase::base_getOverlappingPairCache() const. Got : '%s'\n%s",typeid(Luna< btBroadphaseInterface >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_getBroadphaseAabb(lua_State *L) {
		...
		btDbvtBroadphase* self=Luna< btBroadphaseInterface >::checkSubType< btDbvtBroadphase >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void btDbvtBroadphase::base_getBroadphaseAabb(btVector3 &, btVector3 &) const. Got : '%s'\n%s",typeid(Luna< btBroadphaseInterface >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_printStats(lua_State *L) {
		...
		btDbvtBroadphase* self=Luna< btBroadphaseInterface >::checkSubType< btDbvtBroadphase >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void btDbvtBroadphase::base_printStats(). Got : '%s'\n%s",typeid(Luna< btBroadphaseInterface >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_resetPool(lua_State *L) {
		...
		btDbvtBroadphase* self=Luna< btBroadphaseInterface >::checkSubType< btDbvtBroadphase >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void btDbvtBroadphase::base_resetPool(btDispatcher *). Got : '%s'\n%s",typeid(Luna< btBroadphaseInterface >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
