...
public:
	...
	static int _bind_fromVoid(lua_State *L) {
		...
		Luna< btCollisionObjectWrapper >::push(L,self,false);
		return 1;
	}
...
luna_RegType LunaTraits< btCollisionObjectWrapper >::methods[] = {
	...
	{"fromVoid", &luna_wrapper_btCollisionObjectWrapper::_bind_fromVoid},
	{"asVoid", &luna_wrapper_btCollisionObjectWrapper::_bind_asVoid},
	{0,0}
};
