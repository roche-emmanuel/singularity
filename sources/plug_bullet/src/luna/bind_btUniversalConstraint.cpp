...
public:
	...
	static int _bind_getAnchor(lua_State *L) {
		...
		if(!self) {
			luaL_error(L, "Invalid object in function call const btVector3 & btUniversalConstraint::getAnchor(). Got : '%s'\n%s",typeid(Luna< btTypedObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_getAnchor2(lua_State *L) {
		...
		btUniversalConstraint* self=Luna< btTypedObject >::checkSubType< btUniversalConstraint >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call const btVector3 & btUniversalConstraint::getAnchor2(). Got : '%s'\n%s",typeid(Luna< btTypedObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_getAxis1(lua_State *L) {
		...
		btUniversalConstraint* self=Luna< btTypedObject >::checkSubType< btUniversalConstraint >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call const btVector3 & btUniversalConstraint::getAxis1(). Got : '%s'\n%s",typeid(Luna< btTypedObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_getAxis2(lua_State *L) {
		...
		btUniversalConstraint* self=Luna< btTypedObject >::checkSubType< btUniversalConstraint >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call const btVector3 & btUniversalConstraint::getAxis2(). Got : '%s'\n%s",typeid(Luna< btTypedObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_getAngle1(lua_State *L) {
		...
		btUniversalConstraint* self=Luna< btTypedObject >::checkSubType< btUniversalConstraint >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call float btUniversalConstraint::getAngle1(). Got : '%s'\n%s",typeid(Luna< btTypedObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_getAngle2(lua_State *L) {
		...
		btUniversalConstraint* self=Luna< btTypedObject >::checkSubType< btUniversalConstraint >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call float btUniversalConstraint::getAngle2(). Got : '%s'\n%s",typeid(Luna< btTypedObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_setUpperLimit(lua_State *L) {
		...
		btUniversalConstraint* self=Luna< btTypedObject >::checkSubType< btUniversalConstraint >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void btUniversalConstraint::setUpperLimit(float, float). Got : '%s'\n%s",typeid(Luna< btTypedObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_setLowerLimit(lua_State *L) {
		...
		btUniversalConstraint* self=Luna< btTypedObject >::checkSubType< btUniversalConstraint >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void btUniversalConstraint::setLowerLimit(float, float). Got : '%s'\n%s",typeid(Luna< btTypedObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_setAxis(lua_State *L) {
		...
		btUniversalConstraint* self=Luna< btTypedObject >::checkSubType< btUniversalConstraint >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void btUniversalConstraint::setAxis(const btVector3 &, const btVector3 &). Got : '%s'\n%s",typeid(Luna< btTypedObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_setupSolverConstraint(lua_State *L) {
		...
		btUniversalConstraint* self=Luna< btTypedObject >::checkSubType< btUniversalConstraint >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void btUniversalConstraint::base_setupSolverConstraint(btConstraintArray &, int, int, float). Got : '%s'\n%s",typeid(Luna< btTypedObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_solveConstraintObsolete(lua_State *L) {
		...
		btUniversalConstraint* self=Luna< btTypedObject >::checkSubType< btUniversalConstraint >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void btUniversalConstraint::base_solveConstraintObsolete(btSolverBody &, btSolverBody &, float). Got : '%s'\n%s",typeid(Luna< btTypedObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_buildJacobian(lua_State *L) {
		...
		btUniversalConstraint* self=Luna< btTypedObject >::checkSubType< btUniversalConstraint >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void btUniversalConstraint::base_buildJacobian(). Got : '%s'\n%s",typeid(Luna< btTypedObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_getInfo1(lua_State *L) {
		...
		btUniversalConstraint* self=Luna< btTypedObject >::checkSubType< btUniversalConstraint >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void btUniversalConstraint::base_getInfo1(btTypedConstraint::btConstraintInfo1 *). Got : '%s'\n%s",typeid(Luna< btTypedObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_getInfo2(lua_State *L) {
		...
		btUniversalConstraint* self=Luna< btTypedObject >::checkSubType< btUniversalConstraint >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void btUniversalConstraint::base_getInfo2(btTypedConstraint::btConstraintInfo2 *). Got : '%s'\n%s",typeid(Luna< btTypedObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_calcAnchorPos(lua_State *L) {
		...
		btUniversalConstraint* self=Luna< btTypedObject >::checkSubType< btUniversalConstraint >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void btUniversalConstraint::base_calcAnchorPos(). Got : '%s'\n%s",typeid(Luna< btTypedObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_setParam(lua_State *L) {
		...
		btUniversalConstraint* self=Luna< btTypedObject >::checkSubType< btUniversalConstraint >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void btUniversalConstraint::base_setParam(int, float, int). Got : '%s'\n%s",typeid(Luna< btTypedObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_getParam(lua_State *L) {
		...
		btUniversalConstraint* self=Luna< btTypedObject >::checkSubType< btUniversalConstraint >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call float btUniversalConstraint::base_getParam(int, int) const. Got : '%s'\n%s",typeid(Luna< btTypedObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_calculateSerializeBufferSize(lua_State *L) {
		...
		btUniversalConstraint* self=Luna< btTypedObject >::checkSubType< btUniversalConstraint >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call int btUniversalConstraint::base_calculateSerializeBufferSize() const. Got : '%s'\n%s",typeid(Luna< btTypedObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
