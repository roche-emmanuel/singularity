...
public:
	...
	static int _bind_fromVoid(lua_State *L) {
		...
		Luna< btGenericMemoryPool >::push(L,self,false);
		return 1;
	}
...
luna_RegType LunaTraits< btGenericMemoryPool >::methods[] = {
	...
	{"fromVoid", &luna_wrapper_btGenericMemoryPool::_bind_fromVoid},
	{"asVoid", &luna_wrapper_btGenericMemoryPool::_bind_asVoid},
	{0,0}
};
