...
public:
	...
	static int _bind_getHalfExtentsWithMargin(lua_State *L) {
		...
		if(!self) {
			luaL_error(L, "Invalid object in function call btVector3 btBoxShape::getHalfExtentsWithMargin() const. Got : '%s'\n%s",typeid(Luna< btCollisionShape >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_getHalfExtentsWithoutMargin(lua_State *L) {
		...
		btBoxShape* self=Luna< btCollisionShape >::checkSubType< btBoxShape >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call const btVector3 & btBoxShape::getHalfExtentsWithoutMargin() const. Got : '%s'\n%s",typeid(Luna< btCollisionShape >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_localGetSupportingVertex(lua_State *L) {
		...
		btBoxShape* self=Luna< btCollisionShape >::checkSubType< btBoxShape >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call btVector3 btBoxShape::localGetSupportingVertex(const btVector3 &) const. Got : '%s'\n%s",typeid(Luna< btCollisionShape >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_localGetSupportingVertexWithoutMargin(lua_State *L) {
		...
		btBoxShape* self=Luna< btCollisionShape >::checkSubType< btBoxShape >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call btVector3 btBoxShape::localGetSupportingVertexWithoutMargin(const btVector3 &) const. Got : '%s'\n%s",typeid(Luna< btCollisionShape >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_batchedUnitVectorGetSupportingVertexWithoutMargin(lua_State *L) {
		...
		btBoxShape* self=Luna< btCollisionShape >::checkSubType< btBoxShape >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void btBoxShape::batchedUnitVectorGetSupportingVertexWithoutMargin(const btVector3 *, btVector3 *, int) const. Got : '%s'\n%s",typeid(Luna< btCollisionShape >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_setMargin(lua_State *L) {
		...
		btBoxShape* self=Luna< btCollisionShape >::checkSubType< btBoxShape >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void btBoxShape::setMargin(float). Got : '%s'\n%s",typeid(Luna< btCollisionShape >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_setLocalScaling(lua_State *L) {
		...
		btBoxShape* self=Luna< btCollisionShape >::checkSubType< btBoxShape >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void btBoxShape::setLocalScaling(const btVector3 &). Got : '%s'\n%s",typeid(Luna< btCollisionShape >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_getAabb(lua_State *L) {
		...
		btBoxShape* self=Luna< btCollisionShape >::checkSubType< btBoxShape >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void btBoxShape::getAabb(const btTransform &, btVector3 &, btVector3 &) const. Got : '%s'\n%s",typeid(Luna< btCollisionShape >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_calculateLocalInertia(lua_State *L) {
		...
		btBoxShape* self=Luna< btCollisionShape >::checkSubType< btBoxShape >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void btBoxShape::calculateLocalInertia(float, btVector3 &) const. Got : '%s'\n%s",typeid(Luna< btCollisionShape >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_getPlane(lua_State *L) {
		...
		btBoxShape* self=Luna< btCollisionShape >::checkSubType< btBoxShape >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void btBoxShape::getPlane(btVector3 &, btVector3 &, int) const. Got : '%s'\n%s",typeid(Luna< btCollisionShape >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_getNumPlanes(lua_State *L) {
		...
		btBoxShape* self=Luna< btCollisionShape >::checkSubType< btBoxShape >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call int btBoxShape::getNumPlanes() const. Got : '%s'\n%s",typeid(Luna< btCollisionShape >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_getNumVertices(lua_State *L) {
		...
		btBoxShape* self=Luna< btCollisionShape >::checkSubType< btBoxShape >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call int btBoxShape::getNumVertices() const. Got : '%s'\n%s",typeid(Luna< btCollisionShape >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_getNumEdges(lua_State *L) {
		...
		btBoxShape* self=Luna< btCollisionShape >::checkSubType< btBoxShape >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call int btBoxShape::getNumEdges() const. Got : '%s'\n%s",typeid(Luna< btCollisionShape >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_getVertex(lua_State *L) {
		...
		btBoxShape* self=Luna< btCollisionShape >::checkSubType< btBoxShape >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void btBoxShape::getVertex(int, btVector3 &) const. Got : '%s'\n%s",typeid(Luna< btCollisionShape >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_getPlaneEquation(lua_State *L) {
		...
		btBoxShape* self=Luna< btCollisionShape >::checkSubType< btBoxShape >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void btBoxShape::getPlaneEquation(btVector4 &, int) const. Got : '%s'\n%s",typeid(Luna< btCollisionShape >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_getEdge(lua_State *L) {
		...
		btBoxShape* self=Luna< btCollisionShape >::checkSubType< btBoxShape >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void btBoxShape::getEdge(int, btVector3 &, btVector3 &) const. Got : '%s'\n%s",typeid(Luna< btCollisionShape >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_isInside(lua_State *L) {
		...
		btBoxShape* self=Luna< btCollisionShape >::checkSubType< btBoxShape >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call bool btBoxShape::isInside(const btVector3 &, float) const. Got : '%s'\n%s",typeid(Luna< btCollisionShape >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_getName(lua_State *L) {
		...
		btBoxShape* self=Luna< btCollisionShape >::checkSubType< btBoxShape >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call const char * btBoxShape::getName() const. Got : '%s'\n%s",typeid(Luna< btCollisionShape >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_getNumPreferredPenetrationDirections(lua_State *L) {
		...
		btBoxShape* self=Luna< btCollisionShape >::checkSubType< btBoxShape >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call int btBoxShape::getNumPreferredPenetrationDirections() const. Got : '%s'\n%s",typeid(Luna< btCollisionShape >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_getPreferredPenetrationDirection(lua_State *L) {
		...
		btBoxShape* self=Luna< btCollisionShape >::checkSubType< btBoxShape >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void btBoxShape::getPreferredPenetrationDirection(int, btVector3 &) const. Got : '%s'\n%s",typeid(Luna< btCollisionShape >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_getBoundingSphere(lua_State *L) {
		...
		btBoxShape* self=Luna< btCollisionShape >::checkSubType< btBoxShape >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void btBoxShape::base_getBoundingSphere(btVector3 &, float &) const. Got : '%s'\n%s",typeid(Luna< btCollisionShape >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_getAngularMotionDisc(lua_State *L) {
		...
		btBoxShape* self=Luna< btCollisionShape >::checkSubType< btBoxShape >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call float btBoxShape::base_getAngularMotionDisc() const. Got : '%s'\n%s",typeid(Luna< btCollisionShape >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_getContactBreakingThreshold(lua_State *L) {
		...
		btBoxShape* self=Luna< btCollisionShape >::checkSubType< btBoxShape >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call float btBoxShape::base_getContactBreakingThreshold(float) const. Got : '%s'\n%s",typeid(Luna< btCollisionShape >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_getAnisotropicRollingFrictionDirection(lua_State *L) {
		...
		btBoxShape* self=Luna< btCollisionShape >::checkSubType< btBoxShape >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call btVector3 btBoxShape::base_getAnisotropicRollingFrictionDirection() const. Got : '%s'\n%s",typeid(Luna< btCollisionShape >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_project(lua_State *L) {
		...
		btBoxShape* self=Luna< btCollisionShape >::checkSubType< btBoxShape >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void btBoxShape::base_project(const btTransform &, const btVector3 &, float &, float &) const. Got : '%s'\n%s",typeid(Luna< btCollisionShape >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_getAabbSlow(lua_State *L) {
		...
		btBoxShape* self=Luna< btCollisionShape >::checkSubType< btBoxShape >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void btBoxShape::base_getAabbSlow(const btTransform &, btVector3 &, btVector3 &) const. Got : '%s'\n%s",typeid(Luna< btCollisionShape >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_getLocalScaling(lua_State *L) {
		...
		btBoxShape* self=Luna< btCollisionShape >::checkSubType< btBoxShape >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call const btVector3 & btBoxShape::base_getLocalScaling() const. Got : '%s'\n%s",typeid(Luna< btCollisionShape >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_getMargin(lua_State *L) {
		...
		btBoxShape* self=Luna< btCollisionShape >::checkSubType< btBoxShape >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call float btBoxShape::base_getMargin() const. Got : '%s'\n%s",typeid(Luna< btCollisionShape >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_calculateSerializeBufferSize(lua_State *L) {
		...
		btBoxShape* self=Luna< btCollisionShape >::checkSubType< btBoxShape >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call int btBoxShape::base_calculateSerializeBufferSize() const. Got : '%s'\n%s",typeid(Luna< btCollisionShape >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_initializePolyhedralFeatures(lua_State *L) {
		...
		btBoxShape* self=Luna< btCollisionShape >::checkSubType< btBoxShape >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call bool btBoxShape::base_initializePolyhedralFeatures(int). Got : '%s'\n%s",typeid(Luna< btCollisionShape >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_localGetSupportingVertex(lua_State *L) {
		...
		btBoxShape* self=Luna< btCollisionShape >::checkSubType< btBoxShape >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call btVector3 btBoxShape::base_localGetSupportingVertex(const btVector3 &) const. Got : '%s'\n%s",typeid(Luna< btCollisionShape >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_localGetSupportingVertexWithoutMargin(lua_State *L) {
		...
		btBoxShape* self=Luna< btCollisionShape >::checkSubType< btBoxShape >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call btVector3 btBoxShape::base_localGetSupportingVertexWithoutMargin(const btVector3 &) const. Got : '%s'\n%s",typeid(Luna< btCollisionShape >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_batchedUnitVectorGetSupportingVertexWithoutMargin(lua_State *L) {
		...
		btBoxShape* self=Luna< btCollisionShape >::checkSubType< btBoxShape >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void btBoxShape::base_batchedUnitVectorGetSupportingVertexWithoutMargin(const btVector3 *, btVector3 *, int) const. Got : '%s'\n%s",typeid(Luna< btCollisionShape >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_setMargin(lua_State *L) {
		...
		btBoxShape* self=Luna< btCollisionShape >::checkSubType< btBoxShape >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void btBoxShape::base_setMargin(float). Got : '%s'\n%s",typeid(Luna< btCollisionShape >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_setLocalScaling(lua_State *L) {
		...
		btBoxShape* self=Luna< btCollisionShape >::checkSubType< btBoxShape >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void btBoxShape::base_setLocalScaling(const btVector3 &). Got : '%s'\n%s",typeid(Luna< btCollisionShape >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_getAabb(lua_State *L) {
		...
		btBoxShape* self=Luna< btCollisionShape >::checkSubType< btBoxShape >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void btBoxShape::base_getAabb(const btTransform &, btVector3 &, btVector3 &) const. Got : '%s'\n%s",typeid(Luna< btCollisionShape >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_calculateLocalInertia(lua_State *L) {
		...
		btBoxShape* self=Luna< btCollisionShape >::checkSubType< btBoxShape >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void btBoxShape::base_calculateLocalInertia(float, btVector3 &) const. Got : '%s'\n%s",typeid(Luna< btCollisionShape >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_getPlane(lua_State *L) {
		...
		btBoxShape* self=Luna< btCollisionShape >::checkSubType< btBoxShape >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void btBoxShape::base_getPlane(btVector3 &, btVector3 &, int) const. Got : '%s'\n%s",typeid(Luna< btCollisionShape >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_getNumPlanes(lua_State *L) {
		...
		btBoxShape* self=Luna< btCollisionShape >::checkSubType< btBoxShape >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call int btBoxShape::base_getNumPlanes() const. Got : '%s'\n%s",typeid(Luna< btCollisionShape >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_getNumVertices(lua_State *L) {
		...
		btBoxShape* self=Luna< btCollisionShape >::checkSubType< btBoxShape >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call int btBoxShape::base_getNumVertices() const. Got : '%s'\n%s",typeid(Luna< btCollisionShape >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_getNumEdges(lua_State *L) {
		...
		btBoxShape* self=Luna< btCollisionShape >::checkSubType< btBoxShape >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call int btBoxShape::base_getNumEdges() const. Got : '%s'\n%s",typeid(Luna< btCollisionShape >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_getVertex(lua_State *L) {
		...
		btBoxShape* self=Luna< btCollisionShape >::checkSubType< btBoxShape >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void btBoxShape::base_getVertex(int, btVector3 &) const. Got : '%s'\n%s",typeid(Luna< btCollisionShape >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_getPlaneEquation(lua_State *L) {
		...
		btBoxShape* self=Luna< btCollisionShape >::checkSubType< btBoxShape >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void btBoxShape::base_getPlaneEquation(btVector4 &, int) const. Got : '%s'\n%s",typeid(Luna< btCollisionShape >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_getEdge(lua_State *L) {
		...
		btBoxShape* self=Luna< btCollisionShape >::checkSubType< btBoxShape >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void btBoxShape::base_getEdge(int, btVector3 &, btVector3 &) const. Got : '%s'\n%s",typeid(Luna< btCollisionShape >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_isInside(lua_State *L) {
		...
		btBoxShape* self=Luna< btCollisionShape >::checkSubType< btBoxShape >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call bool btBoxShape::base_isInside(const btVector3 &, float) const. Got : '%s'\n%s",typeid(Luna< btCollisionShape >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_getName(lua_State *L) {
		...
		btBoxShape* self=Luna< btCollisionShape >::checkSubType< btBoxShape >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call const char * btBoxShape::base_getName() const. Got : '%s'\n%s",typeid(Luna< btCollisionShape >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_getNumPreferredPenetrationDirections(lua_State *L) {
		...
		btBoxShape* self=Luna< btCollisionShape >::checkSubType< btBoxShape >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call int btBoxShape::base_getNumPreferredPenetrationDirections() const. Got : '%s'\n%s",typeid(Luna< btCollisionShape >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_getPreferredPenetrationDirection(lua_State *L) {
		...
		btBoxShape* self=Luna< btCollisionShape >::checkSubType< btBoxShape >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void btBoxShape::base_getPreferredPenetrationDirection(int, btVector3 &) const. Got : '%s'\n%s",typeid(Luna< btCollisionShape >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
