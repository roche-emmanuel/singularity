...
public:
	...
	static int _bind___eq(lua_State *L) {
		if (!_lg_typecheck___eq(L)) {
			luaL_error(L, "luna typecheck failed in __eq function, expected prototype:\n__eq(btTriangleInfo*). Got arguments:\n%s",luna_dumpStack(L).c_str());
		}
	...
	static int _bind_getFlags(lua_State *L) {
		...
		btTriangleInfo* self=(Luna< btTriangleInfo >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call int btTriangleInfo::m_flags(). Got : '%s'\n%s",typeid(Luna< btTriangleInfo >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_getEdgeV0V1Angle(lua_State *L) {
		...
		btTriangleInfo* self=(Luna< btTriangleInfo >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call float btTriangleInfo::m_edgeV0V1Angle(). Got : '%s'\n%s",typeid(Luna< btTriangleInfo >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_getEdgeV1V2Angle(lua_State *L) {
		...
		btTriangleInfo* self=(Luna< btTriangleInfo >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call float btTriangleInfo::m_edgeV1V2Angle(). Got : '%s'\n%s",typeid(Luna< btTriangleInfo >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_getEdgeV2V0Angle(lua_State *L) {
		...
		btTriangleInfo* self=(Luna< btTriangleInfo >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call float btTriangleInfo::m_edgeV2V0Angle(). Got : '%s'\n%s",typeid(Luna< btTriangleInfo >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_setFlags(lua_State *L) {
		...
		btTriangleInfo* self=(Luna< btTriangleInfo >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call void btTriangleInfo::m_flags(int). Got : '%s'\n%s",typeid(Luna< btTriangleInfo >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
		self->m_flags = value;
	...
	static int _bind_setEdgeV0V1Angle(lua_State *L) {
		...
		btTriangleInfo* self=(Luna< btTriangleInfo >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call void btTriangleInfo::m_edgeV0V1Angle(float). Got : '%s'\n%s",typeid(Luna< btTriangleInfo >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_setEdgeV1V2Angle(lua_State *L) {
		...
		btTriangleInfo* self=(Luna< btTriangleInfo >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call void btTriangleInfo::m_edgeV1V2Angle(float). Got : '%s'\n%s",typeid(Luna< btTriangleInfo >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_setEdgeV2V0Angle(lua_State *L) {
		...
		btTriangleInfo* self=(Luna< btTriangleInfo >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call void btTriangleInfo::m_edgeV2V0Angle(float). Got : '%s'\n%s",typeid(Luna< btTriangleInfo >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
