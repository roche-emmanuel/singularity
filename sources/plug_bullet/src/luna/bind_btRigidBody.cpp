...
public:
	...
	static int _bind_proceedToTransform(lua_State *L) {
		...
		if(!self) {
			luaL_error(L, "Invalid object in function call void btRigidBody::proceedToTransform(const btTransform &). Got : '%s'\n%s",typeid(Luna< btCollisionObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_predictIntegratedTransform(lua_State *L) {
		...
		btRigidBody* self=Luna< btCollisionObject >::checkSubType< btRigidBody >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void btRigidBody::predictIntegratedTransform(float, btTransform &). Got : '%s'\n%s",typeid(Luna< btCollisionObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_saveKinematicState(lua_State *L) {
		...
		btRigidBody* self=Luna< btCollisionObject >::checkSubType< btRigidBody >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void btRigidBody::saveKinematicState(float). Got : '%s'\n%s",typeid(Luna< btCollisionObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_applyGravity(lua_State *L) {
		...
		btRigidBody* self=Luna< btCollisionObject >::checkSubType< btRigidBody >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void btRigidBody::applyGravity(). Got : '%s'\n%s",typeid(Luna< btCollisionObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
		self->applyGravity();
	...
	static int _bind_setGravity(lua_State *L) {
		...
		btRigidBody* self=Luna< btCollisionObject >::checkSubType< btRigidBody >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void btRigidBody::setGravity(const btVector3 &). Got : '%s'\n%s",typeid(Luna< btCollisionObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_getGravity(lua_State *L) {
		...
		btRigidBody* self=Luna< btCollisionObject >::checkSubType< btRigidBody >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call const btVector3 & btRigidBody::getGravity() const. Got : '%s'\n%s",typeid(Luna< btCollisionObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_setDamping(lua_State *L) {
		...
		btRigidBody* self=Luna< btCollisionObject >::checkSubType< btRigidBody >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void btRigidBody::setDamping(float, float). Got : '%s'\n%s",typeid(Luna< btCollisionObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_getLinearDamping(lua_State *L) {
		...
		btRigidBody* self=Luna< btCollisionObject >::checkSubType< btRigidBody >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call float btRigidBody::getLinearDamping() const. Got : '%s'\n%s",typeid(Luna< btCollisionObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_getAngularDamping(lua_State *L) {
		...
		btRigidBody* self=Luna< btCollisionObject >::checkSubType< btRigidBody >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call float btRigidBody::getAngularDamping() const. Got : '%s'\n%s",typeid(Luna< btCollisionObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_getLinearSleepingThreshold(lua_State *L) {
		...
		btRigidBody* self=Luna< btCollisionObject >::checkSubType< btRigidBody >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call float btRigidBody::getLinearSleepingThreshold() const. Got : '%s'\n%s",typeid(Luna< btCollisionObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_getAngularSleepingThreshold(lua_State *L) {
		...
		btRigidBody* self=Luna< btCollisionObject >::checkSubType< btRigidBody >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call float btRigidBody::getAngularSleepingThreshold() const. Got : '%s'\n%s",typeid(Luna< btCollisionObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_applyDamping(lua_State *L) {
		...
		btRigidBody* self=Luna< btCollisionObject >::checkSubType< btRigidBody >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void btRigidBody::applyDamping(float). Got : '%s'\n%s",typeid(Luna< btCollisionObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_getCollisionShape_overload_1(lua_State *L) {
		...
		btRigidBody* self=Luna< btCollisionObject >::checkSubType< btRigidBody >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call const btCollisionShape * btRigidBody::getCollisionShape() const. Got : '%s'\n%s",typeid(Luna< btCollisionObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_getCollisionShape_overload_2(lua_State *L) {
		...
		btRigidBody* self=Luna< btCollisionObject >::checkSubType< btRigidBody >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call btCollisionShape * btRigidBody::getCollisionShape(). Got : '%s'\n%s",typeid(Luna< btCollisionObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_setMassProps(lua_State *L) {
		...
		btRigidBody* self=Luna< btCollisionObject >::checkSubType< btRigidBody >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void btRigidBody::setMassProps(float, const btVector3 &). Got : '%s'\n%s",typeid(Luna< btCollisionObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_getLinearFactor(lua_State *L) {
		...
		btRigidBody* self=Luna< btCollisionObject >::checkSubType< btRigidBody >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call const btVector3 & btRigidBody::getLinearFactor() const. Got : '%s'\n%s",typeid(Luna< btCollisionObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_setLinearFactor(lua_State *L) {
		...
		btRigidBody* self=Luna< btCollisionObject >::checkSubType< btRigidBody >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void btRigidBody::setLinearFactor(const btVector3 &). Got : '%s'\n%s",typeid(Luna< btCollisionObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_getInvMass(lua_State *L) {
		...
		btRigidBody* self=Luna< btCollisionObject >::checkSubType< btRigidBody >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call float btRigidBody::getInvMass() const. Got : '%s'\n%s",typeid(Luna< btCollisionObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_getInvInertiaTensorWorld(lua_State *L) {
		...
		btRigidBody* self=Luna< btCollisionObject >::checkSubType< btRigidBody >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call const btMatrix3x3 & btRigidBody::getInvInertiaTensorWorld() const. Got : '%s'\n%s",typeid(Luna< btCollisionObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_integrateVelocities(lua_State *L) {
		...
		btRigidBody* self=Luna< btCollisionObject >::checkSubType< btRigidBody >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void btRigidBody::integrateVelocities(float). Got : '%s'\n%s",typeid(Luna< btCollisionObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_setCenterOfMassTransform(lua_State *L) {
		...
		btRigidBody* self=Luna< btCollisionObject >::checkSubType< btRigidBody >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void btRigidBody::setCenterOfMassTransform(const btTransform &). Got : '%s'\n%s",typeid(Luna< btCollisionObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_applyCentralForce(lua_State *L) {
		...
		btRigidBody* self=Luna< btCollisionObject >::checkSubType< btRigidBody >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void btRigidBody::applyCentralForce(const btVector3 &). Got : '%s'\n%s",typeid(Luna< btCollisionObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_getTotalForce(lua_State *L) {
		...
		btRigidBody* self=Luna< btCollisionObject >::checkSubType< btRigidBody >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call const btVector3 & btRigidBody::getTotalForce() const. Got : '%s'\n%s",typeid(Luna< btCollisionObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_getTotalTorque(lua_State *L) {
		...
		btRigidBody* self=Luna< btCollisionObject >::checkSubType< btRigidBody >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call const btVector3 & btRigidBody::getTotalTorque() const. Got : '%s'\n%s",typeid(Luna< btCollisionObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_getInvInertiaDiagLocal(lua_State *L) {
		...
		btRigidBody* self=Luna< btCollisionObject >::checkSubType< btRigidBody >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call const btVector3 & btRigidBody::getInvInertiaDiagLocal() const. Got : '%s'\n%s",typeid(Luna< btCollisionObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_setInvInertiaDiagLocal(lua_State *L) {
		...
		btRigidBody* self=Luna< btCollisionObject >::checkSubType< btRigidBody >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void btRigidBody::setInvInertiaDiagLocal(const btVector3 &). Got : '%s'\n%s",typeid(Luna< btCollisionObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_setSleepingThresholds(lua_State *L) {
		...
		btRigidBody* self=Luna< btCollisionObject >::checkSubType< btRigidBody >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void btRigidBody::setSleepingThresholds(float, float). Got : '%s'\n%s",typeid(Luna< btCollisionObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_applyTorque(lua_State *L) {
		...
		btRigidBody* self=Luna< btCollisionObject >::checkSubType< btRigidBody >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void btRigidBody::applyTorque(const btVector3 &). Got : '%s'\n%s",typeid(Luna< btCollisionObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_applyForce(lua_State *L) {
		...
		btRigidBody* self=Luna< btCollisionObject >::checkSubType< btRigidBody >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void btRigidBody::applyForce(const btVector3 &, const btVector3 &). Got : '%s'\n%s",typeid(Luna< btCollisionObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_applyCentralImpulse(lua_State *L) {
		...
		btRigidBody* self=Luna< btCollisionObject >::checkSubType< btRigidBody >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void btRigidBody::applyCentralImpulse(const btVector3 &). Got : '%s'\n%s",typeid(Luna< btCollisionObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_applyTorqueImpulse(lua_State *L) {
		...
		btRigidBody* self=Luna< btCollisionObject >::checkSubType< btRigidBody >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void btRigidBody::applyTorqueImpulse(const btVector3 &). Got : '%s'\n%s",typeid(Luna< btCollisionObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_applyImpulse(lua_State *L) {
		...
		btRigidBody* self=Luna< btCollisionObject >::checkSubType< btRigidBody >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void btRigidBody::applyImpulse(const btVector3 &, const btVector3 &). Got : '%s'\n%s",typeid(Luna< btCollisionObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_clearForces(lua_State *L) {
		...
		btRigidBody* self=Luna< btCollisionObject >::checkSubType< btRigidBody >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void btRigidBody::clearForces(). Got : '%s'\n%s",typeid(Luna< btCollisionObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
		self->clearForces();
	...
	static int _bind_updateInertiaTensor(lua_State *L) {
		...
		btRigidBody* self=Luna< btCollisionObject >::checkSubType< btRigidBody >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void btRigidBody::updateInertiaTensor(). Got : '%s'\n%s",typeid(Luna< btCollisionObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_getCenterOfMassPosition(lua_State *L) {
		...
		btRigidBody* self=Luna< btCollisionObject >::checkSubType< btRigidBody >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call const btVector3 & btRigidBody::getCenterOfMassPosition() const. Got : '%s'\n%s",typeid(Luna< btCollisionObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_getOrientation(lua_State *L) {
		...
		btRigidBody* self=Luna< btCollisionObject >::checkSubType< btRigidBody >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call btQuaternion btRigidBody::getOrientation() const. Got : '%s'\n%s",typeid(Luna< btCollisionObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_getCenterOfMassTransform(lua_State *L) {
		...
		btRigidBody* self=Luna< btCollisionObject >::checkSubType< btRigidBody >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call const btTransform & btRigidBody::getCenterOfMassTransform() const. Got : '%s'\n%s",typeid(Luna< btCollisionObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_getLinearVelocity(lua_State *L) {
		...
		btRigidBody* self=Luna< btCollisionObject >::checkSubType< btRigidBody >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call const btVector3 & btRigidBody::getLinearVelocity() const. Got : '%s'\n%s",typeid(Luna< btCollisionObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_getAngularVelocity(lua_State *L) {
		...
		btRigidBody* self=Luna< btCollisionObject >::checkSubType< btRigidBody >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call const btVector3 & btRigidBody::getAngularVelocity() const. Got : '%s'\n%s",typeid(Luna< btCollisionObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_setLinearVelocity(lua_State *L) {
		...
		btRigidBody* self=Luna< btCollisionObject >::checkSubType< btRigidBody >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void btRigidBody::setLinearVelocity(const btVector3 &). Got : '%s'\n%s",typeid(Luna< btCollisionObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_setAngularVelocity(lua_State *L) {
		...
		btRigidBody* self=Luna< btCollisionObject >::checkSubType< btRigidBody >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void btRigidBody::setAngularVelocity(const btVector3 &). Got : '%s'\n%s",typeid(Luna< btCollisionObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_getVelocityInLocalPoint(lua_State *L) {
		...
		btRigidBody* self=Luna< btCollisionObject >::checkSubType< btRigidBody >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call btVector3 btRigidBody::getVelocityInLocalPoint(const btVector3 &) const. Got : '%s'\n%s",typeid(Luna< btCollisionObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_translate(lua_State *L) {
		...
		btRigidBody* self=Luna< btCollisionObject >::checkSubType< btRigidBody >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void btRigidBody::translate(const btVector3 &). Got : '%s'\n%s",typeid(Luna< btCollisionObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
		self->translate(v);
	...
	static int _bind_getAabb(lua_State *L) {
		...
		btRigidBody* self=Luna< btCollisionObject >::checkSubType< btRigidBody >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void btRigidBody::getAabb(btVector3 &, btVector3 &) const. Got : '%s'\n%s",typeid(Luna< btCollisionObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_computeImpulseDenominator(lua_State *L) {
		...
		btRigidBody* self=Luna< btCollisionObject >::checkSubType< btRigidBody >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call float btRigidBody::computeImpulseDenominator(const btVector3 &, const btVector3 &) const. Got : '%s'\n%s",typeid(Luna< btCollisionObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_computeAngularImpulseDenominator(lua_State *L) {
		...
		btRigidBody* self=Luna< btCollisionObject >::checkSubType< btRigidBody >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call float btRigidBody::computeAngularImpulseDenominator(const btVector3 &) const. Got : '%s'\n%s",typeid(Luna< btCollisionObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_updateDeactivation(lua_State *L) {
		...
		btRigidBody* self=Luna< btCollisionObject >::checkSubType< btRigidBody >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void btRigidBody::updateDeactivation(float). Got : '%s'\n%s",typeid(Luna< btCollisionObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_wantsSleeping(lua_State *L) {
		...
		btRigidBody* self=Luna< btCollisionObject >::checkSubType< btRigidBody >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call bool btRigidBody::wantsSleeping(). Got : '%s'\n%s",typeid(Luna< btCollisionObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_getBroadphaseProxy_overload_1(lua_State *L) {
		...
		btRigidBody* self=Luna< btCollisionObject >::checkSubType< btRigidBody >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call const btBroadphaseProxy * btRigidBody::getBroadphaseProxy() const. Got : '%s'\n%s",typeid(Luna< btCollisionObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_getBroadphaseProxy_overload_2(lua_State *L) {
		...
		btRigidBody* self=Luna< btCollisionObject >::checkSubType< btRigidBody >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call btBroadphaseProxy * btRigidBody::getBroadphaseProxy(). Got : '%s'\n%s",typeid(Luna< btCollisionObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_setNewBroadphaseProxy(lua_State *L) {
		...
		btRigidBody* self=Luna< btCollisionObject >::checkSubType< btRigidBody >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void btRigidBody::setNewBroadphaseProxy(btBroadphaseProxy *). Got : '%s'\n%s",typeid(Luna< btCollisionObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_getMotionState_overload_1(lua_State *L) {
		...
		btRigidBody* self=Luna< btCollisionObject >::checkSubType< btRigidBody >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call btMotionState * btRigidBody::getMotionState(). Got : '%s'\n%s",typeid(Luna< btCollisionObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_getMotionState_overload_2(lua_State *L) {
		...
		btRigidBody* self=Luna< btCollisionObject >::checkSubType< btRigidBody >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call const btMotionState * btRigidBody::getMotionState() const. Got : '%s'\n%s",typeid(Luna< btCollisionObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_setMotionState(lua_State *L) {
		...
		btRigidBody* self=Luna< btCollisionObject >::checkSubType< btRigidBody >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void btRigidBody::setMotionState(btMotionState *). Got : '%s'\n%s",typeid(Luna< btCollisionObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_setAngularFactor_overload_1(lua_State *L) {
		...
		btRigidBody* self=Luna< btCollisionObject >::checkSubType< btRigidBody >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void btRigidBody::setAngularFactor(const btVector3 &). Got : '%s'\n%s",typeid(Luna< btCollisionObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_setAngularFactor_overload_2(lua_State *L) {
		...
		btRigidBody* self=Luna< btCollisionObject >::checkSubType< btRigidBody >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void btRigidBody::setAngularFactor(float). Got : '%s'\n%s",typeid(Luna< btCollisionObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
		self->setAngularFactor(angFac);
	...
	static int _bind_getAngularFactor(lua_State *L) {
		...
		btRigidBody* self=Luna< btCollisionObject >::checkSubType< btRigidBody >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call const btVector3 & btRigidBody::getAngularFactor() const. Got : '%s'\n%s",typeid(Luna< btCollisionObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_isInWorld(lua_State *L) {
		...
		btRigidBody* self=Luna< btCollisionObject >::checkSubType< btRigidBody >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call bool btRigidBody::isInWorld() const. Got : '%s'\n%s",typeid(Luna< btCollisionObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_checkCollideWithOverride(lua_State *L) {
		...
		btRigidBody* self=Luna< btCollisionObject >::checkSubType< btRigidBody >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call bool btRigidBody::checkCollideWithOverride(const btCollisionObject *) const. Got : '%s'\n%s",typeid(Luna< btCollisionObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_addConstraintRef(lua_State *L) {
		...
		btRigidBody* self=Luna< btCollisionObject >::checkSubType< btRigidBody >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void btRigidBody::addConstraintRef(btTypedConstraint *). Got : '%s'\n%s",typeid(Luna< btCollisionObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_removeConstraintRef(lua_State *L) {
		...
		btRigidBody* self=Luna< btCollisionObject >::checkSubType< btRigidBody >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void btRigidBody::removeConstraintRef(btTypedConstraint *). Got : '%s'\n%s",typeid(Luna< btCollisionObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_getConstraintRef(lua_State *L) {
		...
		btRigidBody* self=Luna< btCollisionObject >::checkSubType< btRigidBody >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call btTypedConstraint * btRigidBody::getConstraintRef(int). Got : '%s'\n%s",typeid(Luna< btCollisionObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_getNumConstraintRefs(lua_State *L) {
		...
		btRigidBody* self=Luna< btCollisionObject >::checkSubType< btRigidBody >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call int btRigidBody::getNumConstraintRefs() const. Got : '%s'\n%s",typeid(Luna< btCollisionObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_setFlags(lua_State *L) {
		...
		btRigidBody* self=Luna< btCollisionObject >::checkSubType< btRigidBody >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void btRigidBody::setFlags(int). Got : '%s'\n%s",typeid(Luna< btCollisionObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
		self->setFlags(flags);
	...
	static int _bind_getFlags(lua_State *L) {
		...
		btRigidBody* self=Luna< btCollisionObject >::checkSubType< btRigidBody >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call int btRigidBody::getFlags() const. Got : '%s'\n%s",typeid(Luna< btCollisionObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_computeGyroscopicForce(lua_State *L) {
		...
		btRigidBody* self=Luna< btCollisionObject >::checkSubType< btRigidBody >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call btVector3 btRigidBody::computeGyroscopicForce(float) const. Got : '%s'\n%s",typeid(Luna< btCollisionObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_calculateSerializeBufferSize(lua_State *L) {
		...
		btRigidBody* self=Luna< btCollisionObject >::checkSubType< btRigidBody >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call int btRigidBody::calculateSerializeBufferSize() const. Got : '%s'\n%s",typeid(Luna< btCollisionObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_getContactSolverType(lua_State *L) {
		...
		btRigidBody* self=Luna< btCollisionObject >::checkSubType< btRigidBody >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call int btRigidBody::m_contactSolverType(). Got : '%s'\n%s",typeid(Luna< btCollisionObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_getFrictionSolverType(lua_State *L) {
		...
		btRigidBody* self=Luna< btCollisionObject >::checkSubType< btRigidBody >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call int btRigidBody::m_frictionSolverType(). Got : '%s'\n%s",typeid(Luna< btCollisionObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_setContactSolverType(lua_State *L) {
		...
		btRigidBody* self=Luna< btCollisionObject >::checkSubType< btRigidBody >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void btRigidBody::m_contactSolverType(int). Got : '%s'\n%s",typeid(Luna< btCollisionObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_setFrictionSolverType(lua_State *L) {
		...
		btRigidBody* self=Luna< btCollisionObject >::checkSubType< btRigidBody >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void btRigidBody::m_frictionSolverType(int). Got : '%s'\n%s",typeid(Luna< btCollisionObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_setCollisionShape(lua_State *L) {
		...
		btRigidBody* self=Luna< btCollisionObject >::checkSubType< btRigidBody >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void btRigidBody::base_setCollisionShape(btCollisionShape *). Got : '%s'\n%s",typeid(Luna< btCollisionObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_checkCollideWithOverride(lua_State *L) {
		...
		btRigidBody* self=Luna< btCollisionObject >::checkSubType< btRigidBody >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call bool btRigidBody::base_checkCollideWithOverride(const btCollisionObject *) const. Got : '%s'\n%s",typeid(Luna< btCollisionObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_calculateSerializeBufferSize(lua_State *L) {
		...
		btRigidBody* self=Luna< btCollisionObject >::checkSubType< btRigidBody >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call int btRigidBody::base_calculateSerializeBufferSize() const. Got : '%s'\n%s",typeid(Luna< btCollisionObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
