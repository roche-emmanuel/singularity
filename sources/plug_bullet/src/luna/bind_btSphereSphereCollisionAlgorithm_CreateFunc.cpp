...
const char LunaTraits< btSphereSphereCollisionAlgorithm::CreateFunc >::moduleName[] = "btSphereSphereCollisionAlgorithm";
...
luna_RegType LunaTraits< btSphereSphereCollisionAlgorithm::CreateFunc >::methods[] = {
	...
	{"__eq", &luna_wrapper_btSphereSphereCollisionAlgorithm_CreateFunc::_bind___eq},
