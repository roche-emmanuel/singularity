...
public:
	...
	static int _bind___eq(lua_State *L) {
		if (!_lg_typecheck___eq(L)) {
			luaL_error(L, "luna typecheck failed in __eq function, expected prototype:\n__eq(btGeneric6DofSpringConstraintData*). Got arguments:\n%s",luna_dumpStack(L).c_str());
		}
	...
	static int _bind_get6dofData(lua_State *L) {
		...
		btGeneric6DofSpringConstraintData* self=(Luna< btGeneric6DofSpringConstraintData >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call btGeneric6DofConstraintData btGeneric6DofSpringConstraintData::m_6dofData(). Got : '%s'\n%s",typeid(Luna< btGeneric6DofSpringConstraintData >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_set6dofData(lua_State *L) {
		...
		btGeneric6DofSpringConstraintData* self=(Luna< btGeneric6DofSpringConstraintData >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call void btGeneric6DofSpringConstraintData::m_6dofData(btGeneric6DofConstraintData). Got : '%s'\n%s",typeid(Luna< btGeneric6DofSpringConstraintData >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
