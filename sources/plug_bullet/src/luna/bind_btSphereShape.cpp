...
public:
	...
	static int _bind_fromVoid(lua_State *L) {
		...
		btSphereShape* self= (btSphereShape*)(Luna< void >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call fromVoid(...)");
		}
		
		Luna< btSphereShape >::push(L,self,false);
		return 1;
	}
	...
	static int _bind_localGetSupportingVertex(lua_State *L) {
		...
		if(!self) {
			luaL_error(L, "Invalid object in function call btVector3 btSphereShape::localGetSupportingVertex(const btVector3 &) const. Got : '%s'\n%s",typeid(Luna< btCollisionShape >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_localGetSupportingVertexWithoutMargin(lua_State *L) {
		...
		btSphereShape* self=Luna< btCollisionShape >::checkSubType< btSphereShape >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call btVector3 btSphereShape::localGetSupportingVertexWithoutMargin(const btVector3 &) const. Got : '%s'\n%s",typeid(Luna< btCollisionShape >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_batchedUnitVectorGetSupportingVertexWithoutMargin(lua_State *L) {
		...
		btSphereShape* self=Luna< btCollisionShape >::checkSubType< btSphereShape >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void btSphereShape::batchedUnitVectorGetSupportingVertexWithoutMargin(const btVector3 *, btVector3 *, int) const. Got : '%s'\n%s",typeid(Luna< btCollisionShape >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_calculateLocalInertia(lua_State *L) {
		...
		btSphereShape* self=Luna< btCollisionShape >::checkSubType< btSphereShape >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void btSphereShape::calculateLocalInertia(float, btVector3 &) const. Got : '%s'\n%s",typeid(Luna< btCollisionShape >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_getAabb(lua_State *L) {
		...
		btSphereShape* self=Luna< btCollisionShape >::checkSubType< btSphereShape >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void btSphereShape::getAabb(const btTransform &, btVector3 &, btVector3 &) const. Got : '%s'\n%s",typeid(Luna< btCollisionShape >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_getRadius(lua_State *L) {
		...
		btSphereShape* self=Luna< btCollisionShape >::checkSubType< btSphereShape >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call float btSphereShape::getRadius() const. Got : '%s'\n%s",typeid(Luna< btCollisionShape >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_setUnscaledRadius(lua_State *L) {
		...
		btSphereShape* self=Luna< btCollisionShape >::checkSubType< btSphereShape >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void btSphereShape::setUnscaledRadius(float). Got : '%s'\n%s",typeid(Luna< btCollisionShape >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_getName(lua_State *L) {
		...
		btSphereShape* self=Luna< btCollisionShape >::checkSubType< btSphereShape >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call const char * btSphereShape::getName() const. Got : '%s'\n%s",typeid(Luna< btCollisionShape >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_setMargin(lua_State *L) {
		...
		btSphereShape* self=Luna< btCollisionShape >::checkSubType< btSphereShape >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void btSphereShape::setMargin(float). Got : '%s'\n%s",typeid(Luna< btCollisionShape >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_getMargin(lua_State *L) {
		...
		btSphereShape* self=Luna< btCollisionShape >::checkSubType< btSphereShape >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call float btSphereShape::getMargin() const. Got : '%s'\n%s",typeid(Luna< btCollisionShape >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_getBoundingSphere(lua_State *L) {
		...
		btSphereShape* self=Luna< btCollisionShape >::checkSubType< btSphereShape >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void btSphereShape::base_getBoundingSphere(btVector3 &, float &) const. Got : '%s'\n%s",typeid(Luna< btCollisionShape >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_getAngularMotionDisc(lua_State *L) {
		...
		btSphereShape* self=Luna< btCollisionShape >::checkSubType< btSphereShape >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call float btSphereShape::base_getAngularMotionDisc() const. Got : '%s'\n%s",typeid(Luna< btCollisionShape >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_getContactBreakingThreshold(lua_State *L) {
		...
		btSphereShape* self=Luna< btCollisionShape >::checkSubType< btSphereShape >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call float btSphereShape::base_getContactBreakingThreshold(float) const. Got : '%s'\n%s",typeid(Luna< btCollisionShape >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_getAnisotropicRollingFrictionDirection(lua_State *L) {
		...
		btSphereShape* self=Luna< btCollisionShape >::checkSubType< btSphereShape >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call btVector3 btSphereShape::base_getAnisotropicRollingFrictionDirection() const. Got : '%s'\n%s",typeid(Luna< btCollisionShape >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_project(lua_State *L) {
		...
		btSphereShape* self=Luna< btCollisionShape >::checkSubType< btSphereShape >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void btSphereShape::base_project(const btTransform &, const btVector3 &, float &, float &) const. Got : '%s'\n%s",typeid(Luna< btCollisionShape >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_getAabbSlow(lua_State *L) {
		...
		btSphereShape* self=Luna< btCollisionShape >::checkSubType< btSphereShape >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void btSphereShape::base_getAabbSlow(const btTransform &, btVector3 &, btVector3 &) const. Got : '%s'\n%s",typeid(Luna< btCollisionShape >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_setLocalScaling(lua_State *L) {
		...
		btSphereShape* self=Luna< btCollisionShape >::checkSubType< btSphereShape >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void btSphereShape::base_setLocalScaling(const btVector3 &). Got : '%s'\n%s",typeid(Luna< btCollisionShape >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_getLocalScaling(lua_State *L) {
		...
		btSphereShape* self=Luna< btCollisionShape >::checkSubType< btSphereShape >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call const btVector3 & btSphereShape::base_getLocalScaling() const. Got : '%s'\n%s",typeid(Luna< btCollisionShape >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_getNumPreferredPenetrationDirections(lua_State *L) {
		...
		btSphereShape* self=Luna< btCollisionShape >::checkSubType< btSphereShape >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call int btSphereShape::base_getNumPreferredPenetrationDirections() const. Got : '%s'\n%s",typeid(Luna< btCollisionShape >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_getPreferredPenetrationDirection(lua_State *L) {
		...
		btSphereShape* self=Luna< btCollisionShape >::checkSubType< btSphereShape >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void btSphereShape::base_getPreferredPenetrationDirection(int, btVector3 &) const. Got : '%s'\n%s",typeid(Luna< btCollisionShape >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_calculateSerializeBufferSize(lua_State *L) {
		...
		btSphereShape* self=Luna< btCollisionShape >::checkSubType< btSphereShape >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call int btSphereShape::base_calculateSerializeBufferSize() const. Got : '%s'\n%s",typeid(Luna< btCollisionShape >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_localGetSupportingVertex(lua_State *L) {
		...
		btSphereShape* self=Luna< btCollisionShape >::checkSubType< btSphereShape >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call btVector3 btSphereShape::base_localGetSupportingVertex(const btVector3 &) const. Got : '%s'\n%s",typeid(Luna< btCollisionShape >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_localGetSupportingVertexWithoutMargin(lua_State *L) {
		...
		btSphereShape* self=Luna< btCollisionShape >::checkSubType< btSphereShape >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call btVector3 btSphereShape::base_localGetSupportingVertexWithoutMargin(const btVector3 &) const. Got : '%s'\n%s",typeid(Luna< btCollisionShape >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_batchedUnitVectorGetSupportingVertexWithoutMargin(lua_State *L) {
		...
		btSphereShape* self=Luna< btCollisionShape >::checkSubType< btSphereShape >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void btSphereShape::base_batchedUnitVectorGetSupportingVertexWithoutMargin(const btVector3 *, btVector3 *, int) const. Got : '%s'\n%s",typeid(Luna< btCollisionShape >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_calculateLocalInertia(lua_State *L) {
		...
		btSphereShape* self=Luna< btCollisionShape >::checkSubType< btSphereShape >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void btSphereShape::base_calculateLocalInertia(float, btVector3 &) const. Got : '%s'\n%s",typeid(Luna< btCollisionShape >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_getAabb(lua_State *L) {
		...
		btSphereShape* self=Luna< btCollisionShape >::checkSubType< btSphereShape >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void btSphereShape::base_getAabb(const btTransform &, btVector3 &, btVector3 &) const. Got : '%s'\n%s",typeid(Luna< btCollisionShape >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_getName(lua_State *L) {
		...
		btSphereShape* self=Luna< btCollisionShape >::checkSubType< btSphereShape >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call const char * btSphereShape::base_getName() const. Got : '%s'\n%s",typeid(Luna< btCollisionShape >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_setMargin(lua_State *L) {
		...
		btSphereShape* self=Luna< btCollisionShape >::checkSubType< btSphereShape >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void btSphereShape::base_setMargin(float). Got : '%s'\n%s",typeid(Luna< btCollisionShape >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_getMargin(lua_State *L) {
		...
		btSphereShape* self=Luna< btCollisionShape >::checkSubType< btSphereShape >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call float btSphereShape::base_getMargin() const. Got : '%s'\n%s",typeid(Luna< btCollisionShape >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
...
luna_RegType LunaTraits< btSphereShape >::methods[] = {
	...
	{"fromVoid", &luna_wrapper_btSphereShape::_bind_fromVoid},
	{"asVoid", &luna_wrapper_btSphereShape::_bind_asVoid},
