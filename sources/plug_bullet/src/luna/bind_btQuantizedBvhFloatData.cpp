...
public:
	...
	static int _bind___eq(lua_State *L) {
		if (!_lg_typecheck___eq(L)) {
			luaL_error(L, "luna typecheck failed in __eq function, expected prototype:\n__eq(btQuantizedBvhFloatData*). Got arguments:\n%s",luna_dumpStack(L).c_str());
		}
	...
	static int _bind_fromVoid(lua_State *L) {
		...
		btQuantizedBvhFloatData* self= (btQuantizedBvhFloatData*)(Luna< void >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call fromVoid(...)");
		}
		
		Luna< btQuantizedBvhFloatData >::push(L,self,false);
		return 1;
	}
	...
	static int _bind_asVoid(lua_State *L) {
		...
		void* self= (void*)(Luna< btQuantizedBvhFloatData >::check(L,1));
		if(!self) {
	...
	static int _bind_getBvhAabbMin(lua_State *L) {
		...
		btQuantizedBvhFloatData* self=(Luna< btQuantizedBvhFloatData >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call btVector3FloatData btQuantizedBvhFloatData::m_bvhAabbMin(). Got : '%s'\n%s",typeid(Luna< btQuantizedBvhFloatData >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_getBvhAabbMax(lua_State *L) {
		...
		btQuantizedBvhFloatData* self=(Luna< btQuantizedBvhFloatData >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call btVector3FloatData btQuantizedBvhFloatData::m_bvhAabbMax(). Got : '%s'\n%s",typeid(Luna< btQuantizedBvhFloatData >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_getBvhQuantization(lua_State *L) {
		...
		btQuantizedBvhFloatData* self=(Luna< btQuantizedBvhFloatData >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call btVector3FloatData btQuantizedBvhFloatData::m_bvhQuantization(). Got : '%s'\n%s",typeid(Luna< btQuantizedBvhFloatData >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_getCurNodeIndex(lua_State *L) {
		...
		btQuantizedBvhFloatData* self=(Luna< btQuantizedBvhFloatData >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call int btQuantizedBvhFloatData::m_curNodeIndex(). Got : '%s'\n%s",typeid(Luna< btQuantizedBvhFloatData >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_getUseQuantization(lua_State *L) {
		...
		btQuantizedBvhFloatData* self=(Luna< btQuantizedBvhFloatData >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call int btQuantizedBvhFloatData::m_useQuantization(). Got : '%s'\n%s",typeid(Luna< btQuantizedBvhFloatData >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_getNumContiguousLeafNodes(lua_State *L) {
		...
		btQuantizedBvhFloatData* self=(Luna< btQuantizedBvhFloatData >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call int btQuantizedBvhFloatData::m_numContiguousLeafNodes(). Got : '%s'\n%s",typeid(Luna< btQuantizedBvhFloatData >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_getNumQuantizedContiguousNodes(lua_State *L) {
		...
		btQuantizedBvhFloatData* self=(Luna< btQuantizedBvhFloatData >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call int btQuantizedBvhFloatData::m_numQuantizedContiguousNodes(). Got : '%s'\n%s",typeid(Luna< btQuantizedBvhFloatData >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_getContiguousNodesPtr(lua_State *L) {
		...
		btQuantizedBvhFloatData* self=(Luna< btQuantizedBvhFloatData >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call btOptimizedBvhNodeFloatData * btQuantizedBvhFloatData::m_contiguousNodesPtr(). Got : '%s'\n%s",typeid(Luna< btQuantizedBvhFloatData >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_getQuantizedContiguousNodesPtr(lua_State *L) {
		...
		btQuantizedBvhFloatData* self=(Luna< btQuantizedBvhFloatData >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call btQuantizedBvhNodeData * btQuantizedBvhFloatData::m_quantizedContiguousNodesPtr(). Got : '%s'\n%s",typeid(Luna< btQuantizedBvhFloatData >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_getSubTreeInfoPtr(lua_State *L) {
		...
		btQuantizedBvhFloatData* self=(Luna< btQuantizedBvhFloatData >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call btBvhSubtreeInfoData * btQuantizedBvhFloatData::m_subTreeInfoPtr(). Got : '%s'\n%s",typeid(Luna< btQuantizedBvhFloatData >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_getTraversalMode(lua_State *L) {
		...
		btQuantizedBvhFloatData* self=(Luna< btQuantizedBvhFloatData >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call int btQuantizedBvhFloatData::m_traversalMode(). Got : '%s'\n%s",typeid(Luna< btQuantizedBvhFloatData >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_getNumSubtreeHeaders(lua_State *L) {
		...
		btQuantizedBvhFloatData* self=(Luna< btQuantizedBvhFloatData >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call int btQuantizedBvhFloatData::m_numSubtreeHeaders(). Got : '%s'\n%s",typeid(Luna< btQuantizedBvhFloatData >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_setBvhAabbMin(lua_State *L) {
		...
		btQuantizedBvhFloatData* self=(Luna< btQuantizedBvhFloatData >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call void btQuantizedBvhFloatData::m_bvhAabbMin(btVector3FloatData). Got : '%s'\n%s",typeid(Luna< btQuantizedBvhFloatData >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_setBvhAabbMax(lua_State *L) {
		...
		btQuantizedBvhFloatData* self=(Luna< btQuantizedBvhFloatData >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call void btQuantizedBvhFloatData::m_bvhAabbMax(btVector3FloatData). Got : '%s'\n%s",typeid(Luna< btQuantizedBvhFloatData >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_setBvhQuantization(lua_State *L) {
		...
		btQuantizedBvhFloatData* self=(Luna< btQuantizedBvhFloatData >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call void btQuantizedBvhFloatData::m_bvhQuantization(btVector3FloatData). Got : '%s'\n%s",typeid(Luna< btQuantizedBvhFloatData >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_setCurNodeIndex(lua_State *L) {
		...
		btQuantizedBvhFloatData* self=(Luna< btQuantizedBvhFloatData >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call void btQuantizedBvhFloatData::m_curNodeIndex(int). Got : '%s'\n%s",typeid(Luna< btQuantizedBvhFloatData >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_setUseQuantization(lua_State *L) {
		...
		btQuantizedBvhFloatData* self=(Luna< btQuantizedBvhFloatData >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call void btQuantizedBvhFloatData::m_useQuantization(int). Got : '%s'\n%s",typeid(Luna< btQuantizedBvhFloatData >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_setNumContiguousLeafNodes(lua_State *L) {
		...
		btQuantizedBvhFloatData* self=(Luna< btQuantizedBvhFloatData >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call void btQuantizedBvhFloatData::m_numContiguousLeafNodes(int). Got : '%s'\n%s",typeid(Luna< btQuantizedBvhFloatData >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_setNumQuantizedContiguousNodes(lua_State *L) {
		...
		btQuantizedBvhFloatData* self=(Luna< btQuantizedBvhFloatData >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call void btQuantizedBvhFloatData::m_numQuantizedContiguousNodes(int). Got : '%s'\n%s",typeid(Luna< btQuantizedBvhFloatData >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_setContiguousNodesPtr(lua_State *L) {
		...
		btQuantizedBvhFloatData* self=(Luna< btQuantizedBvhFloatData >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call void btQuantizedBvhFloatData::m_contiguousNodesPtr(btOptimizedBvhNodeFloatData *). Got : '%s'\n%s",typeid(Luna< btQuantizedBvhFloatData >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_setQuantizedContiguousNodesPtr(lua_State *L) {
		...
		btQuantizedBvhFloatData* self=(Luna< btQuantizedBvhFloatData >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call void btQuantizedBvhFloatData::m_quantizedContiguousNodesPtr(btQuantizedBvhNodeData *). Got : '%s'\n%s",typeid(Luna< btQuantizedBvhFloatData >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_setSubTreeInfoPtr(lua_State *L) {
		...
		btQuantizedBvhFloatData* self=(Luna< btQuantizedBvhFloatData >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call void btQuantizedBvhFloatData::m_subTreeInfoPtr(btBvhSubtreeInfoData *). Got : '%s'\n%s",typeid(Luna< btQuantizedBvhFloatData >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_setTraversalMode(lua_State *L) {
		...
		btQuantizedBvhFloatData* self=(Luna< btQuantizedBvhFloatData >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call void btQuantizedBvhFloatData::m_traversalMode(int). Got : '%s'\n%s",typeid(Luna< btQuantizedBvhFloatData >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_setNumSubtreeHeaders(lua_State *L) {
		...
		btQuantizedBvhFloatData* self=(Luna< btQuantizedBvhFloatData >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call void btQuantizedBvhFloatData::m_numSubtreeHeaders(int). Got : '%s'\n%s",typeid(Luna< btQuantizedBvhFloatData >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
...
luna_RegType LunaTraits< btQuantizedBvhFloatData >::methods[] = {
	...
	{"fromVoid", &luna_wrapper_btQuantizedBvhFloatData::_bind_fromVoid},
	{"asVoid", &luna_wrapper_btQuantizedBvhFloatData::_bind_asVoid},
	{0,0}
};
