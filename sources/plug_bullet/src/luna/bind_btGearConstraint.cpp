...
public:
	...
	static int _bind_fromVoid(lua_State *L) {
		...
		btGearConstraint* self= (btGearConstraint*)(Luna< void >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call fromVoid(...)");
		}
		
		Luna< btGearConstraint >::push(L,self,false);
		return 1;
	}
	...
	static int _bind_getInfo1(lua_State *L) {
		...
		if(!self) {
			luaL_error(L, "Invalid object in function call void btGearConstraint::getInfo1(btTypedConstraint::btConstraintInfo1 *). Got : '%s'\n%s",typeid(Luna< btTypedObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
		self->getInfo1(info);
	...
	static int _bind_getInfo2(lua_State *L) {
		...
		btGearConstraint* self=Luna< btTypedObject >::checkSubType< btGearConstraint >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void btGearConstraint::getInfo2(btTypedConstraint::btConstraintInfo2 *). Got : '%s'\n%s",typeid(Luna< btTypedObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
		self->getInfo2(info);
	...
	static int _bind_setParam(lua_State *L) {
		...
		btGearConstraint* self=Luna< btTypedObject >::checkSubType< btGearConstraint >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void btGearConstraint::setParam(int, float, int). Got : '%s'\n%s",typeid(Luna< btTypedObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_getParam(lua_State *L) {
		...
		btGearConstraint* self=Luna< btTypedObject >::checkSubType< btGearConstraint >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call float btGearConstraint::getParam(int, int) const. Got : '%s'\n%s",typeid(Luna< btTypedObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_buildJacobian(lua_State *L) {
		...
		btGearConstraint* self=Luna< btTypedObject >::checkSubType< btGearConstraint >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void btGearConstraint::base_buildJacobian(). Got : '%s'\n%s",typeid(Luna< btTypedObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_setupSolverConstraint(lua_State *L) {
		...
		btGearConstraint* self=Luna< btTypedObject >::checkSubType< btGearConstraint >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void btGearConstraint::base_setupSolverConstraint(btConstraintArray &, int, int, float). Got : '%s'\n%s",typeid(Luna< btTypedObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_solveConstraintObsolete(lua_State *L) {
		...
		btGearConstraint* self=Luna< btTypedObject >::checkSubType< btGearConstraint >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void btGearConstraint::base_solveConstraintObsolete(btSolverBody &, btSolverBody &, float). Got : '%s'\n%s",typeid(Luna< btTypedObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_calculateSerializeBufferSize(lua_State *L) {
		...
		btGearConstraint* self=Luna< btTypedObject >::checkSubType< btGearConstraint >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call int btGearConstraint::base_calculateSerializeBufferSize() const. Got : '%s'\n%s",typeid(Luna< btTypedObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_getInfo1(lua_State *L) {
		...
		btGearConstraint* self=Luna< btTypedObject >::checkSubType< btGearConstraint >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void btGearConstraint::base_getInfo1(btTypedConstraint::btConstraintInfo1 *). Got : '%s'\n%s",typeid(Luna< btTypedObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_getInfo2(lua_State *L) {
		...
		btGearConstraint* self=Luna< btTypedObject >::checkSubType< btGearConstraint >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void btGearConstraint::base_getInfo2(btTypedConstraint::btConstraintInfo2 *). Got : '%s'\n%s",typeid(Luna< btTypedObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_setParam(lua_State *L) {
		...
		btGearConstraint* self=Luna< btTypedObject >::checkSubType< btGearConstraint >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void btGearConstraint::base_setParam(int, float, int). Got : '%s'\n%s",typeid(Luna< btTypedObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_getParam(lua_State *L) {
		...
		btGearConstraint* self=Luna< btTypedObject >::checkSubType< btGearConstraint >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call float btGearConstraint::base_getParam(int, int) const. Got : '%s'\n%s",typeid(Luna< btTypedObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
...
luna_RegType LunaTraits< btGearConstraint >::methods[] = {
	...
	{"fromVoid", &luna_wrapper_btGearConstraint::_bind_fromVoid},
	{"asVoid", &luna_wrapper_btGearConstraint::_bind_asVoid},
