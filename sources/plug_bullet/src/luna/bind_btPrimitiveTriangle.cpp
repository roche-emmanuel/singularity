...
public:
	...
	static int _bind_fromVoid(lua_State *L) {
		...
		Luna< btPrimitiveTriangle >::push(L,self,false);
		return 1;
	}
...
luna_RegType LunaTraits< btPrimitiveTriangle >::methods[] = {
	...
	{"fromVoid", &luna_wrapper_btPrimitiveTriangle::_bind_fromVoid},
	{"asVoid", &luna_wrapper_btPrimitiveTriangle::_bind_asVoid},
	{0,0}
};
