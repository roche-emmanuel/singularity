...
public:
	...
	static int _bind___eq(lua_State *L) {
		if (!_lg_typecheck___eq(L)) {
			luaL_error(L, "luna typecheck failed in __eq function, expected prototype:\n__eq(btTransformDoubleData*). Got arguments:\n%s",luna_dumpStack(L).c_str());
		}
	...
	static int _bind_fromVoid(lua_State *L) {
		...
		btTransformDoubleData* self= (btTransformDoubleData*)(Luna< void >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call fromVoid(...)");
		}
		
		Luna< btTransformDoubleData >::push(L,self,false);
		return 1;
	}
	...
	static int _bind_asVoid(lua_State *L) {
		...
		void* self= (void*)(Luna< btTransformDoubleData >::check(L,1));
		if(!self) {
	...
	static int _bind_getBasis(lua_State *L) {
		...
		btTransformDoubleData* self=(Luna< btTransformDoubleData >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call btMatrix3x3DoubleData btTransformDoubleData::m_basis(). Got : '%s'\n%s",typeid(Luna< btTransformDoubleData >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_getOrigin(lua_State *L) {
		...
		btTransformDoubleData* self=(Luna< btTransformDoubleData >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call btVector3DoubleData btTransformDoubleData::m_origin(). Got : '%s'\n%s",typeid(Luna< btTransformDoubleData >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_setBasis(lua_State *L) {
		...
		btTransformDoubleData* self=(Luna< btTransformDoubleData >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call void btTransformDoubleData::m_basis(btMatrix3x3DoubleData). Got : '%s'\n%s",typeid(Luna< btTransformDoubleData >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
		self->m_basis = value;
	...
	static int _bind_setOrigin(lua_State *L) {
		...
		btTransformDoubleData* self=(Luna< btTransformDoubleData >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call void btTransformDoubleData::m_origin(btVector3DoubleData). Got : '%s'\n%s",typeid(Luna< btTransformDoubleData >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
		self->m_origin = value;
...
luna_RegType LunaTraits< btTransformDoubleData >::methods[] = {
	...
	{"fromVoid", &luna_wrapper_btTransformDoubleData::_bind_fromVoid},
	{"asVoid", &luna_wrapper_btTransformDoubleData::_bind_asVoid},
	{0,0}
};
