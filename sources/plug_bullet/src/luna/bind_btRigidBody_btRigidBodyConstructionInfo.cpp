...
public:
	...
	static int _bind___eq(lua_State *L) {
		if (!_lg_typecheck___eq(L)) {
			luaL_error(L, "luna typecheck failed in __eq function, expected prototype:\n__eq(btRigidBody::btRigidBodyConstructionInfo*). Got arguments:\n%s",luna_dumpStack(L).c_str());
		}
	...
	static int _bind_fromVoid(lua_State *L) {
		...
		btRigidBody::btRigidBodyConstructionInfo* self= (btRigidBody::btRigidBodyConstructionInfo*)(Luna< void >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call fromVoid(...)");
		}
		
		Luna< btRigidBody::btRigidBodyConstructionInfo >::push(L,self,false);
		return 1;
	}
	...
	static int _bind_asVoid(lua_State *L) {
		...
		void* self= (void*)(Luna< btRigidBody::btRigidBodyConstructionInfo >::check(L,1));
		if(!self) {
	...
	static int _bind_getMass(lua_State *L) {
		...
		btRigidBody::btRigidBodyConstructionInfo* self=(Luna< btRigidBody::btRigidBodyConstructionInfo >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call float btRigidBody::btRigidBodyConstructionInfo::m_mass(). Got : '%s'\n%s",typeid(Luna< btRigidBody::btRigidBodyConstructionInfo >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_getMotionState(lua_State *L) {
		...
		btRigidBody::btRigidBodyConstructionInfo* self=(Luna< btRigidBody::btRigidBodyConstructionInfo >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call btMotionState * btRigidBody::btRigidBodyConstructionInfo::m_motionState(). Got : '%s'\n%s",typeid(Luna< btRigidBody::btRigidBodyConstructionInfo >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_getStartWorldTransform(lua_State *L) {
		...
		btRigidBody::btRigidBodyConstructionInfo* self=(Luna< btRigidBody::btRigidBodyConstructionInfo >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call btTransform btRigidBody::btRigidBodyConstructionInfo::m_startWorldTransform(). Got : '%s'\n%s",typeid(Luna< btRigidBody::btRigidBodyConstructionInfo >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_getCollisionShape(lua_State *L) {
		...
		btRigidBody::btRigidBodyConstructionInfo* self=(Luna< btRigidBody::btRigidBodyConstructionInfo >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call btCollisionShape * btRigidBody::btRigidBodyConstructionInfo::m_collisionShape(). Got : '%s'\n%s",typeid(Luna< btRigidBody::btRigidBodyConstructionInfo >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_getLocalInertia(lua_State *L) {
		...
		btRigidBody::btRigidBodyConstructionInfo* self=(Luna< btRigidBody::btRigidBodyConstructionInfo >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call btVector3 btRigidBody::btRigidBodyConstructionInfo::m_localInertia(). Got : '%s'\n%s",typeid(Luna< btRigidBody::btRigidBodyConstructionInfo >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_getLinearDamping(lua_State *L) {
		...
		btRigidBody::btRigidBodyConstructionInfo* self=(Luna< btRigidBody::btRigidBodyConstructionInfo >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call float btRigidBody::btRigidBodyConstructionInfo::m_linearDamping(). Got : '%s'\n%s",typeid(Luna< btRigidBody::btRigidBodyConstructionInfo >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_getAngularDamping(lua_State *L) {
		...
		btRigidBody::btRigidBodyConstructionInfo* self=(Luna< btRigidBody::btRigidBodyConstructionInfo >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call float btRigidBody::btRigidBodyConstructionInfo::m_angularDamping(). Got : '%s'\n%s",typeid(Luna< btRigidBody::btRigidBodyConstructionInfo >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_getFriction(lua_State *L) {
		...
		btRigidBody::btRigidBodyConstructionInfo* self=(Luna< btRigidBody::btRigidBodyConstructionInfo >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call float btRigidBody::btRigidBodyConstructionInfo::m_friction(). Got : '%s'\n%s",typeid(Luna< btRigidBody::btRigidBodyConstructionInfo >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_getRollingFriction(lua_State *L) {
		...
		btRigidBody::btRigidBodyConstructionInfo* self=(Luna< btRigidBody::btRigidBodyConstructionInfo >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call float btRigidBody::btRigidBodyConstructionInfo::m_rollingFriction(). Got : '%s'\n%s",typeid(Luna< btRigidBody::btRigidBodyConstructionInfo >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_getRestitution(lua_State *L) {
		...
		btRigidBody::btRigidBodyConstructionInfo* self=(Luna< btRigidBody::btRigidBodyConstructionInfo >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call float btRigidBody::btRigidBodyConstructionInfo::m_restitution(). Got : '%s'\n%s",typeid(Luna< btRigidBody::btRigidBodyConstructionInfo >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_getLinearSleepingThreshold(lua_State *L) {
		...
		btRigidBody::btRigidBodyConstructionInfo* self=(Luna< btRigidBody::btRigidBodyConstructionInfo >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call float btRigidBody::btRigidBodyConstructionInfo::m_linearSleepingThreshold(). Got : '%s'\n%s",typeid(Luna< btRigidBody::btRigidBodyConstructionInfo >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_getAngularSleepingThreshold(lua_State *L) {
		...
		btRigidBody::btRigidBodyConstructionInfo* self=(Luna< btRigidBody::btRigidBodyConstructionInfo >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call float btRigidBody::btRigidBodyConstructionInfo::m_angularSleepingThreshold(). Got : '%s'\n%s",typeid(Luna< btRigidBody::btRigidBodyConstructionInfo >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_getAdditionalDamping(lua_State *L) {
		...
		btRigidBody::btRigidBodyConstructionInfo* self=(Luna< btRigidBody::btRigidBodyConstructionInfo >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call bool btRigidBody::btRigidBodyConstructionInfo::m_additionalDamping(). Got : '%s'\n%s",typeid(Luna< btRigidBody::btRigidBodyConstructionInfo >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_getAdditionalDampingFactor(lua_State *L) {
		...
		btRigidBody::btRigidBodyConstructionInfo* self=(Luna< btRigidBody::btRigidBodyConstructionInfo >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call float btRigidBody::btRigidBodyConstructionInfo::m_additionalDampingFactor(). Got : '%s'\n%s",typeid(Luna< btRigidBody::btRigidBodyConstructionInfo >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_getAdditionalLinearDampingThresholdSqr(lua_State *L) {
		...
		btRigidBody::btRigidBodyConstructionInfo* self=(Luna< btRigidBody::btRigidBodyConstructionInfo >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call float btRigidBody::btRigidBodyConstructionInfo::m_additionalLinearDampingThresholdSqr(). Got : '%s'\n%s",typeid(Luna< btRigidBody::btRigidBodyConstructionInfo >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_getAdditionalAngularDampingThresholdSqr(lua_State *L) {
		...
		btRigidBody::btRigidBodyConstructionInfo* self=(Luna< btRigidBody::btRigidBodyConstructionInfo >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call float btRigidBody::btRigidBodyConstructionInfo::m_additionalAngularDampingThresholdSqr(). Got : '%s'\n%s",typeid(Luna< btRigidBody::btRigidBodyConstructionInfo >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_getAdditionalAngularDampingFactor(lua_State *L) {
		...
		btRigidBody::btRigidBodyConstructionInfo* self=(Luna< btRigidBody::btRigidBodyConstructionInfo >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call float btRigidBody::btRigidBodyConstructionInfo::m_additionalAngularDampingFactor(). Got : '%s'\n%s",typeid(Luna< btRigidBody::btRigidBodyConstructionInfo >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_setMass(lua_State *L) {
		...
		btRigidBody::btRigidBodyConstructionInfo* self=(Luna< btRigidBody::btRigidBodyConstructionInfo >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call void btRigidBody::btRigidBodyConstructionInfo::m_mass(float). Got : '%s'\n%s",typeid(Luna< btRigidBody::btRigidBodyConstructionInfo >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
		self->m_mass = value;
	...
	static int _bind_setMotionState(lua_State *L) {
		...
		btRigidBody::btRigidBodyConstructionInfo* self=(Luna< btRigidBody::btRigidBodyConstructionInfo >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call void btRigidBody::btRigidBodyConstructionInfo::m_motionState(btMotionState *). Got : '%s'\n%s",typeid(Luna< btRigidBody::btRigidBodyConstructionInfo >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_setStartWorldTransform(lua_State *L) {
		...
		btRigidBody::btRigidBodyConstructionInfo* self=(Luna< btRigidBody::btRigidBodyConstructionInfo >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call void btRigidBody::btRigidBodyConstructionInfo::m_startWorldTransform(btTransform). Got : '%s'\n%s",typeid(Luna< btRigidBody::btRigidBodyConstructionInfo >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_setCollisionShape(lua_State *L) {
		...
		btRigidBody::btRigidBodyConstructionInfo* self=(Luna< btRigidBody::btRigidBodyConstructionInfo >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call void btRigidBody::btRigidBodyConstructionInfo::m_collisionShape(btCollisionShape *). Got : '%s'\n%s",typeid(Luna< btRigidBody::btRigidBodyConstructionInfo >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_setLocalInertia(lua_State *L) {
		...
		btRigidBody::btRigidBodyConstructionInfo* self=(Luna< btRigidBody::btRigidBodyConstructionInfo >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call void btRigidBody::btRigidBodyConstructionInfo::m_localInertia(btVector3). Got : '%s'\n%s",typeid(Luna< btRigidBody::btRigidBodyConstructionInfo >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_setLinearDamping(lua_State *L) {
		...
		btRigidBody::btRigidBodyConstructionInfo* self=(Luna< btRigidBody::btRigidBodyConstructionInfo >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call void btRigidBody::btRigidBodyConstructionInfo::m_linearDamping(float). Got : '%s'\n%s",typeid(Luna< btRigidBody::btRigidBodyConstructionInfo >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_setAngularDamping(lua_State *L) {
		...
		btRigidBody::btRigidBodyConstructionInfo* self=(Luna< btRigidBody::btRigidBodyConstructionInfo >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call void btRigidBody::btRigidBodyConstructionInfo::m_angularDamping(float). Got : '%s'\n%s",typeid(Luna< btRigidBody::btRigidBodyConstructionInfo >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_setFriction(lua_State *L) {
		...
		btRigidBody::btRigidBodyConstructionInfo* self=(Luna< btRigidBody::btRigidBodyConstructionInfo >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call void btRigidBody::btRigidBodyConstructionInfo::m_friction(float). Got : '%s'\n%s",typeid(Luna< btRigidBody::btRigidBodyConstructionInfo >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_setRollingFriction(lua_State *L) {
		...
		btRigidBody::btRigidBodyConstructionInfo* self=(Luna< btRigidBody::btRigidBodyConstructionInfo >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call void btRigidBody::btRigidBodyConstructionInfo::m_rollingFriction(float). Got : '%s'\n%s",typeid(Luna< btRigidBody::btRigidBodyConstructionInfo >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_setRestitution(lua_State *L) {
		...
		btRigidBody::btRigidBodyConstructionInfo* self=(Luna< btRigidBody::btRigidBodyConstructionInfo >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call void btRigidBody::btRigidBodyConstructionInfo::m_restitution(float). Got : '%s'\n%s",typeid(Luna< btRigidBody::btRigidBodyConstructionInfo >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_setLinearSleepingThreshold(lua_State *L) {
		...
		btRigidBody::btRigidBodyConstructionInfo* self=(Luna< btRigidBody::btRigidBodyConstructionInfo >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call void btRigidBody::btRigidBodyConstructionInfo::m_linearSleepingThreshold(float). Got : '%s'\n%s",typeid(Luna< btRigidBody::btRigidBodyConstructionInfo >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_setAngularSleepingThreshold(lua_State *L) {
		...
		btRigidBody::btRigidBodyConstructionInfo* self=(Luna< btRigidBody::btRigidBodyConstructionInfo >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call void btRigidBody::btRigidBodyConstructionInfo::m_angularSleepingThreshold(float). Got : '%s'\n%s",typeid(Luna< btRigidBody::btRigidBodyConstructionInfo >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_setAdditionalDamping(lua_State *L) {
		...
		btRigidBody::btRigidBodyConstructionInfo* self=(Luna< btRigidBody::btRigidBodyConstructionInfo >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call void btRigidBody::btRigidBodyConstructionInfo::m_additionalDamping(bool). Got : '%s'\n%s",typeid(Luna< btRigidBody::btRigidBodyConstructionInfo >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_setAdditionalDampingFactor(lua_State *L) {
		...
		btRigidBody::btRigidBodyConstructionInfo* self=(Luna< btRigidBody::btRigidBodyConstructionInfo >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call void btRigidBody::btRigidBodyConstructionInfo::m_additionalDampingFactor(float). Got : '%s'\n%s",typeid(Luna< btRigidBody::btRigidBodyConstructionInfo >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_setAdditionalLinearDampingThresholdSqr(lua_State *L) {
		...
		btRigidBody::btRigidBodyConstructionInfo* self=(Luna< btRigidBody::btRigidBodyConstructionInfo >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call void btRigidBody::btRigidBodyConstructionInfo::m_additionalLinearDampingThresholdSqr(float). Got : '%s'\n%s",typeid(Luna< btRigidBody::btRigidBodyConstructionInfo >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_setAdditionalAngularDampingThresholdSqr(lua_State *L) {
		...
		btRigidBody::btRigidBodyConstructionInfo* self=(Luna< btRigidBody::btRigidBodyConstructionInfo >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call void btRigidBody::btRigidBodyConstructionInfo::m_additionalAngularDampingThresholdSqr(float). Got : '%s'\n%s",typeid(Luna< btRigidBody::btRigidBodyConstructionInfo >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_setAdditionalAngularDampingFactor(lua_State *L) {
		...
		btRigidBody::btRigidBodyConstructionInfo* self=(Luna< btRigidBody::btRigidBodyConstructionInfo >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call void btRigidBody::btRigidBodyConstructionInfo::m_additionalAngularDampingFactor(float). Got : '%s'\n%s",typeid(Luna< btRigidBody::btRigidBodyConstructionInfo >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
...
luna_RegType LunaTraits< btRigidBody::btRigidBodyConstructionInfo >::methods[] = {
	...
	{"fromVoid", &luna_wrapper_btRigidBody_btRigidBodyConstructionInfo::_bind_fromVoid},
	{"asVoid", &luna_wrapper_btRigidBody_btRigidBodyConstructionInfo::_bind_asVoid},
	{0,0}
};
