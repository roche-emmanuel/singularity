...
public:
	...
	static int _bind_processCollision(lua_State *L) {
		...
		if(!self) {
			luaL_error(L, "Invalid object in function call void btSphereSphereCollisionAlgorithm::processCollision(const btCollisionObjectWrapper *, const btCollisionObjectWrapper *, const btDispatcherInfo &, btManifoldResult *). Got : '%s'\n%s",typeid(Luna< btCollisionAlgorithm >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_calculateTimeOfImpact(lua_State *L) {
		...
		btSphereSphereCollisionAlgorithm* self=Luna< btCollisionAlgorithm >::checkSubType< btSphereSphereCollisionAlgorithm >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call float btSphereSphereCollisionAlgorithm::calculateTimeOfImpact(btCollisionObject *, btCollisionObject *, const btDispatcherInfo &, btManifoldResult *). Got : '%s'\n%s",typeid(Luna< btCollisionAlgorithm >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_getAllContactManifolds(lua_State *L) {
		...
		btSphereSphereCollisionAlgorithm* self=Luna< btCollisionAlgorithm >::checkSubType< btSphereSphereCollisionAlgorithm >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void btSphereSphereCollisionAlgorithm::getAllContactManifolds(btManifoldArray &). Got : '%s'\n%s",typeid(Luna< btCollisionAlgorithm >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_processCollision(lua_State *L) {
		...
		btSphereSphereCollisionAlgorithm* self=Luna< btCollisionAlgorithm >::checkSubType< btSphereSphereCollisionAlgorithm >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void btSphereSphereCollisionAlgorithm::base_processCollision(const btCollisionObjectWrapper *, const btCollisionObjectWrapper *, const btDispatcherInfo &, btManifoldResult *). Got : '%s'\n%s",typeid(Luna< btCollisionAlgorithm >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_calculateTimeOfImpact(lua_State *L) {
		...
		btSphereSphereCollisionAlgorithm* self=Luna< btCollisionAlgorithm >::checkSubType< btSphereSphereCollisionAlgorithm >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call float btSphereSphereCollisionAlgorithm::base_calculateTimeOfImpact(btCollisionObject *, btCollisionObject *, const btDispatcherInfo &, btManifoldResult *). Got : '%s'\n%s",typeid(Luna< btCollisionAlgorithm >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_getAllContactManifolds(lua_State *L) {
		...
		btSphereSphereCollisionAlgorithm* self=Luna< btCollisionAlgorithm >::checkSubType< btSphereSphereCollisionAlgorithm >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void btSphereSphereCollisionAlgorithm::base_getAllContactManifolds(btManifoldArray &). Got : '%s'\n%s",typeid(Luna< btCollisionAlgorithm >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
