...
public:
	...
	static int _bind_fromVoid(lua_State *L) {
		...
		Luna< btVoronoiSimplexSolver >::push(L,self,false);
		return 1;
	}
...
luna_RegType LunaTraits< btVoronoiSimplexSolver >::methods[] = {
	...
	{"fromVoid", &luna_wrapper_btVoronoiSimplexSolver::_bind_fromVoid},
	{"asVoid", &luna_wrapper_btVoronoiSimplexSolver::_bind_asVoid},
	{0,0}
};
