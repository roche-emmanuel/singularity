...
public:
	...
	static int _bind_localGetSupportingVertex(lua_State *L) {
		...
		if(!self) {
			luaL_error(L, "Invalid object in function call btVector3 btConeShape::localGetSupportingVertex(const btVector3 &) const. Got : '%s'\n%s",typeid(Luna< btCollisionShape >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_localGetSupportingVertexWithoutMargin(lua_State *L) {
		...
		btConeShape* self=Luna< btCollisionShape >::checkSubType< btConeShape >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call btVector3 btConeShape::localGetSupportingVertexWithoutMargin(const btVector3 &) const. Got : '%s'\n%s",typeid(Luna< btCollisionShape >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_batchedUnitVectorGetSupportingVertexWithoutMargin(lua_State *L) {
		...
		btConeShape* self=Luna< btCollisionShape >::checkSubType< btConeShape >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void btConeShape::batchedUnitVectorGetSupportingVertexWithoutMargin(const btVector3 *, btVector3 *, int) const. Got : '%s'\n%s",typeid(Luna< btCollisionShape >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_getRadius(lua_State *L) {
		...
		btConeShape* self=Luna< btCollisionShape >::checkSubType< btConeShape >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call float btConeShape::getRadius() const. Got : '%s'\n%s",typeid(Luna< btCollisionShape >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_getHeight(lua_State *L) {
		...
		btConeShape* self=Luna< btCollisionShape >::checkSubType< btConeShape >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call float btConeShape::getHeight() const. Got : '%s'\n%s",typeid(Luna< btCollisionShape >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_calculateLocalInertia(lua_State *L) {
		...
		btConeShape* self=Luna< btCollisionShape >::checkSubType< btConeShape >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void btConeShape::calculateLocalInertia(float, btVector3 &) const. Got : '%s'\n%s",typeid(Luna< btCollisionShape >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_getName(lua_State *L) {
		...
		btConeShape* self=Luna< btCollisionShape >::checkSubType< btConeShape >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call const char * btConeShape::getName() const. Got : '%s'\n%s",typeid(Luna< btCollisionShape >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_setConeUpIndex(lua_State *L) {
		...
		btConeShape* self=Luna< btCollisionShape >::checkSubType< btConeShape >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void btConeShape::setConeUpIndex(int). Got : '%s'\n%s",typeid(Luna< btCollisionShape >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_getConeUpIndex(lua_State *L) {
		...
		btConeShape* self=Luna< btCollisionShape >::checkSubType< btConeShape >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call int btConeShape::getConeUpIndex() const. Got : '%s'\n%s",typeid(Luna< btCollisionShape >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_getAnisotropicRollingFrictionDirection(lua_State *L) {
		...
		btConeShape* self=Luna< btCollisionShape >::checkSubType< btConeShape >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call btVector3 btConeShape::getAnisotropicRollingFrictionDirection() const. Got : '%s'\n%s",typeid(Luna< btCollisionShape >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_setLocalScaling(lua_State *L) {
		...
		btConeShape* self=Luna< btCollisionShape >::checkSubType< btConeShape >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void btConeShape::setLocalScaling(const btVector3 &). Got : '%s'\n%s",typeid(Luna< btCollisionShape >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_getBoundingSphere(lua_State *L) {
		...
		btConeShape* self=Luna< btCollisionShape >::checkSubType< btConeShape >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void btConeShape::base_getBoundingSphere(btVector3 &, float &) const. Got : '%s'\n%s",typeid(Luna< btCollisionShape >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_getAngularMotionDisc(lua_State *L) {
		...
		btConeShape* self=Luna< btCollisionShape >::checkSubType< btConeShape >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call float btConeShape::base_getAngularMotionDisc() const. Got : '%s'\n%s",typeid(Luna< btCollisionShape >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_getContactBreakingThreshold(lua_State *L) {
		...
		btConeShape* self=Luna< btCollisionShape >::checkSubType< btConeShape >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call float btConeShape::base_getContactBreakingThreshold(float) const. Got : '%s'\n%s",typeid(Luna< btCollisionShape >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_project(lua_State *L) {
		...
		btConeShape* self=Luna< btCollisionShape >::checkSubType< btConeShape >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void btConeShape::base_project(const btTransform &, const btVector3 &, float &, float &) const. Got : '%s'\n%s",typeid(Luna< btCollisionShape >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_getAabb(lua_State *L) {
		...
		btConeShape* self=Luna< btCollisionShape >::checkSubType< btConeShape >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void btConeShape::base_getAabb(const btTransform &, btVector3 &, btVector3 &) const. Got : '%s'\n%s",typeid(Luna< btCollisionShape >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_getAabbSlow(lua_State *L) {
		...
		btConeShape* self=Luna< btCollisionShape >::checkSubType< btConeShape >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void btConeShape::base_getAabbSlow(const btTransform &, btVector3 &, btVector3 &) const. Got : '%s'\n%s",typeid(Luna< btCollisionShape >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_getLocalScaling(lua_State *L) {
		...
		btConeShape* self=Luna< btCollisionShape >::checkSubType< btConeShape >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call const btVector3 & btConeShape::base_getLocalScaling() const. Got : '%s'\n%s",typeid(Luna< btCollisionShape >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_setMargin(lua_State *L) {
		...
		btConeShape* self=Luna< btCollisionShape >::checkSubType< btConeShape >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void btConeShape::base_setMargin(float). Got : '%s'\n%s",typeid(Luna< btCollisionShape >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_getMargin(lua_State *L) {
		...
		btConeShape* self=Luna< btCollisionShape >::checkSubType< btConeShape >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call float btConeShape::base_getMargin() const. Got : '%s'\n%s",typeid(Luna< btCollisionShape >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_getNumPreferredPenetrationDirections(lua_State *L) {
		...
		btConeShape* self=Luna< btCollisionShape >::checkSubType< btConeShape >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call int btConeShape::base_getNumPreferredPenetrationDirections() const. Got : '%s'\n%s",typeid(Luna< btCollisionShape >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_getPreferredPenetrationDirection(lua_State *L) {
		...
		btConeShape* self=Luna< btCollisionShape >::checkSubType< btConeShape >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void btConeShape::base_getPreferredPenetrationDirection(int, btVector3 &) const. Got : '%s'\n%s",typeid(Luna< btCollisionShape >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_calculateSerializeBufferSize(lua_State *L) {
		...
		btConeShape* self=Luna< btCollisionShape >::checkSubType< btConeShape >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call int btConeShape::base_calculateSerializeBufferSize() const. Got : '%s'\n%s",typeid(Luna< btCollisionShape >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_localGetSupportingVertex(lua_State *L) {
		...
		btConeShape* self=Luna< btCollisionShape >::checkSubType< btConeShape >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call btVector3 btConeShape::base_localGetSupportingVertex(const btVector3 &) const. Got : '%s'\n%s",typeid(Luna< btCollisionShape >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_localGetSupportingVertexWithoutMargin(lua_State *L) {
		...
		btConeShape* self=Luna< btCollisionShape >::checkSubType< btConeShape >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call btVector3 btConeShape::base_localGetSupportingVertexWithoutMargin(const btVector3 &) const. Got : '%s'\n%s",typeid(Luna< btCollisionShape >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_batchedUnitVectorGetSupportingVertexWithoutMargin(lua_State *L) {
		...
		btConeShape* self=Luna< btCollisionShape >::checkSubType< btConeShape >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void btConeShape::base_batchedUnitVectorGetSupportingVertexWithoutMargin(const btVector3 *, btVector3 *, int) const. Got : '%s'\n%s",typeid(Luna< btCollisionShape >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_calculateLocalInertia(lua_State *L) {
		...
		btConeShape* self=Luna< btCollisionShape >::checkSubType< btConeShape >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void btConeShape::base_calculateLocalInertia(float, btVector3 &) const. Got : '%s'\n%s",typeid(Luna< btCollisionShape >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_getName(lua_State *L) {
		...
		btConeShape* self=Luna< btCollisionShape >::checkSubType< btConeShape >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call const char * btConeShape::base_getName() const. Got : '%s'\n%s",typeid(Luna< btCollisionShape >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_getAnisotropicRollingFrictionDirection(lua_State *L) {
		...
		btConeShape* self=Luna< btCollisionShape >::checkSubType< btConeShape >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call btVector3 btConeShape::base_getAnisotropicRollingFrictionDirection() const. Got : '%s'\n%s",typeid(Luna< btCollisionShape >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_setLocalScaling(lua_State *L) {
		...
		btConeShape* self=Luna< btCollisionShape >::checkSubType< btConeShape >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void btConeShape::base_setLocalScaling(const btVector3 &). Got : '%s'\n%s",typeid(Luna< btCollisionShape >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
