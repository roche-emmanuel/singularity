...
public:
	...
	static int _bind_fromVoid(lua_State *L) {
		...
		Luna< btPolarDecomposition >::push(L,self,false);
		return 1;
	}
...
luna_RegType LunaTraits< btPolarDecomposition >::methods[] = {
	...
	{"fromVoid", &luna_wrapper_btPolarDecomposition::_bind_fromVoid},
	{"asVoid", &luna_wrapper_btPolarDecomposition::_bind_asVoid},
	{0,0}
};
