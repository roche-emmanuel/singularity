...
public:
	...
	static int _bind_fromVoid(lua_State *L) {
		...
		btConvex2dShape* self= (btConvex2dShape*)(Luna< void >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call fromVoid(...)");
		}
		
		Luna< btConvex2dShape >::push(L,self,false);
		return 1;
	}
	...
	static int _bind_localGetSupportingVertexWithoutMargin(lua_State *L) {
		...
		if(!self) {
			luaL_error(L, "Invalid object in function call btVector3 btConvex2dShape::localGetSupportingVertexWithoutMargin(const btVector3 &) const. Got : '%s'\n%s",typeid(Luna< btCollisionShape >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_localGetSupportingVertex(lua_State *L) {
		...
		btConvex2dShape* self=Luna< btCollisionShape >::checkSubType< btConvex2dShape >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call btVector3 btConvex2dShape::localGetSupportingVertex(const btVector3 &) const. Got : '%s'\n%s",typeid(Luna< btCollisionShape >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_batchedUnitVectorGetSupportingVertexWithoutMargin(lua_State *L) {
		...
		btConvex2dShape* self=Luna< btCollisionShape >::checkSubType< btConvex2dShape >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void btConvex2dShape::batchedUnitVectorGetSupportingVertexWithoutMargin(const btVector3 *, btVector3 *, int) const. Got : '%s'\n%s",typeid(Luna< btCollisionShape >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_calculateLocalInertia(lua_State *L) {
		...
		btConvex2dShape* self=Luna< btCollisionShape >::checkSubType< btConvex2dShape >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void btConvex2dShape::calculateLocalInertia(float, btVector3 &) const. Got : '%s'\n%s",typeid(Luna< btCollisionShape >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_getChildShape_overload_1(lua_State *L) {
		...
		btConvex2dShape* self=Luna< btCollisionShape >::checkSubType< btConvex2dShape >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call btConvexShape * btConvex2dShape::getChildShape(). Got : '%s'\n%s",typeid(Luna< btCollisionShape >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_getChildShape_overload_2(lua_State *L) {
		...
		btConvex2dShape* self=Luna< btCollisionShape >::checkSubType< btConvex2dShape >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call const btConvexShape * btConvex2dShape::getChildShape() const. Got : '%s'\n%s",typeid(Luna< btCollisionShape >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_getName(lua_State *L) {
		...
		btConvex2dShape* self=Luna< btCollisionShape >::checkSubType< btConvex2dShape >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call const char * btConvex2dShape::getName() const. Got : '%s'\n%s",typeid(Luna< btCollisionShape >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_getAabb(lua_State *L) {
		...
		btConvex2dShape* self=Luna< btCollisionShape >::checkSubType< btConvex2dShape >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void btConvex2dShape::getAabb(const btTransform &, btVector3 &, btVector3 &) const. Got : '%s'\n%s",typeid(Luna< btCollisionShape >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_getAabbSlow(lua_State *L) {
		...
		btConvex2dShape* self=Luna< btCollisionShape >::checkSubType< btConvex2dShape >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void btConvex2dShape::getAabbSlow(const btTransform &, btVector3 &, btVector3 &) const. Got : '%s'\n%s",typeid(Luna< btCollisionShape >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_setLocalScaling(lua_State *L) {
		...
		btConvex2dShape* self=Luna< btCollisionShape >::checkSubType< btConvex2dShape >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void btConvex2dShape::setLocalScaling(const btVector3 &). Got : '%s'\n%s",typeid(Luna< btCollisionShape >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_getLocalScaling(lua_State *L) {
		...
		btConvex2dShape* self=Luna< btCollisionShape >::checkSubType< btConvex2dShape >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call const btVector3 & btConvex2dShape::getLocalScaling() const. Got : '%s'\n%s",typeid(Luna< btCollisionShape >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_setMargin(lua_State *L) {
		...
		btConvex2dShape* self=Luna< btCollisionShape >::checkSubType< btConvex2dShape >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void btConvex2dShape::setMargin(float). Got : '%s'\n%s",typeid(Luna< btCollisionShape >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_getMargin(lua_State *L) {
		...
		btConvex2dShape* self=Luna< btCollisionShape >::checkSubType< btConvex2dShape >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call float btConvex2dShape::getMargin() const. Got : '%s'\n%s",typeid(Luna< btCollisionShape >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_getNumPreferredPenetrationDirections(lua_State *L) {
		...
		btConvex2dShape* self=Luna< btCollisionShape >::checkSubType< btConvex2dShape >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call int btConvex2dShape::getNumPreferredPenetrationDirections() const. Got : '%s'\n%s",typeid(Luna< btCollisionShape >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_getPreferredPenetrationDirection(lua_State *L) {
		...
		btConvex2dShape* self=Luna< btCollisionShape >::checkSubType< btConvex2dShape >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void btConvex2dShape::getPreferredPenetrationDirection(int, btVector3 &) const. Got : '%s'\n%s",typeid(Luna< btCollisionShape >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_getBoundingSphere(lua_State *L) {
		...
		btConvex2dShape* self=Luna< btCollisionShape >::checkSubType< btConvex2dShape >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void btConvex2dShape::base_getBoundingSphere(btVector3 &, float &) const. Got : '%s'\n%s",typeid(Luna< btCollisionShape >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_getAngularMotionDisc(lua_State *L) {
		...
		btConvex2dShape* self=Luna< btCollisionShape >::checkSubType< btConvex2dShape >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call float btConvex2dShape::base_getAngularMotionDisc() const. Got : '%s'\n%s",typeid(Luna< btCollisionShape >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_getContactBreakingThreshold(lua_State *L) {
		...
		btConvex2dShape* self=Luna< btCollisionShape >::checkSubType< btConvex2dShape >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call float btConvex2dShape::base_getContactBreakingThreshold(float) const. Got : '%s'\n%s",typeid(Luna< btCollisionShape >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_getAnisotropicRollingFrictionDirection(lua_State *L) {
		...
		btConvex2dShape* self=Luna< btCollisionShape >::checkSubType< btConvex2dShape >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call btVector3 btConvex2dShape::base_getAnisotropicRollingFrictionDirection() const. Got : '%s'\n%s",typeid(Luna< btCollisionShape >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_calculateSerializeBufferSize(lua_State *L) {
		...
		btConvex2dShape* self=Luna< btCollisionShape >::checkSubType< btConvex2dShape >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call int btConvex2dShape::base_calculateSerializeBufferSize() const. Got : '%s'\n%s",typeid(Luna< btCollisionShape >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_project(lua_State *L) {
		...
		btConvex2dShape* self=Luna< btCollisionShape >::checkSubType< btConvex2dShape >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void btConvex2dShape::base_project(const btTransform &, const btVector3 &, float &, float &) const. Got : '%s'\n%s",typeid(Luna< btCollisionShape >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_localGetSupportingVertexWithoutMargin(lua_State *L) {
		...
		btConvex2dShape* self=Luna< btCollisionShape >::checkSubType< btConvex2dShape >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call btVector3 btConvex2dShape::base_localGetSupportingVertexWithoutMargin(const btVector3 &) const. Got : '%s'\n%s",typeid(Luna< btCollisionShape >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_localGetSupportingVertex(lua_State *L) {
		...
		btConvex2dShape* self=Luna< btCollisionShape >::checkSubType< btConvex2dShape >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call btVector3 btConvex2dShape::base_localGetSupportingVertex(const btVector3 &) const. Got : '%s'\n%s",typeid(Luna< btCollisionShape >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_batchedUnitVectorGetSupportingVertexWithoutMargin(lua_State *L) {
		...
		btConvex2dShape* self=Luna< btCollisionShape >::checkSubType< btConvex2dShape >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void btConvex2dShape::base_batchedUnitVectorGetSupportingVertexWithoutMargin(const btVector3 *, btVector3 *, int) const. Got : '%s'\n%s",typeid(Luna< btCollisionShape >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_calculateLocalInertia(lua_State *L) {
		...
		btConvex2dShape* self=Luna< btCollisionShape >::checkSubType< btConvex2dShape >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void btConvex2dShape::base_calculateLocalInertia(float, btVector3 &) const. Got : '%s'\n%s",typeid(Luna< btCollisionShape >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_getName(lua_State *L) {
		...
		btConvex2dShape* self=Luna< btCollisionShape >::checkSubType< btConvex2dShape >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call const char * btConvex2dShape::base_getName() const. Got : '%s'\n%s",typeid(Luna< btCollisionShape >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_getAabb(lua_State *L) {
		...
		btConvex2dShape* self=Luna< btCollisionShape >::checkSubType< btConvex2dShape >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void btConvex2dShape::base_getAabb(const btTransform &, btVector3 &, btVector3 &) const. Got : '%s'\n%s",typeid(Luna< btCollisionShape >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_getAabbSlow(lua_State *L) {
		...
		btConvex2dShape* self=Luna< btCollisionShape >::checkSubType< btConvex2dShape >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void btConvex2dShape::base_getAabbSlow(const btTransform &, btVector3 &, btVector3 &) const. Got : '%s'\n%s",typeid(Luna< btCollisionShape >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_setLocalScaling(lua_State *L) {
		...
		btConvex2dShape* self=Luna< btCollisionShape >::checkSubType< btConvex2dShape >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void btConvex2dShape::base_setLocalScaling(const btVector3 &). Got : '%s'\n%s",typeid(Luna< btCollisionShape >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_getLocalScaling(lua_State *L) {
		...
		btConvex2dShape* self=Luna< btCollisionShape >::checkSubType< btConvex2dShape >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call const btVector3 & btConvex2dShape::base_getLocalScaling() const. Got : '%s'\n%s",typeid(Luna< btCollisionShape >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_setMargin(lua_State *L) {
		...
		btConvex2dShape* self=Luna< btCollisionShape >::checkSubType< btConvex2dShape >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void btConvex2dShape::base_setMargin(float). Got : '%s'\n%s",typeid(Luna< btCollisionShape >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_getMargin(lua_State *L) {
		...
		btConvex2dShape* self=Luna< btCollisionShape >::checkSubType< btConvex2dShape >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call float btConvex2dShape::base_getMargin() const. Got : '%s'\n%s",typeid(Luna< btCollisionShape >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_getNumPreferredPenetrationDirections(lua_State *L) {
		...
		btConvex2dShape* self=Luna< btCollisionShape >::checkSubType< btConvex2dShape >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call int btConvex2dShape::base_getNumPreferredPenetrationDirections() const. Got : '%s'\n%s",typeid(Luna< btCollisionShape >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_getPreferredPenetrationDirection(lua_State *L) {
		...
		btConvex2dShape* self=Luna< btCollisionShape >::checkSubType< btConvex2dShape >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void btConvex2dShape::base_getPreferredPenetrationDirection(int, btVector3 &) const. Got : '%s'\n%s",typeid(Luna< btCollisionShape >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
...
luna_RegType LunaTraits< btConvex2dShape >::methods[] = {
	...
	{"fromVoid", &luna_wrapper_btConvex2dShape::_bind_fromVoid},
	{"asVoid", &luna_wrapper_btConvex2dShape::_bind_asVoid},
