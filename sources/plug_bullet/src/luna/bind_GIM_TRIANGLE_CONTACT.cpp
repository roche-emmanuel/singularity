...
public:
	...
	static int _bind_fromVoid(lua_State *L) {
		...
		Luna< GIM_TRIANGLE_CONTACT >::push(L,self,false);
		return 1;
	}
...
luna_RegType LunaTraits< GIM_TRIANGLE_CONTACT >::methods[] = {
	...
	{"fromVoid", &luna_wrapper_GIM_TRIANGLE_CONTACT::_bind_fromVoid},
	{"asVoid", &luna_wrapper_GIM_TRIANGLE_CONTACT::_bind_asVoid},
	{0,0}
};
