...
public:
	...
	static int _bind_fromVoid(lua_State *L) {
		...
		Luna< BT_BOX_BOX_TRANSFORM_CACHE >::push(L,self,false);
		return 1;
	}
...
luna_RegType LunaTraits< BT_BOX_BOX_TRANSFORM_CACHE >::methods[] = {
	...
	{"fromVoid", &luna_wrapper_BT_BOX_BOX_TRANSFORM_CACHE::_bind_fromVoid},
	{"asVoid", &luna_wrapper_BT_BOX_BOX_TRANSFORM_CACHE::_bind_asVoid},
	{0,0}
};
