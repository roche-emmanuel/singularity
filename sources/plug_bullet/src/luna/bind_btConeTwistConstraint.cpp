...
public:
	...
	static int _bind_buildJacobian(lua_State *L) {
		...
		if(!self) {
			luaL_error(L, "Invalid object in function call void btConeTwistConstraint::buildJacobian(). Got : '%s'\n%s",typeid(Luna< btTypedObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
		self->buildJacobian();
	...
	static int _bind_getInfo1(lua_State *L) {
		...
		btConeTwistConstraint* self=Luna< btTypedObject >::checkSubType< btConeTwistConstraint >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void btConeTwistConstraint::getInfo1(btTypedConstraint::btConstraintInfo1 *). Got : '%s'\n%s",typeid(Luna< btTypedObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
		self->getInfo1(info);
	...
	static int _bind_getInfo1NonVirtual(lua_State *L) {
		...
		btConeTwistConstraint* self=Luna< btTypedObject >::checkSubType< btConeTwistConstraint >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void btConeTwistConstraint::getInfo1NonVirtual(btTypedConstraint::btConstraintInfo1 *). Got : '%s'\n%s",typeid(Luna< btTypedObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_getInfo2(lua_State *L) {
		...
		btConeTwistConstraint* self=Luna< btTypedObject >::checkSubType< btConeTwistConstraint >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void btConeTwistConstraint::getInfo2(btTypedConstraint::btConstraintInfo2 *). Got : '%s'\n%s",typeid(Luna< btTypedObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
		self->getInfo2(info);
	...
	static int _bind_getInfo2NonVirtual(lua_State *L) {
		...
		btConeTwistConstraint* self=Luna< btTypedObject >::checkSubType< btConeTwistConstraint >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void btConeTwistConstraint::getInfo2NonVirtual(btTypedConstraint::btConstraintInfo2 *, const btTransform &, const btTransform &, const btMatrix3x3 &, const btMatrix3x3 &). Got : '%s'\n%s",typeid(Luna< btTypedObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_solveConstraintObsolete(lua_State *L) {
		...
		btConeTwistConstraint* self=Luna< btTypedObject >::checkSubType< btConeTwistConstraint >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void btConeTwistConstraint::solveConstraintObsolete(btSolverBody &, btSolverBody &, float). Got : '%s'\n%s",typeid(Luna< btTypedObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_updateRHS(lua_State *L) {
		...
		btConeTwistConstraint* self=Luna< btTypedObject >::checkSubType< btConeTwistConstraint >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void btConeTwistConstraint::updateRHS(float). Got : '%s'\n%s",typeid(Luna< btTypedObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_getRigidBodyA(lua_State *L) {
		...
		btConeTwistConstraint* self=Luna< btTypedObject >::checkSubType< btConeTwistConstraint >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call const btRigidBody & btConeTwistConstraint::getRigidBodyA() const. Got : '%s'\n%s",typeid(Luna< btTypedObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_getRigidBodyB(lua_State *L) {
		...
		btConeTwistConstraint* self=Luna< btTypedObject >::checkSubType< btConeTwistConstraint >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call const btRigidBody & btConeTwistConstraint::getRigidBodyB() const. Got : '%s'\n%s",typeid(Luna< btTypedObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_setAngularOnly(lua_State *L) {
		...
		btConeTwistConstraint* self=Luna< btTypedObject >::checkSubType< btConeTwistConstraint >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void btConeTwistConstraint::setAngularOnly(bool). Got : '%s'\n%s",typeid(Luna< btTypedObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_setLimit_overload_1(lua_State *L) {
		...
		btConeTwistConstraint* self=Luna< btTypedObject >::checkSubType< btConeTwistConstraint >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void btConeTwistConstraint::setLimit(int, float). Got : '%s'\n%s",typeid(Luna< btTypedObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_setLimit_overload_2(lua_State *L) {
		...
		btConeTwistConstraint* self=Luna< btTypedObject >::checkSubType< btConeTwistConstraint >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void btConeTwistConstraint::setLimit(float, float, float, float, float, float). Got : '%s'\n%s",typeid(Luna< btTypedObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_getAFrame(lua_State *L) {
		...
		btConeTwistConstraint* self=Luna< btTypedObject >::checkSubType< btConeTwistConstraint >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call const btTransform & btConeTwistConstraint::getAFrame(). Got : '%s'\n%s",typeid(Luna< btTypedObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_getBFrame(lua_State *L) {
		...
		btConeTwistConstraint* self=Luna< btTypedObject >::checkSubType< btConeTwistConstraint >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call const btTransform & btConeTwistConstraint::getBFrame(). Got : '%s'\n%s",typeid(Luna< btTypedObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_getSolveTwistLimit(lua_State *L) {
		...
		btConeTwistConstraint* self=Luna< btTypedObject >::checkSubType< btConeTwistConstraint >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call int btConeTwistConstraint::getSolveTwistLimit(). Got : '%s'\n%s",typeid(Luna< btTypedObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_getSolveSwingLimit(lua_State *L) {
		...
		btConeTwistConstraint* self=Luna< btTypedObject >::checkSubType< btConeTwistConstraint >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call int btConeTwistConstraint::getSolveSwingLimit(). Got : '%s'\n%s",typeid(Luna< btTypedObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_getTwistLimitSign(lua_State *L) {
		...
		btConeTwistConstraint* self=Luna< btTypedObject >::checkSubType< btConeTwistConstraint >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call float btConeTwistConstraint::getTwistLimitSign(). Got : '%s'\n%s",typeid(Luna< btTypedObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_calcAngleInfo(lua_State *L) {
		...
		btConeTwistConstraint* self=Luna< btTypedObject >::checkSubType< btConeTwistConstraint >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void btConeTwistConstraint::calcAngleInfo(). Got : '%s'\n%s",typeid(Luna< btTypedObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
		self->calcAngleInfo();
	...
	static int _bind_calcAngleInfo2(lua_State *L) {
		...
		btConeTwistConstraint* self=Luna< btTypedObject >::checkSubType< btConeTwistConstraint >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void btConeTwistConstraint::calcAngleInfo2(const btTransform &, const btTransform &, const btMatrix3x3 &, const btMatrix3x3 &). Got : '%s'\n%s",typeid(Luna< btTypedObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_getSwingSpan1(lua_State *L) {
		...
		btConeTwistConstraint* self=Luna< btTypedObject >::checkSubType< btConeTwistConstraint >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call float btConeTwistConstraint::getSwingSpan1(). Got : '%s'\n%s",typeid(Luna< btTypedObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_getSwingSpan2(lua_State *L) {
		...
		btConeTwistConstraint* self=Luna< btTypedObject >::checkSubType< btConeTwistConstraint >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call float btConeTwistConstraint::getSwingSpan2(). Got : '%s'\n%s",typeid(Luna< btTypedObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_getTwistSpan(lua_State *L) {
		...
		btConeTwistConstraint* self=Luna< btTypedObject >::checkSubType< btConeTwistConstraint >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call float btConeTwistConstraint::getTwistSpan(). Got : '%s'\n%s",typeid(Luna< btTypedObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_getTwistAngle(lua_State *L) {
		...
		btConeTwistConstraint* self=Luna< btTypedObject >::checkSubType< btConeTwistConstraint >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call float btConeTwistConstraint::getTwistAngle(). Got : '%s'\n%s",typeid(Luna< btTypedObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_isPastSwingLimit(lua_State *L) {
		...
		btConeTwistConstraint* self=Luna< btTypedObject >::checkSubType< btConeTwistConstraint >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call bool btConeTwistConstraint::isPastSwingLimit(). Got : '%s'\n%s",typeid(Luna< btTypedObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_setDamping(lua_State *L) {
		...
		btConeTwistConstraint* self=Luna< btTypedObject >::checkSubType< btConeTwistConstraint >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void btConeTwistConstraint::setDamping(float). Got : '%s'\n%s",typeid(Luna< btTypedObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_enableMotor(lua_State *L) {
		...
		btConeTwistConstraint* self=Luna< btTypedObject >::checkSubType< btConeTwistConstraint >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void btConeTwistConstraint::enableMotor(bool). Got : '%s'\n%s",typeid(Luna< btTypedObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
		self->enableMotor(b);
	...
	static int _bind_setMaxMotorImpulse(lua_State *L) {
		...
		btConeTwistConstraint* self=Luna< btTypedObject >::checkSubType< btConeTwistConstraint >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void btConeTwistConstraint::setMaxMotorImpulse(float). Got : '%s'\n%s",typeid(Luna< btTypedObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_setMaxMotorImpulseNormalized(lua_State *L) {
		...
		btConeTwistConstraint* self=Luna< btTypedObject >::checkSubType< btConeTwistConstraint >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void btConeTwistConstraint::setMaxMotorImpulseNormalized(float). Got : '%s'\n%s",typeid(Luna< btTypedObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_getFixThresh(lua_State *L) {
		...
		btConeTwistConstraint* self=Luna< btTypedObject >::checkSubType< btConeTwistConstraint >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call float btConeTwistConstraint::getFixThresh(). Got : '%s'\n%s",typeid(Luna< btTypedObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_setFixThresh(lua_State *L) {
		...
		btConeTwistConstraint* self=Luna< btTypedObject >::checkSubType< btConeTwistConstraint >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void btConeTwistConstraint::setFixThresh(float). Got : '%s'\n%s",typeid(Luna< btTypedObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_setMotorTarget(lua_State *L) {
		...
		btConeTwistConstraint* self=Luna< btTypedObject >::checkSubType< btConeTwistConstraint >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void btConeTwistConstraint::setMotorTarget(const btQuaternion &). Got : '%s'\n%s",typeid(Luna< btTypedObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_setMotorTargetInConstraintSpace(lua_State *L) {
		...
		btConeTwistConstraint* self=Luna< btTypedObject >::checkSubType< btConeTwistConstraint >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void btConeTwistConstraint::setMotorTargetInConstraintSpace(const btQuaternion &). Got : '%s'\n%s",typeid(Luna< btTypedObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_GetPointForAngle(lua_State *L) {
		...
		btConeTwistConstraint* self=Luna< btTypedObject >::checkSubType< btConeTwistConstraint >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call btVector3 btConeTwistConstraint::GetPointForAngle(float, float) const. Got : '%s'\n%s",typeid(Luna< btTypedObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_setParam(lua_State *L) {
		...
		btConeTwistConstraint* self=Luna< btTypedObject >::checkSubType< btConeTwistConstraint >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void btConeTwistConstraint::setParam(int, float, int). Got : '%s'\n%s",typeid(Luna< btTypedObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_setFrames(lua_State *L) {
		...
		btConeTwistConstraint* self=Luna< btTypedObject >::checkSubType< btConeTwistConstraint >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void btConeTwistConstraint::setFrames(const btTransform &, const btTransform &). Got : '%s'\n%s",typeid(Luna< btTypedObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_getFrameOffsetA(lua_State *L) {
		...
		btConeTwistConstraint* self=Luna< btTypedObject >::checkSubType< btConeTwistConstraint >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call const btTransform & btConeTwistConstraint::getFrameOffsetA() const. Got : '%s'\n%s",typeid(Luna< btTypedObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_getFrameOffsetB(lua_State *L) {
		...
		btConeTwistConstraint* self=Luna< btTypedObject >::checkSubType< btConeTwistConstraint >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call const btTransform & btConeTwistConstraint::getFrameOffsetB() const. Got : '%s'\n%s",typeid(Luna< btTypedObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_getParam(lua_State *L) {
		...
		btConeTwistConstraint* self=Luna< btTypedObject >::checkSubType< btConeTwistConstraint >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call float btConeTwistConstraint::getParam(int, int) const. Got : '%s'\n%s",typeid(Luna< btTypedObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_calculateSerializeBufferSize(lua_State *L) {
		...
		btConeTwistConstraint* self=Luna< btTypedObject >::checkSubType< btConeTwistConstraint >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call int btConeTwistConstraint::calculateSerializeBufferSize() const. Got : '%s'\n%s",typeid(Luna< btTypedObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_setupSolverConstraint(lua_State *L) {
		...
		btConeTwistConstraint* self=Luna< btTypedObject >::checkSubType< btConeTwistConstraint >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void btConeTwistConstraint::base_setupSolverConstraint(btConstraintArray &, int, int, float). Got : '%s'\n%s",typeid(Luna< btTypedObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_buildJacobian(lua_State *L) {
		...
		btConeTwistConstraint* self=Luna< btTypedObject >::checkSubType< btConeTwistConstraint >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void btConeTwistConstraint::base_buildJacobian(). Got : '%s'\n%s",typeid(Luna< btTypedObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_getInfo1(lua_State *L) {
		...
		btConeTwistConstraint* self=Luna< btTypedObject >::checkSubType< btConeTwistConstraint >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void btConeTwistConstraint::base_getInfo1(btTypedConstraint::btConstraintInfo1 *). Got : '%s'\n%s",typeid(Luna< btTypedObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_getInfo2(lua_State *L) {
		...
		btConeTwistConstraint* self=Luna< btTypedObject >::checkSubType< btConeTwistConstraint >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void btConeTwistConstraint::base_getInfo2(btTypedConstraint::btConstraintInfo2 *). Got : '%s'\n%s",typeid(Luna< btTypedObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_solveConstraintObsolete(lua_State *L) {
		...
		btConeTwistConstraint* self=Luna< btTypedObject >::checkSubType< btConeTwistConstraint >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void btConeTwistConstraint::base_solveConstraintObsolete(btSolverBody &, btSolverBody &, float). Got : '%s'\n%s",typeid(Luna< btTypedObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_setParam(lua_State *L) {
		...
		btConeTwistConstraint* self=Luna< btTypedObject >::checkSubType< btConeTwistConstraint >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void btConeTwistConstraint::base_setParam(int, float, int). Got : '%s'\n%s",typeid(Luna< btTypedObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_setFrames(lua_State *L) {
		...
		btConeTwistConstraint* self=Luna< btTypedObject >::checkSubType< btConeTwistConstraint >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void btConeTwistConstraint::base_setFrames(const btTransform &, const btTransform &). Got : '%s'\n%s",typeid(Luna< btTypedObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_getParam(lua_State *L) {
		...
		btConeTwistConstraint* self=Luna< btTypedObject >::checkSubType< btConeTwistConstraint >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call float btConeTwistConstraint::base_getParam(int, int) const. Got : '%s'\n%s",typeid(Luna< btTypedObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_calculateSerializeBufferSize(lua_State *L) {
		...
		btConeTwistConstraint* self=Luna< btTypedObject >::checkSubType< btConeTwistConstraint >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call int btConeTwistConstraint::base_calculateSerializeBufferSize() const. Got : '%s'\n%s",typeid(Luna< btTypedObject >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
