...
public:
	...
	static int _bind_fromVoid(lua_State *L) {
		...
		Luna< btContinuousConvexCollision >::push(L,self,false);
		return 1;
	}
...
luna_RegType LunaTraits< btContinuousConvexCollision >::methods[] = {
	...
	{"fromVoid", &luna_wrapper_btContinuousConvexCollision::_bind_fromVoid},
	{"asVoid", &luna_wrapper_btContinuousConvexCollision::_bind_asVoid},
