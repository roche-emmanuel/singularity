...
public:
	...
	static int _bind_fromVoid(lua_State *L) {
		...
		Luna< btStridingMeshInterfaceData >::push(L,self,false);
		return 1;
	}
...
luna_RegType LunaTraits< btStridingMeshInterfaceData >::methods[] = {
	...
	{"fromVoid", &luna_wrapper_btStridingMeshInterfaceData::_bind_fromVoid},
	{"asVoid", &luna_wrapper_btStridingMeshInterfaceData::_bind_asVoid},
	{0,0}
};
