...
public:
	...
	static int _bind___eq(lua_State *L) {
		if (!_lg_typecheck___eq(L)) {
			luaL_error(L, "luna typecheck failed in __eq function, expected prototype:\n__eq(btGenericPoolAllocator*). Got arguments:\n%s",luna_dumpStack(L).c_str());
		}
	...
	static int _bind_fromVoid(lua_State *L) {
		...
		btGenericPoolAllocator* self= (btGenericPoolAllocator*)(Luna< void >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call fromVoid(...)");
		}
		
		Luna< btGenericPoolAllocator >::push(L,self,false);
		return 1;
	}
	...
	static int _bind_asVoid(lua_State *L) {
		...
		void* self= (void*)(Luna< btGenericPoolAllocator >::check(L,1));
		if(!self) {
	...
	static int _bind_get_pool_capacity(lua_State *L) {
		...
		btGenericPoolAllocator* self=(Luna< btGenericPoolAllocator >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call size_t btGenericPoolAllocator::get_pool_capacity(). Got : '%s'\n%s",typeid(Luna< btGenericPoolAllocator >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_allocate(lua_State *L) {
		...
		btGenericPoolAllocator* self=(Luna< btGenericPoolAllocator >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call void * btGenericPoolAllocator::allocate(size_t). Got : '%s'\n%s",typeid(Luna< btGenericPoolAllocator >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_freeMemory(lua_State *L) {
		...
		btGenericPoolAllocator* self=(Luna< btGenericPoolAllocator >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call bool btGenericPoolAllocator::freeMemory(void *). Got : '%s'\n%s",typeid(Luna< btGenericPoolAllocator >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_get_pool_count(lua_State *L) {
		...
		btGenericPoolAllocator* self=(Luna< btGenericPoolAllocator >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call size_t btGenericPoolAllocator::m_pool_count(). Got : '%s'\n%s",typeid(Luna< btGenericPoolAllocator >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_set_pool_count(lua_State *L) {
		...
		btGenericPoolAllocator* self=(Luna< btGenericPoolAllocator >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call void btGenericPoolAllocator::m_pool_count(size_t). Got : '%s'\n%s",typeid(Luna< btGenericPoolAllocator >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
...
luna_RegType LunaTraits< btGenericPoolAllocator >::methods[] = {
	...
	{"fromVoid", &luna_wrapper_btGenericPoolAllocator::_bind_fromVoid},
	{"asVoid", &luna_wrapper_btGenericPoolAllocator::_bind_asVoid},
