...
public:
	...
	static int _bind___eq(lua_State *L) {
		if (!_lg_typecheck___eq(L)) {
			luaL_error(L, "luna typecheck failed in __eq function, expected prototype:\n__eq(btHingeConstraintDoubleData*). Got arguments:\n%s",luna_dumpStack(L).c_str());
		}
	...
	static int _bind_getTypeConstraintData(lua_State *L) {
		...
		btHingeConstraintDoubleData* self=(Luna< btHingeConstraintDoubleData >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call btTypedConstraintData btHingeConstraintDoubleData::m_typeConstraintData(). Got : '%s'\n%s",typeid(Luna< btHingeConstraintDoubleData >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_getRbAFrame(lua_State *L) {
		...
		btHingeConstraintDoubleData* self=(Luna< btHingeConstraintDoubleData >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call btTransformDoubleData btHingeConstraintDoubleData::m_rbAFrame(). Got : '%s'\n%s",typeid(Luna< btHingeConstraintDoubleData >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_getRbBFrame(lua_State *L) {
		...
		btHingeConstraintDoubleData* self=(Luna< btHingeConstraintDoubleData >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call btTransformDoubleData btHingeConstraintDoubleData::m_rbBFrame(). Got : '%s'\n%s",typeid(Luna< btHingeConstraintDoubleData >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_getUseReferenceFrameA(lua_State *L) {
		...
		btHingeConstraintDoubleData* self=(Luna< btHingeConstraintDoubleData >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call int btHingeConstraintDoubleData::m_useReferenceFrameA(). Got : '%s'\n%s",typeid(Luna< btHingeConstraintDoubleData >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_getAngularOnly(lua_State *L) {
		...
		btHingeConstraintDoubleData* self=(Luna< btHingeConstraintDoubleData >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call int btHingeConstraintDoubleData::m_angularOnly(). Got : '%s'\n%s",typeid(Luna< btHingeConstraintDoubleData >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_getEnableAngularMotor(lua_State *L) {
		...
		btHingeConstraintDoubleData* self=(Luna< btHingeConstraintDoubleData >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call int btHingeConstraintDoubleData::m_enableAngularMotor(). Got : '%s'\n%s",typeid(Luna< btHingeConstraintDoubleData >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_getMotorTargetVelocity(lua_State *L) {
		...
		btHingeConstraintDoubleData* self=(Luna< btHingeConstraintDoubleData >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call float btHingeConstraintDoubleData::m_motorTargetVelocity(). Got : '%s'\n%s",typeid(Luna< btHingeConstraintDoubleData >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_getMaxMotorImpulse(lua_State *L) {
		...
		btHingeConstraintDoubleData* self=(Luna< btHingeConstraintDoubleData >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call float btHingeConstraintDoubleData::m_maxMotorImpulse(). Got : '%s'\n%s",typeid(Luna< btHingeConstraintDoubleData >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_getLowerLimit(lua_State *L) {
		...
		btHingeConstraintDoubleData* self=(Luna< btHingeConstraintDoubleData >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call float btHingeConstraintDoubleData::m_lowerLimit(). Got : '%s'\n%s",typeid(Luna< btHingeConstraintDoubleData >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_getUpperLimit(lua_State *L) {
		...
		btHingeConstraintDoubleData* self=(Luna< btHingeConstraintDoubleData >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call float btHingeConstraintDoubleData::m_upperLimit(). Got : '%s'\n%s",typeid(Luna< btHingeConstraintDoubleData >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_getLimitSoftness(lua_State *L) {
		...
		btHingeConstraintDoubleData* self=(Luna< btHingeConstraintDoubleData >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call float btHingeConstraintDoubleData::m_limitSoftness(). Got : '%s'\n%s",typeid(Luna< btHingeConstraintDoubleData >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_getBiasFactor(lua_State *L) {
		...
		btHingeConstraintDoubleData* self=(Luna< btHingeConstraintDoubleData >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call float btHingeConstraintDoubleData::m_biasFactor(). Got : '%s'\n%s",typeid(Luna< btHingeConstraintDoubleData >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_getRelaxationFactor(lua_State *L) {
		...
		btHingeConstraintDoubleData* self=(Luna< btHingeConstraintDoubleData >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call float btHingeConstraintDoubleData::m_relaxationFactor(). Got : '%s'\n%s",typeid(Luna< btHingeConstraintDoubleData >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_setTypeConstraintData(lua_State *L) {
		...
		btHingeConstraintDoubleData* self=(Luna< btHingeConstraintDoubleData >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call void btHingeConstraintDoubleData::m_typeConstraintData(btTypedConstraintData). Got : '%s'\n%s",typeid(Luna< btHingeConstraintDoubleData >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_setRbAFrame(lua_State *L) {
		...
		btHingeConstraintDoubleData* self=(Luna< btHingeConstraintDoubleData >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call void btHingeConstraintDoubleData::m_rbAFrame(btTransformDoubleData). Got : '%s'\n%s",typeid(Luna< btHingeConstraintDoubleData >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_setRbBFrame(lua_State *L) {
		...
		btHingeConstraintDoubleData* self=(Luna< btHingeConstraintDoubleData >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call void btHingeConstraintDoubleData::m_rbBFrame(btTransformDoubleData). Got : '%s'\n%s",typeid(Luna< btHingeConstraintDoubleData >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_setUseReferenceFrameA(lua_State *L) {
		...
		btHingeConstraintDoubleData* self=(Luna< btHingeConstraintDoubleData >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call void btHingeConstraintDoubleData::m_useReferenceFrameA(int). Got : '%s'\n%s",typeid(Luna< btHingeConstraintDoubleData >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_setAngularOnly(lua_State *L) {
		...
		btHingeConstraintDoubleData* self=(Luna< btHingeConstraintDoubleData >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call void btHingeConstraintDoubleData::m_angularOnly(int). Got : '%s'\n%s",typeid(Luna< btHingeConstraintDoubleData >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_setEnableAngularMotor(lua_State *L) {
		...
		btHingeConstraintDoubleData* self=(Luna< btHingeConstraintDoubleData >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call void btHingeConstraintDoubleData::m_enableAngularMotor(int). Got : '%s'\n%s",typeid(Luna< btHingeConstraintDoubleData >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_setMotorTargetVelocity(lua_State *L) {
		...
		btHingeConstraintDoubleData* self=(Luna< btHingeConstraintDoubleData >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call void btHingeConstraintDoubleData::m_motorTargetVelocity(float). Got : '%s'\n%s",typeid(Luna< btHingeConstraintDoubleData >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_setMaxMotorImpulse(lua_State *L) {
		...
		btHingeConstraintDoubleData* self=(Luna< btHingeConstraintDoubleData >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call void btHingeConstraintDoubleData::m_maxMotorImpulse(float). Got : '%s'\n%s",typeid(Luna< btHingeConstraintDoubleData >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_setLowerLimit(lua_State *L) {
		...
		btHingeConstraintDoubleData* self=(Luna< btHingeConstraintDoubleData >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call void btHingeConstraintDoubleData::m_lowerLimit(float). Got : '%s'\n%s",typeid(Luna< btHingeConstraintDoubleData >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_setUpperLimit(lua_State *L) {
		...
		btHingeConstraintDoubleData* self=(Luna< btHingeConstraintDoubleData >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call void btHingeConstraintDoubleData::m_upperLimit(float). Got : '%s'\n%s",typeid(Luna< btHingeConstraintDoubleData >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_setLimitSoftness(lua_State *L) {
		...
		btHingeConstraintDoubleData* self=(Luna< btHingeConstraintDoubleData >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call void btHingeConstraintDoubleData::m_limitSoftness(float). Got : '%s'\n%s",typeid(Luna< btHingeConstraintDoubleData >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_setBiasFactor(lua_State *L) {
		...
		btHingeConstraintDoubleData* self=(Luna< btHingeConstraintDoubleData >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call void btHingeConstraintDoubleData::m_biasFactor(float). Got : '%s'\n%s",typeid(Luna< btHingeConstraintDoubleData >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_setRelaxationFactor(lua_State *L) {
		...
		btHingeConstraintDoubleData* self=(Luna< btHingeConstraintDoubleData >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call void btHingeConstraintDoubleData::m_relaxationFactor(float). Got : '%s'\n%s",typeid(Luna< btHingeConstraintDoubleData >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
