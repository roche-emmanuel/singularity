...
public:
	...
	static int _bind_fromVoid(lua_State *L) {
		...
		btBox2dBox2dCollisionAlgorithm::CreateFunc* self= (btBox2dBox2dCollisionAlgorithm::CreateFunc*)(Luna< void >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call fromVoid(...)");
		}
		
		Luna< btBox2dBox2dCollisionAlgorithm::CreateFunc >::push(L,self,false);
		return 1;
	}
	...
	static int _bind_CreateCollisionAlgorithm(lua_State *L) {
		...
		if(!self) {
			luaL_error(L, "Invalid object in function call btCollisionAlgorithm * btBox2dBox2dCollisionAlgorithm::CreateFunc::CreateCollisionAlgorithm(btCollisionAlgorithmConstructionInfo &, const btCollisionObjectWrapper *, const btCollisionObjectWrapper *). Got : '%s'\n%s",typeid(Luna< btCollisionAlgorithmCreateFunc >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_CreateCollisionAlgorithm(lua_State *L) {
		...
		btBox2dBox2dCollisionAlgorithm::CreateFunc* self=Luna< btCollisionAlgorithmCreateFunc >::checkSubType< btBox2dBox2dCollisionAlgorithm::CreateFunc >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call btCollisionAlgorithm * btBox2dBox2dCollisionAlgorithm::CreateFunc::base_CreateCollisionAlgorithm(btCollisionAlgorithmConstructionInfo &, const btCollisionObjectWrapper *, const btCollisionObjectWrapper *). Got : '%s'\n%s",typeid(Luna< btCollisionAlgorithmCreateFunc >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
...
const char LunaTraits< btBox2dBox2dCollisionAlgorithm::CreateFunc >::moduleName[] = "bullet";
...
luna_RegType LunaTraits< btBox2dBox2dCollisionAlgorithm::CreateFunc >::methods[] = {
	...
	{"fromVoid", &luna_wrapper_btBox2dBox2dCollisionAlgorithm_CreateFunc::_bind_fromVoid},
	{"asVoid", &luna_wrapper_btBox2dBox2dCollisionAlgorithm_CreateFunc::_bind_asVoid},
