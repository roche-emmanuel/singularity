...
public:
	...
	static int _bind_fromVoid(lua_State *L) {
		...
		Luna< btGImpactCompoundShape::CompoundPrimitiveManager >::push(L,self,false);
		return 1;
	}
...
luna_RegType LunaTraits< btGImpactCompoundShape::CompoundPrimitiveManager >::methods[] = {
	...
	{"fromVoid", &luna_wrapper_btGImpactCompoundShape_CompoundPrimitiveManager::_bind_fromVoid},
	{"asVoid", &luna_wrapper_btGImpactCompoundShape_CompoundPrimitiveManager::_bind_asVoid},
