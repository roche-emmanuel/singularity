...
public:
	...
	static int _bind_CreateCollisionAlgorithm(lua_State *L) {
		...
		if(!self) {
			luaL_error(L, "Invalid object in function call btCollisionAlgorithm * btConvexConvexAlgorithm::CreateFunc::CreateCollisionAlgorithm(btCollisionAlgorithmConstructionInfo &, const btCollisionObjectWrapper *, const btCollisionObjectWrapper *). Got : '%s'\n%s",typeid(Luna< btCollisionAlgorithmCreateFunc >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_getPdSolver(lua_State *L) {
		...
		btConvexConvexAlgorithm::CreateFunc* self=Luna< btCollisionAlgorithmCreateFunc >::checkSubType< btConvexConvexAlgorithm::CreateFunc >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call btConvexPenetrationDepthSolver * btConvexConvexAlgorithm::CreateFunc::m_pdSolver(). Got : '%s'\n%s",typeid(Luna< btCollisionAlgorithmCreateFunc >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_getSimplexSolver(lua_State *L) {
		...
		btConvexConvexAlgorithm::CreateFunc* self=Luna< btCollisionAlgorithmCreateFunc >::checkSubType< btConvexConvexAlgorithm::CreateFunc >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call btVoronoiSimplexSolver * btConvexConvexAlgorithm::CreateFunc::m_simplexSolver(). Got : '%s'\n%s",typeid(Luna< btCollisionAlgorithmCreateFunc >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_getNumPerturbationIterations(lua_State *L) {
		...
		btConvexConvexAlgorithm::CreateFunc* self=Luna< btCollisionAlgorithmCreateFunc >::checkSubType< btConvexConvexAlgorithm::CreateFunc >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call int btConvexConvexAlgorithm::CreateFunc::m_numPerturbationIterations(). Got : '%s'\n%s",typeid(Luna< btCollisionAlgorithmCreateFunc >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_getMinimumPointsPerturbationThreshold(lua_State *L) {
		...
		btConvexConvexAlgorithm::CreateFunc* self=Luna< btCollisionAlgorithmCreateFunc >::checkSubType< btConvexConvexAlgorithm::CreateFunc >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call int btConvexConvexAlgorithm::CreateFunc::m_minimumPointsPerturbationThreshold(). Got : '%s'\n%s",typeid(Luna< btCollisionAlgorithmCreateFunc >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_setPdSolver(lua_State *L) {
		...
		btConvexConvexAlgorithm::CreateFunc* self=Luna< btCollisionAlgorithmCreateFunc >::checkSubType< btConvexConvexAlgorithm::CreateFunc >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void btConvexConvexAlgorithm::CreateFunc::m_pdSolver(btConvexPenetrationDepthSolver *). Got : '%s'\n%s",typeid(Luna< btCollisionAlgorithmCreateFunc >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_setSimplexSolver(lua_State *L) {
		...
		btConvexConvexAlgorithm::CreateFunc* self=Luna< btCollisionAlgorithmCreateFunc >::checkSubType< btConvexConvexAlgorithm::CreateFunc >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void btConvexConvexAlgorithm::CreateFunc::m_simplexSolver(btVoronoiSimplexSolver *). Got : '%s'\n%s",typeid(Luna< btCollisionAlgorithmCreateFunc >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_setNumPerturbationIterations(lua_State *L) {
		...
		btConvexConvexAlgorithm::CreateFunc* self=Luna< btCollisionAlgorithmCreateFunc >::checkSubType< btConvexConvexAlgorithm::CreateFunc >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void btConvexConvexAlgorithm::CreateFunc::m_numPerturbationIterations(int). Got : '%s'\n%s",typeid(Luna< btCollisionAlgorithmCreateFunc >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_setMinimumPointsPerturbationThreshold(lua_State *L) {
		...
		btConvexConvexAlgorithm::CreateFunc* self=Luna< btCollisionAlgorithmCreateFunc >::checkSubType< btConvexConvexAlgorithm::CreateFunc >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void btConvexConvexAlgorithm::CreateFunc::m_minimumPointsPerturbationThreshold(int). Got : '%s'\n%s",typeid(Luna< btCollisionAlgorithmCreateFunc >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	static int _bind_base_CreateCollisionAlgorithm(lua_State *L) {
		...
		btConvexConvexAlgorithm::CreateFunc* self=Luna< btCollisionAlgorithmCreateFunc >::checkSubType< btConvexConvexAlgorithm::CreateFunc >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call btCollisionAlgorithm * btConvexConvexAlgorithm::CreateFunc::base_CreateCollisionAlgorithm(btCollisionAlgorithmConstructionInfo &, const btCollisionObjectWrapper *, const btCollisionObjectWrapper *). Got : '%s'\n%s",typeid(Luna< btCollisionAlgorithmCreateFunc >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
