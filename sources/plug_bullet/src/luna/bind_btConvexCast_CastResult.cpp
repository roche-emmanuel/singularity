...
public:
	...
	static int _bind_fromVoid(lua_State *L) {
		...
		Luna< btConvexCast::CastResult >::push(L,self,false);
		return 1;
	}
...
luna_RegType LunaTraits< btConvexCast::CastResult >::methods[] = {
	...
	{"fromVoid", &luna_wrapper_btConvexCast_CastResult::_bind_fromVoid},
	{"asVoid", &luna_wrapper_btConvexCast_CastResult::_bind_asVoid},
