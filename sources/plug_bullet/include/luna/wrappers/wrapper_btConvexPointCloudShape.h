#ifndef _WRAPPERS_WRAPPER_BTCONVEXPOINTCLOUDSHAPE_H_
#define _WRAPPERS_WRAPPER_BTCONVEXPOINTCLOUDSHAPE_H_
...
class wrapper_btConvexPointCloudShape : public btConvexPointCloudShape, public luna_wrapper_base {

public:
		

	~wrapper_btConvexPointCloudShape() {
		logDEBUG3("Calling delete function for wrapper btConvexPointCloudShape");
		if(_obj.pushFunction("delete")) {
			//_obj.pushArg((btConvexPointCloudShape*)this); // No this argument or the object will be referenced again!
			_obj.callFunction<void>();
		}
	};
	
	wrapper_btConvexPointCloudShape(lua_State* L, lua_Table* dum) 
		: btConvexPointCloudShape(), luna_wrapper_base(L) { 
		register_protected_methods(L); 
		if(_obj.pushFunction("buildInstance")) {
			_obj.pushArg((btConvexPointCloudShape*)this);
			_obj.callFunction<void>();
		}
	};
	wrapper_btConvexPointCloudShape(lua_State* L, lua_Table* dum, btVector3 * points, int numPoints, const btVector3 & localScaling, bool computeAabb = true) 
		: btConvexPointCloudShape(points, numPoints, localScaling, computeAabb), luna_wrapper_base(L) { 
		register_protected_methods(L);
		if(_obj.pushFunction("buildInstance")) {
			_obj.pushArg((btConvexPointCloudShape*)this);
			_obj.callFunction<void>();
	...
	void getBoundingSphere(btVector3 & center, float & radius) const {
		...
		return btConvexPointCloudShape::getBoundingSphere(center, radius);
	};
	...
	float getAngularMotionDisc() const {
		...
		return btConvexPointCloudShape::getAngularMotionDisc();
	};
	...
	float getContactBreakingThreshold(float defaultContactThresholdFactor) const {
		...
		return btConvexPointCloudShape::getContactBreakingThreshold(defaultContactThresholdFactor);
	};
	...
	btVector3 getAnisotropicRollingFrictionDirection() const {
		...
		return btConvexPointCloudShape::getAnisotropicRollingFrictionDirection();
	};
	...
	void project(const btTransform & trans, const btVector3 & dir, float & min, float & max) const {
		...
		return btConvexPointCloudShape::project(trans, dir, min, max);
	};
	...
	void getAabbSlow(const btTransform & t, btVector3 & aabbMin, btVector3 & aabbMax) const {
		...
		return btConvexPointCloudShape::getAabbSlow(t, aabbMin, aabbMax);
	};
	...
	const btVector3 & getLocalScaling() const {
		...
		return btConvexPointCloudShape::getLocalScaling();
	};
	...
	void setMargin(float margin) {
		...
		return btConvexPointCloudShape::setMargin(margin);
	};
	...
	float getMargin() const {
		...
		return btConvexPointCloudShape::getMargin();
	};
	...
	int getNumPreferredPenetrationDirections() const {
		...
		return btConvexPointCloudShape::getNumPreferredPenetrationDirections();
	};
	...
	void getPreferredPenetrationDirection(int index, btVector3 & penetrationVector) const {
		...
		return btConvexPointCloudShape::getPreferredPenetrationDirection(index, penetrationVector);
	};
	...
	int calculateSerializeBufferSize() const {
		...
		return btConvexPointCloudShape::calculateSerializeBufferSize();
	};
	...
	bool initializePolyhedralFeatures(int shiftVerticesByMargin = 0) {
		...
		return btConvexPointCloudShape::initializePolyhedralFeatures(shiftVerticesByMargin);
	};
	...
	void calculateLocalInertia(float mass, btVector3 & inertia) const {
		...
		return btConvexPointCloudShape::calculateLocalInertia(mass, inertia);
	};
	...
	void getAabb(const btTransform & t, btVector3 & aabbMin, btVector3 & aabbMax) const {
		...
		return btConvexPointCloudShape::getAabb(t, aabbMin, aabbMax);
	};
	...
	btVector3 localGetSupportingVertex(const btVector3 & vec) const {
		...
		return btConvexPointCloudShape::localGetSupportingVertex(vec);
	};
	...
	btVector3 localGetSupportingVertexWithoutMargin(const btVector3 & vec) const {
		...
		return btConvexPointCloudShape::localGetSupportingVertexWithoutMargin(vec);
	};
	...
	void batchedUnitVectorGetSupportingVertexWithoutMargin(const btVector3 * vectors, btVector3 * supportVerticesOut, int numVectors) const {
		...
		return btConvexPointCloudShape::batchedUnitVectorGetSupportingVertexWithoutMargin(vectors, supportVerticesOut, numVectors);
	};
	...
	const char * getName() const {
		...
		return btConvexPointCloudShape::getName();
	};
	...
	int getNumVertices() const {
		...
		return btConvexPointCloudShape::getNumVertices();
	};
	...
	int getNumEdges() const {
		...
		return btConvexPointCloudShape::getNumEdges();
	};
	...
	void getEdge(int i, btVector3 & pa, btVector3 & pb) const {
		...
		return btConvexPointCloudShape::getEdge(i, pa, pb);
	};
	...
	void getVertex(int i, btVector3 & vtx) const {
		...
		return btConvexPointCloudShape::getVertex(i, vtx);
	};
	...
	int getNumPlanes() const {
		...
		return btConvexPointCloudShape::getNumPlanes();
	};
	...
	void getPlane(btVector3 & planeNormal, btVector3 & planeSupport, int i) const {
		...
		return btConvexPointCloudShape::getPlane(planeNormal, planeSupport, i);
	};
	...
	bool isInside(const btVector3 & pt, float tolerance) const {
		...
		return btConvexPointCloudShape::isInside(pt, tolerance);
	};
	...
	void setLocalScaling(const btVector3 & scaling) {
		...
		return btConvexPointCloudShape::setLocalScaling(scaling);
	};
	...
	static int _bind_public_setCachedLocalAabb(lua_State *L) {
		...
		wrapper_btConvexPointCloudShape* self=Luna< btCollisionShape >::checkSubType< wrapper_btConvexPointCloudShape >(L,1);
		if(!self) {
			luna_printStack(L);
