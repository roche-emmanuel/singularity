#ifndef _WRAPPERS_WRAPPER_BTGENERIC_DOFCONSTRAINT_H_
#define _WRAPPERS_WRAPPER_BTGENERIC_DOFCONSTRAINT_H_
...
class wrapper_btGeneric6DofConstraint : public btGeneric6DofConstraint, public luna_wrapper_base {

public:
		

	~wrapper_btGeneric6DofConstraint() {
		logDEBUG3("Calling delete function for wrapper btGeneric6DofConstraint");
		if(_obj.pushFunction("delete")) {
			//_obj.pushArg((btGeneric6DofConstraint*)this); // No this argument or the object will be referenced again!
			_obj.callFunction<void>();
		}
	};
	
	wrapper_btGeneric6DofConstraint(lua_State* L, lua_Table* dum, btRigidBody & rbA, btRigidBody & rbB, const btTransform & frameInA, const btTransform & frameInB, bool useLinearReferenceFrameA) 
		: btGeneric6DofConstraint(rbA, rbB, frameInA, frameInB, useLinearReferenceFrameA), luna_wrapper_base(L) { 
		register_protected_methods(L);
		if(_obj.pushFunction("buildInstance")) {
			_obj.pushArg((btGeneric6DofConstraint*)this);
			_obj.callFunction<void>();
		}
	};
	wrapper_btGeneric6DofConstraint(lua_State* L, lua_Table* dum, btRigidBody & rbB, const btTransform & frameInB, bool useLinearReferenceFrameB) 
		: btGeneric6DofConstraint(rbB, frameInB, useLinearReferenceFrameB), luna_wrapper_base(L) { 
		register_protected_methods(L);
		if(_obj.pushFunction("buildInstance")) {
			_obj.pushArg((btGeneric6DofConstraint*)this);
			_obj.callFunction<void>();
	...
	void setupSolverConstraint(btConstraintArray & ca, int solverBodyA, int solverBodyB, float timeStep) {
		...
		return btGeneric6DofConstraint::setupSolverConstraint(ca, solverBodyA, solverBodyB, timeStep);
	};
	...
	void solveConstraintObsolete(btSolverBody & arg1, btSolverBody & arg2, float arg3) {
		...
		return btGeneric6DofConstraint::solveConstraintObsolete(arg1, arg2, arg3);
	};
	...
	void buildJacobian() {
		...
		return btGeneric6DofConstraint::buildJacobian();
	};
	...
	void getInfo1(btTypedConstraint::btConstraintInfo1 * info) {
		...
		return btGeneric6DofConstraint::getInfo1(info);
	};
	...
	void getInfo2(btTypedConstraint::btConstraintInfo2 * info) {
		...
		return btGeneric6DofConstraint::getInfo2(info);
	};
	...
	void calcAnchorPos() {
		...
		return btGeneric6DofConstraint::calcAnchorPos();
	};
	...
	void setParam(int num, float value, int axis = -1) {
		...
		return btGeneric6DofConstraint::setParam(num, value, axis);
	};
	...
	float getParam(int num, int axis = -1) const {
		...
		return btGeneric6DofConstraint::getParam(num, axis);
	};
	...
	int calculateSerializeBufferSize() const {
		...
		return btGeneric6DofConstraint::calculateSerializeBufferSize();
	};
	...
	static int _bind_public_setAngularLimits(lua_State *L) {
		...
		wrapper_btGeneric6DofConstraint* self=Luna< btTypedObject >::checkSubType< wrapper_btGeneric6DofConstraint >(L,1);
		if(!self) {
			luna_printStack(L);
