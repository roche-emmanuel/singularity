#ifndef _WRAPPERS_WRAPPER_BT_BITAXISSWEEP__H_
#define _WRAPPERS_WRAPPER_BT_BITAXISSWEEP__H_
...
class wrapper_bt32BitAxisSweep3 : public bt32BitAxisSweep3, public luna_wrapper_base {

public:
		

	~wrapper_bt32BitAxisSweep3() {
		logDEBUG3("Calling delete function for wrapper bt32BitAxisSweep3");
		if(_obj.pushFunction("delete")) {
			//_obj.pushArg((bt32BitAxisSweep3*)this); // No this argument or the object will be referenced again!
			_obj.callFunction<void>();
		}
	};
	
	wrapper_bt32BitAxisSweep3(lua_State* L, lua_Table* dum, const btVector3 & worldAabbMin, const btVector3 & worldAabbMax, unsigned int maxHandles = 1500000, btOverlappingPairCache * pairCache = 0, bool disableRaycastAccelerator = false) 
		: bt32BitAxisSweep3(worldAabbMin, worldAabbMax, maxHandles, pairCache, disableRaycastAccelerator), luna_wrapper_base(L) { 
		register_protected_methods(L);
		if(_obj.pushFunction("buildInstance")) {
			_obj.pushArg((bt32BitAxisSweep3*)this);
			_obj.callFunction<void>();
		}
	};
	...
	void calculateOverlappingPairs(btDispatcher * dispatcher) {
		...
		return bt32BitAxisSweep3::calculateOverlappingPairs(dispatcher);
	};
	...
	void resetPool(btDispatcher * dispatcher) {
		...
		return bt32BitAxisSweep3::resetPool(dispatcher);
	};
	...
	btBroadphaseProxy * createProxy(const btVector3 & aabbMin, const btVector3 & aabbMax, int shapeType, void * userPtr, short int collisionFilterGroup, short int collisionFilterMask, btDispatcher * dispatcher, void * multiSapProxy) {
		...
		return bt32BitAxisSweep3::createProxy(aabbMin, aabbMax, shapeType, userPtr, collisionFilterGroup, collisionFilterMask, dispatcher, multiSapProxy);
	};
	...
	void destroyProxy(btBroadphaseProxy * proxy, btDispatcher * dispatcher) {
		...
		return bt32BitAxisSweep3::destroyProxy(proxy, dispatcher);
	};
	...
	void setAabb(btBroadphaseProxy * proxy, const btVector3 & aabbMin, const btVector3 & aabbMax, btDispatcher * dispatcher) {
		...
		return bt32BitAxisSweep3::setAabb(proxy, aabbMin, aabbMax, dispatcher);
	};
	...
	void getAabb(btBroadphaseProxy * proxy, btVector3 & aabbMin, btVector3 & aabbMax) const {
		...
		return bt32BitAxisSweep3::getAabb(proxy, aabbMin, aabbMax);
	};
	...
	void rayTest(const btVector3 & rayFrom, const btVector3 & rayTo, btBroadphaseRayCallback & rayCallback, const btVector3 & aabbMin = btVector3 (0, 0, 0), const btVector3 & aabbMax = btVector3 (0, 0, 0)) {
		...
		return bt32BitAxisSweep3::rayTest(rayFrom, rayTo, rayCallback, aabbMin, aabbMax);
	};
	...
	void aabbTest(const btVector3 & aabbMin, const btVector3 & aabbMax, btBroadphaseAabbCallback & callback) {
		...
		return bt32BitAxisSweep3::aabbTest(aabbMin, aabbMax, callback);
	};
	...
	btOverlappingPairCache * getOverlappingPairCache() {
		...
		return bt32BitAxisSweep3::getOverlappingPairCache();
	};
	...
	void getBroadphaseAabb(btVector3 & aabbMin, btVector3 & aabbMax) const {
		...
		return bt32BitAxisSweep3::getBroadphaseAabb(aabbMin, aabbMax);
	};
	...
	void printStats() {
		...
		return bt32BitAxisSweep3::printStats();
	};
