#ifndef _WRAPPERS_WRAPPER_BTCONESHAPEZ_H_
#define _WRAPPERS_WRAPPER_BTCONESHAPEZ_H_
...
class wrapper_btConeShapeZ : public btConeShapeZ, public luna_wrapper_base {

public:
		

	~wrapper_btConeShapeZ() {
		logDEBUG3("Calling delete function for wrapper btConeShapeZ");
		if(_obj.pushFunction("delete")) {
			//_obj.pushArg((btConeShapeZ*)this); // No this argument or the object will be referenced again!
			_obj.callFunction<void>();
		}
	};
	
	wrapper_btConeShapeZ(lua_State* L, lua_Table* dum, float radius, float height) 
		: btConeShapeZ(radius, height), luna_wrapper_base(L) { 
		register_protected_methods(L);
		if(_obj.pushFunction("buildInstance")) {
			_obj.pushArg((btConeShapeZ*)this);
			_obj.callFunction<void>();
		}
	};
	...
	void getBoundingSphere(btVector3 & center, float & radius) const {
		...
		return btConeShapeZ::getBoundingSphere(center, radius);
	};
	...
	float getAngularMotionDisc() const {
		...
		return btConeShapeZ::getAngularMotionDisc();
	};
	...
	float getContactBreakingThreshold(float defaultContactThresholdFactor) const {
		...
		return btConeShapeZ::getContactBreakingThreshold(defaultContactThresholdFactor);
	};
	...
	void project(const btTransform & trans, const btVector3 & dir, float & min, float & max) const {
		...
		return btConeShapeZ::project(trans, dir, min, max);
	};
	...
	void getAabb(const btTransform & t, btVector3 & aabbMin, btVector3 & aabbMax) const {
		...
		return btConeShapeZ::getAabb(t, aabbMin, aabbMax);
	};
	...
	void getAabbSlow(const btTransform & t, btVector3 & aabbMin, btVector3 & aabbMax) const {
		...
		return btConeShapeZ::getAabbSlow(t, aabbMin, aabbMax);
	};
	...
	const btVector3 & getLocalScaling() const {
		...
		return btConeShapeZ::getLocalScaling();
	};
	...
	void setMargin(float margin) {
		...
		return btConeShapeZ::setMargin(margin);
	};
	...
	int getNumPreferredPenetrationDirections() const {
		...
		return btConeShapeZ::getNumPreferredPenetrationDirections();
	};
	...
	void getPreferredPenetrationDirection(int index, btVector3 & penetrationVector) const {
		...
		return btConeShapeZ::getPreferredPenetrationDirection(index, penetrationVector);
	};
	...
	int calculateSerializeBufferSize() const {
		...
		return btConeShapeZ::calculateSerializeBufferSize();
	};
	...
	btVector3 localGetSupportingVertex(const btVector3 & vec) const {
		...
		return btConeShapeZ::localGetSupportingVertex(vec);
	};
	...
	btVector3 localGetSupportingVertexWithoutMargin(const btVector3 & vec) const {
		...
		return btConeShapeZ::localGetSupportingVertexWithoutMargin(vec);
	};
	...
	void batchedUnitVectorGetSupportingVertexWithoutMargin(const btVector3 * vectors, btVector3 * supportVerticesOut, int numVectors) const {
		...
		return btConeShapeZ::batchedUnitVectorGetSupportingVertexWithoutMargin(vectors, supportVerticesOut, numVectors);
	};
	...
	void calculateLocalInertia(float mass, btVector3 & inertia) const {
		...
		return btConeShapeZ::calculateLocalInertia(mass, inertia);
	};
	...
	void setLocalScaling(const btVector3 & scaling) {
		...
		return btConeShapeZ::setLocalScaling(scaling);
	};
	...
	btVector3 getAnisotropicRollingFrictionDirection() const {
		...
		return btConeShapeZ::getAnisotropicRollingFrictionDirection();
	};
