...
public:
	...
	static int _bind_public_getUpAxisDirections(lua_State *L) {
		...
		if(!self) {
			luna_printStack(L);
			luaL_error(L, "Invalid object in function call static btVector3 * btKinematicCharacterController::public_getUpAxisDirections(). Got : '%s'",typeid(Luna< btActionInterface >::check(L,1)).name());
		}
	...
	static int _bind_public_computeReflectionDirection(lua_State *L) {
		...
		if(!self) {
			luna_printStack(L);
			luaL_error(L, "Invalid object in function call btVector3 btKinematicCharacterController::public_computeReflectionDirection(const btVector3 &, const btVector3 &). Got : '%s'",typeid(Luna< btActionInterface >::check(L,1)).name());
		}
	...
	static int _bind_public_parallelComponent(lua_State *L) {
		...
		if(!self) {
			luna_printStack(L);
			luaL_error(L, "Invalid object in function call btVector3 btKinematicCharacterController::public_parallelComponent(const btVector3 &, const btVector3 &). Got : '%s'",typeid(Luna< btActionInterface >::check(L,1)).name());
		}
	...
	static int _bind_public_perpindicularComponent(lua_State *L) {
		...
		if(!self) {
			luna_printStack(L);
			luaL_error(L, "Invalid object in function call btVector3 btKinematicCharacterController::public_perpindicularComponent(const btVector3 &, const btVector3 &). Got : '%s'",typeid(Luna< btActionInterface >::check(L,1)).name());
		}
	...
	static int _bind_public_recoverFromPenetration(lua_State *L) {
		...
		if(!self) {
			luna_printStack(L);
			luaL_error(L, "Invalid object in function call bool btKinematicCharacterController::public_recoverFromPenetration(btCollisionWorld *). Got : '%s'",typeid(Luna< btActionInterface >::check(L,1)).name());
		}
	...
	static int _bind_public_stepUp(lua_State *L) {
		...
		if(!self) {
			luna_printStack(L);
			luaL_error(L, "Invalid object in function call void btKinematicCharacterController::public_stepUp(btCollisionWorld *). Got : '%s'",typeid(Luna< btActionInterface >::check(L,1)).name());
		}
	...
	static int _bind_public_updateTargetPositionBasedOnCollision(lua_State *L) {
		...
		if(!self) {
			luna_printStack(L);
			luaL_error(L, "Invalid object in function call void btKinematicCharacterController::public_updateTargetPositionBasedOnCollision(const btVector3 &, float, float). Got : '%s'",typeid(Luna< btActionInterface >::check(L,1)).name());
		}
	...
	static int _bind_public_stepForwardAndStrafe(lua_State *L) {
		...
		if(!self) {
			luna_printStack(L);
			luaL_error(L, "Invalid object in function call void btKinematicCharacterController::public_stepForwardAndStrafe(btCollisionWorld *, const btVector3 &). Got : '%s'",typeid(Luna< btActionInterface >::check(L,1)).name());
		}
	...
	static int _bind_public_stepDown(lua_State *L) {
		...
		if(!self) {
			luna_printStack(L);
			luaL_error(L, "Invalid object in function call void btKinematicCharacterController::public_stepDown(btCollisionWorld *, float). Got : '%s'",typeid(Luna< btActionInterface >::check(L,1)).name());
		}
