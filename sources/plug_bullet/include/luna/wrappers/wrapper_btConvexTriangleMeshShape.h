#ifndef _WRAPPERS_WRAPPER_BTCONVEXTRIANGLEMESHSHAPE_H_
#define _WRAPPERS_WRAPPER_BTCONVEXTRIANGLEMESHSHAPE_H_
...
class wrapper_btConvexTriangleMeshShape : public btConvexTriangleMeshShape, public luna_wrapper_base {

public:
		

	~wrapper_btConvexTriangleMeshShape() {
		logDEBUG3("Calling delete function for wrapper btConvexTriangleMeshShape");
		if(_obj.pushFunction("delete")) {
			//_obj.pushArg((btConvexTriangleMeshShape*)this); // No this argument or the object will be referenced again!
			_obj.callFunction<void>();
		}
	};
	
	wrapper_btConvexTriangleMeshShape(lua_State* L, lua_Table* dum, btStridingMeshInterface * meshInterface, bool calcAabb = true) 
		: btConvexTriangleMeshShape(meshInterface, calcAabb), luna_wrapper_base(L) { 
		register_protected_methods(L);
		if(_obj.pushFunction("buildInstance")) {
			_obj.pushArg((btConvexTriangleMeshShape*)this);
			_obj.callFunction<void>();
		}
	};
	...
	void getBoundingSphere(btVector3 & center, float & radius) const {
		...
		return btConvexTriangleMeshShape::getBoundingSphere(center, radius);
	};
	...
	float getAngularMotionDisc() const {
		...
		return btConvexTriangleMeshShape::getAngularMotionDisc();
	};
	...
	float getContactBreakingThreshold(float defaultContactThresholdFactor) const {
		...
		return btConvexTriangleMeshShape::getContactBreakingThreshold(defaultContactThresholdFactor);
	};
	...
	btVector3 getAnisotropicRollingFrictionDirection() const {
		...
		return btConvexTriangleMeshShape::getAnisotropicRollingFrictionDirection();
	};
	...
	void project(const btTransform & trans, const btVector3 & dir, float & min, float & max) const {
		...
		return btConvexTriangleMeshShape::project(trans, dir, min, max);
	};
	...
	void getAabbSlow(const btTransform & t, btVector3 & aabbMin, btVector3 & aabbMax) const {
		...
		return btConvexTriangleMeshShape::getAabbSlow(t, aabbMin, aabbMax);
	};
	...
	void setMargin(float margin) {
		...
		return btConvexTriangleMeshShape::setMargin(margin);
	};
	...
	float getMargin() const {
		...
		return btConvexTriangleMeshShape::getMargin();
	};
	...
	int getNumPreferredPenetrationDirections() const {
		...
		return btConvexTriangleMeshShape::getNumPreferredPenetrationDirections();
	};
	...
	void getPreferredPenetrationDirection(int index, btVector3 & penetrationVector) const {
		...
		return btConvexTriangleMeshShape::getPreferredPenetrationDirection(index, penetrationVector);
	};
	...
	int calculateSerializeBufferSize() const {
		...
		return btConvexTriangleMeshShape::calculateSerializeBufferSize();
	};
	...
	bool initializePolyhedralFeatures(int shiftVerticesByMargin = 0) {
		...
		return btConvexTriangleMeshShape::initializePolyhedralFeatures(shiftVerticesByMargin);
	};
	...
	void calculateLocalInertia(float mass, btVector3 & inertia) const {
		...
		return btConvexTriangleMeshShape::calculateLocalInertia(mass, inertia);
	};
	...
	void getAabb(const btTransform & t, btVector3 & aabbMin, btVector3 & aabbMax) const {
		...
		return btConvexTriangleMeshShape::getAabb(t, aabbMin, aabbMax);
	};
	...
	btVector3 localGetSupportingVertex(const btVector3 & vec) const {
		...
		return btConvexTriangleMeshShape::localGetSupportingVertex(vec);
	};
	...
	btVector3 localGetSupportingVertexWithoutMargin(const btVector3 & vec) const {
		...
		return btConvexTriangleMeshShape::localGetSupportingVertexWithoutMargin(vec);
	};
	...
	void batchedUnitVectorGetSupportingVertexWithoutMargin(const btVector3 * vectors, btVector3 * supportVerticesOut, int numVectors) const {
		...
		return btConvexTriangleMeshShape::batchedUnitVectorGetSupportingVertexWithoutMargin(vectors, supportVerticesOut, numVectors);
	};
	...
	const char * getName() const {
		...
		return btConvexTriangleMeshShape::getName();
	};
	...
	int getNumVertices() const {
		...
		return btConvexTriangleMeshShape::getNumVertices();
	};
	...
	int getNumEdges() const {
		...
		return btConvexTriangleMeshShape::getNumEdges();
	};
	...
	void getEdge(int i, btVector3 & pa, btVector3 & pb) const {
		...
		return btConvexTriangleMeshShape::getEdge(i, pa, pb);
	};
	...
	void getVertex(int i, btVector3 & vtx) const {
		...
		return btConvexTriangleMeshShape::getVertex(i, vtx);
	};
	...
	int getNumPlanes() const {
		...
		return btConvexTriangleMeshShape::getNumPlanes();
	};
	...
	void getPlane(btVector3 & planeNormal, btVector3 & planeSupport, int i) const {
		...
		return btConvexTriangleMeshShape::getPlane(planeNormal, planeSupport, i);
	};
	...
	bool isInside(const btVector3 & pt, float tolerance) const {
		...
		return btConvexTriangleMeshShape::isInside(pt, tolerance);
	};
	...
	void setLocalScaling(const btVector3 & scaling) {
		...
		return btConvexTriangleMeshShape::setLocalScaling(scaling);
	};
	...
	const btVector3 & getLocalScaling() const {
		...
		return btConvexTriangleMeshShape::getLocalScaling();
	};
	...
	static int _bind_public_setCachedLocalAabb(lua_State *L) {
		...
		wrapper_btConvexTriangleMeshShape* self=Luna< btCollisionShape >::checkSubType< wrapper_btConvexTriangleMeshShape >(L,1);
		if(!self) {
			luna_printStack(L);
