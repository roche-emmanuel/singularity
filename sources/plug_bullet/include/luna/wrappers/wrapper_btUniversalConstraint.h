#ifndef _WRAPPERS_WRAPPER_BTUNIVERSALCONSTRAINT_H_
#define _WRAPPERS_WRAPPER_BTUNIVERSALCONSTRAINT_H_
...
class wrapper_btUniversalConstraint : public btUniversalConstraint, public luna_wrapper_base {

public:
		

	~wrapper_btUniversalConstraint() {
		logDEBUG3("Calling delete function for wrapper btUniversalConstraint");
		if(_obj.pushFunction("delete")) {
			//_obj.pushArg((btUniversalConstraint*)this); // No this argument or the object will be referenced again!
			_obj.callFunction<void>();
		}
	};
	
	wrapper_btUniversalConstraint(lua_State* L, lua_Table* dum, btRigidBody & rbA, btRigidBody & rbB, const btVector3 & anchor, const btVector3 & axis1, const btVector3 & axis2) 
		: btUniversalConstraint(rbA, rbB, anchor, axis1, axis2), luna_wrapper_base(L) { 
		register_protected_methods(L);
		if(_obj.pushFunction("buildInstance")) {
			_obj.pushArg((btUniversalConstraint*)this);
			_obj.callFunction<void>();
		}
	};
	...
	void setupSolverConstraint(btConstraintArray & ca, int solverBodyA, int solverBodyB, float timeStep) {
		...
		return btUniversalConstraint::setupSolverConstraint(ca, solverBodyA, solverBodyB, timeStep);
	};
	...
	void solveConstraintObsolete(btSolverBody & arg1, btSolverBody & arg2, float arg3) {
		...
		return btUniversalConstraint::solveConstraintObsolete(arg1, arg2, arg3);
	};
	...
	void buildJacobian() {
		...
		return btUniversalConstraint::buildJacobian();
	};
	...
	void getInfo1(btTypedConstraint::btConstraintInfo1 * info) {
		...
		return btUniversalConstraint::getInfo1(info);
	};
	...
	void getInfo2(btTypedConstraint::btConstraintInfo2 * info) {
		...
		return btUniversalConstraint::getInfo2(info);
	};
	...
	void calcAnchorPos() {
		...
		return btUniversalConstraint::calcAnchorPos();
	};
	...
	void setParam(int num, float value, int axis = -1) {
		...
		return btUniversalConstraint::setParam(num, value, axis);
	};
	...
	float getParam(int num, int axis = -1) const {
		...
		return btUniversalConstraint::getParam(num, axis);
	};
	...
	int calculateSerializeBufferSize() const {
		...
		return btUniversalConstraint::calculateSerializeBufferSize();
	};
	...
	static int _bind_public_setAngularLimits(lua_State *L) {
		...
		wrapper_btUniversalConstraint* self=Luna< btTypedObject >::checkSubType< wrapper_btUniversalConstraint >(L,1);
		if(!self) {
			luna_printStack(L);
