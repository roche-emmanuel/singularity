define(["log","jquery","backbone","base/Tools"],function(log,$,Backbone,tools) {
	...
	var Class = Backbone.Model.extend({
		...
		setSize: function(ww,hh) {
			this._paper.clear();
			var wsize = tools.getWindowSize()
			ww *= wsize.x/4; // Horizontal tick size
			...
			var str = M(c+ww*0.5,c)+L(c+ww*2,c)+M(c-ww*0.5,c)+L(c-ww*2,c)
					 +M(c,c+hh*0.5)+L(c,c+hh*2)+M(c,c-hh*0.5)+L(c,c-hh*2)
